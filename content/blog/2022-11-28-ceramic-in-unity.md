...
description: I created an open source and code oriented 2D Framework called Ceramic and made it run inside Unity.
...
In **Ceramic**, there is no such this as a `Material` to configure a visual texture or color. Instead, you directly set properties on the visual:
