...
title: Utils
target: Headless
permalink: api-docs/headless/tracker/Utils/
---
...
|------|------|-------------|
| `values` | [Array](/api-docs/headless/Array/)<[Int](/api-docs/headless/Int/)> | the values to put in list |
| `frequencies` | [Array](/api-docs/headless/Array/)<[Float](/api-docs/headless/Float/)> |  |
...
| Name | Type | Default |
|------|------|---------|
| `val` | [Int](/api-docs/headless/Int/) | *(optional)* |
...
| Name | Type |
|------|------|
| `rawData` | [String](/api-docs/headless/String/) |
