...
title: EReg
target: Headless
permalink: api-docs/headless/EReg/
---
...
| `len` | [Int](/api-docs/headless/Int/) | `-1` |
...
| `opt` | [String](/api-docs/headless/String/) |

## Private Members

<div class="signature field-var no-description" id="escapeRe"><code><span class="field-name">escapeRe</span><span class="operator">:</span> <a href="/api-docs/headless/js/lib/RegExp/" class="type-link">js.lib.RegExp</a></code><a class="header-anchor" href="#escapeRe"><span aria-hidden="true" class="header-anchor__symbol">#</span></a></div>

<hr class="field-separator" />

<div class="signature field-var no-description" id="r"><code><span class="field-name">r</span><span class="operator">:</span> <a href="/api-docs/headless/_EReg/HaxeRegExp/" class="type-link">_EReg.HaxeRegExp</a></code><a class="header-anchor" href="#r"><span aria-hidden="true" class="header-anchor__symbol">#</span></a></div>
