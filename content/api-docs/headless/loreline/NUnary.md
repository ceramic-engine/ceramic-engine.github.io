...
title: NUnary
target: Headless
permalink: api-docs/headless/loreline/NUnary/
---
...
<div class="type-hierarchy"><a href="/api-docs/headless/loreline/Node/">Node</a> → <a href="/api-docs/headless/loreline/AstNode/">AstNode</a> → <a href="/api-docs/headless/loreline/NExpr/">NExpr</a> → <strong>loreline.NUnary</strong> (Class)</div>
...
<div class="signature field-var has-description" id="operand"><code><span class="field-name">operand</span><span class="operator">:</span> <a href="/api-docs/headless/loreline/NExpr/" class="type-link">NExpr</a></code><a class="header-anchor" href="#operand"><span aria-hidden="true" class="header-anchor__symbol">#</span></a></div>
...
| `operand` | [NExpr](/api-docs/headless/loreline/NExpr/) | | Operand expression  |
