...
target: Headless
permalink: api-docs/headless/loreline/_Node/NodeIdMapKeyIterator/
---
...
<div class="signature field-method no-description" id="next"><code><span class="field-name">next</span><span class="parenthesis">(</span><span class="parenthesis">)</span><span class="operator">:</span> <a href="/api-docs/headless/loreline/NodeId/" class="type-link">loreline.NodeId</a></code><a class="header-anchor" href="#next"><span aria-hidden="true" class="header-anchor__symbol">#</span></a></div>

| Returns |
|---------|
| [loreline.NodeId](/api-docs/headless/loreline/NodeId/) |
...
| Name | Type |
|------|------|
| `map` | [loreline.Int64Map](/api-docs/headless/loreline/Int64Map/)<loreline._Node.NodeIdMapKeyIterator.V> |
