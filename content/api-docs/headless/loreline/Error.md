...
title: Error
target: Headless
permalink: api-docs/headless/loreline/Error/
---
...
<div class="type-hierarchy"><strong>loreline.Error</strong> (Class) → <a href="/api-docs/headless/loreline/LexerError/">LexerError</a>, <a href="/api-docs/headless/loreline/ParseError/">ParseError</a>, <a href="/api-docs/headless/loreline/RuntimeError/">RuntimeError</a>, <a href="/api-docs/headless/loreline/WrappedError/">WrappedError</a></div>
...
| Returns | Description |
|---------|-------------|
| [String](/api-docs/headless/String/) | Formatted error message with position |
...
|------|------|---------|-------------|
| `message` | [String](/api-docs/headless/String/) | | The error message  |
| `pos` | [Position](/api-docs/headless/loreline/Position/) | *(optional)* | The position where the error occurred |
