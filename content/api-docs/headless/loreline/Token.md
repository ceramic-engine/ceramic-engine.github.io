...
title: Token
target: Headless
permalink: api-docs/headless/loreline/Token/
---
...
| Returns | Description |
|---------|-------------|
| [String](/api-docs/headless/String/) | Formatted token information with position |
...
| `pos` | [Position](/api-docs/headless/loreline/Position/) | The token's position |
