...
title: RuntimeScope
target: Headless
permalink: api-docs/headless/loreline/RuntimeScope/
---
...
<div class="signature field-var has-description" id="beat"><code><span class="field-name">beat</span><span class="operator">:</span> <a href="/api-docs/headless/loreline/NBeatDecl/" class="type-link">NBeatDecl</a></code><a class="header-anchor" href="#beat"><span aria-hidden="true" class="header-anchor__symbol">#</span></a></div>
...
<div class="signature field-var has-description" id="node"><code><span class="field-name">node</span><span class="operator">:</span> <a href="/api-docs/headless/loreline/AstNode/" class="type-link">AstNode</a></code><a class="header-anchor" href="#node"><span aria-hidden="true" class="header-anchor__symbol">#</span></a></div>
...
<div class="signature field-var has-description" id="state"><code><span class="field-name">state</span><span class="operator">:</span> <a href="/api-docs/headless/loreline/RuntimeState/" class="type-link">RuntimeState</a></code><a class="header-anchor" href="#state"><span aria-hidden="true" class="header-anchor__symbol">#</span></a></div>

The temporary state associated with this scope, if any.

<hr class="field-separator" />

<div class="signature field-var has-description" id="head"><code><span class="field-name">head</span><span class="operator">:</span> <a href="/api-docs/headless/loreline/AstNode/" class="type-link">AstNode</a></code><a class="header-anchor" href="#head"><span aria-hidden="true" class="header-anchor__symbol">#</span></a></div>
...
|------|------|-------------|
| `name` | [String](/api-docs/headless/String/) | The name of the beat to find  |

| Returns | Description |
|---------|-------------|
| [Null](/api-docs/headless/Null/)<[NBeatDecl](/api-docs/headless/loreline/NBeatDecl/)> | The beat declaration if found, null otherwise |
...
|------|------|---------|-------------|
| `id` | [Null](/api-docs/headless/Null/)<[Int](/api-docs/headless/Int/)> | *(optional)* | * The scope id, a unique integer value in the stack. |
| `beat` | [NBeatDecl](/api-docs/headless/loreline/NBeatDecl/) | | * The parent beat where this scope is located. Can be either a top level beat or a nested beat. |
| `node` | [AstNode](/api-docs/headless/loreline/AstNode/) | | * The node where this scope is attached. |
| `beats` | [Null](/api-docs/headless/Null/)<[Array](/api-docs/headless/Array/)<[NBeatDecl](/api-docs/headless/loreline/NBeatDecl/)>> | *(optional)* | * The nested beat declarations, if any, found in this scope. |
| `state` | [Null](/api-docs/headless/Null/)<[RuntimeState](/api-docs/headless/loreline/RuntimeState/)> | *(optional)* | * The temporary state associated with this scope, if any. |
| `head` | [Null](/api-docs/headless/Null/)<[AstNode](/api-docs/headless/loreline/AstNode/)> | *(optional)* | * If applicable, the node this scope's "reading head" is at. This is used to track the current execution position within the scope. |
| `insertion` | [Null](/api-docs/headless/Null/)<[RuntimeInsertion](/api-docs/headless/loreline/RuntimeInsertion/)> | *(optional)* | * If this scope was created from an insertion, this is the insertion runtime data. |
