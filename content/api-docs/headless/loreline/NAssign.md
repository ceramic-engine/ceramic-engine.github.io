...
title: NAssign
target: Headless
permalink: api-docs/headless/loreline/NAssign/
---
...
<div class="type-hierarchy"><a href="/api-docs/headless/loreline/Node/">Node</a> → <a href="/api-docs/headless/loreline/AstNode/">AstNode</a> → <a href="/api-docs/headless/loreline/NExpr/">NExpr</a> → <strong>loreline.NAssign</strong> (Class)</div>
...
| Returns | Description |
|---------|-------------|
| [Dynamic](/api-docs/headless/Dynamic/) | Dynamic object containing assignment data |
...
| `pos` | [Position](/api-docs/headless/loreline/Position/) | | Position in source where this assignment appears  |
| `target` | [NExpr](/api-docs/headless/loreline/NExpr/) | | Target expression being assigned to  |
| `op` | Anonymous | | Assignment operator type  |
| `value` | [NExpr](/api-docs/headless/loreline/NExpr/) | | Value being assigned  |
| `leadingComments` | [Array](/api-docs/headless/Array/)<[Comment](/api-docs/headless/loreline/Comment/)> | *(optional)* | Optional comments before the assignment  |
| `trailingComments` | [Array](/api-docs/headless/Array/)<[Comment](/api-docs/headless/loreline/Comment/)> | *(optional)* | Optional comments after the assignment |
