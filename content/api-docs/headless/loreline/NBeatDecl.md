...
title: NBeatDecl
target: Headless
permalink: api-docs/headless/loreline/NBeatDecl/
---
...
<div class="type-hierarchy"><a href="/api-docs/headless/loreline/Node/">Node</a> → <a href="/api-docs/headless/loreline/AstNode/">AstNode</a> → <strong>loreline.NBeatDecl</strong> (Class)</div>
...
| Returns | Description |
|---------|-------------|
| [Dynamic](/api-docs/headless/Dynamic/) | Dynamic object containing beat data |
...
| `pos` | [Position](/api-docs/headless/loreline/Position/) | | Position in source where this beat appears  |
| `name` | [String](/api-docs/headless/String/) | | Name of the beat  |
| `body` | [Array](/api-docs/headless/Array/)<[AstNode](/api-docs/headless/loreline/AstNode/)> | | Array of nodes comprising the beat's content  |
| `leadingComments` | [Array](/api-docs/headless/Array/)<[Comment](/api-docs/headless/loreline/Comment/)> | *(optional)* | Optional comments before the beat  |
| `trailingComments` | [Array](/api-docs/headless/Array/)<[Comment](/api-docs/headless/loreline/Comment/)> | *(optional)* | Optional comments after the beat |
