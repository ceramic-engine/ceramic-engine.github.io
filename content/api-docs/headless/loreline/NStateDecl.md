...
title: NStateDecl
target: Headless
permalink: api-docs/headless/loreline/NStateDecl/
---
...
<div class="type-hierarchy"><a href="/api-docs/headless/loreline/Node/">Node</a> → <a href="/api-docs/headless/loreline/AstNode/">AstNode</a> → <strong>loreline.NStateDecl</strong> (Class)</div>
...
<div class="signature field-var has-description" id="temporary"><code><span class="field-name">temporary</span><span class="operator">:</span> <a href="/api-docs/headless/Bool/" class="type-link">Bool</a></code><a class="header-anchor" href="#temporary"><span aria-hidden="true" class="header-anchor__symbol">#</span></a></div>
...
| Returns | Description |
|---------|-------------|
| [Dynamic](/api-docs/headless/Dynamic/) | Dynamic object containing state data |
...
| `pos` | [Position](/api-docs/headless/loreline/Position/) | | Position in source where this state appears  |
| `temporary` | [Bool](/api-docs/headless/Bool/) | | Whether this is a temporary state  |
| `fields` | [Array](/api-docs/headless/Array/)<[NObjectField](/api-docs/headless/loreline/NObjectField/)> | | Array of property definitions  |
| `leadingComments` | [Array](/api-docs/headless/Array/)<[Comment](/api-docs/headless/loreline/Comment/)> | *(optional)* | Optional comments before the state  |
| `trailingComments` | [Array](/api-docs/headless/Array/)<[Comment](/api-docs/headless/loreline/Comment/)> | *(optional)* | Optional comments after the state |
