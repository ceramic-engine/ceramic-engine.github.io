...
target: Headless
permalink: api-docs/headless/loreline/_Int64Map/Int64MapKeyValueIterator/
---
...
<div class="signature field-method no-description" id="next"><code><span class="field-name">next</span><span class="parenthesis">(</span><span class="parenthesis">)</span><span class="operator">:</span> <a href="/api-docs/headless/loreline/Int64MapKeyVal/" class="type-link">loreline.Int64MapKeyVal</a></code><a class="header-anchor" href="#next"><span aria-hidden="true" class="header-anchor__symbol">#</span></a></div>

| Returns |
|---------|
| [loreline.Int64MapKeyVal](/api-docs/headless/loreline/Int64MapKeyVal/) |
...
| Name | Type |
|------|------|
| `map` | [loreline.Int64Map](/api-docs/headless/loreline/Int64Map/)<loreline._Int64Map.Int64MapKeyValueIterator.V> |
