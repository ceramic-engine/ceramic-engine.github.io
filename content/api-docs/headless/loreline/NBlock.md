...
title: NBlock
target: Headless
permalink: api-docs/headless/loreline/NBlock/
---
...
<div class="type-hierarchy"><a href="/api-docs/headless/loreline/Node/">Node</a> → <a href="/api-docs/headless/loreline/AstNode/">AstNode</a> → <strong>loreline.NBlock</strong> (Class)</div>
...
| `body` | [Array](/api-docs/headless/Array/)<[AstNode](/api-docs/headless/loreline/AstNode/)> | | Array of nodes comprising the block's content  |
