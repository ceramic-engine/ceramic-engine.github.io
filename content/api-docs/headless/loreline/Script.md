...
title: Script
target: Headless
permalink: api-docs/headless/loreline/Script/
---
...
<div class="type-hierarchy"><a href="/api-docs/headless/loreline/Node/">Node</a> → <a href="/api-docs/headless/loreline/AstNode/">AstNode</a> → <strong>loreline.Script</strong> (Class)</div>
...
| Returns | Description |
|---------|-------------|
| [Dynamic](/api-docs/headless/Dynamic/) | Dynamic object containing all script data |
...
|------|------|-------------|
| `id` | [NodeId](/api-docs/headless/loreline/NodeId/) | The node id of this script  |
| `pos` | [Position](/api-docs/headless/loreline/Position/) | Position in source where this script starts  |
| `body` | [Array](/api-docs/headless/Array/)<[AstNode](/api-docs/headless/loreline/AstNode/)> | Array of top-level declarations |
