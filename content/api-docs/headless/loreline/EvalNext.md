...
title: EvalNext
target: Headless
permalink: api-docs/headless/loreline/EvalNext/
---
...
<div class="signature field-var has-description" id="sync"><code><span class="field-name">sync</span><span class="operator">:</span> <a href="/api-docs/headless/Bool/" class="type-link">Bool</a></code><a class="header-anchor" href="#sync"><span aria-hidden="true" class="header-anchor__symbol">#</span></a></div>
