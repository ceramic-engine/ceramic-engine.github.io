...
title: NAccess
target: Headless
permalink: api-docs/headless/loreline/NAccess/
---
...
<div class="type-hierarchy"><a href="/api-docs/headless/loreline/Node/">Node</a> → <a href="/api-docs/headless/loreline/AstNode/">AstNode</a> → <a href="/api-docs/headless/loreline/NExpr/">NExpr</a> → <strong>loreline.NAccess</strong> (Class)</div>
...
| Returns | Description |
|---------|-------------|
| [Dynamic](/api-docs/headless/Dynamic/) | Dynamic object containing access data |
...
| `target` | [Null](/api-docs/headless/Null/)<[NExpr](/api-docs/headless/loreline/NExpr/)> | | Optional target object expression  |
| `name` | [String](/api-docs/headless/String/) | | Name of the accessed field  |
