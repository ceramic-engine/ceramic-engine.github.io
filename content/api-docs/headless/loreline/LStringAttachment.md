...
target: Headless
permalink: api-docs/headless/loreline/LStringAttachment/
---
...
| `expr` | [loreline.Tokens](/api-docs/headless/loreline/Tokens/) | The tokens making up the interpolation expression  |
| `start` | [Int](/api-docs/headless/Int/) | Starting position in the string  |
| `length` | [Int](/api-docs/headless/Int/) | Length of the interpolation |
...
| `start` | [Int](/api-docs/headless/Int/) | Starting position in the string  |
| `length` | [Int](/api-docs/headless/Int/) | Length of the tag |
