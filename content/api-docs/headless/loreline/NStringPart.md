...
title: NStringPart
target: Headless
permalink: api-docs/headless/loreline/NStringPart/
---
...
<div class="type-hierarchy"><a href="/api-docs/headless/loreline/Node/">Node</a> → <a href="/api-docs/headless/loreline/AstNode/">AstNode</a> → <a href="/api-docs/headless/loreline/NExpr/">NExpr</a> → <strong>loreline.NStringPart</strong> (Class)</div>
...
| Returns | Description |
|---------|-------------|
| [Dynamic](/api-docs/headless/Dynamic/) | Dynamic object containing string part data |
...
| `pos` | [Position](/api-docs/headless/loreline/Position/) | | Position in source where this string part appears  |
| `partType` | Anonymous | |  |
