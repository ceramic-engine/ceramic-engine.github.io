...
title: RuntimeError
target: Headless
permalink: api-docs/headless/loreline/RuntimeError/
---
...
<div class="type-hierarchy"><a href="/api-docs/headless/loreline/Error/">Error</a> → <strong>loreline.RuntimeError</strong> (Class)</div>
...
| `pos` | [Position](/api-docs/headless/loreline/Position/) | *(optional)* |
