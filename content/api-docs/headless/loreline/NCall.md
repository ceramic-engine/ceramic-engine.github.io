...
title: NCall
target: Headless
permalink: api-docs/headless/loreline/NCall/
---
...
<div class="type-hierarchy"><a href="/api-docs/headless/loreline/Node/">Node</a> → <a href="/api-docs/headless/loreline/AstNode/">AstNode</a> → <a href="/api-docs/headless/loreline/NExpr/">NExpr</a> → <strong>loreline.NCall</strong> (Class)</div>
...
| Returns | Description |
|---------|-------------|
| [Dynamic](/api-docs/headless/Dynamic/) | Dynamic object containing call data |
...
| `pos` | [Position](/api-docs/headless/loreline/Position/) | | Position in source where this call appears  |
| `target` | [NExpr](/api-docs/headless/loreline/NExpr/) | | Expression being called  |
| `args` | [Array](/api-docs/headless/Array/)<[NExpr](/api-docs/headless/loreline/NExpr/)> | | Array of argument expressions  |
| `leadingComments` | [Array](/api-docs/headless/Array/)<[Comment](/api-docs/headless/loreline/Comment/)> | *(optional)* | Optional comments before the call  |
| `trailingComments` | [Array](/api-docs/headless/Array/)<[Comment](/api-docs/headless/loreline/Comment/)> | *(optional)* | Optional comments after the call |
