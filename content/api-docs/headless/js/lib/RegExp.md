...
title: RegExp
target: Headless
permalink: api-docs/headless/js/lib/RegExp/
---

# RegExp

<div class="type-hierarchy"><strong>js.lib.RegExp</strong> (extern class) → <a href="/api-docs/headless/_EReg/HaxeRegExp/">_EReg.HaxeRegExp</a></div>
...
<div class="signature field-var has-description" id="global"><code><span class="field-name">global</span><span class="operator">:</span> <a href="/api-docs/headless/Bool/" class="type-link">Bool</a></code><a class="header-anchor" href="#global"><span aria-hidden="true" class="header-anchor__symbol">#</span></a></div>

Indicates whether or not the "g" flag is used with the regular expression.

<hr class="field-separator" />

<div class="signature field-var has-description" id="ignoreCase"><code><span class="field-name">ignoreCase</span><span class="operator">:</span> <a href="/api-docs/headless/Bool/" class="type-link">Bool</a></code><a class="header-anchor" href="#ignoreCase"><span aria-hidden="true" class="header-anchor__symbol">#</span></a></div>
...
| Returns |
|---------|
| [Null](/api-docs/headless/Null/)<[RegExpMatch](/api-docs/headless/js/lib/RegExpMatch/)> |

<hr class="field-separator" />

<div class="signature field-method has-description" id="test"><code><span class="field-name">test</span><span class="parenthesis">(</span><span class="arg-name">str</span><span class="operator">:</span> <a href="/api-docs/headless/String/" class="type-link">String</a><span class="parenthesis">)</span><span class="operator">:</span> <a href="/api-docs/headless/Bool/" class="type-link">Bool</a></code><a class="header-anchor" href="#test"><span aria-hidden="true" class="header-anchor__symbol">#</span></a></div>
...
| Name | Type | Default |
|------|------|---------|
| `pattern` | [String](/api-docs/headless/String/) | |
| `flags` | [String](/api-docs/headless/String/) | *(optional)* |
