...
title: TextureTile
target: Headless
permalink: api-docs/headless/ceramic/TextureTile/
---
...
<div class="type-hierarchy"><strong>ceramic.TextureTile</strong> (Class) → <a href="/api-docs/headless/ceramic/TextureAtlasRegion/">TextureAtlasRegion</a>, <a href="/api-docs/headless/ceramic/_TextureTilePacker/PackedTextureTile/">ceramic._TextureTilePacker.PackedTextureTile</a></div>
...
<div class="signature field-var has-description" id="edgeInset"><code><span class="field-name">edgeInset</span><span class="operator">:</span> <a href="/api-docs/headless/Float/" class="type-link">Float</a></code><a class="header-anchor" href="#edgeInset"><span aria-hidden="true" class="header-anchor__symbol">#</span></a></div>
...
|------|------|-------------|
| `frameX` | [Float](/api-docs/headless/Float/) | New X coordinate in texture pixels  |
| `frameY` | [Float](/api-docs/headless/Float/) | New Y coordinate in texture pixels  |
| `frameWidth` | [Float](/api-docs/headless/Float/) | New width in texture pixels  |
| `frameHeight` | [Float](/api-docs/headless/Float/) | New height in texture pixels |
...
|------|------|---------|-------------|
| `texture` | [Texture](/api-docs/headless/ceramic/Texture/) | | Source texture containing the tile  |
| `frameX` | [Float](/api-docs/headless/Float/) | | X coordinate in texture pixels  |
| `frameY` | [Float](/api-docs/headless/Float/) | | Y coordinate in texture pixels  |
| `frameWidth` | [Float](/api-docs/headless/Float/) | | Width in texture pixels  |
| `frameHeight` | [Float](/api-docs/headless/Float/) | | Height in texture pixels  |
| `rotateFrame` | [Bool](/api-docs/headless/Bool/) | `false` | Whether tile is rotated 90 degrees (default: false)  |
| `edgeInset` | [Float](/api-docs/headless/Float/) | `0` | Pixel inset for edge bleeding prevention (default: 0) |
...
| Returns | Description |
|---------|-------------|
| [String](/api-docs/headless/String/) | String with tile properties |
