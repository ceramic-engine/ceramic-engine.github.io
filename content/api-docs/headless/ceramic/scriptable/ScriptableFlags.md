...
target: Headless
permalink: api-docs/headless/ceramic/scriptable/ScriptableFlags/
---
...
|------|------|-------------|
| `flags` | [Int](/api-docs/headless/Int/) | The integer containing the bit flags  |
| `bit` | [Int](/api-docs/headless/Int/) | The bit position to check (0-31)  |

| Returns | Description |
|---------|-------------|
| [Bool](/api-docs/headless/Bool/) | True if the bit is set (1), false if not set (0) |

<hr class="field-separator" />

<div class="signature field-method has-description" id="setBoolAndGetFlags"><code><span class="field-name">setBoolAndGetFlags</span><span class="parenthesis">(</span><span class="arg-name">flags</span><span class="operator">:</span> <a href="/api-docs/headless/Int/" class="type-link">Int</a><span class="operator">,</span> <span class="arg-name">bit</span><span class="operator">:</span> <a href="/api-docs/headless/Int/" class="type-link">Int</a><span class="operator">,</span> <span class="arg-name">bool</span><span class="operator">:</span> <a href="/api-docs/headless/Bool/" class="type-link">Bool</a><span class="parenthesis">)</span><span class="operator">:</span> <a href="/api-docs/headless/Int/" class="type-link">Int</a></code><a class="header-anchor" href="#setBoolAndGetFlags"><span aria-hidden="true" class="header-anchor__symbol">#</span></a></div>
...
|------|------|-------------|
| `flags` | [Int](/api-docs/headless/Int/) | The integer containing the bit flags  |
| `bit` | [Int](/api-docs/headless/Int/) | The bit position to modify (0-31)  |
| `bool` | [Bool](/api-docs/headless/Bool/) | True to set the bit (1), false to clear it (0)  |

| Returns | Description |
|---------|-------------|
| [Int](/api-docs/headless/Int/) | The updated flags value with the bit modified |
