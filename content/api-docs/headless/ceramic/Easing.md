...
title: Easing
target: Headless
permalink: api-docs/headless/ceramic/Easing/
---
...
|------|------|-------------|
| `x1` | [Float](/api-docs/headless/Float/) | X coordinate of first control point (0-1)  |
| `y1` | [Float](/api-docs/headless/Float/) | Y coordinate of first control point  |
| `x2` | [Float](/api-docs/headless/Float/) | X coordinate of second control point (0-1)  |
| `y2` | [Float](/api-docs/headless/Float/) | Y coordinate of second control point * ```haxe // Common bezier curves BEZIER(0.25, 0.1, 0.25, 1) // ease-out BEZIER(0.42, 0, 1, 1) // ease-in BEZIER(0.42, 0, 0.58, 1) // ease-in-out BEZIER(0.68, -0.55, 0.265, 1.55) // back ease-in-out ``` |
