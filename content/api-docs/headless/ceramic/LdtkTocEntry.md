...
title: LdtkTocEntry
target: Headless
permalink: api-docs/headless/ceramic/LdtkTocEntry/
---
...
|------|------|---------|-------------|
| `ldtkData` | [LdtkData](/api-docs/headless/ceramic/LdtkData/) | *(optional)* | The parent LdtkData object  |
| `json` | [haxe.DynamicAccess](/api-docs/headless/haxe/DynamicAccess/)<[Dynamic](/api-docs/headless/Dynamic/)> | *(optional)* | The JSON data for this entry |
