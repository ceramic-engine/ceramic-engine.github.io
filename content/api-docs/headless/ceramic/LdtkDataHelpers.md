...
target: Headless
permalink: api-docs/headless/ceramic/LdtkDataHelpers/
---
...
<div class="signature field-var no-description has-plugin" id="HIDDEN_VALUE"><div class="plugin-name">ldtk</div><code><span class="field-name">HIDDEN_VALUE</span><span class="operator">:</span> <a href="/api-docs/headless/String/" class="type-link">String</a></code><a class="header-anchor" href="#HIDDEN_VALUE"><span aria-hidden="true" class="header-anchor__symbol">#</span></a></div>
...
| Name | Type |
|------|------|
| `raw` | [Dynamic](/api-docs/headless/Dynamic/) |
