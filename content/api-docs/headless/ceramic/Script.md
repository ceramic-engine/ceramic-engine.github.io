...
title: Script
target: Headless
permalink: api-docs/headless/ceramic/Script/
---
...
<div class="type-hierarchy"><a href="/api-docs/headless/ceramic/Entity/">Entity</a> → <strong>ceramic.Script</strong> (Class)</div>
...
<div class="signature field-var has-description has-plugin" id="log"><div class="plugin-name">script</div><code><span class="field-name">log</span><span class="operator">:</span> <a href="/api-docs/headless/ceramic/Logger/" class="type-link">Logger</a></code><a class="header-anchor" href="#log"><span aria-hidden="true" class="header-anchor__symbol">#</span></a></div>
...
<div class="signature field-var no-description has-plugin" id="entity"><div class="plugin-name">script</div><code><span class="field-name">entity</span><span class="operator">:</span> <a href="/api-docs/headless/ceramic/Entity/" class="type-link">Entity</a></code><a class="header-anchor" href="#entity"><span aria-hidden="true" class="header-anchor__symbol">#</span></a></div>
...
|------|------|-------------|
| `itemId` | [String](/api-docs/headless/String/) | Entity ID to look up  |

| Returns | Description |
|---------|-------------|
| [Entity](/api-docs/headless/ceramic/Entity/) | Found entity or null |
...
| Name | Type | Description |
|------|------|-------------|
| `itemId` | [String](/api-docs/headless/String/) | ID of the entity whose script module to retrieve  |

| Returns | Description |
|---------|-------------|
| [ScriptModule](/api-docs/headless/ceramic/ScriptModule/) | Script module or null if entity has no script |
...
| Name | Type | Description |
|------|------|-------------|
| `name` | [String](/api-docs/headless/String/) | Variable name  |

| Returns | Description |
|---------|-------------|
| [Dynamic](/api-docs/headless/Dynamic/) | Variable value or null if not found |
...
|------|------|---------|-------------|
| `name` | [String](/api-docs/headless/String/) | | Function name  |
| `numArgs` | [Int](/api-docs/headless/Int/) | | Number of arguments  |
| `arg1` | [Dynamic](/api-docs/headless/Dynamic/) | *(optional)* | First argument (or array of all arguments if numArgs > 3)  |
| `arg2` | [Dynamic](/api-docs/headless/Dynamic/) | *(optional)* | Second argument  |
| `arg3` | [Dynamic](/api-docs/headless/Dynamic/) | *(optional)* | Third argument  |

| Returns | Description |
|---------|-------------|
| [Dynamic](/api-docs/headless/Dynamic/) | Function return value or null if function not found |
