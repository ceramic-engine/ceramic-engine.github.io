...
title: ConvertMap
target: Headless
permalink: api-docs/headless/ceramic/ConvertMap/
---
...
<div class="see"><strong>See:</strong> <a href="/api-docs/headless/ceramic/ConvertField/">ConvertField</a>, <a href="/api-docs/headless/ceramic/Fragment/">Fragment</a></div>
...
| `assets` | [Assets](/api-docs/headless/ceramic/Assets/) | Assets instance for resource loading (unused for maps)  |
| `basic` | [haxe.DynamicAccess](/api-docs/headless/haxe/DynamicAccess/)<ceramic.ConvertMap.T> | The DynamicAccess object to convert  |
...
| `instance` | [Entity](/api-docs/headless/ceramic/Entity/) | The entity that owns this field  |
| `field` | [String](/api-docs/headless/String/) | The name of the field being converted  |
| `value` | [Map](/api-docs/headless/Map/) | The Map instance to convert  |

| Returns | Description |
|---------|-------------|
| [haxe.DynamicAccess](/api-docs/headless/haxe/DynamicAccess/)<ceramic.ConvertMap.T> | A DynamicAccess object containing all map entries |
