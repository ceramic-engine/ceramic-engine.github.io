...
title: ConvertFont
target: Headless
permalink: api-docs/headless/ceramic/ConvertFont/
---
...
<div class="see"><strong>See:</strong> <a href="/api-docs/headless/ceramic/ConvertField/">ConvertField</a>, <a href="/api-docs/headless/ceramic/BitmapFont/">BitmapFont</a>, <a href="/api-docs/headless/ceramic/FontAsset/">FontAsset</a>, <a href="/api-docs/headless/ceramic/Fragment/">Fragment</a></div>
...
|------|------|-------------|
| `instance` | [Entity](/api-docs/headless/ceramic/Entity/) | The entity that will use this font  |
| `field` | [String](/api-docs/headless/String/) | The name of the field being converted  |
| `assets` | [Assets](/api-docs/headless/ceramic/Assets/) | Assets instance used to load the font  |
| `basic` | [String](/api-docs/headless/String/) | The font asset name to load  |
...
| Name | Type | Description |
|------|------|-------------|
| `instance` | [Entity](/api-docs/headless/ceramic/Entity/) | The entity that owns this font  |
| `field` | [String](/api-docs/headless/String/) | The name of the field being converted  |
| `value` | [BitmapFont](/api-docs/headless/ceramic/BitmapFont/) | The BitmapFont instance to convert  |

| Returns | Description |
|---------|-------------|
| [String](/api-docs/headless/String/) | The font's asset name, or null if the font or its asset is null |
