...
target: Headless
permalink: api-docs/headless/ceramic/SpineBindVisualOptions/
---
...
<div class="see"><strong>See:</strong> <a href="/api-docs/headless/ceramic/SpineBindVisual/">SpineBindVisual</a></div>


## Instance Members

<div class="signature field-var has-description has-plugin" id="drawDefault"><div class="plugin-name">spine</div><code><span class="field-name">drawDefault</span><span class="operator">:</span> <a href="/api-docs/headless/Bool/" class="type-link">Bool</a></code><a class="header-anchor" href="#drawDefault"><span aria-hidden="true" class="header-anchor__symbol">#</span></a></div>
