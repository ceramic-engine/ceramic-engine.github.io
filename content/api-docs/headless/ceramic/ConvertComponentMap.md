...
target: Headless
permalink: api-docs/headless/ceramic/ConvertComponentMap/
---
...
<div class="see"><strong>See:</strong> <a href="/api-docs/headless/ceramic/ConvertField/">ConvertField</a>, <a href="/api-docs/headless/ceramic/Component/">Component</a>, <a href="/api-docs/headless/ceramic/Fragment/">Fragment</a></div>
...
|------|------|-------------|
| `instance` | [Entity](/api-docs/headless/ceramic/Entity/) | The entity that will own these components  |
| `field` | [String](/api-docs/headless/String/) | The name of the field being converted  |
| `assets` | [Assets](/api-docs/headless/ceramic/Assets/) | Assets instance for resource loading (unused for components)  |
| `basic` | [haxe.DynamicAccess](/api-docs/headless/haxe/DynamicAccess/)<[String](/api-docs/headless/String/)> | Object mapping component names to initializer names  |
...
| Name | Type | Description |
|------|------|-------------|
| `instance` | [Entity](/api-docs/headless/ceramic/Entity/) | The entity that owns these components  |
| `field` | [String](/api-docs/headless/String/) | The name of the field being converted  |
| `value` | [Map](/api-docs/headless/Map/) | Map of component instances to serialize  |

| Returns | Description |
|---------|-------------|
| [haxe.DynamicAccess](/api-docs/headless/haxe/DynamicAccess/)<[String](/api-docs/headless/String/)> | Object mapping component names to initializer names |
