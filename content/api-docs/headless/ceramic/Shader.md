...
title: Shader
target: Headless
permalink: api-docs/headless/ceramic/Shader/
---
...
<div class="signature field-var has-description" id="backendItem"><code><span class="field-name">backendItem</span><span class="operator">:</span> <a href="/api-docs/headless/backend/Shader/" class="type-link">backend.Shader</a></code><a class="header-anchor" href="#backendItem"><span aria-hidden="true" class="header-anchor__symbol">#</span></a></div>
...
<div class="signature field-var has-description" id="asset"><code><span class="field-name">asset</span><span class="operator">:</span> <a href="/api-docs/headless/ceramic/ShaderAsset/" class="type-link">ShaderAsset</a></code><a class="header-anchor" href="#asset"><span aria-hidden="true" class="header-anchor__symbol">#</span></a></div>
...
| Returns | Description |
|---------|-------------|
| [Shader](/api-docs/headless/ceramic/Shader/) | A new shader instance with the same program but separate uniforms |
...
|------|------|-------------|
| `name` | [String](/api-docs/headless/String/) | The uniform variable name in the shader  |
| `x` | [Float](/api-docs/headless/Float/) | The x component  |
| `y` | [Float](/api-docs/headless/Float/) | The y component |
...
| `x` | [Float](/api-docs/headless/Float/) | The x component  |
| `y` | [Float](/api-docs/headless/Float/) | The y component  |
| `z` | [Float](/api-docs/headless/Float/) | The z component |
...
| `y` | [Float](/api-docs/headless/Float/) | The y component  |
| `z` | [Float](/api-docs/headless/Float/) | The z component  |
| `w` | [Float](/api-docs/headless/Float/) | The w component |
