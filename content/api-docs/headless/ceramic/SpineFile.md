...
title: SpineFile
target: Headless
permalink: api-docs/headless/ceramic/SpineFile/
---
...
<div class="type-implements"><strong>Implements:</strong> <a href="/api-docs/headless/spine/support/files/FileHandle/">spine.support.files.FileHandle</a></div>
...
| Returns | Description |
|---------|-------------|
| [String](/api-docs/headless/String/) | The complete file content as a string |
...
|------|------|-------------|
| `path` | [String](/api-docs/headless/String/) | The file path or identifier  |
| `content` | [String](/api-docs/headless/String/) | The text content of the file |
