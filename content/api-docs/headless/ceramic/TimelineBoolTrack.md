...
target: Headless
permalink: api-docs/headless/ceramic/TimelineBoolTrack/
---
...
<div class="type-hierarchy"><a href="/api-docs/headless/ceramic/Entity/">Entity</a> → <a href="/api-docs/headless/ceramic/TimelineTrack/">TimelineTrack</a> → <strong>ceramic.TimelineBoolTrack</strong> (Class)</div>
...
<div class="see"><strong>See:</strong> <a href="/api-docs/headless/ceramic/TimelineBoolKeyframe/">TimelineBoolKeyframe</a>, <a href="/api-docs/headless/ceramic/TimelineTrack/">TimelineTrack</a>, <a href="/api-docs/headless/ceramic/Timeline/">Timeline</a></div>


## Instance Members

<div class="signature field-var has-description" id="value"><code><span class="field-name">value</span><span class="operator">:</span> <a href="/api-docs/headless/Bool/" class="type-link">Bool</a></code><a class="header-anchor" href="#value"><span aria-hidden="true" class="header-anchor__symbol">#</span></a></div>
...
|------|------|---------|-------------|
| `forceChange` | [Bool](/api-docs/headless/Bool/) | `false` | If true, triggers the change event even if value hasn't changed |
...
|------|------|-------------|
| `track` | [TimelineBoolTrack](/api-docs/headless/ceramic/TimelineBoolTrack/) | This track instance (for convenience in handlers) |
