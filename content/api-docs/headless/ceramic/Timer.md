...
title: Timer
target: Headless
permalink: api-docs/headless/ceramic/Timer/
---
...
<div class="signature field-var has-description" id="now"><code><span class="field-name">now</span><span class="operator">:</span> <a href="/api-docs/headless/Float/" class="type-link">Float</a></code><a class="header-anchor" href="#now"><span aria-hidden="true" class="header-anchor__symbol">#</span></a></div>
...
<div class="signature field-var has-description" id="timestamp"><code><span class="field-name">timestamp</span><span class="operator">:</span> <a href="/api-docs/headless/Float/" class="type-link">Float</a></code><a class="header-anchor" href="#timestamp"><span aria-hidden="true" class="header-anchor__symbol">#</span></a></div>
...
<div class="signature field-var has-description" id="startTimestamp"><code><span class="field-name">startTimestamp</span><span class="operator">:</span> <a href="/api-docs/headless/Float/" class="type-link">Float</a></code><a class="header-anchor" href="#startTimestamp"><span aria-hidden="true" class="header-anchor__symbol">#</span></a></div>
...
|------|------|-------------|
| `owner` | [Null](/api-docs/headless/Null/)<[Entity](/api-docs/headless/ceramic/Entity/)> | Optional entity that owns this timer. If provided and the entity is destroyed, the timer is automatically cancelled.  |
| `seconds` | [Float](/api-docs/headless/Float/) | The delay in seconds before executing the callback  |
...
|------|------|-------------|
| `owner` | [Null](/api-docs/headless/Null/)<[Entity](/api-docs/headless/ceramic/Entity/)> | Optional entity that owns this timer. If provided and the entity is destroyed, the timer is automatically cancelled.  |
| `seconds` | [Float](/api-docs/headless/Float/) | The interval in seconds between each callback execution  |
...
<div class="signature field-var no-description" id="callbacks"><code><span class="field-name">callbacks</span><span class="operator">:</span> <a href="/api-docs/headless/Array/" class="type-link">Array</a><span class="operator">&lt;</span><a href="/api-docs/headless/ceramic/TimerCallback/" class="type-link">TimerCallback</a><span class="operator">&gt;</span></code><a class="header-anchor" href="#callbacks"><span aria-hidden="true" class="header-anchor__symbol">#</span></a></div>

<hr class="field-separator" />

<div class="signature field-var no-description" id="next"><code><span class="field-name">next</span><span class="operator">:</span> <a href="/api-docs/headless/Float/" class="type-link">Float</a></code><a class="header-anchor" href="#next"><span aria-hidden="true" class="header-anchor__symbol">#</span></a></div>
...
| Name | Type | Description |
|------|------|-------------|
| `delta` | [Float](/api-docs/headless/Float/) | The frame time delta in seconds  |
| `realDelta` | [Float](/api-docs/headless/Float/) | The real time delta in seconds (unaffected by time scale) |
...
| Name | Type | Description |
|------|------|-------------|
| `owner` | [Entity](/api-docs/headless/ceramic/Entity/) | The entity that owns this timer (for auto-cleanup)  |
| `seconds` | [Float](/api-docs/headless/Float/) | Initial delay before first execution  |
| `callback` | Function | The function to execute  |
| `interval` | [Float](/api-docs/headless/Float/) | For repeating timers, the interval between executions. -1 for one-shot timers.  |
