...
title: Http
target: Headless
permalink: api-docs/headless/ceramic/Http/
---
...
|------|------|-------------|
| `options` | [HttpRequestOptions](/api-docs/headless/ceramic/HttpRequestOptions/) | The HTTP request configuration including URL, method, headers, parameters, and timeout  |
