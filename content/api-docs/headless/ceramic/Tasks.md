...
title: Tasks
target: Headless
permalink: api-docs/headless/ceramic/Tasks/
---
...
<div class="signature field-method has-description" id="runFromArgs"><code><span class="field-name">runFromArgs</span><span class="parenthesis">(</span><span class="parenthesis">)</span><span class="operator">:</span> <a href="/api-docs/headless/Void/" class="type-link">Void</a></code><a class="header-anchor" href="#runFromArgs"><span aria-hidden="true" class="header-anchor__symbol">#</span></a></div>
