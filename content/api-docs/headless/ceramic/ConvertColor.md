...
title: ConvertColor
target: Headless
permalink: api-docs/headless/ceramic/ConvertColor/
---
...
<div class="see"><strong>See:</strong> <a href="/api-docs/headless/ceramic/ConvertField/">ConvertField</a>, <a href="/api-docs/headless/ceramic/Color/">Color</a>, <a href="/api-docs/headless/ceramic/Fragment/">Fragment</a></div>


## Instance Members

<div class="signature field-var has-description" id="preferStringBasic"><code><span class="field-name">preferStringBasic</span><span class="operator">:</span> <a href="/api-docs/headless/Bool/" class="type-link">Bool</a></code><a class="header-anchor" href="#preferStringBasic"><span aria-hidden="true" class="header-anchor__symbol">#</span></a></div>
...
| `assets` | [Assets](/api-docs/headless/ceramic/Assets/) | Assets instance for resource loading (unused for colors)  |
| `basic` | [Any](/api-docs/headless/Any/) | The source value to convert (string or number)  |
| `done` | Function | Callback invoked with the converted Color instance |

<hr class="field-separator" />

<div class="signature field-method has-description" id="fieldToBasic"><code><span class="field-name">fieldToBasic</span><span class="parenthesis">(</span><span class="arg-name">instance</span><span class="operator">:</span> <a href="/api-docs/headless/ceramic/Entity/" class="type-link">Entity</a><span class="operator">,</span> <span class="arg-name">field</span><span class="operator">:</span> <a href="/api-docs/headless/String/" class="type-link">String</a><span class="operator">,</span> <span class="arg-name">value</span><span class="operator">:</span> <a href="/api-docs/headless/ceramic/Color/" class="type-link">Color</a><span class="parenthesis">)</span><span class="operator">:</span> <a href="/api-docs/headless/Any/" class="type-link">Any</a></code><a class="header-anchor" href="#fieldToBasic"><span aria-hidden="true" class="header-anchor__symbol">#</span></a></div>
...
| `instance` | [Entity](/api-docs/headless/ceramic/Entity/) | The entity that owns this field  |
| `field` | [String](/api-docs/headless/String/) | The name of the field being converted  |
| `value` | [Color](/api-docs/headless/ceramic/Color/) | The Color instance to convert  |

| Returns | Description |
|---------|-------------|
| [Any](/api-docs/headless/Any/) | Either a web color string or numeric value |
