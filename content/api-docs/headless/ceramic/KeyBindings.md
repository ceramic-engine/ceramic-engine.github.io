...
title: KeyBindings
target: Headless
permalink: api-docs/headless/ceramic/KeyBindings/
---
...
<div class="type-hierarchy"><a href="/api-docs/headless/ceramic/Entity/">Entity</a> → <strong>ceramic.KeyBindings</strong> (Class)</div>
...
<div class="see"><strong>See:</strong> <a href="/api-docs/headless/ceramic/KeyBinding/">KeyBinding</a>, <a href="/api-docs/headless/ceramic/KeyAcceleratorItem/">KeyAcceleratorItem</a></div>
...
|------|------|---------|-------------|
| `accelerator` | [Array](/api-docs/headless/Array/)<Anonymous> | | Array of keys that must be pressed together. Order doesn't matter for modifier keys.  |
...
| Returns | Description |
|---------|-------------|
| [KeyBinding](/api-docs/headless/ceramic/KeyBinding/) | The created KeyBinding instance |
