...
title: LowRes
target: Headless
permalink: api-docs/headless/ceramic/LowRes/
---
...
<div class="type-hierarchy"><a href="/api-docs/headless/ceramic/Entity/">Entity</a> → <a href="/api-docs/headless/ceramic/Visual/">Visual</a> → <a href="/api-docs/headless/ceramic/Quad/">Quad</a> → <a href="/api-docs/headless/ceramic/Layer/">Layer</a> → <strong>ceramic.LowRes</strong> (Class)</div>
...
<div class="signature field-var has-description" id="pixelArt"><code><span class="field-name">pixelArt</span><span class="operator">:</span> <a href="/api-docs/headless/ceramic/PixelArt/" class="type-link">PixelArt</a></code><a class="header-anchor" href="#pixelArt"><span aria-hidden="true" class="header-anchor__symbol">#</span></a></div>
...
|------|------|-------------|
| `width` | [Float](/api-docs/headless/Float/) | New width in pixels  |
| `height` | [Float](/api-docs/headless/Float/) | New height in pixels |
