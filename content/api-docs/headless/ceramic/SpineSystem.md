...
title: SpineSystem
target: Headless
permalink: api-docs/headless/ceramic/SpineSystem/
---
...
<div class="type-hierarchy"><a href="/api-docs/headless/ceramic/Entity/">Entity</a> → <a href="/api-docs/headless/ceramic/System/">System</a> → <strong>ceramic.SpineSystem</strong> (Class)</div>
...
|------|------|-------------|
| `delta` | [Float](/api-docs/headless/Float/) | Time elapsed since the last frame in seconds |
