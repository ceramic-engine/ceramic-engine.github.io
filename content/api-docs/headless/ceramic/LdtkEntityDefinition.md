...
target: Headless
permalink: api-docs/headless/ceramic/LdtkEntityDefinition/
---
...
|------|------|-------------|
| `renderMode` | [LdtkRenderMode](/api-docs/headless/ceramic/LdtkRenderMode/) | The render mode we want to test  |
...
| Returns |
|---------|
| [LdtkFieldDefinition](/api-docs/headless/ceramic/LdtkFieldDefinition/) |
