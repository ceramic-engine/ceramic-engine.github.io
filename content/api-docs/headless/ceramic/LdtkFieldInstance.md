...
target: Headless
permalink: api-docs/headless/ceramic/LdtkFieldInstance/
---
...
<div class="signature field-var has-description has-plugin" id="tile"><div class="plugin-name">ldtk</div><code><span class="field-name">tile</span><span class="operator">:</span> <a href="/api-docs/headless/ceramic/LdtkTilesetRectangle/" class="type-link">LdtkTilesetRectangle</a></code><a class="header-anchor" href="#tile"><span aria-hidden="true" class="header-anchor__symbol">#</span></a></div>
...
| `ldtkData` | [LdtkData](/api-docs/headless/ceramic/LdtkData/) | *(optional)* |
| `ldtkWorld` | [LdtkWorld](/api-docs/headless/ceramic/LdtkWorld/) | *(optional)* |
| `rawValue` | [Any](/api-docs/headless/Any/) | *(optional)* |
