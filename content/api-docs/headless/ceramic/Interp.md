...
title: Interp
target: Headless
permalink: api-docs/headless/ceramic/Interp/
---
...
<div class="type-hierarchy"><a href="/api-docs/headless/hscript/Interp/">hscript.Interp</a> → <strong>ceramic.Interp</strong> (Class)</div>
...
|------|------|-------------|
| `owner` | [Script](/api-docs/headless/ceramic/Script/) | Script that owns this interpreter |
...
| Name | Type | Description |
|------|------|-------------|
| `o` | [Dynamic](/api-docs/headless/Dynamic/) | Object to call method on  |
| `f` | [String](/api-docs/headless/String/) | Function name  |
| `args` | [Array](/api-docs/headless/Array/)<[Dynamic](/api-docs/headless/Dynamic/)> | Function arguments  |

| Returns | Description |
|---------|-------------|
| [Dynamic](/api-docs/headless/Dynamic/) | Function result |
...
| Name | Type | Description |
|------|------|-------------|
| `o` | [Dynamic](/api-docs/headless/Dynamic/) | Object to get field from  |
| `f` | [String](/api-docs/headless/String/) | Field name  |

| Returns | Description |
|---------|-------------|
| [Dynamic](/api-docs/headless/Dynamic/) | Field value |
...
| Name | Type | Description |
|------|------|-------------|
| `cl` | [String](/api-docs/headless/String/) | Class name  |
| `args` | [Array](/api-docs/headless/Array/)<[Dynamic](/api-docs/headless/Dynamic/)> | Constructor arguments  |

| Returns | Description |
|---------|-------------|
| [Dynamic](/api-docs/headless/Dynamic/) | New instance |
...
| Name | Type | Description |
|------|------|-------------|
| `e` | [hscript.Expr](/api-docs/headless/hscript/Expr/) | Expression to evaluate  |

| Returns | Description |
|---------|-------------|
| [Dynamic](/api-docs/headless/Dynamic/) | Expression result or null if error |
