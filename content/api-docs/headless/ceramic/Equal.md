...
title: Equal
target: Headless
permalink: api-docs/headless/ceramic/Equal/
---
...
| Returns | Description |
|---------|-------------|
| [Bool](/api-docs/headless/Bool/) | True if values are deeply equal, false otherwise * ```haxe // Simple values Equal.equal(5, 5); // true Equal.equal("hello", "hello"); // true * // Arrays Equal.equal([1, 2, 3], [1, 2, 3]); // true Equal.equal([1, 2], [1, 2, 3]); // false * // Objects Equal.equal( {name: "John", age: 30}, {name: "John", age: 30} ); // true ``` |
...
| Name | Type | Description |
|------|------|-------------|
| `a` | [Any](/api-docs/headless/Any/) | First object to compare  |
| `b` | [Any](/api-docs/headless/Any/) | Second object to compare  |

| Returns | Description |
|---------|-------------|
| [Bool](/api-docs/headless/Bool/) | True if all fields match, false otherwise * ```haxe var obj1 = {x: 10, y: {z: 20}}; var obj2 = {x: 10, y: {z: 20}}; Equal.objectFieldsEqual(obj1, obj2); // true * var obj3 = {x: 10, y: 20, extra: true}; Equal.objectFieldsEqual(obj1, obj3); // false (different fields) ``` |
...
| Name | Type | Description |
|------|------|-------------|
| `a` | [Array](/api-docs/headless/Array/)<[Any](/api-docs/headless/Any/)> | First array  |
| `b` | [Array](/api-docs/headless/Array/)<[Any](/api-docs/headless/Any/)> | Second array  |

| Returns | Description |
|---------|-------------|
| [Bool](/api-docs/headless/Bool/) | True if arrays are equal |
...
| Name | Type | Description |
|------|------|-------------|
| `a` | [haxe.ds.StringMap](/api-docs/headless/haxe/ds/StringMap/)<[Any](/api-docs/headless/Any/)> | First StringMap  |
| `b` | [haxe.ds.StringMap](/api-docs/headless/haxe/ds/StringMap/)<[Any](/api-docs/headless/Any/)> | Second StringMap  |

| Returns | Description |
|---------|-------------|
| [Bool](/api-docs/headless/Bool/) | True if maps have identical key-value pairs * ```haxe var map1 = new StringMap<Int>(); map1.set("a", 1); map1.set("b", 2); * var map2 = new StringMap<Int>(); map2.set("b", 2); map2.set("a", 1); * Equal.stringMapEqual(map1, map2); // true (order doesn't matter) ``` |
...
| Name | Type | Description |
|------|------|-------------|
| `a` | [haxe.ds.IntMap](/api-docs/headless/haxe/ds/IntMap/)<[Any](/api-docs/headless/Any/)> | First IntMap  |
| `b` | [haxe.ds.IntMap](/api-docs/headless/haxe/ds/IntMap/)<[Any](/api-docs/headless/Any/)> | Second IntMap  |

| Returns | Description |
|---------|-------------|
| [Bool](/api-docs/headless/Bool/) | True if maps have identical key-value pairs * ```haxe var map1 = new IntMap<String>(); map1.set(1, "one"); map1.set(2, "two"); * var map2 = new IntMap<String>(); map2.set(2, "two"); map2.set(1, "one"); * Equal.intMapEqual(map1, map2); // true ``` |
