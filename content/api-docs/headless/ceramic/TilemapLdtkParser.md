...
target: Headless
permalink: api-docs/headless/ceramic/TilemapLdtkParser/
---
...
<div class="see"><strong>See:</strong> <a href="/api-docs/headless/ceramic/LdtkData/">LdtkData</a>, <a href="/api-docs/headless/ceramic/Tilemap/">Tilemap</a></div>
...
|------|------|-------------|
| `rawLdtkData` | [String](/api-docs/headless/String/) | The raw JSON string from an LDtk project file  |
| `loadExternalLdtkLevelData` | Function | Callback to load external level files (for multi-file projects)  |

| Returns | Description |
|---------|-------------|
| [LdtkData](/api-docs/headless/ceramic/LdtkData/) | The parsed LdtkData object, or null if parsing fails |
...
| Name | Type | Description |
|------|------|-------------|
| `level` | [LdtkLevel](/api-docs/headless/ceramic/LdtkLevel/) | The LDtk level to convert |
...
| Name | Type | Description |
|------|------|-------------|
| `ldtkTiles` | [Array](/api-docs/headless/Array/)<[Int](/api-docs/headless/Int/)> | Raw tile data from LDtk (7 integers per tile)  |
| `tileset` | [LdtkTilesetDefinition](/api-docs/headless/ceramic/LdtkTilesetDefinition/) | The tileset definition for GID mapping  |
| `cols` | [Int](/api-docs/headless/Int/) | Number of columns in the layer  |
| `rows` | [Int](/api-docs/headless/Int/) | Number of rows in the layer  |
| `gridSize` | [Int](/api-docs/headless/Int/) | The grid cell size in pixels  |
| `tilesAlpha` | [Array](/api-docs/headless/Array/)<[Float](/api-docs/headless/Float/)> | Output array for tile alpha values  |
| `tilesOffsetX` | [Array](/api-docs/headless/Array/)<[Int](/api-docs/headless/Int/)> | Output array for tile X offsets  |
| `tilesOffsetY` | [Array](/api-docs/headless/Array/)<[Int](/api-docs/headless/Int/)> | Output array for tile Y offsets  |

| Returns | Description |
|---------|-------------|
| [Array](/api-docs/headless/Array/)<[TilemapTile](/api-docs/headless/ceramic/TilemapTile/)> | Array of TilemapTile objects, or null if no tiles |
