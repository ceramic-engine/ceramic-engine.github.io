...
target: Headless
permalink: api-docs/headless/ceramic/ShaderAttribute/
---
...
<div class="see"><strong>See:</strong> <a href="/api-docs/headless/ceramic/Shader/">Shader</a>, <a href="/api-docs/headless/ceramic/Mesh/">Mesh</a></div>
...
|------|------|-------------|
| `size` | [Int](/api-docs/headless/Int/) | Number of components (1-4)  |
| `name` | [String](/api-docs/headless/String/) | Attribute name in shader code |
