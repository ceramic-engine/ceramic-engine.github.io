...
title: ConvertArray
target: Headless
permalink: api-docs/headless/ceramic/ConvertArray/
---
...
| `assets` | [Assets](/api-docs/headless/ceramic/Assets/) | Assets instance for resource loading (unused for arrays)  |
| `basic` | [Array](/api-docs/headless/Array/)<ceramic.ConvertArray.T> | The source array to convert  |
...
| `instance` | [Entity](/api-docs/headless/ceramic/Entity/) | The entity that owns this field  |
| `field` | [String](/api-docs/headless/String/) | The name of the field being converted  |
| `value` | [Array](/api-docs/headless/Array/)<ceramic.ConvertArray.T> | The field array to convert  |

| Returns | Description |
|---------|-------------|
| [Array](/api-docs/headless/Array/)<ceramic.ConvertArray.T> | A new array containing copies of all elements |
