...
title: LdtkVisual
target: Headless
permalink: api-docs/headless/ceramic/LdtkVisual/
---
...
<div class="type-hierarchy"><a href="/api-docs/headless/ceramic/Entity/">Entity</a> → <a href="/api-docs/headless/ceramic/Visual/">Visual</a> → <a href="/api-docs/headless/ceramic/Quad/">Quad</a> → <strong>ceramic.LdtkVisual</strong> (Class)</div>
...
<div class="see"><strong>See:</strong> <a href="/api-docs/headless/ceramic/LdtkEntityInstance/">LdtkEntityInstance</a></div>


## Instance Members

<div class="signature field-var has-description has-plugin" id="ldtkEntity"><div class="plugin-name">ldtk</div><code><span class="field-name">ldtkEntity</span><span class="operator">:</span> <a href="/api-docs/headless/ceramic/LdtkEntityInstance/" class="type-link">LdtkEntityInstance</a></code><a class="header-anchor" href="#ldtkEntity"><span aria-hidden="true" class="header-anchor__symbol">#</span></a></div>
...
|------|------|-------------|
| `ldtkEntity` | [LdtkEntityInstance](/api-docs/headless/ceramic/LdtkEntityInstance/) | The LDtk entity instance to visualize |

## Private Members

<div class="signature field-method has-description has-plugin" id="setup"><div class="plugin-name">ldtk</div><code><span class="field-name">setup</span><span class="parenthesis">(</span><span class="parenthesis">)</span><span class="operator">:</span> <a href="/api-docs/headless/Void/" class="type-link">Void</a></code><a class="header-anchor" href="#setup"><span aria-hidden="true" class="header-anchor__symbol">#</span></a></div>
