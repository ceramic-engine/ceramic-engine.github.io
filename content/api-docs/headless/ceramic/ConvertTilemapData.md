...
target: Headless
permalink: api-docs/headless/ceramic/ConvertTilemapData/
---
...
|------|------|-------------|
| `instance` | [Entity](/api-docs/headless/ceramic/Entity/) | The entity that owns the field being converted  |
...
| `basic` | [String](/api-docs/headless/String/) | The tilemap asset name to load  |
...
| `instance` | [Entity](/api-docs/headless/ceramic/Entity/) | The entity that owns the field being converted  |
| `field` | [String](/api-docs/headless/String/) | The name of the field being converted  |
| `value` | [TilemapData](/api-docs/headless/ceramic/TilemapData/) | The TilemapData instance to convert  |

| Returns | Description |
|---------|-------------|
| [String](/api-docs/headless/String/) | The asset name string, or null if the data has no associated asset |
