...
title: Rect
target: Headless
permalink: api-docs/headless/ceramic/Rect/
---
...
|------|------|---------|-------------|
| `x` | [Float](/api-docs/headless/Float/) | `0` | The X coordinate of the top-left corner (default: 0)  |
| `y` | [Float](/api-docs/headless/Float/) | `0` | The Y coordinate of the top-left corner (default: 0)  |
| `width` | [Float](/api-docs/headless/Float/) | `0` | The width of the rectangle (default: 0)  |
| `height` | [Float](/api-docs/headless/Float/) | `0` | The height of the rectangle (default: 0) |
...
| Returns | Description |
|---------|-------------|
| [String](/api-docs/headless/String/) | String representation of the rectangle |
