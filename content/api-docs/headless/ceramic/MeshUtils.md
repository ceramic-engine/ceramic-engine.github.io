...
title: MeshUtils
target: Headless
permalink: api-docs/headless/ceramic/MeshUtils/
---
...
|------|------|---------|-------------|
| `vertices` | [Array](/api-docs/headless/Array/)<[Float](/api-docs/headless/Float/)> | *(optional)* | Existing array to reuse, or null to create new array. If provided and larger than needed, will be truncated.  |
| `columns` | [Int](/api-docs/headless/Int/) | | Number of columns in the grid (cells, not vertices)  |
| `rows` | [Int](/api-docs/headless/Int/) | | Number of rows in the grid (cells, not vertices)  |
...
| `staggerX` | [Float](/api-docs/headless/Float/) | `0` | Horizontal offset applied to odd-numbered rows. Use cellWidth*0.5 for hexagonal grids.  |
| `staggerY` | [Float](/api-docs/headless/Float/) | `0` | Vertical offset applied to odd-numbered columns. Rarely used, but can create diamond patterns.  |
| `attrLength` | [Int](/api-docs/headless/Int/) | `0` | Number of custom float attributes per vertex. Common values: 2 for UV, 4 for color, etc.  |
| `attrValues` | [Array](/api-docs/headless/Array/)<[Float](/api-docs/headless/Float/)> | *(optional)* | Array of attribute values to assign. If null, attributes are initialized to 0. Length must equal (columns+1)×(rows+1)×attrLength.  |

| Returns | Description |
|---------|-------------|
| [Array](/api-docs/headless/Array/)<[Float](/api-docs/headless/Float/)> | Array of vertex data with length (columns+1)×(rows+1)×(2+attrLength) * ```haxe // Simple 10x10 grid var vertices = MeshUtils.createVerticesGrid(null, 10, 10, 400, 400); * // Hexagonal grid with horizontal stagger var cellWidth = 40; var vertices = MeshUtils.createVerticesGrid( null, 10, 10, 400, 400, cellWidth * 0.5, 0 ); * // Grid with per-vertex colors (4 floats: r,g,b,a) var colors = [ // color data ]; var vertices = MeshUtils.createVerticesGrid( null, 10, 10, 400, 400, 0, 0, 4, colors ); ``` |
...
| Name | Type | Default | Description |
|------|------|---------|-------------|
| `vertices32` | [Null](/api-docs/headless/Null/)<[Float32Array](/api-docs/headless/ceramic/Float32Array/)> | *(optional)* | Existing Float32Array to reuse, or null to create new array.  |
| `columns` | [Int](/api-docs/headless/Int/) | | Number of columns in the grid (cells, not vertices)  |
| `rows` | [Int](/api-docs/headless/Int/) | | Number of rows in the grid (cells, not vertices)  |
| `width` | [Float](/api-docs/headless/Float/) | | Total width of the grid in pixels  |
| `height` | [Float](/api-docs/headless/Float/) | | Total height of the grid in pixels  |
| `staggerX` | [Float](/api-docs/headless/Float/) | `0` | Horizontal offset applied to odd-numbered rows.  |
| `staggerY` | [Float](/api-docs/headless/Float/) | `0` | Vertical offset applied to odd-numbered columns.  |
| `attrLength` | [Int](/api-docs/headless/Int/) | `0` | Number of custom float attributes per vertex.  |
| `attrValues` | [Array](/api-docs/headless/Array/)<[Float](/api-docs/headless/Float/)> | *(optional)* | Array of attribute values to assign.  |

| Returns | Description |
|---------|-------------|
| [Float32Array](/api-docs/headless/ceramic/Float32Array/) | Float32Array of vertex data with length (columns+1)×(rows+1)×(2+attrLength) * ```haxe // Simple 10x10 grid with Float32Array var vertices32 = MeshUtils.createVertices32Grid(null, 10, 10, 400, 400); ``` |
...
| Name | Type | Default | Description |
|------|------|---------|-------------|
| `indices` | [Array](/api-docs/headless/Array/)<[Int](/api-docs/headless/Int/)> | *(optional)* | Existing array to reuse, or null to create new array. If provided and larger than needed, will be truncated.  |
| `columns` | [Int](/api-docs/headless/Int/) | | Number of columns in the grid (cells, not vertices)  |
| `rows` | [Int](/api-docs/headless/Int/) | | Number of rows in the grid (cells, not vertices)  |
| `mirrorX` | [Bool](/api-docs/headless/Bool/) | `false` | Mirror triangle diagonal in odd-numbered columns. Creates horizontal alternation pattern.  |
| `mirrorY` | [Bool](/api-docs/headless/Bool/) | `false` | Mirror triangle diagonal in odd-numbered rows. Creates vertical alternation pattern.  |
| `mirrorFlip` | [Bool](/api-docs/headless/Bool/) | `false` | Inverts the mirroring pattern. If true, mirrors even cells instead of odd.  |

| Returns | Description |
|---------|-------------|
| [Array](/api-docs/headless/Array/)<[Int](/api-docs/headless/Int/)> | Array of indices with length columns×rows×6 (2 triangles × 3 vertices per cell) * ```haxe // Standard grid triangulation var indices = MeshUtils.createIndicesGrid(null, 10, 10); * // Alternating pattern for natural terrain var indices = MeshUtils.createIndicesGrid( null, 10, 10, true, true // Mirror both X and Y ); * // Custom pattern with flipped mirroring var indices = MeshUtils.createIndicesGrid( null, 10, 10, true, false, true // Mirror X on even columns ); ``` |
...
| Name | Type | Default | Description |
|------|------|---------|-------------|
| `uvs` | [Array](/api-docs/headless/Array/)<[Float](/api-docs/headless/Float/)> | *(optional)* | Existing array to reuse, or null to create new array. If provided and larger than needed, will be truncated.  |
| `columns` | [Int](/api-docs/headless/Int/) | | Number of columns in the grid (cells, not vertices)  |
| `rows` | [Int](/api-docs/headless/Int/) | | Number of rows in the grid (cells, not vertices)  |
| `offsetX` | [Float](/api-docs/headless/Float/) | `0` | Horizontal UV offset for texture scrolling. Values > 1 create tiling if texture wrap is enabled.  |
| `offsetY` | [Float](/api-docs/headless/Float/) | `0` | Vertical UV offset for texture scrolling. Values > 1 create tiling if texture wrap is enabled.  |

| Returns | Description |
|---------|-------------|
| [Array](/api-docs/headless/Array/)<[Float](/api-docs/headless/Float/)> | Array of UV coordinates with length (columns+1)×(rows+1)×2 * ```haxe // Standard UV mapping (texture stretched across grid) var uvs = MeshUtils.createUVsGrid(null, 10, 10); * // Scrolling texture effect var uvs = MeshUtils.createUVsGrid( null, 10, 10, time * 0.1, 0 // Scroll horizontally over time ); * // Tiled texture (requires texture wrap mode) var uvs = MeshUtils.createUVsGrid( null, 10, 10, 0, 0 // UVs will go from 0 to 1 ); // Then scale UVs by tile count in shader or modify here ``` |
