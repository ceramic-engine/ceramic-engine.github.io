...
target: Headless
permalink: api-docs/headless/ceramic/ConvertTexture/
---
...
<div class="see"><strong>See:</strong> <a href="/api-docs/headless/ceramic/ConvertField/">ConvertField</a>, <a href="/api-docs/headless/ceramic/Texture/">Texture</a>, <a href="/api-docs/headless/ceramic/ImageAsset/">ImageAsset</a>, <a href="/api-docs/headless/ceramic/Fragment/">Fragment</a></div>
...
|------|------|-------------|
| `instance` | [Entity](/api-docs/headless/ceramic/Entity/) | The entity that will use this texture  |
| `field` | [String](/api-docs/headless/String/) | The name of the field being converted  |
| `assets` | [Assets](/api-docs/headless/ceramic/Assets/) | Assets instance used to load the image  |
| `basic` | [String](/api-docs/headless/String/) | The image asset name to load  |
...
| Name | Type | Description |
|------|------|-------------|
| `instance` | [Entity](/api-docs/headless/ceramic/Entity/) | The entity that owns this texture  |
| `field` | [String](/api-docs/headless/String/) | The name of the field being converted  |
| `value` | [Texture](/api-docs/headless/ceramic/Texture/) | The Texture instance to convert  |

| Returns | Description |
|---------|-------------|
| [String](/api-docs/headless/String/) | The texture's asset name, or null if the texture or its asset is null |
