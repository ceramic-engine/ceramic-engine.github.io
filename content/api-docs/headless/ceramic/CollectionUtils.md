...
target: Headless
permalink: api-docs/headless/ceramic/CollectionUtils/
---
...
|------|------|-------------|
| `array` | [Array](/api-docs/headless/Array/)<toCollection.T> | The array to convert  |

| Returns | Description |
|---------|-------------|
| [Collection](/api-docs/headless/ceramic/Collection/)<[ValueEntry](/api-docs/headless/ceramic/ValueEntry/)<toCollection.T>> | A new Collection containing the array elements |
...
|------|------|---------|-------------|
| `collection` | [Collection](/api-docs/headless/ceramic/Collection/)<filtered.T> | | The source collection to filter  |
| `filter` | Function | | Function that filters the entries array  |
| `cacheKey` | [String](/api-docs/headless/String/) | *(optional)* | Optional key to cache and reuse the filtered collection  |

| Returns | Description |
|---------|-------------|
| [Collection](/api-docs/headless/ceramic/Collection/)<filtered.T> | A filtered collection that updates with the source |
...
| Name | Type | Default | Description |
|------|------|---------|-------------|
| `collections` | [Array](/api-docs/headless/Array/)<[Collection](/api-docs/headless/ceramic/Collection/)<combined.T>> | | Array of collections to combine  |
| `cache` | [Bool](/api-docs/headless/Bool/) | `true` | Whether to cache the combined collection (default: true)  |

| Returns | Description |
|---------|-------------|
| [Collection](/api-docs/headless/ceramic/Collection/)<combined.T> | A collection containing all entries from all source collections |
