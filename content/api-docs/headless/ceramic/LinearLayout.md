...
title: LinearLayout
target: Headless
permalink: api-docs/headless/ceramic/LinearLayout/
---
...
<div class="see"><strong>See:</strong> <a href="/api-docs/headless/ceramic/ChildrenDepth/">ChildrenDepth</a></div>
...
| `parentLayoutMask` | [ViewLayoutMask](/api-docs/headless/ceramic/ViewLayoutMask/) | Constraints from parent layout  |
| `persist` | [Bool](/api-docs/headless/Bool/) | Whether to save computed sizes for layout phase |
