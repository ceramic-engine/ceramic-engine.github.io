...
title: Preloadable
target: Headless
permalink: api-docs/headless/ceramic/Preloadable/
---
...
<div class="type-hierarchy"><strong>ceramic.Preloadable</strong> (Interface) → <a href="/api-docs/headless/ceramic/Scene/">Scene</a></div>
...
<div class="see"><strong>See:</strong> <a href="/api-docs/headless/ceramic/Preloader/">Preloader</a>, <a href="/api-docs/headless/ceramic/PreloadStatus/">PreloadStatus</a></div>


## Instance Members

<div class="signature field-method has-description" id="requestPreloadUpdate"><code><span class="field-name">requestPreloadUpdate</span><span class="parenthesis">(</span><span class="arg-name">updatePreload</span><span class="operator">:</span> <span class="type-name">Function</span><span class="parenthesis">)</span><span class="operator">:</span> <a href="/api-docs/headless/Void/" class="type-link">Void</a></code><a class="header-anchor" href="#requestPreloadUpdate"><span aria-hidden="true" class="header-anchor__symbol">#</span></a></div>
