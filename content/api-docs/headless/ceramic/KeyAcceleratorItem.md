...
target: Headless
permalink: api-docs/headless/ceramic/KeyAcceleratorItem/
---
...
<div class="see"><strong>See:</strong> <a href="/api-docs/headless/ceramic/KeyBinding/">KeyBinding</a>, <a href="/api-docs/headless/ceramic/KeyBindings/">KeyBindings</a></div>
...
|------|------|-------------|
| `scanCode` | [ceramic.ScanCode](/api-docs/headless/ceramic/ScanCode/) | The scan code of the key |
...
| Name | Type | Description |
|------|------|-------------|
| `keyCode` | [ceramic.KeyCode](/api-docs/headless/ceramic/KeyCode/) | The key code of the key |
