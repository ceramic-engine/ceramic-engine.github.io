...
target: Headless
permalink: api-docs/headless/ceramic/ConvertSpineData/
---
...
<div class="see"><strong>See:</strong> <a href="/api-docs/headless/ceramic/SpineData/">SpineData</a>, <a href="/api-docs/headless/ceramic/SpineAsset/">SpineAsset</a>, <a href="/api-docs/headless/ceramic/ConvertField/">ConvertField</a></div>
...
|------|------|-------------|
| `instance` | [Entity](/api-docs/headless/ceramic/Entity/) | The entity instance that owns the field  |
| `field` | [String](/api-docs/headless/String/) | The name of the field being converted  |
| `assets` | [Assets](/api-docs/headless/ceramic/Assets/) | The asset manager used to load the Spine asset  |
| `basic` | [String](/api-docs/headless/String/) | The string value (asset name) to convert from  |
...
| `instance` | [Entity](/api-docs/headless/ceramic/Entity/) | The entity instance that owns the field  |
| `field` | [String](/api-docs/headless/String/) | The name of the field being converted  |
| `value` | [SpineData](/api-docs/headless/ceramic/SpineData/) | The SpineData value to convert  |

| Returns | Description |
|---------|-------------|
| [String](/api-docs/headless/String/) | The asset name string, or null if the SpineData has no associated asset |
