...
title: ScriptUtils
target: Headless
permalink: api-docs/headless/ceramic/ScriptUtils/
---
...
|------|------|-------------|
| `code` | [String](/api-docs/headless/String/) | Source code with JS/TS syntax  |

| Returns | Description |
|---------|-------------|
| [String](/api-docs/headless/String/) | Equivalent HScript code |
...
| Name | Type | Description |
|------|------|-------------|
| `code` | [String](/api-docs/headless/String/) | Raw JS/TS code  |

| Returns | Description |
|---------|-------------|
| [String](/api-docs/headless/String/) | Cleaned code with basic conversions |
...
| Name | Type | Description |
|------|------|-------------|
| `error` | [Dynamic](/api-docs/headless/Dynamic/) | Error message  |
| `i` | [Int](/api-docs/headless/Int/) | Character position where error occurred  |
| `code` | [String](/api-docs/headless/String/) | Full source code |
