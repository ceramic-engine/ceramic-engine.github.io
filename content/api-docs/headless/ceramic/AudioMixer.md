...
title: AudioMixer
target: Headless
permalink: api-docs/headless/ceramic/AudioMixer/
---
...
<div class="type-hierarchy"><a href="/api-docs/headless/ceramic/Entity/">Entity</a> → <strong>ceramic.AudioMixer</strong> (Class)</div>
...
<div class="see"><strong>See:</strong> <a href="/api-docs/headless/ceramic/Audio/">Audio</a>, <a href="/api-docs/headless/ceramic/Sound/">Sound</a></div>
...
<div class="signature field-var has-description" id="mute"><code><span class="field-name">mute</span><span class="operator">:</span> <a href="/api-docs/headless/Bool/" class="type-link">Bool</a></code><a class="header-anchor" href="#mute"><span aria-hidden="true" class="header-anchor__symbol">#</span></a></div>
...
|------|------|-------------|
| `index` | [Int](/api-docs/headless/Int/) | The group index for this mixer |
