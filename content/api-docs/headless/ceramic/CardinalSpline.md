...
target: Headless
permalink: api-docs/headless/ceramic/CardinalSpline/
---
...
|------|------|---------|-------------|
| `points` | [Array](/api-docs/headless/Array/)<[Float](/api-docs/headless/Float/)> | | Point array containing at least 2 points (4 values). Format: [x1, y1, x2, y2, ..., xn, yn]  |
| `tension` | [Float](/api-docs/headless/Float/) | `0.5` | Curve tension parameter. Default: 0.5 - 0.0 = sharp corners (Catmull-Rom spline) - 0.5 = balanced curve - 1.0 = loose curve - Can exceed [0,1] for special effects  |
| `numSegments` | [Int](/api-docs/headless/Int/) | `25` | Number of interpolated points between each pair of control points. Higher values create smoother curves. Default: 25  |
| `close` | [Bool](/api-docs/headless/Bool/) | `false` | Whether to connect the last point back to the first, creating a closed loop. Default: false  |
| `result` | [Array](/api-docs/headless/Array/)<[Float](/api-docs/headless/Float/)> | *(optional)* | Optional array to store results in (avoids allocation). Will be resized as needed.  |

| Returns | Description |
|---------|-------------|
| [Null](/api-docs/headless/Null/)<[Array](/api-docs/headless/Array/)<[Float](/api-docs/headless/Float/)>> | Array containing interpolated points [x1,y1, x2,y2, ...] Length = (numPoints-1) * numSegments * 2 + 2 (+ extra for closed) * ```haxe // Create a smooth curve through 4 points var controlPoints = [ 100, 100, // Point 1 200, 50, // Point 2 300, 150, // Point 3 400, 100 // Point 4 ]; * var smoothCurve = CardinalSpline.getCurvePoints( controlPoints, 0.5, // Medium tension 30 // 30 segments between points ); ``` |
...
|------|------|-------------|
| `pts` | [Array](/api-docs/headless/Array/)<[Float](/api-docs/headless/Float/)> | Extended point array with duplicated endpoints  |
| `cache` | [Array](/api-docs/headless/Array/)<[Float](/api-docs/headless/Float/)> | Pre-calculated hermite basis function values  |
| `l` | [Int](/api-docs/headless/Int/) | Original point array length  |
| `tension` | [Float](/api-docs/headless/Float/) | Spline tension parameter  |
| `numSegments` | [Int](/api-docs/headless/Int/) | Segments between control points  |
| `result` | [Array](/api-docs/headless/Array/)<[Float](/api-docs/headless/Float/)> | Output array for interpolated points  |
| `rPos` | [Int](/api-docs/headless/Int/) | Current position in result array  |

| Returns | Description |
|---------|-------------|
| [Int](/api-docs/headless/Int/) | Updated position in result array |
