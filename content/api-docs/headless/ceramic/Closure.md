...
title: Closure
target: Headless
permalink: api-docs/headless/ceramic/Closure/
---
...
<div class="signature field-var has-description" id="method"><code><span class="field-name">method</span><span class="operator">:</span> <a href="/api-docs/headless/Any/" class="type-link">Any</a></code><a class="header-anchor" href="#method"><span aria-hidden="true" class="header-anchor__symbol">#</span></a></div>
...
| Returns | Description |
|---------|-------------|
| [Dynamic](/api-docs/headless/Dynamic/) | The return value from the called method, or null if the method returns Void * ```haxe var closure = new Closure(Math.max, [5, 10]); var result = closure.call(); // Returns 10 ``` |
...
|------|------|---------|-------------|
| `method` | [Any](/api-docs/headless/Any/) | | The function or method to store. Can be any callable reference.  |
| `args` | [Array](/api-docs/headless/Array/)<[Any](/api-docs/headless/Any/)> | *(optional)* | Optional array of arguments to pass when the method is called. If not provided, an empty array is used. * ```haxe // Simple function var c1 = new Closure(trace, ["Hello"]); * // Instance method var c2 = new Closure(sprite.moveTo, [100, 200]); * // No arguments var c3 = new Closure(doCleanup); ``` |
