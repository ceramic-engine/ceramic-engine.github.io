...
target: Headless
permalink: api-docs/headless/ceramic/TilemapTmxParser/
---
...
|------|------|---------|-------------|
| `rawTmxData` | [String](/api-docs/headless/String/) | | The TMX file content as an XML string  |
| `cwd` | [String](/api-docs/headless/String/) | | Current working directory for resolving relative TSX paths  |
...
| Returns | Description |
|---------|-------------|
| [format.tmx.TmxMap](/api-docs/headless/format/tmx/TmxMap/) | Parsed TmxMap object, or null if parsing fails  |
...
|------|------|-------------|
| `name` | [String](/api-docs/headless/String/) | The TSX filename referenced in the TMX  |

| Returns | Description |
|---------|-------------|
| [format.tmx.TmxTileset](/api-docs/headless/format/tmx/TmxTileset/) | The parsed TmxTileset object |
