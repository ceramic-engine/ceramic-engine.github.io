...
target: Headless
permalink: api-docs/headless/ceramic/CollectionEntry/
---
...
<div class="type-hierarchy"><strong>ceramic.CollectionEntry</strong> (Class) → <a href="/api-docs/headless/ceramic/ValueEntry/">ValueEntry</a></div>
...
<div class="see"><strong>See:</strong> <a href="/api-docs/headless/ceramic/Collection/">Collection</a>, <a href="/api-docs/headless/ceramic/FieldInfo/">FieldInfo</a></div>
...
| Name | Type | Description |
|------|------|-------------|
| `name` | [String](/api-docs/headless/String/) | The field name  |
| `rawValue` | [Dynamic](/api-docs/headless/Dynamic/) | The raw value to process  |

| Returns | Description |
|---------|-------------|
| [Bool](/api-docs/headless/Bool/) | True if field was handled, false to use default conversion |
...
|------|------|---------|-------------|
| `id` | [String](/api-docs/headless/String/) | *(optional)* | Optional unique identifier (auto-generated if not provided)  |
| `name` | [String](/api-docs/headless/String/) | *(optional)* | Optional human-readable name |
