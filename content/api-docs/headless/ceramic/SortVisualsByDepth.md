...
target: Headless
permalink: api-docs/headless/ceramic/SortVisualsByDepth/
---
...
|------|------|-------------|
| `a` | [Array](/api-docs/headless/Array/)<[Visual](/api-docs/headless/ceramic/Visual/)> | The array of visuals to sort by depth. Modified in place. If null, behavior is undefined. |
...
| Returns | Description |
|---------|-------------|
| [Int](/api-docs/headless/Int/) | -1 if a has lower depth, 1 if a has higher depth, 0 if equal |
