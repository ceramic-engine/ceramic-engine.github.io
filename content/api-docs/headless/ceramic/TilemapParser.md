...
title: TilemapParser
target: Headless
permalink: api-docs/headless/ceramic/TilemapParser/
---
...
|------|------|-------------|
| `rawLdtkData` | [String](/api-docs/headless/String/) | Raw LDtk data as string  |
| `loadExternalLdtkLevelData` | Function |  |

| Returns | Description |
|---------|-------------|
| [LdtkData](/api-docs/headless/ceramic/LdtkData/) | The LDtk parsed data |
...
| Name | Type | Default |
|------|------|---------|
| `ldtkData` | [LdtkData](/api-docs/headless/ceramic/LdtkData/) | |
| `loadTexture` | Function | *(optional)* |
| `skip` | [Array](/api-docs/headless/Array/)<[String](/api-docs/headless/String/)> | |
...
|------|------|---------|-------------|
| `rawTmxData` | [String](/api-docs/headless/String/) | | Raw TMX data as string  |
| `cwd` | [String](/api-docs/headless/String/) | *(optional)* | Current working directory. Needed to identify cached tileset relative to their tilemap  |
| `resolveTsxRawData` | Function | *(optional)* | A method to resolve TSX Tileset data that are not embedded in TMX data (optional)  |

| Returns | Description |
|---------|-------------|
| [format.tmx.TmxMap](/api-docs/headless/format/tmx/TmxMap/) | The TMX map data |
...
| Name | Type | Description |
|------|------|-------------|
| `rawTmxData` | [String](/api-docs/headless/String/) | The raw TMX XML data as a string  |

| Returns | Description |
|---------|-------------|
| [Array](/api-docs/headless/Array/)<[String](/api-docs/headless/String/)> | Array of external tileset filenames (relative paths as specified in TMX) |
...
| Name | Type | Default | Description |
|------|------|---------|-------------|
| `tmxMap` | [format.tmx.TmxMap](/api-docs/headless/format/tmx/TmxMap/) | | The parsed TMX map data  |
...
| Returns | Description |
|---------|-------------|
| [TilemapData](/api-docs/headless/ceramic/TilemapData/) | A new TilemapData instance ready to be used with a Tilemap visual |
