...
target: Headless
permalink: api-docs/headless/ceramic/_TilemapLdtkParser/TilemapLdtkParser_Fields_/
---
...
|------|------|-------------|
| `array` | [Array](/api-docs/headless/Array/)<allEqual.T> | The array to check  |
| `value` | allEqual.T | The value to compare against  |

| Returns | Description |
|---------|-------------|
| [Bool](/api-docs/headless/Bool/) | True if all elements equal the value |
