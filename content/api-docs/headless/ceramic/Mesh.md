...
title: Mesh
target: Headless
permalink: api-docs/headless/ceramic/Mesh/
---
...
<div class="type-hierarchy"><a href="/api-docs/headless/ceramic/Entity/">Entity</a> → <a href="/api-docs/headless/ceramic/Visual/">Visual</a> → <strong>ceramic.Mesh</strong> (Class) → <a href="/api-docs/headless/ceramic/AntialiasedTriangle/">AntialiasedTriangle</a>, <a href="/api-docs/headless/ceramic/Arc/">Arc</a>, <a href="/api-docs/headless/ceramic/Border/">Border</a>, <a href="/api-docs/headless/ceramic/CeramicLogo/">CeramicLogo</a>, <a href="/api-docs/headless/ceramic/Line/">Line</a>, <a href="/api-docs/headless/ceramic/Ngon/">Ngon</a>, <a href="/api-docs/headless/ceramic/Shape/">Shape</a>, <a href="/api-docs/headless/ceramic/TilemapMesh/">TilemapMesh</a>, <a href="/api-docs/headless/ceramic/Triangle/">Triangle</a>, <a href="/api-docs/headless/elements/BiBorderedTriangle/">elements.BiBorderedTriangle</a></div>
...
<div class="see"><strong>See:</strong> <a href="/api-docs/headless/ceramic/Visual/">Visual</a>, <a href="/api-docs/headless/ceramic/Quad/">Quad</a>, <a href="/api-docs/headless/ceramic/MeshPool/">MeshPool</a></div>


## Instance Members

<div class="signature field-var has-description" id="colorMapping"><code><span class="field-name">colorMapping</span><span class="operator">:</span> <a href="/api-docs/headless/ceramic/MeshColorMapping/" class="type-link">MeshColorMapping</a></code><a class="header-anchor" href="#colorMapping"><span aria-hidden="true" class="header-anchor__symbol">#</span></a></div>
...
<div class="signature field-var has-description" id="complexHit"><code><span class="field-name">complexHit</span><span class="operator">:</span> <a href="/api-docs/headless/Bool/" class="type-link">Bool</a></code><a class="header-anchor" href="#complexHit"><span aria-hidden="true" class="header-anchor__symbol">#</span></a></div>
...
|------|------|---------|-------------|
| `cols` | [Int](/api-docs/headless/Int/) | | The number of columnns in the grid  |
| `rows` | [Int](/api-docs/headless/Int/) | | The number of rows in the grid  |
| `width` | [Float](/api-docs/headless/Float/) | `-1` | The width of the grid  |
| `height` | [Float](/api-docs/headless/Float/) | `-1` | The height of the grid |

<hr class="field-separator" />

<div class="signature field-method has-description" id="gridFromTexture"><code><span class="field-name">gridFromTexture</span><span class="parenthesis">(</span><span class="arg-name">cols</span><span class="operator">:</span> <a href="/api-docs/headless/Int/" class="type-link">Int</a><span class="operator">,</span> <span class="arg-name">rows</span><span class="operator">:</span> <a href="/api-docs/headless/Int/" class="type-link">Int</a><span class="operator">,</span> <span class="operator">?</span><span class="arg-name">texture</span><span class="operator">:</span> <a href="/api-docs/headless/ceramic/Texture/" class="type-link">Texture</a><span class="parenthesis">)</span><span class="operator">:</span> <a href="/api-docs/headless/Void/" class="type-link">Void</a></code><a class="header-anchor" href="#gridFromTexture"><span aria-hidden="true" class="header-anchor__symbol">#</span></a></div>
...
| `cols` | [Int](/api-docs/headless/Int/) | | The number of columnns in the grid  |
| `rows` | [Int](/api-docs/headless/Int/) | | The number of rows in the grid  |
| `texture` | [Texture](/api-docs/headless/ceramic/Texture/) | *(optional)* | The texture used to generate the grid. If not provided, will use mesh's current texture |
...
| `matrix` | [Transform](/api-docs/headless/ceramic/Transform/) | Transform matrix for coordinate conversion  |

| Returns | Description |
|---------|-------------|
| [Bool](/api-docs/headless/Bool/) | True if the point hits the mesh |
