...
title: Shape
target: Headless
permalink: api-docs/headless/ceramic/Shape/
---
...
<div class="see"><strong>See:</strong> <a href="/api-docs/headless/ceramic/Mesh/">Mesh</a>, <a href="/api-docs/headless/ceramic/Triangulate/">Triangulate</a></div>
...
| `space` | [nape.space.Space](/api-docs/headless/nape/space/Space/) | *(optional)* | Nape physics space (uses default if not provided)  |
| `shape` | [nape.shape.Shape](/api-docs/headless/nape/shape/Shape/) | *(optional)* | Custom collision shape (auto-generated from points if null)  |
| `shapes` | [Array](/api-docs/headless/Array/)<[nape.shape.Shape](/api-docs/headless/nape/shape/Shape/)> | *(optional)* | Array of collision shapes for complex bodies  |
| `material` | [nape.phys.Material](/api-docs/headless/nape/phys/Material/) | *(optional)* | Physics material defining friction, elasticity, etc.  |

| Returns | Description |
|---------|-------------|
| [VisualNapePhysics](/api-docs/headless/ceramic/VisualNapePhysics/) | VisualNapePhysics component for further configuration |
