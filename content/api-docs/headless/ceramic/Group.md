...
title: Group
target: Headless
permalink: api-docs/headless/ceramic/Group/
---
...
<div class="type-hierarchy"><a href="/api-docs/headless/ceramic/Entity/">Entity</a> → <strong>ceramic.Group</strong> (Class)</div>
...
| Returns | Description |
|---------|-------------|
| [Bool](/api-docs/headless/Bool/) | `true` if the item is in the group, `false` otherwise |
...
|------|------|---------|-------------|
| `id` | [String](/api-docs/headless/String/) | *(optional)* | Optional identifier for the group. Useful for debugging and finding specific groups. |
...
| Name | Type | Description |
|------|------|-------------|
| `item` | [Entity](/api-docs/headless/ceramic/Entity/) | The entity that was destroyed |
