...
title: Assert
target: Headless
permalink: api-docs/headless/ceramic/Assert/
---
...
|------|------|---------|-------------|
| `expr` | [Dynamic](/api-docs/headless/Dynamic/) | | The expression to evaluate. Must resolve to a boolean value.  |
| `reason` | [String](/api-docs/headless/String/) | *(optional)* | Optional custom error message to include when assertion fails. If not provided, defaults to "Assertion failure". * |
