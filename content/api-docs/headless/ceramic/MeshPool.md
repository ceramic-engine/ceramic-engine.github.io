...
title: MeshPool
target: Headless
permalink: api-docs/headless/ceramic/MeshPool/
---
...
<div class="signature field-method has-description" id="get"><code><span class="field-name">get</span><span class="parenthesis">(</span><span class="parenthesis">)</span><span class="operator">:</span> <a href="/api-docs/headless/ceramic/Mesh/" class="type-link">Mesh</a></code><a class="header-anchor" href="#get"><span aria-hidden="true" class="header-anchor__symbol">#</span></a></div>
...
| Returns | Description |
|---------|-------------|
| [Mesh](/api-docs/headless/ceramic/Mesh/) | A ready-to-use Mesh instance * ```haxe var mesh = MeshPool.get(); mesh.createQuad(100, 100); parent.add(mesh); ``` |
...
|------|------|-------------|
| `mesh` | [Mesh](/api-docs/headless/ceramic/Mesh/) | The mesh to recycle  |
