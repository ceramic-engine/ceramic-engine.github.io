...
title: SpineColors
target: Headless
permalink: api-docs/headless/ceramic/SpineColors/
---
...
|------|------|---------|-------------|
| `spine` | [Spine](/api-docs/headless/ceramic/Spine/) | | The Spine instance to extract colors from  |
| `slots` | [Array](/api-docs/headless/Array/)<[String](/api-docs/headless/String/)> | | Array of slot names to extract colors from  |
| `result` | [Array](/api-docs/headless/Array/)<[Color](/api-docs/headless/ceramic/Color/)> | *(optional)* | Optional array to store results in. If provided, it will be reused; otherwise a new array is created  |

| Returns | Description |
|---------|-------------|
| [Array](/api-docs/headless/Array/)<[Color](/api-docs/headless/ceramic/Color/)> | Array of Color values corresponding to each slot. Slots that don't exist or have no color will have Color.NONE * ```haxe var spine = new Spine(); spine.load(spineData); * // Extract colors from specific slots var slotNames = ["head", "body", "weapon"]; var colors = SpineColors.extractColors(spine, slotNames); * for (i in 0...slotNames.length) { trace('${slotNames[i]} color: ${colors[i].toHex()}'); } ``` |
...
| Name | Type | Default | Description |
|------|------|---------|-------------|
| `spine` | [Spine](/api-docs/headless/ceramic/Spine/) | | The Spine instance to extract dark colors from  |
| `slots` | [Array](/api-docs/headless/Array/)<[String](/api-docs/headless/String/)> | | Array of slot names to extract dark colors from  |
| `result` | [Array](/api-docs/headless/Array/)<[Color](/api-docs/headless/ceramic/Color/)> | *(optional)* | Optional array to store results in. If provided, it will be reused; otherwise a new array is created  |
