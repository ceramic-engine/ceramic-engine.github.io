...
target: Headless
permalink: api-docs/headless/ceramic/TimelineFloatArrayTrack/
---
...
<div class="type-hierarchy"><a href="/api-docs/headless/ceramic/Entity/">Entity</a> → <a href="/api-docs/headless/ceramic/TimelineTrack/">TimelineTrack</a> → <strong>ceramic.TimelineFloatArrayTrack</strong> (Class)</div>
...
<div class="see"><strong>See:</strong> <a href="/api-docs/headless/ceramic/TimelineFloatArrayKeyframe/">TimelineFloatArrayKeyframe</a>, <a href="/api-docs/headless/ceramic/TimelineTrack/">TimelineTrack</a>, <a href="/api-docs/headless/ceramic/Timeline/">Timeline</a></div>
...
|------|------|---------|-------------|
| `forceChange` | [Bool](/api-docs/headless/Bool/) | `false` | If true, triggers the change event even if no values changed |
...
|------|------|-------------|
| `track` | [TimelineFloatArrayTrack](/api-docs/headless/ceramic/TimelineFloatArrayTrack/) | This track instance (for convenience in handlers) |
