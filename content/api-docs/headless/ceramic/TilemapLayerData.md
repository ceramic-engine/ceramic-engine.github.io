...
<div class="signature field-var no-description has-plugin" id="unobservedExtraBlending"><div class="plugin-name">tilemap</div><code><span class="field-name">unobservedExtraBlending</span><span class="operator">:</span> <a href="/api-docs/headless/ceramic/Blending/" class="type-link">Blending</a></code><a class="header-anchor" href="#unobservedExtraBlending"><span aria-hidden="true" class="header-anchor__symbol">#</span></a></div>
