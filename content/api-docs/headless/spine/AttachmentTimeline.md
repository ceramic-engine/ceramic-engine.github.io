...
target: Headless
permalink: api-docs/headless/spine/AttachmentTimeline/
---
...
<div class="type-hierarchy"><a href="/api-docs/headless/spine/Timeline/">Timeline</a> → <strong>spine.AttachmentTimeline</strong> (Class)</div>
...
<div class="signature field-var no-description has-plugin" id="attachmentNames"><div class="plugin-name">spine</div><code><span class="field-name">attachmentNames</span><span class="operator">:</span> <a href="/api-docs/headless/spine/support/utils/StringArray/" class="type-link">spine.support.utils.StringArray</a></code><a class="header-anchor" href="#attachmentNames"><span aria-hidden="true" class="header-anchor__symbol">#</span></a></div>
...
<div class="signature field-method has-description has-plugin" id="getAttachmentNames"><div class="plugin-name">spine</div><code><span class="field-name">getAttachmentNames</span><span class="parenthesis">(</span><span class="parenthesis">)</span><span class="operator">:</span> <a href="/api-docs/headless/spine/support/utils/StringArray/" class="type-link">spine.support.utils.StringArray</a></code><a class="header-anchor" href="#getAttachmentNames"><span aria-hidden="true" class="header-anchor__symbol">#</span></a></div>
