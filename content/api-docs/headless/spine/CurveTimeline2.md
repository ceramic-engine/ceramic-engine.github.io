...
target: Headless
permalink: api-docs/headless/spine/CurveTimeline2/
---
...
<div class="type-hierarchy"><a href="/api-docs/headless/spine/Timeline/">Timeline</a> → <a href="/api-docs/headless/spine/CurveTimeline/">CurveTimeline</a> → <strong>spine.CurveTimeline2</strong> (Class) → <a href="/api-docs/headless/spine/ScaleTimeline/">ScaleTimeline</a>, <a href="/api-docs/headless/spine/ShearTimeline/">ShearTimeline</a>, <a href="/api-docs/headless/spine/TranslateTimeline/">TranslateTimeline</a></div>
...
<div class="signature field-var no-description has-plugin" id="VALUE1"><div class="plugin-name">spine</div><code><span class="field-name">VALUE1</span><span class="operator">:</span> <a href="/api-docs/headless/Int/" class="type-link">Int</a></code><a class="header-anchor" href="#VALUE1"><span aria-hidden="true" class="header-anchor__symbol">#</span></a></div>

<hr class="field-separator" />

<div class="signature field-var no-description has-plugin" id="VALUE2"><div class="plugin-name">spine</div><code><span class="field-name">VALUE2</span><span class="operator">:</span> <a href="/api-docs/headless/Int/" class="type-link">Int</a></code><a class="header-anchor" href="#VALUE2"><span aria-hidden="true" class="header-anchor__symbol">#</span></a></div>
...
| `propertyId1` | [String](/api-docs/headless/String/) | Unique identifier for the first property the timeline modifies.  |
| `propertyId2` | [String](/api-docs/headless/String/) | Unique identifier for the second property the timeline modifies. |
