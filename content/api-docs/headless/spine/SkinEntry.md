...
title: SkinEntry
target: Headless
permalink: api-docs/headless/spine/SkinEntry/
---
...
<div class="type-hierarchy"><strong>spine.SkinEntry</strong> (Class)</div>
...
<div class="signature field-method no-description has-plugin" id="getHashCode"><div class="plugin-name">spine</div><code><span class="field-name">getHashCode</span><span class="parenthesis">(</span><span class="parenthesis">)</span><span class="operator">:</span> <a href="/api-docs/headless/Int/" class="type-link">Int</a></code><a class="header-anchor" href="#getHashCode"><span aria-hidden="true" class="header-anchor__symbol">#</span></a></div>
