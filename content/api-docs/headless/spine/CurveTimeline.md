...
title: CurveTimeline
target: Headless
permalink: api-docs/headless/spine/CurveTimeline/
---
...
<div class="type-hierarchy"><a href="/api-docs/headless/spine/Timeline/">Timeline</a> → <strong>spine.CurveTimeline</strong> (Class) → <a href="/api-docs/headless/spine/CurveTimeline1/">CurveTimeline1</a>, <a href="/api-docs/headless/spine/CurveTimeline2/">CurveTimeline2</a>, <a href="/api-docs/headless/spine/DeformTimeline/">DeformTimeline</a>, <a href="/api-docs/headless/spine/IkConstraintTimeline/">IkConstraintTimeline</a>, <a href="/api-docs/headless/spine/PathConstraintMixTimeline/">PathConstraintMixTimeline</a>, <a href="/api-docs/headless/spine/RGB2Timeline/">RGB2Timeline</a>, <a href="/api-docs/headless/spine/RGBA2Timeline/">RGBA2Timeline</a>, <a href="/api-docs/headless/spine/RGBATimeline/">RGBATimeline</a>, <a href="/api-docs/headless/spine/RGBTimeline/">RGBTimeline</a>, <a href="/api-docs/headless/spine/TransformConstraintTimeline/">TransformConstraintTimeline</a></div>
...
|------|------|-------------|
| `frame` | [Int](/api-docs/headless/Int/) | Between 0 and <code>frameCount - 1</code>, inclusive. |

<hr class="field-separator" />

<div class="signature field-method has-description has-plugin" id="setStepped"><div class="plugin-name">spine</div><code><span class="field-name">setStepped</span><span class="parenthesis">(</span><span class="arg-name">frame</span><span class="operator">:</span> <a href="/api-docs/headless/Int/" class="type-link">Int</a><span class="parenthesis">)</span><span class="operator">:</span> <a href="/api-docs/headless/Void/" class="type-link">Void</a></code><a class="header-anchor" href="#setStepped"><span aria-hidden="true" class="header-anchor__symbol">#</span></a></div>
...
| Name | Type | Description |
|------|------|-------------|
| `bezier` | [Int](/api-docs/headless/Int/) | The ordinal of this Bezier curve for this timeline, between 0 and <code>bezierCount - 1</code> (specified in the constructor), inclusive.  |
| `frame` | [Int](/api-docs/headless/Int/) | Between 0 and <code>frameCount - 1</code>, inclusive.  |
| `value` | [Int](/api-docs/headless/Int/) | The index of the value for the frame this curve is used for.  |
| `time1` | [Float](/api-docs/headless/Float/) | The time for the first key.  |
| `value1` | [Float](/api-docs/headless/Float/) | The value for the first key.  |
| `cx1` | [Float](/api-docs/headless/Float/) | The time for the first Bezier handle.  |
| `cy1` | [Float](/api-docs/headless/Float/) | The value for the first Bezier handle.  |
| `cx2` | [Float](/api-docs/headless/Float/) | The time of the second Bezier handle.  |
| `cy2` | [Float](/api-docs/headless/Float/) | The value for the second Bezier handle.  |
| `time2` | [Float](/api-docs/headless/Float/) | The time for the second key.  |
| `value2` | [Float](/api-docs/headless/Float/) | The value for the second key. |

<hr class="field-separator" />

<div class="signature field-method has-description has-plugin" id="getBezierValue"><div class="plugin-name">spine</div><code><span class="field-name">getBezierValue</span><span class="parenthesis">(</span><span class="arg-name">time</span><span class="operator">:</span> <a href="/api-docs/headless/Float/" class="type-link">Float</a><span class="operator">,</span> <span class="arg-name">frameIndex</span><span class="operator">:</span> <a href="/api-docs/headless/Int/" class="type-link">Int</a><span class="operator">,</span> <span class="arg-name">valueOffset</span><span class="operator">:</span> <a href="/api-docs/headless/Int/" class="type-link">Int</a><span class="operator">,</span> <span class="arg-name">i</span><span class="operator">:</span> <a href="/api-docs/headless/Int/" class="type-link">Int</a><span class="parenthesis">)</span><span class="operator">:</span> <a href="/api-docs/headless/Float/" class="type-link">Float</a></code><a class="header-anchor" href="#getBezierValue"><span aria-hidden="true" class="header-anchor__symbol">#</span></a></div>
...
| `frameIndex` | [Int](/api-docs/headless/Int/) | The index into { |
| `valueOffset` | [Int](/api-docs/headless/Int/) | The offset from <code>frameIndex</code> to the value this curve is used for.  |
| `i` | [Int](/api-docs/headless/Int/) | The index of the Bezier segments. See { |
...
| `bezierCount` | [Int](/api-docs/headless/Int/) | The maximum number of Bezier curves. See { |
