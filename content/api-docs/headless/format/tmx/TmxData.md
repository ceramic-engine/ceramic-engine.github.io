...
title: TmxData
target: Headless
permalink: api-docs/headless/format/tmx/TmxData/
---
...
<div class="signature field-var has-description" id="data"><code><span class="field-name">data</span><span class="operator">:</span> <a href="/api-docs/headless/haxe/io/Bytes/" class="type-link">haxe.io.Bytes</a></code><a class="header-anchor" href="#data"><span aria-hidden="true" class="header-anchor__symbol">#</span></a></div>
...
| `tiles` | [Array](/api-docs/headless/Array/)<[TmxTile](/api-docs/headless/format/tmx/TmxTile/)> | *(optional)* | Decoded tile data |
| `chunks` | [Array](/api-docs/headless/Array/)<[TmxChunk](/api-docs/headless/format/tmx/TmxChunk/)> | *(optional)* | Infinite maps chunk data |
| `data` | [haxe.io.Bytes](/api-docs/headless/haxe/io/Bytes/) | *(optional)* | Raw data. Exists for non-tile-layer data objects. |
