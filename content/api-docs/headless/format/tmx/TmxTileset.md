...
title: TmxTileset
target: Headless
permalink: api-docs/headless/format/tmx/TmxTileset/
---
...
<div class="signature field-var has-description" id="source"><code><span class="field-name">source</span><span class="operator">:</span> <a href="/api-docs/headless/String/" class="type-link">String</a></code><a class="header-anchor" href="#source"><span aria-hidden="true" class="header-anchor__symbol">#</span></a></div>
...
<div class="signature field-var has-description" id="tileCount"><code><span class="field-name">tileCount</span><span class="operator">:</span> <a href="/api-docs/headless/Int/" class="type-link">Int</a></code><a class="header-anchor" href="#tileCount"><span aria-hidden="true" class="header-anchor__symbol">#</span></a></div>

The number of tiles in this tileset (since 0.13)

<hr class="field-separator" />

<div class="signature field-var has-description" id="columns"><code><span class="field-name">columns</span><span class="operator">:</span> <a href="/api-docs/headless/Int/" class="type-link">Int</a></code><a class="header-anchor" href="#columns"><span aria-hidden="true" class="header-anchor__symbol">#</span></a></div>
...
<div class="signature field-var has-description" id="image"><code><span class="field-name">image</span><span class="operator">:</span> <a href="/api-docs/headless/format/tmx/TmxImage/" class="type-link">TmxImage</a></code><a class="header-anchor" href="#image"><span aria-hidden="true" class="header-anchor__symbol">#</span></a></div>
...
<div class="signature field-var has-description" id="grid"><code><span class="field-name">grid</span><span class="operator">:</span> <a href="/api-docs/headless/format/tmx/TmxTilesetGrid/" class="type-link">TmxTilesetGrid</a></code><a class="header-anchor" href="#grid"><span aria-hidden="true" class="header-anchor__symbol">#</span></a></div>
...
|------|------|---------|-------------|
| `firstGID` | [Int](/api-docs/headless/Int/) | *(optional)* | The first global tile ID of this tileset (this global ID maps to the first tile in this tileset). |
| `source` | [String](/api-docs/headless/String/) | *(optional)* | If this tileset is stored in an external TSX (Tile Set XML) file, this attribute refers to that file. That TSX file has the same structure as the <tileset> element described here. (There is the firstgid attribute missing and this source attribute is also not there. These two attributes are kept in the TMX map, since they are map specific.) |
| `name` | [String](/api-docs/headless/String/) | *(optional)* | The name of this tileset. |
| `tileWidth` | [Int](/api-docs/headless/Int/) | *(optional)* | The (maximum) width of the tiles in this tileset. |
| `tileHeight` | [Int](/api-docs/headless/Int/) | *(optional)* | The (maximum) height of the tiles in this tileset. |
| `spacing` | [Int](/api-docs/headless/Int/) | *(optional)* | The spacing in pixels between the tiles in this tileset (applies to the tileset image). |
| `margin` | [Int](/api-docs/headless/Int/) | *(optional)* | The margin around the tiles in this tileset (applies to the tileset image). |
| `tileCount` | [Int](/api-docs/headless/Int/) | *(optional)* | The number of tiles in this tileset (since 0.13) |
| `columns` | [Int](/api-docs/headless/Int/) | *(optional)* | The number of tile columns in the tileset. For image collection tilesets it is editable and is used when displaying the tileset. (since 0.15) |
| `tileOffset` | [TmxTileOffset](/api-docs/headless/format/tmx/TmxTileOffset/) | *(optional)* | This element is used to specify an offset in pixels, to be applied when drawing a tile from the related tileset. When not present, no offset is applied. Since 0.8 |
| `properties` | [TmxProperties](/api-docs/headless/format/tmx/TmxProperties/) | *(optional)* | Since 0.8 |
| `image` | [TmxImage](/api-docs/headless/format/tmx/TmxImage/) | *(optional)* | * As of the current version of Tiled Qt, each tileset has a single image associated with it, which is cut into smaller tiles based on the attributes defined on the tileset element. Later versions may add support for adding multiple images to a single tileset, as is possible in Tiled Java. |
| `terrainTypes` | [Array](/api-docs/headless/Array/)<[TmxTerrain](/api-docs/headless/format/tmx/TmxTerrain/)> | *(optional)* | Terrain type defines. Since 0.9 |
| `tiles` | [Array](/api-docs/headless/Array/)<[TmxTilesetTile](/api-docs/headless/format/tmx/TmxTilesetTile/)> | *(optional)* | Extended tiles data. |
| `grid` | [TmxTilesetGrid](/api-docs/headless/format/tmx/TmxTilesetGrid/) | *(optional)* | Since 1.0 |
| `wangSets` | [Array](/api-docs/headless/Array/)<[TmxWangSet](/api-docs/headless/format/tmx/TmxWangSet/)> | *(optional)* | Since 1.1 |
