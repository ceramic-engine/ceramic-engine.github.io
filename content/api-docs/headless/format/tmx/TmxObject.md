...
title: TmxObject
target: Headless
permalink: api-docs/headless/format/tmx/TmxObject/
---
...
<div class="signature field-var has-description" id="type"><code><span class="field-name">type</span><span class="operator">:</span> <a href="/api-docs/headless/String/" class="type-link">String</a></code><a class="header-anchor" href="#type"><span aria-hidden="true" class="header-anchor__symbol">#</span></a></div>
...
<div class="signature field-var has-description" id="flippedHorizontally"><code><span class="field-name">flippedHorizontally</span><span class="operator">:</span> <a href="/api-docs/headless/Bool/" class="type-link">Bool</a></code><a class="header-anchor" href="#flippedHorizontally"><span aria-hidden="true" class="header-anchor__symbol">#</span></a></div>

Is tile flipped horizontally? Default: false

<hr class="field-separator" />

<div class="signature field-var has-description" id="flippedVertically"><code><span class="field-name">flippedVertically</span><span class="operator">:</span> <a href="/api-docs/headless/Bool/" class="type-link">Bool</a></code><a class="header-anchor" href="#flippedVertically"><span aria-hidden="true" class="header-anchor__symbol">#</span></a></div>

Is tile flipped vertically? Default: false

<hr class="field-separator" />

<div class="signature field-var has-description" id="template"><code><span class="field-name">template</span><span class="operator">:</span> <a href="/api-docs/headless/String/" class="type-link">String</a></code><a class="header-anchor" href="#template"><span aria-hidden="true" class="header-anchor__symbol">#</span></a></div>
...
|------|------|---------|-------------|
| `id` | [Int](/api-docs/headless/Int/) | | Id of the object. Each object that is placed on map gets unique id. And even if object was deleted no one gets it's id again. Can not be changed in Tiled Qt. |
| `name` | [String](/api-docs/headless/String/) | *(optional)* | The name of the object. An arbitrary string. |
| `type` | [String](/api-docs/headless/String/) | *(optional)* | The type of the object. An arbitrary string. |
| `x` | [Float](/api-docs/headless/Float/) | | The x coordinate of the object in pixels. |
| `y` | [Float](/api-docs/headless/Float/) | | The y coordinate of the object in pixels. |
| `width` | [Float](/api-docs/headless/Float/) | *(optional)* | The width of the object in pixels (defaults to 0). |
| `height` | [Float](/api-docs/headless/Float/) | *(optional)* | The height of the object in pixels (defaults to 0). |
| `rotation` | [Float](/api-docs/headless/Float/) | *(optional)* | The rotation of the object in degrees clockwise (defaults to 0). (Since 0.10) |
| `visible` | [Bool](/api-docs/headless/Bool/) | *(optional)* | Whether the object is shown (1) or hidden (0). Defaults to 1. (since 0.9.0) |
| `objectType` | Anonymous | | Helper type to easily detect what exactly is that object. |
| `properties` | [TmxProperties](/api-docs/headless/format/tmx/TmxProperties/) | *(optional)* | Object properties. |
| `flippedHorizontally` | [Bool](/api-docs/headless/Bool/) | *(optional)* | Is tile flipped horizontally? Default: false |
| `flippedVertically` | [Bool](/api-docs/headless/Bool/) | *(optional)* | Is tile flipped vertically? Default: false |
| `template` | [String](/api-docs/headless/String/) | *(optional)* | A reference to a template file (optional). |
