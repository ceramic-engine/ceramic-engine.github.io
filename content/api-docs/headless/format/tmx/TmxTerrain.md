...
title: TmxTerrain
target: Headless
permalink: api-docs/headless/format/tmx/TmxTerrain/
---
...
<div class="type-hierarchy"><strong>format.tmx.TmxTerrain</strong> (Class)</div>
...
|------|------|---------|-------------|
| `name` | [String](/api-docs/headless/String/) | | The name of the terrain type. |
| `tile` | [Int](/api-docs/headless/Int/) | | The local tile-id of the tile that represents the terrain visually. |
