...
title: TmxWangSet
target: Headless
permalink: api-docs/headless/format/tmx/TmxWangSet/
---
...
|------|------|-------------|
| `name` | [String](/api-docs/headless/String/) | The name of the Wang set. |
| `tile` | [Int](/api-docs/headless/Int/) | The tile ID of the tile representing this Wang set. |
| `corners` | [Array](/api-docs/headless/Array/)<[TmxWangSetColor](/api-docs/headless/format/tmx/TmxWangSetColor/)> | A color that can be used to define the corner of a Wang tile. |
| `edges` | [Array](/api-docs/headless/Array/)<[TmxWangSetColor](/api-docs/headless/format/tmx/TmxWangSetColor/)> | A color that can be used to define the edge of a Wang tile. |
| `tiles` | [Array](/api-docs/headless/Array/)<[TmxWangSetTile](/api-docs/headless/format/tmx/TmxWangSetTile/)> | Defines a Wang tile, by referring to a tile in the tileset and associating it with a certain Wang ID. |
