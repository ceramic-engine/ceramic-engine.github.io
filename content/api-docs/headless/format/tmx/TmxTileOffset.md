...
title: TmxTileOffset
target: Headless
permalink: api-docs/headless/format/tmx/TmxTileOffset/
---
...
|------|------|-------------|
| `x` | [Int](/api-docs/headless/Int/) | Horizontal offset in pixels |
| `y` | [Int](/api-docs/headless/Int/) | Vertical offset in pixels (positive is down) |
