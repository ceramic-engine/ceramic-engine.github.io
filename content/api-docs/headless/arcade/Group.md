...
title: Group
target: Headless
permalink: api-docs/headless/arcade/Group/
---
...
|------|------|-------------|
| `body` | [Body](/api-docs/headless/arcade/Body/) | The body to add to the group. |
