...
title: TextInput
target: Headless
permalink: api-docs/headless/spec/TextInput/
---
...
<div class="type-hierarchy"><strong>spec.TextInput</strong> (Interface) → <a href="/api-docs/headless/backend/TextInput/">backend.TextInput</a></div>
...
|------|------|-------------|
| `initialText` | [String](/api-docs/headless/String/) | The initial text to display in the input field  |
| `x` | [Float](/api-docs/headless/Float/) | The X position of the input field in screen coordinates  |
| `y` | [Float](/api-docs/headless/Float/) | The Y position of the input field in screen coordinates  |
| `w` | [Float](/api-docs/headless/Float/) | The width of the input field  |
| `h` | [Float](/api-docs/headless/Float/) | The height of the input field |
