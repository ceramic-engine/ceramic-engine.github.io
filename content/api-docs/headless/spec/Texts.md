...
title: Texts
target: Headless
permalink: api-docs/headless/spec/Texts/
---
...
<div class="type-hierarchy"><strong>spec.Texts</strong> (Interface) → <a href="/api-docs/headless/backend/Texts/">backend.Texts</a></div>
...
|------|------|---------|-------------|
| `path` | [String](/api-docs/headless/String/) | | The path to the text file to load  |
| `options` | [Null](/api-docs/headless/Null/)<[backend.LoadTextOptions](/api-docs/headless/backend/LoadTextOptions/)> | *(optional)* | Optional loading configuration (caching, hot-reload, etc.)  |
