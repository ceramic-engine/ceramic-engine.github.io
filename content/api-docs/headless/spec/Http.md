...
title: Http
target: Headless
permalink: api-docs/headless/spec/Http/
---
...
<div class="type-hierarchy"><strong>spec.Http</strong> (Interface) → <a href="/api-docs/headless/backend/Http/">backend.Http</a></div>
...
|------|------|-------------|
| `options` | [backend.HttpRequestOptions](/api-docs/headless/backend/HttpRequestOptions/) | The request configuration including URL, method, headers, body, etc.  |
