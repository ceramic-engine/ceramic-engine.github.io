...
title: IO
target: Headless
permalink: api-docs/headless/spec/IO/
---
...
<div class="type-hierarchy"><strong>spec.IO</strong> (Interface) → <a href="/api-docs/headless/backend/IO/">backend.IO</a></div>
...
|------|------|-------------|
| `key` | [String](/api-docs/headless/String/) | The storage key/path (e.g., "saves/game1.json")  |
| `str` | [String](/api-docs/headless/String/) | The string content to save  |

| Returns | Description |
|---------|-------------|
| [Bool](/api-docs/headless/Bool/) | True if the save was successful, false on error |
...
| Name | Type | Description |
|------|------|-------------|
| `key` | [String](/api-docs/headless/String/) | The storage key/path (e.g., "logs/debug.txt")  |
| `str` | [String](/api-docs/headless/String/) | The string content to append  |

| Returns | Description |
|---------|-------------|
| [Bool](/api-docs/headless/Bool/) | True if the append was successful, false on error |
...
| Returns | Description |
|---------|-------------|
| [String](/api-docs/headless/String/) | The file contents as a string, or null if the file doesn't exist or can't be read |
