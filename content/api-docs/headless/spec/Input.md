...
title: Input
target: Headless
permalink: api-docs/headless/spec/Input/
---
...
<div class="type-hierarchy"><strong>spec.Input</strong> (Interface) → <a href="/api-docs/headless/backend/Input/">backend.Input</a></div>
