...
title: SliceChunk
target: Headless
permalink: api-docs/headless/ase/chunks/SliceChunk/
---
...
<div class="type-hierarchy"><a href="/api-docs/headless/ase/chunks/Chunk/">Chunk</a> → <strong>ase.chunks.SliceChunk</strong> (Class)</div>
...
| Returns |
|---------|
| [SliceChunk](/api-docs/headless/ase/chunks/SliceChunk/) |

## Instance Members

<div class="signature field-var no-description" id="numSliceKeys"><code><span class="field-name">numSliceKeys</span><span class="operator">:</span> <a href="/api-docs/headless/haxe/Int32/" class="type-link">haxe.Int32</a></code><a class="header-anchor" href="#numSliceKeys"><span aria-hidden="true" class="header-anchor__symbol">#</span></a></div>
...
<div class="signature field-var no-description" id="sliceKeys"><code><span class="field-name">sliceKeys</span><span class="operator">:</span> <a href="/api-docs/headless/Array/" class="type-link">Array</a><span class="operator">&lt;</span><a href="/api-docs/headless/ase/chunks/SliceKey/" class="type-link">SliceKey</a><span class="operator">&gt;</span></code><a class="header-anchor" href="#sliceKeys"><span aria-hidden="true" class="header-anchor__symbol">#</span></a></div>

<hr class="field-separator" />

<div class="signature field-var no-description" id="has9Slices"><code><span class="field-name">has9Slices</span><span class="operator">:</span> <a href="/api-docs/headless/Bool/" class="type-link">Bool</a></code><a class="header-anchor" href="#has9Slices"><span aria-hidden="true" class="header-anchor__symbol">#</span></a></div>

<hr class="field-separator" />

<div class="signature field-var no-description" id="hasPivot"><code><span class="field-name">hasPivot</span><span class="operator">:</span> <a href="/api-docs/headless/Bool/" class="type-link">Bool</a></code><a class="header-anchor" href="#hasPivot"><span aria-hidden="true" class="header-anchor__symbol">#</span></a></div>
