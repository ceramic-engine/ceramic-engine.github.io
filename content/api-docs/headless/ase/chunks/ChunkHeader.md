...
title: ChunkHeader
target: Headless
permalink: api-docs/headless/ase/chunks/ChunkHeader/
---
...
| Returns |
|---------|
| [ChunkHeader](/api-docs/headless/ase/chunks/ChunkHeader/) |
...
<div class="signature field-var no-description" id="type"><code><span class="field-name">type</span><span class="operator">:</span> <a href="/api-docs/headless/ase/types/ChunkType/" class="type-link">ase.types.ChunkType</a></code><a class="header-anchor" href="#type"><span aria-hidden="true" class="header-anchor__symbol">#</span></a></div>
