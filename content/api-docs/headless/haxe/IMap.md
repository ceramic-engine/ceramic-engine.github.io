...
title: IMap
target: Headless
permalink: api-docs/headless/haxe/IMap/
---

# IMap

<div class="type-hierarchy"><strong>haxe.IMap</strong> (Interface) → <a href="/api-docs/headless/haxe/ds/BalancedTree/">haxe.ds.BalancedTree</a>, <a href="/api-docs/headless/haxe/ds/EnumValueMap/">haxe.ds.EnumValueMap</a>, <a href="/api-docs/headless/haxe/ds/IntMap/">haxe.ds.IntMap</a>, <a href="/api-docs/headless/haxe/ds/ObjectMap/">haxe.ds.ObjectMap</a>, <a href="/api-docs/headless/haxe/ds/StringMap/">haxe.ds.StringMap</a></div>

## Instance Members

<div class="signature field-method no-description" id="get"><code><span class="field-name">get</span><span class="parenthesis">(</span><span class="arg-name">k</span><span class="operator">:</span> <span class="type-name">haxe.IMap.K</span><span class="parenthesis">)</span><span class="operator">:</span> <a href="/api-docs/headless/Null/" class="type-link">Null</a><span class="operator">&lt;</span><span class="type-name">haxe.IMap.V</span><span class="operator">&gt;</span></code><a class="header-anchor" href="#get"><span aria-hidden="true" class="header-anchor__symbol">#</span></a></div>
...
| Returns |
|---------|
| [Null](/api-docs/headless/Null/)<haxe.IMap.V> |

<hr class="field-separator" />

<div class="signature field-method no-description" id="set"><code><span class="field-name">set</span><span class="parenthesis">(</span><span class="arg-name">k</span><span class="operator">:</span> <span class="type-name">haxe.IMap.K</span><span class="operator">,</span> <span class="arg-name">v</span><span class="operator">:</span> <span class="type-name">haxe.IMap.V</span><span class="parenthesis">)</span><span class="operator">:</span> <a href="/api-docs/headless/Void/" class="type-link">Void</a></code><a class="header-anchor" href="#set"><span aria-hidden="true" class="header-anchor__symbol">#</span></a></div>
