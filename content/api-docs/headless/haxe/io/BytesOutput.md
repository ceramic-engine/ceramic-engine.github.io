...
title: BytesOutput
target: Headless
permalink: api-docs/headless/haxe/io/BytesOutput/
---

# BytesOutput

<div class="type-hierarchy"><a href="/api-docs/headless/haxe/io/Output/">Output</a> → <strong>haxe.io.BytesOutput</strong> (Class)</div>
...
<div class="signature field-var no-description" id="b"><code><span class="field-name">b</span><span class="operator">:</span> <a href="/api-docs/headless/haxe/io/BytesBuffer/" class="type-link">BytesBuffer</a></code><a class="header-anchor" href="#b"><span aria-hidden="true" class="header-anchor__symbol">#</span></a></div>
