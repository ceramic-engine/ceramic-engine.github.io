...
subCategory: doc
menu: Haxe
title: StringMapKeyIterator
target: Headless
permalink: api-docs/headless/haxe/ds/_StringMap/StringMapKeyIterator/
---

# StringMapKeyIterator

<div class="type-hierarchy"><strong>haxe.ds._StringMap.StringMapKeyIterator</strong> (private class)</div>
...
<div class="signature field-method no-description" id="next"><code><span class="field-name">next</span><span class="parenthesis">(</span><span class="parenthesis">)</span><span class="operator">:</span> <a href="/api-docs/headless/String/" class="type-link">String</a></code><a class="header-anchor" href="#next"><span aria-hidden="true" class="header-anchor__symbol">#</span></a></div>
