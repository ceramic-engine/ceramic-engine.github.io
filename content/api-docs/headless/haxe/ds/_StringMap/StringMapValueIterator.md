...
subCategory: doc
menu: Haxe
title: StringMapValueIterator
target: Headless
permalink: api-docs/headless/haxe/ds/_StringMap/StringMapValueIterator/
---

# StringMapValueIterator

<div class="type-hierarchy"><strong>haxe.ds._StringMap.StringMapValueIterator</strong> (private class)</div>
...
<div class="signature field-method no-description" id="next"><code><span class="field-name">next</span><span class="parenthesis">(</span><span class="parenthesis">)</span><span class="operator">:</span> <span class="type-name">haxe.ds._StringMap.StringMapValueIterator.T</span></code><a class="header-anchor" href="#next"><span aria-hidden="true" class="header-anchor__symbol">#</span></a></div>

| Returns |
|---------|
| haxe.ds._StringMap.StringMapValueIterator.T |
...
| Name | Type |
|------|------|
| `h` | [Dynamic](/api-docs/headless/Dynamic/) |
...
<div class="signature field-var no-description" id="current"><code><span class="field-name">current</span><span class="operator">:</span> <a href="/api-docs/headless/Int/" class="type-link">Int</a></code><a class="header-anchor" href="#current"><span aria-hidden="true" class="header-anchor__symbol">#</span></a></div>
