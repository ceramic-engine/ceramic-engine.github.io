...
target: Headless
permalink: api-docs/headless/haxe/iterators/DynamicAccessKeyValueIterator/
---
...
| Name | Type |
|------|------|
| `access` | [haxe.DynamicAccess](/api-docs/headless/haxe/DynamicAccess/)<haxe.iterators.DynamicAccessKeyValueIterator.T> |
