...
title: Hmac
target: Headless
permalink: api-docs/headless/haxe/crypto/Hmac/
---
...
| Name | Type |
|------|------|
| `key` | [haxe.io.Bytes](/api-docs/headless/haxe/io/Bytes/) |
| `msg` | [haxe.io.Bytes](/api-docs/headless/haxe/io/Bytes/) |
...
<div class="signature field-var no-description" id="blockSize"><code><span class="field-name">blockSize</span><span class="operator">:</span> <a href="/api-docs/headless/Int/" class="type-link">Int</a></code><a class="header-anchor" href="#blockSize"><span aria-hidden="true" class="header-anchor__symbol">#</span></a></div>
...
<div class="signature field-method no-description" id="doHash"><code><span class="field-name">doHash</span><span class="parenthesis">(</span><span class="arg-name">b</span><span class="operator">:</span> <a href="/api-docs/headless/haxe/io/Bytes/" class="type-link">haxe.io.Bytes</a><span class="parenthesis">)</span><span class="operator">:</span> <a href="/api-docs/headless/haxe/io/Bytes/" class="type-link">haxe.io.Bytes</a></code><a class="header-anchor" href="#doHash"><span aria-hidden="true" class="header-anchor__symbol">#</span></a></div>
