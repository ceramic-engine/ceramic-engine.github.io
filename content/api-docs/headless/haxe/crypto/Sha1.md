...
title: Sha1
target: Headless
permalink: api-docs/headless/haxe/crypto/Sha1/
---
...
<div class="signature field-method has-description" id="kt"><code><span class="field-name">kt</span><span class="parenthesis">(</span><span class="arg-name">t</span><span class="operator">:</span> <a href="/api-docs/headless/Int/" class="type-link">Int</a><span class="parenthesis">)</span><span class="operator">:</span> <a href="/api-docs/headless/Int/" class="type-link">Int</a></code><a class="header-anchor" href="#kt"><span aria-hidden="true" class="header-anchor__symbol">#</span></a></div>
