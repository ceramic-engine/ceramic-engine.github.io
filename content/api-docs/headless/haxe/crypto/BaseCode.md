...
title: BaseCode
target: Headless
permalink: api-docs/headless/haxe/crypto/BaseCode/
---
...
| Name | Type |
|------|------|
| `base` | [haxe.io.Bytes](/api-docs/headless/haxe/io/Bytes/) |

## Private Members

<div class="signature field-var no-description" id="base"><code><span class="field-name">base</span><span class="operator">:</span> <a href="/api-docs/headless/haxe/io/Bytes/" class="type-link">haxe.io.Bytes</a></code><a class="header-anchor" href="#base"><span aria-hidden="true" class="header-anchor__symbol">#</span></a></div>
...
<div class="signature field-method no-description" id="initTable"><code><span class="field-name">initTable</span><span class="parenthesis">(</span><span class="parenthesis">)</span><span class="operator">:</span> <a href="/api-docs/headless/Void/" class="type-link">Void</a></code><a class="header-anchor" href="#initTable"><span aria-hidden="true" class="header-anchor__symbol">#</span></a></div>
