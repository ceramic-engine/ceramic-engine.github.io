...
target: Headless
permalink: api-docs/headless/elements/ColorPickerHSBSpectrumView/
---
...
<div class="type-hierarchy"><a href="/api-docs/headless/ceramic/Entity/">ceramic.Entity</a> → <a href="/api-docs/headless/ceramic/Visual/">ceramic.Visual</a> → <a href="/api-docs/headless/ceramic/Quad/">ceramic.Quad</a> → <a href="/api-docs/headless/ceramic/Layer/">ceramic.Layer</a> → <a href="/api-docs/headless/ceramic/View/">ceramic.View</a> → <strong>elements.ColorPickerHSBSpectrumView</strong> (Class)</div>
...
<div class="see"><strong>See:</strong> <a href="/api-docs/headless/elements/ColorPickerView/">ColorPickerView</a>, <a href="/api-docs/headless/elements/ColorPickerHSBGradientView/">ColorPickerHSBGradientView</a></div>
...
<div class="signature field-var has-description has-plugin" id="huePointer"><div class="plugin-name">elements</div><code><span class="field-name">huePointer</span><span class="operator">:</span> <a href="/api-docs/headless/ceramic/Border/" class="type-link">ceramic.Border</a></code><a class="header-anchor" href="#huePointer"><span aria-hidden="true" class="header-anchor__symbol">#</span></a></div>
...
| Name | Type |
|------|------|
| `instance` | [ColorPickerHSBSpectrumView](/api-docs/headless/elements/ColorPickerHSBSpectrumView/) |
...
|------|------|-------------|
| `hue` | [Float](/api-docs/headless/Float/) | The hue value in degrees (0-360)  |

| Returns | Description |
|---------|-------------|
| [ceramic.AlphaColor](/api-docs/headless/ceramic/AlphaColor/) | An AlphaColor with the specified hue at full saturation/brightness |
