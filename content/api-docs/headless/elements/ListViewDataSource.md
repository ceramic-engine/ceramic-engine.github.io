...
target: Headless
permalink: api-docs/headless/elements/ListViewDataSource/
---
...
<div class="type-implements"><strong>Implements:</strong> <a href="/api-docs/headless/ceramic/CollectionViewDataSource/">ceramic.CollectionViewDataSource</a></div>
...
<div class="see"><strong>See:</strong> CollectionViewDataSource, <a href="/api-docs/headless/elements/ListView/">ListView</a>, <a href="/api-docs/headless/elements/CellView/">CellView</a></div>
...
|------|------|-------------|
| `collectionView` | [ceramic.CollectionView](/api-docs/headless/ceramic/CollectionView/) | The requesting collection view  |

| Returns | Description |
|---------|-------------|
| [Int](/api-docs/headless/Int/) | The number of items in the ListView's items array |
...
|------|------|-------------|
| `collectionView` | [ceramic.CollectionView](/api-docs/headless/ceramic/CollectionView/) | The requesting collection view  |
| `itemIndex` | [Int](/api-docs/headless/Int/) | The index of the item  |
| `frame` | [ceramic.CollectionViewItemFrame](/api-docs/headless/ceramic/CollectionViewItemFrame/) | The frame to configure |
...
|------|------|-------------|
| `collectionView` | [ceramic.CollectionView](/api-docs/headless/ceramic/CollectionView/) | The requesting collection view  |
| `itemIndex` | [Int](/api-docs/headless/Int/) | The index where the view was used  |
...
| Name | Type | Description |
|------|------|-------------|
| `listView` | [ListView](/api-docs/headless/elements/ListView/) | The ListView this data source serves |
