...
title: Scrollbar
target: Headless
permalink: api-docs/headless/elements/Scrollbar/
---
...
<div class="type-hierarchy"><a href="/api-docs/headless/ceramic/Entity/">ceramic.Entity</a> → <a href="/api-docs/headless/ceramic/Visual/">ceramic.Visual</a> → <strong>elements.Scrollbar</strong> (Class)</div>
...
|------|------|-------------|
| `insetTop` | [Float](/api-docs/headless/Float/) | Top inset in pixels  |
| `insetRight` | [Float](/api-docs/headless/Float/) | Right inset in pixels  |
| `insetBottom` | [Float](/api-docs/headless/Float/) | Bottom inset in pixels  |
| `insetLeft` | [Float](/api-docs/headless/Float/) | Left inset in pixels |
...
| Name | Type |
|------|------|
| `instance` | [Scrollbar](/api-docs/headless/elements/Scrollbar/) |
