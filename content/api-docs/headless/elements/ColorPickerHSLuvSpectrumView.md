...
target: Headless
permalink: api-docs/headless/elements/ColorPickerHSLuvSpectrumView/
---
...
<div class="type-hierarchy"><a href="/api-docs/headless/ceramic/Entity/">ceramic.Entity</a> → <a href="/api-docs/headless/ceramic/Visual/">ceramic.Visual</a> → <a href="/api-docs/headless/ceramic/Quad/">ceramic.Quad</a> → <a href="/api-docs/headless/ceramic/Layer/">ceramic.Layer</a> → <a href="/api-docs/headless/ceramic/View/">ceramic.View</a> → <strong>elements.ColorPickerHSLuvSpectrumView</strong> (Class)</div>
...
|------|------|-------------|
| `lightness` | [Float](/api-docs/headless/Float/) | The lightness value (0-1)  |

| Returns | Description |
|---------|-------------|
| [ceramic.AlphaColor](/api-docs/headless/ceramic/AlphaColor/) | The resulting color in HSLuv space with full opacity |
