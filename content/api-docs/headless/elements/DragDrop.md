...
title: DragDrop
target: Headless
permalink: api-docs/headless/elements/DragDrop/
---
...
<div class="type-hierarchy"><a href="/api-docs/headless/ceramic/Entity/">ceramic.Entity</a> → <strong>elements.DragDrop</strong> (Class)</div>

<div class="type-implements"><strong>Implements:</strong> <a href="/api-docs/headless/tracker/Observable/">tracker.Observable</a>, <a href="/api-docs/headless/ceramic/Component/">ceramic.Component</a></div>
...
<div class="signature field-var has-description has-plugin" id="click"><div class="plugin-name">elements</div><code><span class="field-name">click</span><span class="operator">:</span> <a href="/api-docs/headless/ceramic/Click/" class="type-link">ceramic.Click</a></code><a class="header-anchor" href="#click"><span aria-hidden="true" class="header-anchor__symbol">#</span></a></div>
...
|------|------|---------|-------------|
| `pointerX` | [Float](/api-docs/headless/Float/) | *(optional)* | X position to start drag from (defaults to current pointer position)  |
| `pointerY` | [Float](/api-docs/headless/Float/) | *(optional)* | Y position to start drag from (defaults to current pointer position) |
...
| Name | Type | Default | Description |
|------|------|---------|-------------|
| `threshold` | [Float](/api-docs/headless/Float/) | `4.0` | Minimum pointer movement to start drag (default: 4.0 pixels)  |
| `click` | [ceramic.Click](/api-docs/headless/ceramic/Click/) | *(optional)* | Optional click component to cancel when dragging starts  |
...
| Name | Type |
|------|------|
| `instance` | [DragDrop](/api-docs/headless/elements/DragDrop/) |
...
|------|------|-------------|
| `pointerX` | [Float](/api-docs/headless/Float/) | Current pointer X position in screen space  |
| `pointerY` | [Float](/api-docs/headless/Float/) | Current pointer Y position in screen space |
