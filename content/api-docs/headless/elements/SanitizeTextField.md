...
target: Headless
permalink: api-docs/headless/elements/SanitizeTextField/
---
...
|------|------|-------------|
| `field` | [BaseTextFieldView](/api-docs/headless/elements/BaseTextFieldView/) | The text field to update  |
| `textValue` | [String](/api-docs/headless/String/) | The text input to parse  |
| `minValue` | [Int](/api-docs/headless/Int/) | Minimum allowed integer value  |
| `maxValue` | [Int](/api-docs/headless/Int/) | Maximum allowed integer value |

<hr class="field-separator" />

<div class="signature field-method has-description has-plugin" id="setEmptyToInt"><div class="plugin-name">elements</div><code><span class="field-name">setEmptyToInt</span><span class="parenthesis">(</span><span class="arg-name">field</span><span class="operator">:</span> <a href="/api-docs/headless/elements/BaseTextFieldView/" class="type-link">BaseTextFieldView</a><span class="operator">,</span> <span class="arg-name">minValue</span><span class="operator">:</span> <a href="/api-docs/headless/Int/" class="type-link">Int</a><span class="operator">,</span> <span class="arg-name">maxValue</span><span class="operator">:</span> <a href="/api-docs/headless/Int/" class="type-link">Int</a><span class="parenthesis">)</span><span class="operator">:</span> <a href="/api-docs/headless/Int/" class="type-link">Int</a></code><a class="header-anchor" href="#setEmptyToInt"><span aria-hidden="true" class="header-anchor__symbol">#</span></a></div>
...
| `field` | [BaseTextFieldView](/api-docs/headless/elements/BaseTextFieldView/) | The text field to update  |
| `textValue` | [String](/api-docs/headless/String/) | The text input to parse  |
| `minValue` | [Float](/api-docs/headless/Float/) | Minimum allowed float value  |
| `maxValue` | [Float](/api-docs/headless/Float/) | Maximum allowed float value  |
| `round` | [Int](/api-docs/headless/Int/) | Rounding factor (1 = integer, >1 = decimal places)  |
| `finishing` | [Bool](/api-docs/headless/Bool/) | Whether to apply final formatting (true) or preserve editing state (false) |

<hr class="field-separator" />

<div class="signature field-method has-description has-plugin" id="setEmptyToFloat"><div class="plugin-name">elements</div><code><span class="field-name">setEmptyToFloat</span><span class="parenthesis">(</span><span class="arg-name">field</span><span class="operator">:</span> <a href="/api-docs/headless/elements/BaseTextFieldView/" class="type-link">BaseTextFieldView</a><span class="operator">,</span> <span class="arg-name">minValue</span><span class="operator">:</span> <a href="/api-docs/headless/Float/" class="type-link">Float</a><span class="operator">,</span> <span class="arg-name">maxValue</span><span class="operator">:</span> <a href="/api-docs/headless/Float/" class="type-link">Float</a><span class="operator">,</span> <span class="arg-name">round</span><span class="operator">:</span> <a href="/api-docs/headless/Int/" class="type-link">Int</a><span class="parenthesis">)</span><span class="operator">:</span> <a href="/api-docs/headless/Float/" class="type-link">Float</a></code><a class="header-anchor" href="#setEmptyToFloat"><span aria-hidden="true" class="header-anchor__symbol">#</span></a></div>
...
| Returns | Description |
|---------|-------------|
| [Float](/api-docs/headless/Float/) | The assigned default value |

<hr class="field-separator" />

<div class="signature field-method has-description has-plugin" id="setTextValueToEmptyFloat"><div class="plugin-name">elements</div><code><span class="field-name">setTextValueToEmptyFloat</span><span class="parenthesis">(</span><span class="arg-name">field</span><span class="operator">:</span> <a href="/api-docs/headless/elements/BaseTextFieldView/" class="type-link">BaseTextFieldView</a><span class="parenthesis">)</span><span class="operator">:</span> <a href="/api-docs/headless/Void/" class="type-link">Void</a></code><a class="header-anchor" href="#setTextValueToEmptyFloat"><span aria-hidden="true" class="header-anchor__symbol">#</span></a></div>
...
|------|------|-------------|
| `field` | [BaseTextFieldView](/api-docs/headless/elements/BaseTextFieldView/) | The text field to update  |
| `textValue` | [String](/api-docs/headless/String/) | The text input potentially containing math operations  |
| `minValue` | [Float](/api-docs/headless/Float/) | Minimum allowed value  |
| `maxValue` | [Float](/api-docs/headless/Float/) | Maximum allowed value  |
| `castToInt` | [Bool](/api-docs/headless/Bool/) | Whether to treat the result as an integer  |
| `round` | [Int](/api-docs/headless/Int/) | Rounding factor for float values  |

| Returns | Description |
|---------|-------------|
| [Bool](/api-docs/headless/Bool/) | `true` if a mathematical operation was found and processed, `false` otherwise |
