...
title: ItalicText
target: Headless
permalink: api-docs/headless/elements/ItalicText/
---
...
<div class="type-hierarchy"><a href="/api-docs/headless/ceramic/Entity/">ceramic.Entity</a> → <strong>elements.ItalicText</strong> (Class)</div>
...
<div class="see"><strong>See:</strong> <a href="/api-docs/headless/ceramic/Text/">ceramic.Text</a>, <a href="/api-docs/headless/ceramic/GlyphQuad/">ceramic.GlyphQuad</a></div>


## Instance Members

<div class="signature field-var has-description has-plugin" id="entity"><div class="plugin-name">elements</div><code><span class="field-name">entity</span><span class="operator">:</span> <a href="/api-docs/headless/ceramic/Text/" class="type-link">ceramic.Text</a></code><a class="header-anchor" href="#entity"><span aria-hidden="true" class="header-anchor__symbol">#</span></a></div>
