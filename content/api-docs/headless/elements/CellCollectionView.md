...
target: Headless
permalink: api-docs/headless/elements/CellCollectionView/
---
...
<div class="type-hierarchy"><a href="/api-docs/headless/ceramic/Entity/">ceramic.Entity</a> → <a href="/api-docs/headless/ceramic/Visual/">ceramic.Visual</a> → <a href="/api-docs/headless/ceramic/Quad/">ceramic.Quad</a> → <a href="/api-docs/headless/ceramic/Layer/">ceramic.Layer</a> → <a href="/api-docs/headless/ceramic/View/">ceramic.View</a> → <a href="/api-docs/headless/ceramic/ScrollView/">ceramic.ScrollView</a> → <a href="/api-docs/headless/ceramic/CollectionView/">ceramic.CollectionView</a> → <strong>elements.CellCollectionView</strong> (Class)</div>
...
<div class="see"><strong>See:</strong> CollectionView, <a href="/api-docs/headless/elements/Scrollbar/">Scrollbar</a>, <a href="/api-docs/headless/elements/Theme/">Theme</a></div>
...
<div class="signature field-var no-description has-plugin" id="unobservedScrolling"><div class="plugin-name">elements</div><code><span class="field-name">unobservedScrolling</span><span class="operator">:</span> <a href="/api-docs/headless/Bool/" class="type-link">Bool</a></code><a class="header-anchor" href="#unobservedScrolling"><span aria-hidden="true" class="header-anchor__symbol">#</span></a></div>
...
| Name | Type |
|------|------|
| `instance` | [CellCollectionView](/api-docs/headless/elements/CellCollectionView/) |
...
|------|------|-------------|
| `delta` | [Float](/api-docs/headless/Float/) | Time elapsed since last frame (not used) |
