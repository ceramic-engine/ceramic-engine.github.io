...
title: PendingDialog
target: Headless
permalink: api-docs/headless/elements/PendingDialog/
---
...
<div class="type-hierarchy"><a href="/api-docs/headless/ceramic/Entity/">ceramic.Entity</a> → <a href="/api-docs/headless/tracker/Model/">tracker.Model</a> → <strong>elements.PendingDialog</strong> (Class)</div>
...
|------|------|---------|-------------|
| `key` | [String](/api-docs/headless/String/) | *(optional)* | Optional unique identifier for the dialog  |
| `title` | [String](/api-docs/headless/String/) | | Title text for the dialog header  |
| `message` | [String](/api-docs/headless/String/) | | Main message text for the dialog body  |
| `prompt` | [Bool](/api-docs/headless/Bool/) | `false` | Whether to include a text input prompt  |
| `promptPointer` | [StringPointer](/api-docs/headless/elements/StringPointer/) | *(optional)* | Optional string pointer for prompt value binding  |
| `promptPlaceholder` | [String](/api-docs/headless/String/) | *(optional)* | Placeholder text for the prompt input  |
| `choices` | [Array](/api-docs/headless/Array/)<[String](/api-docs/headless/String/)> | | Array of button labels for user choices  |
| `cancelable` | [Bool](/api-docs/headless/Bool/) | `false` | Whether the dialog can be canceled  |
| `width` | [Float](/api-docs/headless/Float/) | `-1` | Fixed width (-1 for auto-sizing)  |
| `height` | [Float](/api-docs/headless/Float/) | `-1` | Fixed height (-1 for auto-sizing)  |
| `async` | [Bool](/api-docs/headless/Bool/) | | Whether the dialog operates asynchronously  |
