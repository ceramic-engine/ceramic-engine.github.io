...
title: FieldSystem
target: Headless
permalink: api-docs/headless/elements/FieldSystem/
---
...
| Name | Type |
|------|------|
| `instance` | [FieldSystem](/api-docs/headless/elements/FieldSystem/) |
...
| Name | Type |
|------|------|
| `current` | [FieldView](/api-docs/headless/elements/FieldView/) |
| `previous` | [FieldView](/api-docs/headless/elements/FieldView/) |
...
|------|------|-------------|
| `focusedField` | [FieldView](/api-docs/headless/elements/FieldView/) | The newly focused field (may be null)  |
| `prevFocusedField` | [FieldView](/api-docs/headless/elements/FieldView/) | The previously focused field (may be null) |
