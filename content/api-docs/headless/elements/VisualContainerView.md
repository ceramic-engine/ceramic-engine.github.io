...
target: Headless
permalink: api-docs/headless/elements/VisualContainerView/
---
...
<div class="type-hierarchy"><a href="/api-docs/headless/ceramic/Entity/">ceramic.Entity</a> → <a href="/api-docs/headless/ceramic/Visual/">ceramic.Visual</a> → <a href="/api-docs/headless/ceramic/Quad/">ceramic.Quad</a> → <a href="/api-docs/headless/ceramic/Layer/">ceramic.Layer</a> → <a href="/api-docs/headless/ceramic/View/">ceramic.View</a> → <strong>elements.VisualContainerView</strong> (Class)</div>
...
<div class="see"><strong>See:</strong> <a href="/api-docs/headless/elements/VisualContainerViewScaling/">VisualContainerViewScaling</a>, Filter, Visual, LayoutAlign</div>
...
<div class="see"><strong>See:</strong> <a href="/api-docs/headless/elements/VisualContainerViewScaling/">VisualContainerViewScaling</a>, visualScale</div>
...
|------|------|-------------|
| `parentWidth` | [Float](/api-docs/headless/Float/) | Available width from the parent  |
| `parentHeight` | [Float](/api-docs/headless/Float/) | Available height from the parent  |
| `layoutMask` | [ceramic.ViewLayoutMask](/api-docs/headless/ceramic/ViewLayoutMask/) | Layout constraints mask  |
| `persist` | [Bool](/api-docs/headless/Bool/) | Whether to persist the computed values  |
...
<div class="signature field-var no-description has-plugin" id="unobservedVisualScale"><div class="plugin-name">elements</div><code><span class="field-name">unobservedVisualScale</span><span class="operator">:</span> <a href="/api-docs/headless/Float/" class="type-link">Float</a></code><a class="header-anchor" href="#unobservedVisualScale"><span aria-hidden="true" class="header-anchor__symbol">#</span></a></div>
