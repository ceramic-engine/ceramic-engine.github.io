...
target: Headless
permalink: api-docs/headless/elements/EnumAbstractInfo/
---
...
| Returns | Description |
|---------|-------------|
| [Array](/api-docs/headless/Array/)<[String](/api-docs/headless/String/)> | Array of enum field names as strings |
...
|------|------|-------------|
| `value` | [Dynamic](/api-docs/headless/Dynamic/) | The enum value to look up  |

| Returns | Description |
|---------|-------------|
| [Null](/api-docs/headless/Null/)<[String](/api-docs/headless/String/)> | The field name if found, null otherwise |

<hr class="field-separator" />

<div class="signature field-method has-description has-plugin" id="createEnumValue"><div class="plugin-name">elements</div><code><span class="field-name">createEnumValue</span><span class="parenthesis">(</span><span class="arg-name">name</span><span class="operator">:</span> <a href="/api-docs/headless/String/" class="type-link">String</a><span class="parenthesis">)</span><span class="operator">:</span> <a href="/api-docs/headless/Dynamic/" class="type-link">Dynamic</a></code><a class="header-anchor" href="#createEnumValue"><span aria-hidden="true" class="header-anchor__symbol">#</span></a></div>
...
| Name | Type | Description |
|------|------|-------------|
| `name` | [String](/api-docs/headless/String/) | The enum field name to look up  |

| Returns | Description |
|---------|-------------|
| [Dynamic](/api-docs/headless/Dynamic/) | The corresponding enum value if found, null otherwise |
...
| Name | Type | Description |
|------|------|-------------|
| `enumFields` | [Array](/api-docs/headless/Array/)<[String](/api-docs/headless/String/)> | Array of enum field names (e.g., ["OPTION_A", "OPTION_B"])  |
| `enumValues` | [Array](/api-docs/headless/Array/)<[Dynamic](/api-docs/headless/Dynamic/)> | Array of corresponding values (e.g., [1, 2]) |
