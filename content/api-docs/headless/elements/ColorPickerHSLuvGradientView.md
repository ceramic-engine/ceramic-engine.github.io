...
target: Headless
permalink: api-docs/headless/elements/ColorPickerHSLuvGradientView/
---
...
<div class="type-hierarchy"><a href="/api-docs/headless/ceramic/Entity/">ceramic.Entity</a> → <a href="/api-docs/headless/ceramic/Visual/">ceramic.Visual</a> → <a href="/api-docs/headless/ceramic/Quad/">ceramic.Quad</a> → <a href="/api-docs/headless/ceramic/Layer/">ceramic.Layer</a> → <a href="/api-docs/headless/ceramic/View/">ceramic.View</a> → <strong>elements.ColorPickerHSLuvGradientView</strong> (Class)</div>
...
|------|------|---------|-------------|
| `lightness` | [Float](/api-docs/headless/Float/) | *(optional)* | Optional new lightness value (0-1) |

<hr class="field-separator" />

<div class="signature field-method has-description has-plugin" id="savePointerPosition"><div class="plugin-name">elements</div><code><span class="field-name">savePointerPosition</span><span class="parenthesis">(</span><span class="parenthesis">)</span><span class="operator">:</span> <a href="/api-docs/headless/Void/" class="type-link">Void</a></code><a class="header-anchor" href="#savePointerPosition"><span aria-hidden="true" class="header-anchor__symbol">#</span></a></div>
...
|------|------|-------------|
| `hue` | [Float](/api-docs/headless/Float/) | Hue value in degrees (0-360)  |
| `saturation` | [Float](/api-docs/headless/Float/) | Saturation value (0-1)  |

| Returns | Description |
|---------|-------------|
| [ceramic.AlphaColor](/api-docs/headless/ceramic/AlphaColor/) | The resulting color with full opacity |

<hr class="field-separator" />

<div class="signature field-method has-description has-plugin" id="updatePointerFromColor"><div class="plugin-name">elements</div><code><span class="field-name">updatePointerFromColor</span><span class="parenthesis">(</span><span class="parenthesis">)</span><span class="operator">:</span> <a href="/api-docs/headless/Void/" class="type-link">Void</a></code><a class="header-anchor" href="#updatePointerFromColor"><span aria-hidden="true" class="header-anchor__symbol">#</span></a></div>
...
| Name | Type | Description |
|------|------|-------------|
| `info` | [ceramic.TouchInfo](/api-docs/headless/ceramic/TouchInfo/) | Touch/mouse information |
...
| Name | Type | Description |
|------|------|-------------|
| `info` | [ceramic.TouchInfo](/api-docs/headless/ceramic/TouchInfo/) | Touch/mouse information containing screen coordinates |
