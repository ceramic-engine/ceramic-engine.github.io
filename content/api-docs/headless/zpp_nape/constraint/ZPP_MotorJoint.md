...
target: Headless
permalink: api-docs/headless/zpp_nape/constraint/ZPP_MotorJoint/
---
...
<div class="type-hierarchy"><a href="/api-docs/headless/zpp_nape/constraint/ZPP_Constraint/">ZPP_Constraint</a> → <strong>zpp_nape.constraint.ZPP_MotorJoint</strong> (Class)</div>

## Instance Members

<div class="signature field-var no-description has-plugin" id="outer_zn"><div class="plugin-name">nape</div><code><span class="field-name">outer_zn</span><span class="operator">:</span> <a href="/api-docs/headless/nape/constraint/MotorJoint/" class="type-link">nape.constraint.MotorJoint</a></code><a class="header-anchor" href="#outer_zn"><span aria-hidden="true" class="header-anchor__symbol">#</span></a></div>
...
<div class="signature field-var no-description has-plugin" id="rate"><div class="plugin-name">nape</div><code><span class="field-name">rate</span><span class="operator">:</span> <a href="/api-docs/headless/Float/" class="type-link">Float</a></code><a class="header-anchor" href="#rate"><span aria-hidden="true" class="header-anchor__symbol">#</span></a></div>
