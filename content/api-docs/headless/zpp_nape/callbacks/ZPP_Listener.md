...
title: ZPP_Listener
target: Headless
permalink: api-docs/headless/zpp_nape/callbacks/ZPP_Listener/
---
...
<div class="type-hierarchy"><strong>zpp_nape.callbacks.ZPP_Listener</strong> (Class) → <a href="/api-docs/headless/zpp_nape/callbacks/ZPP_BodyListener/">ZPP_BodyListener</a>, <a href="/api-docs/headless/zpp_nape/callbacks/ZPP_ConstraintListener/">ZPP_ConstraintListener</a>, <a href="/api-docs/headless/zpp_nape/callbacks/ZPP_InteractionListener/">ZPP_InteractionListener</a></div>
...
| Name | Type |
|------|------|
| `a` | [ZPP_Listener](/api-docs/headless/zpp_nape/callbacks/ZPP_Listener/) |
| `b` | [ZPP_Listener](/api-docs/headless/zpp_nape/callbacks/ZPP_Listener/) |
...
<div class="signature field-var no-description has-plugin" id="outer"><div class="plugin-name">nape</div><code><span class="field-name">outer</span><span class="operator">:</span> <a href="/api-docs/headless/nape/callbacks/Listener/" class="type-link">nape.callbacks.Listener</a></code><a class="header-anchor" href="#outer"><span aria-hidden="true" class="header-anchor__symbol">#</span></a></div>
