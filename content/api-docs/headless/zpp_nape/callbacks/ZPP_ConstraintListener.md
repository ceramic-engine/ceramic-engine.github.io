...
subCategory: doc
menu: Nape
title: ZPP_ConstraintListener
target: Headless
permalink: api-docs/headless/zpp_nape/callbacks/ZPP_ConstraintListener/
---
...
<div class="type-hierarchy"><a href="/api-docs/headless/zpp_nape/callbacks/ZPP_Listener/">ZPP_Listener</a> → <strong>zpp_nape.callbacks.ZPP_ConstraintListener</strong> (Class)</div>

## Instance Members

<div class="signature field-var no-description has-plugin" id="outer_zn"><div class="plugin-name">nape</div><code><span class="field-name">outer_zn</span><span class="operator">:</span> <a href="/api-docs/headless/nape/callbacks/ConstraintListener/" class="type-link">nape.callbacks.ConstraintListener</a></code><a class="header-anchor" href="#outer_zn"><span aria-hidden="true" class="header-anchor__symbol">#</span></a></div>
...
| Name | Type |
|------|------|
| `options` | [nape.callbacks.OptionType](/api-docs/headless/nape/callbacks/OptionType/) |
| `event` | [Int](/api-docs/headless/Int/) |
| `handler` | Function |

## Private Members

<div class="signature field-method no-description has-plugin" id="immutable_options"><div class="plugin-name">nape</div><code><span class="field-name">immutable_options</span><span class="parenthesis">(</span><span class="parenthesis">)</span><span class="operator">:</span> <a href="/api-docs/headless/Void/" class="type-link">Void</a></code><a class="header-anchor" href="#immutable_options"><span aria-hidden="true" class="header-anchor__symbol">#</span></a></div>
