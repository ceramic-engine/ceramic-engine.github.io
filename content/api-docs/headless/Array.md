...
title: Array
target: Headless
permalink: api-docs/headless/Array/
---

# Array

<div class="type-hierarchy"><strong>Array</strong> (extern class) → <a href="/api-docs/headless/js/lib/RegExpMatch/">js.lib.RegExpMatch</a></div>
...
| Name | Type |
|------|------|
| `a` | [Array](/api-docs/headless/Array/)<Array.T> |

| Returns |
|---------|
| [Array](/api-docs/headless/Array/)<Array.T> |
...
| Name | Type |
|------|------|
| `sep` | [String](/api-docs/headless/String/) |
