...
title: Filter
target: Headless
permalink: api-docs/headless/fuzzaldrin/Filter/
---
...
| `queryHasSlashes` | [Bool](/api-docs/headless/Bool/) | |
...
<div class="signature field-method no-description" id="pluckCandidates"><code><span class="field-name">pluckCandidates</span><span class="parenthesis">(</span><span class="arg-name">a</span><span class="operator">:</span> <span class="type-name">AnonStruct</span><span class="parenthesis">)</span><span class="operator">:</span> <a href="/api-docs/headless/Dynamic/" class="type-link">Dynamic</a></code><a class="header-anchor" href="#pluckCandidates"><span aria-hidden="true" class="header-anchor__symbol">#</span></a></div>
