...
title: Mat23
target: Headless
permalink: api-docs/headless/nape/geom/Mat23/
---
...
|------|------|-------------|
| `angle` | [Float](/api-docs/headless/Float/) | The clockwise rotation in radians  |

| Returns | Description |
|---------|-------------|
| [Mat23](/api-docs/headless/nape/geom/Mat23/) | The rotation matrix. |
...
| Name | Type | Description |
|------|------|-------------|
| `tx` | [Float](/api-docs/headless/Float/) | The x translation.  |
| `ty` | [Float](/api-docs/headless/Float/) | The y translation.  |

| Returns | Description |
|---------|-------------|
| [Mat23](/api-docs/headless/nape/geom/Mat23/) | The translation matrix. |
...
| Name | Type | Description |
|------|------|-------------|
| `sx` | [Float](/api-docs/headless/Float/) | The x factor of scaling.  |
| `sy` | [Float](/api-docs/headless/Float/) | The y factor of scaling.  |

| Returns | Description |
|---------|-------------|
| [Mat23](/api-docs/headless/nape/geom/Mat23/) | The scaling matrix. |

## Instance Members

<div class="signature field-var has-description has-plugin" id="zpp_inner"><div class="plugin-name">nape</div><code><span class="field-name">zpp_inner</span><span class="operator">:</span> <a href="/api-docs/headless/zpp_nape/geom/ZPP_Mat23/" class="type-link">zpp_nape.geom.ZPP_Mat23</a></code><a class="header-anchor" href="#zpp_inner"><span aria-hidden="true" class="header-anchor__symbol">#</span></a></div>
...
| Returns | Description |
|---------|-------------|
| [Mat23](/api-docs/headless/nape/geom/Mat23/) | The new Mat23 representing copy of this. |
...
| Name | Type | Description |
|------|------|-------------|
| `matrix` | [Mat23](/api-docs/headless/nape/geom/Mat23/) | The matrix to copy values from.  |

| Returns | Description |
|---------|-------------|
| [Mat23](/api-docs/headless/nape/geom/Mat23/) | A reference to this Mat23.  |
...
|------|------|---------|-------------|
| `a` | [Float](/api-docs/headless/Float/) | `1.0` | The value to which the (1,1) entry will be set (default 1)  |
| `b` | [Float](/api-docs/headless/Float/) | `0.0` | The value to which the (1,2) entry will be set (default 0)  |
| `c` | [Float](/api-docs/headless/Float/) | `0.0` | The value to which the (2,1) entry will be set (default 0)  |
| `d` | [Float](/api-docs/headless/Float/) | `1.0` | The value to which the (2,2) entry will be set (default 1)  |
| `tx` | [Float](/api-docs/headless/Float/) | `0.0` | The value to which the (1,3) entry will be set (default 0)  |
| `ty` | [Float](/api-docs/headless/Float/) | `0.0` | The value to which the (2,3) entry will be set (default 0)  |
...
| Returns | Description |
|---------|-------------|
| [Bool](/api-docs/headless/Bool/) | True, if matrix is singular. |
...
| Returns | Description |
|---------|-------------|
| [Mat23](/api-docs/headless/nape/geom/Mat23/) | The inverse matrix.  |
...
| Returns | Description |
|---------|-------------|
| [Mat23](/api-docs/headless/nape/geom/Mat23/) | The transposed matrix. |
...
| Name | Type | Description |
|------|------|-------------|
| `matrix` | [Mat23](/api-docs/headless/nape/geom/Mat23/) | Matrix to concatenate with.  |

| Returns | Description |
|---------|-------------|
| [Mat23](/api-docs/headless/nape/geom/Mat23/) | The result of the concatenation.  |
...
| Name | Type | Default | Description |
|------|------|---------|-------------|
| `point` | [Vec2](/api-docs/headless/nape/geom/Vec2/) | | The Vec2 to transform by this matrix.  |
| `noTranslation` | [Bool](/api-docs/headless/Bool/) | `false` | If true, then the input Vec2 will be treat as a vector, rather than a point with the tx/ty values treat as 0. (default false)  |
| `weak` | [Bool](/api-docs/headless/Bool/) | `false` | If true, then the allocated Vec2 will be automatically released to global object pool when used as an argument to a Nape function.  |

| Returns | Description |
|---------|-------------|
| [Vec2](/api-docs/headless/nape/geom/Vec2/) | The result of the transformation as a newly allocated (possibly weak) Vec2. (default false)  |
...
| Name | Type | Default | Description |
|------|------|---------|-------------|
| `point` | [Vec2](/api-docs/headless/nape/geom/Vec2/) | | The Vec2 to transform.  |
| `noTranslation` | [Bool](/api-docs/headless/Bool/) | `false` | If true then the input Vec2 will be treat as a vector instead of a point, treating the tx/ty values of this Mat23 as though they were 0. (default false)  |
| `weak` | [Bool](/api-docs/headless/Bool/) | `false` | If true, then the allocated Vec2 will be automatically released to global object pool when used as an argument to a Nape function.  |
...
| Returns | Description |
|---------|-------------|
| [Bool](/api-docs/headless/Bool/) | True if matrix is equiorthogonal. |

<hr class="field-separator" />

<div class="signature field-method has-description has-plugin" id="orthogonal"><div class="plugin-name">nape</div><code><span class="field-name">orthogonal</span><span class="parenthesis">(</span><span class="parenthesis">)</span><span class="operator">:</span> <a href="/api-docs/headless/Bool/" class="type-link">Bool</a></code><a class="header-anchor" href="#orthogonal"><span aria-hidden="true" class="header-anchor__symbol">#</span></a></div>
...
| Returns | Description |
|---------|-------------|
| [Bool](/api-docs/headless/Bool/) | True if matrix is orthogonal. |
...
| Name | Type | Default | Description |
|------|------|---------|-------------|
| `a` | [Float](/api-docs/headless/Float/) | `1.0` | The (1,1) entry in matrix (default 1)  |
| `b` | [Float](/api-docs/headless/Float/) | `0.0` | The (1,2) entry in matrix (default 0)  |
| `c` | [Float](/api-docs/headless/Float/) | `0.0` | The (2,1) entry in matrix (default 0)  |
| `d` | [Float](/api-docs/headless/Float/) | `1.0` | The (2,2) entry in matrix (default 1)  |
| `tx` | [Float](/api-docs/headless/Float/) | `0.0` | The (1,3) entry in matrix (default 0)  |
| `ty` | [Float](/api-docs/headless/Float/) | `0.0` | The (2,3) entry in matrix (default 0)  |
