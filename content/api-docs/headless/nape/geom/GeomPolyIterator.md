...
target: Headless
permalink: api-docs/headless/nape/geom/GeomPolyIterator/
---
...
|------|------|-------------|
| `list` | [GeomPolyList](/api-docs/headless/nape/geom/GeomPolyList/) | The Nape list to create iterator for.  |

| Returns | Description |
|---------|-------------|
| [GeomPolyIterator](/api-docs/headless/nape/geom/GeomPolyIterator/) | An iterator over the Nape list. |
...
| Returns | Description |
|---------|-------------|
| [GeomPoly](/api-docs/headless/nape/geom/GeomPoly/) | The next element in iteration. |
