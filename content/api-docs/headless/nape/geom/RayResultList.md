...
title: RayResultList
target: Headless
permalink: api-docs/headless/nape/geom/RayResultList/
---

# RayResultList

<div class="view-source"><a href="https://github.com/ceramic-engine/nape/blob/master/nape/geom/RayResultList.hx">View source</a></div>

<div class="type-hierarchy"><strong>nape.geom.RayResultList</strong> (final class)</div>
...
<div class="signature field-method has-description has-plugin" id="fromArray"><div class="plugin-name">nape</div><code><span class="field-name">fromArray</span><span class="parenthesis">(</span><span class="arg-name">array</span><span class="operator">:</span> <a href="/api-docs/headless/Array/" class="type-link">Array</a><span class="operator">&lt;</span><a href="/api-docs/headless/nape/geom/RayResult/" class="type-link">RayResult</a><span class="operator">&gt;</span><span class="parenthesis">)</span><span class="operator">:</span> <a href="#" class="type-link">RayResultList</a></code><a class="header-anchor" href="#fromArray"><span aria-hidden="true" class="header-anchor__symbol">#</span></a></div>
...
|------|------|-------------|
| `array` | [Array](/api-docs/headless/Array/)<[RayResult](/api-docs/headless/nape/geom/RayResult/)> | The array to be converted  |

| Returns | Description |
|---------|-------------|
| [RayResultList](/api-docs/headless/nape/geom/RayResultList/) | An equivalent Nape list.  |

## Instance Members

<div class="signature field-var has-description has-plugin" id="zpp_inner"><div class="plugin-name">nape</div><code><span class="field-name">zpp_inner</span><span class="operator">:</span> <a href="/api-docs/headless/zpp_nape/util/ZPP_RayResultList/" class="type-link">zpp_nape.util.ZPP_RayResultList</a></code><a class="header-anchor" href="#zpp_inner"><span aria-hidden="true" class="header-anchor__symbol">#</span></a></div>
...
| Name | Type | Description |
|------|------|-------------|
| `obj` | [RayResult](/api-docs/headless/nape/geom/RayResult/) | The object to test.  |
...
| Returns |
|---------|
| [RayResult](/api-docs/headless/nape/geom/RayResult/) |
...
| Name | Type | Description |
|------|------|-------------|
| `obj` | [RayResult](/api-docs/headless/nape/geom/RayResult/) | The object to insert.  |
...
| Name | Type | Description |
|------|------|-------------|
| `obj` | [RayResult](/api-docs/headless/nape/geom/RayResult/) | The object to remove  |
...
<div class="signature field-method has-description has-plugin" id="iterator"><div class="plugin-name">nape</div><code><span class="field-name">iterator</span><span class="parenthesis">(</span><span class="parenthesis">)</span><span class="operator">:</span> <a href="/api-docs/headless/nape/geom/RayResultIterator/" class="type-link">RayResultIterator</a></code><a class="header-anchor" href="#iterator"><span aria-hidden="true" class="header-anchor__symbol">#</span></a></div>
...
| Name | Type | Description |
|------|------|-------------|
| `xs` | [RayResultList](/api-docs/headless/nape/geom/RayResultList/) | The list to merge.  |
...
| Returns | Description |
|---------|-------------|
| [RayResultList](/api-docs/headless/nape/geom/RayResultList/) | A reference to 'this' list.  |

<hr class="field-separator" />

<div class="signature field-method has-description has-plugin" id="filter"><div class="plugin-name">nape</div><code><span class="field-name">filter</span><span class="parenthesis">(</span><span class="arg-name">lambda</span><span class="operator">:</span> <span class="type-name">Function</span><span class="parenthesis">)</span><span class="operator">:</span> <a href="#" class="type-link">RayResultList</a></code><a class="header-anchor" href="#filter"><span aria-hidden="true" class="header-anchor__symbol">#</span></a></div>
