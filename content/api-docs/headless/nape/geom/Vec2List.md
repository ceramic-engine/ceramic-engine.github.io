...
title: Vec2List
target: Headless
permalink: api-docs/headless/nape/geom/Vec2List/
---

# Vec2List

<div class="view-source"><a href="https://github.com/ceramic-engine/nape/blob/master/nape/geom/Vec2List.hx">View source</a></div>

<div class="type-hierarchy"><strong>nape.geom.Vec2List</strong> (Class) → <a href="/api-docs/headless/zpp_nape/util/ZPP_MixVec2List/">zpp_nape.util.ZPP_MixVec2List</a></div>
...
|------|------|-------------|
| `array` | [Array](/api-docs/headless/Array/)<[Vec2](/api-docs/headless/nape/geom/Vec2/)> | The array to be converted  |

| Returns | Description |
|---------|-------------|
| [Vec2List](/api-docs/headless/nape/geom/Vec2List/) | An equivalent Nape list.  |

## Instance Members

<div class="signature field-var has-description has-plugin" id="zpp_inner"><div class="plugin-name">nape</div><code><span class="field-name">zpp_inner</span><span class="operator">:</span> <a href="/api-docs/headless/zpp_nape/util/ZPP_Vec2List/" class="type-link">zpp_nape.util.ZPP_Vec2List</a></code><a class="header-anchor" href="#zpp_inner"><span aria-hidden="true" class="header-anchor__symbol">#</span></a></div>
...
| Name | Type | Description |
|------|------|-------------|
| `obj` | [Vec2](/api-docs/headless/nape/geom/Vec2/) | The object to test.  |
...
| Returns |
|---------|
| [Vec2](/api-docs/headless/nape/geom/Vec2/) |
...
| Name | Type | Description |
|------|------|-------------|
| `obj` | [Vec2](/api-docs/headless/nape/geom/Vec2/) | The object to insert.  |
...
| Name | Type | Description |
|------|------|-------------|
| `obj` | [Vec2](/api-docs/headless/nape/geom/Vec2/) | The object to remove  |
...
| Name | Type | Description |
|------|------|-------------|
| `xs` | [Vec2List](/api-docs/headless/nape/geom/Vec2List/) | The list to merge.  |
...
| Returns | Description |
|---------|-------------|
| [Vec2List](/api-docs/headless/nape/geom/Vec2List/) | A reference to 'this' list.  |

<hr class="field-separator" />

<div class="signature field-method has-description has-plugin" id="filter"><div class="plugin-name">nape</div><code><span class="field-name">filter</span><span class="parenthesis">(</span><span class="arg-name">lambda</span><span class="operator">:</span> <span class="type-name">Function</span><span class="parenthesis">)</span><span class="operator">:</span> <a href="#" class="type-link">Vec2List</a></code><a class="header-anchor" href="#filter"><span aria-hidden="true" class="header-anchor__symbol">#</span></a></div>
