...
title: PreCallback
target: Headless
permalink: api-docs/headless/nape/callbacks/PreCallback/
---
...
<div class="type-hierarchy"><a href="/api-docs/headless/nape/callbacks/Callback/">Callback</a> → <strong>nape.callbacks.PreCallback</strong> (final class)</div>
...
<div class="signature field-var has-description has-plugin" id="arbiter"><div class="plugin-name">nape</div><code><span class="field-name">arbiter</span><span class="operator">:</span> <a href="/api-docs/headless/nape/dynamics/Arbiter/" class="type-link">nape.dynamics.Arbiter</a></code><a class="header-anchor" href="#arbiter"><span aria-hidden="true" class="header-anchor__symbol">#</span></a></div>
...
<div class="signature field-var has-description has-plugin" id="int1"><div class="plugin-name">nape</div><code><span class="field-name">int1</span><span class="operator">:</span> <a href="/api-docs/headless/nape/phys/Interactor/" class="type-link">nape.phys.Interactor</a></code><a class="header-anchor" href="#int1"><span aria-hidden="true" class="header-anchor__symbol">#</span></a></div>
