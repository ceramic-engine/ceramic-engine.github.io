...
title: BodyListener
target: Headless
permalink: api-docs/headless/nape/callbacks/BodyListener/
---
...
<div class="type-hierarchy"><a href="/api-docs/headless/nape/callbacks/Listener/">Listener</a> → <strong>nape.callbacks.BodyListener</strong> (final class)</div>
...
| `options` | [Null](/api-docs/headless/Null/)<[Dynamic](/api-docs/headless/Dynamic/)> | | The OptionType to match Bodys against, passing null will equate to an empty OptionType.  |
