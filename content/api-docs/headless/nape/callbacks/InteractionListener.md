...
target: Headless
permalink: api-docs/headless/nape/callbacks/InteractionListener/
---
...
<div class="type-hierarchy"><a href="/api-docs/headless/nape/callbacks/Listener/">Listener</a> → <strong>nape.callbacks.InteractionListener</strong> (final class)</div>
...
|------|------|---------|-------------|
| `event` | [CbEvent](/api-docs/headless/nape/callbacks/CbEvent/) | | The event type to listen for.  |
