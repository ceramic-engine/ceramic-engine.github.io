...
subCategory: doc
menu: Nape
title: InteractorList
target: Headless
permalink: api-docs/headless/nape/phys/InteractorList/
---

# InteractorList

<div class="view-source"><a href="https://github.com/ceramic-engine/nape/blob/master/nape/phys/InteractorList.hx">View source</a></div>

<div class="type-hierarchy"><strong>nape.phys.InteractorList</strong> (final class)</div>
...
<div class="signature field-method has-description has-plugin" id="fromArray"><div class="plugin-name">nape</div><code><span class="field-name">fromArray</span><span class="parenthesis">(</span><span class="arg-name">array</span><span class="operator">:</span> <a href="/api-docs/headless/Array/" class="type-link">Array</a><span class="operator">&lt;</span><a href="/api-docs/headless/nape/phys/Interactor/" class="type-link">Interactor</a><span class="operator">&gt;</span><span class="parenthesis">)</span><span class="operator">:</span> <a href="#" class="type-link">InteractorList</a></code><a class="header-anchor" href="#fromArray"><span aria-hidden="true" class="header-anchor__symbol">#</span></a></div>
...
|------|------|-------------|
| `array` | [Array](/api-docs/headless/Array/)<[Interactor](/api-docs/headless/nape/phys/Interactor/)> | The array to be converted  |

| Returns | Description |
|---------|-------------|
| [InteractorList](/api-docs/headless/nape/phys/InteractorList/) | An equivalent Nape list.  |

## Instance Members

<div class="signature field-var has-description has-plugin" id="zpp_inner"><div class="plugin-name">nape</div><code><span class="field-name">zpp_inner</span><span class="operator">:</span> <a href="/api-docs/headless/zpp_nape/util/ZPP_InteractorList/" class="type-link">zpp_nape.util.ZPP_InteractorList</a></code><a class="header-anchor" href="#zpp_inner"><span aria-hidden="true" class="header-anchor__symbol">#</span></a></div>
...
| Name | Type | Description |
|------|------|-------------|
| `obj` | [Interactor](/api-docs/headless/nape/phys/Interactor/) | The object to test.  |
...
| Returns |
|---------|
| [Interactor](/api-docs/headless/nape/phys/Interactor/) |
...
| Name | Type | Description |
|------|------|-------------|
| `obj` | [Interactor](/api-docs/headless/nape/phys/Interactor/) | The object to insert.  |
...
| Name | Type | Description |
|------|------|-------------|
| `obj` | [Interactor](/api-docs/headless/nape/phys/Interactor/) | The object to remove  |
...
<div class="signature field-method has-description has-plugin" id="iterator"><div class="plugin-name">nape</div><code><span class="field-name">iterator</span><span class="parenthesis">(</span><span class="parenthesis">)</span><span class="operator">:</span> <a href="/api-docs/headless/nape/phys/InteractorIterator/" class="type-link">InteractorIterator</a></code><a class="header-anchor" href="#iterator"><span aria-hidden="true" class="header-anchor__symbol">#</span></a></div>
...
| Name | Type | Description |
|------|------|-------------|
| `xs` | [InteractorList](/api-docs/headless/nape/phys/InteractorList/) | The list to merge.  |
...
| Returns | Description |
|---------|-------------|
| [InteractorList](/api-docs/headless/nape/phys/InteractorList/) | A reference to 'this' list.  |

<hr class="field-separator" />

<div class="signature field-method has-description has-plugin" id="filter"><div class="plugin-name">nape</div><code><span class="field-name">filter</span><span class="parenthesis">(</span><span class="arg-name">lambda</span><span class="operator">:</span> <span class="type-name">Function</span><span class="parenthesis">)</span><span class="operator">:</span> <a href="#" class="type-link">InteractorList</a></code><a class="header-anchor" href="#filter"><span aria-hidden="true" class="header-anchor__symbol">#</span></a></div>
