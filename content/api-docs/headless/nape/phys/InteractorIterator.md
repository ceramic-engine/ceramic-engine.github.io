...
target: Headless
permalink: api-docs/headless/nape/phys/InteractorIterator/
---
...
|------|------|-------------|
| `list` | [InteractorList](/api-docs/headless/nape/phys/InteractorList/) | The Nape list to create iterator for.  |

| Returns | Description |
|---------|-------------|
| [InteractorIterator](/api-docs/headless/nape/phys/InteractorIterator/) | An iterator over the Nape list. |
...
| Returns | Description |
|---------|-------------|
| [Interactor](/api-docs/headless/nape/phys/Interactor/) | The next element in iteration. |
