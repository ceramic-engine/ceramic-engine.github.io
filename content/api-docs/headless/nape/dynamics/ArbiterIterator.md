...
target: Headless
permalink: api-docs/headless/nape/dynamics/ArbiterIterator/
---
...
|------|------|-------------|
| `list` | [ArbiterList](/api-docs/headless/nape/dynamics/ArbiterList/) | The Nape list to create iterator for.  |

| Returns | Description |
|---------|-------------|
| [ArbiterIterator](/api-docs/headless/nape/dynamics/ArbiterIterator/) | An iterator over the Nape list. |
...
| Returns | Description |
|---------|-------------|
| [Arbiter](/api-docs/headless/nape/dynamics/Arbiter/) | The next element in iteration. |
