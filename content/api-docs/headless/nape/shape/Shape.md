...
title: Shape
target: Headless
permalink: api-docs/headless/nape/shape/Shape/
---
...
<div class="type-hierarchy"><a href="/api-docs/headless/nape/phys/Interactor/">nape.phys.Interactor</a> → <strong>nape.shape.Shape</strong> (Class) → <a href="/api-docs/headless/nape/shape/Circle/">Circle</a>, <a href="/api-docs/headless/nape/shape/Polygon/">Polygon</a></div>
...
<div class="signature field-var has-description has-plugin" id="filter"><div class="plugin-name">nape</div><code><span class="field-name">filter</span><span class="operator">:</span> <a href="/api-docs/headless/nape/dynamics/InteractionFilter/" class="type-link">nape.dynamics.InteractionFilter</a></code><a class="header-anchor" href="#filter"><span aria-hidden="true" class="header-anchor__symbol">#</span></a></div>
...
<div class="signature field-var has-description has-plugin" id="fluidProperties"><div class="plugin-name">nape</div><code><span class="field-name">fluidProperties</span><span class="operator">:</span> <a href="/api-docs/headless/nape/phys/FluidProperties/" class="type-link">nape.phys.FluidProperties</a></code><a class="header-anchor" href="#fluidProperties"><span aria-hidden="true" class="header-anchor__symbol">#</span></a></div>
...
| Returns | Description |
|---------|-------------|
| [Bool](/api-docs/headless/Bool/) | True if shape is a Circle type. |

<hr class="field-separator" />

<div class="signature field-method has-description has-plugin" id="isPolygon"><div class="plugin-name">nape</div><code><span class="field-name">isPolygon</span><span class="parenthesis">(</span><span class="parenthesis">)</span><span class="operator">:</span> <a href="/api-docs/headless/Bool/" class="type-link">Bool</a></code><a class="header-anchor" href="#isPolygon"><span aria-hidden="true" class="header-anchor__symbol">#</span></a></div>
...
| Returns | Description |
|---------|-------------|
| [Bool](/api-docs/headless/Bool/) | True if shape is a Polygon type. |
...
|------|------|-------------|
| `translation` | [nape.geom.Vec2](/api-docs/headless/nape/geom/Vec2/) | The local translation to apply to Shape.  |

| Returns | Description |
|---------|-------------|
| [Shape](/api-docs/headless/nape/shape/Shape/) | A reference to 'this' Shape.  |
...
| Name | Type | Description |
|------|------|-------------|
| `scalex` | [Float](/api-docs/headless/Float/) | The x-coordinate scaling to apply to Shape.  |
| `scaley` | [Float](/api-docs/headless/Float/) | The y-coordinate scaling to apply to Shape.  |
...
| Name | Type | Description |
|------|------|-------------|
| `angle` | [Float](/api-docs/headless/Float/) | The number of radians to rotate this Shape by in a clockwise direction.  |
...
| Name | Type | Description |
|------|------|-------------|
| `matrix` | [nape.geom.Mat23](/api-docs/headless/nape/geom/Mat23/) | The matrix to transform Shape by.  |
...
| Name | Type | Description |
|------|------|-------------|
| `point` | [nape.geom.Vec2](/api-docs/headless/nape/geom/Vec2/) | The point to check for containment.  |

| Returns | Description |
|---------|-------------|
| [Bool](/api-docs/headless/Bool/) | True if point is contained within the Shape.  |
...
| Returns | Description |
|---------|-------------|
| [Shape](/api-docs/headless/nape/shape/Shape/) | A copy of this shape. |
