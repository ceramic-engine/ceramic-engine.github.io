...
title: AngleJoint
target: Headless
permalink: api-docs/headless/nape/constraint/AngleJoint/
---
...
<div class="type-hierarchy"><a href="/api-docs/headless/nape/constraint/Constraint/">Constraint</a> → <strong>nape.constraint.AngleJoint</strong> (final class)</div>
...
<div class="signature field-var has-description has-plugin" id="zpp_inner_zn"><div class="plugin-name">nape</div><code><span class="field-name">zpp_inner_zn</span><span class="operator">:</span> <a href="/api-docs/headless/zpp_nape/constraint/ZPP_AngleJoint/" class="type-link">zpp_nape.constraint.ZPP_AngleJoint</a></code><a class="header-anchor" href="#zpp_inner_zn"><span aria-hidden="true" class="header-anchor__symbol">#</span></a></div>
...
|------|------|---------|-------------|
| `body1` | [Null](/api-docs/headless/Null/)<[nape.phys.Body](/api-docs/headless/nape/phys/Body/)> | | The first body in AngleJoint.  |
| `body2` | [Null](/api-docs/headless/Null/)<[nape.phys.Body](/api-docs/headless/nape/phys/Body/)> | | The second body in AngleJoint.  |
...
| `ratio` | [Float](/api-docs/headless/Float/) | `1.0` | The ratio of joint (default 1)  |
