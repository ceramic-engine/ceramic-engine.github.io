...
title: DistanceJoint
target: Headless
permalink: api-docs/headless/nape/constraint/DistanceJoint/
---
...
<div class="type-hierarchy"><a href="/api-docs/headless/nape/constraint/Constraint/">Constraint</a> → <strong>nape.constraint.DistanceJoint</strong> (final class)</div>
...
|------|------|-------------|
| `body1` | [Null](/api-docs/headless/Null/)<[nape.phys.Body](/api-docs/headless/nape/phys/Body/)> | The first body in DistanceJoint.  |
| `body2` | [Null](/api-docs/headless/Null/)<[nape.phys.Body](/api-docs/headless/nape/phys/Body/)> | The second body in DistanceJoint.  |
