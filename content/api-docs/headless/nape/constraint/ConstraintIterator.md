...
target: Headless
permalink: api-docs/headless/nape/constraint/ConstraintIterator/
---
...
|------|------|-------------|
| `list` | [ConstraintList](/api-docs/headless/nape/constraint/ConstraintList/) | The Nape list to create iterator for.  |

| Returns | Description |
|---------|-------------|
| [ConstraintIterator](/api-docs/headless/nape/constraint/ConstraintIterator/) | An iterator over the Nape list. |

## Instance Members

<div class="signature field-var has-description has-plugin" id="zpp_inner"><div class="plugin-name">nape</div><code><span class="field-name">zpp_inner</span><span class="operator">:</span> <a href="/api-docs/headless/nape/constraint/ConstraintList/" class="type-link">ConstraintList</a></code><a class="header-anchor" href="#zpp_inner"><span aria-hidden="true" class="header-anchor__symbol">#</span></a></div>
...
<div class="signature field-method has-description has-plugin" id="next"><div class="plugin-name">nape</div><code><span class="field-name">next</span><span class="parenthesis">(</span><span class="parenthesis">)</span><span class="operator">:</span> <a href="/api-docs/headless/nape/constraint/Constraint/" class="type-link">Constraint</a></code><a class="header-anchor" href="#next"><span aria-hidden="true" class="header-anchor__symbol">#</span></a></div>
...
| Returns | Description |
|---------|-------------|
| [Constraint](/api-docs/headless/nape/constraint/Constraint/) | The next element in iteration. |
