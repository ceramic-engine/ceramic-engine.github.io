...
target: Headless
permalink: api-docs/headless/nape/constraint/ConstraintList/
---

# ConstraintList

<div class="view-source"><a href="https://github.com/ceramic-engine/nape/blob/master/nape/constraint/ConstraintList.hx">View source</a></div>

<div class="type-hierarchy"><strong>nape.constraint.ConstraintList</strong> (final class)</div>
...
<div class="signature field-method has-description has-plugin" id="fromArray"><div class="plugin-name">nape</div><code><span class="field-name">fromArray</span><span class="parenthesis">(</span><span class="arg-name">array</span><span class="operator">:</span> <a href="/api-docs/headless/Array/" class="type-link">Array</a><span class="operator">&lt;</span><a href="/api-docs/headless/nape/constraint/Constraint/" class="type-link">Constraint</a><span class="operator">&gt;</span><span class="parenthesis">)</span><span class="operator">:</span> <a href="#" class="type-link">ConstraintList</a></code><a class="header-anchor" href="#fromArray"><span aria-hidden="true" class="header-anchor__symbol">#</span></a></div>
...
|------|------|-------------|
| `array` | [Array](/api-docs/headless/Array/)<[Constraint](/api-docs/headless/nape/constraint/Constraint/)> | The array to be converted  |

| Returns | Description |
|---------|-------------|
| [ConstraintList](/api-docs/headless/nape/constraint/ConstraintList/) | An equivalent Nape list.  |

## Instance Members

<div class="signature field-var has-description has-plugin" id="zpp_inner"><div class="plugin-name">nape</div><code><span class="field-name">zpp_inner</span><span class="operator">:</span> <a href="/api-docs/headless/zpp_nape/util/ZPP_ConstraintList/" class="type-link">zpp_nape.util.ZPP_ConstraintList</a></code><a class="header-anchor" href="#zpp_inner"><span aria-hidden="true" class="header-anchor__symbol">#</span></a></div>
...
| Name | Type | Description |
|------|------|-------------|
| `obj` | [Constraint](/api-docs/headless/nape/constraint/Constraint/) | The object to test.  |
...
| Returns |
|---------|
| [Constraint](/api-docs/headless/nape/constraint/Constraint/) |
...
| Name | Type | Description |
|------|------|-------------|
| `obj` | [Constraint](/api-docs/headless/nape/constraint/Constraint/) | The object to insert.  |
...
<div class="signature field-method has-description has-plugin" id="pop"><div class="plugin-name">nape</div><code><span class="field-name">pop</span><span class="parenthesis">(</span><span class="parenthesis">)</span><span class="operator">:</span> <a href="/api-docs/headless/nape/constraint/Constraint/" class="type-link">Constraint</a></code><a class="header-anchor" href="#pop"><span aria-hidden="true" class="header-anchor__symbol">#</span></a></div>
...
| Name | Type | Description |
|------|------|-------------|
| `obj` | [Constraint](/api-docs/headless/nape/constraint/Constraint/) | The object to remove  |
...
<div class="signature field-method has-description has-plugin" id="iterator"><div class="plugin-name">nape</div><code><span class="field-name">iterator</span><span class="parenthesis">(</span><span class="parenthesis">)</span><span class="operator">:</span> <a href="/api-docs/headless/nape/constraint/ConstraintIterator/" class="type-link">ConstraintIterator</a></code><a class="header-anchor" href="#iterator"><span aria-hidden="true" class="header-anchor__symbol">#</span></a></div>
...
| Name | Type | Description |
|------|------|-------------|
| `xs` | [ConstraintList](/api-docs/headless/nape/constraint/ConstraintList/) | The list to merge.  |
...
| Returns | Description |
|---------|-------------|
| [ConstraintList](/api-docs/headless/nape/constraint/ConstraintList/) | A reference to 'this' list.  |

<hr class="field-separator" />

<div class="signature field-method has-description has-plugin" id="filter"><div class="plugin-name">nape</div><code><span class="field-name">filter</span><span class="parenthesis">(</span><span class="arg-name">lambda</span><span class="operator">:</span> <span class="type-name">Function</span><span class="parenthesis">)</span><span class="operator">:</span> <a href="#" class="type-link">ConstraintList</a></code><a class="header-anchor" href="#filter"><span aria-hidden="true" class="header-anchor__symbol">#</span></a></div>
