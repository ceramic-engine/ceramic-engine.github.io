...
target: Clay (Native)
permalink: api-docs/clay-native/elements/SelectListView/
---
...
<div class="type-hierarchy"><a href="/api-docs/clay-native/ceramic/Entity/">ceramic.Entity</a> → <a href="/api-docs/clay-native/ceramic/Visual/">ceramic.Visual</a> → <a href="/api-docs/clay-native/ceramic/Quad/">ceramic.Quad</a> → <a href="/api-docs/clay-native/ceramic/Layer/">ceramic.Layer</a> → <a href="/api-docs/clay-native/ceramic/View/">ceramic.View</a> → <strong>elements.SelectListView</strong> (Class)</div>

<div class="type-implements"><strong>Implements:</strong> <a href="/api-docs/clay-native/tracker/Observable/">tracker.Observable</a>, <a href="/api-docs/clay-native/ceramic/CollectionViewDataSource/">ceramic.CollectionViewDataSource</a></div>
...
<div class="signature field-method has-description has-plugin" id="scrollToValue"><div class="plugin-name">elements</div><code><span class="field-name">scrollToValue</span><span class="parenthesis">(</span><span class="arg-name">position</span><span class="operator">:</span> <a href="/api-docs/clay-native/ceramic/CollectionViewItemPosition/" class="type-link">ceramic.CollectionViewItemPosition</a><span class="parenthesis">)</span><span class="operator">:</span> <a href="/api-docs/clay-native/Void/" class="type-link">Void</a></code><a class="header-anchor" href="#scrollToValue"><span aria-hidden="true" class="header-anchor__symbol">#</span></a></div>
...
|------|------|-------------|
| `position` | [ceramic.CollectionViewItemPosition](/api-docs/clay-native/ceramic/CollectionViewItemPosition/) | How to position the item (START, CENTER, END, ENSURE_VISIBLE) |
...
| Name | Type | Description |
|------|------|-------------|
| `collectionView` | [ceramic.CollectionView](/api-docs/clay-native/ceramic/CollectionView/) | The collection view requesting the size  |

| Returns | Description |
|---------|-------------|
| [Int](/api-docs/clay-native/Int/) | Total number of items including null option if applicable |
...
| Name | Type | Description |
|------|------|-------------|
| `collectionView` | [ceramic.CollectionView](/api-docs/clay-native/ceramic/CollectionView/) | The collection view requesting the frame  |
| `itemIndex` | [Int](/api-docs/clay-native/Int/) | Index of the item  |
| `frame` | [ceramic.CollectionViewItemFrame](/api-docs/clay-native/ceramic/CollectionViewItemFrame/) | Frame object to populate with size information |
...
| Name | Type | Description |
|------|------|-------------|
| `collectionView` | [ceramic.CollectionView](/api-docs/clay-native/ceramic/CollectionView/) | The collection view releasing the item  |
| `itemIndex` | [Int](/api-docs/clay-native/Int/) | Index of the item being released  |
...
| Name | Type | Description |
|------|------|-------------|
| `collectionView` | [ceramic.CollectionView](/api-docs/clay-native/ceramic/CollectionView/) | The collection view requesting the item  |
| `itemIndex` | [Int](/api-docs/clay-native/Int/) | Index of the item  |
| `reusableView` | [ceramic.View](/api-docs/clay-native/ceramic/View/) | Existing view that can be recycled, if available  |

| Returns | Description |
|---------|-------------|
| [ceramic.View](/api-docs/clay-native/ceramic/View/) | The view to display for this item |
...
| Name | Type |
|------|------|
| `instance` | [SelectListView](/api-docs/clay-native/elements/SelectListView/) |
...
| Name | Type | Description |
|------|------|-------------|
| `cell` | [CellView](/api-docs/clay-native/elements/CellView/) | The cell view to bind |
