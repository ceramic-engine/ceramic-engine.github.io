...
title: Scrollbar
target: Clay (Native)
permalink: api-docs/clay-native/elements/Scrollbar/
---
...
<div class="type-hierarchy"><a href="/api-docs/clay-native/ceramic/Entity/">ceramic.Entity</a> → <a href="/api-docs/clay-native/ceramic/Visual/">ceramic.Visual</a> → <strong>elements.Scrollbar</strong> (Class)</div>
...
|------|------|-------------|
| `insetTop` | [Float](/api-docs/clay-native/Float/) | Top inset in pixels  |
| `insetRight` | [Float](/api-docs/clay-native/Float/) | Right inset in pixels  |
| `insetBottom` | [Float](/api-docs/clay-native/Float/) | Bottom inset in pixels  |
| `insetLeft` | [Float](/api-docs/clay-native/Float/) | Left inset in pixels |
...
| Name | Type |
|------|------|
| `instance` | [Scrollbar](/api-docs/clay-native/elements/Scrollbar/) |
