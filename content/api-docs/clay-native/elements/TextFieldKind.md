...
title: TextFieldKind
target: Clay (Native)
permalink: api-docs/clay-native/elements/TextFieldKind/
---
...
|------|------|-------------|
| `?title` | [String](/api-docs/clay-native/String/) | Optional title for the directory selection dialog |
...
| Name | Type | Description |
|------|------|-------------|
| `?title` | [String](/api-docs/clay-native/String/) | Optional title for the file selection dialog  |
| `?filters` | [Array](/api-docs/clay-native/Array/)<[ceramic.DialogsFileFilter](/api-docs/clay-native/ceramic/DialogsFileFilter/)> | Optional array of file filters to restrict selectable file types |
