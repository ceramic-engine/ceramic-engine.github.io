...
title: LabelView
target: Clay (Native)
permalink: api-docs/clay-native/elements/LabelView/
---
...
<div class="see"><strong>See:</strong> TextView, <a href="/api-docs/clay-native/elements/Theme/">Theme</a></div>
...
<div class="signature field-var no-description has-plugin" id="unobservedBold"><div class="plugin-name">elements</div><code><span class="field-name">unobservedBold</span><span class="operator">:</span> <a href="/api-docs/clay-native/Bool/" class="type-link">Bool</a></code><a class="header-anchor" href="#unobservedBold"><span aria-hidden="true" class="header-anchor__symbol">#</span></a></div>
...
| Name | Type |
|------|------|
| `instance` | [LabelView](/api-docs/clay-native/elements/LabelView/) |
