...
title: TabFocusable
target: Clay (Native)
permalink: api-docs/clay-native/elements/TabFocusable/
---
...
<div class="type-hierarchy"><strong>elements.TabFocusable</strong> (Interface) → <a href="/api-docs/clay-native/elements/Button/">Button</a>, <a href="/api-docs/clay-native/elements/FieldView/">FieldView</a></div>
...
| Returns | Description |
|---------|-------------|
| [Bool](/api-docs/clay-native/Bool/) | true if the element can receive focus, false otherwise |
