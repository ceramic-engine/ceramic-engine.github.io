...
title: TmxWangSet
target: Clay (Native)
permalink: api-docs/clay-native/format/tmx/TmxWangSet/
---
...
<div class="signature field-var has-description" id="tile"><code><span class="field-name">tile</span><span class="operator">:</span> <a href="/api-docs/clay-native/Int/" class="type-link">Int</a></code><a class="header-anchor" href="#tile"><span aria-hidden="true" class="header-anchor__symbol">#</span></a></div>
...
|------|------|-------------|
| `name` | [String](/api-docs/clay-native/String/) | The name of the Wang set. |
| `tile` | [Int](/api-docs/clay-native/Int/) | The tile ID of the tile representing this Wang set. |
| `corners` | [Array](/api-docs/clay-native/Array/)<[TmxWangSetColor](/api-docs/clay-native/format/tmx/TmxWangSetColor/)> | A color that can be used to define the corner of a Wang tile. |
| `edges` | [Array](/api-docs/clay-native/Array/)<[TmxWangSetColor](/api-docs/clay-native/format/tmx/TmxWangSetColor/)> | A color that can be used to define the edge of a Wang tile. |
| `tiles` | [Array](/api-docs/clay-native/Array/)<[TmxWangSetTile](/api-docs/clay-native/format/tmx/TmxWangSetTile/)> | Defines a Wang tile, by referring to a tile in the tileset and associating it with a certain Wang ID. |
