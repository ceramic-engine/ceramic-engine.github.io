...
title: TmxData
target: Clay (Native)
permalink: api-docs/clay-native/format/tmx/TmxData/
---
...
<div class="signature field-var has-description" id="data"><code><span class="field-name">data</span><span class="operator">:</span> <a href="/api-docs/clay-native/haxe/io/Bytes/" class="type-link">haxe.io.Bytes</a></code><a class="header-anchor" href="#data"><span aria-hidden="true" class="header-anchor__symbol">#</span></a></div>
...
|------|------|---------|-------------|
| `encoding` | Anonymous | *(optional)* | The encoding used to encode the tile layer data. When used, it can be "base64" and "csv" at the moment. |
| `compression` | Anonymous | *(optional)* | The compression used to compress the tile layer data. Tiled Qt supports "gzip" and "zlib". Optional |
| `tiles` | [Array](/api-docs/clay-native/Array/)<[TmxTile](/api-docs/clay-native/format/tmx/TmxTile/)> | *(optional)* | Decoded tile data |
| `chunks` | [Array](/api-docs/clay-native/Array/)<[TmxChunk](/api-docs/clay-native/format/tmx/TmxChunk/)> | *(optional)* | Infinite maps chunk data |
| `data` | [haxe.io.Bytes](/api-docs/clay-native/haxe/io/Bytes/) | *(optional)* | Raw data. Exists for non-tile-layer data objects. |
