...
target: Clay (Native)
permalink: api-docs/clay-native/format/tmx/TmxWangSetColor/
---
...
|------|------|-------------|
| `name` | [String](/api-docs/clay-native/String/) | The name of this color. |
| `color` | [Int](/api-docs/clay-native/Int/) | The color in #RRGGBB format (example: #c17d11). |
| `tile` | [Int](/api-docs/clay-native/Int/) | The tile ID of the tile representing this color. |
| `probability` | [Float](/api-docs/clay-native/Float/) | The relative probability that this color is chosen over others in case of multiple options. |
