...
title: TmxObjectType
target: Clay (Native)
permalink: api-docs/clay-native/format/tmx/TmxObjectType/
---
...
|------|------|
| `gid` | [Int](/api-docs/clay-native/Int/) |
| `tileset` | [format.tmx.TmxTileset](/api-docs/clay-native/format/tmx/TmxTileset/) |
...
| Name | Type |
|------|------|
| `points` | [Array](/api-docs/clay-native/Array/)<[format.tmx.TmxPoint](/api-docs/clay-native/format/tmx/TmxPoint/)> |
...
| Name | Type |
|------|------|
| `text` | [format.tmx.TmxText](/api-docs/clay-native/format/tmx/TmxText/) |
