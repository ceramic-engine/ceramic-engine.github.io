...
title: TmxChunk
target: Clay (Native)
permalink: api-docs/clay-native/format/tmx/TmxChunk/
---
...
|------|------|-------------|
| `x` | [Int](/api-docs/clay-native/Int/) | The x coordinate of the chunk in tiles. |
| `y` | [Int](/api-docs/clay-native/Int/) | The y coordinate of the chunk in tiles. |
| `width` | [Int](/api-docs/clay-native/Int/) | The width of the chunk in tiles. |
| `height` | [Int](/api-docs/clay-native/Int/) | The height of the chunk in tiles. |
| `tiles` | [Array](/api-docs/clay-native/Array/)<[TmxTile](/api-docs/clay-native/format/tmx/TmxTile/)> | Decoded tile data |
