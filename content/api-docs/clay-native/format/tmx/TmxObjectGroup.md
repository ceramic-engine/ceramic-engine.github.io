...
target: Clay (Native)
permalink: api-docs/clay-native/format/tmx/TmxObjectGroup/
---
...
<div class="type-hierarchy"><a href="/api-docs/clay-native/format/tmx/TmxBaseLayer/">TmxBaseLayer</a> → <strong>format.tmx.TmxObjectGroup</strong> (Class)</div>
...
|------|------|
| `drawOrder` | Anonymous |
| `objects` | [Array](/api-docs/clay-native/Array/)<[TmxObject](/api-docs/clay-native/format/tmx/TmxObject/)> |
| `color` | [Null](/api-docs/clay-native/Null/)<[Int](/api-docs/clay-native/Int/)> |
