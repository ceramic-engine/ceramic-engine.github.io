...
title: TmxImage
target: Clay (Native)
permalink: api-docs/clay-native/format/tmx/TmxImage/
---
...
<div class="signature field-var has-description" id="format"><code><span class="field-name">format</span><span class="operator">:</span> <a href="/api-docs/clay-native/String/" class="type-link">String</a></code><a class="header-anchor" href="#format"><span aria-hidden="true" class="header-anchor__symbol">#</span></a></div>
...
<div class="signature field-var has-description" id="data"><code><span class="field-name">data</span><span class="operator">:</span> <a href="/api-docs/clay-native/format/tmx/TmxData/" class="type-link">TmxData</a></code><a class="header-anchor" href="#data"><span aria-hidden="true" class="header-anchor__symbol">#</span></a></div>
...
|------|------|---------|-------------|
| `format` | [String](/api-docs/clay-native/String/) | *(optional)* | Used for embedded images, in combination with a data child element. Valid values are file extensions like png, gif, jpg, bmp, etc. (since 0.9.0) |
| `id` | [String](/api-docs/clay-native/String/) | *(optional)* | Used by some versions of Tiled Java. Deprecated and unsupported by Tiled Qt. |
| `source` | [String](/api-docs/clay-native/String/) | | The reference to the tileset image file (Tiled supports most common image formats). |
| `transparent` | [Int](/api-docs/clay-native/Int/) | *(optional)* | * Defines a specific color that is treated as transparent (example value: "#FF00FF" for magenta). Up until Tiled 0.10 (upd: 0.12), this value is written out without a # but this is planned to change. |
| `width` | [Int](/api-docs/clay-native/Int/) | *(optional)* | The image width in pixels (optional, used for tile index correction when the image changes) |
| `height` | [Int](/api-docs/clay-native/Int/) | *(optional)* | The image height in pixels (optional) |
| `data` | [TmxData](/api-docs/clay-native/format/tmx/TmxData/) | *(optional)* | Since 0.9 |
