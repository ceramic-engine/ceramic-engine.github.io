...
target: Clay (Native)
permalink: api-docs/clay-native/zpp_nape/geom/ZPP_Triangular/
---
...
| `C` | [ZPP_PartitionVertex](/api-docs/clay-native/zpp_nape/geom/ZPP_PartitionVertex/) |
| `D` | [ZPP_PartitionVertex](/api-docs/clay-native/zpp_nape/geom/ZPP_PartitionVertex/) |
...
<div class="signature field-var no-description has-plugin" id="edgeSet"><div class="plugin-name">nape</div><code><span class="field-name">edgeSet</span><span class="operator">:</span> <a href="/api-docs/clay-native/zpp_nape/util/ZPP_Set_ZPP_PartitionPair/" class="type-link">zpp_nape.util.ZPP_Set_ZPP_PartitionPair</a></code><a class="header-anchor" href="#edgeSet"><span aria-hidden="true" class="header-anchor__symbol">#</span></a></div>
