...
target: Clay (Native)
permalink: api-docs/clay-native/zpp_nape/geom/ZPP_SweepDistance/
---
...
<div class="signature field-method no-description has-plugin" id="dynamicSweep"><div class="plugin-name">nape</div><code><span class="field-name">dynamicSweep</span><span class="parenthesis">(</span><span class="arg-name">toi</span><span class="operator">:</span> <a href="/api-docs/clay-native/zpp_nape/geom/ZPP_ToiEvent/" class="type-link">ZPP_ToiEvent</a><span class="operator">,</span> <span class="arg-name">timeStep</span><span class="operator">:</span> <a href="/api-docs/clay-native/Float/" class="type-link">Float</a><span class="operator">,</span> <span class="arg-name">lowerBound</span><span class="operator">:</span> <a href="/api-docs/clay-native/Float/" class="type-link">Float</a><span class="operator">,</span> <span class="arg-name">negRadius</span><span class="operator">:</span> <a href="/api-docs/clay-native/Float/" class="type-link">Float</a><span class="operator">,</span> <span class="operator">?</span><span class="arg-name">userAPI</span><span class="operator">:</span> <a href="/api-docs/clay-native/Bool/" class="type-link">Bool</a> <span class="operator">=</span> <span class="default-value">false</span><span class="parenthesis">)</span><span class="operator">:</span> <a href="/api-docs/clay-native/Void/" class="type-link">Void</a></code><a class="header-anchor" href="#dynamicSweep"><span aria-hidden="true" class="header-anchor__symbol">#</span></a></div>


| Name | Type | Default |
|------|------|---------|
| `toi` | [ZPP_ToiEvent](/api-docs/clay-native/zpp_nape/geom/ZPP_ToiEvent/) | |
| `timeStep` | [Float](/api-docs/clay-native/Float/) | |
| `lowerBound` | [Float](/api-docs/clay-native/Float/) | |
| `negRadius` | [Float](/api-docs/clay-native/Float/) | |
| `userAPI` | [Bool](/api-docs/clay-native/Bool/) | `false` |

<hr class="field-separator" />

<div class="signature field-method no-description has-plugin" id="staticSweep"><div class="plugin-name">nape</div><code><span class="field-name">staticSweep</span><span class="parenthesis">(</span><span class="arg-name">toi</span><span class="operator">:</span> <a href="/api-docs/clay-native/zpp_nape/geom/ZPP_ToiEvent/" class="type-link">ZPP_ToiEvent</a><span class="operator">,</span> <span class="arg-name">timeStep</span><span class="operator">:</span> <a href="/api-docs/clay-native/Float/" class="type-link">Float</a><span class="operator">,</span> <span class="arg-name">lowerBound</span><span class="operator">:</span> <a href="/api-docs/clay-native/Float/" class="type-link">Float</a><span class="operator">,</span> <span class="arg-name">negRadius</span><span class="operator">:</span> <a href="/api-docs/clay-native/Float/" class="type-link">Float</a><span class="parenthesis">)</span><span class="operator">:</span> <a href="/api-docs/clay-native/Void/" class="type-link">Void</a></code><a class="header-anchor" href="#staticSweep"><span aria-hidden="true" class="header-anchor__symbol">#</span></a></div>
...
| `w1` | [ZPP_Vec2](/api-docs/clay-native/zpp_nape/geom/ZPP_Vec2/) |
| `w2` | [ZPP_Vec2](/api-docs/clay-native/zpp_nape/geom/ZPP_Vec2/) |
...
| `w1` | [ZPP_Vec2](/api-docs/clay-native/zpp_nape/geom/ZPP_Vec2/) | |
| `w2` | [ZPP_Vec2](/api-docs/clay-native/zpp_nape/geom/ZPP_Vec2/) | |
| `axis` | [ZPP_Vec2](/api-docs/clay-native/zpp_nape/geom/ZPP_Vec2/) | |
| `upperBound` | [Float](/api-docs/clay-native/Float/) | `1e100` |
