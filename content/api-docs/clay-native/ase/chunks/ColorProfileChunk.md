...
target: Clay (Native)
permalink: api-docs/clay-native/ase/chunks/ColorProfileChunk/
---
...
<div class="type-hierarchy"><a href="/api-docs/clay-native/ase/chunks/Chunk/">Chunk</a> → <strong>ase.chunks.ColorProfileChunk</strong> (Class)</div>
...
| Returns |
|---------|
| [ColorProfileChunk](/api-docs/clay-native/ase/chunks/ColorProfileChunk/) |

## Instance Members

<div class="signature field-var no-description" id="colorProfileType"><code><span class="field-name">colorProfileType</span><span class="operator">:</span> <a href="/api-docs/clay-native/ase/types/ColorProfileType/" class="type-link">ase.types.ColorProfileType</a></code><a class="header-anchor" href="#colorProfileType"><span aria-hidden="true" class="header-anchor__symbol">#</span></a></div>
...
<div class="signature field-var no-description" id="gamma"><code><span class="field-name">gamma</span><span class="operator">:</span> <a href="/api-docs/clay-native/Float/" class="type-link">Float</a></code><a class="header-anchor" href="#gamma"><span aria-hidden="true" class="header-anchor__symbol">#</span></a></div>

<hr class="field-separator" />

<div class="signature field-var no-description" id="iccProfileData"><code><span class="field-name">iccProfileData</span><span class="operator">:</span> <a href="/api-docs/clay-native/haxe/io/Bytes/" class="type-link">haxe.io.Bytes</a></code><a class="header-anchor" href="#iccProfileData"><span aria-hidden="true" class="header-anchor__symbol">#</span></a></div>
