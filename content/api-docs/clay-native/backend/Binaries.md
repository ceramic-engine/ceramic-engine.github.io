...
title: Binaries
target: Clay (Native)
permalink: api-docs/clay-native/backend/Binaries/
---
...
<div class="type-implements"><strong>Implements:</strong> <a href="/api-docs/clay-native/spec/Binaries/">spec.Binaries</a></div>
...
|------|------|---------|-------------|
| `path` | [String](/api-docs/clay-native/String/) | | Path to the binary file to load  |
| `options` | [Null](/api-docs/clay-native/Null/)<[LoadBinaryOptions](/api-docs/clay-native/backend/LoadBinaryOptions/)> | *(optional)* | Optional loading configuration (immediate callback execution)  |
...
| Returns | Description |
|---------|-------------|
| [Bool](/api-docs/clay-native/Bool/) | true, indicating hot reload is supported |
