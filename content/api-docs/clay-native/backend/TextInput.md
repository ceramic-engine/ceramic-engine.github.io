...
title: TextInput
target: Clay (Native)
permalink: api-docs/clay-native/backend/TextInput/
---
...
<div class="type-implements"><strong>Implements:</strong> <a href="/api-docs/clay-native/spec/TextInput/">spec.TextInput</a></div>
...
|------|------|-------------|
| `initialText` | [String](/api-docs/clay-native/String/) | Initial text content (currently unused)  |
| `x` | [Float](/api-docs/clay-native/Float/) | X position of the text input area  |
| `y` | [Float](/api-docs/clay-native/Float/) | Y position of the text input area  |
| `w` | [Float](/api-docs/clay-native/Float/) | Width of the text input area (minimum 1 pixel)  |
| `h` | [Float](/api-docs/clay-native/Float/) | Height of the text input area (minimum 1 pixel) |
...
| Name | Type | Description |
|------|------|-------------|
| `text` | [String](/api-docs/clay-native/String/) | The input text (may be multiple characters for IME) |
...
| Name | Type | Description |
|------|------|-------------|
| `keyCode` | [Int](/api-docs/clay-native/Int/) | Virtual key code  |
| `scanCode` | [Int](/api-docs/clay-native/Int/) | Physical key scan code |
