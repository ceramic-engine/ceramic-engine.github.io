...
title: ShaderImpl
target: Clay (Native)
permalink: api-docs/clay-native/backend/ShaderImpl/
---
...
<div class="type-hierarchy"><a href="/api-docs/clay-native/clay/Resource/">clay.Resource</a> → <a href="/api-docs/clay-native/clay/graphics/Shader/">clay.graphics.Shader</a> → <strong>backend.ShaderImpl</strong> (Class)</div>
...
| Returns | Description |
|---------|-------------|
| [ShaderImpl](/api-docs/clay-native/backend/ShaderImpl/) | A new ShaderImpl instance with the same configuration |
