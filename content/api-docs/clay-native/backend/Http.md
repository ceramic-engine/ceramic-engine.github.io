...
title: Http
target: Clay (Native)
permalink: api-docs/clay-native/backend/Http/
---
...
<div class="type-implements"><strong>Implements:</strong> <a href="/api-docs/clay-native/spec/Http/">spec.Http</a></div>
...
|------|------|-------------|
| `options` | [HttpRequestOptions](/api-docs/clay-native/backend/HttpRequestOptions/) | The HTTP request configuration  |
...
| Name | Type | Description |
|------|------|-------------|
| `url` | [String](/api-docs/clay-native/String/) | The URL of the file to download  |
| `targetPath` | [String](/api-docs/clay-native/String/) | The local file path where the file should be saved (can be relative)  |
