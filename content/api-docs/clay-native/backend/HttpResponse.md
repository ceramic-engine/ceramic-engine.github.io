...
title: HttpResponse
target: Clay (Native)
permalink: api-docs/clay-native/backend/HttpResponse/
---
...
|------|------|---------|-------------|
| `status` | [Int](/api-docs/clay-native/Int/) | | HTTP status code returned by the server (e.g., 200, 404, 500) |
| `content` | [String](/api-docs/clay-native/String/) | | * Response content as a string for text responses. This may contain trailing newlines that are cleaned up by higher-level processing. |
| `binaryContent` | [Null](/api-docs/clay-native/Null/)<[haxe.io.Bytes](/api-docs/clay-native/haxe/io/Bytes/)> | *(optional)* | * Response content as raw bytes for binary responses. Defaults to null for text responses. |
| `error` | [Null](/api-docs/clay-native/Null/)<[String](/api-docs/clay-native/String/)> | *(optional)* | * Error message for failed requests. Defaults to null for successful requests. |
| `headers` | [Array](/api-docs/clay-native/Array/)<[String](/api-docs/clay-native/String/)> | | * HTTP response headers as a flat array: [key1, value1, key2, value2, ...]. This format allows multiple headers with the same name. Header names may not be normalized at this level. |
