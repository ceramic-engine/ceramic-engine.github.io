...
target: Clay (Native)
permalink: api-docs/clay-native/shaders/GaussianBlur_Vert/
---
...
<div class="type-hierarchy"><a href="/api-docs/clay-native/shade/Shade/">shade.Shade</a> → <a href="/api-docs/clay-native/shade/Vert/">shade.Vert</a> → <strong>shaders.GaussianBlur_Vert</strong> (Class)</div>
