...
title: Glow_Vert
target: Clay (Native)
permalink: api-docs/clay-native/shaders/Glow_Vert/
---
...
<div class="type-hierarchy"><a href="/api-docs/clay-native/shade/Shade/">shade.Shade</a> → <a href="/api-docs/clay-native/shade/Vert/">shade.Vert</a> → <strong>shaders.Glow_Vert</strong> (Class)</div>
