...
target: Clay (Native)
permalink: api-docs/clay-native/shaders/TintBlack_Frag/
---
...
<div class="type-hierarchy"><a href="/api-docs/clay-native/shade/Shade/">shade.Shade</a> → <a href="/api-docs/clay-native/shade/Frag/">shade.Frag</a> → <strong>shaders.TintBlack_Frag</strong> (Class)</div>
