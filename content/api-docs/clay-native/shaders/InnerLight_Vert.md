...
target: Clay (Native)
permalink: api-docs/clay-native/shaders/InnerLight_Vert/
---
...
<div class="type-hierarchy"><a href="/api-docs/clay-native/shade/Shade/">shade.Shade</a> → <a href="/api-docs/clay-native/shade/Vert/">shade.Vert</a> → <strong>shaders.InnerLight_Vert</strong> (Class)</div>
