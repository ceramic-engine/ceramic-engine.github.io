...
target: Clay (Native)
permalink: api-docs/clay-native/shaders/InnerLight_Frag/
---
...
<div class="type-hierarchy"><a href="/api-docs/clay-native/shade/Shade/">shade.Shade</a> → <a href="/api-docs/clay-native/shade/Frag/">shade.Frag</a> → <strong>shaders.InnerLight_Frag</strong> (Class)</div>
...
<div class="signature field-var no-description has-plugin" id="gap"><div class="plugin-name">shade</div><code><span class="field-name">gap</span><span class="operator">:</span> <a href="/api-docs/clay-native/shade/Vec2/" class="type-link">shade.Vec2</a></code><a class="header-anchor" href="#gap"><span aria-hidden="true" class="header-anchor__symbol">#</span></a></div>

<hr class="field-separator" />

<div class="signature field-var no-description has-plugin" id="lightColor"><div class="plugin-name">shade</div><code><span class="field-name">lightColor</span><span class="operator">:</span> <a href="/api-docs/clay-native/shade/Vec4/" class="type-link">shade.Vec4</a></code><a class="header-anchor" href="#lightColor"><span aria-hidden="true" class="header-anchor__symbol">#</span></a></div>
