...
title: Blur_Frag
target: Clay (Native)
permalink: api-docs/clay-native/shaders/Blur_Frag/
---
...
<div class="type-hierarchy"><a href="/api-docs/clay-native/shade/Shade/">shade.Shade</a> → <a href="/api-docs/clay-native/shade/Frag/">shade.Frag</a> → <strong>shaders.Blur_Frag</strong> (Class)</div>
