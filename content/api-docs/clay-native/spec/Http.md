...
title: Http
target: Clay (Native)
permalink: api-docs/clay-native/spec/Http/
---
...
<div class="type-hierarchy"><strong>spec.Http</strong> (Interface) → <a href="/api-docs/clay-native/backend/Http/">backend.Http</a></div>
...
|------|------|-------------|
| `options` | [backend.HttpRequestOptions](/api-docs/clay-native/backend/HttpRequestOptions/) | The request configuration including URL, method, headers, body, etc.  |
