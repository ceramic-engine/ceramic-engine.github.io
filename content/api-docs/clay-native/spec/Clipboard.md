...
title: Clipboard
target: Clay (Native)
permalink: api-docs/clay-native/spec/Clipboard/
---
...
<div class="type-hierarchy"><strong>spec.Clipboard</strong> (Interface) → <a href="/api-docs/clay-native/backend/Clipboard/">backend.Clipboard</a></div>
...
| Returns | Description |
|---------|-------------|
| [String](/api-docs/clay-native/String/) | The clipboard text content, or an empty string if the clipboard is empty or doesn't contain text data |
