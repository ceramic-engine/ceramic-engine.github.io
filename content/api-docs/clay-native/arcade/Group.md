...
title: Group
target: Clay (Native)
permalink: api-docs/clay-native/arcade/Group/
---
...
|------|------|-------------|
| `body` | [Body](/api-docs/clay-native/arcade/Body/) | The body to add to the group. |
