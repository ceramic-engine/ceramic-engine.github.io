...
target: Clay (Native)
permalink: api-docs/clay-native/arcade/SortBodiesBottomTop/
---
...
|------|------|-------------|
| `a` | [Array](/api-docs/clay-native/Array/)<[Body](/api-docs/clay-native/arcade/Body/)> | The array of bodies to sort. |
...
| Name | Type |
|------|------|
| `a` | [Body](/api-docs/clay-native/arcade/Body/) |
| `b` | [Body](/api-docs/clay-native/arcade/Body/) |
...
| Name | Type |
|------|------|
| `a` | [Array](/api-docs/clay-native/Array/)<[Body](/api-docs/clay-native/arcade/Body/)> |
