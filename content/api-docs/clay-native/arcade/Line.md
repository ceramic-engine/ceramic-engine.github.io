...
title: Line
target: Clay (Native)
permalink: api-docs/clay-native/arcade/Line/
---
...
<div class="signature field-var has-description has-plugin" id="x2"><div class="plugin-name">arcade</div><code><span class="field-name">x2</span><span class="operator">:</span> <a href="/api-docs/clay-native/Float/" class="type-link">Float</a></code><a class="header-anchor" href="#x2"><span aria-hidden="true" class="header-anchor__symbol">#</span></a></div>

The x coordinate of the end point.

<hr class="field-separator" />

<div class="signature field-var has-description has-plugin" id="y2"><div class="plugin-name">arcade</div><code><span class="field-name">y2</span><span class="operator">:</span> <a href="/api-docs/clay-native/Float/" class="type-link">Float</a></code><a class="header-anchor" href="#y2"><span aria-hidden="true" class="header-anchor__symbol">#</span></a></div>
...
|------|------|-------------|
| `x` | [Float](/api-docs/clay-native/Float/) | The x coordinate of the start point.  |
| `y` | [Float](/api-docs/clay-native/Float/) | The y coordinate of the start point.  |
| `angle` | [Float](/api-docs/clay-native/Float/) | The angle in radians.  |
| `length` | [Float](/api-docs/clay-native/Float/) | The length of the line. |
...
| Name | Type | Description |
|------|------|-------------|
| `x1` | [Float](/api-docs/clay-native/Float/) | The x coordinate of the start point.  |
| `y1` | [Float](/api-docs/clay-native/Float/) | The y coordinate of the start point.  |
| `x2` | [Float](/api-docs/clay-native/Float/) | The x coordinate of the end point.  |
| `y2` | [Float](/api-docs/clay-native/Float/) | The y coordinate of the end point. |
