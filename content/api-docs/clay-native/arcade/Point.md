...
title: Point
target: Clay (Native)
permalink: api-docs/clay-native/arcade/Point/
---
...
|------|------|---------|-------------|
| `azimuth` | [Float](/api-docs/clay-native/Float/) | | The angle in radians (or degrees if asDegrees is true).  |
| `radius` | [Float](/api-docs/clay-native/Float/) | `1` | The distance from the origin.  |
| `asDegrees` | [Bool](/api-docs/clay-native/Bool/) | `false` | Whether the azimuth is given in degrees (true) or radians (false). |
...
| Name | Type | Description |
|------|------|-------------|
| `deg` | [Float](/api-docs/clay-native/Float/) | The angle in degrees.  |

| Returns | Description |
|---------|-------------|
| [Float](/api-docs/clay-native/Float/) | The angle in radians. |
