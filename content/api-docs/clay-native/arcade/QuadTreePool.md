...
title: QuadTreePool
target: Clay (Native)
permalink: api-docs/clay-native/arcade/QuadTreePool/
---
...
| Returns |
|---------|
| [QuadTree](/api-docs/clay-native/arcade/QuadTree/) |

<hr class="field-separator" />

<div class="signature field-method no-description has-plugin" id="recycleAll"><div class="plugin-name">arcade</div><code><span class="field-name">recycleAll</span><span class="parenthesis">(</span><span class="parenthesis">)</span><span class="operator">:</span> <a href="/api-docs/clay-native/Void/" class="type-link">Void</a></code><a class="header-anchor" href="#recycleAll"><span aria-hidden="true" class="header-anchor__symbol">#</span></a></div>
