...
title: QuadTree
target: Clay (Native)
permalink: api-docs/clay-native/arcade/QuadTree/
---
...
<div class="signature field-var has-description has-plugin" id="busy"><div class="plugin-name">arcade</div><code><span class="field-name">busy</span><span class="operator">:</span> <a href="/api-docs/clay-native/Bool/" class="type-link">Bool</a></code><a class="header-anchor" href="#busy"><span aria-hidden="true" class="header-anchor__symbol">#</span></a></div>
...
|------|------|---------|-------------|
| `x` | [Float](/api-docs/clay-native/Float/) | | The top left coordinate of the quadtree.  |
| `y` | [Float](/api-docs/clay-native/Float/) | | The top left coordinate of the quadtree.  |
| `width` | [Float](/api-docs/clay-native/Float/) | | The width of the quadtree in pixels.  |
| `height` | [Float](/api-docs/clay-native/Float/) | | The height of the quadtree in pixels.  |
| `maxObjects` | [Int](/api-docs/clay-native/Int/) | `10` | The maximum number of objects per node.  |
| `maxLevels` | [Int](/api-docs/clay-native/Int/) | `4` | The maximum number of levels to iterate to.  |
| `level` | [Int](/api-docs/clay-native/Int/) | `0` | Which level is this? |

<hr class="field-separator" />

<div class="signature field-method has-description has-plugin" id="populate"><div class="plugin-name">arcade</div><code><span class="field-name">populate</span><span class="parenthesis">(</span><span class="arg-name">group</span><span class="operator">:</span> <a href="/api-docs/clay-native/arcade/Group/" class="type-link">Group</a><span class="parenthesis">)</span><span class="operator">:</span> <a href="/api-docs/clay-native/Void/" class="type-link">Void</a></code><a class="header-anchor" href="#populate"><span aria-hidden="true" class="header-anchor__symbol">#</span></a></div>
...
|------|------|-------------|
| `group` | [Group](/api-docs/clay-native/arcade/Group/) | The Group to add to the quadtree. |

<hr class="field-separator" />

<div class="signature field-method has-description has-plugin" id="split"><div class="plugin-name">arcade</div><code><span class="field-name">split</span><span class="parenthesis">(</span><span class="parenthesis">)</span><span class="operator">:</span> <a href="/api-docs/clay-native/Void/" class="type-link">Void</a></code><a class="header-anchor" href="#split"><span aria-hidden="true" class="header-anchor__symbol">#</span></a></div>
...
| Name | Type | Description |
|------|------|-------------|
| `body` | [Body](/api-docs/clay-native/arcade/Body/) | The Body object to insert into the quadtree. |
...
| Name | Type | Description |
|------|------|-------------|
| `left` | [Float](/api-docs/clay-native/Float/) | The left edge of the bounds to check.  |
| `top` | [Float](/api-docs/clay-native/Float/) | The top edge of the bounds to check.  |
| `right` | [Float](/api-docs/clay-native/Float/) | The right edge of the bounds to check.  |
| `bottom` | [Float](/api-docs/clay-native/Float/) | The bottom edge of the bounds to check.  |

| Returns | Description |
|---------|-------------|
| [Int](/api-docs/clay-native/Int/) | Index of the subnode (0-3), or -1 if rect cannot completely fit within a subnode and is part of the parent node. |
...
| Returns | Description |
|---------|-------------|
| [Array](/api-docs/clay-native/Array/)<[Body](/api-docs/clay-native/arcade/Body/)> | Array with all detected objects. |
...
| `maxObjects` | [Int](/api-docs/clay-native/Int/) | `10` |
| `maxLevels` | [Int](/api-docs/clay-native/Int/) | `4` |
| `level` | [Int](/api-docs/clay-native/Int/) | `0` |
