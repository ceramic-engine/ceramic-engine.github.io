...
target: Clay (Native)
permalink: api-docs/clay-native/clay/spec/GraphicsBatcher/
---
...
<div class="type-hierarchy"><strong>clay.spec.GraphicsBatcher</strong> (Interface) → <a href="/api-docs/clay-native/clay/opengl/GLGraphicsBatcher/">clay.opengl.GLGraphicsBatcher</a></div>
...
| Name | Type | Description |
|------|------|-------------|
| `attributes` | [Array](/api-docs/clay-native/Array/)<[Dynamic](/api-docs/clay-native/Dynamic/)> | Array of shader attributes (objects with 'size' field), or null for none |
...
| Returns | Description |
|---------|-------------|
| [Bool](/api-docs/clay-native/Bool/) | True if flush is needed before adding the geometry |
