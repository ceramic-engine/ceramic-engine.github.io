...
target: Clay (Native)
permalink: api-docs/clay-native/clay/opengl/GLGraphicsDriver/
---
...
<div class="signature field-var has-description" id="noFramebuffer"><code><span class="field-name">noFramebuffer</span><span class="operator">:</span> <a href="/api-docs/clay-native/clay/Framebuffer/" class="type-link">clay.Framebuffer</a></code><a class="header-anchor" href="#noFramebuffer"><span aria-hidden="true" class="header-anchor__symbol">#</span></a></div>

Sentinel value representing the default framebuffer.

<hr class="field-separator" />

<div class="signature field-var has-description" id="noRenderbuffer"><code><span class="field-name">noRenderbuffer</span><span class="operator">:</span> <a href="/api-docs/clay-native/clay/Renderbuffer/" class="type-link">clay.Renderbuffer</a></code><a class="header-anchor" href="#noRenderbuffer"><span aria-hidden="true" class="header-anchor__symbol">#</span></a></div>

Sentinel value representing the default renderbuffer.

<hr class="field-separator" />

<div class="signature field-var has-description" id="noShader"><code><span class="field-name">noShader</span><span class="operator">:</span> <a href="/api-docs/clay-native/clay/ShaderHandle/" class="type-link">clay.ShaderHandle</a></code><a class="header-anchor" href="#noShader"><span aria-hidden="true" class="header-anchor__symbol">#</span></a></div>

Sentinel value representing no shader handle.

<hr class="field-separator" />

<div class="signature field-var has-description" id="noProgram"><code><span class="field-name">noProgram</span><span class="operator">:</span> <a href="/api-docs/clay-native/clay/ProgramHandle/" class="type-link">clay.ProgramHandle</a></code><a class="header-anchor" href="#noProgram"><span aria-hidden="true" class="header-anchor__symbol">#</span></a></div>

Sentinel value representing no program handle.

<hr class="field-separator" />

<div class="signature field-var has-description" id="noLocation"><code><span class="field-name">noLocation</span><span class="operator">:</span> <a href="/api-docs/clay-native/clay/UniformLocation/" class="type-link">clay.UniformLocation</a></code><a class="header-anchor" href="#noLocation"><span aria-hidden="true" class="header-anchor__symbol">#</span></a></div>

Sentinel value representing an invalid uniform location.

<hr class="field-separator" />

<div class="signature field-var has-description" id="noBuffer"><code><span class="field-name">noBuffer</span><span class="operator">:</span> <a href="/api-docs/clay-native/clay/BufferHandle/" class="type-link">clay.BufferHandle</a></code><a class="header-anchor" href="#noBuffer"><span aria-hidden="true" class="header-anchor__symbol">#</span></a></div>
...
<div class="signature field-method has-description" id="getMaxTextureSize"><code><span class="field-name">getMaxTextureSize</span><span class="parenthesis">(</span><span class="parenthesis">)</span><span class="operator">:</span> <a href="/api-docs/clay-native/Int/" class="type-link">Int</a></code><a class="header-anchor" href="#getMaxTextureSize"><span aria-hidden="true" class="header-anchor__symbol">#</span></a></div>
...
| Returns | Description |
|---------|-------------|
| [Int](/api-docs/clay-native/Int/) | Maximum texture dimension in pixels |

<hr class="field-separator" />

<div class="signature field-method has-description" id="getMaxTextureUnits"><code><span class="field-name">getMaxTextureUnits</span><span class="parenthesis">(</span><span class="parenthesis">)</span><span class="operator">:</span> <a href="/api-docs/clay-native/Int/" class="type-link">Int</a></code><a class="header-anchor" href="#getMaxTextureUnits"><span aria-hidden="true" class="header-anchor__symbol">#</span></a></div>
...
|------|------|---------|-------------|
| `maxIfs` | [Int](/api-docs/clay-native/Int/) | `32` | Starting maximum to test (halves on failure until working)  |

| Returns | Description |
|---------|-------------|
| [Int](/api-docs/clay-native/Int/) | Maximum number of if-statements supported |

<hr class="field-separator" />

<div class="signature field-method has-description" id="loadExtensions"><code><span class="field-name">loadExtensions</span><span class="parenthesis">(</span><span class="parenthesis">)</span><span class="operator">:</span> <a href="/api-docs/clay-native/Void/" class="type-link">Void</a></code><a class="header-anchor" href="#loadExtensions"><span aria-hidden="true" class="header-anchor__symbol">#</span></a></div>
...
|------|------|-------------|
| `x` | [Int](/api-docs/clay-native/Int/) | X position to start reading  |
| `y` | [Int](/api-docs/clay-native/Int/) | Y position to start reading  |
| `width` | [Int](/api-docs/clay-native/Int/) | Width of the rectangle to read  |
| `height` | [Int](/api-docs/clay-native/Int/) | Height of the rectangle to read  |
| `pixels` | [clay.buffers.Uint8Array](/api-docs/clay-native/clay/buffers/Uint8Array/) | Buffer to store RGBA pixel data |
...
| Name | Type | Default | Description |
|------|------|---------|-------------|
| `r` | [Float](/api-docs/clay-native/Float/) | | Red component of clear color (0.0 to 1.0)  |
| `g` | [Float](/api-docs/clay-native/Float/) | | Green component of clear color (0.0 to 1.0)  |
| `b` | [Float](/api-docs/clay-native/Float/) | | Blue component of clear color (0.0 to 1.0)  |
| `a` | [Float](/api-docs/clay-native/Float/) | | Alpha component of clear color (0.0 to 1.0)  |
| `clearDepth` | [Bool](/api-docs/clay-native/Bool/) | `true` | Whether to also clear the depth buffer (default: true) |
...
| Name | Type | Description |
|------|------|-------------|
| `x` | [Int](/api-docs/clay-native/Int/) | Left edge of viewport  |
| `y` | [Int](/api-docs/clay-native/Int/) | Bottom edge of viewport  |
| `width` | [Int](/api-docs/clay-native/Int/) | Viewport width in pixels  |
| `height` | [Int](/api-docs/clay-native/Int/) | Viewport height in pixels |
...
| Name | Type | Description |
|------|------|-------------|
| `srcRgb` | [clay.BlendMode](/api-docs/clay-native/clay/BlendMode/) | Source blend factor for RGB channels  |
| `dstRgb` | [clay.BlendMode](/api-docs/clay-native/clay/BlendMode/) | Destination blend factor for RGB channels  |
| `srcAlpha` | [clay.BlendMode](/api-docs/clay-native/clay/BlendMode/) | Source blend factor for alpha channel  |
| `dstAlpha` | [clay.BlendMode](/api-docs/clay-native/clay/BlendMode/) | Destination blend factor for alpha channel |
...
| Returns | Description |
|---------|-------------|
| [clay.TextureId](/api-docs/clay-native/clay/TextureId/) | New texture identifier |
...
| Name | Type | Description |
|------|------|-------------|
| `textureId` | [clay.TextureId](/api-docs/clay-native/clay/TextureId/) | Texture identifier to delete |
...
| Name | Type | Description |
|------|------|-------------|
| `slot` | [Int](/api-docs/clay-native/Int/) | Texture slot index (0-based) |
...
| Name | Type | Description |
|------|------|-------------|
| `textureId` | [clay.TextureId](/api-docs/clay-native/clay/TextureId/) | Texture identifier to bind, or noTexture to unbind |
...
| Returns | Description |
|---------|-------------|
| [Bool](/api-docs/clay-native/Bool/) | True if preprocessing is needed, false if handled by GL |
...
| Name | Type | Description |
|------|------|-------------|
| `level` | [Int](/api-docs/clay-native/Int/) | Mipmap level (0 = base image)  |
| `format` | [clay.TextureFormat](/api-docs/clay-native/clay/TextureFormat/) | Texture format (RGB or RGBA)  |
| `width` | [Int](/api-docs/clay-native/Int/) | Texture width in pixels  |
| `height` | [Int](/api-docs/clay-native/Int/) | Texture height in pixels  |
| `dataType` | [clay.TextureDataType](/api-docs/clay-native/clay/TextureDataType/) | Data type of pixel data (UNSIGNED_BYTE)  |
| `pixels` | [clay.buffers.Uint8Array](/api-docs/clay-native/clay/buffers/Uint8Array/) | Pixel data buffer  |
| `premultipliedAlpha` | [Bool](/api-docs/clay-native/Bool/) | Whether pixels use premultiplied alpha |
...
|------|------|-------------|
| `level` | [Int](/api-docs/clay-native/Int/) | Mipmap level (0 = base image)  |
| `format` | [clay.TextureFormat](/api-docs/clay-native/clay/TextureFormat/) | Compressed texture format  |
| `width` | [Int](/api-docs/clay-native/Int/) | Texture width in pixels  |
| `height` | [Int](/api-docs/clay-native/Int/) | Texture height in pixels  |
| `pixels` | [clay.buffers.Uint8Array](/api-docs/clay-native/clay/buffers/Uint8Array/) | Compressed pixel data buffer  |
| `premultipliedAlpha` | [Bool](/api-docs/clay-native/Bool/) | Whether pixels use premultiplied alpha |
...
| Name | Type | Description |
|------|------|-------------|
| `into` | [clay.buffers.Uint8Array](/api-docs/clay-native/clay/buffers/Uint8Array/) | Buffer to store pixel data (must be at least w * h * 4 bytes)  |
| `x` | [Int](/api-docs/clay-native/Int/) | X position of texture rectangle to fetch  |
| `y` | [Int](/api-docs/clay-native/Int/) | Y position of texture rectangle to fetch  |
| `w` | [Int](/api-docs/clay-native/Int/) | Width of texture rectangle to fetch  |
| `h` | [Int](/api-docs/clay-native/Int/) | Height of texture rectangle to fetch |
...
| Name | Type | Description |
|------|------|-------------|
| `minFilter` | [clay.TextureFilter](/api-docs/clay-native/clay/TextureFilter/) | Filter mode (NEAREST, LINEAR, or mipmap variants) |
...
| Name | Type | Description |
|------|------|-------------|
| `magFilter` | [clay.TextureFilter](/api-docs/clay-native/clay/TextureFilter/) | Filter mode (NEAREST or LINEAR) |
...
| Name | Type | Description |
|------|------|-------------|
| `wrapS` | [clay.TextureWrap](/api-docs/clay-native/clay/TextureWrap/) | Wrap mode (CLAMP_TO_EDGE, REPEAT, or MIRRORED_REPEAT) |
...
| Name | Type | Description |
|------|------|-------------|
| `wrapT` | [clay.TextureWrap](/api-docs/clay-native/clay/TextureWrap/) | Wrap mode (CLAMP_TO_EDGE, REPEAT, or MIRRORED_REPEAT) |

<hr class="field-separator" />

<div class="signature field-method has-description" id="createFramebuffer"><code><span class="field-name">createFramebuffer</span><span class="parenthesis">(</span><span class="parenthesis">)</span><span class="operator">:</span> <a href="/api-docs/clay-native/clay/Framebuffer/" class="type-link">clay.Framebuffer</a></code><a class="header-anchor" href="#createFramebuffer"><span aria-hidden="true" class="header-anchor__symbol">#</span></a></div>
...
| Name | Type | Description |
|------|------|-------------|
| `framebuffer` | [clay.Framebuffer](/api-docs/clay-native/clay/Framebuffer/) | Framebuffer to bind, or noFramebuffer for default |

<hr class="field-separator" />

<div class="signature field-method has-description" id="createRenderbuffer"><code><span class="field-name">createRenderbuffer</span><span class="parenthesis">(</span><span class="parenthesis">)</span><span class="operator">:</span> <a href="/api-docs/clay-native/clay/Renderbuffer/" class="type-link">clay.Renderbuffer</a></code><a class="header-anchor" href="#createRenderbuffer"><span aria-hidden="true" class="header-anchor__symbol">#</span></a></div>
...
| Name | Type | Description |
|------|------|-------------|
| `renderbuffer` | [clay.Renderbuffer](/api-docs/clay-native/clay/Renderbuffer/) | Renderbuffer to bind, or noRenderbuffer for default |
...
| Name | Type | Description |
|------|------|-------------|
| `textureId` | [clay.TextureId](/api-docs/clay-native/clay/TextureId/) | Texture to render into  |
| `width` | [Int](/api-docs/clay-native/Int/) | Render target width in pixels  |
| `height` | [Int](/api-docs/clay-native/Int/) | Render target height in pixels  |
| `depth` | [Bool](/api-docs/clay-native/Bool/) | Whether to include a depth buffer  |
| `stencil` | [Bool](/api-docs/clay-native/Bool/) | Whether to include a stencil buffer  |
| `antialiasing` | [Int](/api-docs/clay-native/Int/) | MSAA sample count (0 or 1 for none)  |
| `level` | [Int](/api-docs/clay-native/Int/) | Mipmap level (0 = base)  |
| `format` | [clay.TextureFormat](/api-docs/clay-native/clay/TextureFormat/) | Texture format  |
| `dataType` | [clay.TextureDataType](/api-docs/clay-native/clay/TextureDataType/) | Data type of texture  |

| Returns | Description |
|---------|-------------|
| [clay.RenderTarget](/api-docs/clay-native/clay/RenderTarget/) | Created render target |

<hr class="field-separator" />

<div class="signature field-method has-description" id="deleteRenderTarget"><code><span class="field-name">deleteRenderTarget</span><span class="parenthesis">(</span><span class="arg-name">renderTarget</span><span class="operator">:</span> <a href="/api-docs/clay-native/clay/RenderTarget/" class="type-link">clay.RenderTarget</a><span class="parenthesis">)</span><span class="operator">:</span> <a href="/api-docs/clay-native/Void/" class="type-link">Void</a></code><a class="header-anchor" href="#deleteRenderTarget"><span aria-hidden="true" class="header-anchor__symbol">#</span></a></div>
...
| Name | Type | Description |
|------|------|-------------|
| `renderTarget` | [clay.RenderTarget](/api-docs/clay-native/clay/RenderTarget/) | Render target to delete |
...
| Name | Type | Description |
|------|------|-------------|
| `renderTarget` | [clay.RenderTarget](/api-docs/clay-native/clay/RenderTarget/) | Render target to configure  |
| `textureId` | [clay.TextureId](/api-docs/clay-native/clay/TextureId/) | Texture associated with the render target  |
| `width` | [Int](/api-docs/clay-native/Int/) | New width in pixels  |
| `height` | [Int](/api-docs/clay-native/Int/) | New height in pixels  |
| `depth` | [Bool](/api-docs/clay-native/Bool/) | Whether to include depth buffer  |
| `stencil` | [Bool](/api-docs/clay-native/Bool/) | Whether to include stencil buffer  |
| `antialiasing` | [Int](/api-docs/clay-native/Int/) | MSAA sample count |
...
| Name | Type | Description |
|------|------|-------------|
| `renderTarget` | [clay.RenderTarget](/api-docs/clay-native/clay/RenderTarget/) | Render target to resolve  |
| `width` | [Int](/api-docs/clay-native/Int/) | Width of the render target  |
| `height` | [Int](/api-docs/clay-native/Int/) | Height of the render target |
...
| Name | Type | Default | Description |
|------|------|---------|-------------|
| `vertSource` | [String](/api-docs/clay-native/String/) | | Vertex shader source code  |
| `fragSource` | [String](/api-docs/clay-native/String/) | | Fragment shader source code  |
| `attributes` | [Array](/api-docs/clay-native/Array/)<[String](/api-docs/clay-native/String/)> | *(optional)* | Optional array of attribute names in binding order  |
| `textures` | [Array](/api-docs/clay-native/Array/)<[String](/api-docs/clay-native/String/)> | *(optional)* | Optional array of texture uniform names in slot order  |

| Returns | Description |
|---------|-------------|
| [clay.GpuShader](/api-docs/clay-native/clay/GpuShader/) | Compiled shader, or null on failure |
...
| Name | Type | Description |
|------|------|-------------|
| `shader` | [clay.GpuShader](/api-docs/clay-native/clay/GpuShader/) | Shader program to delete |
...
| Name | Type | Description |
|------|------|-------------|
| `shader` | [clay.GpuShader](/api-docs/clay-native/clay/GpuShader/) | Shader program to use |

<hr class="field-separator" />

<div class="signature field-method has-description" id="synchronizeShaderMatrices"><code><span class="field-name">synchronizeShaderMatrices</span><span class="parenthesis">(</span><span class="arg-name">shader</span><span class="operator">:</span> <a href="/api-docs/clay-native/clay/GpuShader/" class="type-link">clay.GpuShader</a><span class="parenthesis">)</span><span class="operator">:</span> <a href="/api-docs/clay-native/Void/" class="type-link">Void</a></code><a class="header-anchor" href="#synchronizeShaderMatrices"><span aria-hidden="true" class="header-anchor__symbol">#</span></a></div>
...
| Name | Type | Description |
|------|------|-------------|
| `shader` | [clay.GpuShader](/api-docs/clay-native/clay/GpuShader/) | Shader program to synchronize |

<hr class="field-separator" />

<div class="signature field-method has-description" id="getUniformLocation"><code><span class="field-name">getUniformLocation</span><span class="parenthesis">(</span><span class="arg-name">shader</span><span class="operator">:</span> <a href="/api-docs/clay-native/clay/GpuShader/" class="type-link">clay.GpuShader</a><span class="operator">,</span> <span class="arg-name">name</span><span class="operator">:</span> <a href="/api-docs/clay-native/String/" class="type-link">String</a><span class="parenthesis">)</span><span class="operator">:</span> <a href="/api-docs/clay-native/clay/UniformLocation/" class="type-link">clay.UniformLocation</a></code><a class="header-anchor" href="#getUniformLocation"><span aria-hidden="true" class="header-anchor__symbol">#</span></a></div>
...
|------|------|-------------|
| `shader` | [clay.GpuShader](/api-docs/clay-native/clay/GpuShader/) | Shader program  |
| `location` | [clay.UniformLocation](/api-docs/clay-native/clay/UniformLocation/) | Uniform location  |
| `value` | [Int](/api-docs/clay-native/Int/) | Integer value |
...
| `shader` | [clay.GpuShader](/api-docs/clay-native/clay/GpuShader/) | Shader program  |
| `location` | [clay.UniformLocation](/api-docs/clay-native/clay/UniformLocation/) | Uniform location  |
| `value` | [clay.buffers.Int32Array](/api-docs/clay-native/clay/buffers/Int32Array/) | Integer array |
...
| `shader` | [clay.GpuShader](/api-docs/clay-native/clay/GpuShader/) | Shader program  |
| `location` | [clay.UniformLocation](/api-docs/clay-native/clay/UniformLocation/) | Uniform location  |
| `value` | [Float](/api-docs/clay-native/Float/) | Float value |
...
| `shader` | [clay.GpuShader](/api-docs/clay-native/clay/GpuShader/) | Shader program  |
| `location` | [clay.UniformLocation](/api-docs/clay-native/clay/UniformLocation/) | Uniform location  |
| `value` | [clay.buffers.Float32Array](/api-docs/clay-native/clay/buffers/Float32Array/) | Float array |
...
| `shader` | [clay.GpuShader](/api-docs/clay-native/clay/GpuShader/) | Shader program  |
| `location` | [clay.UniformLocation](/api-docs/clay-native/clay/UniformLocation/) | Uniform location  |
| `value` | [clay.buffers.Float32Array](/api-docs/clay-native/clay/buffers/Float32Array/) | Matrix as Float32Array (4 elements, column-major) |

<hr class="field-separator" />

<div class="signature field-method has-description" id="setMatrix3Uniform"><code><span class="field-name">setMatrix3Uniform</span><span class="parenthesis">(</span><span class="arg-name">shader</span><span class="operator">:</span> <a href="/api-docs/clay-native/clay/GpuShader/" class="type-link">clay.GpuShader</a><span class="operator">,</span> <span class="arg-name">location</span><span class="operator">:</span> <a href="/api-docs/clay-native/clay/UniformLocation/" class="type-link">clay.UniformLocation</a><span class="operator">,</span> <span class="arg-name">value</span><span class="operator">:</span> <a href="/api-docs/clay-native/clay/buffers/Float32Array/" class="type-link">clay.buffers.Float32Array</a><span class="parenthesis">)</span><span class="operator">:</span> <a href="/api-docs/clay-native/Void/" class="type-link">Void</a></code><a class="header-anchor" href="#setMatrix3Uniform"><span aria-hidden="true" class="header-anchor__symbol">#</span></a></div>
...
| `shader` | [clay.GpuShader](/api-docs/clay-native/clay/GpuShader/) | Shader program  |
| `location` | [clay.UniformLocation](/api-docs/clay-native/clay/UniformLocation/) | Uniform location  |
| `value` | [clay.buffers.Float32Array](/api-docs/clay-native/clay/buffers/Float32Array/) | Matrix as Float32Array (9 elements, column-major) |
...
| `shader` | [clay.GpuShader](/api-docs/clay-native/clay/GpuShader/) | Shader program  |
| `location` | [clay.UniformLocation](/api-docs/clay-native/clay/UniformLocation/) | Uniform location  |
| `value` | [clay.buffers.Float32Array](/api-docs/clay-native/clay/buffers/Float32Array/) | Matrix as Float32Array (16 elements, column-major) |
...
| `shader` | [clay.GpuShader](/api-docs/clay-native/clay/GpuShader/) | Shader program  |
| `location` | [clay.UniformLocation](/api-docs/clay-native/clay/UniformLocation/) | Uniform location  |
| `slot` | [Int](/api-docs/clay-native/Int/) | Texture slot index  |
| `texture` | [clay.TextureId](/api-docs/clay-native/clay/TextureId/) | Texture identifier to bind |
...
<div class="signature field-method has-description" id="patchGlslVersion"><code><span class="field-name">patchGlslVersion</span><span class="parenthesis">(</span><span class="arg-name">source</span><span class="operator">:</span> <a href="/api-docs/clay-native/String/" class="type-link">String</a><span class="parenthesis">)</span><span class="operator">:</span> <a href="/api-docs/clay-native/String/" class="type-link">String</a></code><a class="header-anchor" href="#patchGlslVersion"><span aria-hidden="true" class="header-anchor__symbol">#</span></a></div>
...
| Name | Type | Default | Description |
|------|------|---------|-------------|
| `shader` | [GLGraphicsDriver_GpuShader](/api-docs/clay-native/clay/opengl/GLGraphicsDriver_GpuShader/) | | Shader object with compiled vert/frag shaders  |
| `attributes` | [Array](/api-docs/clay-native/Array/)<[String](/api-docs/clay-native/String/)> | *(optional)* | Optional array of attribute names in binding order  |

| Returns | Description |
|---------|-------------|
| [Bool](/api-docs/clay-native/Bool/) | True if linking succeeded, false otherwise |
...
| Name | Type | Description |
|------|------|-------------|
| `shader` | [GLGraphicsDriver_GpuShader](/api-docs/clay-native/clay/opengl/GLGraphicsDriver_GpuShader/) | Shader to configure  |
| `textures` | [Array](/api-docs/clay-native/Array/)<[String](/api-docs/clay-native/String/)> | Array of texture uniform names in slot order |
...
| Name | Type | Description |
|------|------|-------------|
| `type` | [Int](/api-docs/clay-native/Int/) | GL.VERTEX_SHADER or GL.FRAGMENT_SHADER  |
| `source` | [String](/api-docs/clay-native/String/) | GLSL source code  |

| Returns | Description |
|---------|-------------|
| [GLShader](/api-docs/clay-native/clay/opengl/GLShader/) | Compiled shader, or noShader on failure |
