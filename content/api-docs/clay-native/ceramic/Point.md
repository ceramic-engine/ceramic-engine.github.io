...
title: Point
target: Clay (Native)
permalink: api-docs/clay-native/ceramic/Point/
---
...
|------|------|---------|-------------|
| `x` | [Float](/api-docs/clay-native/Float/) | `0` | The X coordinate (default: 0)  |
| `y` | [Float](/api-docs/clay-native/Float/) | `0` | The Y coordinate (default: 0)  |
| `z` | [Float](/api-docs/clay-native/Float/) | `0` | The Z coordinate (default: 0)  |

| Returns | Description |
|---------|-------------|
| [Point](/api-docs/clay-native/ceramic/Point/) | A Point instance with the specified coordinates |
...
| Returns | Description |
|---------|-------------|
| [String](/api-docs/clay-native/String/) | String representation of the point |
