...
target: Clay (Native)
permalink: api-docs/clay-native/ceramic/IntFloatMapKeyValueIterator/
---
...
<div class="signature field-var no-description" id="intFloatMap"><code><span class="field-name">intFloatMap</span><span class="operator">:</span> <a href="/api-docs/clay-native/ceramic/IntFloatMap/" class="type-link">IntFloatMap</a></code><a class="header-anchor" href="#intFloatMap"><span aria-hidden="true" class="header-anchor__symbol">#</span></a></div>
