...
title: LdtkEnumTag
target: Clay (Native)
permalink: api-docs/clay-native/ceramic/LdtkEnumTag/
---
...
<div class="type-hierarchy"><strong>ceramic.LdtkEnumTag</strong> (Class)</div>

## Instance Members

<div class="signature field-var no-description has-plugin" id="enumValueId"><div class="plugin-name">ldtk</div><code><span class="field-name">enumValueId</span><span class="operator">:</span> <a href="/api-docs/clay-native/String/" class="type-link">String</a></code><a class="header-anchor" href="#enumValueId"><span aria-hidden="true" class="header-anchor__symbol">#</span></a></div>

<hr class="field-separator" />

<div class="signature field-var no-description has-plugin" id="tileIds"><div class="plugin-name">ldtk</div><code><span class="field-name">tileIds</span><span class="operator">:</span> <a href="/api-docs/clay-native/Array/" class="type-link">Array</a><span class="operator">&lt;</span><a href="/api-docs/clay-native/Int/" class="type-link">Int</a><span class="operator">&gt;</span></code><a class="header-anchor" href="#tileIds"><span aria-hidden="true" class="header-anchor__symbol">#</span></a></div>
