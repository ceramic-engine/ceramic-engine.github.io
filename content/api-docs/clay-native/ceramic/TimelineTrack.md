...
title: TimelineTrack
target: Clay (Native)
permalink: api-docs/clay-native/ceramic/TimelineTrack/
---
...
<div class="type-hierarchy"><a href="/api-docs/clay-native/ceramic/Entity/">Entity</a> → <strong>ceramic.TimelineTrack</strong> (Class) → <a href="/api-docs/clay-native/ceramic/TimelineBoolTrack/">TimelineBoolTrack</a>, <a href="/api-docs/clay-native/ceramic/TimelineColorTrack/">TimelineColorTrack</a>, <a href="/api-docs/clay-native/ceramic/TimelineDegreesTrack/">TimelineDegreesTrack</a>, <a href="/api-docs/clay-native/ceramic/TimelineFloatArrayTrack/">TimelineFloatArrayTrack</a>, <a href="/api-docs/clay-native/ceramic/TimelineFloatTrack/">TimelineFloatTrack</a></div>
...
<div class="see"><strong>See:</strong> <a href="/api-docs/clay-native/ceramic/Timeline/">Timeline</a>, <a href="/api-docs/clay-native/ceramic/TimelineKeyframe/">TimelineKeyframe</a></div>
...
<div class="signature field-var has-description" id="locked"><code><span class="field-name">locked</span><span class="operator">:</span> <a href="/api-docs/clay-native/Bool/" class="type-link">Bool</a></code><a class="header-anchor" href="#locked"><span aria-hidden="true" class="header-anchor__symbol">#</span></a></div>
...
|------|------|---------|-------------|
| `forceChange` | [Bool](/api-docs/clay-native/Bool/) | `false` | If true, forces the update even if the value hasn't changed |
...
| Name | Type | Description |
|------|------|-------------|
| `index` | [Int](/api-docs/clay-native/Int/) | The frame index to search for  |

| Returns | Description |
|---------|-------------|
| [Null](/api-docs/clay-native/Null/)<ceramic.TimelineTrack.K> | The keyframe at that index, or null if none exists |
...
| Name | Type | Description |
|------|------|-------------|
| `position` | [Float](/api-docs/clay-native/Float/) | The position to search from  |

| Returns | Description |
|---------|-------------|
| [Null](/api-docs/clay-native/Null/)<ceramic.TimelineTrack.K> | The keyframe at or before the position, or null if none exists |
...
| Returns | Description |
|---------|-------------|
| [Null](/api-docs/clay-native/Null/)<ceramic.TimelineTrack.K> | The keyframe after the position, or null if none exists |
