...
title: Equal
target: Clay (Native)
permalink: api-docs/clay-native/ceramic/Equal/
---
...
|------|------|-------------|
| `a` | [Dynamic](/api-docs/clay-native/Dynamic/) | First value to compare  |
| `b` | [Dynamic](/api-docs/clay-native/Dynamic/) | Second value to compare  |

| Returns | Description |
|---------|-------------|
| [Bool](/api-docs/clay-native/Bool/) | True if values are deeply equal, false otherwise * ```haxe // Simple values Equal.equal(5, 5); // true Equal.equal("hello", "hello"); // true * // Arrays Equal.equal([1, 2, 3], [1, 2, 3]); // true Equal.equal([1, 2], [1, 2, 3]); // false * // Objects Equal.equal( {name: "John", age: 30}, {name: "John", age: 30} ); // true ``` |

<hr class="field-separator" />

<div class="signature field-method has-description" id="objectFieldsEqual"><code><span class="field-name">objectFieldsEqual</span><span class="parenthesis">(</span><span class="arg-name">a</span><span class="operator">:</span> <a href="/api-docs/clay-native/Any/" class="type-link">Any</a><span class="operator">,</span> <span class="arg-name">b</span><span class="operator">:</span> <a href="/api-docs/clay-native/Any/" class="type-link">Any</a><span class="parenthesis">)</span><span class="operator">:</span> <a href="/api-docs/clay-native/Bool/" class="type-link">Bool</a></code><a class="header-anchor" href="#objectFieldsEqual"><span aria-hidden="true" class="header-anchor__symbol">#</span></a></div>
...
| Name | Type | Description |
|------|------|-------------|
| `a` | [Any](/api-docs/clay-native/Any/) | First object to compare  |
| `b` | [Any](/api-docs/clay-native/Any/) | Second object to compare  |

| Returns | Description |
|---------|-------------|
| [Bool](/api-docs/clay-native/Bool/) | True if all fields match, false otherwise * ```haxe var obj1 = {x: 10, y: {z: 20}}; var obj2 = {x: 10, y: {z: 20}}; Equal.objectFieldsEqual(obj1, obj2); // true * var obj3 = {x: 10, y: 20, extra: true}; Equal.objectFieldsEqual(obj1, obj3); // false (different fields) ``` |

<hr class="field-separator" />

<div class="signature field-method has-description" id="arrayEqual"><code><span class="field-name">arrayEqual</span><span class="parenthesis">(</span><span class="arg-name">a</span><span class="operator">:</span> <a href="/api-docs/clay-native/Array/" class="type-link">Array</a><span class="operator">&lt;</span><a href="/api-docs/clay-native/Any/" class="type-link">Any</a><span class="operator">&gt;</span><span class="operator">,</span> <span class="arg-name">b</span><span class="operator">:</span> <a href="/api-docs/clay-native/Array/" class="type-link">Array</a><span class="operator">&lt;</span><a href="/api-docs/clay-native/Any/" class="type-link">Any</a><span class="operator">&gt;</span><span class="parenthesis">)</span><span class="operator">:</span> <a href="/api-docs/clay-native/Bool/" class="type-link">Bool</a></code><a class="header-anchor" href="#arrayEqual"><span aria-hidden="true" class="header-anchor__symbol">#</span></a></div>
...
| Name | Type | Description |
|------|------|-------------|
| `a` | [Array](/api-docs/clay-native/Array/)<[Any](/api-docs/clay-native/Any/)> | First array  |
| `b` | [Array](/api-docs/clay-native/Array/)<[Any](/api-docs/clay-native/Any/)> | Second array  |

| Returns | Description |
|---------|-------------|
| [Bool](/api-docs/clay-native/Bool/) | True if arrays are equal |

<hr class="field-separator" />

<div class="signature field-method has-description" id="stringMapEqual"><code><span class="field-name">stringMapEqual</span><span class="parenthesis">(</span><span class="arg-name">a</span><span class="operator">:</span> <a href="/api-docs/clay-native/haxe/ds/StringMap/" class="type-link">haxe.ds.StringMap</a><span class="operator">&lt;</span><a href="/api-docs/clay-native/Any/" class="type-link">Any</a><span class="operator">&gt;</span><span class="operator">,</span> <span class="arg-name">b</span><span class="operator">:</span> <a href="/api-docs/clay-native/haxe/ds/StringMap/" class="type-link">haxe.ds.StringMap</a><span class="operator">&lt;</span><a href="/api-docs/clay-native/Any/" class="type-link">Any</a><span class="operator">&gt;</span><span class="parenthesis">)</span><span class="operator">:</span> <a href="/api-docs/clay-native/Bool/" class="type-link">Bool</a></code><a class="header-anchor" href="#stringMapEqual"><span aria-hidden="true" class="header-anchor__symbol">#</span></a></div>
...
| Name | Type | Description |
|------|------|-------------|
| `a` | [haxe.ds.StringMap](/api-docs/clay-native/haxe/ds/StringMap/)<[Any](/api-docs/clay-native/Any/)> | First StringMap  |
| `b` | [haxe.ds.StringMap](/api-docs/clay-native/haxe/ds/StringMap/)<[Any](/api-docs/clay-native/Any/)> | Second StringMap  |

| Returns | Description |
|---------|-------------|
| [Bool](/api-docs/clay-native/Bool/) | True if maps have identical key-value pairs * ```haxe var map1 = new StringMap<Int>(); map1.set("a", 1); map1.set("b", 2); * var map2 = new StringMap<Int>(); map2.set("b", 2); map2.set("a", 1); * Equal.stringMapEqual(map1, map2); // true (order doesn't matter) ``` |

<hr class="field-separator" />

<div class="signature field-method has-description" id="intMapEqual"><code><span class="field-name">intMapEqual</span><span class="parenthesis">(</span><span class="arg-name">a</span><span class="operator">:</span> <a href="/api-docs/clay-native/haxe/ds/IntMap/" class="type-link">haxe.ds.IntMap</a><span class="operator">&lt;</span><a href="/api-docs/clay-native/Any/" class="type-link">Any</a><span class="operator">&gt;</span><span class="operator">,</span> <span class="arg-name">b</span><span class="operator">:</span> <a href="/api-docs/clay-native/haxe/ds/IntMap/" class="type-link">haxe.ds.IntMap</a><span class="operator">&lt;</span><a href="/api-docs/clay-native/Any/" class="type-link">Any</a><span class="operator">&gt;</span><span class="parenthesis">)</span><span class="operator">:</span> <a href="/api-docs/clay-native/Bool/" class="type-link">Bool</a></code><a class="header-anchor" href="#intMapEqual"><span aria-hidden="true" class="header-anchor__symbol">#</span></a></div>
...
| Name | Type | Description |
|------|------|-------------|
| `a` | [haxe.ds.IntMap](/api-docs/clay-native/haxe/ds/IntMap/)<[Any](/api-docs/clay-native/Any/)> | First IntMap  |
| `b` | [haxe.ds.IntMap](/api-docs/clay-native/haxe/ds/IntMap/)<[Any](/api-docs/clay-native/Any/)> | Second IntMap  |

| Returns | Description |
|---------|-------------|
| [Bool](/api-docs/clay-native/Bool/) | True if maps have identical key-value pairs * ```haxe var map1 = new IntMap<String>(); map1.set(1, "one"); map1.set(2, "two"); * var map2 = new IntMap<String>(); map2.set(2, "two"); map2.set(1, "one"); * Equal.intMapEqual(map1, map2); // true ``` |
