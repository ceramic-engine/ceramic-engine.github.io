...
title: Float32Array
target: Clay (Native)
permalink: api-docs/clay-native/ceramic/Float32Array/
---

# Float32Array

<div class="view-source"><a href="https://github.com/ceramic-engine/ceramic/blob/master/runtime/src/ceramic/Float32Array.hx">View source</a></div>

<div class="type-hierarchy"><strong>ceramic.Float32Array</strong> (Typedef)</div>
...
<div class="see"><strong>See:</strong> UInt8Array For 8-bit unsigned integer arrays, ceramic.Mesh For usage in vertex data, ceramic.AudioFilterBuffer For usage in audio processing</div>
