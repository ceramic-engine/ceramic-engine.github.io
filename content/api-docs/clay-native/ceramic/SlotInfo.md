...
title: SlotInfo
target: Clay (Native)
permalink: api-docs/clay-native/ceramic/SlotInfo/
---
...
<div class="signature field-var has-description has-plugin" id="slot"><div class="plugin-name">spine</div><code><span class="field-name">slot</span><span class="operator">:</span> <a href="/api-docs/clay-native/spine/Slot/" class="type-link">spine.Slot</a></code><a class="header-anchor" href="#slot"><span aria-hidden="true" class="header-anchor__symbol">#</span></a></div>
