...
title: Assert
target: Clay (Native)
permalink: api-docs/clay-native/ceramic/Assert/
---
...
|------|------|---------|-------------|
| `expr` | [Dynamic](/api-docs/clay-native/Dynamic/) | | The expression to evaluate. Must resolve to a boolean value.  |
| `reason` | [String](/api-docs/clay-native/String/) | *(optional)* | Optional custom error message to include when assertion fails. If not provided, defaults to "Assertion failure". * |
