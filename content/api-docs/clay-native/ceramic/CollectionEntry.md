...
target: Clay (Native)
permalink: api-docs/clay-native/ceramic/CollectionEntry/
---
...
<div class="type-hierarchy"><strong>ceramic.CollectionEntry</strong> (Class) → <a href="/api-docs/clay-native/ceramic/ValueEntry/">ValueEntry</a></div>
...
<div class="see"><strong>See:</strong> <a href="/api-docs/clay-native/ceramic/Collection/">Collection</a>, <a href="/api-docs/clay-native/ceramic/FieldInfo/">FieldInfo</a></div>
...
| Name | Type | Description |
|------|------|-------------|
| `name` | [String](/api-docs/clay-native/String/) | The field name  |
| `rawValue` | [Dynamic](/api-docs/clay-native/Dynamic/) | The raw value to process  |

| Returns | Description |
|---------|-------------|
| [Bool](/api-docs/clay-native/Bool/) | True if field was handled, false to use default conversion |
...
|------|------|---------|-------------|
| `id` | [String](/api-docs/clay-native/String/) | *(optional)* | Optional unique identifier (auto-generated if not provided)  |
| `name` | [String](/api-docs/clay-native/String/) | *(optional)* | Optional human-readable name |
