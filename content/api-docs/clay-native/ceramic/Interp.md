...
title: Interp
target: Clay (Native)
permalink: api-docs/clay-native/ceramic/Interp/
---
...
<div class="type-hierarchy"><a href="/api-docs/clay-native/hscript/Interp/">hscript.Interp</a> → <strong>ceramic.Interp</strong> (Class)</div>
...
|------|------|-------------|
| `owner` | [Script](/api-docs/clay-native/ceramic/Script/) | Script that owns this interpreter |

## Private Members

<div class="signature field-var has-description has-plugin" id="owner"><div class="plugin-name">script</div><code><span class="field-name">owner</span><span class="operator">:</span> <a href="/api-docs/clay-native/ceramic/Script/" class="type-link">Script</a></code><a class="header-anchor" href="#owner"><span aria-hidden="true" class="header-anchor__symbol">#</span></a></div>
...
| Name | Type | Description |
|------|------|-------------|
| `o` | [Dynamic](/api-docs/clay-native/Dynamic/) | Object to call method on  |
| `f` | [String](/api-docs/clay-native/String/) | Function name  |
| `args` | [Array](/api-docs/clay-native/Array/)<[Dynamic](/api-docs/clay-native/Dynamic/)> | Function arguments  |

| Returns | Description |
|---------|-------------|
| [Dynamic](/api-docs/clay-native/Dynamic/) | Function result |
...
| Name | Type | Description |
|------|------|-------------|
| `o` | [Dynamic](/api-docs/clay-native/Dynamic/) | Object to get field from  |
| `f` | [String](/api-docs/clay-native/String/) | Field name  |

| Returns | Description |
|---------|-------------|
| [Dynamic](/api-docs/clay-native/Dynamic/) | Field value |
...
| Name | Type | Description |
|------|------|-------------|
| `cl` | [String](/api-docs/clay-native/String/) | Class name  |
| `args` | [Array](/api-docs/clay-native/Array/)<[Dynamic](/api-docs/clay-native/Dynamic/)> | Constructor arguments  |

| Returns | Description |
|---------|-------------|
| [Dynamic](/api-docs/clay-native/Dynamic/) | New instance |
...
| Name | Type | Description |
|------|------|-------------|
| `e` | [hscript.Expr](/api-docs/clay-native/hscript/Expr/) | Expression to evaluate  |

| Returns | Description |
|---------|-------------|
| [Dynamic](/api-docs/clay-native/Dynamic/) | Expression result or null if error |
