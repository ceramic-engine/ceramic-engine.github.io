...
title: System
target: Clay (Native)
permalink: api-docs/clay-native/ceramic/System/
---
...
<div class="type-hierarchy"><a href="/api-docs/clay-native/ceramic/Entity/">Entity</a> → <strong>ceramic.System</strong> (Class) → <a href="/api-docs/clay-native/ceramic/ArcadeSystem/">ArcadeSystem</a>, <a href="/api-docs/clay-native/ceramic/NapeSystem/">NapeSystem</a>, <a href="/api-docs/clay-native/ceramic/SceneSystem/">SceneSystem</a>, <a href="/api-docs/clay-native/ceramic/SpineSystem/">SpineSystem</a>, <a href="/api-docs/clay-native/ceramic/SpriteSystem/">SpriteSystem</a>, <a href="/api-docs/clay-native/ceramic/StateMachineSystem/">StateMachineSystem</a>, <a href="/api-docs/clay-native/ceramic/ViewSystem/">ViewSystem</a>, <a href="/api-docs/clay-native/elements/FieldSystem/">elements.FieldSystem</a>, <a href="/api-docs/clay-native/elements/ImSystem/">elements.ImSystem</a></div>
...
<div class="see"><strong>See:</strong> <a href="/api-docs/clay-native/ceramic/Systems/">Systems</a>, <a href="/api-docs/clay-native/ceramic/App/">App</a></div>
...
<div class="signature field-var has-description" id="earlyUpdateOrder"><code><span class="field-name">earlyUpdateOrder</span><span class="operator">:</span> <a href="/api-docs/clay-native/Float/" class="type-link">Float</a></code><a class="header-anchor" href="#earlyUpdateOrder"><span aria-hidden="true" class="header-anchor__symbol">#</span></a></div>
...
<div class="signature field-method has-description" id="emitEndEarlyUpdate"><code><span class="field-name">emitEndEarlyUpdate</span><span class="parenthesis">(</span><span class="arg-name">delta</span><span class="operator">:</span> <a href="/api-docs/clay-native/Float/" class="type-link">Float</a><span class="parenthesis">)</span><span class="operator">:</span> <a href="/api-docs/clay-native/Void/" class="type-link">Void</a></code><a class="header-anchor" href="#emitEndEarlyUpdate"><span aria-hidden="true" class="header-anchor__symbol">#</span></a></div>
...
<div class="signature field-method has-description" id="emitEndLateUpdate"><code><span class="field-name">emitEndLateUpdate</span><span class="parenthesis">(</span><span class="arg-name">delta</span><span class="operator">:</span> <a href="/api-docs/clay-native/Float/" class="type-link">Float</a><span class="parenthesis">)</span><span class="operator">:</span> <a href="/api-docs/clay-native/Void/" class="type-link">Void</a></code><a class="header-anchor" href="#emitEndLateUpdate"><span aria-hidden="true" class="header-anchor__symbol">#</span></a></div>
