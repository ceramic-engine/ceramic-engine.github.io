...
title: FieldMeta
target: Clay (Native)
permalink: api-docs/clay-native/ceramic/FieldMeta/
---
...
|------|------|---------|-------------|
| `clazz` | [Class](/api-docs/clay-native/Class/)<[Dynamic](/api-docs/clay-native/Dynamic/)> | | The class containing the field  |
| `field` | [String](/api-docs/clay-native/String/) | | The name of the field to check  |
| `meta` | [String](/api-docs/clay-native/String/) | | The metadata name to look for  |
| `recursive` | [Bool](/api-docs/clay-native/Bool/) | `true` | Whether to include parent classes in the search (default: true)  |

| Returns | Description |
|---------|-------------|
| [Bool](/api-docs/clay-native/Bool/) | True if the field has the specified metadata |
...
|------|------|---------|-------------|
| `clazz` | [Class](/api-docs/clay-native/Class/)<[Dynamic](/api-docs/clay-native/Dynamic/)> | | The class containing the field  |
| `field` | [String](/api-docs/clay-native/String/) | | The name of the field to get metadata for  |
| `recursive` | [Bool](/api-docs/clay-native/Bool/) | `true` | Whether to include parent classes in the search (default: true)  |

| Returns | Description |
|---------|-------------|
| [ReadOnlyMap](/api-docs/clay-native/ceramic/ReadOnlyMap/)<[String](/api-docs/clay-native/String/), [Dynamic](/api-docs/clay-native/Dynamic/)> | A read-only map of metadata names to values, or null if field not found |

## Private Members

<div class="signature field-var has-description" id="metaMap"><code><span class="field-name">metaMap</span><span class="operator">:</span> <a href="/api-docs/clay-native/Map/" class="type-link">Map</a></code><a class="header-anchor" href="#metaMap"><span aria-hidden="true" class="header-anchor__symbol">#</span></a></div>
...
<div class="signature field-var has-description" id="metaMapRecursive"><code><span class="field-name">metaMapRecursive</span><span class="operator">:</span> <a href="/api-docs/clay-native/Map/" class="type-link">Map</a></code><a class="header-anchor" href="#metaMapRecursive"><span aria-hidden="true" class="header-anchor__symbol">#</span></a></div>
