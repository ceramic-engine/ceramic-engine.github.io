...
title: TimerCallback
target: Clay (Native)
permalink: api-docs/clay-native/ceramic/TimerCallback/
---
...
<div class="signature field-var has-description" id="owner"><code><span class="field-name">owner</span><span class="operator">:</span> <a href="/api-docs/clay-native/ceramic/Entity/" class="type-link">Entity</a></code><a class="header-anchor" href="#owner"><span aria-hidden="true" class="header-anchor__symbol">#</span></a></div>
...
<div class="signature field-var has-description" id="cleared"><code><span class="field-name">cleared</span><span class="operator">:</span> <a href="/api-docs/clay-native/Bool/" class="type-link">Bool</a></code><a class="header-anchor" href="#cleared"><span aria-hidden="true" class="header-anchor__symbol">#</span></a></div>
