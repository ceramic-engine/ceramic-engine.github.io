...
title: RoundedRect
target: Clay (Native)
permalink: api-docs/clay-native/ceramic/RoundedRect/
---
...
<div class="type-hierarchy"><a href="/api-docs/clay-native/ceramic/Entity/">Entity</a> → <a href="/api-docs/clay-native/ceramic/Visual/">Visual</a> → <a href="/api-docs/clay-native/ceramic/Mesh/">Mesh</a> → <a href="/api-docs/clay-native/ceramic/Shape/">Shape</a> → <strong>ceramic.RoundedRect</strong> (Class)</div>
...
<div class="signature field-var has-description" id="segments"><code><span class="field-name">segments</span><span class="operator">:</span> <a href="/api-docs/clay-native/Int/" class="type-link">Int</a></code><a class="header-anchor" href="#segments"><span aria-hidden="true" class="header-anchor__symbol">#</span></a></div>
...
<div class="signature field-var has-description" id="radiusTopLeft"><code><span class="field-name">radiusTopLeft</span><span class="operator">:</span> <a href="/api-docs/clay-native/Float/" class="type-link">Float</a></code><a class="header-anchor" href="#radiusTopLeft"><span aria-hidden="true" class="header-anchor__symbol">#</span></a></div>
...
<div class="signature field-var has-description" id="radiusTopRight"><code><span class="field-name">radiusTopRight</span><span class="operator">:</span> <a href="/api-docs/clay-native/Float/" class="type-link">Float</a></code><a class="header-anchor" href="#radiusTopRight"><span aria-hidden="true" class="header-anchor__symbol">#</span></a></div>
...
<div class="signature field-var has-description" id="radiusBottomRight"><code><span class="field-name">radiusBottomRight</span><span class="operator">:</span> <a href="/api-docs/clay-native/Float/" class="type-link">Float</a></code><a class="header-anchor" href="#radiusBottomRight"><span aria-hidden="true" class="header-anchor__symbol">#</span></a></div>
...
<div class="signature field-var has-description" id="radiusBottomLeft"><code><span class="field-name">radiusBottomLeft</span><span class="operator">:</span> <a href="/api-docs/clay-native/Float/" class="type-link">Float</a></code><a class="header-anchor" href="#radiusBottomLeft"><span aria-hidden="true" class="header-anchor__symbol">#</span></a></div>
...
|------|------|---------|-------------|
| `topLeft` | [Float](/api-docs/clay-native/Float/) | | Radius for top-left corner (required)  |
| `topRight` | [Float](/api-docs/clay-native/Float/) | *(optional)* | Radius for top-right corner (optional)  |
| `bottomRight` | [Float](/api-docs/clay-native/Float/) | *(optional)* | Radius for bottom-right corner (optional)  |
| `bottomLeft` | [Float](/api-docs/clay-native/Float/) | *(optional)* | Radius for bottom-left corner (optional) * ```haxe // All corners 20px rect.radius(20); * // Top corners 20px, bottom corners 10px rect.radius(20, 10); * // Each corner different rect.radius(20, 15, 10, 5); ``` |
