...
title: TextureTile
target: Clay (Native)
permalink: api-docs/clay-native/ceramic/TextureTile/
---
...
<div class="type-hierarchy"><strong>ceramic.TextureTile</strong> (Class) → <a href="/api-docs/clay-native/ceramic/TextureAtlasRegion/">TextureAtlasRegion</a>, <a href="/api-docs/clay-native/ceramic/_TextureTilePacker/PackedTextureTile/">ceramic._TextureTilePacker.PackedTextureTile</a></div>
...
<div class="signature field-var has-description" id="edgeInset"><code><span class="field-name">edgeInset</span><span class="operator">:</span> <a href="/api-docs/clay-native/Float/" class="type-link">Float</a></code><a class="header-anchor" href="#edgeInset"><span aria-hidden="true" class="header-anchor__symbol">#</span></a></div>
...
|------|------|-------------|
| `frameX` | [Float](/api-docs/clay-native/Float/) | New X coordinate in texture pixels  |
| `frameY` | [Float](/api-docs/clay-native/Float/) | New Y coordinate in texture pixels  |
| `frameWidth` | [Float](/api-docs/clay-native/Float/) | New width in texture pixels  |
| `frameHeight` | [Float](/api-docs/clay-native/Float/) | New height in texture pixels |
...
|------|------|---------|-------------|
| `texture` | [Texture](/api-docs/clay-native/ceramic/Texture/) | | Source texture containing the tile  |
| `frameX` | [Float](/api-docs/clay-native/Float/) | | X coordinate in texture pixels  |
| `frameY` | [Float](/api-docs/clay-native/Float/) | | Y coordinate in texture pixels  |
| `frameWidth` | [Float](/api-docs/clay-native/Float/) | | Width in texture pixels  |
| `frameHeight` | [Float](/api-docs/clay-native/Float/) | | Height in texture pixels  |
| `rotateFrame` | [Bool](/api-docs/clay-native/Bool/) | `false` | Whether tile is rotated 90 degrees (default: false)  |
| `edgeInset` | [Float](/api-docs/clay-native/Float/) | `0` | Pixel inset for edge bleeding prevention (default: 0) |
...
| Returns | Description |
|---------|-------------|
| [String](/api-docs/clay-native/String/) | String with tile properties |
