...
target: Clay (Native)
permalink: api-docs/clay-native/ceramic/ArcadeSortGroupTopBottom/
---
...
|------|------|-------------|
| `a` | [Array](/api-docs/clay-native/Array/)<[Visual](/api-docs/clay-native/ceramic/Visual/)> | The array of visuals to sort |
...
| Returns | Description |
|---------|-------------|
| [Int](/api-docs/clay-native/Int/) | 1 if a.body.y >= b.body.y, -1 otherwise, 0 if either has no body |
