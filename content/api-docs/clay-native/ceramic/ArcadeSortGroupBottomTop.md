...
target: Clay (Native)
permalink: api-docs/clay-native/ceramic/ArcadeSortGroupBottomTop/
---
...
| Returns | Description |
|---------|-------------|
| [Int](/api-docs/clay-native/Int/) | 1 if b.body.y > a.body.y, -1 otherwise, 0 if either has no body |
