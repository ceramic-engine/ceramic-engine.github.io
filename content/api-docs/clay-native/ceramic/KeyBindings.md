...
title: KeyBindings
target: Clay (Native)
permalink: api-docs/clay-native/ceramic/KeyBindings/
---
...
<div class="type-hierarchy"><a href="/api-docs/clay-native/ceramic/Entity/">Entity</a> → <strong>ceramic.KeyBindings</strong> (Class)</div>
...
<div class="see"><strong>See:</strong> <a href="/api-docs/clay-native/ceramic/KeyBinding/">KeyBinding</a>, <a href="/api-docs/clay-native/ceramic/KeyAcceleratorItem/">KeyAcceleratorItem</a></div>
...
|------|------|---------|-------------|
| `accelerator` | [Array](/api-docs/clay-native/Array/)<Anonymous> | | Array of keys that must be pressed together. Order doesn't matter for modifier keys.  |
...
| Returns | Description |
|---------|-------------|
| [KeyBinding](/api-docs/clay-native/ceramic/KeyBinding/) | The created KeyBinding instance |
