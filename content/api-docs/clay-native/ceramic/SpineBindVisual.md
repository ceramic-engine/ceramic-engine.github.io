...
target: Clay (Native)
permalink: api-docs/clay-native/ceramic/SpineBindVisual/
---
...
|------|------|-------------|
| `spine` | [Spine](/api-docs/clay-native/ceramic/Spine/) | The Spine instance  |
| `slotName` | [String](/api-docs/clay-native/String/) | Name of the slot to hide |

<hr class="field-separator" />

<div class="signature field-method has-description has-plugin" id="showSlot"><div class="plugin-name">spine</div><code><span class="field-name">showSlot</span><span class="parenthesis">(</span><span class="arg-name">spine</span><span class="operator">:</span> <a href="/api-docs/clay-native/ceramic/Spine/" class="type-link">Spine</a><span class="operator">,</span> <span class="arg-name">slotName</span><span class="operator">:</span> <a href="/api-docs/clay-native/String/" class="type-link">String</a><span class="parenthesis">)</span><span class="operator">:</span> <a href="/api-docs/clay-native/Void/" class="type-link">Void</a></code><a class="header-anchor" href="#showSlot"><span aria-hidden="true" class="header-anchor__symbol">#</span></a></div>
...
|------|------|---------|-------------|
| `spine` | [Spine](/api-docs/clay-native/ceramic/Spine/) | | The Spine instance to bind to  |
| `slotName` | [String](/api-docs/clay-native/String/) | | Name of the slot to follow  |
| `visual` | [Visual](/api-docs/clay-native/ceramic/Visual/) | | The Ceramic visual to attach  |
| `offsetX` | [Float](/api-docs/clay-native/Float/) | `0.0` | Horizontal offset from the slot position  |
| `offsetY` | [Float](/api-docs/clay-native/Float/) | `0.0` | Vertical offset from the slot position  |

| Returns | Description |
|---------|-------------|
| [SpineBindVisualOptions](/api-docs/clay-native/ceramic/SpineBindVisualOptions/) | Configuration options for customizing the binding behavior |
