...
target: Clay (Native)
permalink: api-docs/clay-native/ceramic/KeyAcceleratorItem/
---
...
<div class="see"><strong>See:</strong> <a href="/api-docs/clay-native/ceramic/KeyBinding/">KeyBinding</a>, <a href="/api-docs/clay-native/ceramic/KeyBindings/">KeyBindings</a></div>
...
|------|------|-------------|
| `scanCode` | [ceramic.ScanCode](/api-docs/clay-native/ceramic/ScanCode/) | The scan code of the key |
...
| Name | Type | Description |
|------|------|-------------|
| `keyCode` | [ceramic.KeyCode](/api-docs/clay-native/ceramic/KeyCode/) | The key code of the key |
