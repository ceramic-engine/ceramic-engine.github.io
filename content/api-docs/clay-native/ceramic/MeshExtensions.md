...
target: Clay (Native)
permalink: api-docs/clay-native/ceramic/MeshExtensions/
---
...
|------|------|---------|-------------|
| `mesh` | [Mesh](/api-docs/clay-native/ceramic/Mesh/) | | The mesh to configure as a quad  |
| `width` | [Float](/api-docs/clay-native/Float/) | | Width of the quad in pixels  |
| `height` | [Float](/api-docs/clay-native/Float/) | | Height of the quad in pixels  |
| `floatsPerVertex` | [Int](/api-docs/clay-native/Int/) | `-1` | Number of floats per vertex in the vertex buffer. - 2: Standard quad (x, y) - 6: Quad with dark color support (x, y, r, g, b, a) - -1: Auto-detect from mesh.customFloatAttributesSize Must be at least 2. * ```haxe var mesh = new Mesh(); mesh.createQuad(200, 150); // Creates a 200x150 quad mesh.texture = myTexture; // Apply texture ``` |

<hr class="field-separator" />

<div class="signature field-method has-description" id="setDarkColor"><code><span class="field-name">setDarkColor</span><span class="parenthesis">(</span><span class="arg-name">mesh</span><span class="operator">:</span> <a href="/api-docs/clay-native/ceramic/Mesh/" class="type-link">Mesh</a><span class="operator">,</span> <span class="arg-name">darkColor</span><span class="operator">:</span> <a href="/api-docs/clay-native/ceramic/Color/" class="type-link">Color</a><span class="parenthesis">)</span><span class="operator">:</span> <a href="/api-docs/clay-native/Void/" class="type-link">Void</a></code><a class="header-anchor" href="#setDarkColor"><span aria-hidden="true" class="header-anchor__symbol">#</span></a></div>
...
|------|------|-------------|
| `mesh` | [Mesh](/api-docs/clay-native/ceramic/Mesh/) | The mesh to modify. Must have 6 floats per vertex.  |
| `darkColor` | [Color](/api-docs/clay-native/ceramic/Color/) | The dark color to apply to all vertices. Alpha is automatically set to 1.0. * ```haxe var mesh = new Mesh(); mesh.createQuad(100, 100, 6); // 6 floats per vertex mesh.setDarkColor(Color.PURPLE); // Set dark color mesh.shader = myDarkColorShader; // Use compatible shader ``` |

<hr class="field-separator" />

<div class="signature field-method has-description" id="setDarkAlphaColor"><code><span class="field-name">setDarkAlphaColor</span><span class="parenthesis">(</span><span class="arg-name">mesh</span><span class="operator">:</span> <a href="/api-docs/clay-native/ceramic/Mesh/" class="type-link">Mesh</a><span class="operator">,</span> <span class="arg-name">darkAlphaColor</span><span class="operator">:</span> <a href="/api-docs/clay-native/ceramic/AlphaColor/" class="type-link">AlphaColor</a><span class="parenthesis">)</span><span class="operator">:</span> <a href="/api-docs/clay-native/Void/" class="type-link">Void</a></code><a class="header-anchor" href="#setDarkAlphaColor"><span aria-hidden="true" class="header-anchor__symbol">#</span></a></div>
...
| Name | Type | Description |
|------|------|-------------|
| `mesh` | [Mesh](/api-docs/clay-native/ceramic/Mesh/) | The mesh to configure with arc geometry  |
| `radius` | [Float](/api-docs/clay-native/Float/) | Outer radius of the arc in pixels  |
| `angle` | [Float](/api-docs/clay-native/Float/) | Arc angle in degrees (0-360). 360 creates a full circle.  |
| `thickness` | [Float](/api-docs/clay-native/Float/) | Width of the arc stroke. Set equal to radius with INSIDE position for filled shapes.  |
| `sides` | [Int](/api-docs/clay-native/Int/) | Number of segments. More sides = smoother curves but more vertices. Recommended: 32 for small arcs, 64+ for large arcs.  |
...
| Name | Type | Default | Description |
|------|------|---------|-------------|
| `mesh` | [Mesh](/api-docs/clay-native/ceramic/Mesh/) | | The mesh to populate with grid vertices  |
| `columns` | [Int](/api-docs/clay-native/Int/) | | Number of columns (vertices per row)  |
| `rows` | [Int](/api-docs/clay-native/Int/) | | Number of rows  |
| `width` | [Float](/api-docs/clay-native/Float/) | | Total width of the grid in pixels  |
| `height` | [Float](/api-docs/clay-native/Float/) | | Total height of the grid in pixels  |
| `staggerX` | [Float](/api-docs/clay-native/Float/) | `0` | Horizontal offset applied to odd rows (for hexagonal grids)  |
| `staggerY` | [Float](/api-docs/clay-native/Float/) | `0` | Vertical offset applied to odd columns (for diamond grids)  |
| `attrLength` | [Int](/api-docs/clay-native/Int/) | `0` | Number of custom float attributes per vertex (beyond x,y)  |
| `attrValues` | [Array](/api-docs/clay-native/Array/)<[Float](/api-docs/clay-native/Float/)> | *(optional)* | Optional array of custom attribute values. Length must equal (columns+1) * (rows+1) * attrLength * ```haxe // Create a 10x10 grid for terrain deformation mesh.createVerticesGrid(10, 10, 400, 400); mesh.createIndicesGrid(10, 10); * // Create hexagonal grid mesh.createVerticesGrid(10, 10, 400, 400, cellWidth * 0.5, 0); ``` * |

<hr class="field-separator" />

<div class="signature field-method has-description" id="createIndicesGrid"><code><span class="field-name">createIndicesGrid</span><span class="parenthesis">(</span><span class="arg-name">mesh</span><span class="operator">:</span> <a href="/api-docs/clay-native/ceramic/Mesh/" class="type-link">Mesh</a><span class="operator">,</span> <span class="arg-name">columns</span><span class="operator">:</span> <a href="/api-docs/clay-native/Int/" class="type-link">Int</a><span class="operator">,</span> <span class="arg-name">rows</span><span class="operator">:</span> <a href="/api-docs/clay-native/Int/" class="type-link">Int</a><span class="operator">,</span> <span class="operator">?</span><span class="arg-name">mirrorX</span><span class="operator">:</span> <a href="/api-docs/clay-native/Bool/" class="type-link">Bool</a> <span class="operator">=</span> <span class="default-value">false</span><span class="operator">,</span> <span class="operator">?</span><span class="arg-name">mirrorY</span><span class="operator">:</span> <a href="/api-docs/clay-native/Bool/" class="type-link">Bool</a> <span class="operator">=</span> <span class="default-value">false</span><span class="operator">,</span> <span class="operator">?</span><span class="arg-name">mirrorFlip</span><span class="operator">:</span> <a href="/api-docs/clay-native/Bool/" class="type-link">Bool</a> <span class="operator">=</span> <span class="default-value">false</span><span class="parenthesis">)</span><span class="operator">:</span> <a href="/api-docs/clay-native/Void/" class="type-link">Void</a></code><a class="header-anchor" href="#createIndicesGrid"><span aria-hidden="true" class="header-anchor__symbol">#</span></a></div>
...
| Name | Type | Default | Description |
|------|------|---------|-------------|
| `mesh` | [Mesh](/api-docs/clay-native/ceramic/Mesh/) | | The mesh to populate with indices  |
| `columns` | [Int](/api-docs/clay-native/Int/) | | Number of columns in the vertex grid  |
| `rows` | [Int](/api-docs/clay-native/Int/) | | Number of rows in the vertex grid  |
| `mirrorX` | [Bool](/api-docs/clay-native/Bool/) | `false` | Mirror triangle orientation in odd columns  |
| `mirrorY` | [Bool](/api-docs/clay-native/Bool/) | `false` | Mirror triangle orientation in odd rows  |
| `mirrorFlip` | [Bool](/api-docs/clay-native/Bool/) | `false` | Inverts the mirroring pattern (even instead of odd) * ```haxe // Standard grid mesh.createIndicesGrid(10, 10); * // Alternating pattern for better deformation mesh.createIndicesGrid(10, 10, true, true); ``` * |

<hr class="field-separator" />

<div class="signature field-method has-description" id="createUVsGrid"><code><span class="field-name">createUVsGrid</span><span class="parenthesis">(</span><span class="arg-name">mesh</span><span class="operator">:</span> <a href="/api-docs/clay-native/ceramic/Mesh/" class="type-link">Mesh</a><span class="operator">,</span> <span class="arg-name">columns</span><span class="operator">:</span> <a href="/api-docs/clay-native/Int/" class="type-link">Int</a><span class="operator">,</span> <span class="arg-name">rows</span><span class="operator">:</span> <a href="/api-docs/clay-native/Int/" class="type-link">Int</a><span class="operator">,</span> <span class="operator">?</span><span class="arg-name">offsetX</span><span class="operator">:</span> <a href="/api-docs/clay-native/Float/" class="type-link">Float</a> <span class="operator">=</span> <span class="default-value">0</span><span class="operator">,</span> <span class="operator">?</span><span class="arg-name">offsetY</span><span class="operator">:</span> <a href="/api-docs/clay-native/Float/" class="type-link">Float</a> <span class="operator">=</span> <span class="default-value">0</span><span class="parenthesis">)</span><span class="operator">:</span> <a href="/api-docs/clay-native/Void/" class="type-link">Void</a></code><a class="header-anchor" href="#createUVsGrid"><span aria-hidden="true" class="header-anchor__symbol">#</span></a></div>
...
| Name | Type | Default | Description |
|------|------|---------|-------------|
| `mesh` | [Mesh](/api-docs/clay-native/ceramic/Mesh/) | | The mesh to populate with UV coordinates  |
| `columns` | [Int](/api-docs/clay-native/Int/) | | Number of columns in the vertex grid  |
| `rows` | [Int](/api-docs/clay-native/Int/) | | Number of rows in the vertex grid  |
| `offsetX` | [Float](/api-docs/clay-native/Float/) | `0` | UV offset in the X direction (texture scrolling)  |
| `offsetY` | [Float](/api-docs/clay-native/Float/) | `0` | UV offset in the Y direction (texture scrolling) * ```haxe // Standard UV mapping mesh.createUVsGrid(10, 10); * // Scrolling texture effect mesh.createUVsGrid(10, 10, time * 0.1, 0); ``` * |
