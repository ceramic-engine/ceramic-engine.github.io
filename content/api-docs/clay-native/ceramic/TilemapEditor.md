...
title: TilemapEditor
target: Clay (Native)
permalink: api-docs/clay-native/ceramic/TilemapEditor/
---
...
<div class="type-hierarchy"><a href="/api-docs/clay-native/ceramic/Entity/">Entity</a> → <strong>ceramic.TilemapEditor</strong> (Class)</div>
...
<div class="signature field-var has-description has-plugin" id="fillValue"><div class="plugin-name">tilemap</div><code><span class="field-name">fillValue</span><span class="operator">:</span> <a href="/api-docs/clay-native/ceramic/TilemapTile/" class="type-link">TilemapTile</a></code><a class="header-anchor" href="#fillValue"><span aria-hidden="true" class="header-anchor__symbol">#</span></a></div>
...
<div class="signature field-var has-description has-plugin" id="eraseValue"><div class="plugin-name">tilemap</div><code><span class="field-name">eraseValue</span><span class="operator">:</span> <a href="/api-docs/clay-native/ceramic/TilemapTile/" class="type-link">TilemapTile</a></code><a class="header-anchor" href="#eraseValue"><span aria-hidden="true" class="header-anchor__symbol">#</span></a></div>
...
|------|------|---------|-------------|
| `layerName` | [String](/api-docs/clay-native/String/) | `"main"` | The name of the layer to edit (default: 'main')  |
| `fillValue` | [TilemapTile](/api-docs/clay-native/ceramic/TilemapTile/) | `1` | The tile value for filling (default: 1)  |
| `eraseValue` | [TilemapTile](/api-docs/clay-native/ceramic/TilemapTile/) | `0` | The tile value for erasing (default: 0) |

## Private Members

<div class="signature field-var has-description has-plugin" id="buttonDownId"><div class="plugin-name">tilemap</div><code><span class="field-name">buttonDownId</span><span class="operator">:</span> <a href="/api-docs/clay-native/Int/" class="type-link">Int</a></code><a class="header-anchor" href="#buttonDownId"><span aria-hidden="true" class="header-anchor__symbol">#</span></a></div>
...
|------|------|-------------|
| `tilemapData` | [TilemapData](/api-docs/clay-native/ceramic/TilemapData/) | The tilemap data containing layer information  |
| `layerData` | [TilemapLayerData](/api-docs/clay-native/ceramic/TilemapLayerData/) | The specific layer data to check against  |
| `x` | [Float](/api-docs/clay-native/Float/) | The X position in visual coordinates  |
| `y` | [Float](/api-docs/clay-native/Float/) | The Y position in visual coordinates  |

| Returns | Description |
|---------|-------------|
| [Int](/api-docs/clay-native/Int/) | The tile index at the position, or -1 if outside bounds |

<hr class="field-separator" />

<div class="signature field-method has-description has-plugin" id="emitFill"><div class="plugin-name">tilemap</div><code><span class="field-name">emitFill</span><span class="parenthesis">(</span><span class="arg-name">index</span><span class="operator">:</span> <a href="/api-docs/clay-native/Int/" class="type-link">Int</a><span class="parenthesis">)</span><span class="operator">:</span> <a href="/api-docs/clay-native/Void/" class="type-link">Void</a></code><a class="header-anchor" href="#emitFill"><span aria-hidden="true" class="header-anchor__symbol">#</span></a></div>
...
| Name | Type | Description |
|------|------|-------------|
| `index` | [Int](/api-docs/clay-native/Int/) | The tile index that was filled |

<hr class="field-separator" />

<div class="signature field-method has-description has-plugin" id="emitErase"><div class="plugin-name">tilemap</div><code><span class="field-name">emitErase</span><span class="parenthesis">(</span><span class="arg-name">index</span><span class="operator">:</span> <a href="/api-docs/clay-native/Int/" class="type-link">Int</a><span class="parenthesis">)</span><span class="operator">:</span> <a href="/api-docs/clay-native/Void/" class="type-link">Void</a></code><a class="header-anchor" href="#emitErase"><span aria-hidden="true" class="header-anchor__symbol">#</span></a></div>
...
| Name | Type | Description |
|------|------|-------------|
| `index` | [Int](/api-docs/clay-native/Int/) | The tile index that was erased |
...
| Name | Type | Description |
|------|------|-------------|
| `info` | [TouchInfo](/api-docs/clay-native/ceramic/TouchInfo/) | Touch/mouse event information |
