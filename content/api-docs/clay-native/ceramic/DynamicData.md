...
title: DynamicData
target: Clay (Native)
permalink: api-docs/clay-native/ceramic/DynamicData/
---
...
<div class="type-hierarchy"><a href="/api-docs/clay-native/ceramic/Entity/">Entity</a> → <strong>ceramic.DynamicData</strong> (Class)</div>
...
<div class="signature field-var has-description" id="hasData"><code><span class="field-name">hasData</span><span class="operator">:</span> <a href="/api-docs/clay-native/Bool/" class="type-link">Bool</a></code><a class="header-anchor" href="#hasData"><span aria-hidden="true" class="header-anchor__symbol">#</span></a></div>
...
<div class="signature field-var has-description" id="data"><code><span class="field-name">data</span><span class="operator">:</span> <a href="/api-docs/clay-native/Dynamic/" class="type-link">Dynamic</a></code><a class="header-anchor" href="#data"><span aria-hidden="true" class="header-anchor__symbol">#</span></a></div>
...
|------|------|---------|-------------|
| `data` | [Dynamic](/api-docs/clay-native/Dynamic/) | *(optional)* | Optional initial data to store. If not provided, data will be lazily initialized on first access. * ```haxe // With initial data var data1 = new DynamicData({level: 1, xp: 0}); * // Without initial data (lazy init) var data2 = new DynamicData(); ``` |
