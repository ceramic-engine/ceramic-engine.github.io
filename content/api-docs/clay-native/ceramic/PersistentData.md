...
target: Clay (Native)
permalink: api-docs/clay-native/ceramic/PersistentData/
---
...
|------|------|-------------|
| `key` | [String](/api-docs/clay-native/String/) | The key to look up  |

| Returns | Description |
|---------|-------------|
| [Dynamic](/api-docs/clay-native/Dynamic/) | The stored value, or null if the key doesn't exist |
...
| Name | Type | Description |
|------|------|-------------|
| `key` | [String](/api-docs/clay-native/String/) | The key to store the value under  |
| `value` | [Dynamic](/api-docs/clay-native/Dynamic/) | The value to store (must be serializable) |
...
| Name | Type | Description |
|------|------|-------------|
| `key` | [String](/api-docs/clay-native/String/) | The key to remove |
...
| Name | Type | Description |
|------|------|-------------|
| `key` | [String](/api-docs/clay-native/String/) | The key to check  |

| Returns | Description |
|---------|-------------|
| [Bool](/api-docs/clay-native/Bool/) | True if the key exists, false otherwise |
...
| Returns | Description |
|---------|-------------|
| [Array](/api-docs/clay-native/Array/)<[String](/api-docs/clay-native/String/)> | Array of all keys currently in storage |

<hr class="field-separator" />

<div class="signature field-method has-description" id="save"><code><span class="field-name">save</span><span class="parenthesis">(</span><span class="parenthesis">)</span><span class="operator">:</span> <a href="/api-docs/clay-native/Void/" class="type-link">Void</a></code><a class="header-anchor" href="#save"><span aria-hidden="true" class="header-anchor__symbol">#</span></a></div>
...
| Name | Type | Description |
|------|------|-------------|
| `id` | [String](/api-docs/clay-native/String/) | Unique identifier for this storage. Used as part of the filename (stored as "persistent_[id]"). Should contain only filename-safe characters. |
