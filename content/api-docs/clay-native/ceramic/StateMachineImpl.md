...
target: Clay (Native)
permalink: api-docs/clay-native/ceramic/StateMachineImpl/
---
...
<div class="type-hierarchy"><a href="/api-docs/clay-native/ceramic/Entity/">Entity</a> → <a href="/api-docs/clay-native/ceramic/StateMachineBase/">StateMachineBase</a> → <strong>ceramic.StateMachineImpl</strong> (Class) → <a href="/api-docs/clay-native/ceramic/StateMachine/">StateMachine</a>, <a href="/api-docs/clay-native/ceramic/StateMachineComponent/">StateMachineComponent</a></div>
...
<div class="see"><strong>See:</strong> <a href="/api-docs/clay-native/ceramic/StateMachine/">StateMachine</a>, <a href="/api-docs/clay-native/ceramic/StateMachineBase/">StateMachineBase</a>, <a href="/api-docs/clay-native/ceramic/State/">State</a></div>
...
| `stateInstance` | [State](/api-docs/clay-native/ceramic/State/) | The State instance to use for this state |

<hr class="field-separator" />

<div class="signature field-method has-description" id="get"><code><span class="field-name">get</span><span class="parenthesis">(</span><span class="arg-name">key</span><span class="operator">:</span> <span class="type-name">ceramic.StateMachineImpl.T</span><span class="parenthesis">)</span><span class="operator">:</span> <a href="/api-docs/clay-native/ceramic/State/" class="type-link">State</a></code><a class="header-anchor" href="#get"><span aria-hidden="true" class="header-anchor__symbol">#</span></a></div>
...
| Returns | Description |
|---------|-------------|
| [State](/api-docs/clay-native/ceramic/State/) | The State instance, or null if not found |
