...
target: Clay (Native)
permalink: api-docs/clay-native/ceramic/ConvertSpriteSheet/
---
...
| `assets` | [Assets](/api-docs/clay-native/ceramic/Assets/) | The assets instance to load from  |
| `basic` | [String](/api-docs/clay-native/String/) | The sprite sheet asset name  |
...
| `instance` | [Entity](/api-docs/clay-native/ceramic/Entity/) | The entity that owns this field  |
| `field` | [String](/api-docs/clay-native/String/) | The name of the field being converted  |
| `value` | [SpriteSheet](/api-docs/clay-native/ceramic/SpriteSheet/) | The SpriteSheet instance  |

| Returns | Description |
|---------|-------------|
| [String](/api-docs/clay-native/String/) | The asset name, or null if the sheet has no associated asset |
