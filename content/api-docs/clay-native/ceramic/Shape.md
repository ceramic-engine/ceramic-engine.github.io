...
title: Shape
target: Clay (Native)
permalink: api-docs/clay-native/ceramic/Shape/
---
...
<div class="type-hierarchy"><a href="/api-docs/clay-native/ceramic/Entity/">Entity</a> → <a href="/api-docs/clay-native/ceramic/Visual/">Visual</a> → <a href="/api-docs/clay-native/ceramic/Mesh/">Mesh</a> → <strong>ceramic.Shape</strong> (Class) → <a href="/api-docs/clay-native/ceramic/RoundedRect/">RoundedRect</a></div>
...
<div class="see"><strong>See:</strong> <a href="/api-docs/clay-native/ceramic/Mesh/">Mesh</a>, <a href="/api-docs/clay-native/ceramic/Triangulate/">Triangulate</a></div>
...
| `space` | [nape.space.Space](/api-docs/clay-native/nape/space/Space/) | *(optional)* | Nape physics space (uses default if not provided)  |
| `shape` | [nape.shape.Shape](/api-docs/clay-native/nape/shape/Shape/) | *(optional)* | Custom collision shape (auto-generated from points if null)  |
| `shapes` | [Array](/api-docs/clay-native/Array/)<[nape.shape.Shape](/api-docs/clay-native/nape/shape/Shape/)> | *(optional)* | Array of collision shapes for complex bodies  |
...
| Returns | Description |
|---------|-------------|
| [VisualNapePhysics](/api-docs/clay-native/ceramic/VisualNapePhysics/) | VisualNapePhysics component for further configuration |
