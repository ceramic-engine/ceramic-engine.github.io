...
title: TilesetImage
target: Clay (Native)
permalink: api-docs/clay-native/ceramic/TilesetImage/
---
...
<div class="type-hierarchy"><a href="/api-docs/clay-native/ceramic/Entity/">Entity</a> → <a href="/api-docs/clay-native/tracker/Model/">tracker.Model</a> → <strong>ceramic.TilesetImage</strong> (Class)</div>
...
<div class="see"><strong>See:</strong> <a href="/api-docs/clay-native/ceramic/Tileset/">Tileset</a>, <a href="/api-docs/clay-native/ceramic/Texture/">Texture</a></div>
...
|------|------|-------------|
| `newTexture` | [Texture](/api-docs/clay-native/ceramic/Texture/) | The new texture instance  |
