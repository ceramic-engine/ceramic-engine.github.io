...
target: Clay (Native)
permalink: api-docs/clay-native/ceramic/BitmapFontDistanceFieldData/
---
...
<div class="signature field-var has-description" id="fieldType"><code><span class="field-name">fieldType</span><span class="operator">:</span> <a href="/api-docs/clay-native/String/" class="type-link">String</a></code><a class="header-anchor" href="#fieldType"><span aria-hidden="true" class="header-anchor__symbol">#</span></a></div>
...
<div class="signature field-var has-description" id="distanceRange"><code><span class="field-name">distanceRange</span><span class="operator">:</span> <a href="/api-docs/clay-native/Int/" class="type-link">Int</a></code><a class="header-anchor" href="#distanceRange"><span aria-hidden="true" class="header-anchor__symbol">#</span></a></div>
