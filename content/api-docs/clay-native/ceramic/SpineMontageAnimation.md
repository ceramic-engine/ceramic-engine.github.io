...
target: Clay (Native)
permalink: api-docs/clay-native/ceramic/SpineMontageAnimation/
---
...
|------|------|---------|-------------|
| `anim` | [String](/api-docs/clay-native/String/) | | * The name of the Spine animation to play. This must match an animation name defined in the Spine skeleton data. This is the only required field when creating an animation configuration. |
