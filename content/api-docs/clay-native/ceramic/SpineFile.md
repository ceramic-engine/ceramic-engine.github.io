...
title: SpineFile
target: Clay (Native)
permalink: api-docs/clay-native/ceramic/SpineFile/
---
...
<div class="type-implements"><strong>Implements:</strong> <a href="/api-docs/clay-native/spine/support/files/FileHandle/">spine.support.files.FileHandle</a></div>
...
| Returns | Description |
|---------|-------------|
| [String](/api-docs/clay-native/String/) | The complete file content as a string |
...
|------|------|-------------|
| `path` | [String](/api-docs/clay-native/String/) | The file path or identifier  |
| `content` | [String](/api-docs/clay-native/String/) | The text content of the file |
