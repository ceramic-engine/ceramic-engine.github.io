...
target: Clay (Native)
permalink: api-docs/clay-native/ceramic/TilemapLdtkParser/
---
...
<div class="see"><strong>See:</strong> <a href="/api-docs/clay-native/ceramic/LdtkData/">LdtkData</a>, <a href="/api-docs/clay-native/ceramic/Tilemap/">Tilemap</a></div>
...
|------|------|-------------|
| `rawLdtkData` | [String](/api-docs/clay-native/String/) | The raw JSON string from an LDtk project file  |
| `loadExternalLdtkLevelData` | Function | Callback to load external level files (for multi-file projects)  |

| Returns | Description |
|---------|-------------|
| [LdtkData](/api-docs/clay-native/ceramic/LdtkData/) | The parsed LdtkData object, or null if parsing fails |
...
| Name | Type | Description |
|------|------|-------------|
| `level` | [LdtkLevel](/api-docs/clay-native/ceramic/LdtkLevel/) | The LDtk level to convert |
...
| Name | Type | Description |
|------|------|-------------|
| `ldtkTiles` | [Array](/api-docs/clay-native/Array/)<[Int](/api-docs/clay-native/Int/)> | Raw tile data from LDtk (7 integers per tile)  |
| `tileset` | [LdtkTilesetDefinition](/api-docs/clay-native/ceramic/LdtkTilesetDefinition/) | The tileset definition for GID mapping  |
| `cols` | [Int](/api-docs/clay-native/Int/) | Number of columns in the layer  |
| `rows` | [Int](/api-docs/clay-native/Int/) | Number of rows in the layer  |
| `gridSize` | [Int](/api-docs/clay-native/Int/) | The grid cell size in pixels  |
| `tilesAlpha` | [Array](/api-docs/clay-native/Array/)<[Float](/api-docs/clay-native/Float/)> | Output array for tile alpha values  |
| `tilesOffsetX` | [Array](/api-docs/clay-native/Array/)<[Int](/api-docs/clay-native/Int/)> | Output array for tile X offsets  |
| `tilesOffsetY` | [Array](/api-docs/clay-native/Array/)<[Int](/api-docs/clay-native/Int/)> | Output array for tile Y offsets  |

| Returns | Description |
|---------|-------------|
| [Array](/api-docs/clay-native/Array/)<[TilemapTile](/api-docs/clay-native/ceramic/TilemapTile/)> | Array of TilemapTile objects, or null if no tiles |
