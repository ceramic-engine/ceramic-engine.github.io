...
title: WatchedFile
target: Clay (Native)
permalink: api-docs/clay-native/ceramic/_FileWatcher/WatchedFile/
---
...
<div class="signature field-var has-description" id="mtime"><code><span class="field-name">mtime</span><span class="operator">:</span> <a href="/api-docs/clay-native/Float/" class="type-link">Float</a></code><a class="header-anchor" href="#mtime"><span aria-hidden="true" class="header-anchor__symbol">#</span></a></div>
