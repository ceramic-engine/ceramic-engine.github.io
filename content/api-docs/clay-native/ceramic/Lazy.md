...
title: Lazy
target: Clay (Native)
permalink: api-docs/clay-native/ceramic/Lazy/
---

# Lazy

<div class="view-source"><a href="https://github.com/ceramic-engine/ceramic/blob/master/runtime/src/ceramic/Lazy.hx">View source</a></div>

<div class="type-hierarchy"><strong>ceramic.Lazy</strong> (Interface) → <a href="/api-docs/clay-native/ceramic/Entity/">Entity</a></div>
...
<div class="see"><strong>See:</strong> ceramic.macros.LazyMacro The macro that implements lazy initialization</div>
