...
title: SpineSystem
target: Clay (Native)
permalink: api-docs/clay-native/ceramic/SpineSystem/
---
...
<div class="type-hierarchy"><a href="/api-docs/clay-native/ceramic/Entity/">Entity</a> → <a href="/api-docs/clay-native/ceramic/System/">System</a> → <strong>ceramic.SpineSystem</strong> (Class)</div>
...
|------|------|-------------|
| `delta` | [Float](/api-docs/clay-native/Float/) | Time elapsed since the last frame in seconds |
