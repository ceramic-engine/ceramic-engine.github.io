...
target: Clay (Native)
permalink: api-docs/clay-native/ceramic/_TilemapLdtkParser/TilemapLdtkParser_Fields_/
---
...
|------|------|-------------|
| `array` | [Array](/api-docs/clay-native/Array/)<allEqual.T> | The array to check  |
| `value` | allEqual.T | The value to compare against  |

| Returns | Description |
|---------|-------------|
| [Bool](/api-docs/clay-native/Bool/) | True if all elements equal the value |
