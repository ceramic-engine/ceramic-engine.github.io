...
title: Group
target: Clay (Native)
permalink: api-docs/clay-native/ceramic/Group/
---
...
<div class="type-hierarchy"><a href="/api-docs/clay-native/ceramic/Entity/">Entity</a> → <strong>ceramic.Group</strong> (Class)</div>
...
| Returns | Description |
|---------|-------------|
| [Bool](/api-docs/clay-native/Bool/) | `true` if the item is in the group, `false` otherwise |
...
|------|------|---------|-------------|
| `id` | [String](/api-docs/clay-native/String/) | *(optional)* | Optional identifier for the group. Useful for debugging and finding specific groups. |
...
| Name | Type | Description |
|------|------|-------------|
| `item` | [Entity](/api-docs/clay-native/ceramic/Entity/) | The entity that was destroyed |
