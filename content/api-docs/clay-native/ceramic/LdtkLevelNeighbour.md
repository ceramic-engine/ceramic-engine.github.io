...
subCategory: doc
menu: Ldtk
title: LdtkLevelNeighbour
target: Clay (Native)
permalink: api-docs/clay-native/ceramic/LdtkLevelNeighbour/
---
...
<div class="type-hierarchy"><strong>ceramic.LdtkLevelNeighbour</strong> (Class)</div>

## Instance Members

<div class="signature field-var has-description has-plugin" id="dir"><div class="plugin-name">ldtk</div><code><span class="field-name">dir</span><span class="operator">:</span> <a href="/api-docs/clay-native/ceramic/LdtkLevelLocation/" class="type-link">LdtkLevelLocation</a></code><a class="header-anchor" href="#dir"><span aria-hidden="true" class="header-anchor__symbol">#</span></a></div>
