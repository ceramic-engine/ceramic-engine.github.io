...
title: GifCapture
target: Clay (Native)
permalink: api-docs/clay-native/ceramic/GifCapture/
---
...
<div class="type-hierarchy"><a href="/api-docs/clay-native/ceramic/Entity/">Entity</a> → <strong>ceramic.GifCapture</strong> (Class)</div>
...
|------|------|---------|-------------|
| `imagesPerFrame` | [Int](/api-docs/clay-native/Int/) | `1` | Number of screen captures to blend per GIF frame (higher = smoother)  |
| `middleFactor` | [Float](/api-docs/clay-native/Float/) | `1` | Blending weight for middle frames (0-1, affects smoothness)  |
| `gifFps` | [Int](/api-docs/clay-native/Int/) | `50` | Target frame rate for the output GIF  |
| `duration` | [Float](/api-docs/clay-native/Float/) | `-1` | Duration to capture in seconds (-1 to capture until manually stopped)  |
| `path` | [String](/api-docs/clay-native/String/) | *(optional)* | Optional file path to save the GIF (can also be specified in finish()) |

<hr class="field-separator" />

<div class="signature field-method has-description has-plugin" id="finish"><div class="plugin-name">gif</div><code><span class="field-name">finish</span><span class="parenthesis">(</span><span class="operator">?</span><span class="arg-name">path</span><span class="operator">:</span> <a href="/api-docs/clay-native/String/" class="type-link">String</a><span class="parenthesis">)</span><span class="operator">:</span> <a href="/api-docs/clay-native/haxe/io/Bytes/" class="type-link">haxe.io.Bytes</a></code><a class="header-anchor" href="#finish"><span aria-hidden="true" class="header-anchor__symbol">#</span></a></div>
...
| Name | Type | Default | Description |
|------|------|---------|-------------|
| `path` | [String](/api-docs/clay-native/String/) | *(optional)* | Optional file path to save the GIF (overrides path from captureScreen)  |

| Returns | Description |
|---------|-------------|
| [haxe.io.Bytes](/api-docs/clay-native/haxe/io/Bytes/) | The encoded GIF data as bytes |
