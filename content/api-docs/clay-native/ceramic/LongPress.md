...
title: LongPress
target: Clay (Native)
permalink: api-docs/clay-native/ceramic/LongPress/
---
...
<div class="type-hierarchy"><a href="/api-docs/clay-native/ceramic/Entity/">Entity</a> → <strong>ceramic.LongPress</strong> (Class)</div>
...
<div class="signature field-var has-description" id="requiredDuration"><code><span class="field-name">requiredDuration</span><span class="operator">:</span> <a href="/api-docs/clay-native/Float/" class="type-link">Float</a></code><a class="header-anchor" href="#requiredDuration"><span aria-hidden="true" class="header-anchor__symbol">#</span></a></div>
...
<div class="signature field-var has-description" id="click"><code><span class="field-name">click</span><span class="operator">:</span> <a href="/api-docs/clay-native/ceramic/Click/" class="type-link">Click</a></code><a class="header-anchor" href="#click"><span aria-hidden="true" class="header-anchor__symbol">#</span></a></div>
...
| `click` | [Click](/api-docs/clay-native/ceramic/Click/) | *(optional)* | Optional Click component to coordinate with |
...
<div class="signature field-var no-description" id="didLongPress"><code><span class="field-name">didLongPress</span><span class="operator">:</span> <a href="/api-docs/clay-native/Bool/" class="type-link">Bool</a></code><a class="header-anchor" href="#didLongPress"><span aria-hidden="true" class="header-anchor__symbol">#</span></a></div>
...
|------|------|-------------|
| `info` | [TouchInfo](/api-docs/clay-native/ceramic/TouchInfo/) | Touch information for the long press |
