...
target: Clay (Native)
permalink: api-docs/clay-native/ceramic/InputMapConvertToAxis/
---
...
|------|------|-------------|
| `index` | [Int](/api-docs/clay-native/Int/) | The index of the target axis action |
| `value` | [Int](/api-docs/clay-native/Int/) | The axis value to apply (stored as int * 1000 for precision) |
...
<div class="signature field-var has-description" id="value"><code><span class="field-name">value</span><span class="operator">:</span> <a href="/api-docs/clay-native/Int/" class="type-link">Int</a></code><a class="header-anchor" href="#value"><span aria-hidden="true" class="header-anchor__symbol">#</span></a></div>
