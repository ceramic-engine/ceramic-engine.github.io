...
target: Clay (Native)
permalink: api-docs/clay-native/ceramic/ShaderAttribute/
---
...
<div class="see"><strong>See:</strong> <a href="/api-docs/clay-native/ceramic/Shader/">Shader</a>, <a href="/api-docs/clay-native/ceramic/Mesh/">Mesh</a></div>
...
|------|------|-------------|
| `size` | [Int](/api-docs/clay-native/Int/) | Number of components (1-4)  |
| `name` | [String](/api-docs/clay-native/String/) | Attribute name in shader code |
