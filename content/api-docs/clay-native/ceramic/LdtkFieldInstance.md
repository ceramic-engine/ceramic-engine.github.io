...
target: Clay (Native)
permalink: api-docs/clay-native/ceramic/LdtkFieldInstance/
---
...
<div class="signature field-var has-description has-plugin" id="tile"><div class="plugin-name">ldtk</div><code><span class="field-name">tile</span><span class="operator">:</span> <a href="/api-docs/clay-native/ceramic/LdtkTilesetRectangle/" class="type-link">LdtkTilesetRectangle</a></code><a class="header-anchor" href="#tile"><span aria-hidden="true" class="header-anchor__symbol">#</span></a></div>
...
| `ldtkData` | [LdtkData](/api-docs/clay-native/ceramic/LdtkData/) | *(optional)* |
| `ldtkWorld` | [LdtkWorld](/api-docs/clay-native/ceramic/LdtkWorld/) | *(optional)* |
| `rawValue` | [Any](/api-docs/clay-native/Any/) | *(optional)* |
