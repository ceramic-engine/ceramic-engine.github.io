...
title: ConvertArray
target: Clay (Native)
permalink: api-docs/clay-native/ceramic/ConvertArray/
---
...
| `assets` | [Assets](/api-docs/clay-native/ceramic/Assets/) | Assets instance for resource loading (unused for arrays)  |
| `basic` | [Array](/api-docs/clay-native/Array/)<ceramic.ConvertArray.T> | The source array to convert  |
...
| `instance` | [Entity](/api-docs/clay-native/ceramic/Entity/) | The entity that owns this field  |
| `field` | [String](/api-docs/clay-native/String/) | The name of the field being converted  |
| `value` | [Array](/api-docs/clay-native/Array/)<ceramic.ConvertArray.T> | The field array to convert  |

| Returns | Description |
|---------|-------------|
| [Array](/api-docs/clay-native/Array/)<ceramic.ConvertArray.T> | A new array containing copies of all elements |
