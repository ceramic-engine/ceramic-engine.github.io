...
title: Script
target: Clay (Native)
permalink: api-docs/clay-native/ceramic/Script/
---
...
<div class="type-hierarchy"><a href="/api-docs/clay-native/ceramic/Entity/">Entity</a> → <strong>ceramic.Script</strong> (Class)</div>
...
<div class="signature field-var no-description has-plugin" id="entity"><div class="plugin-name">script</div><code><span class="field-name">entity</span><span class="operator">:</span> <a href="/api-docs/clay-native/ceramic/Entity/" class="type-link">Entity</a></code><a class="header-anchor" href="#entity"><span aria-hidden="true" class="header-anchor__symbol">#</span></a></div>
...
|------|------|-------------|
| `itemId` | [String](/api-docs/clay-native/String/) | Entity ID to look up  |

| Returns | Description |
|---------|-------------|
| [Entity](/api-docs/clay-native/ceramic/Entity/) | Found entity or null |
...
| Name | Type | Description |
|------|------|-------------|
| `itemId` | [String](/api-docs/clay-native/String/) | ID of the entity whose script module to retrieve  |

| Returns | Description |
|---------|-------------|
| [ScriptModule](/api-docs/clay-native/ceramic/ScriptModule/) | Script module or null if entity has no script |
...
| Name | Type | Description |
|------|------|-------------|
| `name` | [String](/api-docs/clay-native/String/) | Variable name  |

| Returns | Description |
|---------|-------------|
| [Dynamic](/api-docs/clay-native/Dynamic/) | Variable value or null if not found |
...
|------|------|---------|-------------|
| `name` | [String](/api-docs/clay-native/String/) | | Function name  |
| `numArgs` | [Int](/api-docs/clay-native/Int/) | | Number of arguments  |
| `arg1` | [Dynamic](/api-docs/clay-native/Dynamic/) | *(optional)* | First argument (or array of all arguments if numArgs > 3)  |
| `arg2` | [Dynamic](/api-docs/clay-native/Dynamic/) | *(optional)* | Second argument  |
| `arg3` | [Dynamic](/api-docs/clay-native/Dynamic/) | *(optional)* | Third argument  |

| Returns | Description |
|---------|-------------|
| [Dynamic](/api-docs/clay-native/Dynamic/) | Function return value or null if function not found |
...
| Name | Type | Description |
|------|------|-------------|
| `index` | [Int](/api-docs/clay-native/Int/) | Unique index for each loop in the script  |

| Returns | Description |
|---------|-------------|
| [Bool](/api-docs/clay-native/Bool/) | Always true unless max iterations exceeded  |

<hr class="field-separator" />

<div class="signature field-method has-description has-plugin" id="resetCheckLoop"><div class="plugin-name">script</div><code><span class="field-name">resetCheckLoop</span><span class="parenthesis">(</span><span class="arg-name">_</span><span class="operator">:</span> <a href="/api-docs/clay-native/Float/" class="type-link">Float</a><span class="parenthesis">)</span><span class="operator">:</span> <a href="/api-docs/clay-native/Void/" class="type-link">Void</a></code><a class="header-anchor" href="#resetCheckLoop"><span aria-hidden="true" class="header-anchor__symbol">#</span></a></div>
