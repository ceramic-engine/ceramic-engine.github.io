...
title: LdtkData
target: Clay (Native)
permalink: api-docs/clay-native/ceramic/LdtkData/
---
...
<div class="type-hierarchy"><a href="/api-docs/clay-native/ceramic/Entity/">Entity</a> → <strong>ceramic.LdtkData</strong> (Class)</div>
...
|------|------|-------------|
| `identifier` | [String](/api-docs/clay-native/String/) | The world identifier to search for  |

| Returns | Description |
|---------|-------------|
| [LdtkWorld](/api-docs/clay-native/ceramic/LdtkWorld/) | The matching LdtkWorld, or null if not found |
...
| Name | Type | Description |
|------|------|-------------|
| `iid` | [String](/api-docs/clay-native/String/) | The world IID to search for  |
...
| Returns |
|---------|
| [LdtkLayerDefinition](/api-docs/clay-native/ceramic/LdtkLayerDefinition/) |

<hr class="field-separator" />

<div class="signature field-method no-description has-plugin" id="findTilesetDef"><div class="plugin-name">ldtk</div><code><span class="field-name">findTilesetDef</span><span class="parenthesis">(</span><span class="arg-name">identifier</span><span class="operator">:</span> <a href="/api-docs/clay-native/String/" class="type-link">String</a><span class="parenthesis">)</span><span class="operator">:</span> <a href="/api-docs/clay-native/ceramic/LdtkTilesetDefinition/" class="type-link">LdtkTilesetDefinition</a></code><a class="header-anchor" href="#findTilesetDef"><span aria-hidden="true" class="header-anchor__symbol">#</span></a></div>
...
| Returns |
|---------|
| [LdtkEntityDefinition](/api-docs/clay-native/ceramic/LdtkEntityDefinition/) |

<hr class="field-separator" />

<div class="signature field-method has-description has-plugin" id="findLayerInstance"><div class="plugin-name">ldtk</div><code><span class="field-name">findLayerInstance</span><span class="parenthesis">(</span><span class="arg-name">iid</span><span class="operator">:</span> <a href="/api-docs/clay-native/String/" class="type-link">String</a><span class="parenthesis">)</span><span class="operator">:</span> <a href="/api-docs/clay-native/ceramic/LdtkLayerInstance/" class="type-link">LdtkLayerInstance</a></code><a class="header-anchor" href="#findLayerInstance"><span aria-hidden="true" class="header-anchor__symbol">#</span></a></div>
...
| Name | Type | Description |
|------|------|-------------|
| `iid` | [String](/api-docs/clay-native/String/) | The unique instance identifier of the layer  |

| Returns | Description |
|---------|-------------|
| [LdtkLayerInstance](/api-docs/clay-native/ceramic/LdtkLayerInstance/) | The layer instance if found, null otherwise |
...
|------|------|---------|-------------|
| `json` | [haxe.DynamicAccess](/api-docs/clay-native/haxe/DynamicAccess/)<[Dynamic](/api-docs/clay-native/Dynamic/)> | *(optional)* | The parsed LDtk project JSON data  |
...
| Name | Type |
|------|------|
| `level` | [LdtkLevel](/api-docs/clay-native/ceramic/LdtkLevel/) |
