...
title: TextAsset
target: Clay (Native)
permalink: api-docs/clay-native/ceramic/TextAsset/
---
...
<div class="type-hierarchy"><a href="/api-docs/clay-native/ceramic/Entity/">Entity</a> → <a href="/api-docs/clay-native/ceramic/Asset/">Asset</a> → <strong>ceramic.TextAsset</strong> (Class)</div>
...
|------|------|---------|-------------|
| `name` | [String](/api-docs/clay-native/String/) | | Text file name (with or without extension)  |
| `variant` | [String](/api-docs/clay-native/String/) | *(optional)* | Optional variant suffix  |
| `options` | [Null](/api-docs/clay-native/Null/)<[AssetOptions](/api-docs/clay-native/ceramic/AssetOptions/)> | *(optional)* | Loading options (backend-specific) |
