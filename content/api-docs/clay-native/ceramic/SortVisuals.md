...
title: SortVisuals
target: Clay (Native)
permalink: api-docs/clay-native/ceramic/SortVisuals/
---
...
|------|------|-------------|
| `a` | [Array](/api-docs/clay-native/Array/)<[Visual](/api-docs/clay-native/ceramic/Visual/)> | The array of visuals to sort. Modified in place. If null, behavior is undefined. |
...
| Returns | Description |
|---------|-------------|
| [Int](/api-docs/clay-native/Int/) | -1 if a should render before b, 1 if b should render before a, 0 if equal |
