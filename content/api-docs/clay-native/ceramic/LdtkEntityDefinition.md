...
target: Clay (Native)
permalink: api-docs/clay-native/ceramic/LdtkEntityDefinition/
---
...
|------|------|-------------|
| `renderMode` | [LdtkRenderMode](/api-docs/clay-native/ceramic/LdtkRenderMode/) | The render mode we want to test  |
...
| Returns |
|---------|
| [LdtkFieldDefinition](/api-docs/clay-native/ceramic/LdtkFieldDefinition/) |
