...
title: ArrayPool
target: Clay (Native)
permalink: api-docs/clay-native/ceramic/ArrayPool/
---
...
<div class="see"><strong>See:</strong> <a href="/api-docs/clay-native/ceramic/ReusableArray/">ReusableArray</a></div>
...
| Returns | Description |
|---------|-------------|
| [ReusableArray](/api-docs/clay-native/ceramic/ReusableArray/)<[Any](/api-docs/clay-native/Any/)> | A ReusableArray instance of the pool's configured size |
...
| Name | Type | Description |
|------|------|-------------|
| `array` | [ReusableArray](/api-docs/clay-native/ceramic/ReusableArray/)<[Any](/api-docs/clay-native/Any/)> | The array to return to the pool |
...
| Name | Type | Description |
|------|------|-------------|
| `arrayLengths` | [Int](/api-docs/clay-native/Int/) | The size of arrays this pool will manage |

## Private Members

<div class="signature field-var no-description" id="ALLOC_STEP"><code><span class="field-name">ALLOC_STEP</span><span class="operator">:</span> <a href="/api-docs/clay-native/Int/" class="type-link">Int</a></code><a class="header-anchor" href="#ALLOC_STEP"><span aria-hidden="true" class="header-anchor__symbol">#</span></a></div>
...
<div class="signature field-var has-description" id="didNotifyLargePool"><code><span class="field-name">didNotifyLargePool</span><span class="operator">:</span> <a href="/api-docs/clay-native/Bool/" class="type-link">Bool</a></code><a class="header-anchor" href="#didNotifyLargePool"><span aria-hidden="true" class="header-anchor__symbol">#</span></a></div>
...
<div class="signature field-var has-description" id="nextFree"><code><span class="field-name">nextFree</span><span class="operator">:</span> <a href="/api-docs/clay-native/Int/" class="type-link">Int</a></code><a class="header-anchor" href="#nextFree"><span aria-hidden="true" class="header-anchor__symbol">#</span></a></div>

Index of the next available slot in the pool

<hr class="field-separator" />

<div class="signature field-var has-description" id="arrayLengths"><code><span class="field-name">arrayLengths</span><span class="operator">:</span> <a href="/api-docs/clay-native/Int/" class="type-link">Int</a></code><a class="header-anchor" href="#arrayLengths"><span aria-hidden="true" class="header-anchor__symbol">#</span></a></div>
