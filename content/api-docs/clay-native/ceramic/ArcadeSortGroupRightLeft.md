...
target: Clay (Native)
permalink: api-docs/clay-native/ceramic/ArcadeSortGroupRightLeft/
---
...
| Returns | Description |
|---------|-------------|
| [Int](/api-docs/clay-native/Int/) | 1 if b.body.x >= a.body.x, -1 otherwise, 0 if either has no body |
