...
title: ValueEntry
target: Clay (Native)
permalink: api-docs/clay-native/ceramic/ValueEntry/
---
...
<div class="type-hierarchy"><a href="/api-docs/clay-native/ceramic/CollectionEntry/">CollectionEntry</a> → <strong>ceramic.ValueEntry</strong> (Class)</div>
...
<div class="see"><strong>See:</strong> <a href="/api-docs/clay-native/ceramic/CollectionEntry/">CollectionEntry</a>, <a href="/api-docs/clay-native/ceramic/Collection/">Collection</a></div>
...
| `id` | [String](/api-docs/clay-native/String/) | *(optional)* | Optional unique identifier for this entry in a collection  |
| `name` | [String](/api-docs/clay-native/String/) | *(optional)* | Optional human-readable name for this entry |
