...
title: Errors
target: Clay (Native)
permalink: api-docs/clay-native/ceramic/Errors/
---
...
|------|------|-------------|
| `e` | [Dynamic](/api-docs/clay-native/Dynamic/) | The uncaught error/exception object |
