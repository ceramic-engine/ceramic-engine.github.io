...
title: TextureFilter
target: Clay (Native)
permalink: api-docs/clay-native/ceramic/TextureFilter/
---

# TextureFilter

<div class="view-source"><a href="https://github.com/ceramic-engine/ceramic/blob/master/runtime/src/ceramic/TextureFilter.hx">View source</a></div>

<div class="type-hierarchy"><strong>ceramic.TextureFilter</strong> (Enum)</div>
...
<div class="see"><strong>See:</strong> Texture.filter, RenderTexture.textureFilter</div>
