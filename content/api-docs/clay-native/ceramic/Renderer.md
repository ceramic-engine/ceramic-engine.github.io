...
title: Renderer
target: Clay (Native)
permalink: api-docs/clay-native/ceramic/Renderer/
---
...
<div class="type-hierarchy"><a href="/api-docs/clay-native/ceramic/Entity/">Entity</a> → <strong>ceramic.Renderer</strong> (Class)</div>
...
|------|------|-------------|
| `isMainRender` | [Bool](/api-docs/clay-native/Bool/) | Whether this is the main render pass (vs render-to-texture)  |
| `ceramicVisuals` | [Array](/api-docs/clay-native/Array/)<[Visual](/api-docs/clay-native/ceramic/Visual/)> | Array of visuals to render, pre-sorted by depth |
...
| Name | Type | Description |
|------|------|-------------|
| `draw` | [backend.Draw](/api-docs/clay-native/backend/Draw/) | Backend draw interface  |
| `quad` | [Quad](/api-docs/clay-native/ceramic/Quad/) | The quad visual to render |
...
|------|------|-------------|
| `draw` | [backend.Draw](/api-docs/clay-native/backend/Draw/) | Backend draw interface  |
| `mesh` | [Mesh](/api-docs/clay-native/ceramic/Mesh/) | The mesh visual to render |
...
| Name | Type |
|------|------|
| `draw` | [backend.Draw](/api-docs/clay-native/backend/Draw/) |
| `mesh` | [Mesh](/api-docs/clay-native/ceramic/Mesh/) |
...
| Name | Type | Description |
|------|------|-------------|
| `z` | [Float](/api-docs/clay-native/Float/) | The current Z depth value  |

| Returns | Description |
|---------|-------------|
| [Float](/api-docs/clay-native/Float/) | The incremented Z value with non-linear spacing |
...
| Name | Type | Description |
|------|------|-------------|
| `quad` | [Quad](/api-docs/clay-native/ceramic/Quad/) | The quad to compute blending for  |

| Returns | Description |
|---------|-------------|
| [Blending](/api-docs/clay-native/ceramic/Blending/) | The resolved blending mode |
...
| Name | Type | Description |
|------|------|-------------|
| `mesh` | [Mesh](/api-docs/clay-native/ceramic/Mesh/) | The mesh to compute blending for  |
...
| Name | Type |
|------|------|
| `shaderA` | [Shader](/api-docs/clay-native/ceramic/Shader/) |
| `shaderB` | [Shader](/api-docs/clay-native/ceramic/Shader/) |
...
|------|------|-------------|
| `draw` | [backend.Draw](/api-docs/clay-native/backend/Draw/) | Backend draw interface  |
| `shader` | [backend.Shader](/api-docs/clay-native/backend/Shader/) | Backend shader to activate (null for default) |
...
|------|------|-------------|
| `draw` | [backend.Draw](/api-docs/clay-native/backend/Draw/) | Backend draw interface  |
| `blending` | [Blending](/api-docs/clay-native/ceramic/Blending/) | The blending mode to apply |
...
|------|------|
| `draw` | [backend.Draw](/api-docs/clay-native/backend/Draw/) |
| `quad` | [Quad](/api-docs/clay-native/ceramic/Quad/) |
...
|------|------|-------------|
| `draw` | [backend.Draw](/api-docs/clay-native/backend/Draw/) | Backend draw interface  |
| `renderTarget` | [RenderTexture](/api-docs/clay-native/ceramic/RenderTexture/) | Texture to render to (null for screen) |
...
| `draw` | [backend.Draw](/api-docs/clay-native/backend/Draw/) |
| `texture` | [Texture](/api-docs/clay-native/ceramic/Texture/) |
| `reusing` | [Bool](/api-docs/clay-native/Bool/) |
...
|------|------|-------------|
| `draw` | [backend.Draw](/api-docs/clay-native/backend/Draw/) | Backend draw interface  |
| `texture` | [Texture](/api-docs/clay-native/ceramic/Texture/) | Texture to check  |

| Returns | Description |
|---------|-------------|
| [Bool](/api-docs/clay-native/Bool/) | True if batching can continue |
