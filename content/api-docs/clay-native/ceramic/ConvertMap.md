...
title: ConvertMap
target: Clay (Native)
permalink: api-docs/clay-native/ceramic/ConvertMap/
---
...
<div class="see"><strong>See:</strong> <a href="/api-docs/clay-native/ceramic/ConvertField/">ConvertField</a>, <a href="/api-docs/clay-native/ceramic/Fragment/">Fragment</a></div>
...
| `assets` | [Assets](/api-docs/clay-native/ceramic/Assets/) | Assets instance for resource loading (unused for maps)  |
| `basic` | [haxe.DynamicAccess](/api-docs/clay-native/haxe/DynamicAccess/)<ceramic.ConvertMap.T> | The DynamicAccess object to convert  |
...
| `instance` | [Entity](/api-docs/clay-native/ceramic/Entity/) | The entity that owns this field  |
| `field` | [String](/api-docs/clay-native/String/) | The name of the field being converted  |
| `value` | [Map](/api-docs/clay-native/Map/) | The Map instance to convert  |

| Returns | Description |
|---------|-------------|
| [haxe.DynamicAccess](/api-docs/clay-native/haxe/DynamicAccess/)<ceramic.ConvertMap.T> | A DynamicAccess object containing all map entries |
