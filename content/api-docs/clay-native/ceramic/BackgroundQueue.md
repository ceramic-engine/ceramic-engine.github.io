...
target: Clay (Native)
permalink: api-docs/clay-native/ceramic/BackgroundQueue/
---
...
<div class="type-hierarchy"><a href="/api-docs/clay-native/ceramic/Entity/">Entity</a> → <strong>ceramic.BackgroundQueue</strong> (Class)</div>
...
<div class="see"><strong>See:</strong> <a href="/api-docs/clay-native/ceramic/Runner/">Runner</a></div>
...
|------|------|---------|-------------|
| `checkInterval` | [Float](/api-docs/clay-native/Float/) | `0.1` | Time in seconds between queue checks (default: 0.1) |
...
<div class="signature field-var has-description" id="stop"><code><span class="field-name">stop</span><span class="operator">:</span> <a href="/api-docs/clay-native/Bool/" class="type-link">Bool</a></code><a class="header-anchor" href="#stop"><span aria-hidden="true" class="header-anchor__symbol">#</span></a></div>
...
<div class="signature field-var has-description" id="mutex"><code><span class="field-name">mutex</span><span class="operator">:</span> <a href="/api-docs/clay-native/sys/thread/Mutex/" class="type-link">sys.thread.Mutex</a></code><a class="header-anchor" href="#mutex"><span aria-hidden="true" class="header-anchor__symbol">#</span></a></div>
