...
target: Clay (Native)
permalink: api-docs/clay-native/ceramic/ArcadeSortGroupLeftRight/
---
...
| Returns | Description |
|---------|-------------|
| [Int](/api-docs/clay-native/Int/) | 1 if a.body.x >= b.body.x, -1 otherwise, 0 if either has no body |
