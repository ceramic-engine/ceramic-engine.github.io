...
title: AudioMixer
target: Clay (Native)
permalink: api-docs/clay-native/ceramic/AudioMixer/
---
...
<div class="type-hierarchy"><a href="/api-docs/clay-native/ceramic/Entity/">Entity</a> → <strong>ceramic.AudioMixer</strong> (Class)</div>
...
<div class="see"><strong>See:</strong> <a href="/api-docs/clay-native/ceramic/Audio/">Audio</a>, <a href="/api-docs/clay-native/ceramic/Sound/">Sound</a></div>
...
<div class="signature field-var has-description" id="mute"><code><span class="field-name">mute</span><span class="operator">:</span> <a href="/api-docs/clay-native/Bool/" class="type-link">Bool</a></code><a class="header-anchor" href="#mute"><span aria-hidden="true" class="header-anchor__symbol">#</span></a></div>
...
|------|------|-------------|
| `index` | [Int](/api-docs/clay-native/Int/) | The group index for this mixer |
