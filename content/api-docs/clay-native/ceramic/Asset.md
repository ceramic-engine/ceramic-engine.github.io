...
title: Asset
target: Clay (Native)
permalink: api-docs/clay-native/ceramic/Asset/
---
...
<div class="type-hierarchy"><a href="/api-docs/clay-native/ceramic/Entity/">Entity</a> → <strong>ceramic.Asset</strong> (Class) → <a href="/api-docs/clay-native/ceramic/AtlasAsset/">AtlasAsset</a>, <a href="/api-docs/clay-native/ceramic/BinaryAsset/">BinaryAsset</a>, <a href="/api-docs/clay-native/ceramic/DatabaseAsset/">DatabaseAsset</a>, <a href="/api-docs/clay-native/ceramic/FontAsset/">FontAsset</a>, <a href="/api-docs/clay-native/ceramic/FragmentsAsset/">FragmentsAsset</a>, <a href="/api-docs/clay-native/ceramic/ImageAsset/">ImageAsset</a>, <a href="/api-docs/clay-native/ceramic/LorelineAsset/">LorelineAsset</a>, <a href="/api-docs/clay-native/ceramic/ShaderAsset/">ShaderAsset</a>, <a href="/api-docs/clay-native/ceramic/SoundAsset/">SoundAsset</a>, <a href="/api-docs/clay-native/ceramic/SpineAsset/">SpineAsset</a>, <a href="/api-docs/clay-native/ceramic/SpriteAsset/">SpriteAsset</a>, <a href="/api-docs/clay-native/ceramic/TextAsset/">TextAsset</a>, <a href="/api-docs/clay-native/ceramic/TilemapAsset/">TilemapAsset</a></div>
...
<div class="see"><strong>See:</strong> <a href="/api-docs/clay-native/ceramic/Assets/">Assets</a></div>
...
<div class="signature field-var has-description" id="kind"><code><span class="field-name">kind</span><span class="operator">:</span> <a href="/api-docs/clay-native/String/" class="type-link">String</a></code><a class="header-anchor" href="#kind"><span aria-hidden="true" class="header-anchor__symbol">#</span></a></div>
...
<div class="signature field-var has-description" id="variant"><code><span class="field-name">variant</span><span class="operator">:</span> <a href="/api-docs/clay-native/String/" class="type-link">String</a></code><a class="header-anchor" href="#variant"><span aria-hidden="true" class="header-anchor__symbol">#</span></a></div>
...
<div class="signature field-var has-description" id="fullName"><code><span class="field-name">fullName</span><span class="operator">:</span> <a href="/api-docs/clay-native/String/" class="type-link">String</a></code><a class="header-anchor" href="#fullName"><span aria-hidden="true" class="header-anchor__symbol">#</span></a></div>
...
<div class="signature field-var has-description" id="owner"><code><span class="field-name">owner</span><span class="operator">:</span> <a href="/api-docs/clay-native/ceramic/Assets/" class="type-link">Assets</a></code><a class="header-anchor" href="#owner"><span aria-hidden="true" class="header-anchor__symbol">#</span></a></div>
...
<div class="signature field-var has-description" id="options"><code><span class="field-name">options</span><span class="operator">:</span> <a href="/api-docs/clay-native/ceramic/AssetOptions/" class="type-link">AssetOptions</a></code><a class="header-anchor" href="#options"><span aria-hidden="true" class="header-anchor__symbol">#</span></a></div>
...
<div class="signature field-var has-description" id="refCount"><code><span class="field-name">refCount</span><span class="operator">:</span> <a href="/api-docs/clay-native/Int/" class="type-link">Int</a></code><a class="header-anchor" href="#refCount"><span aria-hidden="true" class="header-anchor__symbol">#</span></a></div>
...
|------|------|---------|-------------|
| `extensions` | [Array](/api-docs/clay-native/Array/)<[String](/api-docs/clay-native/String/)> | *(optional)* | File extensions to look for (auto-detected if not provided)  |
| `dir` | [Bool](/api-docs/clay-native/Bool/) | *(optional)* | Whether to look for directories instead of files  |
| `runtimeAssets` | [RuntimeAssets](/api-docs/clay-native/ceramic/RuntimeAssets/) | *(optional)* | Runtime assets configuration to use |

<hr class="field-separator" />

<div class="signature field-method has-description" id="retain"><code><span class="field-name">retain</span><span class="parenthesis">(</span><span class="parenthesis">)</span><span class="operator">:</span> <a href="/api-docs/clay-native/Void/" class="type-link">Void</a></code><a class="header-anchor" href="#retain"><span aria-hidden="true" class="header-anchor__symbol">#</span></a></div>
...
| Name | Type | Default | Description |
|------|------|---------|-------------|
| `kind` | [String](/api-docs/clay-native/String/) | | The asset type identifier  |
| `name` | [String](/api-docs/clay-native/String/) | | The asset name (without extension)  |
| `variant` | [String](/api-docs/clay-native/String/) | *(optional)* | Optional variant suffix  |
| `options` | [Null](/api-docs/clay-native/Null/)<[AssetOptions](/api-docs/clay-native/ceramic/AssetOptions/)> | *(optional)* | Loading options specific to the asset type |
...
<div class="signature field-var no-description" id="handleTexturesDensityChange"><code><span class="field-name">handleTexturesDensityChange</span><span class="operator">:</span> <a href="/api-docs/clay-native/Bool/" class="type-link">Bool</a></code><a class="header-anchor" href="#handleTexturesDensityChange"><span aria-hidden="true" class="header-anchor__symbol">#</span></a></div>

<hr class="field-separator" />

<div class="signature field-var no-description" id="hotReload"><code><span class="field-name">hotReload</span><span class="operator">:</span> <a href="/api-docs/clay-native/Bool/" class="type-link">Bool</a></code><a class="header-anchor" href="#hotReload"><span aria-hidden="true" class="header-anchor__symbol">#</span></a></div>
...
| Name | Type |
|------|------|
| `instance` | [Asset](/api-docs/clay-native/ceramic/Asset/) |
...
|------|------|-------------|
| `success` | [Bool](/api-docs/clay-native/Bool/) | True if the asset loaded successfully, false if it failed |
...
| Name | Type | Description |
|------|------|-------------|
| `newDensity` | [Float](/api-docs/clay-native/Float/) | The new texture density  |
| `prevDensity` | [Float](/api-docs/clay-native/Float/) | The previous texture density |
...
| Name | Type | Description |
|------|------|-------------|
| `newFiles` | [ReadOnlyMap](/api-docs/clay-native/ceramic/ReadOnlyMap/)<[String](/api-docs/clay-native/String/), [Float](/api-docs/clay-native/Float/)> | Map of file paths to modification times after change  |
| `previousFiles` | [ReadOnlyMap](/api-docs/clay-native/ceramic/ReadOnlyMap/)<[String](/api-docs/clay-native/String/), [Float](/api-docs/clay-native/Float/)> | Map of file paths to modification times before change |
...
| Returns | Description |
|---------|-------------|
| [String](/api-docs/clay-native/String/) | String in format "AssetType(name:variant path)" or "AssetType(name:variant)" |
...
| Name | Type |
|------|------|
| `success` | [Bool](/api-docs/clay-native/Bool/) |
