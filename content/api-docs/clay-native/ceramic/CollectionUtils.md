...
target: Clay (Native)
permalink: api-docs/clay-native/ceramic/CollectionUtils/
---
...
|------|------|-------------|
| `array` | [Array](/api-docs/clay-native/Array/)<toCollection.T> | The array to convert  |

| Returns | Description |
|---------|-------------|
| [Collection](/api-docs/clay-native/ceramic/Collection/)<[ValueEntry](/api-docs/clay-native/ceramic/ValueEntry/)<toCollection.T>> | A new Collection containing the array elements |
...
|------|------|---------|-------------|
| `collection` | [Collection](/api-docs/clay-native/ceramic/Collection/)<filtered.T> | | The source collection to filter  |
| `filter` | Function | | Function that filters the entries array  |
| `cacheKey` | [String](/api-docs/clay-native/String/) | *(optional)* | Optional key to cache and reuse the filtered collection  |

| Returns | Description |
|---------|-------------|
| [Collection](/api-docs/clay-native/ceramic/Collection/)<filtered.T> | A filtered collection that updates with the source |
...
| Name | Type | Default | Description |
|------|------|---------|-------------|
| `collections` | [Array](/api-docs/clay-native/Array/)<[Collection](/api-docs/clay-native/ceramic/Collection/)<combined.T>> | | Array of collections to combine  |
| `cache` | [Bool](/api-docs/clay-native/Bool/) | `true` | Whether to cache the combined collection (default: true)  |

| Returns | Description |
|---------|-------------|
| [Collection](/api-docs/clay-native/ceramic/Collection/)<combined.T> | A collection containing all entries from all source collections |
