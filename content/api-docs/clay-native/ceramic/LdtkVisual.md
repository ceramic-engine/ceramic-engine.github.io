...
title: LdtkVisual
target: Clay (Native)
permalink: api-docs/clay-native/ceramic/LdtkVisual/
---
...
<div class="type-hierarchy"><a href="/api-docs/clay-native/ceramic/Entity/">Entity</a> → <a href="/api-docs/clay-native/ceramic/Visual/">Visual</a> → <a href="/api-docs/clay-native/ceramic/Quad/">Quad</a> → <strong>ceramic.LdtkVisual</strong> (Class)</div>
...
<div class="see"><strong>See:</strong> <a href="/api-docs/clay-native/ceramic/LdtkEntityInstance/">LdtkEntityInstance</a></div>


## Instance Members

<div class="signature field-var has-description has-plugin" id="ldtkEntity"><div class="plugin-name">ldtk</div><code><span class="field-name">ldtkEntity</span><span class="operator">:</span> <a href="/api-docs/clay-native/ceramic/LdtkEntityInstance/" class="type-link">LdtkEntityInstance</a></code><a class="header-anchor" href="#ldtkEntity"><span aria-hidden="true" class="header-anchor__symbol">#</span></a></div>
...
|------|------|-------------|
| `ldtkEntity` | [LdtkEntityInstance](/api-docs/clay-native/ceramic/LdtkEntityInstance/) | The LDtk entity instance to visualize |
