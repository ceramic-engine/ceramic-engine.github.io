...
title: TouchInfo
target: Clay (Native)
permalink: api-docs/clay-native/ceramic/TouchInfo/
---
...
<div class="see"><strong>See:</strong> <a href="/api-docs/clay-native/ceramic/Visual/">Visual</a>, <a href="/api-docs/clay-native/ceramic/Screen/">Screen</a></div>
...
<div class="signature field-var has-description" id="buttonId"><code><span class="field-name">buttonId</span><span class="operator">:</span> <a href="/api-docs/clay-native/Int/" class="type-link">Int</a></code><a class="header-anchor" href="#buttonId"><span aria-hidden="true" class="header-anchor__symbol">#</span></a></div>
...
<div class="signature field-var has-description" id="hits"><code><span class="field-name">hits</span><span class="operator">:</span> <a href="/api-docs/clay-native/Bool/" class="type-link">Bool</a></code><a class="header-anchor" href="#hits"><span aria-hidden="true" class="header-anchor__symbol">#</span></a></div>
...
|------|------|-------------|
| `touchIndex` | [Int](/api-docs/clay-native/Int/) | * If the input is a touch input, this is the index of the touch. Otherwise it will be -1. |
| `buttonId` | [Int](/api-docs/clay-native/Int/) | * If the input is a mouse input, this is the id of the mouse button. Otherwise it will be -1. |
| `x` | [Float](/api-docs/clay-native/Float/) | * X coordinate of the input (relative to screen). |
| `y` | [Float](/api-docs/clay-native/Float/) | * Y coordinate of the input (relative to screen). |
| `hits` | [Bool](/api-docs/clay-native/Bool/) | * Whether these info do hit the related visual. This is usually `true`, Except when we have touch/mouse up events outside of a visual that initially received a down event. |
