...
title: SocketInput
target: Clay (Native)
permalink: api-docs/clay-native/sys/net/_Socket/SocketInput/
---

# SocketInput

<div class="type-hierarchy"><a href="/api-docs/clay-native/haxe/io/Input/">haxe.io.Input</a> → <strong>sys.net._Socket.SocketInput</strong> (private class)</div>
