...
title: SocketOutput
target: Clay (Native)
permalink: api-docs/clay-native/sys/net/_Socket/SocketOutput/
---

# SocketOutput

<div class="type-hierarchy"><a href="/api-docs/clay-native/haxe/io/Output/">haxe.io.Output</a> → <strong>sys.net._Socket.SocketOutput</strong> (private class)</div>
