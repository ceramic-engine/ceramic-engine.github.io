...
title: TypeApi
target: Clay (Native)
permalink: api-docs/clay-native/haxe/rtti/TypeApi/
---
...
<div class="signature field-method no-description" id="typeInfos"><code><span class="field-name">typeInfos</span><span class="parenthesis">(</span><span class="arg-name">t</span><span class="operator">:</span> <span class="type-name">Anonymous</span><span class="parenthesis">)</span><span class="operator">:</span> <a href="/api-docs/clay-native/haxe/rtti/TypeInfos/" class="type-link">TypeInfos</a></code><a class="header-anchor" href="#typeInfos"><span aria-hidden="true" class="header-anchor__symbol">#</span></a></div>
...
| Returns |
|---------|
| [TypeInfos](/api-docs/clay-native/haxe/rtti/TypeInfos/) |

<hr class="field-separator" />

<div class="signature field-method has-description" id="rightsEq"><code><span class="field-name">rightsEq</span><span class="parenthesis">(</span><span class="arg-name">r1</span><span class="operator">:</span> <span class="type-name">Anonymous</span><span class="operator">,</span> <span class="arg-name">r2</span><span class="operator">:</span> <span class="type-name">Anonymous</span><span class="parenthesis">)</span><span class="operator">:</span> <a href="/api-docs/clay-native/Bool/" class="type-link">Bool</a></code><a class="header-anchor" href="#rightsEq"><span aria-hidden="true" class="header-anchor__symbol">#</span></a></div>
...
| Name | Type |
|------|------|
| `c1` | [EnumField](/api-docs/clay-native/haxe/rtti/EnumField/) |
| `c2` | [EnumField](/api-docs/clay-native/haxe/rtti/EnumField/) |
...
|------|------|
| `f` | Function |
| `l1` | [Array](/api-docs/clay-native/Array/)<leq.T> |
| `l2` | [Array](/api-docs/clay-native/Array/)<leq.T> |
