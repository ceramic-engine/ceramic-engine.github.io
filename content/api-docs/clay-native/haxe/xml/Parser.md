...
title: Parser
target: Clay (Native)
permalink: api-docs/clay-native/haxe/xml/Parser/
---
...
| `strict` | [Bool](/api-docs/clay-native/Bool/) | `false` |
...
| `p` | [Int](/api-docs/clay-native/Int/) | `0` |
| `parent` | [Xml](/api-docs/clay-native/Xml/) | *(optional)* |
...
<div class="signature field-method no-description" id="isValidChar"><code><span class="field-name">isValidChar</span><span class="parenthesis">(</span><span class="arg-name">c</span><span class="operator">:</span> <a href="/api-docs/clay-native/Int/" class="type-link">Int</a><span class="parenthesis">)</span><span class="operator">:</span> <a href="/api-docs/clay-native/Bool/" class="type-link">Bool</a></code><a class="header-anchor" href="#isValidChar"><span aria-hidden="true" class="header-anchor__symbol">#</span></a></div>
