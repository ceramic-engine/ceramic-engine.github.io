...
title: BytesInput
target: Clay (Native)
permalink: api-docs/clay-native/haxe/io/BytesInput/
---

# BytesInput

<div class="type-hierarchy"><a href="/api-docs/clay-native/haxe/io/Input/">Input</a> → <strong>haxe.io.BytesInput</strong> (Class) → <a href="/api-docs/clay-native/haxe/io/StringInput/">StringInput</a></div>
...
| Name | Type |
|------|------|
| `buf` | [Bytes](/api-docs/clay-native/haxe/io/Bytes/) |
...
| Name | Type | Default |
|------|------|---------|
| `b` | [Bytes](/api-docs/clay-native/haxe/io/Bytes/) | |
| `pos` | [Int](/api-docs/clay-native/Int/) | *(optional)* |
...
<div class="signature field-var no-description" id="totlen"><code><span class="field-name">totlen</span><span class="operator">:</span> <a href="/api-docs/clay-native/Int/" class="type-link">Int</a></code><a class="header-anchor" href="#totlen"><span aria-hidden="true" class="header-anchor__symbol">#</span></a></div>
