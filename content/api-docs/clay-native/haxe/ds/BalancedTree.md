...
title: BalancedTree
target: Clay (Native)
permalink: api-docs/clay-native/haxe/ds/BalancedTree/
---

# BalancedTree

<div class="type-hierarchy"><strong>haxe.ds.BalancedTree</strong> (Class) → <a href="/api-docs/clay-native/haxe/ds/EnumValueMap/">EnumValueMap</a></div>
...
| Returns |
|---------|
| [Null](/api-docs/clay-native/Null/)<haxe.ds.BalancedTree.V> |
...
| `node` | [TreeNode](/api-docs/clay-native/haxe/ds/TreeNode/)<haxe.ds.BalancedTree.K, haxe.ds.BalancedTree.V> |

| Returns |
|---------|
| [TreeNode](/api-docs/clay-native/haxe/ds/TreeNode/)<haxe.ds.BalancedTree.K, haxe.ds.BalancedTree.V> |

<hr class="field-separator" />

<div class="signature field-method no-description" id="keysLoop"><code><span class="field-name">keysLoop</span><span class="parenthesis">(</span><span class="arg-name">node</span><span class="operator">:</span> <a href="/api-docs/clay-native/haxe/ds/TreeNode/" class="type-link">TreeNode</a><span class="operator">&lt;</span><span class="type-name">haxe.ds.BalancedTree.K</span><span class="operator">,</span> <span class="type-name">haxe.ds.BalancedTree.V</span><span class="operator">&gt;</span><span class="operator">,</span> <span class="arg-name">acc</span><span class="operator">:</span> <a href="/api-docs/clay-native/Array/" class="type-link">Array</a><span class="operator">&lt;</span><span class="type-name">haxe.ds.BalancedTree.K</span><span class="operator">&gt;</span><span class="parenthesis">)</span><span class="operator">:</span> <a href="/api-docs/clay-native/Void/" class="type-link">Void</a></code><a class="header-anchor" href="#keysLoop"><span aria-hidden="true" class="header-anchor__symbol">#</span></a></div>


| Name | Type |
|------|------|
| `node` | [TreeNode](/api-docs/clay-native/haxe/ds/TreeNode/)<haxe.ds.BalancedTree.K, haxe.ds.BalancedTree.V> |
| `acc` | [Array](/api-docs/clay-native/Array/)<haxe.ds.BalancedTree.K> |
...
| Name | Type |
|------|------|
| `l` | [TreeNode](/api-docs/clay-native/haxe/ds/TreeNode/)<haxe.ds.BalancedTree.K, haxe.ds.BalancedTree.V> |
| `k` | haxe.ds.BalancedTree.K |
| `v` | haxe.ds.BalancedTree.V |
| `r` | [TreeNode](/api-docs/clay-native/haxe/ds/TreeNode/)<haxe.ds.BalancedTree.K, haxe.ds.BalancedTree.V> |
