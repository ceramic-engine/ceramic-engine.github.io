...
title: Exception
target: Clay (Native)
permalink: api-docs/clay-native/haxe/Exception/
---

# Exception

<div class="type-hierarchy"><strong>haxe.Exception</strong> (Class) → <a href="/api-docs/clay-native/haxe/ValueException/">ValueException</a>, <a href="/api-docs/clay-native/haxe/exceptions/PosException/">haxe.exceptions.PosException</a>, <a href="/api-docs/clay-native/sys/thread/NoEventLoopException/">sys.thread.NoEventLoopException</a></div>
...
| Returns |
|---------|
| [Exception](/api-docs/clay-native/haxe/Exception/) |
