...
subCategory: doc
menu: Shade
title: Shader__shaders_TintBlack_Vert__shaders_TintBlack_Frag
target: Clay (Native)
permalink: api-docs/clay-native/shade/Shader__shaders_TintBlack_Vert__shaders_TintBlack_Frag/
---

# Shader__shaders_TintBlack_Vert__shaders_TintBlack_Frag
...
<div class="type-hierarchy"><a href="/api-docs/clay-native/ceramic/Entity/">ceramic.Entity</a> → <a href="/api-docs/clay-native/ceramic/Shader/">ceramic.Shader</a> → <strong>shade.Shader__shaders_TintBlack_Vert__shaders_TintBlack_Frag</strong> (Class) → <a href="/api-docs/clay-native/shaders/TintBlack/">shaders.TintBlack</a></div>
