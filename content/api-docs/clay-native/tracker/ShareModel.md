...
title: ShareModel
target: Clay (Native)
permalink: api-docs/clay-native/tracker/ShareModel/
---
...
<div class="type-hierarchy"><a href="/api-docs/clay-native/ceramic/Entity/">ceramic.Entity</a> → <strong>tracker.ShareModel</strong> (Class)</div>
...
| `checkInterval` | [Float](/api-docs/clay-native/Float/) | `0.032` |
| `owner` | [ceramic.Entity](/api-docs/clay-native/ceramic/Entity/) | *(optional)* |
| `onChangeset` | Function | |

| Returns |
|---------|
| [ShareModel](/api-docs/clay-native/tracker/ShareModel/) |
...
<div class="signature field-method no-description" id="decodeValue"><code><span class="field-name">decodeValue</span><span class="parenthesis">(</span><span class="arg-name">encoded</span><span class="operator">:</span> <a href="/api-docs/clay-native/Any/" class="type-link">Any</a><span class="parenthesis">)</span><span class="operator">:</span> <a href="/api-docs/clay-native/Any/" class="type-link">Any</a></code><a class="header-anchor" href="#decodeValue"><span aria-hidden="true" class="header-anchor__symbol">#</span></a></div>


| Name | Type |
|------|------|
| `encoded` | [Any](/api-docs/clay-native/Any/) |
...
| Name | Type | Default |
|------|------|---------|
| `skipUnchanged` | [Bool](/api-docs/clay-native/Bool/) | `false` |
| `done` | Function | *(optional)* |

<hr class="field-separator" />

<div class="signature field-method no-description" id="receiveShared"><code><span class="field-name">receiveShared</span><span class="parenthesis">(</span><span class="arg-name">changeset</span><span class="operator">:</span> <a href="/api-docs/clay-native/tracker/ShareChangeset/" class="type-link">ShareChangeset</a><span class="parenthesis">)</span><span class="operator">:</span> <a href="/api-docs/clay-native/Void/" class="type-link">Void</a></code><a class="header-anchor" href="#receiveShared"><span aria-hidden="true" class="header-anchor__symbol">#</span></a></div>


| Name | Type |
|------|------|
| `changeset` | [ShareChangeset](/api-docs/clay-native/tracker/ShareChangeset/) |
...
<div class="signature field-var no-description" id="deserializedMap"><code><span class="field-name">deserializedMap</span><span class="operator">:</span> <a href="/api-docs/clay-native/Map/" class="type-link">Map</a></code><a class="header-anchor" href="#deserializedMap"><span aria-hidden="true" class="header-anchor__symbol">#</span></a></div>
...
<div class="signature field-var no-description" id="lastCheckedFrame"><code><span class="field-name">lastCheckedFrame</span><span class="operator">:</span> <a href="/api-docs/clay-native/Int/" class="type-link">Int</a></code><a class="header-anchor" href="#lastCheckedFrame"><span aria-hidden="true" class="header-anchor__symbol">#</span></a></div>
...
<div class="signature field-var no-description" id="paused"><code><span class="field-name">paused</span><span class="operator">:</span> <a href="/api-docs/clay-native/Int/" class="type-link">Int</a></code><a class="header-anchor" href="#paused"><span aria-hidden="true" class="header-anchor__symbol">#</span></a></div>
