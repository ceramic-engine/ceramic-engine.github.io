...
title: Utils
target: Clay (Native)
permalink: api-docs/clay-native/tracker/Utils/
---
...
|------|------|-------------|
| `values` | [Array](/api-docs/clay-native/Array/)<[Int](/api-docs/clay-native/Int/)> | the values to put in list |
| `frequencies` | [Array](/api-docs/clay-native/Array/)<[Float](/api-docs/clay-native/Float/)> |  |
...
| Name | Type | Default |
|------|------|---------|
| `val` | [Int](/api-docs/clay-native/Int/) | *(optional)* |
...
| Name | Type |
|------|------|
| `rawData` | [String](/api-docs/clay-native/String/) |
