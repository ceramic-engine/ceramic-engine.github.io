...
title: History
target: Clay (Native)
permalink: api-docs/clay-native/tracker/History/
---
...
<div class="type-hierarchy"><a href="/api-docs/clay-native/ceramic/Entity/">ceramic.Entity</a> → <strong>tracker.History</strong> (Class)</div>
...
<div class="signature field-var has-description" id="stepSyncDelay"><code><span class="field-name">stepSyncDelay</span><span class="operator">:</span> <a href="/api-docs/clay-native/Float/" class="type-link">Float</a></code><a class="header-anchor" href="#stepSyncDelay"><span aria-hidden="true" class="header-anchor__symbol">#</span></a></div>
...
<div class="signature field-var has-description" id="maxSteps"><code><span class="field-name">maxSteps</span><span class="operator">:</span> <a href="/api-docs/clay-native/Int/" class="type-link">Int</a></code><a class="header-anchor" href="#maxSteps"><span aria-hidden="true" class="header-anchor__symbol">#</span></a></div>
...
<div class="signature field-method has-description" id="undo"><code><span class="field-name">undo</span><span class="parenthesis">(</span><span class="parenthesis">)</span><span class="operator">:</span> <a href="/api-docs/clay-native/Void/" class="type-link">Void</a></code><a class="header-anchor" href="#undo"><span aria-hidden="true" class="header-anchor__symbol">#</span></a></div>

Undo last step, if any

<hr class="field-separator" />

<div class="signature field-method has-description" id="redo"><code><span class="field-name">redo</span><span class="parenthesis">(</span><span class="parenthesis">)</span><span class="operator">:</span> <a href="/api-docs/clay-native/Void/" class="type-link">Void</a></code><a class="header-anchor" href="#redo"><span aria-hidden="true" class="header-anchor__symbol">#</span></a></div>
...
<div class="signature field-var no-description" id="stepPending"><code><span class="field-name">stepPending</span><span class="operator">:</span> <a href="/api-docs/clay-native/Bool/" class="type-link">Bool</a></code><a class="header-anchor" href="#stepPending"><span aria-hidden="true" class="header-anchor__symbol">#</span></a></div>

<hr class="field-separator" />

<div class="signature field-var no-description" id="currentData"><code><span class="field-name">currentData</span><span class="operator">:</span> <a href="/api-docs/clay-native/StringBuf/" class="type-link">StringBuf</a></code><a class="header-anchor" href="#currentData"><span aria-hidden="true" class="header-anchor__symbol">#</span></a></div>
...
<div class="signature field-var no-description" id="currentStep"><code><span class="field-name">currentStep</span><span class="operator">:</span> <a href="/api-docs/clay-native/Int/" class="type-link">Int</a></code><a class="header-anchor" href="#currentStep"><span aria-hidden="true" class="header-anchor__symbol">#</span></a></div>

<hr class="field-separator" />

<div class="signature field-var no-description" id="ignoreSteps"><code><span class="field-name">ignoreSteps</span><span class="operator">:</span> <a href="/api-docs/clay-native/Int/" class="type-link">Int</a></code><a class="header-anchor" href="#ignoreSteps"><span aria-hidden="true" class="header-anchor__symbol">#</span></a></div>

<hr class="field-separator" />

<div class="signature field-var no-description" id="canScheduleImmediateStep"><code><span class="field-name">canScheduleImmediateStep</span><span class="operator">:</span> <a href="/api-docs/clay-native/Bool/" class="type-link">Bool</a></code><a class="header-anchor" href="#canScheduleImmediateStep"><span aria-hidden="true" class="header-anchor__symbol">#</span></a></div>

<hr class="field-separator" />

<div class="signature field-method has-description" id="emitUndo"><code><span class="field-name">emitUndo</span><span class="parenthesis">(</span><span class="parenthesis">)</span><span class="operator">:</span> <a href="/api-docs/clay-native/Void/" class="type-link">Void</a></code><a class="header-anchor" href="#emitUndo"><span aria-hidden="true" class="header-anchor__symbol">#</span></a></div>

undo event

<hr class="field-separator" />

<div class="signature field-method has-description" id="emitRedo"><code><span class="field-name">emitRedo</span><span class="parenthesis">(</span><span class="parenthesis">)</span><span class="operator">:</span> <a href="/api-docs/clay-native/Void/" class="type-link">Void</a></code><a class="header-anchor" href="#emitRedo"><span aria-hidden="true" class="header-anchor__symbol">#</span></a></div>

redo event

<hr class="field-separator" />

<div class="signature field-method no-description" id="scheduledStep"><code><span class="field-name">scheduledStep</span><span class="parenthesis">(</span><span class="parenthesis">)</span><span class="operator">:</span> <a href="/api-docs/clay-native/Void/" class="type-link">Void</a></code><a class="header-anchor" href="#scheduledStep"><span aria-hidden="true" class="header-anchor__symbol">#</span></a></div>

<hr class="field-separator" />

<div class="signature field-method no-description" id="clearDelayAllowImmediateStep"><code><span class="field-name">clearDelayAllowImmediateStep</span><span class="parenthesis">(</span><span class="parenthesis">)</span><span class="operator">:</span> <a href="/api-docs/clay-native/Void/" class="type-link">Void</a></code><a class="header-anchor" href="#clearDelayAllowImmediateStep"><span aria-hidden="true" class="header-anchor__symbol">#</span></a></div>

<hr class="field-separator" />

<div class="signature field-method no-description" id="bindSerializer"><code><span class="field-name">bindSerializer</span><span class="parenthesis">(</span><span class="arg-name">serializer</span><span class="operator">:</span> <a href="/api-docs/clay-native/tracker/SerializeModel/" class="type-link">SerializeModel</a><span class="parenthesis">)</span><span class="operator">:</span> <a href="/api-docs/clay-native/Void/" class="type-link">Void</a></code><a class="header-anchor" href="#bindSerializer"><span aria-hidden="true" class="header-anchor__symbol">#</span></a></div>


| Name | Type |
|------|------|
| `serializer` | [SerializeModel](/api-docs/clay-native/tracker/SerializeModel/) |

<hr class="field-separator" />

<div class="signature field-method no-description" id="recordStepIfNeeded"><code><span class="field-name">recordStepIfNeeded</span><span class="parenthesis">(</span><span class="parenthesis">)</span><span class="operator">:</span> <a href="/api-docs/clay-native/Void/" class="type-link">Void</a></code><a class="header-anchor" href="#recordStepIfNeeded"><span aria-hidden="true" class="header-anchor__symbol">#</span></a></div>

<hr class="field-separator" />

<div class="signature field-method no-description" id="applyCurrentStep"><code><span class="field-name">applyCurrentStep</span><span class="parenthesis">(</span><span class="parenthesis">)</span><span class="operator">:</span> <a href="/api-docs/clay-native/Void/" class="type-link">Void</a></code><a class="header-anchor" href="#applyCurrentStep"><span aria-hidden="true" class="header-anchor__symbol">#</span></a></div>
