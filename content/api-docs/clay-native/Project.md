...
title: Project
target: Clay (Native)
permalink: api-docs/clay-native/Project/
---

# Project

<div class="type-hierarchy"><a href="/api-docs/clay-native/ceramic/Entity/">ceramic.Entity</a> → <strong>Project</strong> (Class)</div>
...
<div class="signature field-method no-description" id="new"><code><span class="field-name">new</span><span class="parenthesis">(</span><span class="arg-name">settings</span><span class="operator">:</span> <a href="/api-docs/clay-native/ceramic/InitSettings/" class="type-link">ceramic.InitSettings</a><span class="parenthesis">)</span><span class="operator">:</span> <a href="/api-docs/clay-native/Void/" class="type-link">Void</a></code><a class="header-anchor" href="#new"><span aria-hidden="true" class="header-anchor__symbol">#</span></a></div>


| Name | Type |
|------|------|
| `settings` | [ceramic.InitSettings](/api-docs/clay-native/ceramic/InitSettings/) |
