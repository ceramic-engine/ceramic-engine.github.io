...
title: Lambda
target: Clay (Native)
permalink: api-docs/clay-native/Lambda/
---
...
| Name | Type |
|------|------|
| `it` | [Iterable](/api-docs/clay-native/Iterable/) |
| `f` | Function |

| Returns |
|---------|
| [Array](/api-docs/clay-native/Array/)<map.B> |
