...
title: Poolable
target: Clay (Native)
permalink: api-docs/clay-native/spine/support/utils/Poolable/
---
...
<div class="type-hierarchy"><strong>spine.support.utils.Poolable</strong> (Interface) → <a href="/api-docs/clay-native/spine/TrackEntry/">spine.TrackEntry</a></div>
