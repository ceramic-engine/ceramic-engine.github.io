...
target: Clay (Native)
permalink: api-docs/clay-native/spine/attachments/AttachmentLoader/
---
...
<div class="type-hierarchy"><strong>spine.attachments.AttachmentLoader</strong> (Interface) → <a href="/api-docs/clay-native/spine/attachments/AtlasAttachmentLoader/">AtlasAttachmentLoader</a></div>
...
| Returns | Description |
|---------|-------------|
| [RegionAttachment](/api-docs/clay-native/spine/attachments/RegionAttachment/) | May be null to not load the attachment. |
...
| Returns | Description |
|---------|-------------|
| [MeshAttachment](/api-docs/clay-native/spine/attachments/MeshAttachment/) | May be null to not load the attachment. In that case null should also be returned for child meshes. |
...
| Returns | Description |
|---------|-------------|
| [BoundingBoxAttachment](/api-docs/clay-native/spine/attachments/BoundingBoxAttachment/) | May be null to not load the attachment. |
...
| Returns | Description |
|---------|-------------|
| [ClippingAttachment](/api-docs/clay-native/spine/attachments/ClippingAttachment/) | May be null to not load the attachment. |
...
| Returns | Description |
|---------|-------------|
| [PathAttachment](/api-docs/clay-native/spine/attachments/PathAttachment/) | May be null to not load the attachment. |
...
| Returns | Description |
|---------|-------------|
| [PointAttachment](/api-docs/clay-native/spine/attachments/PointAttachment/) | May be null to not load the attachment. |
