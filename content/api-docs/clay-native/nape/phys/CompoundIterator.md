...
target: Clay (Native)
permalink: api-docs/clay-native/nape/phys/CompoundIterator/
---
...
|------|------|-------------|
| `list` | [CompoundList](/api-docs/clay-native/nape/phys/CompoundList/) | The Nape list to create iterator for.  |

| Returns | Description |
|---------|-------------|
| [CompoundIterator](/api-docs/clay-native/nape/phys/CompoundIterator/) | An iterator over the Nape list. |
...
| Returns | Description |
|---------|-------------|
| [Compound](/api-docs/clay-native/nape/phys/Compound/) | The next element in iteration. |
