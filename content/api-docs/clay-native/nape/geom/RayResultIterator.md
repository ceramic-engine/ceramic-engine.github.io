...
subCategory: doc
menu: Nape
title: RayResultIterator
target: Clay (Native)
permalink: api-docs/clay-native/nape/geom/RayResultIterator/
---

# RayResultIterator

<div class="view-source"><a href="https://github.com/ceramic-engine/nape/blob/master/nape/geom/RayResultIterator.hx">View source</a></div>

<div class="type-hierarchy"><strong>nape.geom.RayResultIterator</strong> (final class)</div>

Haxe Iterator<T> compatible iterator over Nape list.

## Static Members

<div class="signature field-var has-description has-plugin" id="zpp_pool"><div class="plugin-name">nape</div><code><span class="field-name">zpp_pool</span><span class="operator">:</span> <a href="#" class="type-link">RayResultIterator</a></code><a class="header-anchor" href="#zpp_pool"><span aria-hidden="true" class="header-anchor__symbol">#</span></a></div>

@private

<hr class="field-separator" />

<div class="signature field-method has-description has-plugin" id="get"><div class="plugin-name">nape</div><code><span class="field-name">get</span><span class="parenthesis">(</span><span class="arg-name">list</span><span class="operator">:</span> <a href="/api-docs/clay-native/nape/geom/RayResultList/" class="type-link">RayResultList</a><span class="parenthesis">)</span><span class="operator">:</span> <a href="#" class="type-link">RayResultIterator</a></code><a class="header-anchor" href="#get"><span aria-hidden="true" class="header-anchor__symbol">#</span></a></div>
...
|------|------|-------------|
| `list` | [RayResultList](/api-docs/clay-native/nape/geom/RayResultList/) | The Nape list to create iterator for.  |

| Returns | Description |
|---------|-------------|
| [RayResultIterator](/api-docs/clay-native/nape/geom/RayResultIterator/) | An iterator over the Nape list. |

## Instance Members

<div class="signature field-var has-description has-plugin" id="zpp_inner"><div class="plugin-name">nape</div><code><span class="field-name">zpp_inner</span><span class="operator">:</span> <a href="/api-docs/clay-native/nape/geom/RayResultList/" class="type-link">RayResultList</a></code><a class="header-anchor" href="#zpp_inner"><span aria-hidden="true" class="header-anchor__symbol">#</span></a></div>
...
| Returns | Description |
|---------|-------------|
| [RayResult](/api-docs/clay-native/nape/geom/RayResult/) | The next element in iteration. |
