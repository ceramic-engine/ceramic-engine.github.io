...
title: RayResultList
target: Clay (Native)
permalink: api-docs/clay-native/nape/geom/RayResultList/
---
...
| Name | Type | Description |
|------|------|-------------|
| `obj` | [RayResult](/api-docs/clay-native/nape/geom/RayResult/) | The object to test.  |
...
| Returns |
|---------|
| [RayResult](/api-docs/clay-native/nape/geom/RayResult/) |
...
| Name | Type | Description |
|------|------|-------------|
| `obj` | [RayResult](/api-docs/clay-native/nape/geom/RayResult/) | The object to insert.  |
...
| Name | Type | Description |
|------|------|-------------|
| `obj` | [RayResult](/api-docs/clay-native/nape/geom/RayResult/) | The object to remove  |
...
<div class="signature field-method has-description has-plugin" id="iterator"><div class="plugin-name">nape</div><code><span class="field-name">iterator</span><span class="parenthesis">(</span><span class="parenthesis">)</span><span class="operator">:</span> <a href="/api-docs/clay-native/nape/geom/RayResultIterator/" class="type-link">RayResultIterator</a></code><a class="header-anchor" href="#iterator"><span aria-hidden="true" class="header-anchor__symbol">#</span></a></div>
...
| Returns |
|---------|
| [RayResultIterator](/api-docs/clay-native/nape/geom/RayResultIterator/) |
...
| Returns | Description |
|---------|-------------|
| [RayResultList](/api-docs/clay-native/nape/geom/RayResultList/) | The copied list. |
...
| Name | Type | Description |
|------|------|-------------|
| `xs` | [RayResultList](/api-docs/clay-native/nape/geom/RayResultList/) | The list to merge.  |
...
| Returns | Description |
|---------|-------------|
| [RayResultList](/api-docs/clay-native/nape/geom/RayResultList/) | A reference to 'this' list.  |
