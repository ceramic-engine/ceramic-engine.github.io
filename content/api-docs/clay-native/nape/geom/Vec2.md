...
title: Vec2
target: Clay (Native)
permalink: api-docs/clay-native/nape/geom/Vec2/
---
...
|------|------|---------|-------------|
| `x` | [Float](/api-docs/clay-native/Float/) | `0` | The x coordinate for the vector. (default 0)  |
| `y` | [Float](/api-docs/clay-native/Float/) | `0` | The y coordiante for the vector. (default 0)  |

| Returns | Description |
|---------|-------------|
| [Vec2](/api-docs/clay-native/nape/geom/Vec2/) | The allocated weak Vec2 with given x/y values. |
...
|------|------|---------|-------------|
| `x` | [Float](/api-docs/clay-native/Float/) | `0` | The x coordinate for the vector. (default 0)  |
| `y` | [Float](/api-docs/clay-native/Float/) | `0` | The y coordinate for the vector. (default 0)  |
| `weak` | [Bool](/api-docs/clay-native/Bool/) | `false` | If true, then a weak Vec2 will be allocated which will be automatically released to object pool when passed as an argument to a Nape function. (default false)  |

| Returns | Description |
|---------|-------------|
| [Vec2](/api-docs/clay-native/nape/geom/Vec2/) | The allocated, possibly weak Vec2 with given x/y values. |
...
| Name | Type | Default | Description |
|------|------|---------|-------------|
| `length` | [Float](/api-docs/clay-native/Float/) | | The length of the Vec2. This value may be negative.  |
| `angle` | [Float](/api-docs/clay-native/Float/) | | The angle of the Vec2 as measured in radians clockwise from the positive x axis.  |
| `weak` | [Bool](/api-docs/clay-native/Bool/) | `false` | If true, then a weak Vec2 will be allocated which will be automatically released to the object pool when passed as an argument to any Nape function. (default false)  |

| Returns | Description |
|---------|-------------|
| [Vec2](/api-docs/clay-native/nape/geom/Vec2/) | The possibly weak Vec2 allocated with given polar values. |

<hr class="field-separator" />

<div class="signature field-method has-description has-plugin" id="dsq"><div class="plugin-name">nape</div><code><span class="field-name">dsq</span><span class="parenthesis">(</span><span class="arg-name">a</span><span class="operator">:</span> <a href="#" class="type-link">Vec2</a><span class="operator">,</span> <span class="arg-name">b</span><span class="operator">:</span> <a href="#" class="type-link">Vec2</a><span class="parenthesis">)</span><span class="operator">:</span> <a href="/api-docs/clay-native/Float/" class="type-link">Float</a></code><a class="header-anchor" href="#dsq"><span aria-hidden="true" class="header-anchor__symbol">#</span></a></div>
...
|------|------|-------------|
| `a` | [Vec2](/api-docs/clay-native/nape/geom/Vec2/) | The first point Vec2.  |
| `b` | [Vec2](/api-docs/clay-native/nape/geom/Vec2/) | The second point Vec2.  |

| Returns | Description |
|---------|-------------|
| [Float](/api-docs/clay-native/Float/) | Squared distance between points.  |
...
| Returns | Description |
|---------|-------------|
| [Float](/api-docs/clay-native/Float/) | Distance between points.  |
...
| Returns | Description |
|---------|-------------|
| [Vec2](/api-docs/clay-native/nape/geom/Vec2/) | The possibly weak copy of this Vec2.  |
...
| Returns | Description |
|---------|-------------|
| [Float](/api-docs/clay-native/Float/) | The squared length of this Vec2.  |
...
| Name | Type | Description |
|------|------|-------------|
| `vector` | [Vec2](/api-docs/clay-native/nape/geom/Vec2/) | The Vec2 to set the values of this Vec2 with.  |

| Returns | Description |
|---------|-------------|
| [Vec2](/api-docs/clay-native/nape/geom/Vec2/) | A reference to 'this' Vec2.  |
...
| Name | Type | Description |
|------|------|-------------|
| `x` | [Float](/api-docs/clay-native/Float/) | The x value to set this Vec2's x value to.  |
| `y` | [Float](/api-docs/clay-native/Float/) | The y value to set this Vec2's y value to.  |
...
| Name | Type | Description |
|------|------|-------------|
| `angle` | [Float](/api-docs/clay-native/Float/) | The number of radians to rotate Vec2 by in the clockwise direction.  |
...
| Name | Type | Default | Description |
|------|------|---------|-------------|
| `vec` | [Vec2](/api-docs/clay-native/nape/geom/Vec2/) | | The vector to be reflected.  |
| `weak` | [Bool](/api-docs/clay-native/Bool/) | `false` | If true, the returned Vec2 will be automatically released to object pool when used in another Nape function (default false)  |

| Returns | Description |
|---------|-------------|
| [Vec2](/api-docs/clay-native/nape/geom/Vec2/) | The reflected Vec2.  |
...
| Returns | Description |
|---------|-------------|
| [Vec2](/api-docs/clay-native/nape/geom/Vec2/) | A reference to 'this' vector.  |
...
| Name | Type | Default | Description |
|------|------|---------|-------------|
| `weak` | [Bool](/api-docs/clay-native/Bool/) | `false` | If true then the allocated Vec2 will be automatically released to the global object pool when used as an argument to a Nape function. (default false)  |

| Returns | Description |
|---------|-------------|
| [Vec2](/api-docs/clay-native/nape/geom/Vec2/) | A copy of this vector, normalised.  |
...
| Name | Type | Default | Description |
|------|------|---------|-------------|
| `vector` | [Vec2](/api-docs/clay-native/nape/geom/Vec2/) | | The vector to add to this vector. This value can not be null  |
| `weak` | [Bool](/api-docs/clay-native/Bool/) | `false` | If true then the returned vector will be automatically released to the global object pool when used as an argument to another Nape function. (default false)  |

| Returns | Description |
|---------|-------------|
| [Vec2](/api-docs/clay-native/nape/geom/Vec2/) | The possibly weak vector representing the sum of this and the input vector.  |
...
|------|------|---------|-------------|
| `vector` | [Vec2](/api-docs/clay-native/nape/geom/Vec2/) | | The vector to add to this vector. This value can not be null  |
| `scalar` | [Float](/api-docs/clay-native/Float/) | | The scalar multiplier for the vector being added.  |
| `weak` | [Bool](/api-docs/clay-native/Bool/) | `false` | If true then the returned vector will be automatically released to the global object pool when used as an argument to another Nape function. (default false)  |

| Returns | Description |
|---------|-------------|
| [Vec2](/api-docs/clay-native/nape/geom/Vec2/) | The possibly weak vector representing the sum of this and the input vector by scalar multiplier.  |
...
| Name | Type | Default | Description |
|------|------|---------|-------------|
| `vector` | [Vec2](/api-docs/clay-native/nape/geom/Vec2/) | | The vector to subtract from this vector. This value can not be null  |
| `weak` | [Bool](/api-docs/clay-native/Bool/) | `false` | If true then the returned vector will be automatically released to the global object pool when used as an argument to another Nape function. (default false)  |

| Returns | Description |
|---------|-------------|
| [Vec2](/api-docs/clay-native/nape/geom/Vec2/) | The possibly weak vector representing the subtraction of the input vector from this vector.  |
...
| Name | Type | Default | Description |
|------|------|---------|-------------|
| `scalar` | [Float](/api-docs/clay-native/Float/) | | The number to multiply this vector with.  |
| `weak` | [Bool](/api-docs/clay-native/Bool/) | `false` | If true then the returned vector will be automatically released to the global object pool when used as an argument to another Nape function. (default false)  |

| Returns | Description |
|---------|-------------|
| [Vec2](/api-docs/clay-native/nape/geom/Vec2/) | The possibly weak vector representing the multiplication of this vector and the input number.  |
...
| Name | Type | Description |
|------|------|-------------|
| `vector` | [Vec2](/api-docs/clay-native/nape/geom/Vec2/) | The vector to add into this vector.  |
...
| Name | Type | Description |
|------|------|-------------|
| `vector` | [Vec2](/api-docs/clay-native/nape/geom/Vec2/) | The vector to subtract from this vector.  |
...
| Name | Type | Description |
|------|------|-------------|
| `vector` | [Vec2](/api-docs/clay-native/nape/geom/Vec2/) | The vector to compute dot product with.  |

| Returns | Description |
|---------|-------------|
| [Float](/api-docs/clay-native/Float/) | The dot product of this vector and the other.  |

<hr class="field-separator" />

<div class="signature field-method has-description has-plugin" id="cross"><div class="plugin-name">nape</div><code><span class="field-name">cross</span><span class="parenthesis">(</span><span class="arg-name">vector</span><span class="operator">:</span> <a href="#" class="type-link">Vec2</a><span class="parenthesis">)</span><span class="operator">:</span> <a href="/api-docs/clay-native/Float/" class="type-link">Float</a></code><a class="header-anchor" href="#cross"><span aria-hidden="true" class="header-anchor__symbol">#</span></a></div>
...
| Name | Type | Description |
|------|------|-------------|
| `vector` | [Vec2](/api-docs/clay-native/nape/geom/Vec2/) | The vector to compute cross product with.  |

| Returns | Description |
|---------|-------------|
| [Float](/api-docs/clay-native/Float/) | The cross product of this vector and the other.  |
...
| Returns | Description |
|---------|-------------|
| [Vec2](/api-docs/clay-native/nape/geom/Vec2/) | The possibly weakly allocated, right-perpendicular to this vector.  |
