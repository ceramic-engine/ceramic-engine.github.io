...
title: GeomPolyList
target: Clay (Native)
permalink: api-docs/clay-native/nape/geom/GeomPolyList/
---
...
|------|------|-------------|
| `array` | [Array](/api-docs/clay-native/Array/)<[GeomPoly](/api-docs/clay-native/nape/geom/GeomPoly/)> | The array to be converted  |

| Returns | Description |
|---------|-------------|
| [GeomPolyList](/api-docs/clay-native/nape/geom/GeomPolyList/) | An equivalent Nape list.  |

## Instance Members

<div class="signature field-var has-description has-plugin" id="zpp_inner"><div class="plugin-name">nape</div><code><span class="field-name">zpp_inner</span><span class="operator">:</span> <a href="/api-docs/clay-native/zpp_nape/util/ZPP_GeomPolyList/" class="type-link">zpp_nape.util.ZPP_GeomPolyList</a></code><a class="header-anchor" href="#zpp_inner"><span aria-hidden="true" class="header-anchor__symbol">#</span></a></div>
...
| Name | Type | Description |
|------|------|-------------|
| `obj` | [GeomPoly](/api-docs/clay-native/nape/geom/GeomPoly/) | The object to test.  |
...
| Returns |
|---------|
| [GeomPoly](/api-docs/clay-native/nape/geom/GeomPoly/) |
...
| Name | Type | Description |
|------|------|-------------|
| `obj` | [GeomPoly](/api-docs/clay-native/nape/geom/GeomPoly/) | The object to insert.  |
...
| Name | Type | Description |
|------|------|-------------|
| `obj` | [GeomPoly](/api-docs/clay-native/nape/geom/GeomPoly/) | The object to remove  |
...
| Returns |
|---------|
| [GeomPolyIterator](/api-docs/clay-native/nape/geom/GeomPolyIterator/) |
...
| Returns | Description |
|---------|-------------|
| [GeomPolyList](/api-docs/clay-native/nape/geom/GeomPolyList/) | The copied list. |
...
| Name | Type | Description |
|------|------|-------------|
| `xs` | [GeomPolyList](/api-docs/clay-native/nape/geom/GeomPolyList/) | The list to merge.  |
...
| Returns | Description |
|---------|-------------|
| [GeomPolyList](/api-docs/clay-native/nape/geom/GeomPolyList/) | A reference to 'this' list.  |
