...
target: Clay (Native)
permalink: api-docs/clay-native/nape/geom/GeomPolyIterator/
---
...
|------|------|-------------|
| `list` | [GeomPolyList](/api-docs/clay-native/nape/geom/GeomPolyList/) | The Nape list to create iterator for.  |

| Returns | Description |
|---------|-------------|
| [GeomPolyIterator](/api-docs/clay-native/nape/geom/GeomPolyIterator/) | An iterator over the Nape list. |
...
| Returns | Description |
|---------|-------------|
| [GeomPoly](/api-docs/clay-native/nape/geom/GeomPoly/) | The next element in iteration. |
