...
target: Clay (Native)
permalink: api-docs/clay-native/nape/geom/ConvexResultList/
---
...
|------|------|-------------|
| `array` | [Array](/api-docs/clay-native/Array/)<[ConvexResult](/api-docs/clay-native/nape/geom/ConvexResult/)> | The array to be converted  |

| Returns | Description |
|---------|-------------|
| [ConvexResultList](/api-docs/clay-native/nape/geom/ConvexResultList/) | An equivalent Nape list.  |

## Instance Members

<div class="signature field-var has-description has-plugin" id="zpp_inner"><div class="plugin-name">nape</div><code><span class="field-name">zpp_inner</span><span class="operator">:</span> <a href="/api-docs/clay-native/zpp_nape/util/ZPP_ConvexResultList/" class="type-link">zpp_nape.util.ZPP_ConvexResultList</a></code><a class="header-anchor" href="#zpp_inner"><span aria-hidden="true" class="header-anchor__symbol">#</span></a></div>
...
| Name | Type | Description |
|------|------|-------------|
| `obj` | [ConvexResult](/api-docs/clay-native/nape/geom/ConvexResult/) | The object to test.  |
...
| Returns |
|---------|
| [ConvexResult](/api-docs/clay-native/nape/geom/ConvexResult/) |
...
| Name | Type | Description |
|------|------|-------------|
| `obj` | [ConvexResult](/api-docs/clay-native/nape/geom/ConvexResult/) | The object to insert.  |
...
<div class="signature field-method has-description has-plugin" id="pop"><div class="plugin-name">nape</div><code><span class="field-name">pop</span><span class="parenthesis">(</span><span class="parenthesis">)</span><span class="operator">:</span> <a href="/api-docs/clay-native/nape/geom/ConvexResult/" class="type-link">ConvexResult</a></code><a class="header-anchor" href="#pop"><span aria-hidden="true" class="header-anchor__symbol">#</span></a></div>
...
| Name | Type | Description |
|------|------|-------------|
| `obj` | [ConvexResult](/api-docs/clay-native/nape/geom/ConvexResult/) | The object to remove  |
...
<div class="signature field-method has-description has-plugin" id="iterator"><div class="plugin-name">nape</div><code><span class="field-name">iterator</span><span class="parenthesis">(</span><span class="parenthesis">)</span><span class="operator">:</span> <a href="/api-docs/clay-native/nape/geom/ConvexResultIterator/" class="type-link">ConvexResultIterator</a></code><a class="header-anchor" href="#iterator"><span aria-hidden="true" class="header-anchor__symbol">#</span></a></div>
...
| Returns |
|---------|
| [ConvexResultIterator](/api-docs/clay-native/nape/geom/ConvexResultIterator/) |
...
| Returns | Description |
|---------|-------------|
| [ConvexResultList](/api-docs/clay-native/nape/geom/ConvexResultList/) | The copied list. |
...
| Name | Type | Description |
|------|------|-------------|
| `xs` | [ConvexResultList](/api-docs/clay-native/nape/geom/ConvexResultList/) | The list to merge.  |
...
| Returns | Description |
|---------|-------------|
| [ConvexResultList](/api-docs/clay-native/nape/geom/ConvexResultList/) | A reference to 'this' list.  |
