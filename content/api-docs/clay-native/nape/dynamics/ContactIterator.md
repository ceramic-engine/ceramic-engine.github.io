...
subCategory: doc
menu: Nape
title: ContactIterator
target: Clay (Native)
permalink: api-docs/clay-native/nape/dynamics/ContactIterator/
---

# ContactIterator

<div class="view-source"><a href="https://github.com/ceramic-engine/nape/blob/master/nape/dynamics/ContactIterator.hx">View source</a></div>

<div class="type-hierarchy"><strong>nape.dynamics.ContactIterator</strong> (final class)</div>

Haxe Iterator<T> compatible iterator over Nape list.

## Static Members

<div class="signature field-var has-description has-plugin" id="zpp_pool"><div class="plugin-name">nape</div><code><span class="field-name">zpp_pool</span><span class="operator">:</span> <a href="#" class="type-link">ContactIterator</a></code><a class="header-anchor" href="#zpp_pool"><span aria-hidden="true" class="header-anchor__symbol">#</span></a></div>

@private

<hr class="field-separator" />

<div class="signature field-method has-description has-plugin" id="get"><div class="plugin-name">nape</div><code><span class="field-name">get</span><span class="parenthesis">(</span><span class="arg-name">list</span><span class="operator">:</span> <a href="/api-docs/clay-native/nape/dynamics/ContactList/" class="type-link">ContactList</a><span class="parenthesis">)</span><span class="operator">:</span> <a href="#" class="type-link">ContactIterator</a></code><a class="header-anchor" href="#get"><span aria-hidden="true" class="header-anchor__symbol">#</span></a></div>
...
|------|------|-------------|
| `list` | [ContactList](/api-docs/clay-native/nape/dynamics/ContactList/) | The Nape list to create iterator for.  |

| Returns | Description |
|---------|-------------|
| [ContactIterator](/api-docs/clay-native/nape/dynamics/ContactIterator/) | An iterator over the Nape list. |

## Instance Members

<div class="signature field-var has-description has-plugin" id="zpp_inner"><div class="plugin-name">nape</div><code><span class="field-name">zpp_inner</span><span class="operator">:</span> <a href="/api-docs/clay-native/nape/dynamics/ContactList/" class="type-link">ContactList</a></code><a class="header-anchor" href="#zpp_inner"><span aria-hidden="true" class="header-anchor__symbol">#</span></a></div>
...
| Returns | Description |
|---------|-------------|
| [Contact](/api-docs/clay-native/nape/dynamics/Contact/) | The next element in iteration. |
