...
subCategory: doc
menu: Nape
title: ArbiterIterator
target: Clay (Native)
permalink: api-docs/clay-native/nape/dynamics/ArbiterIterator/
---

# ArbiterIterator

<div class="view-source"><a href="https://github.com/ceramic-engine/nape/blob/master/nape/dynamics/ArbiterIterator.hx">View source</a></div>

<div class="type-hierarchy"><strong>nape.dynamics.ArbiterIterator</strong> (final class)</div>

Haxe Iterator<T> compatible iterator over Nape list.

## Static Members

<div class="signature field-var has-description has-plugin" id="zpp_pool"><div class="plugin-name">nape</div><code><span class="field-name">zpp_pool</span><span class="operator">:</span> <a href="#" class="type-link">ArbiterIterator</a></code><a class="header-anchor" href="#zpp_pool"><span aria-hidden="true" class="header-anchor__symbol">#</span></a></div>

@private

<hr class="field-separator" />

<div class="signature field-method has-description has-plugin" id="get"><div class="plugin-name">nape</div><code><span class="field-name">get</span><span class="parenthesis">(</span><span class="arg-name">list</span><span class="operator">:</span> <a href="/api-docs/clay-native/nape/dynamics/ArbiterList/" class="type-link">ArbiterList</a><span class="parenthesis">)</span><span class="operator">:</span> <a href="#" class="type-link">ArbiterIterator</a></code><a class="header-anchor" href="#get"><span aria-hidden="true" class="header-anchor__symbol">#</span></a></div>
...
|------|------|-------------|
| `list` | [ArbiterList](/api-docs/clay-native/nape/dynamics/ArbiterList/) | The Nape list to create iterator for.  |

| Returns | Description |
|---------|-------------|
| [ArbiterIterator](/api-docs/clay-native/nape/dynamics/ArbiterIterator/) | An iterator over the Nape list. |
...
| Returns | Description |
|---------|-------------|
| [Arbiter](/api-docs/clay-native/nape/dynamics/Arbiter/) | The next element in iteration. |
