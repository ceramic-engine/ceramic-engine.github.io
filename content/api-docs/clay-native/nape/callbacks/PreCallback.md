...
title: PreCallback
target: Clay (Native)
permalink: api-docs/clay-native/nape/callbacks/PreCallback/
---
...
<div class="type-hierarchy"><a href="/api-docs/clay-native/nape/callbacks/Callback/">Callback</a> → <strong>nape.callbacks.PreCallback</strong> (final class)</div>
...
<div class="signature field-var has-description has-plugin" id="arbiter"><div class="plugin-name">nape</div><code><span class="field-name">arbiter</span><span class="operator">:</span> <a href="/api-docs/clay-native/nape/dynamics/Arbiter/" class="type-link">nape.dynamics.Arbiter</a></code><a class="header-anchor" href="#arbiter"><span aria-hidden="true" class="header-anchor__symbol">#</span></a></div>
