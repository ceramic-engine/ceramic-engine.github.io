...
title: Listener
target: Clay (Native)
permalink: api-docs/clay-native/nape/callbacks/Listener/
---
...
<div class="type-hierarchy"><strong>nape.callbacks.Listener</strong> (Class) → <a href="/api-docs/clay-native/nape/callbacks/BodyListener/">BodyListener</a>, <a href="/api-docs/clay-native/nape/callbacks/ConstraintListener/">ConstraintListener</a>, <a href="/api-docs/clay-native/nape/callbacks/InteractionListener/">InteractionListener</a>, <a href="/api-docs/clay-native/nape/callbacks/PreListener/">PreListener</a></div>
...
<div class="signature field-var has-description has-plugin" id="type"><div class="plugin-name">nape</div><code><span class="field-name">type</span><span class="operator">:</span> <a href="/api-docs/clay-native/nape/callbacks/ListenerType/" class="type-link">ListenerType</a></code><a class="header-anchor" href="#type"><span aria-hidden="true" class="header-anchor__symbol">#</span></a></div>
