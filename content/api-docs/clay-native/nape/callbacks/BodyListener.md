...
title: BodyListener
target: Clay (Native)
permalink: api-docs/clay-native/nape/callbacks/BodyListener/
---
...
<div class="type-hierarchy"><a href="/api-docs/clay-native/nape/callbacks/Listener/">Listener</a> → <strong>nape.callbacks.BodyListener</strong> (final class)</div>
...
| `options` | [Null](/api-docs/clay-native/Null/)<[Dynamic](/api-docs/clay-native/Dynamic/)> | | The OptionType to match Bodys against, passing null will equate to an empty OptionType.  |
