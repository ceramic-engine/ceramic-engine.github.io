...
target: Clay (Native)
permalink: api-docs/clay-native/nape/callbacks/ListenerIterator/
---
...
|------|------|-------------|
| `list` | [ListenerList](/api-docs/clay-native/nape/callbacks/ListenerList/) | The Nape list to create iterator for.  |

| Returns | Description |
|---------|-------------|
| [ListenerIterator](/api-docs/clay-native/nape/callbacks/ListenerIterator/) | An iterator over the Nape list. |
...
| Returns | Description |
|---------|-------------|
| [Listener](/api-docs/clay-native/nape/callbacks/Listener/) | The next element in iteration. |
