...
title: BodyCallback
target: Clay (Native)
permalink: api-docs/clay-native/nape/callbacks/BodyCallback/
---
...
<div class="type-hierarchy"><a href="/api-docs/clay-native/nape/callbacks/Callback/">Callback</a> → <strong>nape.callbacks.BodyCallback</strong> (final class)</div>
