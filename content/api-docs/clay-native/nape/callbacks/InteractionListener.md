...
target: Clay (Native)
permalink: api-docs/clay-native/nape/callbacks/InteractionListener/
---
...
<div class="type-hierarchy"><a href="/api-docs/clay-native/nape/callbacks/Listener/">Listener</a> → <strong>nape.callbacks.InteractionListener</strong> (final class)</div>
