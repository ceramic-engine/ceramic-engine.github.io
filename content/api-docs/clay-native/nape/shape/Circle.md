...
title: Circle
target: Clay (Native)
permalink: api-docs/clay-native/nape/shape/Circle/
---
...
<div class="type-hierarchy"><a href="/api-docs/clay-native/nape/phys/Interactor/">nape.phys.Interactor</a> → <a href="/api-docs/clay-native/nape/shape/Shape/">Shape</a> → <strong>nape.shape.Circle</strong> (final class)</div>

Shape subtype representing a Circle

## Instance Members

<div class="signature field-var has-description has-plugin" id="zpp_inner_zn"><div class="plugin-name">nape</div><code><span class="field-name">zpp_inner_zn</span><span class="operator">:</span> <a href="/api-docs/clay-native/zpp_nape/shape/ZPP_Circle/" class="type-link">zpp_nape.shape.ZPP_Circle</a></code><a class="header-anchor" href="#zpp_inner_zn"><span aria-hidden="true" class="header-anchor__symbol">#</span></a></div>
...
|------|------|---------|-------------|
| `radius` | [Float](/api-docs/clay-native/Float/) | | The radius of the circle, this value must be positive.  |
| `localCOM` | [nape.geom.Vec2](/api-docs/clay-native/nape/geom/Vec2/) | `null` | The local offset for the circle. (default &#40;0,0&#41;)  |
| `material` | [nape.phys.Material](/api-docs/clay-native/nape/phys/Material/) | `null` | The material for this circle. (default new Material&#40;&#41;)  |
| `filter` | [nape.dynamics.InteractionFilter](/api-docs/clay-native/nape/dynamics/InteractionFilter/) | `null` | The interaction filter for this circle. (default new InteractionFilter&#40;&#41;)  |
