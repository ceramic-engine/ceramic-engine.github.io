...
title: LineJoint
target: Clay (Native)
permalink: api-docs/clay-native/nape/constraint/LineJoint/
---

# LineJoint

<div class="view-source"><a href="https://github.com/ceramic-engine/nape/blob/master/nape/constraint/LineJoint.hx">View source</a></div>

<div class="type-hierarchy"><a href="/api-docs/clay-native/nape/constraint/Constraint/">Constraint</a> → <strong>nape.constraint.LineJoint</strong> (final class)</div>
...
<div class="signature field-var has-description has-plugin" id="zpp_inner_zn"><div class="plugin-name">nape</div><code><span class="field-name">zpp_inner_zn</span><span class="operator">:</span> <a href="/api-docs/clay-native/zpp_nape/constraint/ZPP_LineJoint/" class="type-link">zpp_nape.constraint.ZPP_LineJoint</a></code><a class="header-anchor" href="#zpp_inner_zn"><span aria-hidden="true" class="header-anchor__symbol">#</span></a></div>
...
<div class="signature field-var has-description has-plugin" id="direction"><div class="plugin-name">nape</div><code><span class="field-name">direction</span><span class="operator">:</span> <a href="/api-docs/clay-native/nape/geom/Vec2/" class="type-link">nape.geom.Vec2</a></code><a class="header-anchor" href="#direction"><span aria-hidden="true" class="header-anchor__symbol">#</span></a></div>
...
|------|------|-------------|
| `body1` | [Null](/api-docs/clay-native/Null/)<[nape.phys.Body](/api-docs/clay-native/nape/phys/Body/)> | The first body in LineJoint.  |
| `body2` | [Null](/api-docs/clay-native/Null/)<[nape.phys.Body](/api-docs/clay-native/nape/phys/Body/)> | The second body in LineJoint.  |
...
| `direction` | [nape.geom.Vec2](/api-docs/clay-native/nape/geom/Vec2/) | The direction of local line for joint.  |
