...
title: PulleyJoint
target: Clay (Native)
permalink: api-docs/clay-native/nape/constraint/PulleyJoint/
---
...
<div class="type-hierarchy"><a href="/api-docs/clay-native/nape/constraint/Constraint/">Constraint</a> → <strong>nape.constraint.PulleyJoint</strong> (final class)</div>
...
<div class="signature field-var has-description has-plugin" id="zpp_inner_zn"><div class="plugin-name">nape</div><code><span class="field-name">zpp_inner_zn</span><span class="operator">:</span> <a href="/api-docs/clay-native/zpp_nape/constraint/ZPP_PulleyJoint/" class="type-link">zpp_nape.constraint.ZPP_PulleyJoint</a></code><a class="header-anchor" href="#zpp_inner_zn"><span aria-hidden="true" class="header-anchor__symbol">#</span></a></div>
...
<div class="signature field-var has-description has-plugin" id="anchor3"><div class="plugin-name">nape</div><code><span class="field-name">anchor3</span><span class="operator">:</span> <a href="/api-docs/clay-native/nape/geom/Vec2/" class="type-link">nape.geom.Vec2</a></code><a class="header-anchor" href="#anchor3"><span aria-hidden="true" class="header-anchor__symbol">#</span></a></div>
...
<div class="signature field-var has-description has-plugin" id="anchor4"><div class="plugin-name">nape</div><code><span class="field-name">anchor4</span><span class="operator">:</span> <a href="/api-docs/clay-native/nape/geom/Vec2/" class="type-link">nape.geom.Vec2</a></code><a class="header-anchor" href="#anchor4"><span aria-hidden="true" class="header-anchor__symbol">#</span></a></div>
...
| Returns | Description |
|---------|-------------|
| [Bool](/api-docs/clay-native/Bool/) | True if positional error of constraint is between the limits indicating that the constraint is not doing any work.  |
...
|------|------|---------|-------------|
| `body1` | [Null](/api-docs/clay-native/Null/)<[nape.phys.Body](/api-docs/clay-native/nape/phys/Body/)> | | The first body in PulleyJoint.  |
| `body2` | [Null](/api-docs/clay-native/Null/)<[nape.phys.Body](/api-docs/clay-native/nape/phys/Body/)> | | The second body in PulleyJoint.  |
| `body3` | [Null](/api-docs/clay-native/Null/)<[nape.phys.Body](/api-docs/clay-native/nape/phys/Body/)> | | The third body in PulleyJoint.  |
| `body4` | [Null](/api-docs/clay-native/Null/)<[nape.phys.Body](/api-docs/clay-native/nape/phys/Body/)> | | The fourth body in PulleyJoint.  |
...
| `anchor3` | [nape.geom.Vec2](/api-docs/clay-native/nape/geom/Vec2/) | | The third local anchor for joint.  |
| `anchor4` | [nape.geom.Vec2](/api-docs/clay-native/nape/geom/Vec2/) | | The fourth local anchor for joint.  |
| `jointMin` | [Float](/api-docs/clay-native/Float/) | | The lower bound for constraint.  |
| `jointMax` | [Float](/api-docs/clay-native/Float/) | | The upper bound for constraint.  |
| `ratio` | [Float](/api-docs/clay-native/Float/) | `1.0` | The ratio for constraint.  |
