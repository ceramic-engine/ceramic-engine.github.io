...
title: DistanceJoint
target: Clay (Native)
permalink: api-docs/clay-native/nape/constraint/DistanceJoint/
---
...
<div class="type-hierarchy"><a href="/api-docs/clay-native/nape/constraint/Constraint/">Constraint</a> → <strong>nape.constraint.DistanceJoint</strong> (final class)</div>
...
|------|------|-------------|
| `body1` | [Null](/api-docs/clay-native/Null/)<[nape.phys.Body](/api-docs/clay-native/nape/phys/Body/)> | The first body in DistanceJoint.  |
| `body2` | [Null](/api-docs/clay-native/Null/)<[nape.phys.Body](/api-docs/clay-native/nape/phys/Body/)> | The second body in DistanceJoint.  |
