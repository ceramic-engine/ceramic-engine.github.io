...
title: NBeatDecl
target: Clay (Native)
permalink: api-docs/clay-native/loreline/NBeatDecl/
---
...
<div class="type-hierarchy"><a href="/api-docs/clay-native/loreline/Node/">Node</a> → <a href="/api-docs/clay-native/loreline/AstNode/">AstNode</a> → <strong>loreline.NBeatDecl</strong> (Class)</div>
...
| `name` | [String](/api-docs/clay-native/String/) | | Name of the beat  |
| `body` | [Array](/api-docs/clay-native/Array/)<[AstNode](/api-docs/clay-native/loreline/AstNode/)> | | Array of nodes comprising the beat's content  |
