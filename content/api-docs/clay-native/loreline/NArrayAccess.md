...
title: NArrayAccess
target: Clay (Native)
permalink: api-docs/clay-native/loreline/NArrayAccess/
---
...
<div class="type-hierarchy"><a href="/api-docs/clay-native/loreline/Node/">Node</a> → <a href="/api-docs/clay-native/loreline/AstNode/">AstNode</a> → <a href="/api-docs/clay-native/loreline/NExpr/">NExpr</a> → <strong>loreline.NArrayAccess</strong> (Class)</div>
...
<div class="signature field-var has-description" id="index"><code><span class="field-name">index</span><span class="operator">:</span> <a href="/api-docs/clay-native/loreline/NExpr/" class="type-link">NExpr</a></code><a class="header-anchor" href="#index"><span aria-hidden="true" class="header-anchor__symbol">#</span></a></div>
...
| Returns | Description |
|---------|-------------|
| [Dynamic](/api-docs/clay-native/Dynamic/) | Dynamic object containing array access data |
...
| `pos` | [Position](/api-docs/clay-native/loreline/Position/) | | Position in source where this access appears  |
| `target` | [NExpr](/api-docs/clay-native/loreline/NExpr/) | | Target array expression  |
| `index` | [NExpr](/api-docs/clay-native/loreline/NExpr/) | | Index expression  |
| `leadingComments` | [Array](/api-docs/clay-native/Array/)<[Comment](/api-docs/clay-native/loreline/Comment/)> | *(optional)* | Optional comments before the access  |
| `trailingComments` | [Array](/api-docs/clay-native/Array/)<[Comment](/api-docs/clay-native/loreline/Comment/)> | *(optional)* | Optional comments after the access |
