...
title: NStringPart
target: Clay (Native)
permalink: api-docs/clay-native/loreline/NStringPart/
---
...
<div class="type-hierarchy"><a href="/api-docs/clay-native/loreline/Node/">Node</a> → <a href="/api-docs/clay-native/loreline/AstNode/">AstNode</a> → <a href="/api-docs/clay-native/loreline/NExpr/">NExpr</a> → <strong>loreline.NStringPart</strong> (Class)</div>
...
| Returns | Description |
|---------|-------------|
| [Dynamic](/api-docs/clay-native/Dynamic/) | Dynamic object containing string part data |
...
| `pos` | [Position](/api-docs/clay-native/loreline/Position/) | | Position in source where this string part appears  |
| `partType` | Anonymous | |  |
