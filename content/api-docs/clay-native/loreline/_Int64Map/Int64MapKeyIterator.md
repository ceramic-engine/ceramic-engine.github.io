...
target: Clay (Native)
permalink: api-docs/clay-native/loreline/_Int64Map/Int64MapKeyIterator/
---
...
<div class="signature field-method no-description" id="next"><code><span class="field-name">next</span><span class="parenthesis">(</span><span class="parenthesis">)</span><span class="operator">:</span> <a href="/api-docs/clay-native/loreline/Int64MapKey/" class="type-link">loreline.Int64MapKey</a></code><a class="header-anchor" href="#next"><span aria-hidden="true" class="header-anchor__symbol">#</span></a></div>

| Returns |
|---------|
| [loreline.Int64MapKey](/api-docs/clay-native/loreline/Int64MapKey/) |
...
| Name | Type |
|------|------|
| `map` | [loreline.Int64Map](/api-docs/clay-native/loreline/Int64Map/)<loreline._Int64Map.Int64MapKeyIterator.V> |
