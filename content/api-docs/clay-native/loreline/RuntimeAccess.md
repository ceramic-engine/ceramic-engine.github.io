...
title: RuntimeAccess
target: Clay (Native)
permalink: api-docs/clay-native/loreline/RuntimeAccess/
---
...
|------|------|-------------|
| `pos` | [loreline.Position](/api-docs/clay-native/loreline/Position/) | Position in the source code where this access occurs  |
| `obj` | [Any](/api-docs/clay-native/Any/) | The object being accessed  |
| `name` | [String](/api-docs/clay-native/String/) | The name of the field to access |
...
|------|------|-------------|
| `pos` | [loreline.Position](/api-docs/clay-native/loreline/Position/) | Position in the source code where this access occurs  |
| `array` | [Any](/api-docs/clay-native/Any/) | The array being accessed  |
| `index` | [Int](/api-docs/clay-native/Int/) | The index into the array |
...
|------|------|-------------|
| `pos` | [loreline.Position](/api-docs/clay-native/loreline/Position/) | Position in the source code where this access occurs  |
| `name` | [String](/api-docs/clay-native/String/) | The name of the character to access |
...
|------|------|-------------|
| `pos` | [loreline.Position](/api-docs/clay-native/loreline/Position/) | Position in the source code where this access occurs  |
| `name` | [String](/api-docs/clay-native/String/) | The name of the function to access |
