...
target: Clay (Native)
permalink: api-docs/clay-native/loreline/RuntimeCharacter/
---
...
<div class="type-hierarchy"><a href="/api-docs/clay-native/loreline/RuntimeState/">RuntimeState</a> → <strong>loreline.RuntimeCharacter</strong> (Class)</div>
...
| `originalFields` | [Any](/api-docs/clay-native/Any/) |
