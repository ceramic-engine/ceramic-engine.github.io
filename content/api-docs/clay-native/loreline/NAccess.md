...
title: NAccess
target: Clay (Native)
permalink: api-docs/clay-native/loreline/NAccess/
---
...
<div class="type-hierarchy"><a href="/api-docs/clay-native/loreline/Node/">Node</a> → <a href="/api-docs/clay-native/loreline/AstNode/">AstNode</a> → <a href="/api-docs/clay-native/loreline/NExpr/">NExpr</a> → <strong>loreline.NAccess</strong> (Class)</div>
...
| Returns | Description |
|---------|-------------|
| [Dynamic](/api-docs/clay-native/Dynamic/) | Dynamic object containing access data |
...
| `target` | [Null](/api-docs/clay-native/Null/)<[NExpr](/api-docs/clay-native/loreline/NExpr/)> | | Optional target object expression  |
| `name` | [String](/api-docs/clay-native/String/) | | Name of the accessed field  |
