...
title: Script
target: Clay (Native)
permalink: api-docs/clay-native/loreline/Script/
---
...
<div class="type-hierarchy"><a href="/api-docs/clay-native/loreline/Node/">Node</a> → <a href="/api-docs/clay-native/loreline/AstNode/">AstNode</a> → <strong>loreline.Script</strong> (Class)</div>
...
| Returns | Description |
|---------|-------------|
| [Dynamic](/api-docs/clay-native/Dynamic/) | Dynamic object containing all script data |
...
|------|------|-------------|
| `id` | [NodeId](/api-docs/clay-native/loreline/NodeId/) | The node id of this script  |
| `pos` | [Position](/api-docs/clay-native/loreline/Position/) | Position in source where this script starts  |
| `body` | [Array](/api-docs/clay-native/Array/)<[AstNode](/api-docs/clay-native/loreline/AstNode/)> | Array of top-level declarations |
