...
title: NObjectField
target: Clay (Native)
permalink: api-docs/clay-native/loreline/NObjectField/
---
...
<div class="type-hierarchy"><a href="/api-docs/clay-native/loreline/Node/">Node</a> → <a href="/api-docs/clay-native/loreline/AstNode/">AstNode</a> → <strong>loreline.NObjectField</strong> (Class)</div>
...
| Returns | Description |
|---------|-------------|
| [Dynamic](/api-docs/clay-native/Dynamic/) | Dynamic object containing field data |
...
| `pos` | [Position](/api-docs/clay-native/loreline/Position/) | | Position in source where this field appears  |
| `name` | [String](/api-docs/clay-native/String/) | | Name of the field  |
| `value` | [NExpr](/api-docs/clay-native/loreline/NExpr/) | | Value expression for the field  |
| `leadingComments` | [Array](/api-docs/clay-native/Array/)<[Comment](/api-docs/clay-native/loreline/Comment/)> | *(optional)* | Optional comments before the field  |
| `trailingComments` | [Array](/api-docs/clay-native/Array/)<[Comment](/api-docs/clay-native/loreline/Comment/)> | *(optional)* | Optional comments after the field |
