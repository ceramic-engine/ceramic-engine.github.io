...
title: Comment
target: Clay (Native)
permalink: api-docs/clay-native/loreline/Comment/
---
...
<div class="type-hierarchy"><a href="/api-docs/clay-native/loreline/Node/">Node</a> → <strong>loreline.Comment</strong> (Class)</div>
...
| Returns | Description |
|---------|-------------|
| [Dynamic](/api-docs/clay-native/Dynamic/) | Dynamic object containing comment data |
...
| `pos` | [Position](/api-docs/clay-native/loreline/Position/) | Position in source where this comment appears  |
| `content` | [String](/api-docs/clay-native/String/) | The text content of the comment  |
| `multiline` | [Bool](/api-docs/clay-native/Bool/) | Whether this is a multiline comment |
