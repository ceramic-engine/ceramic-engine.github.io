...
target: Clay (Native)
permalink: api-docs/clay-native/loreline/NChoiceStatement/
---
...
<div class="type-hierarchy"><a href="/api-docs/clay-native/loreline/Node/">Node</a> → <a href="/api-docs/clay-native/loreline/AstNode/">AstNode</a> → <strong>loreline.NChoiceStatement</strong> (Class)</div>
...
| Returns | Description |
|---------|-------------|
| [Dynamic](/api-docs/clay-native/Dynamic/) | Dynamic object containing choice data |
...
| `pos` | [Position](/api-docs/clay-native/loreline/Position/) | | Position in source where this choice appears  |
| `options` | [Array](/api-docs/clay-native/Array/)<[NChoiceOption](/api-docs/clay-native/loreline/NChoiceOption/)> | | Array of available choice options  |
| `leadingComments` | [Array](/api-docs/clay-native/Array/)<[Comment](/api-docs/clay-native/loreline/Comment/)> | *(optional)* | Optional comments before the choice  |
| `trailingComments` | [Array](/api-docs/clay-native/Array/)<[Comment](/api-docs/clay-native/loreline/Comment/)> | *(optional)* | Optional comments after the choice |
