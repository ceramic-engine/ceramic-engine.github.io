...
title: RuntimeError
target: Clay (Native)
permalink: api-docs/clay-native/loreline/RuntimeError/
---
...
<div class="type-hierarchy"><a href="/api-docs/clay-native/loreline/Error/">Error</a> → <strong>loreline.RuntimeError</strong> (Class)</div>
...
| `pos` | [Position](/api-docs/clay-native/loreline/Position/) | *(optional)* |
