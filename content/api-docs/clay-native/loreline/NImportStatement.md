...
subCategory: doc
menu: Loreline
title: NImportStatement
target: Clay (Native)
permalink: api-docs/clay-native/loreline/NImportStatement/
---
...
<div class="type-hierarchy"><a href="/api-docs/clay-native/loreline/Node/">Node</a> → <a href="/api-docs/clay-native/loreline/AstNode/">AstNode</a> → <strong>loreline.NImportStatement</strong> (Class)</div>

Represents an import statement

## Instance Members

<div class="signature field-var has-description" id="path"><code><span class="field-name">path</span><span class="operator">:</span> <a href="/api-docs/clay-native/loreline/NStringLiteral/" class="type-link">NStringLiteral</a></code><a class="header-anchor" href="#path"><span aria-hidden="true" class="header-anchor__symbol">#</span></a></div>
...
| `pos` | [Position](/api-docs/clay-native/loreline/Position/) | | Position in source where this import appears  |
| `path` | [NStringLiteral](/api-docs/clay-native/loreline/NStringLiteral/) | | The relative path of the file to import  |
| `script` | [Script](/api-docs/clay-native/loreline/Script/) | | The imported AST  |
| `leadingComments` | [Array](/api-docs/clay-native/Array/)<[Comment](/api-docs/clay-native/loreline/Comment/)> | *(optional)* | Optional comments before  |
