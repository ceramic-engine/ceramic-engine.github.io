...
title: Log
target: Unity
permalink: api-docs/unity/haxe/Log/
---
...
| `infos` | [PosInfos](/api-docs/unity/haxe/PosInfos/) |
...
|------|------|---------|
| `v` | [Dynamic](/api-docs/unity/Dynamic/) | |
| `infos` | [PosInfos](/api-docs/unity/haxe/PosInfos/) | *(optional)* |
