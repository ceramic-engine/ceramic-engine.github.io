...
target: Unity
permalink: api-docs/unity/haxe/iterators/ArrayKeyValueIterator/
---
...
| Name | Type |
|------|------|
| `array` | [Array](/api-docs/unity/Array/)<haxe.iterators.ArrayKeyValueIterator.T> |

## Private Members

<div class="signature field-var no-description" id="current"><code><span class="field-name">current</span><span class="operator">:</span> <a href="/api-docs/unity/Int/" class="type-link">Int</a></code><a class="header-anchor" href="#current"><span aria-hidden="true" class="header-anchor__symbol">#</span></a></div>
