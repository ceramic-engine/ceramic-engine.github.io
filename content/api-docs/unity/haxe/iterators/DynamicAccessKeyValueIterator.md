...
target: Unity
permalink: api-docs/unity/haxe/iterators/DynamicAccessKeyValueIterator/
---
...
| Name | Type |
|------|------|
| `access` | [haxe.DynamicAccess](/api-docs/unity/haxe/DynamicAccess/)<haxe.iterators.DynamicAccessKeyValueIterator.T> |
