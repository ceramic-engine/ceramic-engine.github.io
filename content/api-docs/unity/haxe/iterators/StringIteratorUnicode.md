...
target: Unity
permalink: api-docs/unity/haxe/iterators/StringIteratorUnicode/
---
...
| Returns |
|---------|
| [StringIteratorUnicode](/api-docs/unity/haxe/iterators/StringIteratorUnicode/) |
...
<div class="signature field-var no-description" id="s"><code><span class="field-name">s</span><span class="operator">:</span> <a href="/api-docs/unity/String/" class="type-link">String</a></code><a class="header-anchor" href="#s"><span aria-hidden="true" class="header-anchor__symbol">#</span></a></div>
