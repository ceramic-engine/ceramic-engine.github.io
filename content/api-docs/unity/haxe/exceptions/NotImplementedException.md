...
target: Unity
permalink: api-docs/unity/haxe/exceptions/NotImplementedException/
---

# NotImplementedException

<div class="type-hierarchy"><a href="/api-docs/unity/haxe/_Exception/NativeException/">haxe._Exception.NativeException</a> → <a href="/api-docs/unity/haxe/Exception/">haxe.Exception</a> → <a href="/api-docs/unity/haxe/exceptions/PosException/">PosException</a> → <strong>haxe.exceptions.NotImplementedException</strong> (Class)</div>
...
| Name | Type | Default |
|------|------|---------|
| `message` | [String](/api-docs/unity/String/) | `"Not implemented"` |
