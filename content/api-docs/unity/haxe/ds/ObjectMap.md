...
title: ObjectMap
target: Unity
permalink: api-docs/unity/haxe/ds/ObjectMap/
---
...
| Returns |
|---------|
| [Null](/api-docs/unity/Null/)<haxe.ds.ObjectMap.V> |
...
<div class="signature field-var no-description" id="cachedKey"><code><span class="field-name">cachedKey</span><span class="operator">:</span> <span class="type-name">haxe.ds.ObjectMap.K</span></code><a class="header-anchor" href="#cachedKey"><span aria-hidden="true" class="header-anchor__symbol">#</span></a></div>
...
<div class="signature field-method no-description" id="hash"><code><span class="field-name">hash</span><span class="parenthesis">(</span><span class="arg-name">s</span><span class="operator">:</span> <span class="type-name">hash.K</span><span class="parenthesis">)</span><span class="operator">:</span> <a href="/api-docs/unity/haxe/ds/_ObjectMap/HashType/" class="type-link">haxe.ds._ObjectMap.HashType</a></code><a class="header-anchor" href="#hash"><span aria-hidden="true" class="header-anchor__symbol">#</span></a></div>
...
| Returns |
|---------|
| [haxe.ds._ObjectMap.HashType](/api-docs/unity/haxe/ds/_ObjectMap/HashType/) |
