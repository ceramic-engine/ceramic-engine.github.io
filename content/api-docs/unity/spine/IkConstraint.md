...
title: IkConstraint
target: Unity
permalink: api-docs/unity/spine/IkConstraint/
---
...
| `child` | [Bone](/api-docs/unity/spine/Bone/) | A direct descendant of the parent bone. |
| `targetX` | [Float](/api-docs/unity/Float/) |  |
| `targetY` | [Float](/api-docs/unity/Float/) |  |
| `bendDir` | [Int](/api-docs/unity/Int/) |  |
| `stretch` | [Bool](/api-docs/unity/Bool/) |  |
| `uniform` | [Bool](/api-docs/unity/Bool/) |  |
...
| Name | Type |
|------|------|
| `data` | [IkConstraintData](/api-docs/unity/spine/IkConstraintData/) |
