...
title: CurveTimeline
target: Unity
permalink: api-docs/unity/spine/CurveTimeline/
---
...
|------|------|-------------|
| `frame` | [Int](/api-docs/unity/Int/) | Between 0 and <code>frameCount - 1</code>, inclusive. |

<hr class="field-separator" />

<div class="signature field-method has-description has-plugin" id="setStepped"><div class="plugin-name">spine</div><code><span class="field-name">setStepped</span><span class="parenthesis">(</span><span class="arg-name">frame</span><span class="operator">:</span> <a href="/api-docs/unity/Int/" class="type-link">Int</a><span class="parenthesis">)</span><span class="operator">:</span> <a href="/api-docs/unity/Void/" class="type-link">Void</a></code><a class="header-anchor" href="#setStepped"><span aria-hidden="true" class="header-anchor__symbol">#</span></a></div>
...
| Name | Type | Description |
|------|------|-------------|
| `bezier` | [Int](/api-docs/unity/Int/) | The ordinal of this Bezier curve for this timeline, between 0 and <code>bezierCount - 1</code> (specified in the constructor), inclusive.  |
| `frame` | [Int](/api-docs/unity/Int/) | Between 0 and <code>frameCount - 1</code>, inclusive.  |
| `value` | [Int](/api-docs/unity/Int/) | The index of the value for the frame this curve is used for.  |
| `time1` | [Float](/api-docs/unity/Float/) | The time for the first key.  |
| `value1` | [Float](/api-docs/unity/Float/) | The value for the first key.  |
| `cx1` | [Float](/api-docs/unity/Float/) | The time for the first Bezier handle.  |
| `cy1` | [Float](/api-docs/unity/Float/) | The value for the first Bezier handle.  |
| `cx2` | [Float](/api-docs/unity/Float/) | The time of the second Bezier handle.  |
| `cy2` | [Float](/api-docs/unity/Float/) | The value for the second Bezier handle.  |
| `time2` | [Float](/api-docs/unity/Float/) | The time for the second key.  |
| `value2` | [Float](/api-docs/unity/Float/) | The value for the second key. |

<hr class="field-separator" />

<div class="signature field-method has-description has-plugin" id="getBezierValue"><div class="plugin-name">spine</div><code><span class="field-name">getBezierValue</span><span class="parenthesis">(</span><span class="arg-name">time</span><span class="operator">:</span> <a href="/api-docs/unity/Float/" class="type-link">Float</a><span class="operator">,</span> <span class="arg-name">frameIndex</span><span class="operator">:</span> <a href="/api-docs/unity/Int/" class="type-link">Int</a><span class="operator">,</span> <span class="arg-name">valueOffset</span><span class="operator">:</span> <a href="/api-docs/unity/Int/" class="type-link">Int</a><span class="operator">,</span> <span class="arg-name">i</span><span class="operator">:</span> <a href="/api-docs/unity/Int/" class="type-link">Int</a><span class="parenthesis">)</span><span class="operator">:</span> <a href="/api-docs/unity/Float/" class="type-link">Float</a></code><a class="header-anchor" href="#getBezierValue"><span aria-hidden="true" class="header-anchor__symbol">#</span></a></div>
...
| `frameIndex` | [Int](/api-docs/unity/Int/) | The index into { |
| `valueOffset` | [Int](/api-docs/unity/Int/) | The offset from <code>frameIndex</code> to the value this curve is used for.  |
| `i` | [Int](/api-docs/unity/Int/) | The index of the Bezier segments. See { |
...
| `bezierCount` | [Int](/api-docs/unity/Int/) | The maximum number of Bezier curves. See { |
