...
title: SkeletonJson
target: Unity
permalink: api-docs/unity/spine/SkeletonJson/
---
...
<div class="type-hierarchy"><a href="/api-docs/unity/spine/SkeletonLoader/">SkeletonLoader</a> → <strong>spine.SkeletonJson</strong> (Class)</div>
...
| `value2` | [Float](/api-docs/unity/Float/) |

## Instance Members

<div class="signature field-method no-description has-plugin" id="readSkeletonData"><div class="plugin-name">spine</div><code><span class="field-name">readSkeletonData</span><span class="parenthesis">(</span><span class="arg-name">root</span><span class="operator">:</span> <a href="/api-docs/unity/spine/support/utils/JsonValue/" class="type-link">spine.support.utils.JsonValue</a><span class="parenthesis">)</span><span class="operator">:</span> <a href="/api-docs/unity/spine/SkeletonData/" class="type-link">SkeletonData</a></code><a class="header-anchor" href="#readSkeletonData"><span aria-hidden="true" class="header-anchor__symbol">#</span></a></div>


| Name | Type |
|------|------|
| `root` | [spine.support.utils.JsonValue](/api-docs/unity/spine/support/utils/JsonValue/) |
...
<div class="signature field-method no-description has-plugin" id="readCurve"><div class="plugin-name">spine</div><code><span class="field-name">readCurve</span><span class="parenthesis">(</span><span class="arg-name">curve</span><span class="operator">:</span> <a href="/api-docs/unity/spine/support/utils/JsonValue/" class="type-link">spine.support.utils.JsonValue</a><span class="operator">,</span> <span class="arg-name">timeline</span><span class="operator">:</span> <a href="/api-docs/unity/spine/CurveTimeline/" class="type-link">CurveTimeline</a><span class="operator">,</span> <span class="arg-name">bezier</span><span class="operator">:</span> <a href="/api-docs/unity/Int/" class="type-link">Int</a><span class="operator">,</span> <span class="arg-name">frame</span><span class="operator">:</span> <a href="/api-docs/unity/Int/" class="type-link">Int</a><span class="operator">,</span> <span class="arg-name">value</span><span class="operator">:</span> <a href="/api-docs/unity/Int/" class="type-link">Int</a><span class="operator">,</span> <span class="arg-name">time1</span><span class="operator">:</span> <a href="/api-docs/unity/Float/" class="type-link">Float</a><span class="operator">,</span> <span class="arg-name">time2</span><span class="operator">:</span> <a href="/api-docs/unity/Float/" class="type-link">Float</a><span class="operator">,</span> <span class="arg-name">value1</span><span class="operator">:</span> <a href="/api-docs/unity/Float/" class="type-link">Float</a><span class="operator">,</span> <span class="arg-name">value2</span><span class="operator">:</span> <a href="/api-docs/unity/Float/" class="type-link">Float</a><span class="operator">,</span> <span class="arg-name">scale</span><span class="operator">:</span> <a href="/api-docs/unity/Float/" class="type-link">Float</a><span class="parenthesis">)</span><span class="operator">:</span> <a href="/api-docs/unity/Int/" class="type-link">Int</a></code><a class="header-anchor" href="#readCurve"><span aria-hidden="true" class="header-anchor__symbol">#</span></a></div>


| Name | Type |
|------|------|
| `curve` | [spine.support.utils.JsonValue](/api-docs/unity/spine/support/utils/JsonValue/) |
| `timeline` | [CurveTimeline](/api-docs/unity/spine/CurveTimeline/) |
| `bezier` | [Int](/api-docs/unity/Int/) |
| `frame` | [Int](/api-docs/unity/Int/) |
| `value` | [Int](/api-docs/unity/Int/) |
...
<div class="signature field-method no-description has-plugin" id="readTimeline"><div class="plugin-name">spine</div><code><span class="field-name">readTimeline</span><span class="parenthesis">(</span><span class="arg-name">keyMap</span><span class="operator">:</span> <a href="/api-docs/unity/spine/support/utils/JsonValue/" class="type-link">spine.support.utils.JsonValue</a><span class="operator">,</span> <span class="arg-name">timeline</span><span class="operator">:</span> <a href="/api-docs/unity/spine/CurveTimeline1/" class="type-link">CurveTimeline1</a><span class="operator">,</span> <span class="arg-name">defaultValue</span><span class="operator">:</span> <a href="/api-docs/unity/Float/" class="type-link">Float</a><span class="operator">,</span> <span class="arg-name">scale</span><span class="operator">:</span> <a href="/api-docs/unity/Float/" class="type-link">Float</a><span class="parenthesis">)</span><span class="operator">:</span> <a href="/api-docs/unity/spine/Timeline/" class="type-link">Timeline</a></code><a class="header-anchor" href="#readTimeline"><span aria-hidden="true" class="header-anchor__symbol">#</span></a></div>


| Name | Type |
|------|------|
| `keyMap` | [spine.support.utils.JsonValue](/api-docs/unity/spine/support/utils/JsonValue/) |
| `timeline` | [CurveTimeline1](/api-docs/unity/spine/CurveTimeline1/) |
| `defaultValue` | [Float](/api-docs/unity/Float/) |
| `scale` | [Float](/api-docs/unity/Float/) |

| Returns |
|---------|
| [Timeline](/api-docs/unity/spine/Timeline/) |

<hr class="field-separator" />

<div class="signature field-method no-description has-plugin" id="readTimeline2"><div class="plugin-name">spine</div><code><span class="field-name">readTimeline2</span><span class="parenthesis">(</span><span class="arg-name">keyMap</span><span class="operator">:</span> <a href="/api-docs/unity/spine/support/utils/JsonValue/" class="type-link">spine.support.utils.JsonValue</a><span class="operator">,</span> <span class="arg-name">timeline</span><span class="operator">:</span> <a href="/api-docs/unity/spine/CurveTimeline2/" class="type-link">CurveTimeline2</a><span class="operator">,</span> <span class="arg-name">name1</span><span class="operator">:</span> <a href="/api-docs/unity/String/" class="type-link">String</a><span class="operator">,</span> <span class="arg-name">name2</span><span class="operator">:</span> <a href="/api-docs/unity/String/" class="type-link">String</a><span class="operator">,</span> <span class="arg-name">defaultValue</span><span class="operator">:</span> <a href="/api-docs/unity/Float/" class="type-link">Float</a><span class="operator">,</span> <span class="arg-name">scale</span><span class="operator">:</span> <a href="/api-docs/unity/Float/" class="type-link">Float</a><span class="parenthesis">)</span><span class="operator">:</span> <a href="/api-docs/unity/spine/Timeline/" class="type-link">Timeline</a></code><a class="header-anchor" href="#readTimeline2"><span aria-hidden="true" class="header-anchor__symbol">#</span></a></div>


| Name | Type |
|------|------|
| `keyMap` | [spine.support.utils.JsonValue](/api-docs/unity/spine/support/utils/JsonValue/) |
| `timeline` | [CurveTimeline2](/api-docs/unity/spine/CurveTimeline2/) |
| `name1` | [String](/api-docs/unity/String/) |
| `name2` | [String](/api-docs/unity/String/) |
| `defaultValue` | [Float](/api-docs/unity/Float/) |
| `scale` | [Float](/api-docs/unity/Float/) |
