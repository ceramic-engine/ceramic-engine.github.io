...
target: Unity
permalink: api-docs/unity/spine/DrawOrderTimeline/
---
...
<div class="type-hierarchy"><a href="/api-docs/unity/spine/Timeline/">Timeline</a> → <strong>spine.DrawOrderTimeline</strong> (Class)</div>
...
<div class="signature field-method has-description has-plugin" id="getDrawOrders"><div class="plugin-name">spine</div><code><span class="field-name">getDrawOrders</span><span class="parenthesis">(</span><span class="parenthesis">)</span><span class="operator">:</span> <a href="/api-docs/unity/spine/support/utils/IntArray2D/" class="type-link">spine.support.utils.IntArray2D</a></code><a class="header-anchor" href="#getDrawOrders"><span aria-hidden="true" class="header-anchor__symbol">#</span></a></div>

The draw order for each frame. See {@link #setFrame(int, float, int[])}.
| Returns |
|---------|
| [spine.support.utils.IntArray2D](/api-docs/unity/spine/support/utils/IntArray2D/) |
...
| `drawOrder` | [spine.support.utils.IntArray](/api-docs/unity/spine/support/utils/IntArray/) | For each slot in { |
...
<div class="signature field-var no-description has-plugin" id="propertyIds"><div class="plugin-name">spine</div><code><span class="field-name">propertyIds</span><span class="operator">:</span> <a href="/api-docs/unity/spine/support/utils/StringArray/" class="type-link">spine.support.utils.StringArray</a></code><a class="header-anchor" href="#propertyIds"><span aria-hidden="true" class="header-anchor__symbol">#</span></a></div>

<hr class="field-separator" />

<div class="signature field-var no-description has-plugin" id="drawOrders"><div class="plugin-name">spine</div><code><span class="field-name">drawOrders</span><span class="operator">:</span> <a href="/api-docs/unity/spine/support/utils/IntArray2D/" class="type-link">spine.support.utils.IntArray2D</a></code><a class="header-anchor" href="#drawOrders"><span aria-hidden="true" class="header-anchor__symbol">#</span></a></div>
