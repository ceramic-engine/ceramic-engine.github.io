...
target: Unity
permalink: api-docs/unity/loreline/RuntimeInsertion/
---
...
<div class="signature field-var has-description" id="origin"><code><span class="field-name">origin</span><span class="operator">:</span> <a href="/api-docs/unity/loreline/NInsertion/" class="type-link">NInsertion</a></code><a class="header-anchor" href="#origin"><span aria-hidden="true" class="header-anchor__symbol">#</span></a></div>
...
| `origin` | [NInsertion](/api-docs/unity/loreline/NInsertion/) |
