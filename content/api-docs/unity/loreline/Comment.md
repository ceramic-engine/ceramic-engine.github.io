...
title: Comment
target: Unity
permalink: api-docs/unity/loreline/Comment/
---
...
<div class="type-hierarchy"><a href="/api-docs/unity/loreline/Node/">Node</a> → <strong>loreline.Comment</strong> (Class)</div>
...
| Returns | Description |
|---------|-------------|
| [Dynamic](/api-docs/unity/Dynamic/) | Dynamic object containing comment data |
...
| `pos` | [Position](/api-docs/unity/loreline/Position/) | Position in source where this comment appears  |
| `content` | [String](/api-docs/unity/String/) | The text content of the comment  |
| `multiline` | [Bool](/api-docs/unity/Bool/) | Whether this is a multiline comment |
