...
title: NBlock
target: Unity
permalink: api-docs/unity/loreline/NBlock/
---
...
<div class="type-hierarchy"><a href="/api-docs/unity/loreline/Node/">Node</a> → <a href="/api-docs/unity/loreline/AstNode/">AstNode</a> → <strong>loreline.NBlock</strong> (Class)</div>
...
| `body` | [Array](/api-docs/unity/Array/)<[AstNode](/api-docs/unity/loreline/AstNode/)> | | Array of nodes comprising the block's content  |
