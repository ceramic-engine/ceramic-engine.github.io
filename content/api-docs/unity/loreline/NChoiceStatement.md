...
target: Unity
permalink: api-docs/unity/loreline/NChoiceStatement/
---
...
<div class="type-hierarchy"><a href="/api-docs/unity/loreline/Node/">Node</a> → <a href="/api-docs/unity/loreline/AstNode/">AstNode</a> → <strong>loreline.NChoiceStatement</strong> (Class)</div>
...
| Returns | Description |
|---------|-------------|
| [Dynamic](/api-docs/unity/Dynamic/) | Dynamic object containing choice data |
...
| `pos` | [Position](/api-docs/unity/loreline/Position/) | | Position in source where this choice appears  |
| `options` | [Array](/api-docs/unity/Array/)<[NChoiceOption](/api-docs/unity/loreline/NChoiceOption/)> | | Array of available choice options  |
| `leadingComments` | [Array](/api-docs/unity/Array/)<[Comment](/api-docs/unity/loreline/Comment/)> | *(optional)* | Optional comments before the choice  |
| `trailingComments` | [Array](/api-docs/unity/Array/)<[Comment](/api-docs/unity/loreline/Comment/)> | *(optional)* | Optional comments after the choice |
