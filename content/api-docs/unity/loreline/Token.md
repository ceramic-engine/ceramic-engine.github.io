...
title: Token
target: Unity
permalink: api-docs/unity/loreline/Token/
---
...
| Returns | Description |
|---------|-------------|
| [String](/api-docs/unity/String/) | Formatted token information with position |
...
| `pos` | [Position](/api-docs/unity/loreline/Position/) | The token's position |
