...
title: RuntimeScope
target: Unity
permalink: api-docs/unity/loreline/RuntimeScope/
---
...
<div class="signature field-var has-description" id="beat"><code><span class="field-name">beat</span><span class="operator">:</span> <a href="/api-docs/unity/loreline/NBeatDecl/" class="type-link">NBeatDecl</a></code><a class="header-anchor" href="#beat"><span aria-hidden="true" class="header-anchor__symbol">#</span></a></div>
...
<div class="signature field-var has-description" id="node"><code><span class="field-name">node</span><span class="operator">:</span> <a href="/api-docs/unity/loreline/AstNode/" class="type-link">AstNode</a></code><a class="header-anchor" href="#node"><span aria-hidden="true" class="header-anchor__symbol">#</span></a></div>
...
<div class="signature field-var has-description" id="state"><code><span class="field-name">state</span><span class="operator">:</span> <a href="/api-docs/unity/loreline/RuntimeState/" class="type-link">RuntimeState</a></code><a class="header-anchor" href="#state"><span aria-hidden="true" class="header-anchor__symbol">#</span></a></div>

The temporary state associated with this scope, if any.

<hr class="field-separator" />

<div class="signature field-var has-description" id="head"><code><span class="field-name">head</span><span class="operator">:</span> <a href="/api-docs/unity/loreline/AstNode/" class="type-link">AstNode</a></code><a class="header-anchor" href="#head"><span aria-hidden="true" class="header-anchor__symbol">#</span></a></div>
...
|------|------|-------------|
| `name` | [String](/api-docs/unity/String/) | The name of the beat to find  |

| Returns | Description |
|---------|-------------|
| [Null](/api-docs/unity/Null/)<[NBeatDecl](/api-docs/unity/loreline/NBeatDecl/)> | The beat declaration if found, null otherwise |
...
| Name | Type | Description |
|------|------|-------------|
| `id` | [Null](/api-docs/unity/Null/)<[Int](/api-docs/unity/Int/)> | * The scope id, a unique integer value in the stack. |
| `beat` | [NBeatDecl](/api-docs/unity/loreline/NBeatDecl/) | * The parent beat where this scope is located. Can be either a top level beat or a nested beat. |
| `node` | [AstNode](/api-docs/unity/loreline/AstNode/) | * The node where this scope is attached. |
| `beats` | [Null](/api-docs/unity/Null/)<[Array](/api-docs/unity/Array/)<[NBeatDecl](/api-docs/unity/loreline/NBeatDecl/)>> | * The nested beat declarations, if any, found in this scope. |
| `state` | [Null](/api-docs/unity/Null/)<[RuntimeState](/api-docs/unity/loreline/RuntimeState/)> | * The temporary state associated with this scope, if any. |
| `head` | [Null](/api-docs/unity/Null/)<[AstNode](/api-docs/unity/loreline/AstNode/)> | * If applicable, the node this scope's "reading head" is at. This is used to track the current execution position within the scope. |
| `insertion` | [Null](/api-docs/unity/Null/)<[RuntimeInsertion](/api-docs/unity/loreline/RuntimeInsertion/)> | * If this scope was created from an insertion, this is the insertion runtime data. |
