...
title: NAccess
target: Unity
permalink: api-docs/unity/loreline/NAccess/
---
...
<div class="type-hierarchy"><a href="/api-docs/unity/loreline/Node/">Node</a> → <a href="/api-docs/unity/loreline/AstNode/">AstNode</a> → <a href="/api-docs/unity/loreline/NExpr/">NExpr</a> → <strong>loreline.NAccess</strong> (Class)</div>
...
| Returns | Description |
|---------|-------------|
| [Dynamic](/api-docs/unity/Dynamic/) | Dynamic object containing access data |
...
| `target` | [Null](/api-docs/unity/Null/)<[NExpr](/api-docs/unity/loreline/NExpr/)> | | Optional target object expression  |
| `name` | [String](/api-docs/unity/String/) | | Name of the accessed field  |
