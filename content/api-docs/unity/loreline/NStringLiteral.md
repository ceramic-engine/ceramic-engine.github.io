...
target: Unity
permalink: api-docs/unity/loreline/NStringLiteral/
---
...
<div class="type-hierarchy"><a href="/api-docs/unity/loreline/Node/">Node</a> → <a href="/api-docs/unity/loreline/AstNode/">AstNode</a> → <a href="/api-docs/unity/loreline/NExpr/">NExpr</a> → <strong>loreline.NStringLiteral</strong> (Class)</div>

Represents a string literal in the AST, supporting interpolation and tags.

## Instance Members

<div class="signature field-var has-description" id="parts"><code><span class="field-name">parts</span><span class="operator">:</span> <a href="/api-docs/unity/Array/" class="type-link">Array</a><span class="operator">&lt;</span><a href="/api-docs/unity/loreline/NStringPart/" class="type-link">NStringPart</a><span class="operator">&gt;</span></code><a class="header-anchor" href="#parts"><span aria-hidden="true" class="header-anchor__symbol">#</span></a></div>

Array of parts that make up this string literal.

<hr class="field-separator" />

<div class="signature field-var has-description" id="quotes"><code><span class="field-name">quotes</span><span class="operator">:</span> <a href="/api-docs/unity/loreline/Quotes/" class="type-link">Quotes</a></code><a class="header-anchor" href="#quotes"><span aria-hidden="true" class="header-anchor__symbol">#</span></a></div>
...
| Returns | Description |
|---------|-------------|
| [Dynamic](/api-docs/unity/Dynamic/) | Dynamic object containing string data and its parts |
...
| `pos` | [Position](/api-docs/unity/loreline/Position/) | | Position in source where this string appears  |
| `quotes` | [Quotes](/api-docs/unity/loreline/Quotes/) | |  |
| `parts` | [Array](/api-docs/unity/Array/)<[NStringPart](/api-docs/unity/loreline/NStringPart/)> | | Array of string parts (raw text, interpolations, and tags)  |
