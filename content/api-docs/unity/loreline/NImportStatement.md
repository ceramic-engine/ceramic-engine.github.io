...
target: Unity
permalink: api-docs/unity/loreline/NImportStatement/
---
...
<div class="type-hierarchy"><a href="/api-docs/unity/loreline/Node/">Node</a> → <a href="/api-docs/unity/loreline/AstNode/">AstNode</a> → <strong>loreline.NImportStatement</strong> (Class)</div>

Represents an import statement

## Instance Members

<div class="signature field-var has-description" id="path"><code><span class="field-name">path</span><span class="operator">:</span> <a href="/api-docs/unity/loreline/NStringLiteral/" class="type-link">NStringLiteral</a></code><a class="header-anchor" href="#path"><span aria-hidden="true" class="header-anchor__symbol">#</span></a></div>
...
| `pos` | [Position](/api-docs/unity/loreline/Position/) | | Position in source where this import appears  |
| `path` | [NStringLiteral](/api-docs/unity/loreline/NStringLiteral/) | | The relative path of the file to import  |
| `script` | [Script](/api-docs/unity/loreline/Script/) | | The imported AST  |
