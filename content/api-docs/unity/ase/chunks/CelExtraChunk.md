...
title: CelExtraChunk
target: Unity
permalink: api-docs/unity/ase/chunks/CelExtraChunk/
---
...
<div class="type-hierarchy"><a href="/api-docs/unity/ase/chunks/Chunk/">Chunk</a> → <strong>ase.chunks.CelExtraChunk</strong> (Class)</div>
...
| Returns |
|---------|
| [CelExtraChunk](/api-docs/unity/ase/chunks/CelExtraChunk/) |
...
<div class="signature field-var no-description" id="preciseXPosition"><code><span class="field-name">preciseXPosition</span><span class="operator">:</span> <a href="/api-docs/unity/Float/" class="type-link">Float</a></code><a class="header-anchor" href="#preciseXPosition"><span aria-hidden="true" class="header-anchor__symbol">#</span></a></div>

<hr class="field-separator" />

<div class="signature field-var no-description" id="preciseYPosition"><code><span class="field-name">preciseYPosition</span><span class="operator">:</span> <a href="/api-docs/unity/Float/" class="type-link">Float</a></code><a class="header-anchor" href="#preciseYPosition"><span aria-hidden="true" class="header-anchor__symbol">#</span></a></div>

<hr class="field-separator" />

<div class="signature field-var no-description" id="widthInSprite"><code><span class="field-name">widthInSprite</span><span class="operator">:</span> <a href="/api-docs/unity/Float/" class="type-link">Float</a></code><a class="header-anchor" href="#widthInSprite"><span aria-hidden="true" class="header-anchor__symbol">#</span></a></div>

<hr class="field-separator" />

<div class="signature field-var no-description" id="heightInSprite"><code><span class="field-name">heightInSprite</span><span class="operator">:</span> <a href="/api-docs/unity/Float/" class="type-link">Float</a></code><a class="header-anchor" href="#heightInSprite"><span aria-hidden="true" class="header-anchor__symbol">#</span></a></div>
