...
title: Interp
target: Unity
permalink: api-docs/unity/hscript/Interp/
---
...
<div class="type-hierarchy"><strong>hscript.Interp</strong> (Class) → <a href="/api-docs/unity/ceramic/Interp/">ceramic.Interp</a></div>
...
<div class="signature field-var no-description" id="curExpr"><code><span class="field-name">curExpr</span><span class="operator">:</span> <a href="/api-docs/unity/hscript/Expr/" class="type-link">Expr</a></code><a class="header-anchor" href="#curExpr"><span aria-hidden="true" class="header-anchor__symbol">#</span></a></div>
...
| `e2` | [Expr](/api-docs/unity/hscript/Expr/) |
...
| Name | Type |
|------|------|
| `econd` | [Expr](/api-docs/unity/hscript/Expr/) |
| `e` | [Expr](/api-docs/unity/hscript/Expr/) |
