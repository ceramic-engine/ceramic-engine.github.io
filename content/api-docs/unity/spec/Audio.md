...
title: Audio
target: Unity
permalink: api-docs/unity/spec/Audio/
---
...
<div class="type-hierarchy"><strong>spec.Audio</strong> (Interface) → <a href="/api-docs/unity/backend/Audio/">backend.Audio</a></div>
...
|------|------|-------------|
| `buffer` | [backend.Float32Array](/api-docs/unity/backend/Float32Array/) | The raw audio sample data as 32-bit floats (-1.0 to 1.0 range)  |
| `samples` | [Int](/api-docs/unity/Int/) | The total number of samples in the buffer  |
| `channels` | [Int](/api-docs/unity/Int/) | The number of audio channels (1 for mono, 2 for stereo)  |
| `sampleRate` | [Float](/api-docs/unity/Float/) | The sample rate in Hz (e.g., 44100, 48000)  |
| `interleaved` | [Bool](/api-docs/unity/Bool/) | Whether samples are interleaved (L,R,L,R) or planar (L,L,L...,R,R,R)  |

| Returns | Description |
|---------|-------------|
| [backend.AudioResource](/api-docs/unity/backend/AudioResource/) | A new AudioResource containing the audio data |
...
| Name | Type | Description |
|------|------|-------------|
| `audio` | [backend.AudioResource](/api-docs/unity/backend/AudioResource/) | The audio resource to query  |

| Returns | Description |
|---------|-------------|
| [Float](/api-docs/unity/Float/) | The duration in seconds, or -1 if unknown (e.g., for streams) |
...
| Name | Type | Description |
|------|------|-------------|
| `audio` | [backend.AudioResource](/api-docs/unity/backend/AudioResource/) | The audio resource to destroy |
...
| Name | Type | Default | Description |
|------|------|---------|-------------|
| `audio` | [backend.AudioResource](/api-docs/unity/backend/AudioResource/) | | The audio resource to play  |
| `volume` | [Float](/api-docs/unity/Float/) | `0.5` | The playback volume (0.0 to 1.0, default 0.5)  |
| `pan` | [Float](/api-docs/unity/Float/) | `0` | The stereo panning (-1.0 for left, 0.0 for center, 1.0 for right)  |
| `pitch` | [Float](/api-docs/unity/Float/) | `1` | The playback pitch/speed multiplier (1.0 is normal speed)  |
| `position` | [Float](/api-docs/unity/Float/) | `0` | The starting position in seconds  |
| `loop` | [Bool](/api-docs/unity/Bool/) | `false` | Whether to loop playback when reaching the end  |
| `bus` | [Int](/api-docs/unity/Int/) | `0` | The audio bus to route this sound through (0-7)  |

| Returns | Description |
|---------|-------------|
| [backend.AudioHandle](/api-docs/unity/backend/AudioHandle/) | An AudioHandle for controlling the playing sound |
...
| Name | Type | Description |
|------|------|-------------|
| `handle` | [backend.AudioHandle](/api-docs/unity/backend/AudioHandle/) | The audio handle to pause |
...
| Name | Type | Description |
|------|------|-------------|
| `handle` | [backend.AudioHandle](/api-docs/unity/backend/AudioHandle/) | The audio handle to resume |
...
| Name | Type | Description |
|------|------|-------------|
| `handle` | [backend.AudioHandle](/api-docs/unity/backend/AudioHandle/) | The audio handle to stop |
...
| Name | Type | Description |
|------|------|-------------|
| `handle` | [backend.AudioHandle](/api-docs/unity/backend/AudioHandle/) | The audio handle to query  |

| Returns | Description |
|---------|-------------|
| [Float](/api-docs/unity/Float/) | The current volume (0.0 to 1.0) |
...
| Name | Type | Description |
|------|------|-------------|
| `handle` | [backend.AudioHandle](/api-docs/unity/backend/AudioHandle/) | The audio handle to modify  |
| `volume` | [Float](/api-docs/unity/Float/) | The new volume (0.0 to 1.0) |
...
| Returns | Description |
|---------|-------------|
| [Float](/api-docs/unity/Float/) | The current pan value (-1.0 for left, 0.0 for center, 1.0 for right) |
...
|------|------|-------------|
| `handle` | [backend.AudioHandle](/api-docs/unity/backend/AudioHandle/) | The audio handle to modify  |
| `pan` | [Float](/api-docs/unity/Float/) | The new pan value (-1.0 for left, 0.0 for center, 1.0 for right) |
...
| Returns | Description |
|---------|-------------|
| [Float](/api-docs/unity/Float/) | The current pitch multiplier (1.0 is normal speed) |
...
|------|------|-------------|
| `handle` | [backend.AudioHandle](/api-docs/unity/backend/AudioHandle/) | The audio handle to modify  |
| `pitch` | [Float](/api-docs/unity/Float/) | The new pitch multiplier (0.5 = half speed/octave down, 2.0 = double speed/octave up) |
...
| Returns | Description |
|---------|-------------|
| [Float](/api-docs/unity/Float/) | The current position in seconds |
...
|------|------|-------------|
| `handle` | [backend.AudioHandle](/api-docs/unity/backend/AudioHandle/) | The audio handle to modify  |
| `position` | [Float](/api-docs/unity/Float/) | The new position in seconds |
...
| Name | Type | Description |
|------|------|-------------|
| `bus` | [Int](/api-docs/unity/Int/) | The audio bus number (0-7) to add the filter to  |
| `filter` | [ceramic.AudioFilter](/api-docs/unity/ceramic/AudioFilter/) | The AudioFilter instance to add (e.g., LowPassFilter, HighPassFilter)  |
...
| Name | Type | Description |
|------|------|-------------|
| `bus` | [Int](/api-docs/unity/Int/) | The audio bus number (0-7) to remove the filter from  |
| `filterId` | [Int](/api-docs/unity/Int/) | The ID of the filter to remove (from AudioFilter.id) |
...
| Name | Type | Description |
|------|------|-------------|
| `bus` | [Int](/api-docs/unity/Int/) | The audio bus number (0-7) containing the filter  |
| `filterId` | [Int](/api-docs/unity/Int/) | The ID of the filter whose parameters changed |
