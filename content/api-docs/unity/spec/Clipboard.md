...
title: Clipboard
target: Unity
permalink: api-docs/unity/spec/Clipboard/
---
...
<div class="type-hierarchy"><strong>spec.Clipboard</strong> (Interface) → <a href="/api-docs/unity/backend/Clipboard/">backend.Clipboard</a></div>
...
<div class="signature field-method has-description" id="getText"><code><span class="field-name">getText</span><span class="parenthesis">(</span><span class="parenthesis">)</span><span class="operator">:</span> <a href="/api-docs/unity/String/" class="type-link">String</a></code><a class="header-anchor" href="#getText"><span aria-hidden="true" class="header-anchor__symbol">#</span></a></div>

Gets the current text content from the system clipboard.

| Returns | Description |
|---------|-------------|
| [String](/api-docs/unity/String/) | The clipboard text content, or an empty string if the clipboard is empty or doesn't contain text data |

<hr class="field-separator" />

<div class="signature field-method has-description" id="setText"><code><span class="field-name">setText</span><span class="parenthesis">(</span><span class="arg-name">text</span><span class="operator">:</span> <a href="/api-docs/unity/String/" class="type-link">String</a><span class="parenthesis">)</span><span class="operator">:</span> <a href="/api-docs/unity/Void/" class="type-link">Void</a></code><a class="header-anchor" href="#setText"><span aria-hidden="true" class="header-anchor__symbol">#</span></a></div>
...
|------|------|-------------|
| `text` | [String](/api-docs/unity/String/) | The text to copy to the clipboard |
