...
title: Textures
target: Unity
permalink: api-docs/unity/spec/Textures/
---
...
<div class="type-hierarchy"><strong>spec.Textures</strong> (Interface) → <a href="/api-docs/unity/backend/Textures/">backend.Textures</a></div>
...
|------|------|---------|-------------|
| `path` | [String](/api-docs/unity/String/) | | The path to the image file (relative to assets)  |
| `options` | [Null](/api-docs/unity/Null/)<[backend.LoadTextureOptions](/api-docs/unity/backend/LoadTextureOptions/)> | *(optional)* | Optional loading configuration (filtering, density, etc.)  |
...
| Name | Type | Default | Description |
|------|------|---------|-------------|
| `bytes` | [haxe.io.Bytes](/api-docs/unity/haxe/io/Bytes/) | | The raw image file data  |
| `type` | [ceramic.ImageType](/api-docs/unity/ceramic/ImageType/) | | The image format (PNG, JPEG, etc.)  |
| `options` | [Null](/api-docs/unity/Null/)<[backend.LoadTextureOptions](/api-docs/unity/backend/LoadTextureOptions/)> | *(optional)* | Optional loading configuration  |
...
|------|------|-------------|
| `width` | [Int](/api-docs/unity/Int/) | The texture width in pixels  |
| `height` | [Int](/api-docs/unity/Int/) | The texture height in pixels  |
| `pixels` | [ceramic.UInt8Array](/api-docs/unity/ceramic/UInt8Array/) | The raw RGBA pixel data (width * height * 4 bytes)  |

| Returns | Description |
|---------|-------------|
| [backend.Texture](/api-docs/unity/backend/Texture/) | The created texture |
...
| Name | Type | Description |
|------|------|-------------|
| `texture` | [backend.Texture](/api-docs/unity/backend/Texture/) | The texture to destroy |

<hr class="field-separator" />

<div class="signature field-method has-description" id="getTextureId"><code><span class="field-name">getTextureId</span><span class="parenthesis">(</span><span class="arg-name">texture</span><span class="operator">:</span> <a href="/api-docs/unity/backend/Texture/" class="type-link">backend.Texture</a><span class="parenthesis">)</span><span class="operator">:</span> <a href="/api-docs/unity/backend/TextureId/" class="type-link">backend.TextureId</a></code><a class="header-anchor" href="#getTextureId"><span aria-hidden="true" class="header-anchor__symbol">#</span></a></div>
...
| Name | Type | Description |
|------|------|-------------|
| `texture` | [backend.Texture](/api-docs/unity/backend/Texture/) | The texture to query  |

| Returns | Description |
|---------|-------------|
| [backend.TextureId](/api-docs/unity/backend/TextureId/) | The texture's unique identifier |
...
| Returns | Description |
|---------|-------------|
| [Int](/api-docs/unity/Int/) | The logical width in pixels |
...
| Returns | Description |
|---------|-------------|
| [Int](/api-docs/unity/Int/) | The logical height in pixels |
...
| Returns | Description |
|---------|-------------|
| [Int](/api-docs/unity/Int/) | The actual GPU texture width in pixels |
...
| Returns | Description |
|---------|-------------|
| [Int](/api-docs/unity/Int/) | The actual GPU texture height in pixels |
...
| Name | Type | Default | Description |
|------|------|---------|-------------|
| `texture` | [backend.Texture](/api-docs/unity/backend/Texture/) | | The texture to read from  |
| `result` | [Null](/api-docs/unity/Null/)<[ceramic.UInt8Array](/api-docs/unity/ceramic/UInt8Array/)> | *(optional)* | Optional array to store results (must be width*height*4 bytes)  |

| Returns | Description |
|---------|-------------|
| [ceramic.UInt8Array](/api-docs/unity/ceramic/UInt8Array/) | Array containing RGBA pixel data |
...
| Name | Type | Description |
|------|------|-------------|
| `texture` | [backend.Texture](/api-docs/unity/backend/Texture/) | The texture to update  |
| `pixels` | [ceramic.UInt8Array](/api-docs/unity/ceramic/UInt8Array/) | The new RGBA pixel data |
...
| Name | Type | Description |
|------|------|-------------|
| `texture` | [backend.Texture](/api-docs/unity/backend/Texture/) | The texture to configure  |
...
|------|------|-------------|
| `texture` | [backend.Texture](/api-docs/unity/backend/Texture/) | The texture to configure  |
| `wrap` | [ceramic.TextureWrap](/api-docs/unity/ceramic/TextureWrap/) | The wrapping mode for the S (horizontal) axis |
...
| Name | Type | Description |
|------|------|-------------|
| `width` | [Int](/api-docs/unity/Int/) | The render target width in pixels  |
| `height` | [Int](/api-docs/unity/Int/) | The render target height in pixels  |
| `depth` | [Bool](/api-docs/unity/Bool/) | Whether to include a depth buffer  |
| `stencil` | [Bool](/api-docs/unity/Bool/) | Whether to include a stencil buffer  |
| `antialiasing` | [Int](/api-docs/unity/Int/) | MSAA sample count (0 or 1 for no antialiasing)  |

| Returns | Description |
|---------|-------------|
| [backend.Texture](/api-docs/unity/backend/Texture/) | The created render target texture |
...
| Returns | Description |
|---------|-------------|
| [Int](/api-docs/unity/Int/) | Maximum textures per batch (1 if multi-texturing is not supported) |
...
| Returns | Description |
|---------|-------------|
| [Int](/api-docs/unity/Int/) | The texture's slot index for the current batch |
...
| Name | Type | Default | Description |
|------|------|---------|-------------|
| `texture` | [backend.Texture](/api-docs/unity/backend/Texture/) | | The texture to export  |
| `reversePremultiplyAlpha` | [Bool](/api-docs/unity/Bool/) | `true` | Whether to reverse premultiplied alpha (usually true)  |
| `path` | [String](/api-docs/unity/String/) | *(optional)* | Optional file path to save the PNG  |
...
| Name | Type | Default | Description |
|------|------|---------|-------------|
| `width` | [Int](/api-docs/unity/Int/) | | Image width in pixels  |
| `height` | [Int](/api-docs/unity/Int/) | | Image height in pixels  |
| `pixels` | [ceramic.UInt8Array](/api-docs/unity/ceramic/UInt8Array/) | | RGBA pixel data (width * height * 4 bytes)  |
| `path` | [String](/api-docs/unity/String/) | *(optional)* | Optional file path to save the PNG  |
| `done` | Function | | Callback with PNG data bytes (null on error) |
