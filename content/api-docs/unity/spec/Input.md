...
title: Input
target: Unity
permalink: api-docs/unity/spec/Input/
---
...
<div class="type-hierarchy"><strong>spec.Input</strong> (Interface) → <a href="/api-docs/unity/backend/Input/">backend.Input</a></div>
