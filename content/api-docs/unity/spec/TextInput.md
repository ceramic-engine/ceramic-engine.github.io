...
title: TextInput
target: Unity
permalink: api-docs/unity/spec/TextInput/
---
...
<div class="type-hierarchy"><strong>spec.TextInput</strong> (Interface) → <a href="/api-docs/unity/backend/TextInput/">backend.TextInput</a></div>
...
|------|------|-------------|
| `initialText` | [String](/api-docs/unity/String/) | The initial text to display in the input field  |
| `x` | [Float](/api-docs/unity/Float/) | The X position of the input field in screen coordinates  |
| `y` | [Float](/api-docs/unity/Float/) | The Y position of the input field in screen coordinates  |
| `w` | [Float](/api-docs/unity/Float/) | The width of the input field  |
| `h` | [Float](/api-docs/unity/Float/) | The height of the input field |
