...
title: Texts
target: Unity
permalink: api-docs/unity/spec/Texts/
---
...
<div class="type-hierarchy"><strong>spec.Texts</strong> (Interface) → <a href="/api-docs/unity/backend/Texts/">backend.Texts</a></div>
...
|------|------|---------|-------------|
| `path` | [String](/api-docs/unity/String/) | | The path to the text file to load  |
| `options` | [Null](/api-docs/unity/Null/)<[backend.LoadTextOptions](/api-docs/unity/backend/LoadTextOptions/)> | *(optional)* | Optional loading configuration (caching, hot-reload, etc.)  |
