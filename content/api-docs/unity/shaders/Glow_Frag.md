...
title: Glow_Frag
target: Unity
permalink: api-docs/unity/shaders/Glow_Frag/
---
...
<div class="type-hierarchy"><a href="/api-docs/unity/shade/Shade/">shade.Shade</a> → <a href="/api-docs/unity/shade/Frag/">shade.Frag</a> → <strong>shaders.Glow_Frag</strong> (Class)</div>
...
<div class="signature field-var no-description has-plugin" id="glowIntensity"><div class="plugin-name">shade</div><code><span class="field-name">glowIntensity</span><span class="operator">:</span> <a href="/api-docs/unity/Float/" class="type-link">Float</a></code><a class="header-anchor" href="#glowIntensity"><span aria-hidden="true" class="header-anchor__symbol">#</span></a></div>

<hr class="field-separator" />

<div class="signature field-var no-description has-plugin" id="glowThreshold"><div class="plugin-name">shade</div><code><span class="field-name">glowThreshold</span><span class="operator">:</span> <a href="/api-docs/unity/Float/" class="type-link">Float</a></code><a class="header-anchor" href="#glowThreshold"><span aria-hidden="true" class="header-anchor__symbol">#</span></a></div>
