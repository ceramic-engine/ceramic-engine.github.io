...
title: Msdf_Frag
target: Unity
permalink: api-docs/unity/shaders/Msdf_Frag/
---
...
<div class="type-hierarchy"><a href="/api-docs/unity/shade/Shade/">shade.Shade</a> → <a href="/api-docs/unity/shade/Frag/">shade.Frag</a> → <strong>shaders.Msdf_Frag</strong> (Class)</div>
...
<div class="signature field-var no-description has-plugin" id="texSize"><div class="plugin-name">shade</div><code><span class="field-name">texSize</span><span class="operator">:</span> <a href="/api-docs/unity/shade/Vec2/" class="type-link">shade.Vec2</a></code><a class="header-anchor" href="#texSize"><span aria-hidden="true" class="header-anchor__symbol">#</span></a></div>

<hr class="field-separator" />

<div class="signature field-var no-description has-plugin" id="pxRange"><div class="plugin-name">shade</div><code><span class="field-name">pxRange</span><span class="operator">:</span> <a href="/api-docs/unity/Float/" class="type-link">Float</a></code><a class="header-anchor" href="#pxRange"><span aria-hidden="true" class="header-anchor__symbol">#</span></a></div>
