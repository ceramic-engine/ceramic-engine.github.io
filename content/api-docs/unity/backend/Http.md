...
title: Http
target: Unity
permalink: api-docs/unity/backend/Http/
---
...
<div class="type-implements"><strong>Implements:</strong> <a href="/api-docs/unity/spec/Http/">spec.Http</a></div>
...
|------|------|-------------|
| `options` | [HttpRequestOptions](/api-docs/unity/backend/HttpRequestOptions/) | The HTTP request configuration  |
...
| Name | Type | Description |
|------|------|-------------|
| `url` | [String](/api-docs/unity/String/) | The URL of the file to download  |
| `targetPath` | [String](/api-docs/unity/String/) | The local file path where the file should be saved (can be relative)  |
