...
<div class="signature field-var no-description" id="date"><code><span class="field-name">date</span><span class="operator">:</span> <a href="/api-docs/unity/cs/system/DateTime/" class="type-link">cs.system.DateTime</a></code><a class="header-anchor" href="#date"><span aria-hidden="true" class="header-anchor__symbol">#</span></a></div>

<hr class="field-separator" />

<div class="signature field-var no-description" id="dateUTC"><code><span class="field-name">dateUTC</span><span class="operator">:</span> <a href="/api-docs/unity/cs/system/DateTime/" class="type-link">cs.system.DateTime</a></code><a class="header-anchor" href="#dateUTC"><span aria-hidden="true" class="header-anchor__symbol">#</span></a></div>

<hr class="field-separator" />

<div class="signature field-method no-description" id="fromNative"><code><span class="field-name">fromNative</span><span class="parenthesis">(</span><span class="arg-name">d</span><span class="operator">:</span> <a href="/api-docs/unity/cs/system/DateTime/" class="type-link">cs.system.DateTime</a><span class="parenthesis">)</span><span class="operator">:</span> <a href="#" class="type-link">Date</a></code><a class="header-anchor" href="#fromNative"><span aria-hidden="true" class="header-anchor__symbol">#</span></a></div>


| Name | Type |
|------|------|
| `d` | [cs.system.DateTime](/api-docs/unity/cs/system/DateTime/) |
