...
title: TmxChunk
target: Unity
permalink: api-docs/unity/format/tmx/TmxChunk/
---
...
|------|------|-------------|
| `x` | [Int](/api-docs/unity/Int/) | The x coordinate of the chunk in tiles. |
| `y` | [Int](/api-docs/unity/Int/) | The y coordinate of the chunk in tiles. |
| `width` | [Int](/api-docs/unity/Int/) | The width of the chunk in tiles. |
| `height` | [Int](/api-docs/unity/Int/) | The height of the chunk in tiles. |
| `tiles` | [Array](/api-docs/unity/Array/)<[TmxTile](/api-docs/unity/format/tmx/TmxTile/)> | Decoded tile data |
