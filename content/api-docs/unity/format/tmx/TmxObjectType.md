...
title: TmxObjectType
target: Unity
permalink: api-docs/unity/format/tmx/TmxObjectType/
---
...
|------|------|
| `gid` | [Int](/api-docs/unity/Int/) |
| `tileset` | [format.tmx.TmxTileset](/api-docs/unity/format/tmx/TmxTileset/) |
...
| Name | Type |
|------|------|
| `points` | [Array](/api-docs/unity/Array/)<[format.tmx.TmxPoint](/api-docs/unity/format/tmx/TmxPoint/)> |
...
| Name | Type |
|------|------|
| `text` | [format.tmx.TmxText](/api-docs/unity/format/tmx/TmxText/) |
