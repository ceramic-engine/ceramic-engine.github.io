...
title: Reader
target: Unity
permalink: api-docs/unity/format/tmx/Reader/
---
...
| Returns |
|---------|
| [TmxObjectTemplate](/api-docs/unity/format/tmx/TmxObjectTemplate/) |
...
| Returns |
|---------|
| [TmxObjectTypeTemplate](/api-docs/unity/format/tmx/TmxObjectTypeTemplate/) |
...
| `localPath` | [String](/api-docs/unity/String/) | *(optional)* |

| Returns |
|---------|
| [TmxMap](/api-docs/unity/format/tmx/TmxMap/) |
...
|------|------|---------|-------------|
| `xml` | [Xml](/api-docs/unity/Xml/) | |  |
| `root` | [TmxTileset](/api-docs/unity/format/tmx/TmxTileset/) | `null` | Root Tileset into which read TSX data.  |

| Returns | Description |
|---------|-------------|
| [TmxTileset](/api-docs/unity/format/tmx/TmxTileset/) | Resulting TmxTileset. If `root` is null - returns new TmxTileset object, otherwise `root` is returned. |

<hr class="field-separator" />

<div class="signature field-method has-description" id="readObjectTypes"><code><span class="field-name">readObjectTypes</span><span class="parenthesis">(</span><span class="arg-name">xml</span><span class="operator">:</span> <a href="/api-docs/unity/Xml/" class="type-link">Xml</a><span class="operator">,</span> <span class="operator">?</span><span class="arg-name">root</span><span class="operator">:</span> <a href="/api-docs/unity/format/tmx/TmxMap/" class="type-link">TmxMap</a> <span class="operator">=</span> <span class="default-value">null</span><span class="parenthesis">)</span><span class="operator">:</span> <a href="/api-docs/unity/Map/" class="type-link">Map</a></code><a class="header-anchor" href="#readObjectTypes"><span aria-hidden="true" class="header-anchor__symbol">#</span></a></div>
...
|------|------|---------|-------------|
| `xml` | [Xml](/api-docs/unity/Xml/) | |  |
| `root` | [TmxMap](/api-docs/unity/format/tmx/TmxMap/) | `null` | Optional root TMX file to propagate those types into. It uses `Tools.propagateObjectTypes` function with default propagation rules.  |

| Returns | Description |
|---------|-------------|
| [Map](/api-docs/unity/Map/) | Map with object type templates. Always pass null, if using during resolveTypeTemplate |
...
<div class="signature field-var no-description" id="customUncompressors"><code><span class="field-name">customUncompressors</span><span class="operator">:</span> <a href="/api-docs/unity/Map/" class="type-link">Map</a></code><a class="header-anchor" href="#customUncompressors"><span aria-hidden="true" class="header-anchor__symbol">#</span></a></div>

<hr class="field-separator" />

<div class="signature field-var no-description" id="customEncoders"><code><span class="field-name">customEncoders</span><span class="operator">:</span> <a href="/api-docs/unity/Map/" class="type-link">Map</a></code><a class="header-anchor" href="#customEncoders"><span aria-hidden="true" class="header-anchor__symbol">#</span></a></div>
...
| Returns |
|---------|
| [TmxWangSet](/api-docs/unity/format/tmx/TmxWangSet/) |
...
| Returns |
|---------|
| [TmxWangSetColor](/api-docs/unity/format/tmx/TmxWangSetColor/) |
...
| Returns |
|---------|
| [TmxImage](/api-docs/unity/format/tmx/TmxImage/) |
...
| Returns |
|---------|
| [TmxTileLayer](/api-docs/unity/format/tmx/TmxTileLayer/) |
...
| Returns |
|---------|
| [TmxObjectGroup](/api-docs/unity/format/tmx/TmxObjectGroup/) |
...
| Name | Type | Default |
|------|------|---------|
| `obj` | [haxe.xml._Access.Fast](/api-docs/unity/haxe/xml/_Access/Fast/) | |
| `applyObjectTypeTemplate` | [Bool](/api-docs/unity/Bool/) | `true` |

| Returns |
|---------|
| [TmxObject](/api-docs/unity/format/tmx/TmxObject/) |
...
| Returns |
|---------|
| [Array](/api-docs/unity/Array/)<[TmxPoint](/api-docs/unity/format/tmx/TmxPoint/)> |
...
| Returns |
|---------|
| [TmxText](/api-docs/unity/format/tmx/TmxText/) |
...
| Returns |
|---------|
| [TmxImageLayer](/api-docs/unity/format/tmx/TmxImageLayer/) |
...
| Returns |
|---------|
| [TmxProperties](/api-docs/unity/format/tmx/TmxProperties/) |
