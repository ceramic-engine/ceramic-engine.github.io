...
target: Unity
permalink: api-docs/unity/format/tmx/TmxWangSetTile/
---
...
<div class="signature field-var has-description" id="wangID"><code><span class="field-name">wangID</span><span class="operator">:</span> <a href="/api-docs/unity/Int/" class="type-link">Int</a></code><a class="header-anchor" href="#wangID"><span aria-hidden="true" class="header-anchor__symbol">#</span></a></div>
...
|------|------|-------------|
| `tileID` | [Int](/api-docs/unity/Int/) | The tile ID. |
| `wangID` | [Int](/api-docs/unity/Int/) | * The Wang ID, which is a 32-bit unsigned integer stored in the format 0xCECECECE (where each C is a corner color and each E is an edge color, from right to left clockwise, starting with the top edge) |
