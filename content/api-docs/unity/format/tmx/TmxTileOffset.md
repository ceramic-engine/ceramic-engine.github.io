...
title: TmxTileOffset
target: Unity
permalink: api-docs/unity/format/tmx/TmxTileOffset/
---
...
|------|------|-------------|
| `x` | [Int](/api-docs/unity/Int/) | Horizontal offset in pixels |
| `y` | [Int](/api-docs/unity/Int/) | Vertical offset in pixels (positive is down) |
