...
subCategory: doc
menu: Tiled
title: TmxObjectTypeTemplate
target: Unity
permalink: api-docs/unity/format/tmx/TmxObjectTypeTemplate/
---
...
<div class="type-hierarchy"><strong>format.tmx.TmxObjectTypeTemplate</strong> (Class)</div>
...
<div class="signature field-var no-description" id="color"><code><span class="field-name">color</span><span class="operator">:</span> <a href="/api-docs/unity/Int/" class="type-link">Int</a></code><a class="header-anchor" href="#color"><span aria-hidden="true" class="header-anchor__symbol">#</span></a></div>

<hr class="field-separator" />

<div class="signature field-var no-description" id="properties"><code><span class="field-name">properties</span><span class="operator">:</span> <a href="/api-docs/unity/Array/" class="type-link">Array</a><span class="operator">&lt;</span><a href="/api-docs/unity/format/tmx/TmxObjectTypeProperty/" class="type-link">TmxObjectTypeProperty</a><span class="operator">&gt;</span></code><a class="header-anchor" href="#properties"><span aria-hidden="true" class="header-anchor__symbol">#</span></a></div>
...
| `color` | [Int](/api-docs/unity/Int/) |
| `properties` | [Array](/api-docs/unity/Array/)<[TmxObjectTypeProperty](/api-docs/unity/format/tmx/TmxObjectTypeProperty/)> |
