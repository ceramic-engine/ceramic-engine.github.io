...
target: Unity
permalink: api-docs/unity/format/tmx/TmxWangSetColor/
---
...
|------|------|-------------|
| `name` | [String](/api-docs/unity/String/) | The name of this color. |
| `color` | [Int](/api-docs/unity/Int/) | The color in #RRGGBB format (example: #c17d11). |
| `tile` | [Int](/api-docs/unity/Int/) | The tile ID of the tile representing this color. |
| `probability` | [Float](/api-docs/unity/Float/) | The relative probability that this color is chosen over others in case of multiple options. |
