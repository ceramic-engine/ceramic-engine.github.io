...
title: ZPP_Listener
target: Unity
permalink: api-docs/unity/zpp_nape/callbacks/ZPP_Listener/
---
...
| Name | Type |
|------|------|
| `a` | [ZPP_Listener](/api-docs/unity/zpp_nape/callbacks/ZPP_Listener/) |
| `b` | [ZPP_Listener](/api-docs/unity/zpp_nape/callbacks/ZPP_Listener/) |
...
<div class="signature field-var no-description has-plugin" id="outer"><div class="plugin-name">nape</div><code><span class="field-name">outer</span><span class="operator">:</span> <a href="/api-docs/unity/nape/callbacks/Listener/" class="type-link">nape.callbacks.Listener</a></code><a class="header-anchor" href="#outer"><span aria-hidden="true" class="header-anchor__symbol">#</span></a></div>
...
<div class="signature field-var no-description has-plugin" id="precedence"><div class="plugin-name">nape</div><code><span class="field-name">precedence</span><span class="operator">:</span> <a href="/api-docs/unity/Int/" class="type-link">Int</a></code><a class="header-anchor" href="#precedence"><span aria-hidden="true" class="header-anchor__symbol">#</span></a></div>
