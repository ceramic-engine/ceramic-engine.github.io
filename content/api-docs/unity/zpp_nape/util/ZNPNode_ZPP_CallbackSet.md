...
target: Unity
permalink: api-docs/unity/zpp_nape/util/ZNPNode_ZPP_CallbackSet/
---
...
<div class="signature field-var no-description has-plugin" id="elt"><div class="plugin-name">nape</div><code><span class="field-name">elt</span><span class="operator">:</span> <a href="/api-docs/unity/zpp_nape/space/ZPP_CallbackSet/" class="type-link">zpp_nape.space.ZPP_CallbackSet</a></code><a class="header-anchor" href="#elt"><span aria-hidden="true" class="header-anchor__symbol">#</span></a></div>
...
<div class="signature field-method no-description has-plugin" id="elem"><div class="plugin-name">nape</div><code><span class="field-name">elem</span><span class="parenthesis">(</span><span class="parenthesis">)</span><span class="operator">:</span> <a href="/api-docs/unity/zpp_nape/space/ZPP_CallbackSet/" class="type-link">zpp_nape.space.ZPP_CallbackSet</a></code><a class="header-anchor" href="#elem"><span aria-hidden="true" class="header-anchor__symbol">#</span></a></div>
