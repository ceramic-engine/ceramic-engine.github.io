...
title: EnumBuilder
target: Unity
permalink: api-docs/unity/cs/system/reflection/emit/EnumBuilder/
---

# EnumBuilder

<div class="type-hierarchy"><a href="/api-docs/unity/cs/system/reflection/MemberInfo/">cs.system.reflection.MemberInfo</a> → <a href="/api-docs/unity/cs/system/Type/">cs.system.Type</a> → <strong>cs.system.reflection.emit.EnumBuilder</strong> (extern final class)</div>

<div class="type-implements"><strong>Implements:</strong> <a href="/api-docs/unity/cs/system/runtime/interopservices/_EnumBuilder/">cs.system.runtime.interopservices._EnumBuilder</a></div>
...
<div class="signature field-var no-description" id="UnderlyingField"><code><span class="field-name">UnderlyingField</span><span class="operator">:</span> <a href="/api-docs/unity/cs/system/reflection/emit/FieldBuilder/" class="type-link">FieldBuilder</a></code><a class="header-anchor" href="#UnderlyingField"><span aria-hidden="true" class="header-anchor__symbol">#</span></a></div>
...
<div class="signature field-method no-description" id="DefineLiteral"><code><span class="field-name">DefineLiteral</span><span class="parenthesis">(</span><span class="arg-name">literalName</span><span class="operator">:</span> <a href="/api-docs/unity/String/" class="type-link">String</a><span class="operator">,</span> <span class="arg-name">literalValue</span><span class="operator">:</span> <a href="/api-docs/unity/Dynamic/" class="type-link">Dynamic</a><span class="parenthesis">)</span><span class="operator">:</span> <a href="/api-docs/unity/cs/system/reflection/emit/FieldBuilder/" class="type-link">FieldBuilder</a></code><a class="header-anchor" href="#DefineLiteral"><span aria-hidden="true" class="header-anchor__symbol">#</span></a></div>


| Name | Type |
|------|------|
| `literalName` | [String](/api-docs/unity/String/) |
| `literalValue` | [Dynamic](/api-docs/unity/Dynamic/) |
