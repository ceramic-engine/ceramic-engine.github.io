...
subCategory: doc
menu: Other
title: Delegate_Predicate_1
target: Unity
permalink: api-docs/unity/cs/system/Delegate_Predicate_1/
---

# Delegate_Predicate_1

<div class="type-hierarchy"><a href="/api-docs/unity/cs/system/Delegate/">Delegate</a> → <a href="/api-docs/unity/cs/system/MulticastDelegate/">MulticastDelegate</a> → <strong>cs.system.Delegate_Predicate_1</strong> (extern final class)</div>
...
| Name | Type |
|------|------|
| `arg1` | [Predicate_1](/api-docs/unity/cs/system/Predicate_1/)<[op_Addition.T0](/api-docs/unity/op_Addition/T0/)> |
| `arg2` | [Predicate_1](/api-docs/unity/cs/system/Predicate_1/)<[op_Addition.T0](/api-docs/unity/op_Addition/T0/)> |

| Returns |
|---------|
| [Predicate_1](/api-docs/unity/cs/system/Predicate_1/)<[op_Addition.T0](/api-docs/unity/op_Addition/T0/)> |
...
| Name | Type |
|------|------|
| `arg1` | [Predicate_1](/api-docs/unity/cs/system/Predicate_1/)<[op_Subtraction.T0](/api-docs/unity/op_Subtraction/T0/)> |
| `arg2` | [Predicate_1](/api-docs/unity/cs/system/Predicate_1/)<[op_Subtraction.T0](/api-docs/unity/op_Subtraction/T0/)> |

| Returns |
|---------|
| [Predicate_1](/api-docs/unity/cs/system/Predicate_1/)<[op_Subtraction.T0](/api-docs/unity/op_Subtraction/T0/)> |

## Instance Members

<div class="signature field-method no-description" id="Invoke"><code><span class="field-name">Invoke</span><span class="parenthesis">(</span><span class="arg-name">obj</span><span class="operator">:</span> <a href="/api-docs/unity/cs/system/Delegate_Predicate_1/T0/" class="type-link">cs.system.Delegate_Predicate_1.T0</a><span class="parenthesis">)</span><span class="operator">:</span> <a href="/api-docs/unity/Bool/" class="type-link">Bool</a></code><a class="header-anchor" href="#Invoke"><span aria-hidden="true" class="header-anchor__symbol">#</span></a></div>


| Name | Type |
|------|------|
| `obj` | [cs.system.Delegate_Predicate_1.T0](/api-docs/unity/cs/system/Delegate_Predicate_1/T0/) |
