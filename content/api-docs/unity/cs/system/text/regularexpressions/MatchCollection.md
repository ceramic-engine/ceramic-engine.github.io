...
target: Unity
permalink: api-docs/unity/cs/system/text/regularexpressions/MatchCollection/
---

# MatchCollection

<div class="type-hierarchy"><strong>cs.system.text.regularexpressions.MatchCollection</strong> (extern class)</div>
