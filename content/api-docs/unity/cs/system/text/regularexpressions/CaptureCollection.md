...
target: Unity
permalink: api-docs/unity/cs/system/text/regularexpressions/CaptureCollection/
---

# CaptureCollection

<div class="type-hierarchy"><strong>cs.system.text.regularexpressions.CaptureCollection</strong> (extern class)</div>
