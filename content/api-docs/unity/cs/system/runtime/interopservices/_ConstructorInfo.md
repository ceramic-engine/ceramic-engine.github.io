...
subCategory: doc
menu: Other
title: _ConstructorInfo
target: Unity
permalink: api-docs/unity/cs/system/runtime/interopservices/_ConstructorInfo/
---

# _ConstructorInfo

<div class="type-hierarchy"><strong>cs.system.runtime.interopservices._ConstructorInfo</strong> (extern interface) → <a href="/api-docs/unity/cs/system/reflection/ConstructorInfo/">cs.system.reflection.ConstructorInfo</a></div>
...
<div class="signature field-method no-description" id="Invoke_5"><code><span class="field-name">Invoke_5</span><span class="parenthesis">(</span><span class="arg-name">parameters</span><span class="operator">:</span> <a href="/api-docs/unity/cs/NativeArray/" class="type-link">cs.NativeArray</a><span class="operator">&lt;</span><a href="/api-docs/unity/Dynamic/" class="type-link">Dynamic</a><span class="operator">&gt;</span><span class="parenthesis">)</span><span class="operator">:</span> <a href="/api-docs/unity/Dynamic/" class="type-link">Dynamic</a></code><a class="header-anchor" href="#Invoke_5"><span aria-hidden="true" class="header-anchor__symbol">#</span></a></div>


| Name | Type |
|------|------|
| `parameters` | [cs.NativeArray](/api-docs/unity/cs/NativeArray/)<[Dynamic](/api-docs/unity/Dynamic/)> |
...
<div class="signature field-method no-description" id="Invoke_3"><code><span class="field-name">Invoke_3</span><span class="parenthesis">(</span><span class="arg-name">obj</span><span class="operator">:</span> <a href="/api-docs/unity/Dynamic/" class="type-link">Dynamic</a><span class="operator">,</span> <span class="arg-name">parameters</span><span class="operator">:</span> <a href="/api-docs/unity/cs/NativeArray/" class="type-link">cs.NativeArray</a><span class="operator">&lt;</span><a href="/api-docs/unity/Dynamic/" class="type-link">Dynamic</a><span class="operator">&gt;</span><span class="parenthesis">)</span><span class="operator">:</span> <a href="/api-docs/unity/Dynamic/" class="type-link">Dynamic</a></code><a class="header-anchor" href="#Invoke_3"><span aria-hidden="true" class="header-anchor__symbol">#</span></a></div>
...
<div class="signature field-method no-description" id="Invoke_2"><code><span class="field-name">Invoke_2</span><span class="parenthesis">(</span><span class="arg-name">obj</span><span class="operator">:</span> <a href="/api-docs/unity/Dynamic/" class="type-link">Dynamic</a><span class="operator">,</span> <span class="arg-name">invokeAttr</span><span class="operator">:</span> <span class="type-name">Anonymous</span><span class="operator">,</span> <span class="arg-name">binder</span><span class="operator">:</span> <a href="/api-docs/unity/cs/system/reflection/Binder/" class="type-link">cs.system.reflection.Binder</a><span class="operator">,</span> <span class="arg-name">parameters</span><span class="operator">:</span> <a href="/api-docs/unity/cs/NativeArray/" class="type-link">cs.NativeArray</a><span class="operator">&lt;</span><a href="/api-docs/unity/Dynamic/" class="type-link">Dynamic</a><span class="operator">&gt;</span><span class="operator">,</span> <span class="arg-name">culture</span><span class="operator">:</span> <a href="/api-docs/unity/cs/system/globalization/CultureInfo/" class="type-link">cs.system.globalization.CultureInfo</a><span class="parenthesis">)</span><span class="operator">:</span> <a href="/api-docs/unity/Dynamic/" class="type-link">Dynamic</a></code><a class="header-anchor" href="#Invoke_2"><span aria-hidden="true" class="header-anchor__symbol">#</span></a></div>
