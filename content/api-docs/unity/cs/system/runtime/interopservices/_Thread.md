...
title: _Thread
target: Unity
permalink: api-docs/unity/cs/system/runtime/interopservices/_Thread/
---

# _Thread

<div class="type-hierarchy"><strong>cs.system.runtime.interopservices._Thread</strong> (extern interface) → <a href="/api-docs/unity/cs/system/threading/Thread/">cs.system.threading.Thread</a></div>
