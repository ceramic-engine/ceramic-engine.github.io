...
subCategory: doc
menu: Other
title: ArrayList_RangedArrayList
target: Unity
permalink: api-docs/unity/cs/system/collections/ArrayList_RangedArrayList/
---

# ArrayList_RangedArrayList

<div class="type-hierarchy"><a href="/api-docs/unity/cs/system/collections/ArrayList/">ArrayList</a> → <a href="/api-docs/unity/cs/system/collections/ArrayList_ArrayListWrapper/">ArrayList_ArrayListWrapper</a> → <strong>cs.system.collections.ArrayList_RangedArrayList</strong> (extern final class)</div>
...
| Name | Type |
|------|------|
| `innerList` | [ArrayList](/api-docs/unity/cs/system/collections/ArrayList/) |
| `index` | [Int](/api-docs/unity/Int/) |
| `count` | [Int](/api-docs/unity/Int/) |
