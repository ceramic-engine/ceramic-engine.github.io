...
subCategory: doc
menu: Other
title: Hashtable_HashValues
target: Unity
permalink: api-docs/unity/cs/system/collections/Hashtable_HashValues/
---

# Hashtable_HashValues

<div class="type-hierarchy"><strong>cs.system.collections.Hashtable_HashValues</strong> (extern class)</div>

<div class="type-implements"><strong>Implements:</strong> <a href="/api-docs/unity/cs/system/collections/ICollection/">ICollection</a>, <a href="/api-docs/unity/cs/system/collections/IEnumerable/">IEnumerable</a></div>
...
<div class="signature field-method no-description" id="new"><code><span class="field-name">new</span><span class="parenthesis">(</span><span class="arg-name">host</span><span class="operator">:</span> <a href="/api-docs/unity/cs/system/collections/Hashtable/" class="type-link">Hashtable</a><span class="parenthesis">)</span><span class="operator">:</span> <a href="/api-docs/unity/Void/" class="type-link">Void</a></code><a class="header-anchor" href="#new"><span aria-hidden="true" class="header-anchor__symbol">#</span></a></div>


| Name | Type |
|------|------|
| `host` | [Hashtable](/api-docs/unity/cs/system/collections/Hashtable/) |
