...
subCategory: doc
menu: Other
title: ArrayList_FixedSizeListWrapper
target: Unity
permalink: api-docs/unity/cs/system/collections/ArrayList_FixedSizeListWrapper/
---

# ArrayList_FixedSizeListWrapper

<div class="type-hierarchy"><a href="/api-docs/unity/cs/system/collections/ArrayList_ListWrapper/">ArrayList_ListWrapper</a> → <strong>cs.system.collections.ArrayList_FixedSizeListWrapper</strong> (extern class) → <a href="/api-docs/unity/cs/system/collections/ArrayList_ReadOnlyListWrapper/">ArrayList_ReadOnlyListWrapper</a></div>
...
<div class="signature field-var no-description" id="ErrorMessage"><code><span class="field-name">ErrorMessage</span><span class="operator">:</span> <a href="/api-docs/unity/String/" class="type-link">String</a></code><a class="header-anchor" href="#ErrorMessage"><span aria-hidden="true" class="header-anchor__symbol">#</span></a></div>
