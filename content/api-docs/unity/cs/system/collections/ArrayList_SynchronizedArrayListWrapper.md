...
subCategory: doc
menu: Other
title: ArrayList_SynchronizedArrayListWrapper
target: Unity
permalink: api-docs/unity/cs/system/collections/ArrayList_SynchronizedArrayListWrapper/
---

# ArrayList_SynchronizedArrayListWrapper

<div class="type-hierarchy"><a href="/api-docs/unity/cs/system/collections/ArrayList/">ArrayList</a> → <a href="/api-docs/unity/cs/system/collections/ArrayList_ArrayListWrapper/">ArrayList_ArrayListWrapper</a> → <strong>cs.system.collections.ArrayList_SynchronizedArrayListWrapper</strong> (extern final class)</div>
