...
subCategory: doc
menu: Other
title: ArrayList_ListWrapper
target: Unity
permalink: api-docs/unity/cs/system/collections/ArrayList_ListWrapper/
---

# ArrayList_ListWrapper

<div class="type-hierarchy"><strong>cs.system.collections.ArrayList_ListWrapper</strong> (extern class) → <a href="/api-docs/unity/cs/system/collections/ArrayList_FixedSizeListWrapper/">ArrayList_FixedSizeListWrapper</a>, <a href="/api-docs/unity/cs/system/collections/ArrayList_SynchronizedListWrapper/">ArrayList_SynchronizedListWrapper</a></div>

<div class="type-implements"><strong>Implements:</strong> <a href="/api-docs/unity/cs/system/collections/ICollection/">ICollection</a>, <a href="/api-docs/unity/cs/system/collections/IEnumerable/">IEnumerable</a>, <a href="/api-docs/unity/cs/system/collections/IList/">IList</a></div>
...
<div class="signature field-var no-description" id="m_InnerList"><code><span class="field-name">m_InnerList</span><span class="operator">:</span> <a href="/api-docs/unity/cs/system/collections/IList/" class="type-link">IList</a></code><a class="header-anchor" href="#m_InnerList"><span aria-hidden="true" class="header-anchor__symbol">#</span></a></div>
...
<div class="signature field-method no-description" id="Contains"><code><span class="field-name">Contains</span><span class="parenthesis">(</span><span class="arg-name">value</span><span class="operator">:</span> <a href="/api-docs/unity/Dynamic/" class="type-link">Dynamic</a><span class="parenthesis">)</span><span class="operator">:</span> <a href="/api-docs/unity/Bool/" class="type-link">Bool</a></code><a class="header-anchor" href="#Contains"><span aria-hidden="true" class="header-anchor__symbol">#</span></a></div>
...
<div class="signature field-method no-description" id="Remove"><code><span class="field-name">Remove</span><span class="parenthesis">(</span><span class="arg-name">value</span><span class="operator">:</span> <a href="/api-docs/unity/Dynamic/" class="type-link">Dynamic</a><span class="parenthesis">)</span><span class="operator">:</span> <a href="/api-docs/unity/Void/" class="type-link">Void</a></code><a class="header-anchor" href="#Remove"><span aria-hidden="true" class="header-anchor__symbol">#</span></a></div>
...
<div class="signature field-method no-description" id="new"><code><span class="field-name">new</span><span class="parenthesis">(</span><span class="arg-name">innerList</span><span class="operator">:</span> <a href="/api-docs/unity/cs/system/collections/IList/" class="type-link">IList</a><span class="parenthesis">)</span><span class="operator">:</span> <a href="/api-docs/unity/Void/" class="type-link">Void</a></code><a class="header-anchor" href="#new"><span aria-hidden="true" class="header-anchor__symbol">#</span></a></div>


| Name | Type |
|------|------|
| `innerList` | [IList](/api-docs/unity/cs/system/collections/IList/) |
