...
subCategory: doc
menu: Other
title: ArrayList_ArrayListWrapper
target: Unity
permalink: api-docs/unity/cs/system/collections/ArrayList_ArrayListWrapper/
---

# ArrayList_ArrayListWrapper

<div class="type-hierarchy"><a href="/api-docs/unity/cs/system/collections/ArrayList/">ArrayList</a> → <strong>cs.system.collections.ArrayList_ArrayListWrapper</strong> (extern class) → <a href="/api-docs/unity/cs/system/collections/ArrayList_FixedSizeArrayListWrapper/">ArrayList_FixedSizeArrayListWrapper</a>, <a href="/api-docs/unity/cs/system/collections/ArrayList_RangedArrayList/">ArrayList_RangedArrayList</a>, <a href="/api-docs/unity/cs/system/collections/ArrayList_SynchronizedArrayListWrapper/">ArrayList_SynchronizedArrayListWrapper</a></div>
...
<div class="signature field-var no-description" id="m_InnerArrayList"><code><span class="field-name">m_InnerArrayList</span><span class="operator">:</span> <a href="/api-docs/unity/cs/system/collections/ArrayList/" class="type-link">ArrayList</a></code><a class="header-anchor" href="#m_InnerArrayList"><span aria-hidden="true" class="header-anchor__symbol">#</span></a></div>
...
<div class="signature field-method no-description" id="new"><code><span class="field-name">new</span><span class="parenthesis">(</span><span class="arg-name">innerArrayList</span><span class="operator">:</span> <a href="/api-docs/unity/cs/system/collections/ArrayList/" class="type-link">ArrayList</a><span class="parenthesis">)</span><span class="operator">:</span> <a href="/api-docs/unity/Void/" class="type-link">Void</a></code><a class="header-anchor" href="#new"><span aria-hidden="true" class="header-anchor__symbol">#</span></a></div>


| Name | Type |
|------|------|
| `innerArrayList` | [ArrayList](/api-docs/unity/cs/system/collections/ArrayList/) |
