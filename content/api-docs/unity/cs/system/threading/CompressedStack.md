...
subCategory: doc
menu: Other
title: CompressedStack
target: Unity
permalink: api-docs/unity/cs/system/threading/CompressedStack/
---

# CompressedStack

<div class="type-hierarchy"><strong>cs.system.threading.CompressedStack</strong> (extern final class)</div>
...
<div class="signature field-method no-description" id="Capture"><code><span class="field-name">Capture</span><span class="parenthesis">(</span><span class="parenthesis">)</span><span class="operator">:</span> <a href="#" class="type-link">CompressedStack</a></code><a class="header-anchor" href="#Capture"><span aria-hidden="true" class="header-anchor__symbol">#</span></a></div>
