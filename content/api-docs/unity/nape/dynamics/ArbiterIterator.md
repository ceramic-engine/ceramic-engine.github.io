...
target: Unity
permalink: api-docs/unity/nape/dynamics/ArbiterIterator/
---
...
|------|------|-------------|
| `list` | [ArbiterList](/api-docs/unity/nape/dynamics/ArbiterList/) | The Nape list to create iterator for.  |

| Returns | Description |
|---------|-------------|
| [ArbiterIterator](/api-docs/unity/nape/dynamics/ArbiterIterator/) | An iterator over the Nape list. |
...
| Returns | Description |
|---------|-------------|
| [Arbiter](/api-docs/unity/nape/dynamics/Arbiter/) | The next element in iteration. |
