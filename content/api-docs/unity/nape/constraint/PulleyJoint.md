...
title: PulleyJoint
target: Unity
permalink: api-docs/unity/nape/constraint/PulleyJoint/
---
...
<div class="type-hierarchy"><a href="/api-docs/unity/nape/constraint/Constraint/">Constraint</a> → <strong>nape.constraint.PulleyJoint</strong> (final class)</div>
...
<div class="signature field-var has-description has-plugin" id="zpp_inner_zn"><div class="plugin-name">nape</div><code><span class="field-name">zpp_inner_zn</span><span class="operator">:</span> <a href="/api-docs/unity/zpp_nape/constraint/ZPP_PulleyJoint/" class="type-link">zpp_nape.constraint.ZPP_PulleyJoint</a></code><a class="header-anchor" href="#zpp_inner_zn"><span aria-hidden="true" class="header-anchor__symbol">#</span></a></div>
...
|------|------|---------|-------------|
| `body1` | [Null](/api-docs/unity/Null/)<[nape.phys.Body](/api-docs/unity/nape/phys/Body/)> | | The first body in PulleyJoint.  |
| `body2` | [Null](/api-docs/unity/Null/)<[nape.phys.Body](/api-docs/unity/nape/phys/Body/)> | | The second body in PulleyJoint.  |
| `body3` | [Null](/api-docs/unity/Null/)<[nape.phys.Body](/api-docs/unity/nape/phys/Body/)> | | The third body in PulleyJoint.  |
| `body4` | [Null](/api-docs/unity/Null/)<[nape.phys.Body](/api-docs/unity/nape/phys/Body/)> | | The fourth body in PulleyJoint.  |
| `anchor1` | [nape.geom.Vec2](/api-docs/unity/nape/geom/Vec2/) | | The first local anchor for joint.  |
| `anchor2` | [nape.geom.Vec2](/api-docs/unity/nape/geom/Vec2/) | | The second local anchor for joint.  |
| `anchor3` | [nape.geom.Vec2](/api-docs/unity/nape/geom/Vec2/) | | The third local anchor for joint.  |
| `anchor4` | [nape.geom.Vec2](/api-docs/unity/nape/geom/Vec2/) | | The fourth local anchor for joint.  |
...
| `ratio` | [Float](/api-docs/unity/Float/) | `1.0` | The ratio for constraint.  |
