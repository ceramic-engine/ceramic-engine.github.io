...
title: LineJoint
target: Unity
permalink: api-docs/unity/nape/constraint/LineJoint/
---
...
<div class="type-hierarchy"><a href="/api-docs/unity/nape/constraint/Constraint/">Constraint</a> → <strong>nape.constraint.LineJoint</strong> (final class)</div>
...
<div class="signature field-var has-description has-plugin" id="zpp_inner_zn"><div class="plugin-name">nape</div><code><span class="field-name">zpp_inner_zn</span><span class="operator">:</span> <a href="/api-docs/unity/zpp_nape/constraint/ZPP_LineJoint/" class="type-link">zpp_nape.constraint.ZPP_LineJoint</a></code><a class="header-anchor" href="#zpp_inner_zn"><span aria-hidden="true" class="header-anchor__symbol">#</span></a></div>
...
|------|------|-------------|
| `body1` | [Null](/api-docs/unity/Null/)<[nape.phys.Body](/api-docs/unity/nape/phys/Body/)> | The first body in LineJoint.  |
| `body2` | [Null](/api-docs/unity/Null/)<[nape.phys.Body](/api-docs/unity/nape/phys/Body/)> | The second body in LineJoint.  |
...
| `direction` | [nape.geom.Vec2](/api-docs/unity/nape/geom/Vec2/) | The direction of local line for joint.  |
