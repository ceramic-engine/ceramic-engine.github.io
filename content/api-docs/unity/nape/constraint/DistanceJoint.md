...
title: DistanceJoint
target: Unity
permalink: api-docs/unity/nape/constraint/DistanceJoint/
---
...
<div class="type-hierarchy"><a href="/api-docs/unity/nape/constraint/Constraint/">Constraint</a> → <strong>nape.constraint.DistanceJoint</strong> (final class)</div>
...
|------|------|-------------|
| `body1` | [Null](/api-docs/unity/Null/)<[nape.phys.Body](/api-docs/unity/nape/phys/Body/)> | The first body in DistanceJoint.  |
| `body2` | [Null](/api-docs/unity/Null/)<[nape.phys.Body](/api-docs/unity/nape/phys/Body/)> | The second body in DistanceJoint.  |
