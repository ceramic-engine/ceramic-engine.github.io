...
title: MotorJoint
target: Unity
permalink: api-docs/unity/nape/constraint/MotorJoint/
---
...
<div class="type-hierarchy"><a href="/api-docs/unity/nape/constraint/Constraint/">Constraint</a> → <strong>nape.constraint.MotorJoint</strong> (final class)</div>
...
<div class="signature field-var has-description has-plugin" id="zpp_inner_zn"><div class="plugin-name">nape</div><code><span class="field-name">zpp_inner_zn</span><span class="operator">:</span> <a href="/api-docs/unity/zpp_nape/constraint/ZPP_MotorJoint/" class="type-link">zpp_nape.constraint.ZPP_MotorJoint</a></code><a class="header-anchor" href="#zpp_inner_zn"><span aria-hidden="true" class="header-anchor__symbol">#</span></a></div>
...
|------|------|---------|-------------|
| `body1` | [Null](/api-docs/unity/Null/)<[nape.phys.Body](/api-docs/unity/nape/phys/Body/)> | | The first body in MotorJoint  |
| `body2` | [Null](/api-docs/unity/Null/)<[nape.phys.Body](/api-docs/unity/nape/phys/Body/)> | | The second body in MotorJoint  |
| `rate` | [Float](/api-docs/unity/Float/) | `0.0` | The rate of motor. (default 0)  |
| `ratio` | [Float](/api-docs/unity/Float/) | `1.0` | The ratio of the motor. (default 1)  |
