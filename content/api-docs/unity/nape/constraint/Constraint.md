...
title: Constraint
target: Unity
permalink: api-docs/unity/nape/constraint/Constraint/
---
...
<div class="type-hierarchy"><strong>nape.constraint.Constraint</strong> (Class) → <a href="/api-docs/unity/nape/constraint/AngleJoint/">AngleJoint</a>, <a href="/api-docs/unity/nape/constraint/DistanceJoint/">DistanceJoint</a>, <a href="/api-docs/unity/nape/constraint/LineJoint/">LineJoint</a>, <a href="/api-docs/unity/nape/constraint/MotorJoint/">MotorJoint</a>, <a href="/api-docs/unity/nape/constraint/PivotJoint/">PivotJoint</a>, <a href="/api-docs/unity/nape/constraint/PulleyJoint/">PulleyJoint</a>, <a href="/api-docs/unity/nape/constraint/UserConstraint/">UserConstraint</a>, <a href="/api-docs/unity/nape/constraint/WeldJoint/">WeldJoint</a></div>
...
| Returns | Description |
|---------|-------------|
| [nape.geom.MatMN](/api-docs/unity/nape/geom/MatMN/) | A new MatMN representing the constraint space impulse. |
...
|------|------|-------------|
| `body` | [nape.phys.Body](/api-docs/unity/nape/phys/Body/) | The Body to compute impulse for.  |

| Returns | Description |
|---------|-------------|
| [nape.geom.Vec3](/api-docs/unity/nape/geom/Vec3/) | The impulse that was applied to the body in the previous step.  |
...
| Returns | Description |
|---------|-------------|
| [Constraint](/api-docs/unity/nape/constraint/Constraint/) | The copied Constraint. |
