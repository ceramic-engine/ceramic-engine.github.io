...
title: PreCallback
target: Unity
permalink: api-docs/unity/nape/callbacks/PreCallback/
---
...
<div class="type-hierarchy"><a href="/api-docs/unity/nape/callbacks/Callback/">Callback</a> → <strong>nape.callbacks.PreCallback</strong> (final class)</div>
...
<div class="signature field-var has-description has-plugin" id="int1"><div class="plugin-name">nape</div><code><span class="field-name">int1</span><span class="operator">:</span> <a href="/api-docs/unity/nape/phys/Interactor/" class="type-link">nape.phys.Interactor</a></code><a class="header-anchor" href="#int1"><span aria-hidden="true" class="header-anchor__symbol">#</span></a></div>
