...
target: Unity
permalink: api-docs/unity/nape/callbacks/CbTypeIterator/
---
...
|------|------|-------------|
| `list` | [CbTypeList](/api-docs/unity/nape/callbacks/CbTypeList/) | The Nape list to create iterator for.  |

| Returns | Description |
|---------|-------------|
| [CbTypeIterator](/api-docs/unity/nape/callbacks/CbTypeIterator/) | An iterator over the Nape list. |

## Instance Members

<div class="signature field-var has-description has-plugin" id="zpp_inner"><div class="plugin-name">nape</div><code><span class="field-name">zpp_inner</span><span class="operator">:</span> <a href="/api-docs/unity/nape/callbacks/CbTypeList/" class="type-link">CbTypeList</a></code><a class="header-anchor" href="#zpp_inner"><span aria-hidden="true" class="header-anchor__symbol">#</span></a></div>
...
| Returns | Description |
|---------|-------------|
| [CbType](/api-docs/unity/nape/callbacks/CbType/) | The next element in iteration. |
