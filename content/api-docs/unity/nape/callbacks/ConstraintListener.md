...
target: Unity
permalink: api-docs/unity/nape/callbacks/ConstraintListener/
---
...
<div class="type-hierarchy"><a href="/api-docs/unity/nape/callbacks/Listener/">Listener</a> → <strong>nape.callbacks.ConstraintListener</strong> (final class)</div>
...
| `options` | [Null](/api-docs/unity/Null/)<[Dynamic](/api-docs/unity/Dynamic/)> | | The OptionType to match Constraints against, passing null will equate to an empty OptionType.  |
| `handler` | Function | | The callback handler for this listener.  |
| `precedence` | [Int](/api-docs/unity/Int/) | `0` | The precedence of this listener used to sort the order of callbacks in the case of more than one suitable ConstraintListener existing for the same event on the same Constraint. (default 0)  |
