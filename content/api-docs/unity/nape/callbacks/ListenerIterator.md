...
target: Unity
permalink: api-docs/unity/nape/callbacks/ListenerIterator/
---
...
|------|------|-------------|
| `list` | [ListenerList](/api-docs/unity/nape/callbacks/ListenerList/) | The Nape list to create iterator for.  |

| Returns | Description |
|---------|-------------|
| [ListenerIterator](/api-docs/unity/nape/callbacks/ListenerIterator/) | An iterator over the Nape list. |
...
| Returns | Description |
|---------|-------------|
| [Listener](/api-docs/unity/nape/callbacks/Listener/) | The next element in iteration. |
