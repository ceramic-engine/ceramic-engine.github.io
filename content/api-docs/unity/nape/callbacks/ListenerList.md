...
title: ListenerList
target: Unity
permalink: api-docs/unity/nape/callbacks/ListenerList/
---
...
|------|------|-------------|
| `array` | [Array](/api-docs/unity/Array/)<[Listener](/api-docs/unity/nape/callbacks/Listener/)> | The array to be converted  |

| Returns | Description |
|---------|-------------|
| [ListenerList](/api-docs/unity/nape/callbacks/ListenerList/) | An equivalent Nape list.  |

## Instance Members

<div class="signature field-var has-description has-plugin" id="zpp_inner"><div class="plugin-name">nape</div><code><span class="field-name">zpp_inner</span><span class="operator">:</span> <a href="/api-docs/unity/zpp_nape/util/ZPP_ListenerList/" class="type-link">zpp_nape.util.ZPP_ListenerList</a></code><a class="header-anchor" href="#zpp_inner"><span aria-hidden="true" class="header-anchor__symbol">#</span></a></div>
...
| Name | Type | Description |
|------|------|-------------|
| `obj` | [Listener](/api-docs/unity/nape/callbacks/Listener/) | The object to test.  |
...
| Returns |
|---------|
| [Listener](/api-docs/unity/nape/callbacks/Listener/) |
...
| Name | Type | Description |
|------|------|-------------|
| `obj` | [Listener](/api-docs/unity/nape/callbacks/Listener/) | The object to insert.  |
...
| Name | Type | Description |
|------|------|-------------|
| `obj` | [Listener](/api-docs/unity/nape/callbacks/Listener/) | The object to remove  |
...
| Returns |
|---------|
| [ListenerIterator](/api-docs/unity/nape/callbacks/ListenerIterator/) |
...
| Returns | Description |
|---------|-------------|
| [ListenerList](/api-docs/unity/nape/callbacks/ListenerList/) | The copied list. |
...
| Name | Type | Description |
|------|------|-------------|
| `xs` | [ListenerList](/api-docs/unity/nape/callbacks/ListenerList/) | The list to merge.  |
...
| Returns | Description |
|---------|-------------|
| [ListenerList](/api-docs/unity/nape/callbacks/ListenerList/) | A reference to 'this' list.  |
