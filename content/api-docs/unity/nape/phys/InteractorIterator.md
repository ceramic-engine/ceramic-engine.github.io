...
target: Unity
permalink: api-docs/unity/nape/phys/InteractorIterator/
---
...
|------|------|-------------|
| `list` | [InteractorList](/api-docs/unity/nape/phys/InteractorList/) | The Nape list to create iterator for.  |

| Returns | Description |
|---------|-------------|
| [InteractorIterator](/api-docs/unity/nape/phys/InteractorIterator/) | An iterator over the Nape list. |
...
| Returns | Description |
|---------|-------------|
| [Interactor](/api-docs/unity/nape/phys/Interactor/) | The next element in iteration. |
