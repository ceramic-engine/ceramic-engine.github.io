...
target: Unity
permalink: api-docs/unity/nape/phys/CompoundIterator/
---
...
|------|------|-------------|
| `list` | [CompoundList](/api-docs/unity/nape/phys/CompoundList/) | The Nape list to create iterator for.  |

| Returns | Description |
|---------|-------------|
| [CompoundIterator](/api-docs/unity/nape/phys/CompoundIterator/) | An iterator over the Nape list. |
...
| Returns | Description |
|---------|-------------|
| [Compound](/api-docs/unity/nape/phys/Compound/) | The next element in iteration. |
