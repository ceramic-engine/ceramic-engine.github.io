...
title: BodyList
target: Unity
permalink: api-docs/unity/nape/phys/BodyList/
---
...
|------|------|-------------|
| `array` | [Array](/api-docs/unity/Array/)<[Body](/api-docs/unity/nape/phys/Body/)> | The array to be converted  |

| Returns | Description |
|---------|-------------|
| [BodyList](/api-docs/unity/nape/phys/BodyList/) | An equivalent Nape list.  |

## Instance Members

<div class="signature field-var has-description has-plugin" id="zpp_inner"><div class="plugin-name">nape</div><code><span class="field-name">zpp_inner</span><span class="operator">:</span> <a href="/api-docs/unity/zpp_nape/util/ZPP_BodyList/" class="type-link">zpp_nape.util.ZPP_BodyList</a></code><a class="header-anchor" href="#zpp_inner"><span aria-hidden="true" class="header-anchor__symbol">#</span></a></div>
...
| Name | Type | Description |
|------|------|-------------|
| `obj` | [Body](/api-docs/unity/nape/phys/Body/) | The object to test.  |
...
| Name | Type | Description |
|------|------|-------------|
| `obj` | [Body](/api-docs/unity/nape/phys/Body/) | The object to insert.  |
...
| Name | Type | Description |
|------|------|-------------|
| `obj` | [Body](/api-docs/unity/nape/phys/Body/) | The object to remove  |
...
| Returns |
|---------|
| [BodyIterator](/api-docs/unity/nape/phys/BodyIterator/) |
...
| Returns | Description |
|---------|-------------|
| [BodyList](/api-docs/unity/nape/phys/BodyList/) | The copied list. |
...
| Name | Type | Description |
|------|------|-------------|
| `xs` | [BodyList](/api-docs/unity/nape/phys/BodyList/) | The list to merge.  |
...
| Returns | Description |
|---------|-------------|
| [BodyList](/api-docs/unity/nape/phys/BodyList/) | A reference to 'this' list.  |
