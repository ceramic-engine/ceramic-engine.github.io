...
title: Compound
target: Unity
permalink: api-docs/unity/nape/phys/Compound/
---
...
<div class="type-hierarchy"><a href="/api-docs/unity/nape/phys/Interactor/">Interactor</a> → <strong>nape.phys.Compound</strong> (final class)</div>
...
|------|------|---------|-------------|
| `weak` | [Bool](/api-docs/unity/Bool/) | `false` | If true, the returned Vec2 will be automatically released to the object pool when passed as an argument to a Nape function. (default false)  |

| Returns | Description |
|---------|-------------|
| [nape.geom.Vec2](/api-docs/unity/nape/geom/Vec2/) | The centre of mass of compound.  |
...
| Name | Type | Description |
|------|------|-------------|
| `translation` | [nape.geom.Vec2](/api-docs/unity/nape/geom/Vec2/) | The translation to apply to the Compound.  |

| Returns | Description |
|---------|-------------|
| [Compound](/api-docs/unity/nape/phys/Compound/) | A reference to this Compound.  |
...
| `angle` | [Float](/api-docs/unity/Float/) | The clockwise angle of rotation in radians.  |
