...
title: Shape
target: Unity
permalink: api-docs/unity/nape/shape/Shape/
---
...
<div class="signature field-var has-description has-plugin" id="filter"><div class="plugin-name">nape</div><code><span class="field-name">filter</span><span class="operator">:</span> <a href="/api-docs/unity/nape/dynamics/InteractionFilter/" class="type-link">nape.dynamics.InteractionFilter</a></code><a class="header-anchor" href="#filter"><span aria-hidden="true" class="header-anchor__symbol">#</span></a></div>
...
| Returns | Description |
|---------|-------------|
| [Bool](/api-docs/unity/Bool/) | True if shape is a Circle type. |
...
| Returns | Description |
|---------|-------------|
| [Bool](/api-docs/unity/Bool/) | True if shape is a Polygon type. |
...
|------|------|-------------|
| `translation` | [nape.geom.Vec2](/api-docs/unity/nape/geom/Vec2/) | The local translation to apply to Shape.  |

| Returns | Description |
|---------|-------------|
| [Shape](/api-docs/unity/nape/shape/Shape/) | A reference to 'this' Shape.  |
...
| Name | Type | Description |
|------|------|-------------|
| `scalex` | [Float](/api-docs/unity/Float/) | The x-coordinate scaling to apply to Shape.  |
| `scaley` | [Float](/api-docs/unity/Float/) | The y-coordinate scaling to apply to Shape.  |
...
| Name | Type | Description |
|------|------|-------------|
| `angle` | [Float](/api-docs/unity/Float/) | The number of radians to rotate this Shape by in a clockwise direction.  |
...
| Name | Type | Description |
|------|------|-------------|
| `matrix` | [nape.geom.Mat23](/api-docs/unity/nape/geom/Mat23/) | The matrix to transform Shape by.  |
...
| Name | Type | Description |
|------|------|-------------|
| `point` | [nape.geom.Vec2](/api-docs/unity/nape/geom/Vec2/) | The point to check for containment.  |

| Returns | Description |
|---------|-------------|
| [Bool](/api-docs/unity/Bool/) | True if point is contained within the Shape.  |
...
| Returns | Description |
|---------|-------------|
| [Shape](/api-docs/unity/nape/shape/Shape/) | A copy of this shape. |
