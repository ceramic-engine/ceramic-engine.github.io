...
title: Polygon
target: Unity
permalink: api-docs/unity/nape/shape/Polygon/
---
...
<div class="type-hierarchy"><a href="/api-docs/unity/nape/phys/Interactor/">nape.phys.Interactor</a> → <a href="/api-docs/unity/nape/shape/Shape/">Shape</a> → <strong>nape.shape.Polygon</strong> (final class)</div>
...
|------|------|---------|-------------|
| `x` | [Float](/api-docs/unity/Float/) | | The x coordinate of rectangle.  |
| `y` | [Float](/api-docs/unity/Float/) | | The y coordinate of rectangle.  |
| `width` | [Float](/api-docs/unity/Float/) | | The width of the ractangle. This value may be negative.  |
| `height` | [Float](/api-docs/unity/Float/) | | The height of the rectangle This value may be negative.  |
| `weak` | [Bool](/api-docs/unity/Bool/) | `false` | If true, the generated list of vertices will be allocated as weak Vec2s so that when this list is passed to a Nape function these Vec2s will be automatically sent back to object pool. (default false)  |

| Returns | Description |
|---------|-------------|
| [Array](/api-docs/unity/Array/)<[nape.geom.Vec2](/api-docs/unity/nape/geom/Vec2/)> | An array of Vec2 representing the given rectangle. |
...
| Name | Type | Default | Description |
|------|------|---------|-------------|
| `width` | [Float](/api-docs/unity/Float/) | | The width of the box (This value may be negative but will make no difference).  |
| `height` | [Float](/api-docs/unity/Float/) | | The height of the box (This value may be negative but will make no difference).  |
| `weak` | [Bool](/api-docs/unity/Bool/) | `false` | If true, the generated list of vertices will be allocated as weak Vec2s so that when this list is passed to a Nape function these Vec2s will be automatically sent back to object pool. (default false)  |

| Returns | Description |
|---------|-------------|
| [Array](/api-docs/unity/Array/)<[nape.geom.Vec2](/api-docs/unity/nape/geom/Vec2/)> | An array of Vec2 representing the given box. |
...
| Name | Type | Default | Description |
|------|------|---------|-------------|
| `xRadius` | [Float](/api-docs/unity/Float/) | | The x radius of polygon before angleOffset rotation.  |
| `yRadius` | [Float](/api-docs/unity/Float/) | | The y radius of polygon before angleOffset rotation.  |
| `edgeCount` | [Int](/api-docs/unity/Int/) | | The number of edges/vertices in polygon.  |
| `angleOffset` | [Float](/api-docs/unity/Float/) | `0.0` | The clockwise angular offset to generate vertices at in radians. (default 0.0)  |
| `weak` | [Bool](/api-docs/unity/Bool/) | `false` | If true, the generated list of vertices will be allocated as weak Vec2s so that when this list is passed to a Nape function these Vec2s will be automatically sent back to object pool. (default false)  |

| Returns | Description |
|---------|-------------|
| [Array](/api-docs/unity/Array/)<[nape.geom.Vec2](/api-docs/unity/nape/geom/Vec2/)> | An array of Vec2 representing the polygon. |

## Instance Members

<div class="signature field-var has-description has-plugin" id="zpp_inner_zn"><div class="plugin-name">nape</div><code><span class="field-name">zpp_inner_zn</span><span class="operator">:</span> <a href="/api-docs/unity/zpp_nape/shape/ZPP_Polygon/" class="type-link">zpp_nape.shape.ZPP_Polygon</a></code><a class="header-anchor" href="#zpp_inner_zn"><span aria-hidden="true" class="header-anchor__symbol">#</span></a></div>

@private

<hr class="field-separator" />

<div class="signature field-var has-description has-plugin" id="localVerts"><div class="plugin-name">nape</div><code><span class="field-name">localVerts</span><span class="operator">:</span> <a href="/api-docs/unity/nape/geom/Vec2List/" class="type-link">nape.geom.Vec2List</a></code><a class="header-anchor" href="#localVerts"><span aria-hidden="true" class="header-anchor__symbol">#</span></a></div>
...
| Name | Type | Default | Description |
|------|------|---------|-------------|
| `localVerts` | [Dynamic](/api-docs/unity/Dynamic/) | | The local vertices of polygon.  |
| `material` | [nape.phys.Material](/api-docs/unity/nape/phys/Material/) | `null` | The material for this polygon. (default new Material&#40;&#41;)  |
| `filter` | [nape.dynamics.InteractionFilter](/api-docs/unity/nape/dynamics/InteractionFilter/) | `null` | The interaction filter for this polygon. (default new InteractionFilter&#40;&#41;)  |
