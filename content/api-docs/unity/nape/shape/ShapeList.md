...
title: ShapeList
target: Unity
permalink: api-docs/unity/nape/shape/ShapeList/
---
...
|------|------|-------------|
| `array` | [Array](/api-docs/unity/Array/)<[Shape](/api-docs/unity/nape/shape/Shape/)> | The array to be converted  |

| Returns | Description |
|---------|-------------|
| [ShapeList](/api-docs/unity/nape/shape/ShapeList/) | An equivalent Nape list.  |

## Instance Members

<div class="signature field-var has-description has-plugin" id="zpp_inner"><div class="plugin-name">nape</div><code><span class="field-name">zpp_inner</span><span class="operator">:</span> <a href="/api-docs/unity/zpp_nape/util/ZPP_ShapeList/" class="type-link">zpp_nape.util.ZPP_ShapeList</a></code><a class="header-anchor" href="#zpp_inner"><span aria-hidden="true" class="header-anchor__symbol">#</span></a></div>
...
| Name | Type | Description |
|------|------|-------------|
| `obj` | [Shape](/api-docs/unity/nape/shape/Shape/) | The object to test.  |
...
| Returns |
|---------|
| [Shape](/api-docs/unity/nape/shape/Shape/) |
...
| Name | Type | Description |
|------|------|-------------|
| `obj` | [Shape](/api-docs/unity/nape/shape/Shape/) | The object to insert.  |
...
| Name | Type | Description |
|------|------|-------------|
| `obj` | [Shape](/api-docs/unity/nape/shape/Shape/) | The object to remove  |
...
| Returns |
|---------|
| [ShapeIterator](/api-docs/unity/nape/shape/ShapeIterator/) |
...
| Returns | Description |
|---------|-------------|
| [ShapeList](/api-docs/unity/nape/shape/ShapeList/) | The copied list. |
...
| Name | Type | Description |
|------|------|-------------|
| `xs` | [ShapeList](/api-docs/unity/nape/shape/ShapeList/) | The list to merge.  |
...
| Returns | Description |
|---------|-------------|
| [ShapeList](/api-docs/unity/nape/shape/ShapeList/) | A reference to 'this' list.  |
