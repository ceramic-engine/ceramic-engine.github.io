...
title: Vec2Iterator
target: Unity
permalink: api-docs/unity/nape/geom/Vec2Iterator/
---
...
|------|------|-------------|
| `list` | [Vec2List](/api-docs/unity/nape/geom/Vec2List/) | The Nape list to create iterator for.  |

| Returns | Description |
|---------|-------------|
| [Vec2Iterator](/api-docs/unity/nape/geom/Vec2Iterator/) | An iterator over the Nape list. |

## Instance Members

<div class="signature field-var has-description has-plugin" id="zpp_inner"><div class="plugin-name">nape</div><code><span class="field-name">zpp_inner</span><span class="operator">:</span> <a href="/api-docs/unity/nape/geom/Vec2List/" class="type-link">Vec2List</a></code><a class="header-anchor" href="#zpp_inner"><span aria-hidden="true" class="header-anchor__symbol">#</span></a></div>
...
| Returns | Description |
|---------|-------------|
| [Vec2](/api-docs/unity/nape/geom/Vec2/) | The next element in iteration. |
