...
title: Vec2List
target: Unity
permalink: api-docs/unity/nape/geom/Vec2List/
---
...
<div class="type-hierarchy"><strong>nape.geom.Vec2List</strong> (Class) → <a href="/api-docs/unity/zpp_nape/util/ZPP_MixVec2List/">zpp_nape.util.ZPP_MixVec2List</a></div>
...
|------|------|-------------|
| `array` | [Array](/api-docs/unity/Array/)<[Vec2](/api-docs/unity/nape/geom/Vec2/)> | The array to be converted  |

| Returns | Description |
|---------|-------------|
| [Vec2List](/api-docs/unity/nape/geom/Vec2List/) | An equivalent Nape list.  |

## Instance Members

<div class="signature field-var has-description has-plugin" id="zpp_inner"><div class="plugin-name">nape</div><code><span class="field-name">zpp_inner</span><span class="operator">:</span> <a href="/api-docs/unity/zpp_nape/util/ZPP_Vec2List/" class="type-link">zpp_nape.util.ZPP_Vec2List</a></code><a class="header-anchor" href="#zpp_inner"><span aria-hidden="true" class="header-anchor__symbol">#</span></a></div>
...
| Name | Type | Description |
|------|------|-------------|
| `obj` | [Vec2](/api-docs/unity/nape/geom/Vec2/) | The object to test.  |
...
| Returns |
|---------|
| [Vec2](/api-docs/unity/nape/geom/Vec2/) |
...
| Name | Type | Description |
|------|------|-------------|
| `obj` | [Vec2](/api-docs/unity/nape/geom/Vec2/) | The object to insert.  |
...
| Name | Type | Description |
|------|------|-------------|
| `obj` | [Vec2](/api-docs/unity/nape/geom/Vec2/) | The object to remove  |
...
| Returns |
|---------|
| [Vec2Iterator](/api-docs/unity/nape/geom/Vec2Iterator/) |
...
| Returns | Description |
|---------|-------------|
| [Vec2List](/api-docs/unity/nape/geom/Vec2List/) | The copied list. |
...
| Name | Type | Description |
|------|------|-------------|
| `xs` | [Vec2List](/api-docs/unity/nape/geom/Vec2List/) | The list to merge.  |
...
| Returns | Description |
|---------|-------------|
| [Vec2List](/api-docs/unity/nape/geom/Vec2List/) | A reference to 'this' list.  |
