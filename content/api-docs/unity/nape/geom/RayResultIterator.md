...
target: Unity
permalink: api-docs/unity/nape/geom/RayResultIterator/
---
...
|------|------|-------------|
| `list` | [RayResultList](/api-docs/unity/nape/geom/RayResultList/) | The Nape list to create iterator for.  |

| Returns | Description |
|---------|-------------|
| [RayResultIterator](/api-docs/unity/nape/geom/RayResultIterator/) | An iterator over the Nape list. |

## Instance Members

<div class="signature field-var has-description has-plugin" id="zpp_inner"><div class="plugin-name">nape</div><code><span class="field-name">zpp_inner</span><span class="operator">:</span> <a href="/api-docs/unity/nape/geom/RayResultList/" class="type-link">RayResultList</a></code><a class="header-anchor" href="#zpp_inner"><span aria-hidden="true" class="header-anchor__symbol">#</span></a></div>
...
| Returns | Description |
|---------|-------------|
| [RayResult](/api-docs/unity/nape/geom/RayResult/) | The next element in iteration. |
