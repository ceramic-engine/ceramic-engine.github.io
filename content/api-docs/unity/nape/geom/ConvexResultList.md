...
target: Unity
permalink: api-docs/unity/nape/geom/ConvexResultList/
---
...
|------|------|-------------|
| `array` | [Array](/api-docs/unity/Array/)<[ConvexResult](/api-docs/unity/nape/geom/ConvexResult/)> | The array to be converted  |

| Returns | Description |
|---------|-------------|
| [ConvexResultList](/api-docs/unity/nape/geom/ConvexResultList/) | An equivalent Nape list.  |

## Instance Members

<div class="signature field-var has-description has-plugin" id="zpp_inner"><div class="plugin-name">nape</div><code><span class="field-name">zpp_inner</span><span class="operator">:</span> <a href="/api-docs/unity/zpp_nape/util/ZPP_ConvexResultList/" class="type-link">zpp_nape.util.ZPP_ConvexResultList</a></code><a class="header-anchor" href="#zpp_inner"><span aria-hidden="true" class="header-anchor__symbol">#</span></a></div>
...
| Name | Type | Description |
|------|------|-------------|
| `obj` | [ConvexResult](/api-docs/unity/nape/geom/ConvexResult/) | The object to test.  |
...
| Returns |
|---------|
| [ConvexResult](/api-docs/unity/nape/geom/ConvexResult/) |
...
| Name | Type | Description |
|------|------|-------------|
| `obj` | [ConvexResult](/api-docs/unity/nape/geom/ConvexResult/) | The object to insert.  |
...
| Name | Type | Description |
|------|------|-------------|
| `obj` | [ConvexResult](/api-docs/unity/nape/geom/ConvexResult/) | The object to remove  |
...
| Returns |
|---------|
| [ConvexResultIterator](/api-docs/unity/nape/geom/ConvexResultIterator/) |
...
| Returns | Description |
|---------|-------------|
| [ConvexResultList](/api-docs/unity/nape/geom/ConvexResultList/) | The copied list. |
...
| Name | Type | Description |
|------|------|-------------|
| `xs` | [ConvexResultList](/api-docs/unity/nape/geom/ConvexResultList/) | The list to merge.  |
...
| Returns | Description |
|---------|-------------|
| [ConvexResultList](/api-docs/unity/nape/geom/ConvexResultList/) | A reference to 'this' list.  |
