...
target: Unity
permalink: api-docs/unity/elements/ScrollingLayout/
---
...
| `withBorders` | [Bool](/api-docs/unity/Bool/) | `false` | Whether to add visual borders (top border on content, bottom border on container) |
...
| Name | Type |
|------|------|
| `instance` | [ScrollingLayout](/api-docs/unity/elements/ScrollingLayout/)<elements.ScrollingLayout.T> |
...
|------|------|-------------|
| `delta` | [Float](/api-docs/unity/Float/) | Time delta since last update |
