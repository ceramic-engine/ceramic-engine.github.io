...
title: DragDrop
target: Unity
permalink: api-docs/unity/elements/DragDrop/
---
...
<div class="type-hierarchy"><a href="/api-docs/unity/ceramic/Entity/">ceramic.Entity</a> → <strong>elements.DragDrop</strong> (Class)</div>
...
|------|------|---------|-------------|
| `pointerX` | [Float](/api-docs/unity/Float/) | *(optional)* | X position to start drag from (defaults to current pointer position)  |
| `pointerY` | [Float](/api-docs/unity/Float/) | *(optional)* | Y position to start drag from (defaults to current pointer position) |
...
| Name | Type | Default | Description |
|------|------|---------|-------------|
| `threshold` | [Float](/api-docs/unity/Float/) | `4.0` | Minimum pointer movement to start drag (default: 4.0 pixels)  |
| `click` | [ceramic.Click](/api-docs/unity/ceramic/Click/) | *(optional)* | Optional click component to cancel when dragging starts  |
...
| Name | Type |
|------|------|
| `instance` | [DragDrop](/api-docs/unity/elements/DragDrop/) |
...
|------|------|-------------|
| `pointerX` | [Float](/api-docs/unity/Float/) | Current pointer X position in screen space  |
| `pointerY` | [Float](/api-docs/unity/Float/) | Current pointer Y position in screen space |
