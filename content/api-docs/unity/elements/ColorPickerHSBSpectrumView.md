...
target: Unity
permalink: api-docs/unity/elements/ColorPickerHSBSpectrumView/
---
...
<div class="see"><strong>See:</strong> <a href="/api-docs/unity/elements/ColorPickerView/">ColorPickerView</a>, <a href="/api-docs/unity/elements/ColorPickerHSBGradientView/">ColorPickerHSBGradientView</a></div>
...
| Name | Type |
|------|------|
| `instance` | [ColorPickerHSBSpectrumView](/api-docs/unity/elements/ColorPickerHSBSpectrumView/) |
...
|------|------|-------------|
| `hue` | [Float](/api-docs/unity/Float/) | The hue value in degrees (0-360)  |

| Returns | Description |
|---------|-------------|
| [ceramic.AlphaColor](/api-docs/unity/ceramic/AlphaColor/) | An AlphaColor with the specified hue at full saturation/brightness |
