...
title: TabFocusable
target: Unity
permalink: api-docs/unity/elements/TabFocusable/
---
...
<div class="type-hierarchy"><strong>elements.TabFocusable</strong> (Interface) → <a href="/api-docs/unity/elements/Button/">Button</a>, <a href="/api-docs/unity/elements/FieldView/">FieldView</a></div>
...
| Returns | Description |
|---------|-------------|
| [Bool](/api-docs/unity/Bool/) | true if the element can receive focus, false otherwise |
