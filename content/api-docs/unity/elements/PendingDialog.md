...
title: PendingDialog
target: Unity
permalink: api-docs/unity/elements/PendingDialog/
---
...
<div class="type-hierarchy"><a href="/api-docs/unity/ceramic/Entity/">ceramic.Entity</a> → <a href="/api-docs/unity/tracker/Model/">tracker.Model</a> → <strong>elements.PendingDialog</strong> (Class)</div>
...
|------|------|---------|-------------|
| `key` | [String](/api-docs/unity/String/) | *(optional)* | Optional unique identifier for the dialog  |
| `title` | [String](/api-docs/unity/String/) | | Title text for the dialog header  |
| `message` | [String](/api-docs/unity/String/) | | Main message text for the dialog body  |
| `prompt` | [Bool](/api-docs/unity/Bool/) | `false` | Whether to include a text input prompt  |
| `promptPointer` | [StringPointer](/api-docs/unity/elements/StringPointer/) | *(optional)* | Optional string pointer for prompt value binding  |
| `promptPlaceholder` | [String](/api-docs/unity/String/) | *(optional)* | Placeholder text for the prompt input  |
| `choices` | [Array](/api-docs/unity/Array/)<[String](/api-docs/unity/String/)> | | Array of button labels for user choices  |
| `cancelable` | [Bool](/api-docs/unity/Bool/) | `false` | Whether the dialog can be canceled  |
| `width` | [Float](/api-docs/unity/Float/) | `-1` | Fixed width (-1 for auto-sizing)  |
| `height` | [Float](/api-docs/unity/Float/) | `-1` | Fixed height (-1 for auto-sizing)  |
| `async` | [Bool](/api-docs/unity/Bool/) | | Whether the dialog operates asynchronously  |
