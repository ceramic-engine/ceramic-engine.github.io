...
target: Unity
permalink: api-docs/unity/elements/CellCollectionView/
---
...
<div class="see"><strong>See:</strong> CollectionView, <a href="/api-docs/unity/elements/Scrollbar/">Scrollbar</a>, <a href="/api-docs/unity/elements/Theme/">Theme</a></div>
...
| Name | Type |
|------|------|
| `instance` | [CellCollectionView](/api-docs/unity/elements/CellCollectionView/) |
...
|------|------|-------------|
| `delta` | [Float](/api-docs/unity/Float/) | Time elapsed since last frame (not used) |
