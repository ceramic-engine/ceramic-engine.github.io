...
target: Unity
permalink: api-docs/unity/elements/VisualContainerView/
---
...
<div class="see"><strong>See:</strong> <a href="/api-docs/unity/elements/VisualContainerViewScaling/">VisualContainerViewScaling</a>, Filter, Visual, LayoutAlign</div>
...
<div class="see"><strong>See:</strong> <a href="/api-docs/unity/elements/VisualContainerViewScaling/">VisualContainerViewScaling</a>, visualScale</div>
...
|------|------|-------------|
| `parentWidth` | [Float](/api-docs/unity/Float/) | Available width from the parent  |
| `parentHeight` | [Float](/api-docs/unity/Float/) | Available height from the parent  |
| `layoutMask` | [ceramic.ViewLayoutMask](/api-docs/unity/ceramic/ViewLayoutMask/) | Layout constraints mask  |
| `persist` | [Bool](/api-docs/unity/Bool/) | Whether to persist the computed values  |
