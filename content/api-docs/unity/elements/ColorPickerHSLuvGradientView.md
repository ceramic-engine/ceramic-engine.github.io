...
target: Unity
permalink: api-docs/unity/elements/ColorPickerHSLuvGradientView/
---
...
|------|------|---------|-------------|
| `lightness` | [Float](/api-docs/unity/Float/) | *(optional)* | Optional new lightness value (0-1) |
...
|------|------|-------------|
| `hue` | [Float](/api-docs/unity/Float/) | Hue value in degrees (0-360)  |
| `saturation` | [Float](/api-docs/unity/Float/) | Saturation value (0-1)  |

| Returns | Description |
|---------|-------------|
| [ceramic.AlphaColor](/api-docs/unity/ceramic/AlphaColor/) | The resulting color with full opacity |
