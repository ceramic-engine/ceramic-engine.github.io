...
title: World
target: Unity
permalink: api-docs/unity/arcade/World/
---
...
<div class="type-hierarchy"><strong>arcade.World</strong> (Class) → <a href="/api-docs/unity/ceramic/ArcadeWorld/">ceramic.ArcadeWorld</a></div>
...
| Returns | Description |
|---------|-------------|
| [QuadTree](/api-docs/unity/arcade/QuadTree/) | QuadTree |

<hr class="field-separator" />

<div class="signature field-method no-description has-plugin" id="releaseQuadTree"><div class="plugin-name">arcade</div><code><span class="field-name">releaseQuadTree</span><span class="parenthesis">(</span><span class="arg-name">quadTree</span><span class="operator">:</span> <a href="/api-docs/unity/arcade/QuadTree/" class="type-link">QuadTree</a><span class="parenthesis">)</span><span class="operator">:</span> <a href="/api-docs/unity/Void/" class="type-link">Void</a></code><a class="header-anchor" href="#releaseQuadTree"><span aria-hidden="true" class="header-anchor__symbol">#</span></a></div>


| Name | Type |
|------|------|
| `quadTree` | [QuadTree](/api-docs/unity/arcade/QuadTree/) |

<hr class="field-separator" />

<div class="signature field-method has-description has-plugin" id="setBounds"><div class="plugin-name">arcade</div><code><span class="field-name">setBounds</span><span class="parenthesis">(</span><span class="arg-name">x</span><span class="operator">:</span> <a href="/api-docs/unity/Float/" class="type-link">Float</a><span class="operator">,</span> <span class="arg-name">y</span><span class="operator">:</span> <a href="/api-docs/unity/Float/" class="type-link">Float</a><span class="operator">,</span> <span class="arg-name">width</span><span class="operator">:</span> <a href="/api-docs/unity/Float/" class="type-link">Float</a><span class="operator">,</span> <span class="arg-name">height</span><span class="operator">:</span> <a href="/api-docs/unity/Float/" class="type-link">Float</a><span class="parenthesis">)</span><span class="operator">:</span> <a href="/api-docs/unity/Void/" class="type-link">Void</a></code><a class="header-anchor" href="#setBounds"><span aria-hidden="true" class="header-anchor__symbol">#</span></a></div>
...
|------|------|-------------|
| `x` | [Float](/api-docs/unity/Float/) | Top left most corner of the world.  |
| `y` | [Float](/api-docs/unity/Float/) | Top left most corner of the world.  |
| `width` | [Float](/api-docs/unity/Float/) | New width of the world.  |
| `height` | [Float](/api-docs/unity/Float/) | New height of the world. |

<hr class="field-separator" />

<div class="signature field-method has-description has-plugin" id="enableBody"><div class="plugin-name">arcade</div><code><span class="field-name">enableBody</span><span class="parenthesis">(</span><span class="arg-name">body</span><span class="operator">:</span> <a href="/api-docs/unity/arcade/Body/" class="type-link">Body</a><span class="parenthesis">)</span><span class="operator">:</span> <a href="/api-docs/unity/Void/" class="type-link">Void</a></code><a class="header-anchor" href="#enableBody"><span aria-hidden="true" class="header-anchor__symbol">#</span></a></div>
...
|------|------|---------|-------------|
| `axis` | [Axis](/api-docs/unity/arcade/Axis/) | | 0 for nothing, 1 for horizontal, 2 for vertical.  |
| `body` | [Body](/api-docs/unity/arcade/Body/) | | The Body object to be updated.  |
...
| `drag` | [Float](/api-docs/unity/Float/) | | Really kind of a deceleration, this is how much the velocity changes if Acceleration is not set.  |
| `max` | [Float](/api-docs/unity/Float/) | `10000` | An absolute value cap for the velocity.  |
...
| Name | Type | Default |
|------|------|---------|
| `body1` | [Body](/api-docs/unity/arcade/Body/) | |
| `body2` | [Body](/api-docs/unity/arcade/Body/) | |
| `overlapCallback` | Function | *(optional)* |
| `processCallback` | Function | *(optional)* |

| Returns | Description |
|---------|-------------|
| [Bool](/api-docs/unity/Bool/) | True if an overlap occurred otherwise false. |
...
| Name | Type | Default |
|------|------|---------|
| `group1` | [Group](/api-docs/unity/arcade/Group/) | |
| `group2` | [Group](/api-docs/unity/arcade/Group/) | |
| `overlapCallback` | Function | *(optional)* |
| `processCallback` | Function | *(optional)* |
...
| Name | Type | Default |
|------|------|---------|
| `group` | [Group](/api-docs/unity/arcade/Group/) | |
| `overlapCallback` | Function | *(optional)* |
| `processCallback` | Function | *(optional)* |
...
| Returns | Description |
|---------|-------------|
| [Bool](/api-docs/unity/Bool/) | True if a collision occurred otherwise false. |
...
| Name | Type | Default | Description |
|------|------|---------|-------------|
| `group` | [Group](/api-docs/unity/arcade/Group/) | | The Group to sort.  |
| `sortDirection` | [SortDirection](/api-docs/unity/arcade/SortDirection/) | `SortDirection.INHERIT` | The sort direction used to sort this Group. |
...
| Name | Type | Description |
|------|------|-------------|
| `body1` | [Body](/api-docs/unity/arcade/Body/) | The first Body object to check.  |
| `body2` | [Body](/api-docs/unity/arcade/Body/) | The second Body object to check.  |

| Returns | Description |
|---------|-------------|
| [Bool](/api-docs/unity/Bool/) | True if they intersect, otherwise false. |
...
| Name | Type | Default | Description |
|------|------|---------|-------------|
| `x` | [Float](/api-docs/unity/Float/) | | The x coordinate to check.  |
| `y` | [Float](/api-docs/unity/Float/) | | The y coordinate to check.  |
| `group` | [Group](/api-docs/unity/arcade/Group/) | | The Group to check.  |
...
| Name | Type | Default | Description |
|------|------|---------|-------------|
| `body` | [Body](/api-docs/unity/arcade/Body/) | | The body to move.  |
| `destination` | [Body](/api-docs/unity/arcade/Body/) | | The body to move towards. Must have x/y properties.  |
| `speed` | [Float](/api-docs/unity/Float/) | `60` | The speed it will move, in pixels per second (default is 60 pixels/sec)  |
| `maxTime` | [Float](/api-docs/unity/Float/) | `0` | Time given in milliseconds (1000 = 1 sec). If set the speed is adjusted so the object will arrive at destination in the given number of ms.  |

| Returns | Description |
|---------|-------------|
| [Float](/api-docs/unity/Float/) | The angle (in radians) that the object should be visually set to in order to match its new velocity. |

<hr class="field-separator" />

<div class="signature field-method has-description has-plugin" id="moveToXY"><div class="plugin-name">arcade</div><code><span class="field-name">moveToXY</span><span class="parenthesis">(</span><span class="arg-name">body</span><span class="operator">:</span> <a href="/api-docs/unity/arcade/Body/" class="type-link">Body</a><span class="operator">,</span> <span class="arg-name">x</span><span class="operator">:</span> <a href="/api-docs/unity/Float/" class="type-link">Float</a><span class="operator">,</span> <span class="arg-name">y</span><span class="operator">:</span> <a href="/api-docs/unity/Float/" class="type-link">Float</a><span class="operator">,</span> <span class="operator">?</span><span class="arg-name">speed</span><span class="operator">:</span> <a href="/api-docs/unity/Float/" class="type-link">Float</a> <span class="operator">=</span> <span class="default-value">60</span><span class="operator">,</span> <span class="operator">?</span><span class="arg-name">maxTime</span><span class="operator">:</span> <a href="/api-docs/unity/Float/" class="type-link">Float</a> <span class="operator">=</span> <span class="default-value">0</span><span class="parenthesis">)</span><span class="operator">:</span> <a href="/api-docs/unity/Float/" class="type-link">Float</a></code><a class="header-anchor" href="#moveToXY"><span aria-hidden="true" class="header-anchor__symbol">#</span></a></div>
...
|------|------|---------|-------------|
| `body` | [Body](/api-docs/unity/arcade/Body/) | | The body to move.  |
| `x` | [Float](/api-docs/unity/Float/) | | The x coordinate to move towards.  |
| `y` | [Float](/api-docs/unity/Float/) | | The y coordinate to move towards.  |
| `speed` | [Float](/api-docs/unity/Float/) | `60` | The speed it will move, in pixels per second (default is 60 pixels/sec)  |
| `maxTime` | [Float](/api-docs/unity/Float/) | `0` | Time given in milliseconds (1000 = 1 sec). If set the speed is adjusted so the object will arrive at destination in the given number of ms.  |
...
| Name | Type | Default | Description |
|------|------|---------|-------------|
| `angle` | [Float](/api-docs/unity/Float/) | | The angle in degrees calculated in clockwise positive direction (down = 90 degrees positive, right = 0 degrees positive, up = 90 degrees negative)  |
| `speed` | [Float](/api-docs/unity/Float/) | `60` | The speed it will move, in pixels per second sq.  |
| `point` | [Point](/api-docs/unity/arcade/Point/) | *(optional)* | The Point object in which the x and y properties will be set to the calculated velocity.  |

| Returns | Description |
|---------|-------------|
| [Point](/api-docs/unity/arcade/Point/) | A Point where point.x contains the velocity x value and point.y contains the velocity y value. |

<hr class="field-separator" />

<div class="signature field-method has-description has-plugin" id="velocityFromRotation"><div class="plugin-name">arcade</div><code><span class="field-name">velocityFromRotation</span><span class="parenthesis">(</span><span class="arg-name">rotation</span><span class="operator">:</span> <a href="/api-docs/unity/Float/" class="type-link">Float</a><span class="operator">,</span> <span class="operator">?</span><span class="arg-name">speed</span><span class="operator">:</span> <a href="/api-docs/unity/Float/" class="type-link">Float</a> <span class="operator">=</span> <span class="default-value">60</span><span class="operator">,</span> <span class="operator">?</span><span class="arg-name">point</span><span class="operator">:</span> <a href="/api-docs/unity/arcade/Point/" class="type-link">Point</a><span class="parenthesis">)</span><span class="operator">:</span> <a href="/api-docs/unity/arcade/Point/" class="type-link">Point</a></code><a class="header-anchor" href="#velocityFromRotation"><span aria-hidden="true" class="header-anchor__symbol">#</span></a></div>
...
| Name | Type | Default | Description |
|------|------|---------|-------------|
| `rotation` | [Float](/api-docs/unity/Float/) | | The angle in radians.  |
| `speed` | [Float](/api-docs/unity/Float/) | `60` | The speed it will move, in pixels per second sq.  |
| `point` | [Point](/api-docs/unity/arcade/Point/) | *(optional)* | The Point object in which the x and y properties will be set to the calculated velocity.  |
...
| `body` | [Body](/api-docs/unity/arcade/Body/) | | The body to move.  |
| `destination` | [Body](/api-docs/unity/arcade/Body/) | | The body to move towards. Must have x/y properties.  |
| `speed` | [Float](/api-docs/unity/Float/) | `60` | The speed it will accelerate in pixels per second.  |
| `xSpeedMax` | [Float](/api-docs/unity/Float/) | `1000` | The maximum x velocity the body can reach.  |
| `ySpeedMax` | [Float](/api-docs/unity/Float/) | `1000` | The maximum y velocity the body can reach.  |

| Returns | Description |
|---------|-------------|
| [Float](/api-docs/unity/Float/) | The angle (in radians) that the object should be visually set to in order to match its new trajectory. |

<hr class="field-separator" />

<div class="signature field-method has-description has-plugin" id="accelerateToXY"><div class="plugin-name">arcade</div><code><span class="field-name">accelerateToXY</span><span class="parenthesis">(</span><span class="arg-name">body</span><span class="operator">:</span> <a href="/api-docs/unity/arcade/Body/" class="type-link">Body</a><span class="operator">,</span> <span class="arg-name">x</span><span class="operator">:</span> <a href="/api-docs/unity/Float/" class="type-link">Float</a><span class="operator">,</span> <span class="arg-name">y</span><span class="operator">:</span> <a href="/api-docs/unity/Float/" class="type-link">Float</a><span class="operator">,</span> <span class="operator">?</span><span class="arg-name">speed</span><span class="operator">:</span> <a href="/api-docs/unity/Float/" class="type-link">Float</a> <span class="operator">=</span> <span class="default-value">60</span><span class="operator">,</span> <span class="operator">?</span><span class="arg-name">xSpeedMax</span><span class="operator">:</span> <a href="/api-docs/unity/Float/" class="type-link">Float</a> <span class="operator">=</span> <span class="default-value">1000</span><span class="operator">,</span> <span class="operator">?</span><span class="arg-name">ySpeedMax</span><span class="operator">:</span> <a href="/api-docs/unity/Float/" class="type-link">Float</a> <span class="operator">=</span> <span class="default-value">1000</span><span class="parenthesis">)</span><span class="operator">:</span> <a href="/api-docs/unity/Float/" class="type-link">Float</a></code><a class="header-anchor" href="#accelerateToXY"><span aria-hidden="true" class="header-anchor__symbol">#</span></a></div>
...
|------|------|---------|-------------|
| `body` | [Body](/api-docs/unity/arcade/Body/) | | The body to move.  |
| `x` | [Float](/api-docs/unity/Float/) | | The x coordinate to accelerate towards.  |
| `y` | [Float](/api-docs/unity/Float/) | | The y coordinate to accelerate towards.  |
| `speed` | [Float](/api-docs/unity/Float/) | `60` | The speed it will accelerate in pixels per second.  |
| `xSpeedMax` | [Float](/api-docs/unity/Float/) | `1000` | The maximum x velocity the body can reach.  |
| `ySpeedMax` | [Float](/api-docs/unity/Float/) | `1000` | The maximum y velocity the body can reach.  |
...
| Name | Type | Default | Description |
|------|------|---------|-------------|
| `source` | [Body](/api-docs/unity/arcade/Body/) | | The Body to test from.  |
| `target` | [Body](/api-docs/unity/arcade/Body/) | | The Body to test to.  |
| `useCenter` | [Bool](/api-docs/unity/Bool/) | `false` | Calculate the distance using the centerX and centerY coordinates.  |

| Returns | Description |
|---------|-------------|
| [Float](/api-docs/unity/Float/) | The distance between the source and target objects. |

<hr class="field-separator" />

<div class="signature field-method has-description has-plugin" id="distanceToXY"><div class="plugin-name">arcade</div><code><span class="field-name">distanceToXY</span><span class="parenthesis">(</span><span class="arg-name">body</span><span class="operator">:</span> <a href="/api-docs/unity/arcade/Body/" class="type-link">Body</a><span class="operator">,</span> <span class="arg-name">x</span><span class="operator">:</span> <a href="/api-docs/unity/Float/" class="type-link">Float</a><span class="operator">,</span> <span class="arg-name">y</span><span class="operator">:</span> <a href="/api-docs/unity/Float/" class="type-link">Float</a><span class="parenthesis">)</span><span class="operator">:</span> <a href="/api-docs/unity/Float/" class="type-link">Float</a></code><a class="header-anchor" href="#distanceToXY"><span aria-hidden="true" class="header-anchor__symbol">#</span></a></div>
...
| Name | Type | Default | Description |
|------|------|---------|-------------|
| `source` | [Body](/api-docs/unity/arcade/Body/) | | The Body distances will be measured from.  |
| `targets` | [Array](/api-docs/unity/Array/)<[Body](/api-docs/unity/arcade/Body/)> | | The Bodies whose distances to the source will be compared.  |
| `world` | [Bool](/api-docs/unity/Bool/) | `false` | Calculate the distance using World coordinates (true), or Object coordinates (false, the default). If `useCenter` is true, this value is ignored.  |
| `useCenter` | [Bool](/api-docs/unity/Bool/) | `false` | Calculate the distance using the centerX and centerY coordinates. If true, this value overrides the `world` argument.  |

| Returns | Description |
|---------|-------------|
| [Body](/api-docs/unity/arcade/Body/) | The first target closest to the origin. |

<hr class="field-separator" />

<div class="signature field-method has-description has-plugin" id="farthest"><div class="plugin-name">arcade</div><code><span class="field-name">farthest</span><span class="parenthesis">(</span><span class="arg-name">source</span><span class="operator">:</span> <a href="/api-docs/unity/arcade/Body/" class="type-link">Body</a><span class="operator">,</span> <span class="arg-name">targets</span><span class="operator">:</span> <a href="/api-docs/unity/Array/" class="type-link">Array</a><span class="operator">&lt;</span><a href="/api-docs/unity/arcade/Body/" class="type-link">Body</a><span class="operator">&gt;</span><span class="operator">,</span> <span class="operator">?</span><span class="arg-name">useCenter</span><span class="operator">:</span> <a href="/api-docs/unity/Bool/" class="type-link">Bool</a> <span class="operator">=</span> <span class="default-value">false</span><span class="parenthesis">)</span><span class="operator">:</span> <a href="/api-docs/unity/arcade/Body/" class="type-link">Body</a></code><a class="header-anchor" href="#farthest"><span aria-hidden="true" class="header-anchor__symbol">#</span></a></div>
...
| Returns | Description |
|---------|-------------|
| [Body](/api-docs/unity/arcade/Body/) | The target farthest from the origin. |

<hr class="field-separator" />

<div class="signature field-method has-description has-plugin" id="angleBetween"><div class="plugin-name">arcade</div><code><span class="field-name">angleBetween</span><span class="parenthesis">(</span><span class="arg-name">source</span><span class="operator">:</span> <a href="/api-docs/unity/arcade/Body/" class="type-link">Body</a><span class="operator">,</span> <span class="arg-name">target</span><span class="operator">:</span> <a href="/api-docs/unity/arcade/Body/" class="type-link">Body</a><span class="parenthesis">)</span><span class="operator">:</span> <a href="/api-docs/unity/Float/" class="type-link">Float</a></code><a class="header-anchor" href="#angleBetween"><span aria-hidden="true" class="header-anchor__symbol">#</span></a></div>
...
| Returns | Description |
|---------|-------------|
| [Float](/api-docs/unity/Float/) | The angle in radians between the source and target bodies. |

<hr class="field-separator" />

<div class="signature field-method has-description has-plugin" id="angleBetweenCenters"><div class="plugin-name">arcade</div><code><span class="field-name">angleBetweenCenters</span><span class="parenthesis">(</span><span class="arg-name">source</span><span class="operator">:</span> <a href="/api-docs/unity/arcade/Body/" class="type-link">Body</a><span class="operator">,</span> <span class="arg-name">target</span><span class="operator">:</span> <a href="/api-docs/unity/arcade/Body/" class="type-link">Body</a><span class="parenthesis">)</span><span class="operator">:</span> <a href="/api-docs/unity/Float/" class="type-link">Float</a></code><a class="header-anchor" href="#angleBetweenCenters"><span aria-hidden="true" class="header-anchor__symbol">#</span></a></div>
...
|------|------|-------------|
| `body` | [Body](/api-docs/unity/arcade/Body/) | The Body to test from.  |
| `x` | [Float](/api-docs/unity/Float/) | The x coordinate to get the angle to.  |
| `y` | [Float](/api-docs/unity/Float/) | The y coordinate to get the angle to.  |

| Returns | Description |
|---------|-------------|
| [Float](/api-docs/unity/Float/) | The angle in radians between body.x/y to x/y |
...
| Name | Type | Default | Description |
|------|------|---------|-------------|
| `body1` | [Body](/api-docs/unity/arcade/Body/) | | The first Body object to separate.  |
| `body2` | [Body](/api-docs/unity/arcade/Body/) | | The second Body object to separate.  |
...
| `overlapOnly` | [Bool](/api-docs/unity/Bool/) | | Just run an overlap or a full collision.  |

| Returns | Description |
|---------|-------------|
| [Bool](/api-docs/unity/Bool/) | Returns true if the bodies collided, otherwise false. |

<hr class="field-separator" />

<div class="signature field-method has-description has-plugin" id="circleBodyIntersects"><div class="plugin-name">arcade</div><code><span class="field-name">circleBodyIntersects</span><span class="parenthesis">(</span><span class="arg-name">circle</span><span class="operator">:</span> <a href="/api-docs/unity/arcade/Body/" class="type-link">Body</a><span class="operator">,</span> <span class="arg-name">body</span><span class="operator">:</span> <a href="/api-docs/unity/arcade/Body/" class="type-link">Body</a><span class="parenthesis">)</span><span class="operator">:</span> <a href="/api-docs/unity/Bool/" class="type-link">Bool</a></code><a class="header-anchor" href="#circleBodyIntersects"><span aria-hidden="true" class="header-anchor__symbol">#</span></a></div>
...
| Name | Type | Description |
|------|------|-------------|
| `circle` | [Body](/api-docs/unity/arcade/Body/) | The Body with `isCircle` set.  |
| `body` | [Body](/api-docs/unity/arcade/Body/) | The Body with `isCircle` not set (i.e. uses Rectangle shape)  |

| Returns | Description |
|---------|-------------|
| [Bool](/api-docs/unity/Bool/) | Returns true if the bodies intersect, otherwise false. |

<hr class="field-separator" />

<div class="signature field-method has-description has-plugin" id="separateCircle"><div class="plugin-name">arcade</div><code><span class="field-name">separateCircle</span><span class="parenthesis">(</span><span class="arg-name">body1</span><span class="operator">:</span> <a href="/api-docs/unity/arcade/Body/" class="type-link">Body</a><span class="operator">,</span> <span class="arg-name">body2</span><span class="operator">:</span> <a href="/api-docs/unity/arcade/Body/" class="type-link">Body</a><span class="operator">,</span> <span class="arg-name">overlapOnly</span><span class="operator">:</span> <a href="/api-docs/unity/Bool/" class="type-link">Bool</a><span class="parenthesis">)</span><span class="operator">:</span> <a href="/api-docs/unity/Bool/" class="type-link">Bool</a></code><a class="header-anchor" href="#separateCircle"><span aria-hidden="true" class="header-anchor__symbol">#</span></a></div>
...
| Name | Type | Description |
|------|------|-------------|
| `body1` | [Body](/api-docs/unity/arcade/Body/) | The first Body to separate. Must have `Body.isCircle` true and a positive `radius`.  |
| `body2` | [Body](/api-docs/unity/arcade/Body/) | The second Body to separate. Must have `Body.isCircle` true and a positive `radius`.  |
| `overlapOnly` | [Bool](/api-docs/unity/Bool/) | If true the bodies will only have their overlap data set, no separation or exchange of velocity will take place.  |

| Returns | Description |
|---------|-------------|
| [Bool](/api-docs/unity/Bool/) | Returns true if the bodies were separated or overlap, otherwise false. |

<hr class="field-separator" />

<div class="signature field-method has-description has-plugin" id="getOverlapX"><div class="plugin-name">arcade</div><code><span class="field-name">getOverlapX</span><span class="parenthesis">(</span><span class="arg-name">body1</span><span class="operator">:</span> <a href="/api-docs/unity/arcade/Body/" class="type-link">Body</a><span class="operator">,</span> <span class="arg-name">body2</span><span class="operator">:</span> <a href="/api-docs/unity/arcade/Body/" class="type-link">Body</a><span class="operator">,</span> <span class="operator">?</span><span class="arg-name">overlapOnly</span><span class="operator">:</span> <a href="/api-docs/unity/Bool/" class="type-link">Bool</a> <span class="operator">=</span> <span class="default-value">false</span><span class="parenthesis">)</span><span class="operator">:</span> <a href="/api-docs/unity/Float/" class="type-link">Float</a></code><a class="header-anchor" href="#getOverlapX"><span aria-hidden="true" class="header-anchor__symbol">#</span></a></div>
...
| Name | Type | Default | Description |
|------|------|---------|-------------|
| `body1` | [Body](/api-docs/unity/arcade/Body/) | | The first Body to separate.  |
| `body2` | [Body](/api-docs/unity/arcade/Body/) | | The second Body to separate.  |
| `overlapOnly` | [Bool](/api-docs/unity/Bool/) | `false` | Is this an overlap only check, or part of separation?  |

| Returns | Description |
|---------|-------------|
| [Float](/api-docs/unity/Float/) | Returns the amount of horizontal overlap between the two bodies. |

<hr class="field-separator" />

<div class="signature field-method has-description has-plugin" id="getOverlapY"><div class="plugin-name">arcade</div><code><span class="field-name">getOverlapY</span><span class="parenthesis">(</span><span class="arg-name">body1</span><span class="operator">:</span> <a href="/api-docs/unity/arcade/Body/" class="type-link">Body</a><span class="operator">,</span> <span class="arg-name">body2</span><span class="operator">:</span> <a href="/api-docs/unity/arcade/Body/" class="type-link">Body</a><span class="operator">,</span> <span class="operator">?</span><span class="arg-name">overlapOnly</span><span class="operator">:</span> <a href="/api-docs/unity/Bool/" class="type-link">Bool</a> <span class="operator">=</span> <span class="default-value">false</span><span class="parenthesis">)</span><span class="operator">:</span> <a href="/api-docs/unity/Float/" class="type-link">Float</a></code><a class="header-anchor" href="#getOverlapY"><span aria-hidden="true" class="header-anchor__symbol">#</span></a></div>
...
| Returns | Description |
|---------|-------------|
| [Float](/api-docs/unity/Float/) | Returns the amount of vertical overlap between the two bodies. |

<hr class="field-separator" />

<div class="signature field-method has-description has-plugin" id="separateX"><div class="plugin-name">arcade</div><code><span class="field-name">separateX</span><span class="parenthesis">(</span><span class="arg-name">body1</span><span class="operator">:</span> <a href="/api-docs/unity/arcade/Body/" class="type-link">Body</a><span class="operator">,</span> <span class="arg-name">body2</span><span class="operator">:</span> <a href="/api-docs/unity/arcade/Body/" class="type-link">Body</a><span class="operator">,</span> <span class="arg-name">overlapOnly</span><span class="operator">:</span> <a href="/api-docs/unity/Bool/" class="type-link">Bool</a><span class="parenthesis">)</span><span class="operator">:</span> <a href="/api-docs/unity/Bool/" class="type-link">Bool</a></code><a class="header-anchor" href="#separateX"><span aria-hidden="true" class="header-anchor__symbol">#</span></a></div>
