...
title: Line
target: Unity
permalink: api-docs/unity/arcade/Line/
---
...
|------|------|-------------|
| `x` | [Float](/api-docs/unity/Float/) | The x coordinate of the start point.  |
| `y` | [Float](/api-docs/unity/Float/) | The y coordinate of the start point.  |
| `angle` | [Float](/api-docs/unity/Float/) | The angle in radians.  |
| `length` | [Float](/api-docs/unity/Float/) | The length of the line. |
...
| Name | Type | Description |
|------|------|-------------|
| `x1` | [Float](/api-docs/unity/Float/) | The x coordinate of the start point.  |
| `y1` | [Float](/api-docs/unity/Float/) | The y coordinate of the start point.  |
| `x2` | [Float](/api-docs/unity/Float/) | The x coordinate of the end point.  |
| `y2` | [Float](/api-docs/unity/Float/) | The y coordinate of the end point. |
