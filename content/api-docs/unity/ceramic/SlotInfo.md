...
title: SlotInfo
target: Unity
permalink: api-docs/unity/ceramic/SlotInfo/
---
...
<div class="signature field-var has-description has-plugin" id="transform"><div class="plugin-name">spine</div><code><span class="field-name">transform</span><span class="operator">:</span> <a href="/api-docs/unity/ceramic/Transform/" class="type-link">Transform</a></code><a class="header-anchor" href="#transform"><span aria-hidden="true" class="header-anchor__symbol">#</span></a></div>
