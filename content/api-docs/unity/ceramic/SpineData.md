...
title: SpineData
target: Unity
permalink: api-docs/unity/ceramic/SpineData/
---
...
<div class="type-hierarchy"><a href="/api-docs/unity/ceramic/Entity/">Entity</a> → <strong>ceramic.SpineData</strong> (Class)</div>
...
|------|------|-------------|
| `slotName` | [String](/api-docs/unity/String/) | The name of the slot to find  |

| Returns | Description |
|---------|-------------|
| [Int](/api-docs/unity/Int/) | The index of the slot if found, or -1 if the slot doesn't exist or if slotName is null * ```haxe var spineData = assets.spine(Spines.HERO); var weaponSlotIndex = spineData.findSlotIndex("weapon"); * if (weaponSlotIndex != -1) { // Use the index for efficient slot operations trace("Weapon slot found at index: " + weaponSlotIndex); } ``` |
...
|------|------|---------|-------------|
| `atlas` | [spine.support.graphics.TextureAtlas](/api-docs/unity/spine/support/graphics/TextureAtlas/) | | The texture atlas containing all images for the animation  |
| `json` | [spine.support.utils.JsonValue](/api-docs/unity/spine/support/utils/JsonValue/) | | The parsed JSON data exported from Spine  |
| `scale` | [Float](/api-docs/unity/Float/) | `1.0` | Optional scale factor to apply to the skeleton data (default: 1.0). This affects the size of the animation when rendered. |
