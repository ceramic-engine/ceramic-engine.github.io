...
title: GeometryUtils
target: Unity
permalink: api-docs/unity/ceramic/GeometryUtils/
---
...
| `ax` | [Float](/api-docs/unity/Float/) | The x-coordinate of the first triangle vertex  |
| `ay` | [Float](/api-docs/unity/Float/) | The y-coordinate of the first triangle vertex  |
| `bx` | [Float](/api-docs/unity/Float/) | The x-coordinate of the second triangle vertex  |
| `by` | [Float](/api-docs/unity/Float/) | The y-coordinate of the second triangle vertex  |
| `cx` | [Float](/api-docs/unity/Float/) | The x-coordinate of the third triangle vertex  |
| `cy` | [Float](/api-docs/unity/Float/) | The y-coordinate of the third triangle vertex  |

| Returns | Description |
|---------|-------------|
| [Bool](/api-docs/unity/Bool/) | `true` if the point is inside or on the edge of the triangle, `false` otherwise |

<hr class="field-separator" />

<div class="signature field-method has-description" id="pointInRectangle"><code><span class="field-name">pointInRectangle</span><span class="parenthesis">(</span><span class="arg-name">x</span><span class="operator">:</span> <a href="/api-docs/unity/Float/" class="type-link">Float</a><span class="operator">,</span> <span class="arg-name">y</span><span class="operator">:</span> <a href="/api-docs/unity/Float/" class="type-link">Float</a><span class="operator">,</span> <span class="arg-name">rectX</span><span class="operator">:</span> <a href="/api-docs/unity/Float/" class="type-link">Float</a><span class="operator">,</span> <span class="arg-name">rectY</span><span class="operator">:</span> <a href="/api-docs/unity/Float/" class="type-link">Float</a><span class="operator">,</span> <span class="arg-name">rectWidth</span><span class="operator">:</span> <a href="/api-docs/unity/Float/" class="type-link">Float</a><span class="operator">,</span> <span class="arg-name">rectHeight</span><span class="operator">:</span> <a href="/api-docs/unity/Float/" class="type-link">Float</a><span class="parenthesis">)</span><span class="operator">:</span> <a href="/api-docs/unity/Bool/" class="type-link">Bool</a></code><a class="header-anchor" href="#pointInRectangle"><span aria-hidden="true" class="header-anchor__symbol">#</span></a></div>
...
| `x` | [Float](/api-docs/unity/Float/) | The x-coordinate of the point to test  |
| `y` | [Float](/api-docs/unity/Float/) | The y-coordinate of the point to test  |
| `rectX` | [Float](/api-docs/unity/Float/) | The x-coordinate of the rectangle's top-left corner  |
| `rectY` | [Float](/api-docs/unity/Float/) | The y-coordinate of the rectangle's top-left corner  |
| `rectWidth` | [Float](/api-docs/unity/Float/) | The width of the rectangle  |
| `rectHeight` | [Float](/api-docs/unity/Float/) | The height of the rectangle  |

| Returns | Description |
|---------|-------------|
| [Bool](/api-docs/unity/Bool/) | `true` if the point is inside the rectangle, `false` otherwise |

<hr class="field-separator" />

<div class="signature field-method has-description" id="pointInCircle"><code><span class="field-name">pointInCircle</span><span class="parenthesis">(</span><span class="arg-name">x</span><span class="operator">:</span> <a href="/api-docs/unity/Float/" class="type-link">Float</a><span class="operator">,</span> <span class="arg-name">y</span><span class="operator">:</span> <a href="/api-docs/unity/Float/" class="type-link">Float</a><span class="operator">,</span> <span class="arg-name">cx</span><span class="operator">:</span> <a href="/api-docs/unity/Float/" class="type-link">Float</a><span class="operator">,</span> <span class="arg-name">cy</span><span class="operator">:</span> <a href="/api-docs/unity/Float/" class="type-link">Float</a><span class="operator">,</span> <span class="arg-name">radius</span><span class="operator">:</span> <a href="/api-docs/unity/Float/" class="type-link">Float</a><span class="parenthesis">)</span><span class="operator">:</span> <a href="/api-docs/unity/Bool/" class="type-link">Bool</a></code><a class="header-anchor" href="#pointInCircle"><span aria-hidden="true" class="header-anchor__symbol">#</span></a></div>
...
| Name | Type | Description |
|------|------|-------------|
| `x0` | [Float](/api-docs/unity/Float/) | The x-coordinate of the first circle's center  |
| `y0` | [Float](/api-docs/unity/Float/) | The y-coordinate of the first circle's center  |
| `r0` | [Float](/api-docs/unity/Float/) | The radius of the first circle  |
| `x1` | [Float](/api-docs/unity/Float/) | The x-coordinate of the second circle's center  |
| `y1` | [Float](/api-docs/unity/Float/) | The y-coordinate of the second circle's center  |
| `r1` | [Float](/api-docs/unity/Float/) | The radius of the second circle  |

| Returns | Description |
|---------|-------------|
| [Bool](/api-docs/unity/Bool/) | `true` if the circles intersect or touch, `false` otherwise |
...
| Name | Type | Description |
|------|------|-------------|
| `x1` | [Float](/api-docs/unity/Float/) | The x-coordinate of the first point  |
| `y1` | [Float](/api-docs/unity/Float/) | The y-coordinate of the first point  |
| `x2` | [Float](/api-docs/unity/Float/) | The x-coordinate of the second point  |
| `y2` | [Float](/api-docs/unity/Float/) | The y-coordinate of the second point  |

| Returns | Description |
|---------|-------------|
| [Float](/api-docs/unity/Float/) | The distance between the two points |

<hr class="field-separator" />

<div class="signature field-method has-description" id="squareDistance"><code><span class="field-name">squareDistance</span><span class="parenthesis">(</span><span class="arg-name">x1</span><span class="operator">:</span> <a href="/api-docs/unity/Float/" class="type-link">Float</a><span class="operator">,</span> <span class="arg-name">y1</span><span class="operator">:</span> <a href="/api-docs/unity/Float/" class="type-link">Float</a><span class="operator">,</span> <span class="arg-name">x2</span><span class="operator">:</span> <a href="/api-docs/unity/Float/" class="type-link">Float</a><span class="operator">,</span> <span class="arg-name">y2</span><span class="operator">:</span> <a href="/api-docs/unity/Float/" class="type-link">Float</a><span class="parenthesis">)</span><span class="operator">:</span> <a href="/api-docs/unity/Float/" class="type-link">Float</a></code><a class="header-anchor" href="#squareDistance"><span aria-hidden="true" class="header-anchor__symbol">#</span></a></div>
...
| Returns | Description |
|---------|-------------|
| [Float](/api-docs/unity/Float/) | The squared distance between the two points |
...
| Name | Type | Description |
|------|------|-------------|
| `x0` | [Float](/api-docs/unity/Float/) | The x-coordinate of the starting point  |
| `y0` | [Float](/api-docs/unity/Float/) | The y-coordinate of the starting point  |
| `x1` | [Float](/api-docs/unity/Float/) | The x-coordinate of the target point  |
| `y1` | [Float](/api-docs/unity/Float/) | The y-coordinate of the target point  |

| Returns | Description |
|---------|-------------|
| [Float](/api-docs/unity/Float/) | The angle in degrees (0-360), measured clockwise from up |

<hr class="field-separator" />

<div class="signature field-method has-description" id="angleDelta"><code><span class="field-name">angleDelta</span><span class="parenthesis">(</span><span class="arg-name">angle0</span><span class="operator">:</span> <a href="/api-docs/unity/Float/" class="type-link">Float</a><span class="operator">,</span> <span class="arg-name">angle1</span><span class="operator">:</span> <a href="/api-docs/unity/Float/" class="type-link">Float</a><span class="parenthesis">)</span><span class="operator">:</span> <a href="/api-docs/unity/Float/" class="type-link">Float</a></code><a class="header-anchor" href="#angleDelta"><span aria-hidden="true" class="header-anchor__symbol">#</span></a></div>
...
| Name | Type | Description |
|------|------|-------------|
| `angle0` | [Float](/api-docs/unity/Float/) | The starting angle in degrees  |
| `angle1` | [Float](/api-docs/unity/Float/) | The target angle in degrees  |

| Returns | Description |
|---------|-------------|
| [Float](/api-docs/unity/Float/) | The angular difference in degrees (-180 to 180) |

<hr class="field-separator" />

<div class="signature field-method has-description" id="clampDegrees"><code><span class="field-name">clampDegrees</span><span class="parenthesis">(</span><span class="arg-name">deg</span><span class="operator">:</span> <a href="/api-docs/unity/Float/" class="type-link">Float</a><span class="parenthesis">)</span><span class="operator">:</span> <a href="/api-docs/unity/Float/" class="type-link">Float</a></code><a class="header-anchor" href="#clampDegrees"><span aria-hidden="true" class="header-anchor__symbol">#</span></a></div>
...
| Name | Type | Description |
|------|------|-------------|
| `angle` | [Float](/api-docs/unity/Float/) | The angle in degrees (0° = up, 90° = right, etc.)  |
| `result` | [Point](/api-docs/unity/ceramic/Point/) | The Point object to store the resulting direction vector  |

| Returns | Description |
|---------|-------------|
| [Point](/api-docs/unity/ceramic/Point/) | The result object for method chaining |
...
| Name | Type | Description |
|------|------|-------------|
| `vertices` | [Array](/api-docs/unity/Array/)<[Float](/api-docs/unity/Float/)> | Array of polygon vertices in the format [x0,y0,x1,y1,x2,y2,...]  |
| `offset` | [Int](/api-docs/unity/Int/) | Starting index in the vertices array (must be even)  |
| `count` | [Int](/api-docs/unity/Int/) | Number of array elements to process (must be even, minimum 6 for a triangle)  |

| Returns | Description |
|---------|-------------|
| [Bool](/api-docs/unity/Bool/) | `true` if vertices are ordered clockwise, `false` if counter-clockwise |
