...
title: DatabaseAsset
target: Unity
permalink: api-docs/unity/ceramic/DatabaseAsset/
---
...
<div class="type-hierarchy"><a href="/api-docs/unity/ceramic/Entity/">Entity</a> → <a href="/api-docs/unity/ceramic/Asset/">Asset</a> → <strong>ceramic.DatabaseAsset</strong> (Class)</div>
...
<div class="see"><strong>See:</strong> <a href="/api-docs/unity/ceramic/Asset/">Asset</a>, <a href="/api-docs/unity/ceramic/Csv/">Csv</a></div>
...
<div class="signature field-method has-description" id="emitDatabaseChange"><code><span class="field-name">emitDatabaseChange</span><span class="parenthesis">(</span><span class="arg-name">current</span><span class="operator">:</span> <a href="/api-docs/unity/Array/" class="type-link">Array</a><span class="operator">&lt;</span><a href="/api-docs/unity/haxe/DynamicAccess/" class="type-link">haxe.DynamicAccess</a><span class="operator">&lt;</span><a href="/api-docs/unity/String/" class="type-link">String</a><span class="operator">&gt;</span><span class="operator">&gt;</span><span class="operator">,</span> <span class="arg-name">previous</span><span class="operator">:</span> <a href="/api-docs/unity/Array/" class="type-link">Array</a><span class="operator">&lt;</span><a href="/api-docs/unity/haxe/DynamicAccess/" class="type-link">haxe.DynamicAccess</a><span class="operator">&lt;</span><a href="/api-docs/unity/String/" class="type-link">String</a><span class="operator">&gt;</span><span class="operator">&gt;</span><span class="parenthesis">)</span><span class="operator">:</span> <a href="/api-docs/unity/Void/" class="type-link">Void</a></code><a class="header-anchor" href="#emitDatabaseChange"><span aria-hidden="true" class="header-anchor__symbol">#</span></a></div>

Event when database field changes.

| Name | Type |
|------|------|
| `current` | [Array](/api-docs/unity/Array/)<[haxe.DynamicAccess](/api-docs/unity/haxe/DynamicAccess/)<[String](/api-docs/unity/String/)>> |
| `previous` | [Array](/api-docs/unity/Array/)<[haxe.DynamicAccess](/api-docs/unity/haxe/DynamicAccess/)<[String](/api-docs/unity/String/)>> |
