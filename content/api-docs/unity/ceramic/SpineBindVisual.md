...
target: Unity
permalink: api-docs/unity/ceramic/SpineBindVisual/
---
...
|------|------|-------------|
| `spine` | [Spine](/api-docs/unity/ceramic/Spine/) | The Spine instance  |
| `slotName` | [String](/api-docs/unity/String/) | Name of the slot to hide |

<hr class="field-separator" />

<div class="signature field-method has-description has-plugin" id="showSlot"><div class="plugin-name">spine</div><code><span class="field-name">showSlot</span><span class="parenthesis">(</span><span class="arg-name">spine</span><span class="operator">:</span> <a href="/api-docs/unity/ceramic/Spine/" class="type-link">Spine</a><span class="operator">,</span> <span class="arg-name">slotName</span><span class="operator">:</span> <a href="/api-docs/unity/String/" class="type-link">String</a><span class="parenthesis">)</span><span class="operator">:</span> <a href="/api-docs/unity/Void/" class="type-link">Void</a></code><a class="header-anchor" href="#showSlot"><span aria-hidden="true" class="header-anchor__symbol">#</span></a></div>
...
|------|------|---------|-------------|
| `spine` | [Spine](/api-docs/unity/ceramic/Spine/) | | The Spine instance to bind to  |
| `slotName` | [String](/api-docs/unity/String/) | | Name of the slot to follow  |
| `visual` | [Visual](/api-docs/unity/ceramic/Visual/) | | The Ceramic visual to attach  |
| `offsetX` | [Float](/api-docs/unity/Float/) | `0.0` | Horizontal offset from the slot position  |
| `offsetY` | [Float](/api-docs/unity/Float/) | `0.0` | Vertical offset from the slot position  |

| Returns | Description |
|---------|-------------|
| [SpineBindVisualOptions](/api-docs/unity/ceramic/SpineBindVisualOptions/) | Configuration options for customizing the binding behavior |
