...
title: TimelineTrack
target: Unity
permalink: api-docs/unity/ceramic/TimelineTrack/
---
...
<div class="type-hierarchy"><a href="/api-docs/unity/ceramic/Entity/">Entity</a> → <strong>ceramic.TimelineTrack</strong> (Class) → <a href="/api-docs/unity/ceramic/TimelineBoolTrack/">TimelineBoolTrack</a>, <a href="/api-docs/unity/ceramic/TimelineColorTrack/">TimelineColorTrack</a>, <a href="/api-docs/unity/ceramic/TimelineDegreesTrack/">TimelineDegreesTrack</a>, <a href="/api-docs/unity/ceramic/TimelineFloatArrayTrack/">TimelineFloatArrayTrack</a>, <a href="/api-docs/unity/ceramic/TimelineFloatTrack/">TimelineFloatTrack</a></div>
...
<div class="see"><strong>See:</strong> <a href="/api-docs/unity/ceramic/Timeline/">Timeline</a>, <a href="/api-docs/unity/ceramic/TimelineKeyframe/">TimelineKeyframe</a></div>
...
|------|------|---------|-------------|
| `forceChange` | [Bool](/api-docs/unity/Bool/) | `false` | If true, forces the update even if the value hasn't changed |
...
| Name | Type | Description |
|------|------|-------------|
| `index` | [Int](/api-docs/unity/Int/) | The frame index to search for  |

| Returns | Description |
|---------|-------------|
| [Null](/api-docs/unity/Null/)<ceramic.TimelineTrack.K> | The keyframe at that index, or null if none exists |
...
| Name | Type | Description |
|------|------|-------------|
| `position` | [Float](/api-docs/unity/Float/) | The position to search from  |

| Returns | Description |
|---------|-------------|
| [Null](/api-docs/unity/Null/)<ceramic.TimelineTrack.K> | The keyframe at or before the position, or null if none exists |
...
| Returns | Description |
|---------|-------------|
| [Null](/api-docs/unity/Null/)<ceramic.TimelineTrack.K> | The keyframe after the position, or null if none exists |
