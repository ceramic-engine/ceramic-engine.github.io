...
title: TilemapQuad
target: Unity
permalink: api-docs/unity/ceramic/TilemapQuad/
---
...
<div class="type-hierarchy"><a href="/api-docs/unity/ceramic/Entity/">Entity</a> → <a href="/api-docs/unity/ceramic/Visual/">Visual</a> → <a href="/api-docs/unity/ceramic/Quad/">Quad</a> → <strong>ceramic.TilemapQuad</strong> (Class)</div>
...
| Returns | Description |
|---------|-------------|
| [TilemapQuad](/api-docs/unity/ceramic/TilemapQuad/) | A TilemapQuad instance ready for configuration |
