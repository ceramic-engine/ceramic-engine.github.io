...
target: Unity
permalink: api-docs/unity/ceramic/VisualArcadePhysics/
---
...
<div class="type-hierarchy"><a href="/api-docs/unity/ceramic/Entity/">Entity</a> → <strong>ceramic.VisualArcadePhysics</strong> (Class)</div>
...
|------|------|-------------|
| `body` | [arcade.Body](/api-docs/unity/arcade/Body/) | The physics body to look up  |

| Returns | Description |
|---------|-------------|
| [VisualArcadePhysics](/api-docs/unity/ceramic/VisualArcadePhysics/) | The VisualArcadePhysics component, or null if the body doesn't belong to a visual |

## Instance Members

<div class="signature field-var has-description has-plugin" id="visual"><div class="plugin-name">arcade</div><code><span class="field-name">visual</span><span class="operator">:</span> <a href="/api-docs/unity/ceramic/Visual/" class="type-link">Visual</a></code><a class="header-anchor" href="#visual"><span aria-hidden="true" class="header-anchor__symbol">#</span></a></div>
...
| Name | Type | Description |
|------|------|-------------|
| `x` | [Float](/api-docs/unity/Float/) | Initial X position of the body  |
| `y` | [Float](/api-docs/unity/Float/) | Initial Y position of the body  |
| `width` | [Float](/api-docs/unity/Float/) | Width of the collision box  |
| `height` | [Float](/api-docs/unity/Float/) | Height of the collision box  |
| `rotation` | [Float](/api-docs/unity/Float/) | Initial rotation in degrees |
...
| Name | Type | Description |
|------|------|-------------|
| `visual` | [Visual](/api-docs/unity/ceramic/Visual/) | The Visual that owns this physics component  |
| `body` | [arcade.Body](/api-docs/unity/arcade/Body/) | The other body involved in the collision |
...
|------|------|-------------|
| `visual` | [Visual](/api-docs/unity/ceramic/Visual/) | The Visual that owns this physics component  |
| `body` | [arcade.Body](/api-docs/unity/arcade/Body/) | The other body involved in the overlap |
...
| `visual2` | [Visual](/api-docs/unity/ceramic/Visual/) | The other visual involved in the collision |
...
|------|------|-------------|
| `visual1` | [Visual](/api-docs/unity/ceramic/Visual/) | This visual  |
| `visual2` | [Visual](/api-docs/unity/ceramic/Visual/) | The other visual involved in the overlap |
...
|------|------|
| `body1` | [arcade.Body](/api-docs/unity/arcade/Body/) |
| `up` | [Bool](/api-docs/unity/Bool/) |
| `down` | [Bool](/api-docs/unity/Bool/) |
| `left` | [Bool](/api-docs/unity/Bool/) |
| `right` | [Bool](/api-docs/unity/Bool/) |
