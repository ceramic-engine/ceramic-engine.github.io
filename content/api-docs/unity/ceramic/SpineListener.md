...
title: SpineListener
target: Unity
permalink: api-docs/unity/ceramic/SpineListener/
---
...
<div class="type-implements"><strong>Implements:</strong> <a href="/api-docs/unity/spine/AnimationStateListener/">spine.AnimationStateListener</a></div>
...
|------|------|-------------|
| `entry` | [spine.TrackEntry](/api-docs/unity/spine/TrackEntry/) | The track entry that started |
...
| Name | Type | Description |
|------|------|-------------|
| `entry` | [spine.TrackEntry](/api-docs/unity/spine/TrackEntry/) | The track entry that was interrupted |
...
| Name | Type | Description |
|------|------|-------------|
| `entry` | [spine.TrackEntry](/api-docs/unity/spine/TrackEntry/) | The track entry that ended |
...
| Name | Type | Description |
|------|------|-------------|
| `entry` | [spine.TrackEntry](/api-docs/unity/spine/TrackEntry/) | The track entry being disposed |
...
| Name | Type | Description |
|------|------|-------------|
| `entry` | [spine.TrackEntry](/api-docs/unity/spine/TrackEntry/) | The track entry that completed |
...
| `event` | [spine.Event](/api-docs/unity/spine/Event/) | The event data |
...
|------|------|
| `entry` | [spine.TrackEntry](/api-docs/unity/spine/TrackEntry/) |
| `event` | [spine.Event](/api-docs/unity/spine/Event/) |
