...
title: ValueEntry
target: Unity
permalink: api-docs/unity/ceramic/ValueEntry/
---
...
<div class="type-hierarchy"><a href="/api-docs/unity/ceramic/CollectionEntry/">CollectionEntry</a> → <strong>ceramic.ValueEntry</strong> (Class)</div>
...
<div class="see"><strong>See:</strong> <a href="/api-docs/unity/ceramic/CollectionEntry/">CollectionEntry</a>, <a href="/api-docs/unity/ceramic/Collection/">Collection</a></div>
...
| `id` | [String](/api-docs/unity/String/) | *(optional)* | Optional unique identifier for this entry in a collection  |
| `name` | [String](/api-docs/unity/String/) | *(optional)* | Optional human-readable name for this entry |
