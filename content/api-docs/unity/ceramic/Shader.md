...
<div class="type-hierarchy"><a href="/api-docs/unity/ceramic/Entity/">Entity</a> → <strong>ceramic.Shader</strong> (Class) → <a href="/api-docs/unity/shade/Shader/">shade.Shader</a>, <a href="/api-docs/unity/shade/Shader__shaders_Bloom_Vert__shaders_Bloom_Frag/">shade.Shader__shaders_Bloom_Vert__shaders_Bloom_Frag</a>, <a href="/api-docs/unity/shade/Shader__shaders_Blur_Vert__shaders_Blur_Frag/">shade.Shader__shaders_Blur_Vert__shaders_Blur_Frag</a>, <a href="/api-docs/unity/shade/Shader__shaders_Fxaa_Vert__shaders_Fxaa_Frag/">shade.Shader__shaders_Fxaa_Vert__shaders_Fxaa_Frag</a>, <a href="/api-docs/unity/shade/Shader__shaders_GaussianBlur_Vert__shaders_GaussianBlur_Frag/">shade.Shader__shaders_GaussianBlur_Vert__shaders_GaussianBlur_Frag</a>, <a href="/api-docs/unity/shade/Shader__shaders_Glow_Vert__shaders_Glow_Frag/">shade.Shader__shaders_Glow_Vert__shaders_Glow_Frag</a>, <a href="/api-docs/unity/shade/Shader__shaders_InnerLight_Vert__shaders_InnerLight_Frag/">shade.Shader__shaders_InnerLight_Vert__shaders_InnerLight_Frag</a>, <a href="/api-docs/unity/shade/Shader__shaders_Msdf_Vert__shaders_Msdf_Frag/">shade.Shader__shaders_Msdf_Vert__shaders_Msdf_Frag</a>, <a href="/api-docs/unity/shade/Shader__shaders_Outline_Vert__shaders_Outline_Frag/">shade.Shader__shaders_Outline_Vert__shaders_Outline_Frag</a>, <a href="/api-docs/unity/shade/Shader__shaders_PixelArt_Vert__shaders_PixelArt_Frag/">shade.Shader__shaders_PixelArt_Vert__shaders_PixelArt_Frag</a>, <a href="/api-docs/unity/shade/Shader__shaders_Textured_Vert__shaders_Textured_Frag/">shade.Shader__shaders_Textured_Vert__shaders_Textured_Frag</a>, <a href="/api-docs/unity/shade/Shader__shaders_TintBlack_Vert__shaders_TintBlack_Frag/">shade.Shader__shaders_TintBlack_Vert__shaders_TintBlack_Frag</a></div>
...
| `slot` | [Int](/api-docs/unity/Int/) | `-1` | The texture slot index (0-based)  |
...
| Name | Type | Description |
|------|------|-------------|
| `name` | [String](/api-docs/unity/String/) | The uniform mat2 variable name in the shader  |
| `m00` | [Float](/api-docs/unity/Float/) | Column 0, row 0  |
| `m10` | [Float](/api-docs/unity/Float/) | Column 0, row 1  |
| `m01` | [Float](/api-docs/unity/Float/) | Column 1, row 0  |
| `m11` | [Float](/api-docs/unity/Float/) | Column 1, row 1 |
...
| Name | Type | Description |
|------|------|-------------|
| `name` | [String](/api-docs/unity/String/) | The uniform mat3 variable name in the shader  |
| `m00` | [Float](/api-docs/unity/Float/) | Column 0, row 0  |
| `m10` | [Float](/api-docs/unity/Float/) | Column 0, row 1  |
| `m20` | [Float](/api-docs/unity/Float/) | Column 0, row 2  |
| `m01` | [Float](/api-docs/unity/Float/) | Column 1, row 0  |
| `m11` | [Float](/api-docs/unity/Float/) | Column 1, row 1  |
| `m21` | [Float](/api-docs/unity/Float/) | Column 1, row 2  |
| `m02` | [Float](/api-docs/unity/Float/) | Column 2, row 0  |
| `m12` | [Float](/api-docs/unity/Float/) | Column 2, row 1  |
| `m22` | [Float](/api-docs/unity/Float/) | Column 2, row 2 |
...
| `m10` | [Float](/api-docs/unity/Float/) | Column 0, row 1  |
| `m20` | [Float](/api-docs/unity/Float/) | Column 0, row 2  |
| `m30` | [Float](/api-docs/unity/Float/) | Column 0, row 3  |
| `m01` | [Float](/api-docs/unity/Float/) | Column 1, row 0  |
| `m11` | [Float](/api-docs/unity/Float/) | Column 1, row 1  |
| `m21` | [Float](/api-docs/unity/Float/) | Column 1, row 2  |
| `m31` | [Float](/api-docs/unity/Float/) | Column 1, row 3  |
| `m02` | [Float](/api-docs/unity/Float/) | Column 2, row 0  |
| `m12` | [Float](/api-docs/unity/Float/) | Column 2, row 1  |
| `m22` | [Float](/api-docs/unity/Float/) | Column 2, row 2  |
| `m32` | [Float](/api-docs/unity/Float/) | Column 2, row 3  |
| `m03` | [Float](/api-docs/unity/Float/) | Column 3, row 0  |
| `m13` | [Float](/api-docs/unity/Float/) | Column 3, row 1  |
| `m23` | [Float](/api-docs/unity/Float/) | Column 3, row 2  |
| `m33` | [Float](/api-docs/unity/Float/) | Column 3, row 3 |
...
| Name | Type | Description |
|------|------|-------------|
| `customAttributes` | [ReadOnlyArray](/api-docs/unity/ceramic/ReadOnlyArray/)<[ShaderAttribute](/api-docs/unity/ceramic/ShaderAttribute/)> | Optional additional vertex attributes |
| `baseAttributes` | [ReadOnlyArray](/api-docs/unity/ceramic/ReadOnlyArray/)<[ShaderAttribute](/api-docs/unity/ceramic/ShaderAttribute/)> |  |
| `textureIdAttribute` | [ShaderAttribute](/api-docs/unity/ceramic/ShaderAttribute/) |  |
...
| Name | Type | Description |
|------|------|-------------|
| `name` | [String](/api-docs/unity/String/) | The name of the texture uniform  |

| Returns | Description |
|---------|-------------|
| [Int](/api-docs/unity/Int/) | The slot or `-1` if not found. |
