...
title: Shortcuts
target: Unity
permalink: api-docs/unity/ceramic/Shortcuts/
---
...
<div class="see"><strong>See:</strong> <a href="/api-docs/unity/ceramic/App/">App</a>, <a href="/api-docs/unity/ceramic/Screen/">Screen</a>, <a href="/api-docs/unity/ceramic/Audio/">Audio</a>, <a href="/api-docs/unity/ceramic/Input/">Input</a></div>


## Static Members

<div class="signature field-var has-description" id="app"><code><span class="field-name">app</span><span class="operator">:</span> <a href="/api-docs/unity/ceramic/App/" class="type-link">App</a></code><a class="header-anchor" href="#app"><span aria-hidden="true" class="header-anchor__symbol">#</span></a></div>
...
<div class="signature field-var has-description" id="log"><code><span class="field-name">log</span><span class="operator">:</span> <a href="/api-docs/unity/ceramic/Logger/" class="type-link">Logger</a></code><a class="header-anchor" href="#log"><span aria-hidden="true" class="header-anchor__symbol">#</span></a></div>
...
<div class="see"><strong>See:</strong> reobserve, <a href="/api-docs/unity/tracker/Autorun/">tracker.Autorun</a></div>


<hr class="field-separator" />

<div class="signature field-method has-description" id="reobserve"><code><span class="field-name">reobserve</span><span class="parenthesis">(</span><span class="parenthesis">)</span><span class="operator">:</span> <a href="/api-docs/unity/Void/" class="type-link">Void</a></code><a class="header-anchor" href="#reobserve"><span aria-hidden="true" class="header-anchor__symbol">#</span></a></div>
...
<div class="see"><strong>See:</strong> unobserve, <a href="/api-docs/unity/tracker/Autorun/">tracker.Autorun</a></div>


<hr class="field-separator" />

<div class="signature field-method has-description" id="cease"><code><span class="field-name">cease</span><span class="parenthesis">(</span><span class="parenthesis">)</span><span class="operator">:</span> <a href="/api-docs/unity/Void/" class="type-link">Void</a></code><a class="header-anchor" href="#cease"><span aria-hidden="true" class="header-anchor__symbol">#</span></a></div>
...
<div class="see"><strong>See:</strong> <a href="/api-docs/unity/tracker/Autorun/">tracker.Autorun</a></div>


<hr class="field-separator" />

<div class="signature field-method has-description" id="until"><code><span class="field-name">until</span><span class="parenthesis">(</span><span class="arg-name">exprs</span><span class="operator">:</span> <a href="/api-docs/unity/Dynamic/" class="type-link">Dynamic</a><span class="parenthesis">)</span><span class="operator">:</span> <a href="/api-docs/unity/tracker/Autorun/" class="type-link">tracker.Autorun</a></code><a class="header-anchor" href="#until"><span aria-hidden="true" class="header-anchor__symbol">#</span></a></div>
...
|------|------|-------------|
| `exprs` | [Dynamic](/api-docs/unity/Dynamic/) | Variable arguments: [owner], condition, callback  |

| Returns | Description |
|---------|-------------|
| [tracker.Autorun](/api-docs/unity/tracker/Autorun/) | The created Autorun instance (can be manually destroyed if needed) |
...
|------|------|---------|-------------|
| `expr` | [Dynamic](/api-docs/unity/Dynamic/) | | The expression to validate (must evaluate to true)  |
| `reason` | [String](/api-docs/unity/String/) | *(optional)* | Optional explanation shown when assertion fails |
