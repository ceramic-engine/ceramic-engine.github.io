...
title: IntFloatMap
target: Unity
permalink: api-docs/unity/ceramic/IntFloatMap/
---
...
<div class="signature field-method no-description" id="get"><code><span class="field-name">get</span><span class="parenthesis">(</span><span class="arg-name">key</span><span class="operator">:</span> <a href="/api-docs/unity/Int/" class="type-link">Int</a><span class="parenthesis">)</span><span class="operator">:</span> <a href="/api-docs/unity/Float/" class="type-link">Float</a></code><a class="header-anchor" href="#get"><span aria-hidden="true" class="header-anchor__symbol">#</span></a></div>
...
| Returns |
|---------|
| [IntFloatMap](/api-docs/unity/ceramic/IntFloatMap/) |

<hr class="field-separator" />

<div class="signature field-method no-description" id="iterator"><code><span class="field-name">iterator</span><span class="parenthesis">(</span><span class="parenthesis">)</span><span class="operator">:</span> <a href="/api-docs/unity/ceramic/IntFloatMapIterator/" class="type-link">IntFloatMapIterator</a></code><a class="header-anchor" href="#iterator"><span aria-hidden="true" class="header-anchor__symbol">#</span></a></div>

| Returns |
|---------|
| [IntFloatMapIterator](/api-docs/unity/ceramic/IntFloatMapIterator/) |

<hr class="field-separator" />

<div class="signature field-method no-description" id="keys"><code><span class="field-name">keys</span><span class="parenthesis">(</span><span class="parenthesis">)</span><span class="operator">:</span> <a href="/api-docs/unity/ceramic/IntFloatMapKeyIterator/" class="type-link">IntFloatMapKeyIterator</a></code><a class="header-anchor" href="#keys"><span aria-hidden="true" class="header-anchor__symbol">#</span></a></div>

| Returns |
|---------|
| [IntFloatMapKeyIterator](/api-docs/unity/ceramic/IntFloatMapKeyIterator/) |

<hr class="field-separator" />

<div class="signature field-method no-description" id="keyValueIterator"><code><span class="field-name">keyValueIterator</span><span class="parenthesis">(</span><span class="parenthesis">)</span><span class="operator">:</span> <a href="/api-docs/unity/ceramic/IntFloatMapKeyValueIterator/" class="type-link">IntFloatMapKeyValueIterator</a></code><a class="header-anchor" href="#keyValueIterator"><span aria-hidden="true" class="header-anchor__symbol">#</span></a></div>

| Returns |
|---------|
| [IntFloatMapKeyValueIterator](/api-docs/unity/ceramic/IntFloatMapKeyValueIterator/) |
...
| Name | Type | Default |
|------|------|---------|
| `size` | [Int](/api-docs/unity/Int/) | `16` |
| `fillFactor` | [Float](/api-docs/unity/Float/) | `0.5` |
| `iterable` | [Bool](/api-docs/unity/Bool/) | `false` |

## Private Members

<div class="signature field-var has-description" id="intMap"><code><span class="field-name">intMap</span><span class="operator">:</span> <a href="/api-docs/unity/Map/" class="type-link">Map</a></code><a class="header-anchor" href="#intMap"><span aria-hidden="true" class="header-anchor__symbol">#</span></a></div>

Backing map for storing key-value pairs.

<hr class="field-separator" />

<div class="signature field-var has-description" id="iterableKeysUsed"><code><span class="field-name">iterableKeysUsed</span><span class="operator">:</span> <a href="/api-docs/unity/ceramic/IntBoolMap/" class="type-link">IntBoolMap</a></code><a class="header-anchor" href="#iterableKeysUsed"><span aria-hidden="true" class="header-anchor__symbol">#</span></a></div>
