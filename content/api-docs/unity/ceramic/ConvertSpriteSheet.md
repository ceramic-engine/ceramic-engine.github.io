...
target: Unity
permalink: api-docs/unity/ceramic/ConvertSpriteSheet/
---
...
| `assets` | [Assets](/api-docs/unity/ceramic/Assets/) | The assets instance to load from  |
| `basic` | [String](/api-docs/unity/String/) | The sprite sheet asset name  |
...
| `instance` | [Entity](/api-docs/unity/ceramic/Entity/) | The entity that owns this field  |
| `field` | [String](/api-docs/unity/String/) | The name of the field being converted  |
| `value` | [SpriteSheet](/api-docs/unity/ceramic/SpriteSheet/) | The SpriteSheet instance  |

| Returns | Description |
|---------|-------------|
| [String](/api-docs/unity/String/) | The asset name, or null if the sheet has no associated asset |
