...
title: SeedRandom
target: Unity
permalink: api-docs/unity/ceramic/SeedRandom/
---
...
<div class="signature field-var has-description" id="initialSeed"><code><span class="field-name">initialSeed</span><span class="operator">:</span> <a href="/api-docs/unity/Float/" class="type-link">Float</a></code><a class="header-anchor" href="#initialSeed"><span aria-hidden="true" class="header-anchor__symbol">#</span></a></div>
...
|------|------|-------------|
| `arr` | [Array](/api-docs/unity/Array/)<shuffle.T> | The array to shuffle. Modified in place. |
...
| Name | Type | Description |
|------|------|-------------|
| `min` | [Int](/api-docs/unity/Int/) | The minimum value (inclusive)  |
| `max` | [Int](/api-docs/unity/Int/) | The maximum value (exclusive)  |

| Returns | Description |
|---------|-------------|
| [Int](/api-docs/unity/Int/) | A pseudo-random integer in the specified range |
...
|------|------|---------|-------------|
| `initialSeed` | [Float](/api-docs/unity/Float/) | *(optional)* | Optional new seed to use. If not provided, resets to the original seed from construction. |
...
| Name | Type | Description |
|------|------|-------------|
| `seed` | [Float](/api-docs/unity/Float/) | The seed value. Must be a positive number. Same seed values will produce identical random sequences. |
