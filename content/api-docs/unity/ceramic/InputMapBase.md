...
title: InputMapBase
target: Unity
permalink: api-docs/unity/ceramic/InputMapBase/
---
...
<div class="type-hierarchy"><a href="/api-docs/unity/ceramic/Entity/">Entity</a> → <strong>ceramic.InputMapBase</strong> (Class) → <a href="/api-docs/unity/ceramic/InputMapImpl/">InputMapImpl</a></div>
...
<div class="see"><strong>See:</strong> <a href="/api-docs/unity/ceramic/InputMap/">InputMap</a>, <a href="/api-docs/unity/ceramic/InputMapImpl/">InputMapImpl</a></div>
...
<div class="signature field-var has-description" id="NO_KEY"><code><span class="field-name">NO_KEY</span><span class="operator">:</span> <a href="/api-docs/unity/Dynamic/" class="type-link">Dynamic</a></code><a class="header-anchor" href="#NO_KEY"><span aria-hidden="true" class="header-anchor__symbol">#</span></a></div>
