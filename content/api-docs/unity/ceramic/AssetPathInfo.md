...
title: AssetPathInfo
target: Unity
permalink: api-docs/unity/ceramic/AssetPathInfo/
---
...
<div class="signature field-var has-description" id="extension"><code><span class="field-name">extension</span><span class="operator">:</span> <a href="/api-docs/unity/String/" class="type-link">String</a></code><a class="header-anchor" href="#extension"><span aria-hidden="true" class="header-anchor__symbol">#</span></a></div>
...
<div class="signature field-var has-description" id="flags"><code><span class="field-name">flags</span><span class="operator">:</span> <a href="/api-docs/unity/Map/" class="type-link">Map</a></code><a class="header-anchor" href="#flags"><span aria-hidden="true" class="header-anchor__symbol">#</span></a></div>
...
|------|------|-------------|
| `path` | [String](/api-docs/unity/String/) | The asset file path to parse |
...
| Returns | Description |
|---------|-------------|
| [String](/api-docs/unity/String/) | Object-like string with all parsed properties |
