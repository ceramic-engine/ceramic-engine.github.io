...
title: MeshPool
target: Unity
permalink: api-docs/unity/ceramic/MeshPool/
---
...
| Returns | Description |
|---------|-------------|
| [Mesh](/api-docs/unity/ceramic/Mesh/) | A ready-to-use Mesh instance * ```haxe var mesh = MeshPool.get(); mesh.createQuad(100, 100); parent.add(mesh); ``` |
...
|------|------|-------------|
| `mesh` | [Mesh](/api-docs/unity/ceramic/Mesh/) | The mesh to recycle  |
