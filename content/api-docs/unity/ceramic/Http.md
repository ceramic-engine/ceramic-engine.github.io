...
title: Http
target: Unity
permalink: api-docs/unity/ceramic/Http/
---
...
|------|------|-------------|
| `options` | [HttpRequestOptions](/api-docs/unity/ceramic/HttpRequestOptions/) | The HTTP request configuration including URL, method, headers, parameters, and timeout  |
