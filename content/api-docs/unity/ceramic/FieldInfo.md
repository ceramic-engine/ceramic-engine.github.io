...
title: FieldInfo
target: Unity
permalink: api-docs/unity/ceramic/FieldInfo/
---
...
<div class="see"><strong>See:</strong> ceramic.macros.FieldInfoMacro, <a href="/api-docs/unity/ceramic/Entity/">Entity</a></div>
...
|------|------|---------|-------------|
| `targetClass` | [String](/api-docs/unity/String/) | | The fully qualified class name to extract field info from  |
| `recursive` | [Bool](/api-docs/unity/Bool/) | `true` | Whether to include fields from parent classes (default: true)  |

| Returns | Description |
|---------|-------------|
| [ReadOnlyMap](/api-docs/unity/ceramic/ReadOnlyMap/)<[String](/api-docs/unity/String/), [String](/api-docs/unity/String/)> | A read-only map of field names to their type strings  |

<hr class="field-separator" />

<div class="signature field-method has-description" id="typeOf"><code><span class="field-name">typeOf</span><span class="parenthesis">(</span><span class="arg-name">targetClass</span><span class="operator">:</span> <a href="/api-docs/unity/String/" class="type-link">String</a><span class="operator">,</span> <span class="arg-name">field</span><span class="operator">:</span> <a href="/api-docs/unity/String/" class="type-link">String</a><span class="parenthesis">)</span><span class="operator">:</span> <a href="/api-docs/unity/String/" class="type-link">String</a></code><a class="header-anchor" href="#typeOf"><span aria-hidden="true" class="header-anchor__symbol">#</span></a></div>
...
|------|------|-------------|
| `targetClass` | [String](/api-docs/unity/String/) | The fully qualified class name containing the field  |
| `field` | [String](/api-docs/unity/String/) | The name of the field to get type information for  |

| Returns | Description |
|---------|-------------|
| [String](/api-docs/unity/String/) | The type string for the field, or null if the field doesn't exist |

## Private Members

<div class="signature field-var has-description" id="fieldInfoMap"><code><span class="field-name">fieldInfoMap</span><span class="operator">:</span> <a href="/api-docs/unity/Map/" class="type-link">Map</a></code><a class="header-anchor" href="#fieldInfoMap"><span aria-hidden="true" class="header-anchor__symbol">#</span></a></div>
