...
title: Velocity
target: Unity
permalink: api-docs/unity/ceramic/Velocity/
---
...
|------|------|---------|-------------|
| `position` | [Float](/api-docs/unity/Float/) | | The current position value (e.g., x or y coordinate)  |
| `minusDelta` | [Float](/api-docs/unity/Float/) | `0` | Optional time offset in seconds to subtract from the current time. Useful when the position data is slightly delayed. |
...
| Returns | Description |
|---------|-------------|
| [Float](/api-docs/unity/Float/) | The velocity in units per second (e.g., pixels per second). Returns 0 if there are fewer than 2 samples. |
...
|------|------|-------------|
| `expireTime` | [Float](/api-docs/unity/Float/) | The time threshold - samples older than this are removed |
...
| Returns | Description |
|---------|-------------|
| [String](/api-docs/unity/String/) | The current velocity as a string |
