...
title: ScriptUtils
target: Unity
permalink: api-docs/unity/ceramic/ScriptUtils/
---
...
|------|------|-------------|
| `code` | [String](/api-docs/unity/String/) | Source code with JS/TS syntax  |

| Returns | Description |
|---------|-------------|
| [String](/api-docs/unity/String/) | Equivalent HScript code |
...
| Name | Type | Description |
|------|------|-------------|
| `code` | [String](/api-docs/unity/String/) | Raw JS/TS code  |

| Returns | Description |
|---------|-------------|
| [String](/api-docs/unity/String/) | Cleaned code with basic conversions |
...
| Name | Type | Description |
|------|------|-------------|
| `error` | [Dynamic](/api-docs/unity/Dynamic/) | Error message  |
| `i` | [Int](/api-docs/unity/Int/) | Character position where error occurred  |
| `code` | [String](/api-docs/unity/String/) | Full source code |
