...
target: Unity
permalink: api-docs/unity/ceramic/SortVisualsByDepth/
---
...
|------|------|-------------|
| `a` | [Array](/api-docs/unity/Array/)<[Visual](/api-docs/unity/ceramic/Visual/)> | The array of visuals to sort by depth. Modified in place. If null, behavior is undefined. |
...
| Returns | Description |
|---------|-------------|
| [Int](/api-docs/unity/Int/) | -1 if a has lower depth, 1 if a has higher depth, 0 if equal |
