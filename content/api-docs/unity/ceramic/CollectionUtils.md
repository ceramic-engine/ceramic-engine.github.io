...
target: Unity
permalink: api-docs/unity/ceramic/CollectionUtils/
---
...
|------|------|-------------|
| `array` | [Array](/api-docs/unity/Array/)<toCollection.T> | The array to convert  |

| Returns | Description |
|---------|-------------|
| [Collection](/api-docs/unity/ceramic/Collection/)<[ValueEntry](/api-docs/unity/ceramic/ValueEntry/)<toCollection.T>> | A new Collection containing the array elements |
...
|------|------|---------|-------------|
| `collection` | [Collection](/api-docs/unity/ceramic/Collection/)<filtered.T> | | The source collection to filter  |
| `filter` | Function | | Function that filters the entries array  |
| `cacheKey` | [String](/api-docs/unity/String/) | *(optional)* | Optional key to cache and reuse the filtered collection  |

| Returns | Description |
|---------|-------------|
| [Collection](/api-docs/unity/ceramic/Collection/)<filtered.T> | A filtered collection that updates with the source |
...
| Name | Type | Default | Description |
|------|------|---------|-------------|
| `collections` | [Array](/api-docs/unity/Array/)<[Collection](/api-docs/unity/ceramic/Collection/)<combined.T>> | | Array of collections to combine  |
| `cache` | [Bool](/api-docs/unity/Bool/) | `true` | Whether to cache the combined collection (default: true)  |

| Returns | Description |
|---------|-------------|
| [Collection](/api-docs/unity/ceramic/Collection/)<combined.T> | A collection containing all entries from all source collections |
