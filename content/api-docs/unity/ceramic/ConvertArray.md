...
title: ConvertArray
target: Unity
permalink: api-docs/unity/ceramic/ConvertArray/
---
...
| `assets` | [Assets](/api-docs/unity/ceramic/Assets/) | Assets instance for resource loading (unused for arrays)  |
| `basic` | [Array](/api-docs/unity/Array/)<ceramic.ConvertArray.T> | The source array to convert  |
...
| `instance` | [Entity](/api-docs/unity/ceramic/Entity/) | The entity that owns this field  |
| `field` | [String](/api-docs/unity/String/) | The name of the field being converted  |
| `value` | [Array](/api-docs/unity/Array/)<ceramic.ConvertArray.T> | The field array to convert  |

| Returns | Description |
|---------|-------------|
| [Array](/api-docs/unity/Array/)<ceramic.ConvertArray.T> | A new array containing copies of all elements |
