...
target: Unity
permalink: api-docs/unity/ceramic/_TextureAtlasParser/TextureAtlasReader/
---
...
|------|------|-------------|
| `value` | [String](/api-docs/unity/String/) | String to trim  |

| Returns | Description |
|---------|-------------|
| [String](/api-docs/unity/String/) | Trimmed string |
...
| Returns | Description |
|---------|-------------|
| [String](/api-docs/unity/String/) | Next line or null if end of file |
...
| Returns | Description |
|---------|-------------|
| [String](/api-docs/unity/String/) | The key string or null if no key found |
...
| Returns | Description |
|---------|-------------|
| [String](/api-docs/unity/String/) | The value after the colon  |
...
| Name | Type | Description |
|------|------|-------------|
| `tuple` | [Array](/api-docs/unity/Array/)<[Dynamic](/api-docs/unity/Dynamic/)> | Array to fill with parsed values  |

| Returns | Description |
|---------|-------------|
| [Int](/api-docs/unity/Int/) | Number of values read (1, 2, or 4)  |
...
| Name | Type | Description |
|------|------|-------------|
| `text` | [String](/api-docs/unity/String/) | The raw atlas file content |
