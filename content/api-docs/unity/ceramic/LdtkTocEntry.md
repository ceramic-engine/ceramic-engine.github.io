...
title: LdtkTocEntry
target: Unity
permalink: api-docs/unity/ceramic/LdtkTocEntry/
---
...
|------|------|---------|-------------|
| `ldtkData` | [LdtkData](/api-docs/unity/ceramic/LdtkData/) | *(optional)* | The parent LdtkData object  |
| `json` | [haxe.DynamicAccess](/api-docs/unity/haxe/DynamicAccess/)<[Dynamic](/api-docs/unity/Dynamic/)> | *(optional)* | The JSON data for this entry |
