...
title: RoundedRect
target: Unity
permalink: api-docs/unity/ceramic/RoundedRect/
---
...
<div class="type-hierarchy"><a href="/api-docs/unity/ceramic/Entity/">Entity</a> → <a href="/api-docs/unity/ceramic/Visual/">Visual</a> → <a href="/api-docs/unity/ceramic/Mesh/">Mesh</a> → <a href="/api-docs/unity/ceramic/Shape/">Shape</a> → <strong>ceramic.RoundedRect</strong> (Class)</div>
...
<div class="signature field-var has-description" id="segments"><code><span class="field-name">segments</span><span class="operator">:</span> <a href="/api-docs/unity/Int/" class="type-link">Int</a></code><a class="header-anchor" href="#segments"><span aria-hidden="true" class="header-anchor__symbol">#</span></a></div>
...
<div class="signature field-var has-description" id="radiusTopLeft"><code><span class="field-name">radiusTopLeft</span><span class="operator">:</span> <a href="/api-docs/unity/Float/" class="type-link">Float</a></code><a class="header-anchor" href="#radiusTopLeft"><span aria-hidden="true" class="header-anchor__symbol">#</span></a></div>
...
<div class="signature field-var has-description" id="radiusTopRight"><code><span class="field-name">radiusTopRight</span><span class="operator">:</span> <a href="/api-docs/unity/Float/" class="type-link">Float</a></code><a class="header-anchor" href="#radiusTopRight"><span aria-hidden="true" class="header-anchor__symbol">#</span></a></div>
...
<div class="signature field-var has-description" id="radiusBottomLeft"><code><span class="field-name">radiusBottomLeft</span><span class="operator">:</span> <a href="/api-docs/unity/Float/" class="type-link">Float</a></code><a class="header-anchor" href="#radiusBottomLeft"><span aria-hidden="true" class="header-anchor__symbol">#</span></a></div>
...
|------|------|---------|-------------|
| `topLeft` | [Float](/api-docs/unity/Float/) | | Radius for top-left corner (required)  |
| `topRight` | [Float](/api-docs/unity/Float/) | *(optional)* | Radius for top-right corner (optional)  |
| `bottomRight` | [Float](/api-docs/unity/Float/) | *(optional)* | Radius for bottom-right corner (optional)  |
| `bottomLeft` | [Float](/api-docs/unity/Float/) | *(optional)* | Radius for bottom-left corner (optional) * ```haxe // All corners 20px rect.radius(20); * // Top corners 20px, bottom corners 10px rect.radius(20, 10); * // Each corner different rect.radius(20, 15, 10, 5); ``` |
