...
title: SpineFile
target: Unity
permalink: api-docs/unity/ceramic/SpineFile/
---
...
<div class="type-implements"><strong>Implements:</strong> <a href="/api-docs/unity/spine/support/files/FileHandle/">spine.support.files.FileHandle</a></div>
...
| Returns | Description |
|---------|-------------|
| [String](/api-docs/unity/String/) | The complete file content as a string |
...
|------|------|-------------|
| `path` | [String](/api-docs/unity/String/) | The file path or identifier  |
| `content` | [String](/api-docs/unity/String/) | The text content of the file |
