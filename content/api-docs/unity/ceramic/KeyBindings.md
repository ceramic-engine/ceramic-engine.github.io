...
title: KeyBindings
target: Unity
permalink: api-docs/unity/ceramic/KeyBindings/
---
...
<div class="type-hierarchy"><a href="/api-docs/unity/ceramic/Entity/">Entity</a> → <strong>ceramic.KeyBindings</strong> (Class)</div>
...
<div class="see"><strong>See:</strong> <a href="/api-docs/unity/ceramic/KeyBinding/">KeyBinding</a>, <a href="/api-docs/unity/ceramic/KeyAcceleratorItem/">KeyAcceleratorItem</a></div>
...
|------|------|---------|-------------|
| `accelerator` | [Array](/api-docs/unity/Array/)<Anonymous> | | Array of keys that must be pressed together. Order doesn't matter for modifier keys.  |
...
| Returns | Description |
|---------|-------------|
| [KeyBinding](/api-docs/unity/ceramic/KeyBinding/) | The created KeyBinding instance |
