...
title: RenderTexture
target: Unity
permalink: api-docs/unity/ceramic/RenderTexture/
---
...
<div class="type-hierarchy"><a href="/api-docs/unity/ceramic/Entity/">Entity</a> → <a href="/api-docs/unity/ceramic/Texture/">Texture</a> → <strong>ceramic.RenderTexture</strong> (Class)</div>
...
<div class="see"><strong>See:</strong> <a href="/api-docs/unity/ceramic/Texture/">Texture</a>, Visual.renderTarget, <a href="/api-docs/unity/ceramic/Filter/">Filter</a></div>
...
<div class="signature field-var has-description" id="clearOnRender"><code><span class="field-name">clearOnRender</span><span class="operator">:</span> <a href="/api-docs/unity/Bool/" class="type-link">Bool</a></code><a class="header-anchor" href="#clearOnRender"><span aria-hidden="true" class="header-anchor__symbol">#</span></a></div>
...
<div class="signature field-var has-description" id="renderDirty"><code><span class="field-name">renderDirty</span><span class="operator">:</span> <a href="/api-docs/unity/Bool/" class="type-link">Bool</a></code><a class="header-anchor" href="#renderDirty"><span aria-hidden="true" class="header-anchor__symbol">#</span></a></div>
...
<div class="signature field-var has-description" id="depth"><code><span class="field-name">depth</span><span class="operator">:</span> <a href="/api-docs/unity/Bool/" class="type-link">Bool</a></code><a class="header-anchor" href="#depth"><span aria-hidden="true" class="header-anchor__symbol">#</span></a></div>
...
<div class="signature field-var has-description" id="priority"><code><span class="field-name">priority</span><span class="operator">:</span> <a href="/api-docs/unity/Float/" class="type-link">Float</a></code><a class="header-anchor" href="#priority"><span aria-hidden="true" class="header-anchor__symbol">#</span></a></div>
...
|------|------|-------------|
| `visual` | [Visual](/api-docs/unity/ceramic/Visual/) | The visual to render onto this texture  |
...
|------|------|---------|-------------|
| `color` | [Color](/api-docs/unity/ceramic/Color/) | `0xFFFFFF` | Fill color (default: white)  |
| `alpha` | [Float](/api-docs/unity/Float/) | `0` | Fill alpha (default: 0 = transparent)  |
| `clipX` | [Float](/api-docs/unity/Float/) | `-1` | X position of area to clear (-1 = full texture)  |
| `clipY` | [Float](/api-docs/unity/Float/) | `-1` | Y position of area to clear (-1 = full texture)  |
| `clipWidth` | [Float](/api-docs/unity/Float/) | `-1` | Width of area to clear (-1 = full texture)  |
| `clipHeight` | [Float](/api-docs/unity/Float/) | `-1` | Height of area to clear (-1 = full texture)  |
...
| Name | Type | Default | Description |
|------|------|---------|-------------|
| `width` | [Float](/api-docs/unity/Float/) | | Width in logical pixels  |
| `height` | [Float](/api-docs/unity/Float/) | | Height in logical pixels  |
| `density` | [Float](/api-docs/unity/Float/) | `-1` | Pixel density multiplier (-1 = use screen density)  |
| `depth` | [Bool](/api-docs/unity/Bool/) | `true` | Enable depth buffer (default: true)  |
| `stencil` | [Bool](/api-docs/unity/Bool/) | `true` | Enable stencil buffer (default: true)  |
| `antialiasing` | [Int](/api-docs/unity/Int/) | `0` | Multisampling level (default: 0) |
