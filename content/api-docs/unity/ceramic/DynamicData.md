...
title: DynamicData
target: Unity
permalink: api-docs/unity/ceramic/DynamicData/
---
...
<div class="type-hierarchy"><a href="/api-docs/unity/ceramic/Entity/">Entity</a> → <strong>ceramic.DynamicData</strong> (Class)</div>
...
<div class="signature field-var has-description" id="hasData"><code><span class="field-name">hasData</span><span class="operator">:</span> <a href="/api-docs/unity/Bool/" class="type-link">Bool</a></code><a class="header-anchor" href="#hasData"><span aria-hidden="true" class="header-anchor__symbol">#</span></a></div>
...
<div class="signature field-var has-description" id="data"><code><span class="field-name">data</span><span class="operator">:</span> <a href="/api-docs/unity/Dynamic/" class="type-link">Dynamic</a></code><a class="header-anchor" href="#data"><span aria-hidden="true" class="header-anchor__symbol">#</span></a></div>
...
|------|------|---------|-------------|
| `data` | [Dynamic](/api-docs/unity/Dynamic/) | *(optional)* | Optional initial data to store. If not provided, data will be lazily initialized on first access. * ```haxe // With initial data var data1 = new DynamicData({level: 1, xp: 0}); * // Without initial data (lazy init) var data2 = new DynamicData(); ``` |
