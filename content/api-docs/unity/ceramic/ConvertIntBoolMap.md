...
target: Unity
permalink: api-docs/unity/ceramic/ConvertIntBoolMap/
---
...
<div class="see"><strong>See:</strong> <a href="/api-docs/unity/ceramic/ConvertField/">ConvertField</a>, <a href="/api-docs/unity/ceramic/IntBoolMap/">IntBoolMap</a>, <a href="/api-docs/unity/ceramic/Fragment/">Fragment</a></div>
...
| `basic` | [Dynamic](/api-docs/unity/Dynamic/) | Object with string keys and boolean values  |
...
| `instance` | [Entity](/api-docs/unity/ceramic/Entity/) | The entity that owns this field  |
| `field` | [String](/api-docs/unity/String/) | The name of the field being converted  |
| `value` | [IntBoolMap](/api-docs/unity/ceramic/IntBoolMap/) | The IntBoolMap to convert  |

| Returns | Description |
|---------|-------------|
| [Dynamic](/api-docs/unity/Dynamic/) | An empty object (method not implemented) |
