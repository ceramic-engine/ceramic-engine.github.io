...
target: Unity
permalink: api-docs/unity/ceramic/ShaderAttribute/
---
...
<div class="see"><strong>See:</strong> <a href="/api-docs/unity/ceramic/Shader/">Shader</a>, <a href="/api-docs/unity/ceramic/Mesh/">Mesh</a></div>
...
|------|------|-------------|
| `size` | [Int](/api-docs/unity/Int/) | Number of components (1-4)  |
| `name` | [String](/api-docs/unity/String/) | Attribute name in shader code |
