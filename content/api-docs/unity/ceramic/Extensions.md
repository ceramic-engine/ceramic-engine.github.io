...
title: Extensions
target: Unity
permalink: api-docs/unity/ceramic/Extensions/
---
...
|------|------|-------------|
| `array` | [Array](/api-docs/unity/Array/)<unsafeGet.T> | The array to access  |
| `index` | [Int](/api-docs/unity/Int/) | The index to retrieve (must be 0 <= index < array.length)  |
...
| Name | Type | Description |
|------|------|-------------|
| `array` | [Array](/api-docs/unity/Array/)<setArrayLength.T> | The array to resize  |
| `length` | [Int](/api-docs/unity/Int/) | The new length (can be larger or smaller) * ```haxe var arr = [1, 2, 3, 4, 5]; arr.setArrayLength(3); // [1, 2, 3] arr.setArrayLength(5); // [1, 2, 3, null, null] ``` |
...
| Name | Type | Description |
|------|------|-------------|
| `array` | [Array](/api-docs/unity/Array/)<randomElement.T> | The array to select from  |
...
|------|------|---------|-------------|
| `array` | [Array](/api-docs/unity/Array/)<randomElementExcept.T> | | The array in which we extract the element from  |
| `except` | randomElementExcept.T | | The element we don't want  |
| `unsafe` | [Bool](/api-docs/unity/Bool/) | `false` | If set to `true`, will prevent allocating a new array (and may be faster) but will loop forever if there is no element except the one we don't want  |
...
| Name | Type | Description |
|------|------|-------------|
| `array` | [Array](/api-docs/unity/Array/)<randomElementMatchingValidator.T> | The array in which we extract the element from  |
