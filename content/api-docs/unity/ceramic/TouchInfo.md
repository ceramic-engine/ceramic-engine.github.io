...
title: TouchInfo
target: Unity
permalink: api-docs/unity/ceramic/TouchInfo/
---
...
<div class="see"><strong>See:</strong> <a href="/api-docs/unity/ceramic/Visual/">Visual</a>, <a href="/api-docs/unity/ceramic/Screen/">Screen</a></div>
...
<div class="signature field-var has-description" id="buttonId"><code><span class="field-name">buttonId</span><span class="operator">:</span> <a href="/api-docs/unity/Int/" class="type-link">Int</a></code><a class="header-anchor" href="#buttonId"><span aria-hidden="true" class="header-anchor__symbol">#</span></a></div>
...
<div class="signature field-var has-description" id="hits"><code><span class="field-name">hits</span><span class="operator">:</span> <a href="/api-docs/unity/Bool/" class="type-link">Bool</a></code><a class="header-anchor" href="#hits"><span aria-hidden="true" class="header-anchor__symbol">#</span></a></div>
...
|------|------|-------------|
| `touchIndex` | [Int](/api-docs/unity/Int/) | * If the input is a touch input, this is the index of the touch. Otherwise it will be -1. |
| `buttonId` | [Int](/api-docs/unity/Int/) | * If the input is a mouse input, this is the id of the mouse button. Otherwise it will be -1. |
| `x` | [Float](/api-docs/unity/Float/) | * X coordinate of the input (relative to screen). |
| `y` | [Float](/api-docs/unity/Float/) | * Y coordinate of the input (relative to screen). |
| `hits` | [Bool](/api-docs/unity/Bool/) | * Whether these info do hit the related visual. This is usually `true`, Except when we have touch/mouse up events outside of a visual that initially received a down event. |
