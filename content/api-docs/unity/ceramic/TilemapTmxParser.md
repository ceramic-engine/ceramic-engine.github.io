...
target: Unity
permalink: api-docs/unity/ceramic/TilemapTmxParser/
---
...
<div class="see"><strong>See:</strong> <a href="/api-docs/unity/ceramic/TilemapParser/">TilemapParser</a>, <a href="/api-docs/unity/format/tmx/Reader/">format.tmx.Reader</a></div>
...
|------|------|---------|-------------|
| `rawTmxData` | [String](/api-docs/unity/String/) | | The TMX file content as an XML string  |
| `cwd` | [String](/api-docs/unity/String/) | | Current working directory for resolving relative TSX paths  |
...
| Returns | Description |
|---------|-------------|
| [format.tmx.TmxMap](/api-docs/unity/format/tmx/TmxMap/) | Parsed TmxMap object, or null if parsing fails  |
...
|------|------|-------------|
| `name` | [String](/api-docs/unity/String/) | The TSX filename referenced in the TMX  |

| Returns | Description |
|---------|-------------|
| [format.tmx.TmxTileset](/api-docs/unity/format/tmx/TmxTileset/) | The parsed TmxTileset object |
