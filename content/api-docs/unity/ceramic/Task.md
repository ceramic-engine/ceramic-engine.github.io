...
title: Task
target: Unity
permalink: api-docs/unity/ceramic/Task/
---
...
<div class="type-hierarchy"><a href="/api-docs/unity/ceramic/Entity/">Entity</a> → <strong>ceramic.Task</strong> (Class)</div>
...
|------|------|-------------|
| `reason` | [String](/api-docs/unity/String/) | A human-readable description of why the task failed. This should help developers understand what went wrong. |
...
| Name | Type | Description |
|------|------|-------------|
| `reason` | [String](/api-docs/unity/String/) | A human-readable description of why the task failed |
