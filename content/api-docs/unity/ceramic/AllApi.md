...
title: AllApi
target: Unity
permalink: api-docs/unity/ceramic/AllApi/
---
...
<div class="signature field-method has-description has-plugin" id="configureHscript"><div class="plugin-name">script</div><code><span class="field-name">configureHscript</span><span class="parenthesis">(</span><span class="arg-name">interp</span><span class="operator">:</span> <a href="/api-docs/unity/hscript/Interp/" class="type-link">hscript.Interp</a><span class="parenthesis">)</span><span class="operator">:</span> <a href="/api-docs/unity/Void/" class="type-link">Void</a></code><a class="header-anchor" href="#configureHscript"><span aria-hidden="true" class="header-anchor__symbol">#</span></a></div>
...
|------|------|-------------|
| `interp` | [hscript.Interp](/api-docs/unity/hscript/Interp/) | The HScript interpreter to configure |
