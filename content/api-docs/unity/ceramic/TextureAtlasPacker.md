...
target: Unity
permalink: api-docs/unity/ceramic/TextureAtlasPacker/
---
...
<div class="type-hierarchy"><a href="/api-docs/unity/ceramic/Entity/">Entity</a> → <strong>ceramic.TextureAtlasPacker</strong> (Class)</div>
...
| Returns | Description |
|---------|-------------|
| [Bool](/api-docs/unity/Bool/) | True if add() has been called but pack() hasn't processed the regions yet |
...
|------|------|-------------|
| `name` | [String](/api-docs/unity/String/) | The region name to search for  |

| Returns | Description |
|---------|-------------|
| [ceramic._TextureAtlasPacker.TextureAtlasPackerRegion](/api-docs/unity/ceramic/_TextureAtlasPacker/TextureAtlasPackerRegion/) | The packer region data, or null if not found |

<hr class="field-separator" />

<div class="signature field-method has-description" id="removeRegionsWithMatcher"><code><span class="field-name">removeRegionsWithMatcher</span><span class="parenthesis">(</span><span class="operator">?</span><span class="arg-name">removeAtlasRegions</span><span class="operator">:</span> <a href="/api-docs/unity/Bool/" class="type-link">Bool</a> <span class="operator">=</span> <span class="default-value">true</span><span class="operator">,</span> <span class="arg-name">matcher</span><span class="operator">:</span> <span class="type-name">Function</span><span class="parenthesis">)</span><span class="operator">:</span> <a href="/api-docs/unity/Void/" class="type-link">Void</a></code><a class="header-anchor" href="#removeRegionsWithMatcher"><span aria-hidden="true" class="header-anchor__symbol">#</span></a></div>
...
|------|------|---------|-------------|
| `removeAtlasRegions` | [Bool](/api-docs/unity/Bool/) | `true` | If true, also removes matching regions from the final atlas  |
...
|------|------|---------|-------------|
| `removeAtlasRegions` | [Bool](/api-docs/unity/Bool/) | `true` | If true, also removes matching regions from the final atlas  |
| `prefix` | [String](/api-docs/unity/String/) | | The string prefix to match region names against * ```haxe // Remove all UI elements packer.removeRegionsWithPrefix(true, "ui_"); * // Remove temporary regions packer.removeRegionsWithPrefix(true, "temp_"); ``` |
...
| `pixels` | [UInt8Array](/api-docs/unity/ceramic/UInt8Array/) | |
| `originalWidth` | [Int](/api-docs/unity/Int/) | |
| `originalHeight` | [Int](/api-docs/unity/Int/) | |
| `packedWidth` | [Int](/api-docs/unity/Int/) | |
| `packedHeight` | [Int](/api-docs/unity/Int/) | `-1` |
| `offsetX` | [Int](/api-docs/unity/Int/) | `0` |
| `offsetY` | [Int](/api-docs/unity/Int/) | `0` |

<hr class="field-separator" />

<div class="signature field-method has-description" id="pack"><code><span class="field-name">pack</span><span class="parenthesis">(</span><span class="arg-name">done</span><span class="operator">:</span> <span class="type-name">Function</span><span class="parenthesis">)</span><span class="operator">:</span> <a href="/api-docs/unity/Void/" class="type-link">Void</a></code><a class="header-anchor" href="#pack"><span aria-hidden="true" class="header-anchor__symbol">#</span></a></div>
...
<div class="signature field-var has-description" id="MIN_TEXTURE_SIZE"><code><span class="field-name">MIN_TEXTURE_SIZE</span><span class="operator">:</span> <a href="/api-docs/unity/Int/" class="type-link">Int</a></code><a class="header-anchor" href="#MIN_TEXTURE_SIZE"><span aria-hidden="true" class="header-anchor__symbol">#</span></a></div>
...
<div class="signature field-var has-description" id="MAX_TEXTURE_SIZE"><code><span class="field-name">MAX_TEXTURE_SIZE</span><span class="operator">:</span> <a href="/api-docs/unity/Int/" class="type-link">Int</a></code><a class="header-anchor" href="#MAX_TEXTURE_SIZE"><span aria-hidden="true" class="header-anchor__symbol">#</span></a></div>
