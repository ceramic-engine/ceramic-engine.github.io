...
target: Unity
permalink: api-docs/unity/ceramic/SpineTextureLoader/
---
...
<div class="type-implements"><strong>Implements:</strong> <a href="/api-docs/unity/spine/support/graphics/TextureLoader/">spine.support.graphics.TextureLoader</a></div>
...
|------|------|-------------|
| `page` | [spine.support.graphics.AtlasPage](/api-docs/unity/spine/support/graphics/AtlasPage/) | The AtlasPage to load the texture for. The loader should set the page's rendererObject to the loaded texture.  |
| `path` | [String](/api-docs/unity/String/) | The path to the texture file as specified in the atlas |

<hr class="field-separator" />

<div class="signature field-method has-description has-plugin" id="loadRegion"><div class="plugin-name">spine</div><code><span class="field-name">loadRegion</span><span class="parenthesis">(</span><span class="arg-name">region</span><span class="operator">:</span> <a href="/api-docs/unity/spine/support/graphics/AtlasRegion/" class="type-link">spine.support.graphics.AtlasRegion</a><span class="parenthesis">)</span><span class="operator">:</span> <a href="/api-docs/unity/Void/" class="type-link">Void</a></code><a class="header-anchor" href="#loadRegion"><span aria-hidden="true" class="header-anchor__symbol">#</span></a></div>
...
| Name | Type | Description |
|------|------|-------------|
| `region` | [spine.support.graphics.AtlasRegion](/api-docs/unity/spine/support/graphics/AtlasRegion/) | The atlas region that was just loaded |
...
|------|------|---------|-------------|
| `asset` | [SpineAsset](/api-docs/unity/ceramic/SpineAsset/) | | The SpineAsset that will handle texture loading operations  |
| `basePath` | [String](/api-docs/unity/String/) | *(optional)* | Optional base path to prepend to texture paths in the atlas |

## Private Members

<div class="signature field-var has-description has-plugin" id="asset"><div class="plugin-name">spine</div><code><span class="field-name">asset</span><span class="operator">:</span> <a href="/api-docs/unity/ceramic/SpineAsset/" class="type-link">SpineAsset</a></code><a class="header-anchor" href="#asset"><span aria-hidden="true" class="header-anchor__symbol">#</span></a></div>
