...
target: Unity
permalink: api-docs/unity/ceramic/VisualNapePhysics/
---
...
<div class="type-hierarchy"><a href="/api-docs/unity/ceramic/Entity/">Entity</a> → <strong>ceramic.VisualNapePhysics</strong> (Class)</div>
...
| `shape` | [nape.shape.Shape](/api-docs/unity/nape/shape/Shape/) | *(optional)* | Optional single shape for the body  |
| `shapes` | [Array](/api-docs/unity/Array/)<[nape.shape.Shape](/api-docs/unity/nape/shape/Shape/)> | *(optional)* | Optional array of shapes for compound bodies  |
| `material` | [nape.phys.Material](/api-docs/unity/nape/phys/Material/) | *(optional)* | Physics material defining friction, elasticity, etc.  |
| `x` | [Float](/api-docs/unity/Float/) | | Initial X position (center)  |
| `y` | [Float](/api-docs/unity/Float/) | | Initial Y position (center)  |
| `width` | [Float](/api-docs/unity/Float/) | | Width for default box shape  |
| `height` | [Float](/api-docs/unity/Float/) | | Height for default box shape  |
