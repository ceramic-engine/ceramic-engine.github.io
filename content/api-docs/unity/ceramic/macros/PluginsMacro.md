...
title: PluginsMacro
target: Unity
permalink: api-docs/unity/ceramic/macros/PluginsMacro/
---
...
| Returns | Description |
|---------|-------------|
| [Dynamic](/api-docs/unity/Dynamic/) | Expression block containing all plugin initialization calls |
