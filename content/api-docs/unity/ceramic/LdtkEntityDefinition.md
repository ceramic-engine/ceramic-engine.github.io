...
target: Unity
permalink: api-docs/unity/ceramic/LdtkEntityDefinition/
---
...
|------|------|-------------|
| `renderMode` | [LdtkRenderMode](/api-docs/unity/ceramic/LdtkRenderMode/) | The render mode we want to test  |
...
| Returns |
|---------|
| [LdtkFieldDefinition](/api-docs/unity/ceramic/LdtkFieldDefinition/) |
