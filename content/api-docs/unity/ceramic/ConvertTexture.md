...
target: Unity
permalink: api-docs/unity/ceramic/ConvertTexture/
---
...
<div class="see"><strong>See:</strong> <a href="/api-docs/unity/ceramic/ConvertField/">ConvertField</a>, <a href="/api-docs/unity/ceramic/Texture/">Texture</a>, <a href="/api-docs/unity/ceramic/ImageAsset/">ImageAsset</a>, <a href="/api-docs/unity/ceramic/Fragment/">Fragment</a></div>
...
|------|------|-------------|
| `instance` | [Entity](/api-docs/unity/ceramic/Entity/) | The entity that will use this texture  |
| `field` | [String](/api-docs/unity/String/) | The name of the field being converted  |
| `assets` | [Assets](/api-docs/unity/ceramic/Assets/) | Assets instance used to load the image  |
| `basic` | [String](/api-docs/unity/String/) | The image asset name to load  |
...
| Name | Type | Description |
|------|------|-------------|
| `instance` | [Entity](/api-docs/unity/ceramic/Entity/) | The entity that owns this texture  |
| `field` | [String](/api-docs/unity/String/) | The name of the field being converted  |
| `value` | [Texture](/api-docs/unity/ceramic/Texture/) | The Texture instance to convert  |

| Returns | Description |
|---------|-------------|
| [String](/api-docs/unity/String/) | The texture's asset name, or null if the texture or its asset is null |
