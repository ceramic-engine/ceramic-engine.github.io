...
target: Unity
permalink: api-docs/unity/ceramic/CollectionView/
---
...
<div class="see"><strong>See:</strong> <a href="/api-docs/unity/ceramic/CollectionViewDataSource/">CollectionViewDataSource</a>, <a href="/api-docs/unity/ceramic/CollectionViewLayout/">CollectionViewLayout</a>, <a href="/api-docs/unity/ceramic/CollectionViewFlowLayout/">CollectionViewFlowLayout</a></div>


## Instance Members

<div class="signature field-var has-description has-plugin" id="collectionViewFlowLayout"><div class="plugin-name">ui</div><code><span class="field-name">collectionViewFlowLayout</span><span class="operator">:</span> <a href="/api-docs/unity/ceramic/CollectionViewFlowLayout/" class="type-link">CollectionViewFlowLayout</a></code><a class="header-anchor" href="#collectionViewFlowLayout"><span aria-hidden="true" class="header-anchor__symbol">#</span></a></div>
...
|------|------|---------|-------------|
| `x` | [Float](/api-docs/unity/Float/) | | X coordinate to test  |
| `y` | [Float](/api-docs/unity/Float/) | | Y coordinate to test  |
| `includeScroll` | [Bool](/api-docs/unity/Bool/) | `true` | Whether to account for current scroll position  |

| Returns | Description |
|---------|-------------|
| [Int](/api-docs/unity/Int/) | Index of the closest item, or -1 if no items |

<hr class="field-separator" />

<div class="signature field-method has-description has-plugin" id="computeVisibleItems"><div class="plugin-name">ui</div><code><span class="field-name">computeVisibleItems</span><span class="parenthesis">(</span><span class="parenthesis">)</span><span class="operator">:</span> <a href="/api-docs/unity/Void/" class="type-link">Void</a></code><a class="header-anchor" href="#computeVisibleItems"><span aria-hidden="true" class="header-anchor__symbol">#</span></a></div>
...
| Name | Type | Default | Description |
|------|------|---------|-------------|
| `itemIndex` | [Int](/api-docs/unity/Int/) | | Index of the item to scroll to  |
| `itemPosition` | [CollectionViewItemPosition](/api-docs/unity/ceramic/CollectionViewItemPosition/) | `CollectionViewItemPosition.ENSURE_VISIBLE` | Where to position the item (START, MIDDLE, END, ENSURE_VISIBLE)  |

| Returns | Description |
|---------|-------------|
| [Float](/api-docs/unity/Float/) | Target scroll X value |

<hr class="field-separator" />

<div class="signature field-method has-description has-plugin" id="getTargetScrollYForItem"><div class="plugin-name">ui</div><code><span class="field-name">getTargetScrollYForItem</span><span class="parenthesis">(</span><span class="arg-name">itemIndex</span><span class="operator">:</span> <a href="/api-docs/unity/Int/" class="type-link">Int</a><span class="operator">,</span> <span class="operator">?</span><span class="arg-name">itemPosition</span><span class="operator">:</span> <a href="/api-docs/unity/ceramic/CollectionViewItemPosition/" class="type-link">CollectionViewItemPosition</a> <span class="operator">=</span> <span class="default-value">CollectionViewItemPosition.ENSURE_VISIBLE</span><span class="parenthesis">)</span><span class="operator">:</span> <a href="/api-docs/unity/Float/" class="type-link">Float</a></code><a class="header-anchor" href="#getTargetScrollYForItem"><span aria-hidden="true" class="header-anchor__symbol">#</span></a></div>
...
|------|------|---------|-------------|
| `itemIndex` | [Int](/api-docs/unity/Int/) | | Index of the item to scroll to  |
| `itemPosition` | [CollectionViewItemPosition](/api-docs/unity/ceramic/CollectionViewItemPosition/) | `CollectionViewItemPosition.ENSURE_VISIBLE` | Where to position the item (see scrollToItem)  |
