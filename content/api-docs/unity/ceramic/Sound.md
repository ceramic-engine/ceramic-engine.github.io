...
title: Sound
target: Unity
permalink: api-docs/unity/ceramic/Sound/
---
...
<div class="type-hierarchy"><a href="/api-docs/unity/ceramic/Entity/">Entity</a> → <strong>ceramic.Sound</strong> (Class)</div>
...
<div class="see"><strong>See:</strong> <a href="/api-docs/unity/ceramic/SoundPlayer/">SoundPlayer</a>, <a href="/api-docs/unity/ceramic/SoundAsset/">SoundAsset</a>, <a href="/api-docs/unity/ceramic/AudioMixer/">AudioMixer</a></div>
...
|------|------|-------------|
| `buffer` | [Float32Array](/api-docs/unity/ceramic/Float32Array/) | Float32Array containing the raw PCM samples  |
| `samples` | [Int](/api-docs/unity/Int/) | Number of sample frames (total samples divided by channel count)  |
| `channels` | [Int](/api-docs/unity/Int/) | Number of audio channels (1 = mono, 2 = stereo, etc.)  |
| `sampleRate` | [Float](/api-docs/unity/Float/) | Sample rate in Hz (e.g., 44100, 48000)  |
| `interleaved` | [Bool](/api-docs/unity/Bool/) | Whether the PCM data is interleaved (LRLRLR...) or planar (LLL...RRR...)  |

| Returns | Description |
|---------|-------------|
| [Sound](/api-docs/unity/ceramic/Sound/) | A new Sound instance ready to be played |

## Instance Members

<div class="signature field-var has-description" id="backendItem"><code><span class="field-name">backendItem</span><span class="operator">:</span> <a href="/api-docs/unity/backend/AudioResource/" class="type-link">backend.AudioResource</a></code><a class="header-anchor" href="#backendItem"><span aria-hidden="true" class="header-anchor__symbol">#</span></a></div>

The backend audio resource containing the actual audio data.

<hr class="field-separator" />

<div class="signature field-var has-description" id="asset"><code><span class="field-name">asset</span><span class="operator">:</span> <a href="/api-docs/unity/ceramic/SoundAsset/" class="type-link">SoundAsset</a></code><a class="header-anchor" href="#asset"><span aria-hidden="true" class="header-anchor__symbol">#</span></a></div>
...
<div class="signature field-var has-description" id="group"><code><span class="field-name">group</span><span class="operator">:</span> <a href="/api-docs/unity/Int/" class="type-link">Int</a></code><a class="header-anchor" href="#group"><span aria-hidden="true" class="header-anchor__symbol">#</span></a></div>
...
|------|------|---------|-------------|
| `position` | [Float](/api-docs/unity/Float/) | `0` | Start position in seconds (0 = beginning)  |
| `loop` | [Bool](/api-docs/unity/Bool/) | `false` | Whether to loop the sound continuously  |
| `volume` | [Float](/api-docs/unity/Float/) | *(optional)* | Volume override (0-1, null = use default)  |
| `pan` | [Float](/api-docs/unity/Float/) | *(optional)* | Pan override (-1 to 1, null = use default)  |
| `pitch` | [Float](/api-docs/unity/Float/) | *(optional)* | Pitch override (1 = normal, null = use default)  |
| `bus` | [Int](/api-docs/unity/Int/) | *(optional)* | Bus to play on (null = use sound's default bus)  |

| Returns | Description |
|---------|-------------|
| [SoundPlayer](/api-docs/unity/ceramic/SoundPlayer/) | A SoundPlayer instance to control this specific playback |
...
| Name | Type | Description |
|------|------|-------------|
| `backendItem` | [backend.AudioResource](/api-docs/unity/backend/AudioResource/) | The backend audio resource |
