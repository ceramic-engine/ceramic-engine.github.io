...
title: AsepriteTag
target: Unity
permalink: api-docs/unity/ceramic/AsepriteTag/
---
...
|------|------|-------------|
| `chunk` | [ase.chunks.Tag](/api-docs/unity/ase/chunks/Tag/) | The tag data from the Aseprite file  |

| Returns | Description |
|---------|-------------|
| [AsepriteTag](/api-docs/unity/ceramic/AsepriteTag/) | A new AsepriteTag instance |
...
| Name | Type | Description |
|------|------|-------------|
| `name` | [String](/api-docs/unity/String/) | * The name of this animation tag. Used to identify and play specific animations (e.g., "walk", "idle"). |
| `fromFrame` | [Int](/api-docs/unity/Int/) | * The first frame index of this animation (0-based, inclusive). |
| `toFrame` | [Int](/api-docs/unity/Int/) | * The last frame index of this animation (0-based, inclusive). |
| `direction` | [Int](/api-docs/unity/Int/) | * The playback direction for this animation: - 0: Forward (play from fromFrame to toFrame) - 1: Reverse (play from toFrame to fromFrame) - 2: Ping-pong (play forward then reverse) |
