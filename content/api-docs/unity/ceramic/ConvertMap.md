...
title: ConvertMap
target: Unity
permalink: api-docs/unity/ceramic/ConvertMap/
---
...
<div class="see"><strong>See:</strong> <a href="/api-docs/unity/ceramic/ConvertField/">ConvertField</a>, <a href="/api-docs/unity/ceramic/Fragment/">Fragment</a></div>
...
| `assets` | [Assets](/api-docs/unity/ceramic/Assets/) | Assets instance for resource loading (unused for maps)  |
| `basic` | [haxe.DynamicAccess](/api-docs/unity/haxe/DynamicAccess/)<ceramic.ConvertMap.T> | The DynamicAccess object to convert  |
...
| `instance` | [Entity](/api-docs/unity/ceramic/Entity/) | The entity that owns this field  |
| `field` | [String](/api-docs/unity/String/) | The name of the field being converted  |
| `value` | [Map](/api-docs/unity/Map/) | The Map instance to convert  |

| Returns | Description |
|---------|-------------|
| [haxe.DynamicAccess](/api-docs/unity/haxe/DynamicAccess/)<ceramic.ConvertMap.T> | A DynamicAccess object containing all map entries |
