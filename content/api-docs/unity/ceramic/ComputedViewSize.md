...
target: Unity
permalink: api-docs/unity/ceramic/ComputedViewSize/
---
...
<div class="see"><strong>See:</strong> <a href="/api-docs/unity/ceramic/View/">View</a>, <a href="/api-docs/unity/ceramic/ViewLayoutMask/">ViewLayoutMask</a></div>


## Static Members

<div class="signature field-var has-description has-plugin" id="NO_SIZE"><div class="plugin-name">ui</div><code><span class="field-name">NO_SIZE</span><span class="operator">:</span> <a href="/api-docs/unity/Float/" class="type-link">Float</a></code><a class="header-anchor" href="#NO_SIZE"><span aria-hidden="true" class="header-anchor__symbol">#</span></a></div>
...
| Returns | Description |
|---------|-------------|
| [ComputedViewSize](/api-docs/unity/ceramic/ComputedViewSize/) | A reset ComputedViewSize instance ready for use |

## Instance Members

<div class="signature field-var has-description has-plugin" id="parentLayoutMask"><div class="plugin-name">ui</div><code><span class="field-name">parentLayoutMask</span><span class="operator">:</span> <a href="/api-docs/unity/ceramic/ViewLayoutMask/" class="type-link">ViewLayoutMask</a></code><a class="header-anchor" href="#parentLayoutMask"><span aria-hidden="true" class="header-anchor__symbol">#</span></a></div>
...
<div class="signature field-method has-description has-plugin" id="new"><div class="plugin-name">ui</div><code><span class="field-name">new</span><span class="parenthesis">(</span><span class="arg-name">parentLayoutMask</span><span class="operator">:</span> <a href="/api-docs/unity/Null/" class="type-link">Null</a><span class="operator">&lt;</span><a href="/api-docs/unity/ceramic/ViewLayoutMask/" class="type-link">ViewLayoutMask</a><span class="operator">&gt;</span><span class="operator">,</span> <span class="arg-name">parentWidth</span><span class="operator">:</span> <a href="/api-docs/unity/Null/" class="type-link">Null</a><span class="operator">&lt;</span><a href="/api-docs/unity/Float/" class="type-link">Float</a><span class="operator">&gt;</span><span class="operator">,</span> <span class="arg-name">parentHeight</span><span class="operator">:</span> <a href="/api-docs/unity/Null/" class="type-link">Null</a><span class="operator">&lt;</span><a href="/api-docs/unity/Float/" class="type-link">Float</a><span class="operator">&gt;</span><span class="operator">,</span> <span class="arg-name">computedWidth</span><span class="operator">:</span> <a href="/api-docs/unity/Null/" class="type-link">Null</a><span class="operator">&lt;</span><a href="/api-docs/unity/Float/" class="type-link">Float</a><span class="operator">&gt;</span><span class="operator">,</span> <span class="arg-name">computedHeight</span><span class="operator">:</span> <a href="/api-docs/unity/Null/" class="type-link">Null</a><span class="operator">&lt;</span><a href="/api-docs/unity/Float/" class="type-link">Float</a><span class="operator">&gt;</span><span class="operator">,</span> <span class="arg-name">computedFitWidth</span><span class="operator">:</span> <a href="/api-docs/unity/Null/" class="type-link">Null</a><span class="operator">&lt;</span><a href="/api-docs/unity/Float/" class="type-link">Float</a><span class="operator">&gt;</span><span class="parenthesis">)</span><span class="operator">:</span> <a href="/api-docs/unity/Void/" class="type-link">Void</a></code><a class="header-anchor" href="#new"><span aria-hidden="true" class="header-anchor__symbol">#</span></a></div>


| Name | Type | Description |
|------|------|-------------|
| `parentLayoutMask` | [Null](/api-docs/unity/Null/)<[ViewLayoutMask](/api-docs/unity/ceramic/ViewLayoutMask/)> | * The layout mask from the parent view, indicating sizing constraints. Determines how the child view should calculate its dimensions. Default is FLEXIBLE. |
| `parentWidth` | [Null](/api-docs/unity/Null/)<[Float](/api-docs/unity/Float/)> | * The width constraint from the parent view. May be NO_SIZE if no width constraint is imposed. |
| `parentHeight` | [Null](/api-docs/unity/Null/)<[Float](/api-docs/unity/Float/)> | * The height constraint from the parent view. May be NO_SIZE if no height constraint is imposed. |
| `computedWidth` | [Null](/api-docs/unity/Null/)<[Float](/api-docs/unity/Float/)> | * The computed width for the view after layout calculation. Set by the view during its computeSize phase. |
| `computedHeight` | [Null](/api-docs/unity/Null/)<[Float](/api-docs/unity/Float/)> | * The computed height for the view after layout calculation. Set by the view during its computeSize phase. |
| `computedFitWidth` | [Null](/api-docs/unity/Null/)<[Float](/api-docs/unity/Float/)> | * Special computed width for content fitting scenarios. Used by views like TextView that need to calculate their ideal width based on content before applying constraints. |
