...
target: Unity
permalink: api-docs/unity/ceramic/ConvertTilemapData/
---
...
|------|------|-------------|
| `instance` | [Entity](/api-docs/unity/ceramic/Entity/) | The entity that owns the field being converted  |
...
| `basic` | [String](/api-docs/unity/String/) | The tilemap asset name to load  |
...
| `instance` | [Entity](/api-docs/unity/ceramic/Entity/) | The entity that owns the field being converted  |
| `field` | [String](/api-docs/unity/String/) | The name of the field being converted  |
| `value` | [TilemapData](/api-docs/unity/ceramic/TilemapData/) | The TilemapData instance to convert  |

| Returns | Description |
|---------|-------------|
| [String](/api-docs/unity/String/) | The asset name string, or null if the data has no associated asset |
