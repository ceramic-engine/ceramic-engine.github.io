...
title: MimeType
target: Unity
permalink: api-docs/unity/ceramic/MimeType/
---
...
|------|------|-------------|
| `type` | [String](/api-docs/unity/String/) | The MIME type string to analyze (may include parameters)  |

| Returns | Description |
|---------|-------------|
| [Bool](/api-docs/unity/Bool/) | true if the content is binary, false if it's text-based |

<hr class="field-separator" />

<div class="signature field-method has-description has-plugin" id="isText"><div class="plugin-name">http</div><code><span class="field-name">isText</span><span class="parenthesis">(</span><span class="arg-name">type</span><span class="operator">:</span> <a href="/api-docs/unity/String/" class="type-link">String</a><span class="parenthesis">)</span><span class="operator">:</span> <a href="/api-docs/unity/Bool/" class="type-link">Bool</a></code><a class="header-anchor" href="#isText"><span aria-hidden="true" class="header-anchor__symbol">#</span></a></div>
...
| Returns | Description |
|---------|-------------|
| [Bool](/api-docs/unity/Bool/) | true if the content is text-based, false if it's binary |
