...
title: DoubleClick
target: Unity
permalink: api-docs/unity/ceramic/DoubleClick/
---
...
<div class="type-hierarchy"><a href="/api-docs/unity/ceramic/Entity/">Entity</a> → <strong>ceramic.DoubleClick</strong> (Class)</div>
...
<div class="signature field-var has-description" id="maxDelay"><code><span class="field-name">maxDelay</span><span class="operator">:</span> <a href="/api-docs/unity/Float/" class="type-link">Float</a></code><a class="header-anchor" href="#maxDelay"><span aria-hidden="true" class="header-anchor__symbol">#</span></a></div>
...
<div class="signature field-var no-description" id="pressed"><code><span class="field-name">pressed</span><span class="operator">:</span> <a href="/api-docs/unity/Bool/" class="type-link">Bool</a></code><a class="header-anchor" href="#pressed"><span aria-hidden="true" class="header-anchor__symbol">#</span></a></div>

<hr class="field-separator" />

<div class="signature field-var no-description" id="firstClickTime"><code><span class="field-name">firstClickTime</span><span class="operator">:</span> <a href="/api-docs/unity/Float/" class="type-link">Float</a></code><a class="header-anchor" href="#firstClickTime"><span aria-hidden="true" class="header-anchor__symbol">#</span></a></div>
