...
title: SortVisuals
target: Unity
permalink: api-docs/unity/ceramic/SortVisuals/
---
...
|------|------|-------------|
| `a` | [Array](/api-docs/unity/Array/)<[Visual](/api-docs/unity/ceramic/Visual/)> | The array of visuals to sort. Modified in place. If null, behavior is undefined. |
...
| Returns | Description |
|---------|-------------|
| [Int](/api-docs/unity/Int/) | -1 if a should render before b, 1 if b should render before a, 0 if equal |
