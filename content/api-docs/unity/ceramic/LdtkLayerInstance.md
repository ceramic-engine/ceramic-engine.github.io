...
target: Unity
permalink: api-docs/unity/ceramic/LdtkLayerInstance/
---
...
| Name | Type | Default |
|------|------|---------|
| `level` | [LdtkLevel](/api-docs/unity/ceramic/LdtkLevel/) | *(optional)* |
