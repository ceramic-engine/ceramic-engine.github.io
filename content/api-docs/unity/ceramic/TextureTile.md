...
title: TextureTile
target: Unity
permalink: api-docs/unity/ceramic/TextureTile/
---
...
<div class="type-hierarchy"><strong>ceramic.TextureTile</strong> (Class) → <a href="/api-docs/unity/ceramic/TextureAtlasRegion/">TextureAtlasRegion</a>, <a href="/api-docs/unity/ceramic/_TextureTilePacker/PackedTextureTile/">ceramic._TextureTilePacker.PackedTextureTile</a></div>
...
<div class="signature field-var has-description" id="edgeInset"><code><span class="field-name">edgeInset</span><span class="operator">:</span> <a href="/api-docs/unity/Float/" class="type-link">Float</a></code><a class="header-anchor" href="#edgeInset"><span aria-hidden="true" class="header-anchor__symbol">#</span></a></div>
...
|------|------|-------------|
| `frameX` | [Float](/api-docs/unity/Float/) | New X coordinate in texture pixels  |
| `frameY` | [Float](/api-docs/unity/Float/) | New Y coordinate in texture pixels  |
| `frameWidth` | [Float](/api-docs/unity/Float/) | New width in texture pixels  |
| `frameHeight` | [Float](/api-docs/unity/Float/) | New height in texture pixels |
...
|------|------|---------|-------------|
| `texture` | [Texture](/api-docs/unity/ceramic/Texture/) | | Source texture containing the tile  |
| `frameX` | [Float](/api-docs/unity/Float/) | | X coordinate in texture pixels  |
| `frameY` | [Float](/api-docs/unity/Float/) | | Y coordinate in texture pixels  |
| `frameWidth` | [Float](/api-docs/unity/Float/) | | Width in texture pixels  |
| `frameHeight` | [Float](/api-docs/unity/Float/) | | Height in texture pixels  |
| `rotateFrame` | [Bool](/api-docs/unity/Bool/) | `false` | Whether tile is rotated 90 degrees (default: false)  |
| `edgeInset` | [Float](/api-docs/unity/Float/) | `0` | Pixel inset for edge bleeding prevention (default: 0) |
...
| Returns | Description |
|---------|-------------|
| [String](/api-docs/unity/String/) | String with tile properties |
