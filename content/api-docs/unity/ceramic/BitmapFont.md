...
title: BitmapFont
target: Unity
permalink: api-docs/unity/ceramic/BitmapFont/
---
...
<div class="type-hierarchy"><a href="/api-docs/unity/ceramic/Entity/">Entity</a> → <strong>ceramic.BitmapFont</strong> (Class)</div>
...
<div class="signature field-var has-description" id="msdf"><code><span class="field-name">msdf</span><span class="operator">:</span> <a href="/api-docs/unity/Bool/" class="type-link">Bool</a></code><a class="header-anchor" href="#msdf"><span aria-hidden="true" class="header-anchor__symbol">#</span></a></div>
...
<div class="signature field-var has-description" id="pageShaders"><code><span class="field-name">pageShaders</span><span class="operator">:</span> <a href="/api-docs/unity/Map/" class="type-link">Map</a></code><a class="header-anchor" href="#pageShaders"><span aria-hidden="true" class="header-anchor__symbol">#</span></a></div>
...
<div class="signature field-var has-description" id="preRenderedPages"><code><span class="field-name">preRenderedPages</span><span class="operator">:</span> <a href="/api-docs/unity/Map/" class="type-link">Map</a></code><a class="header-anchor" href="#preRenderedPages"><span aria-hidden="true" class="header-anchor__symbol">#</span></a></div>
...
<div class="signature field-var has-description" id="asset"><code><span class="field-name">asset</span><span class="operator">:</span> <a href="/api-docs/unity/ceramic/Asset/" class="type-link">Asset</a></code><a class="header-anchor" href="#asset"><span aria-hidden="true" class="header-anchor__symbol">#</span></a></div>
...
|------|------|-------------|
| `pixelSize` | [Int](/api-docs/unity/Int/) | The target size in pixels  |

| Returns | Description |
|---------|-------------|
| [Bool](/api-docs/unity/Bool/) | True if pre-rendering is needed, false otherwise |

<hr class="field-separator" />

<div class="signature field-method has-description" id="preRenderAtSize"><code><span class="field-name">preRenderAtSize</span><span class="parenthesis">(</span><span class="arg-name">pixelSize</span><span class="operator">:</span> <a href="/api-docs/unity/Int/" class="type-link">Int</a><span class="operator">,</span> <span class="arg-name">done</span><span class="operator">:</span> <span class="type-name">Function</span><span class="parenthesis">)</span><span class="operator">:</span> <a href="/api-docs/unity/Void/" class="type-link">Void</a></code><a class="header-anchor" href="#preRenderAtSize"><span aria-hidden="true" class="header-anchor__symbol">#</span></a></div>
...
| Name | Type | Description |
|------|------|-------------|
| `fontData` | [BitmapFontData](/api-docs/unity/ceramic/BitmapFontData/) | The font data containing metrics and character information  |
| `pages` | [Map](/api-docs/unity/Map/) | A map of texture file paths to their corresponding textures  |

## Private Members

<div class="signature field-var has-description" id="fontData"><code><span class="field-name">fontData</span><span class="operator">:</span> <a href="/api-docs/unity/ceramic/BitmapFontData/" class="type-link">BitmapFontData</a></code><a class="header-anchor" href="#fontData"><span aria-hidden="true" class="header-anchor__symbol">#</span></a></div>
...
| Name | Type | Description |
|------|------|-------------|
| `id` | [Int](/api-docs/unity/Int/) | The texture page ID  |
| `pixelsSize` | [Int](/api-docs/unity/Int/) | The target size in pixels  |
| `done` | Function | Callback function called when pre-rendering is complete |
