...
target: Unity
permalink: api-docs/unity/ceramic/CollectionEntry/
---
...
<div class="type-hierarchy"><strong>ceramic.CollectionEntry</strong> (Class) → <a href="/api-docs/unity/ceramic/ValueEntry/">ValueEntry</a></div>
...
<div class="see"><strong>See:</strong> <a href="/api-docs/unity/ceramic/Collection/">Collection</a>, <a href="/api-docs/unity/ceramic/FieldInfo/">FieldInfo</a></div>
...
| Name | Type | Description |
|------|------|-------------|
| `name` | [String](/api-docs/unity/String/) | The field name  |
| `rawValue` | [Dynamic](/api-docs/unity/Dynamic/) | The raw value to process  |

| Returns | Description |
|---------|-------------|
| [Bool](/api-docs/unity/Bool/) | True if field was handled, false to use default conversion |
...
|------|------|---------|-------------|
| `id` | [String](/api-docs/unity/String/) | *(optional)* | Optional unique identifier (auto-generated if not provided)  |
| `name` | [String](/api-docs/unity/String/) | *(optional)* | Optional human-readable name |
