...
title: TimerCallback
target: Unity
permalink: api-docs/unity/ceramic/TimerCallback/
---
...
<div class="signature field-var has-description" id="cleared"><code><span class="field-name">cleared</span><span class="operator">:</span> <a href="/api-docs/unity/Bool/" class="type-link">Bool</a></code><a class="header-anchor" href="#cleared"><span aria-hidden="true" class="header-anchor__symbol">#</span></a></div>
