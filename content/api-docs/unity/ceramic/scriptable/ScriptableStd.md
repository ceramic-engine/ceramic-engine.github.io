...
title: ScriptableStd
target: Unity
permalink: api-docs/unity/ceramic/scriptable/ScriptableStd/
---
...
|------|------|-------------|
| `x` | [Float](/api-docs/unity/Float/) | The float value to convert  |

| Returns | Description |
|---------|-------------|
| [Int](/api-docs/unity/Int/) | The integer part of x |
...
| Name | Type | Description |
|------|------|-------------|
| `s` | [Dynamic](/api-docs/unity/Dynamic/) | The value to convert  |

| Returns | Description |
|---------|-------------|
| [String](/api-docs/unity/String/) | String representation of the value |
...
| Name | Type | Description |
|------|------|-------------|
| `s` | [String](/api-docs/unity/String/) | The string to parse  |

| Returns | Description |
|---------|-------------|
| [Null](/api-docs/unity/Null/)<[Int](/api-docs/unity/Int/)> | The parsed integer, or null if parsing fails |
...
| Returns | Description |
|---------|-------------|
| [Float](/api-docs/unity/Float/) | The parsed float, or NaN if parsing fails |
...
| Name | Type | Description |
|------|------|-------------|
| `x` | [Int](/api-docs/unity/Int/) | The upper bound (exclusive)  |

| Returns | Description |
|---------|-------------|
| [Int](/api-docs/unity/Int/) | Random integer in range [0, x) |
