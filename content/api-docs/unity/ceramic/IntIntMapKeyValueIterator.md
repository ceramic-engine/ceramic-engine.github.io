...
target: Unity
permalink: api-docs/unity/ceramic/IntIntMapKeyValueIterator/
---
...
<div class="signature field-var no-description" id="intIntMap"><code><span class="field-name">intIntMap</span><span class="operator">:</span> <a href="/api-docs/unity/ceramic/IntIntMap/" class="type-link">IntIntMap</a></code><a class="header-anchor" href="#intIntMap"><span aria-hidden="true" class="header-anchor__symbol">#</span></a></div>
