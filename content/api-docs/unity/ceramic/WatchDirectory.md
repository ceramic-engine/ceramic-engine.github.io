...
target: Unity
permalink: api-docs/unity/ceramic/WatchDirectory/
---
...
<div class="type-hierarchy"><a href="/api-docs/unity/ceramic/Entity/">Entity</a> → <strong>ceramic.WatchDirectory</strong> (Class)</div>
...
|------|------|-------------|
| `path` | [String](/api-docs/unity/String/) | The absolute path to the directory to watch  |
...
| Name | Type | Description |
|------|------|-------------|
| `path` | [String](/api-docs/unity/String/) | The directory path to stop watching  |

| Returns | Description |
|---------|-------------|
| [Bool](/api-docs/unity/Bool/) | true if the directory was being watched and is now stopped, false otherwise |
...
|------|------|---------|-------------|
| `updateInterval` | [Float](/api-docs/unity/Float/) | `1.0` | The interval in seconds between directory checks (default: 1.0). Only used in polling mode; chokidar provides real-time updates. |
...
| Name | Type | Description |
|------|------|-------------|
| `path` | [String](/api-docs/unity/String/) | The directory path that changed  |
| `newFiles` | [ReadOnlyMap](/api-docs/unity/ceramic/ReadOnlyMap/)<[String](/api-docs/unity/String/), [Float](/api-docs/unity/Float/)> | Map of current files to their modification times (Unix timestamp)  |
| `previousFiles` | [ReadOnlyMap](/api-docs/unity/ceramic/ReadOnlyMap/)<[String](/api-docs/unity/String/), [Float](/api-docs/unity/Float/)> | Map of files to modification times before the change |
...
| Name | Type | Description |
|------|------|-------------|
| `path` | [String](/api-docs/unity/String/) | The directory path to check |
...
| Name | Type | Description |
|------|------|-------------|
| `path` | [String](/api-docs/unity/String/) | The directory path to scan  |

| Returns | Description |
|---------|-------------|
| [ReadOnlyMap](/api-docs/unity/ceramic/ReadOnlyMap/)<[String](/api-docs/unity/String/), [Float](/api-docs/unity/Float/)> | Map of relative file paths to modification timestamps |
