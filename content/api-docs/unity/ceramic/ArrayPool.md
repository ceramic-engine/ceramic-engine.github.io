...
title: ArrayPool
target: Unity
permalink: api-docs/unity/ceramic/ArrayPool/
---
...
<div class="see"><strong>See:</strong> <a href="/api-docs/unity/ceramic/ReusableArray/">ReusableArray</a></div>
...
| Returns | Description |
|---------|-------------|
| [ReusableArray](/api-docs/unity/ceramic/ReusableArray/)<[Any](/api-docs/unity/Any/)> | A ReusableArray instance of the pool's configured size |
...
| Name | Type | Description |
|------|------|-------------|
| `array` | [ReusableArray](/api-docs/unity/ceramic/ReusableArray/)<[Any](/api-docs/unity/Any/)> | The array to return to the pool |
...
| Name | Type | Description |
|------|------|-------------|
| `arrayLengths` | [Int](/api-docs/unity/Int/) | The size of arrays this pool will manage |

## Private Members

<div class="signature field-var no-description" id="ALLOC_STEP"><code><span class="field-name">ALLOC_STEP</span><span class="operator">:</span> <a href="/api-docs/unity/Int/" class="type-link">Int</a></code><a class="header-anchor" href="#ALLOC_STEP"><span aria-hidden="true" class="header-anchor__symbol">#</span></a></div>
...
<div class="signature field-var has-description" id="nextFree"><code><span class="field-name">nextFree</span><span class="operator">:</span> <a href="/api-docs/unity/Int/" class="type-link">Int</a></code><a class="header-anchor" href="#nextFree"><span aria-hidden="true" class="header-anchor__symbol">#</span></a></div>

Index of the next available slot in the pool

<hr class="field-separator" />

<div class="signature field-var has-description" id="arrayLengths"><code><span class="field-name">arrayLengths</span><span class="operator">:</span> <a href="/api-docs/unity/Int/" class="type-link">Int</a></code><a class="header-anchor" href="#arrayLengths"><span aria-hidden="true" class="header-anchor__symbol">#</span></a></div>
