...
target: Unity
permalink: api-docs/unity/ceramic/TrackerBackend/
---
...
<div class="see"><strong>See:</strong> <a href="/api-docs/unity/tracker/Observable/">tracker.Observable</a>, <a href="/api-docs/unity/tracker/Tracker/">tracker.Tracker</a>, <a href="/api-docs/unity/ceramic/BackgroundQueue/">BackgroundQueue</a></div>
...
| Name | Type | Description |
|------|------|-------------|
| `key` | [String](/api-docs/unity/String/) | the key to use  |

| Returns | Description |
|---------|-------------|
| [String](/api-docs/unity/String/) | String or null of no string was found |
...
|------|------|-------------|
| `key` | [String](/api-docs/unity/String/) | the key to use  |
| `str` | [String](/api-docs/unity/String/) | the string to save  |

| Returns | Description |
|---------|-------------|
| [Bool](/api-docs/unity/Bool/) | Bool `true` if the save was successful |
...
|------|------|-------------|
| `key` | [String](/api-docs/unity/String/) | the key to use  |
| `str` | [String](/api-docs/unity/String/) | the string to append  |
...
|------|------|---------|-------------|
| `message` | [Dynamic](/api-docs/unity/Dynamic/) | | the warning message |
| `pos` | [Null](/api-docs/unity/Null/)<[haxe.PosInfos](/api-docs/unity/haxe/PosInfos/)> | *(optional)* |  |
...
| Name | Type | Default | Description |
|------|------|---------|-------------|
| `error` | [Dynamic](/api-docs/unity/Dynamic/) | | the error message |
| `pos` | [Null](/api-docs/unity/Null/)<[haxe.PosInfos](/api-docs/unity/haxe/PosInfos/)> | *(optional)* |  |
...
| Name | Type | Default | Description |
|------|------|---------|-------------|
| `message` | [Dynamic](/api-docs/unity/Dynamic/) | | the success message |
| `pos` | [Null](/api-docs/unity/Null/)<[haxe.PosInfos](/api-docs/unity/haxe/PosInfos/)> | *(optional)* |  |
...
| Name | Type | Description |
|------|------|-------------|
| `owner` | [Entity](/api-docs/unity/ceramic/Entity/) | The entity that owns this interval  |
| `seconds` | [Float](/api-docs/unity/Float/) | The time in seconds between each call  |
...
| Name | Type | Description |
|------|------|-------------|
| `owner` | [Entity](/api-docs/unity/ceramic/Entity/) | The entity that owns this delayed call  |
| `seconds` | [Float](/api-docs/unity/Float/) | The time in seconds of delay before the call  |
| `callback` | Function | The callback to call  |
...
| Returns | Description |
|---------|-------------|
| [Null](/api-docs/unity/Null/)<[String](/api-docs/unity/String/)> | The storage directory path, or null if not available |

<hr class="field-separator" />

<div class="signature field-method has-description" id="pathJoin"><code><span class="field-name">pathJoin</span><span class="parenthesis">(</span><span class="arg-name">paths</span><span class="operator">:</span> <a href="/api-docs/unity/Array/" class="type-link">Array</a><span class="operator">&lt;</span><a href="/api-docs/unity/String/" class="type-link">String</a><span class="operator">&gt;</span><span class="parenthesis">)</span><span class="operator">:</span> <a href="/api-docs/unity/String/" class="type-link">String</a></code><a class="header-anchor" href="#pathJoin"><span aria-hidden="true" class="header-anchor__symbol">#</span></a></div>
...
| Returns | Description |
|---------|-------------|
| [String](/api-docs/unity/String/) | The combined path with appropriate separators |
...
<div class="signature field-var has-description" id="backgroundQueue"><code><span class="field-name">backgroundQueue</span><span class="operator">:</span> <a href="/api-docs/unity/ceramic/BackgroundQueue/" class="type-link">BackgroundQueue</a></code><a class="header-anchor" href="#backgroundQueue"><span aria-hidden="true" class="header-anchor__symbol">#</span></a></div>
