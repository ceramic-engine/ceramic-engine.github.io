...
target: Unity
permalink: api-docs/unity/ceramic/ArcadeSortGroupTopBottom/
---
...
| Name | Type | Description |
|------|------|-------------|
| `a` | [Visual](/api-docs/unity/ceramic/Visual/) | First visual to compare  |
| `b` | [Visual](/api-docs/unity/ceramic/Visual/) | Second visual to compare  |

| Returns | Description |
|---------|-------------|
| [Int](/api-docs/unity/Int/) | 1 if a.body.y >= b.body.y, -1 otherwise, 0 if either has no body |
...
| Name | Type |
|------|------|
| `a` | [Array](/api-docs/unity/Array/)<[Visual](/api-docs/unity/ceramic/Visual/)> |
