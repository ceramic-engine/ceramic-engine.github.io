...
target: Unity
permalink: api-docs/unity/ceramic/ConvertSpineData/
---
...
<div class="see"><strong>See:</strong> <a href="/api-docs/unity/ceramic/SpineData/">SpineData</a>, <a href="/api-docs/unity/ceramic/SpineAsset/">SpineAsset</a>, <a href="/api-docs/unity/ceramic/ConvertField/">ConvertField</a></div>
...
|------|------|-------------|
| `instance` | [Entity](/api-docs/unity/ceramic/Entity/) | The entity instance that owns the field  |
| `field` | [String](/api-docs/unity/String/) | The name of the field being converted  |
| `assets` | [Assets](/api-docs/unity/ceramic/Assets/) | The asset manager used to load the Spine asset  |
| `basic` | [String](/api-docs/unity/String/) | The string value (asset name) to convert from  |
...
| `instance` | [Entity](/api-docs/unity/ceramic/Entity/) | The entity instance that owns the field  |
| `field` | [String](/api-docs/unity/String/) | The name of the field being converted  |
| `value` | [SpineData](/api-docs/unity/ceramic/SpineData/) | The SpineData value to convert  |

| Returns | Description |
|---------|-------------|
| [String](/api-docs/unity/String/) | The asset name string, or null if the SpineData has no associated asset |
