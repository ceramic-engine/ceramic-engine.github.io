...
title: Group
target: Unity
permalink: api-docs/unity/ceramic/Group/
---
...
<div class="type-hierarchy"><a href="/api-docs/unity/ceramic/Entity/">Entity</a> → <strong>ceramic.Group</strong> (Class)</div>
...
| Returns | Description |
|---------|-------------|
| [Bool](/api-docs/unity/Bool/) | `true` if the item is in the group, `false` otherwise |
...
|------|------|---------|-------------|
| `id` | [String](/api-docs/unity/String/) | *(optional)* | Optional identifier for the group. Useful for debugging and finding specific groups. |
...
| Name | Type | Description |
|------|------|-------------|
| `item` | [Entity](/api-docs/unity/ceramic/Entity/) | The entity that was destroyed |
