...
subCategory: doc
menu: Shade
title: Shader__shaders_GaussianBlur_Vert__shaders_GaussianBlur_Frag
target: Clay (Web)
permalink: api-docs/clay-web/shade/Shader__shaders_GaussianBlur_Vert__shaders_GaussianBlur_Frag/
---

# Shader__shaders_GaussianBlur_Vert__shaders_GaussianBlur_Frag
...
<div class="type-hierarchy"><a href="/api-docs/clay-web/ceramic/Entity/">ceramic.Entity</a> → <a href="/api-docs/clay-web/ceramic/Shader/">ceramic.Shader</a> → <strong>shade.Shader__shaders_GaussianBlur_Vert__shaders_GaussianBlur_Frag</strong> (Class) → <a href="/api-docs/clay-web/shaders/GaussianBlur/">shaders.GaussianBlur</a></div>
