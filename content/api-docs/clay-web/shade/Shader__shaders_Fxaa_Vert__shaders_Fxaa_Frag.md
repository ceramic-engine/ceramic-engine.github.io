...
target: Clay (Web)
permalink: api-docs/clay-web/shade/Shader__shaders_Fxaa_Vert__shaders_Fxaa_Frag/
---
...
<div class="type-hierarchy"><a href="/api-docs/clay-web/ceramic/Entity/">ceramic.Entity</a> → <a href="/api-docs/clay-web/ceramic/Shader/">ceramic.Shader</a> → <strong>shade.Shader__shaders_Fxaa_Vert__shaders_Fxaa_Frag</strong> (Class) → <a href="/api-docs/clay-web/shaders/Fxaa/">shaders.Fxaa</a></div>
