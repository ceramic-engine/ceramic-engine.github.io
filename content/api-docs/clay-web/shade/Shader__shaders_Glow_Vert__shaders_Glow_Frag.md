...
target: Clay (Web)
permalink: api-docs/clay-web/shade/Shader__shaders_Glow_Vert__shaders_Glow_Frag/
---
...
<div class="type-hierarchy"><a href="/api-docs/clay-web/ceramic/Entity/">ceramic.Entity</a> → <a href="/api-docs/clay-web/ceramic/Shader/">ceramic.Shader</a> → <strong>shade.Shader__shaders_Glow_Vert__shaders_Glow_Frag</strong> (Class) → <a href="/api-docs/clay-web/shaders/Glow/">shaders.Glow</a></div>
