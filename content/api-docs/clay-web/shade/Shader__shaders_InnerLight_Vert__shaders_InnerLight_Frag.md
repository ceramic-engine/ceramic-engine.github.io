...
target: Clay (Web)
permalink: api-docs/clay-web/shade/Shader__shaders_InnerLight_Vert__shaders_InnerLight_Frag/
---
...
<div class="type-hierarchy"><a href="/api-docs/clay-web/ceramic/Entity/">ceramic.Entity</a> → <a href="/api-docs/clay-web/ceramic/Shader/">ceramic.Shader</a> → <strong>shade.Shader__shaders_InnerLight_Vert__shaders_InnerLight_Frag</strong> (Class) → <a href="/api-docs/clay-web/shaders/InnerLight/">shaders.InnerLight</a></div>
