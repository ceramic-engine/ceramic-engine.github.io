...
title: Lambda
target: Clay (Web)
permalink: api-docs/clay-web/Lambda/
---
...
| Name | Type |
|------|------|
| `it` | [Iterable](/api-docs/clay-web/Iterable/) |
| `f` | Function |

| Returns |
|---------|
| [Array](/api-docs/clay-web/Array/)<map.B> |
