...
title: UserDataChunk
target: Clay (Web)
permalink: api-docs/clay-web/ase/chunks/UserDataChunk/
---
...
<div class="type-hierarchy"><a href="/api-docs/clay-web/ase/chunks/Chunk/">Chunk</a> → <strong>ase.chunks.UserDataChunk</strong> (Class)</div>
...
| Returns |
|---------|
| [UserDataChunk](/api-docs/clay-web/ase/chunks/UserDataChunk/) |
...
<div class="signature field-var no-description" id="hasText"><code><span class="field-name">hasText</span><span class="operator">:</span> <a href="/api-docs/clay-web/Bool/" class="type-link">Bool</a></code><a class="header-anchor" href="#hasText"><span aria-hidden="true" class="header-anchor__symbol">#</span></a></div>

<hr class="field-separator" />

<div class="signature field-var no-description" id="hasColor"><code><span class="field-name">hasColor</span><span class="operator">:</span> <a href="/api-docs/clay-web/Bool/" class="type-link">Bool</a></code><a class="header-anchor" href="#hasColor"><span aria-hidden="true" class="header-anchor__symbol">#</span></a></div>
...
<div class="signature field-var no-description" id="green"><code><span class="field-name">green</span><span class="operator">:</span> <a href="/api-docs/clay-web/Int/" class="type-link">Int</a></code><a class="header-anchor" href="#green"><span aria-hidden="true" class="header-anchor__symbol">#</span></a></div>

<hr class="field-separator" />

<div class="signature field-var no-description" id="blue"><code><span class="field-name">blue</span><span class="operator">:</span> <a href="/api-docs/clay-web/Int/" class="type-link">Int</a></code><a class="header-anchor" href="#blue"><span aria-hidden="true" class="header-anchor__symbol">#</span></a></div>
