...
target: Clay (Web)
permalink: api-docs/clay-web/ase/chunks/PaletteChunkEntry/
---
...
| Returns |
|---------|
| [PaletteChunkEntry](/api-docs/clay-web/ase/chunks/PaletteChunkEntry/) |
...
<div class="signature field-var no-description" id="hasName"><code><span class="field-name">hasName</span><span class="operator">:</span> <a href="/api-docs/clay-web/Bool/" class="type-link">Bool</a></code><a class="header-anchor" href="#hasName"><span aria-hidden="true" class="header-anchor__symbol">#</span></a></div>
...
| Name | Type | Default |
|------|------|---------|
| `name` | [String](/api-docs/clay-web/String/) | *(optional)* |
| `color` | [Int](/api-docs/clay-web/Int/) | *(optional)* |
