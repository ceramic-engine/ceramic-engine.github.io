...
title: ChunkHeader
target: Clay (Web)
permalink: api-docs/clay-web/ase/chunks/ChunkHeader/
---
...
| Returns |
|---------|
| [ChunkHeader](/api-docs/clay-web/ase/chunks/ChunkHeader/) |
...
<div class="signature field-var no-description" id="type"><code><span class="field-name">type</span><span class="operator">:</span> <a href="/api-docs/clay-web/ase/types/ChunkType/" class="type-link">ase.types.ChunkType</a></code><a class="header-anchor" href="#type"><span aria-hidden="true" class="header-anchor__symbol">#</span></a></div>
