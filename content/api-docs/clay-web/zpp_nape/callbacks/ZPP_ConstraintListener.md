...
target: Clay (Web)
permalink: api-docs/clay-web/zpp_nape/callbacks/ZPP_ConstraintListener/
---
...
<div class="type-hierarchy"><a href="/api-docs/clay-web/zpp_nape/callbacks/ZPP_Listener/">ZPP_Listener</a> → <strong>zpp_nape.callbacks.ZPP_ConstraintListener</strong> (Class)</div>

## Instance Members

<div class="signature field-var no-description has-plugin" id="outer_zn"><div class="plugin-name">nape</div><code><span class="field-name">outer_zn</span><span class="operator">:</span> <a href="/api-docs/clay-web/nape/callbacks/ConstraintListener/" class="type-link">nape.callbacks.ConstraintListener</a></code><a class="header-anchor" href="#outer_zn"><span aria-hidden="true" class="header-anchor__symbol">#</span></a></div>
