...
target: Clay (Web)
permalink: api-docs/clay-web/zpp_nape/space/ZPP_CbSetManager/
---
...
<div class="signature field-var no-description has-plugin" id="cbsets"><div class="plugin-name">nape</div><code><span class="field-name">cbsets</span><span class="operator">:</span> <a href="/api-docs/clay-web/zpp_nape/util/ZPP_Set_ZPP_CbSet/" class="type-link">zpp_nape.util.ZPP_Set_ZPP_CbSet</a></code><a class="header-anchor" href="#cbsets"><span aria-hidden="true" class="header-anchor__symbol">#</span></a></div>
...
| Name | Type |
|------|------|
| `set` | [zpp_nape.callbacks.ZPP_CbSet](/api-docs/clay-web/zpp_nape/callbacks/ZPP_CbSet/) |
...
| Name | Type |
|------|------|
| `a` | [zpp_nape.callbacks.ZPP_CbSet](/api-docs/clay-web/zpp_nape/callbacks/ZPP_CbSet/) |
| `b` | [zpp_nape.callbacks.ZPP_CbSet](/api-docs/clay-web/zpp_nape/callbacks/ZPP_CbSet/) |
