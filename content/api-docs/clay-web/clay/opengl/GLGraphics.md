...
title: GLGraphics
target: Clay (Web)
permalink: api-docs/clay-web/clay/opengl/GLGraphics/
---
...
<div class="signature field-var no-description" id="NO_FRAMEBUFFER"><code><span class="field-name">NO_FRAMEBUFFER</span><span class="operator">:</span> <a href="/api-docs/clay-web/clay/opengl/GLFramebuffer/" class="type-link">GLFramebuffer</a></code><a class="header-anchor" href="#NO_FRAMEBUFFER"><span aria-hidden="true" class="header-anchor__symbol">#</span></a></div>

<hr class="field-separator" />

<div class="signature field-var no-description" id="NO_RENDERBUFFER"><code><span class="field-name">NO_RENDERBUFFER</span><span class="operator">:</span> <a href="/api-docs/clay-web/clay/opengl/GLRenderbuffer/" class="type-link">GLRenderbuffer</a></code><a class="header-anchor" href="#NO_RENDERBUFFER"><span aria-hidden="true" class="header-anchor__symbol">#</span></a></div>

<hr class="field-separator" />

<div class="signature field-var no-description" id="NO_SHADER"><code><span class="field-name">NO_SHADER</span><span class="operator">:</span> <a href="/api-docs/clay-web/clay/opengl/GLShader/" class="type-link">GLShader</a></code><a class="header-anchor" href="#NO_SHADER"><span aria-hidden="true" class="header-anchor__symbol">#</span></a></div>

<hr class="field-separator" />

<div class="signature field-var no-description" id="NO_PROGRAM"><code><span class="field-name">NO_PROGRAM</span><span class="operator">:</span> <a href="/api-docs/clay-web/clay/opengl/GLProgram/" class="type-link">GLProgram</a></code><a class="header-anchor" href="#NO_PROGRAM"><span aria-hidden="true" class="header-anchor__symbol">#</span></a></div>

<hr class="field-separator" />

<div class="signature field-var no-description" id="NO_LOCATION"><code><span class="field-name">NO_LOCATION</span><span class="operator">:</span> <a href="/api-docs/clay-web/clay/opengl/GLUniformLocation/" class="type-link">GLUniformLocation</a></code><a class="header-anchor" href="#NO_LOCATION"><span aria-hidden="true" class="header-anchor__symbol">#</span></a></div>

<hr class="field-separator" />

<div class="signature field-var no-description" id="NO_BUFFER"><code><span class="field-name">NO_BUFFER</span><span class="operator">:</span> <a href="/api-docs/clay-web/clay/opengl/GLBuffer/" class="type-link">GLBuffer</a></code><a class="header-anchor" href="#NO_BUFFER"><span aria-hidden="true" class="header-anchor__symbol">#</span></a></div>
...
|------|------|---------|-------------|
| `r` | [Float](/api-docs/clay-web/Float/) | | red value (between 0 and 1)  |
| `g` | [Float](/api-docs/clay-web/Float/) | | green value (between 0 and 1)  |
| `b` | [Float](/api-docs/clay-web/Float/) | | blue value (between 0 and 1)  |
| `a` | [Float](/api-docs/clay-web/Float/) | | alpha value (between 0 and 1)  |
| `clearDepth` | [Bool](/api-docs/clay-web/Bool/) | `true` | set to `true` (default) to also clear depth buffer, if applicable |
...
| Returns | Description |
|---------|-------------|
| [clay.TextureId](/api-docs/clay-web/clay/TextureId/) | TextureId |
...
|------|------|-------------|
| `slot` | [Int](/api-docs/clay-web/Int/) | a slot number. Assigned expression will be `GL.TEXTURE0 + slot` on GL |
...
| Name | Type |
|------|------|
| `textureId` | [clay.TextureId](/api-docs/clay-web/clay/TextureId/) |
...
| Name | Type | Description |
|------|------|-------------|
| `x` | [Int](/api-docs/clay-web/Int/) | The x value to specify lower left corner of viewport  |
| `y` | [Int](/api-docs/clay-web/Int/) | The y value to specify lower left corner of viewport  |
| `width` | [Int](/api-docs/clay-web/Int/) | The width of the viewport  |
| `height` | [Int](/api-docs/clay-web/Int/) | The height of the viewport |
...
| Name | Type | Description |
|------|------|-------------|
| `textureId` | [clay.TextureId](/api-docs/clay-web/clay/TextureId/) | a valid texture identifier returned by `createTextureId()` or `NO_TEXTURE` to unbind texture |
...
| Name | Type | Description |
|------|------|-------------|
| `level` | [Int](/api-docs/clay-web/Int/) | The level of detail. Level 0 is the base image level. Level n is the nth mipmap reduction image.  |
| `format` | [clay.TextureFormat](/api-docs/clay-web/clay/TextureFormat/) | The texture format (RGBA)  |
| `width` | [Int](/api-docs/clay-web/Int/) | The width of the texture to submit  |
| `height` | [Int](/api-docs/clay-web/Int/) | The height of the texture to submit  |
| `pixels` | [clay.buffers.Uint8Array](/api-docs/clay-web/clay/buffers/Uint8Array/) | The pixels buffer when the data will be written to  |
| `premultipliedAlpha` | [Bool](/api-docs/clay-web/Bool/) | The pixels buffer should be stored as premultiplied alpha |
...
| `width` | [Int](/api-docs/clay-web/Int/) | The width of the texture to submit  |
| `height` | [Int](/api-docs/clay-web/Int/) | The height of the texture to submit  |
| `dataType` | [clay.TextureDataType](/api-docs/clay-web/clay/TextureDataType/) | The data type of the pixel data (UNSIGNED_BYTE)  |
| `pixels` | [clay.buffers.Uint8Array](/api-docs/clay-web/clay/buffers/Uint8Array/) | The pixels buffer containing data to submit  |
| `premultipliedAlpha` | [Bool](/api-docs/clay-web/Bool/) | The pixels buffer should be stored as premultiplied alpha |
...
| Name | Type | Description |
|------|------|-------------|
| `into` | [clay.buffers.Uint8Array](/api-docs/clay-web/clay/buffers/Uint8Array/) | The pixels buffer when the data will be written to  |
| `x` | [Int](/api-docs/clay-web/Int/) | The x position of the texture rect to fetch  |
| `y` | [Int](/api-docs/clay-web/Int/) | The y position of the texture rect to fetch  |
| `w` | [Int](/api-docs/clay-web/Int/) | The width of the texture rect to fetch  |
| `h` | [Int](/api-docs/clay-web/Int/) | The height of the texture rect to fetch |

<hr class="field-separator" />

<div class="signature field-method has-description" id="createFramebuffer"><code><span class="field-name">createFramebuffer</span><span class="parenthesis">(</span><span class="parenthesis">)</span><span class="operator">:</span> <a href="/api-docs/clay-web/clay/opengl/GLFramebuffer/" class="type-link">GLFramebuffer</a></code><a class="header-anchor" href="#createFramebuffer"><span aria-hidden="true" class="header-anchor__symbol">#</span></a></div>

Create a new framebuffer

| Returns | Description |
|---------|-------------|
| [GLFramebuffer](/api-docs/clay-web/clay/opengl/GLFramebuffer/) | Framebuffer |

<hr class="field-separator" />

<div class="signature field-method has-description" id="bindFramebuffer"><code><span class="field-name">bindFramebuffer</span><span class="parenthesis">(</span><span class="arg-name">framebuffer</span><span class="operator">:</span> <a href="/api-docs/clay-web/clay/opengl/GLFramebuffer/" class="type-link">GLFramebuffer</a><span class="parenthesis">)</span><span class="operator">:</span> <a href="/api-docs/clay-web/Void/" class="type-link">Void</a></code><a class="header-anchor" href="#bindFramebuffer"><span aria-hidden="true" class="header-anchor__symbol">#</span></a></div>
...
| Name | Type | Description |
|------|------|-------------|
| `framebuffer` | [GLFramebuffer](/api-docs/clay-web/clay/opengl/GLFramebuffer/) | The framebuffer to bind |

<hr class="field-separator" />

<div class="signature field-method has-description" id="createRenderbuffer"><code><span class="field-name">createRenderbuffer</span><span class="parenthesis">(</span><span class="parenthesis">)</span><span class="operator">:</span> <a href="/api-docs/clay-web/clay/opengl/GLRenderbuffer/" class="type-link">GLRenderbuffer</a></code><a class="header-anchor" href="#createRenderbuffer"><span aria-hidden="true" class="header-anchor__symbol">#</span></a></div>

Create a new renderbuffer

| Returns | Description |
|---------|-------------|
| [GLRenderbuffer](/api-docs/clay-web/clay/opengl/GLRenderbuffer/) | Renderbuffer |

<hr class="field-separator" />

<div class="signature field-method has-description" id="bindRenderbuffer"><code><span class="field-name">bindRenderbuffer</span><span class="parenthesis">(</span><span class="arg-name">renderbuffer</span><span class="operator">:</span> <a href="/api-docs/clay-web/clay/opengl/GLRenderbuffer/" class="type-link">GLRenderbuffer</a><span class="parenthesis">)</span><span class="operator">:</span> <a href="/api-docs/clay-web/Void/" class="type-link">Void</a></code><a class="header-anchor" href="#bindRenderbuffer"><span aria-hidden="true" class="header-anchor__symbol">#</span></a></div>
...
| Name | Type | Description |
|------|------|-------------|
| `renderbuffer` | [GLRenderbuffer](/api-docs/clay-web/clay/opengl/GLRenderbuffer/) | The renderbuffer to bind |
...
| Name | Type |
|------|------|
| `minFilter` | [clay.TextureFilter](/api-docs/clay-web/clay/TextureFilter/) |
...
| Name | Type |
|------|------|
| `magFilter` | [clay.TextureFilter](/api-docs/clay-web/clay/TextureFilter/) |
...
| Name | Type |
|------|------|
| `wrapS` | [clay.TextureWrap](/api-docs/clay-web/clay/TextureWrap/) |
...
| Name | Type | Description |
|------|------|-------------|
| `renderTarget` | [GLGraphics_RenderTarget](/api-docs/clay-web/clay/opengl/GLGraphics_RenderTarget/) |  |
| `textureId` | [clay.TextureId](/api-docs/clay-web/clay/TextureId/) | * |
| `width` | [Int](/api-docs/clay-web/Int/) | * |
| `height` | [Int](/api-docs/clay-web/Int/) | * |
| `depth` | [Bool](/api-docs/clay-web/Bool/) |  |
...
| Name | Type | Default |
|------|------|---------|
| `vertSource` | [String](/api-docs/clay-web/String/) | |
| `fragSource` | [String](/api-docs/clay-web/String/) | |
| `attributes` | [Array](/api-docs/clay-web/Array/)<[String](/api-docs/clay-web/String/)> | *(optional)* |
| `textures` | [Array](/api-docs/clay-web/Array/)<[String](/api-docs/clay-web/String/)> | *(optional)* |

| Returns |
|---------|
| [clay.GpuShader](/api-docs/clay-web/clay/GpuShader/) |

<hr class="field-separator" />

<div class="signature field-method no-description" id="linkShader"><code><span class="field-name">linkShader</span><span class="parenthesis">(</span><span class="arg-name">shader</span><span class="operator">:</span> <a href="/api-docs/clay-web/clay/opengl/GLGraphics_GpuShader/" class="type-link">GLGraphics_GpuShader</a><span class="operator">,</span> <span class="operator">?</span><span class="arg-name">attributes</span><span class="operator">:</span> <a href="/api-docs/clay-web/Array/" class="type-link">Array</a><span class="operator">&lt;</span><a href="/api-docs/clay-web/String/" class="type-link">String</a><span class="operator">&gt;</span><span class="parenthesis">)</span><span class="operator">:</span> <a href="/api-docs/clay-web/Bool/" class="type-link">Bool</a></code><a class="header-anchor" href="#linkShader"><span aria-hidden="true" class="header-anchor__symbol">#</span></a></div>


| Name | Type | Default |
|------|------|---------|
| `shader` | [GLGraphics_GpuShader](/api-docs/clay-web/clay/opengl/GLGraphics_GpuShader/) | |
| `attributes` | [Array](/api-docs/clay-web/Array/)<[String](/api-docs/clay-web/String/)> | *(optional)* |
...
| Returns |
|---------|
| [GLShader](/api-docs/clay-web/clay/opengl/GLShader/) |
...
| Name | Type |
|------|------|
| `shader` | [clay.GpuShader](/api-docs/clay-web/clay/GpuShader/) |
| `name` | [String](/api-docs/clay-web/String/) |

| Returns |
|---------|
| [GLUniformLocation](/api-docs/clay-web/clay/opengl/GLUniformLocation/) |
...
|------|------|
| `shader` | [clay.GpuShader](/api-docs/clay-web/clay/GpuShader/) |
| `location` | [GLUniformLocation](/api-docs/clay-web/clay/opengl/GLUniformLocation/) |
...
| `texture` | [clay.TextureId](/api-docs/clay-web/clay/TextureId/) |
...
| Name | Type |
|------|------|
| `srcRgb` | [clay.BlendMode](/api-docs/clay-web/clay/BlendMode/) |
| `dstRgb` | [clay.BlendMode](/api-docs/clay-web/clay/BlendMode/) |
| `srcAlpha` | [clay.BlendMode](/api-docs/clay-web/clay/BlendMode/) |
| `dstAlpha` | [clay.BlendMode](/api-docs/clay-web/clay/BlendMode/) |
