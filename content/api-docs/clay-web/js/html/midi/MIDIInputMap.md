...
title: MIDIInputMap
target: Clay (Web)
permalink: api-docs/clay-web/js/html/midi/MIDIInputMap/
---

# MIDIInputMap

<div class="type-hierarchy"><strong>js.html.midi.MIDIInputMap</strong> (extern class)</div>
...
<div class="see"><strong>See:</strong> <https://developer.mozilla.org/en-US/docs/Web/API/MIDIInputMap></div>
