...
title: Promise
target: Clay (Web)
permalink: api-docs/clay-web/js/lib/Promise/
---
...
| Name | Type |
|------|------|
| `thenable` | [Thenable](/api-docs/clay-web/js/lib/Thenable/)<resolve.T> |

| Returns |
|---------|
| [Promise](/api-docs/clay-web/js/lib/Promise/)<resolve.T> |
...
| Name | Type | Default |
|------|------|---------|
| `reason` | [Dynamic](/api-docs/clay-web/Dynamic/) | *(optional)* |

| Returns |
|---------|
| [Promise](/api-docs/clay-web/js/lib/Promise/)<reject.T> |
...
| Name | Type |
|------|------|
| `iterable` | [Array](/api-docs/clay-web/Array/)<[Promise](/api-docs/clay-web/js/lib/Promise/)<all.T>> |

| Returns |
|---------|
| [Promise](/api-docs/clay-web/js/lib/Promise/)<[Array](/api-docs/clay-web/Array/)<all.T>> |

<hr class="field-separator" />

<div class="signature field-method has-description" id="allSettled"><code><span class="field-name">allSettled</span><span class="parenthesis">(</span><span class="arg-name">iterable</span><span class="operator">:</span> <a href="/api-docs/clay-web/Array/" class="type-link">Array</a><span class="operator">&lt;</span><a href="#" class="type-link">Promise</a><span class="operator">&lt;</span><span class="type-name">allSettled.T</span><span class="operator">&gt;</span><span class="operator">&gt;</span><span class="parenthesis">)</span><span class="operator">:</span> <a href="#" class="type-link">Promise</a><span class="operator">&lt;</span><a href="/api-docs/clay-web/Array/" class="type-link">Array</a><span class="operator">&lt;</span><a href="/api-docs/clay-web/js/lib/PromiseSettleOutcome/" class="type-link">PromiseSettleOutcome</a><span class="operator">&gt;</span><span class="operator">&gt;</span></code><a class="header-anchor" href="#allSettled"><span aria-hidden="true" class="header-anchor__symbol">#</span></a></div>
...
| Name | Type |
|------|------|
| `iterable` | [Array](/api-docs/clay-web/Array/)<[Promise](/api-docs/clay-web/js/lib/Promise/)<allSettled.T>> |

| Returns |
|---------|
| [Promise](/api-docs/clay-web/js/lib/Promise/)<[Array](/api-docs/clay-web/Array/)<[PromiseSettleOutcome](/api-docs/clay-web/js/lib/PromiseSettleOutcome/)>> |
...
| Name | Type | Default |
|------|------|---------|
| `onFulfilled` | [Null](/api-docs/clay-web/Null/)<[PromiseHandler](/api-docs/clay-web/js/lib/PromiseHandler/)<js.lib.Promise.T, [then.TOut](/api-docs/clay-web/then/TOut/)>> | |
| `onRejected` | [PromiseHandler](/api-docs/clay-web/js/lib/PromiseHandler/)<[Dynamic](/api-docs/clay-web/Dynamic/), [then.TOut](/api-docs/clay-web/then/TOut/)> | *(optional)* |

| Returns |
|---------|
| [Promise](/api-docs/clay-web/js/lib/Promise/)<[then.TOut](/api-docs/clay-web/then/TOut/)> |
...
| Name | Type |
|------|------|
| `onRejected` | [PromiseHandler](/api-docs/clay-web/js/lib/PromiseHandler/)<[Dynamic](/api-docs/clay-web/Dynamic/), js.lib.Promise.T> |

| Returns |
|---------|
| [Promise](/api-docs/clay-web/js/lib/Promise/)<js.lib.Promise.T> |
