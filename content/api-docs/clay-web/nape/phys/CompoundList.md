...
title: CompoundList
target: Clay (Web)
permalink: api-docs/clay-web/nape/phys/CompoundList/
---
...
|------|------|-------------|
| `array` | [Array](/api-docs/clay-web/Array/)<[Compound](/api-docs/clay-web/nape/phys/Compound/)> | The array to be converted  |

| Returns | Description |
|---------|-------------|
| [CompoundList](/api-docs/clay-web/nape/phys/CompoundList/) | An equivalent Nape list.  |

## Instance Members

<div class="signature field-var has-description has-plugin" id="zpp_inner"><div class="plugin-name">nape</div><code><span class="field-name">zpp_inner</span><span class="operator">:</span> <a href="/api-docs/clay-web/zpp_nape/util/ZPP_CompoundList/" class="type-link">zpp_nape.util.ZPP_CompoundList</a></code><a class="header-anchor" href="#zpp_inner"><span aria-hidden="true" class="header-anchor__symbol">#</span></a></div>
...
| Name | Type | Description |
|------|------|-------------|
| `obj` | [Compound](/api-docs/clay-web/nape/phys/Compound/) | The object to test.  |
...
| Name | Type | Description |
|------|------|-------------|
| `obj` | [Compound](/api-docs/clay-web/nape/phys/Compound/) | The object to insert.  |
...
| Name | Type | Description |
|------|------|-------------|
| `obj` | [Compound](/api-docs/clay-web/nape/phys/Compound/) | The object to remove  |
...
| Returns |
|---------|
| [CompoundIterator](/api-docs/clay-web/nape/phys/CompoundIterator/) |
...
| Returns | Description |
|---------|-------------|
| [CompoundList](/api-docs/clay-web/nape/phys/CompoundList/) | The copied list. |
...
| Name | Type | Description |
|------|------|-------------|
| `xs` | [CompoundList](/api-docs/clay-web/nape/phys/CompoundList/) | The list to merge.  |
...
| Returns | Description |
|---------|-------------|
| [CompoundList](/api-docs/clay-web/nape/phys/CompoundList/) | A reference to 'this' list.  |
