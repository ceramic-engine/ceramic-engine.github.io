...
target: Clay (Web)
permalink: api-docs/clay-web/nape/phys/FluidProperties/
---
...
| Returns | Description |
|---------|-------------|
| [FluidProperties](/api-docs/clay-web/nape/phys/FluidProperties/) | The copied FluidProperties. |
...
|------|------|---------|-------------|
| `density` | [Float](/api-docs/clay-web/Float/) | `1` | The density of the fluid in g/px/px. (default 1)  |
| `viscosity` | [Float](/api-docs/clay-web/Float/) | `1` | The viscosity of the fluid for drag computations in kg/px/s (default 1)  |
