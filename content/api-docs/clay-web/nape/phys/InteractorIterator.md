...
target: Clay (Web)
permalink: api-docs/clay-web/nape/phys/InteractorIterator/
---
...
|------|------|-------------|
| `list` | [InteractorList](/api-docs/clay-web/nape/phys/InteractorList/) | The Nape list to create iterator for.  |

| Returns | Description |
|---------|-------------|
| [InteractorIterator](/api-docs/clay-web/nape/phys/InteractorIterator/) | An iterator over the Nape list. |
...
| Returns | Description |
|---------|-------------|
| [Interactor](/api-docs/clay-web/nape/phys/Interactor/) | The next element in iteration. |
