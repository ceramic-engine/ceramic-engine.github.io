...
target: Clay (Web)
permalink: api-docs/clay-web/nape/phys/CompoundIterator/
---
...
|------|------|-------------|
| `list` | [CompoundList](/api-docs/clay-web/nape/phys/CompoundList/) | The Nape list to create iterator for.  |

| Returns | Description |
|---------|-------------|
| [CompoundIterator](/api-docs/clay-web/nape/phys/CompoundIterator/) | An iterator over the Nape list. |
...
| Returns | Description |
|---------|-------------|
| [Compound](/api-docs/clay-web/nape/phys/Compound/) | The next element in iteration. |
