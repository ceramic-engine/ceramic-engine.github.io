...
target: Clay (Web)
permalink: api-docs/clay-web/nape/phys/InteractorList/
---
...
|------|------|-------------|
| `array` | [Array](/api-docs/clay-web/Array/)<[Interactor](/api-docs/clay-web/nape/phys/Interactor/)> | The array to be converted  |

| Returns | Description |
|---------|-------------|
| [InteractorList](/api-docs/clay-web/nape/phys/InteractorList/) | An equivalent Nape list.  |

## Instance Members

<div class="signature field-var has-description has-plugin" id="zpp_inner"><div class="plugin-name">nape</div><code><span class="field-name">zpp_inner</span><span class="operator">:</span> <a href="/api-docs/clay-web/zpp_nape/util/ZPP_InteractorList/" class="type-link">zpp_nape.util.ZPP_InteractorList</a></code><a class="header-anchor" href="#zpp_inner"><span aria-hidden="true" class="header-anchor__symbol">#</span></a></div>
...
| Name | Type | Description |
|------|------|-------------|
| `obj` | [Interactor](/api-docs/clay-web/nape/phys/Interactor/) | The object to test.  |
...
| Returns |
|---------|
| [Interactor](/api-docs/clay-web/nape/phys/Interactor/) |
...
| Name | Type | Description |
|------|------|-------------|
| `obj` | [Interactor](/api-docs/clay-web/nape/phys/Interactor/) | The object to insert.  |
...
| Name | Type | Description |
|------|------|-------------|
| `obj` | [Interactor](/api-docs/clay-web/nape/phys/Interactor/) | The object to remove  |
...
| Returns |
|---------|
| [InteractorIterator](/api-docs/clay-web/nape/phys/InteractorIterator/) |
...
| Returns | Description |
|---------|-------------|
| [InteractorList](/api-docs/clay-web/nape/phys/InteractorList/) | The copied list. |
...
| Name | Type | Description |
|------|------|-------------|
| `xs` | [InteractorList](/api-docs/clay-web/nape/phys/InteractorList/) | The list to merge.  |
...
| Returns | Description |
|---------|-------------|
| [InteractorList](/api-docs/clay-web/nape/phys/InteractorList/) | A reference to 'this' list.  |
