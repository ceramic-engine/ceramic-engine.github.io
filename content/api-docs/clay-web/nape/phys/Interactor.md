...
title: Interactor
target: Clay (Web)
permalink: api-docs/clay-web/nape/phys/Interactor/
---
...
<div class="type-hierarchy"><strong>nape.phys.Interactor</strong> (Class) → <a href="/api-docs/clay-web/nape/phys/Body/">Body</a>, <a href="/api-docs/clay-web/nape/phys/Compound/">Compound</a>, <a href="/api-docs/clay-web/nape/shape/Shape/">nape.shape.Shape</a></div>
...
<div class="signature field-var has-description has-plugin" id="zpp_inner_i"><div class="plugin-name">nape</div><code><span class="field-name">zpp_inner_i</span><span class="operator">:</span> <a href="/api-docs/clay-web/zpp_nape/phys/ZPP_Interactor/" class="type-link">zpp_nape.phys.ZPP_Interactor</a></code><a class="header-anchor" href="#zpp_inner_i"><span aria-hidden="true" class="header-anchor__symbol">#</span></a></div>
...
| Returns | Description |
|---------|-------------|
| [Bool](/api-docs/clay-web/Bool/) | true if this Interactor is a Shape. |
...
| Returns | Description |
|---------|-------------|
| [Bool](/api-docs/clay-web/Bool/) | true if this Interactor is a Body. |
...
| Returns | Description |
|---------|-------------|
| [Bool](/api-docs/clay-web/Bool/) | true if this Interactor is a Compound. |
