...
title: Polygon
target: Clay (Web)
permalink: api-docs/clay-web/nape/shape/Polygon/
---
...
<div class="type-hierarchy"><a href="/api-docs/clay-web/nape/phys/Interactor/">nape.phys.Interactor</a> → <a href="/api-docs/clay-web/nape/shape/Shape/">Shape</a> → <strong>nape.shape.Polygon</strong> (final class)</div>
...
|------|------|---------|-------------|
| `x` | [Float](/api-docs/clay-web/Float/) | | The x coordinate of rectangle.  |
| `y` | [Float](/api-docs/clay-web/Float/) | | The y coordinate of rectangle.  |
| `width` | [Float](/api-docs/clay-web/Float/) | | The width of the ractangle. This value may be negative.  |
| `height` | [Float](/api-docs/clay-web/Float/) | | The height of the rectangle This value may be negative.  |
| `weak` | [Bool](/api-docs/clay-web/Bool/) | `false` | If true, the generated list of vertices will be allocated as weak Vec2s so that when this list is passed to a Nape function these Vec2s will be automatically sent back to object pool. (default false)  |

| Returns | Description |
|---------|-------------|
| [Array](/api-docs/clay-web/Array/)<[nape.geom.Vec2](/api-docs/clay-web/nape/geom/Vec2/)> | An array of Vec2 representing the given rectangle. |
...
| Name | Type | Default | Description |
|------|------|---------|-------------|
| `width` | [Float](/api-docs/clay-web/Float/) | | The width of the box (This value may be negative but will make no difference).  |
| `height` | [Float](/api-docs/clay-web/Float/) | | The height of the box (This value may be negative but will make no difference).  |
| `weak` | [Bool](/api-docs/clay-web/Bool/) | `false` | If true, the generated list of vertices will be allocated as weak Vec2s so that when this list is passed to a Nape function these Vec2s will be automatically sent back to object pool. (default false)  |

| Returns | Description |
|---------|-------------|
| [Array](/api-docs/clay-web/Array/)<[nape.geom.Vec2](/api-docs/clay-web/nape/geom/Vec2/)> | An array of Vec2 representing the given box. |
...
| Name | Type | Default | Description |
|------|------|---------|-------------|
| `xRadius` | [Float](/api-docs/clay-web/Float/) | | The x radius of polygon before angleOffset rotation.  |
| `yRadius` | [Float](/api-docs/clay-web/Float/) | | The y radius of polygon before angleOffset rotation.  |
| `edgeCount` | [Int](/api-docs/clay-web/Int/) | | The number of edges/vertices in polygon.  |
| `angleOffset` | [Float](/api-docs/clay-web/Float/) | `0.0` | The clockwise angular offset to generate vertices at in radians. (default 0.0)  |
| `weak` | [Bool](/api-docs/clay-web/Bool/) | `false` | If true, the generated list of vertices will be allocated as weak Vec2s so that when this list is passed to a Nape function these Vec2s will be automatically sent back to object pool. (default false)  |

| Returns | Description |
|---------|-------------|
| [Array](/api-docs/clay-web/Array/)<[nape.geom.Vec2](/api-docs/clay-web/nape/geom/Vec2/)> | An array of Vec2 representing the polygon. |

## Instance Members

<div class="signature field-var has-description has-plugin" id="zpp_inner_zn"><div class="plugin-name">nape</div><code><span class="field-name">zpp_inner_zn</span><span class="operator">:</span> <a href="/api-docs/clay-web/zpp_nape/shape/ZPP_Polygon/" class="type-link">zpp_nape.shape.ZPP_Polygon</a></code><a class="header-anchor" href="#zpp_inner_zn"><span aria-hidden="true" class="header-anchor__symbol">#</span></a></div>

@private

<hr class="field-separator" />

<div class="signature field-var has-description has-plugin" id="localVerts"><div class="plugin-name">nape</div><code><span class="field-name">localVerts</span><span class="operator">:</span> <a href="/api-docs/clay-web/nape/geom/Vec2List/" class="type-link">nape.geom.Vec2List</a></code><a class="header-anchor" href="#localVerts"><span aria-hidden="true" class="header-anchor__symbol">#</span></a></div>
...
<div class="signature field-var has-description has-plugin" id="edges"><div class="plugin-name">nape</div><code><span class="field-name">edges</span><span class="operator">:</span> <a href="/api-docs/clay-web/nape/shape/EdgeList/" class="type-link">EdgeList</a></code><a class="header-anchor" href="#edges"><span aria-hidden="true" class="header-anchor__symbol">#</span></a></div>
...
<div class="signature field-method has-description has-plugin" id="validity"><div class="plugin-name">nape</div><code><span class="field-name">validity</span><span class="parenthesis">(</span><span class="parenthesis">)</span><span class="operator">:</span> <a href="/api-docs/clay-web/nape/shape/ValidationResult/" class="type-link">ValidationResult</a></code><a class="header-anchor" href="#validity"><span aria-hidden="true" class="header-anchor__symbol">#</span></a></div>

Determine validity of polygon for use in a Nape simulation.
| Returns |
|---------|
| [ValidationResult](/api-docs/clay-web/nape/shape/ValidationResult/) |
...
| Name | Type | Default | Description |
|------|------|---------|-------------|
| `localVerts` | [Dynamic](/api-docs/clay-web/Dynamic/) | | The local vertices of polygon.  |
| `material` | [nape.phys.Material](/api-docs/clay-web/nape/phys/Material/) | `null` | The material for this polygon. (default new Material&#40;&#41;)  |
| `filter` | [nape.dynamics.InteractionFilter](/api-docs/clay-web/nape/dynamics/InteractionFilter/) | `null` | The interaction filter for this polygon. (default new InteractionFilter&#40;&#41;)  |
