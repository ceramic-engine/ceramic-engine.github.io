...
title: Edge
target: Clay (Web)
permalink: api-docs/clay-web/nape/shape/Edge/
---
...
<div class="signature field-var has-description has-plugin" id="worldNormal"><div class="plugin-name">nape</div><code><span class="field-name">worldNormal</span><span class="operator">:</span> <a href="/api-docs/clay-web/nape/geom/Vec2/" class="type-link">nape.geom.Vec2</a></code><a class="header-anchor" href="#worldNormal"><span aria-hidden="true" class="header-anchor__symbol">#</span></a></div>
