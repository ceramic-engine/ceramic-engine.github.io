...
title: EdgeList
target: Clay (Web)
permalink: api-docs/clay-web/nape/shape/EdgeList/
---
...
|------|------|-------------|
| `array` | [Array](/api-docs/clay-web/Array/)<[Edge](/api-docs/clay-web/nape/shape/Edge/)> | The array to be converted  |

| Returns | Description |
|---------|-------------|
| [EdgeList](/api-docs/clay-web/nape/shape/EdgeList/) | An equivalent Nape list.  |

## Instance Members

<div class="signature field-var has-description has-plugin" id="zpp_inner"><div class="plugin-name">nape</div><code><span class="field-name">zpp_inner</span><span class="operator">:</span> <a href="/api-docs/clay-web/zpp_nape/util/ZPP_EdgeList/" class="type-link">zpp_nape.util.ZPP_EdgeList</a></code><a class="header-anchor" href="#zpp_inner"><span aria-hidden="true" class="header-anchor__symbol">#</span></a></div>
...
| Name | Type | Description |
|------|------|-------------|
| `obj` | [Edge](/api-docs/clay-web/nape/shape/Edge/) | The object to test.  |
...
| Returns |
|---------|
| [Edge](/api-docs/clay-web/nape/shape/Edge/) |
...
| Name | Type | Description |
|------|------|-------------|
| `obj` | [Edge](/api-docs/clay-web/nape/shape/Edge/) | The object to insert.  |
...
| Name | Type | Description |
|------|------|-------------|
| `obj` | [Edge](/api-docs/clay-web/nape/shape/Edge/) | The object to remove  |
...
| Returns |
|---------|
| [EdgeIterator](/api-docs/clay-web/nape/shape/EdgeIterator/) |
...
| Returns | Description |
|---------|-------------|
| [EdgeList](/api-docs/clay-web/nape/shape/EdgeList/) | The copied list. |
...
| Name | Type | Description |
|------|------|-------------|
| `xs` | [EdgeList](/api-docs/clay-web/nape/shape/EdgeList/) | The list to merge.  |
...
| Returns | Description |
|---------|-------------|
| [EdgeList](/api-docs/clay-web/nape/shape/EdgeList/) | A reference to 'this' list.  |
