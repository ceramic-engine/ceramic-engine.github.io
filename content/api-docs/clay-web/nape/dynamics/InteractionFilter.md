...
target: Clay (Web)
permalink: api-docs/clay-web/nape/dynamics/InteractionFilter/
---
...
|------|------|-------------|
| `filter` | [InteractionFilter](/api-docs/clay-web/nape/dynamics/InteractionFilter/) | The filter to evaluate possibility of collision with.  |

| Returns | Description |
|---------|-------------|
| [Bool](/api-docs/clay-web/Bool/) | True, if based on interaction filters only the two objects would be able to collide.  |
...
| Name | Type | Description |
|------|------|-------------|
| `filter` | [InteractionFilter](/api-docs/clay-web/nape/dynamics/InteractionFilter/) | The filter to evaluate possibility of sensor with.  |

| Returns | Description |
|---------|-------------|
| [Bool](/api-docs/clay-web/Bool/) | True, if based on interaction filters only the two objects would be able to sense.  |
...
| Name | Type | Description |
|------|------|-------------|
| `filter` | [InteractionFilter](/api-docs/clay-web/nape/dynamics/InteractionFilter/) | The filter to evaluate possibility of fluid with.  |

| Returns | Description |
|---------|-------------|
| [Bool](/api-docs/clay-web/Bool/) | True, if based on interaction filters only the two objects would be able to interact as fluids.  |
...
| Returns | Description |
|---------|-------------|
| [InteractionFilter](/api-docs/clay-web/nape/dynamics/InteractionFilter/) | The copy of this filter. |
...
|------|------|---------|-------------|
| `collisionGroup` | [Int](/api-docs/clay-web/Int/) | `1` | The Group bitfield for Collision interactions. (default 1)  |
| `collisionMask` | [Int](/api-docs/clay-web/Int/) | `-1` | The Mask bitfield for Collision interactions. (default -1)  |
| `sensorGroup` | [Int](/api-docs/clay-web/Int/) | `1` | The Group bitfield for Sensor interactions. (default 1)  |
| `sensorMask` | [Int](/api-docs/clay-web/Int/) | `-1` | The Mask bitfield for Sensor interactions. (default -1)  |
| `fluidGroup` | [Int](/api-docs/clay-web/Int/) | `1` | The Group bitfield for Fluid interactions. (default 1)  |
| `fluidMask` | [Int](/api-docs/clay-web/Int/) | `-1` | The Mask bitfield for Fluid interactions. (default -1)  |
