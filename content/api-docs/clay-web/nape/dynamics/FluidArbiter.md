...
title: FluidArbiter
target: Clay (Web)
permalink: api-docs/clay-web/nape/dynamics/FluidArbiter/
---
...
<div class="type-hierarchy"><a href="/api-docs/clay-web/nape/dynamics/Arbiter/">Arbiter</a> → <strong>nape.dynamics.FluidArbiter</strong> (final class)</div>
...
| Returns | Description |
|---------|-------------|
| [nape.geom.Vec3](/api-docs/clay-web/nape/geom/Vec3/) | The buoyancy impulse for given body.  |
...
| Returns | Description |
|---------|-------------|
| [nape.geom.Vec3](/api-docs/clay-web/nape/geom/Vec3/) | The drag impulse for given body.  |
...
|------|------|---------|-------------|
| `body` | [nape.phys.Body](/api-docs/clay-web/nape/phys/Body/) | `null` | The body to query impulse for. (default null)  |
| `freshOnly` | [Bool](/api-docs/clay-web/Bool/) | `false` | This parameter is unused for FluidArbiters. (default false)  |

| Returns | Description |
|---------|-------------|
| [nape.geom.Vec3](/api-docs/clay-web/nape/geom/Vec3/) | The total impulse for given body.  |
