...
target: Clay (Web)
permalink: api-docs/clay-web/nape/dynamics/ArbiterIterator/
---
...
|------|------|-------------|
| `list` | [ArbiterList](/api-docs/clay-web/nape/dynamics/ArbiterList/) | The Nape list to create iterator for.  |

| Returns | Description |
|---------|-------------|
| [ArbiterIterator](/api-docs/clay-web/nape/dynamics/ArbiterIterator/) | An iterator over the Nape list. |
...
| Returns | Description |
|---------|-------------|
| [Arbiter](/api-docs/clay-web/nape/dynamics/Arbiter/) | The next element in iteration. |
