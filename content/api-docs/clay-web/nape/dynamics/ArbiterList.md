...
title: ArbiterList
target: Clay (Web)
permalink: api-docs/clay-web/nape/dynamics/ArbiterList/
---
...
<div class="type-hierarchy"><strong>nape.dynamics.ArbiterList</strong> (Class) → <a href="/api-docs/clay-web/zpp_nape/dynamics/ZPP_SpaceArbiterList/">zpp_nape.dynamics.ZPP_SpaceArbiterList</a></div>
...
|------|------|-------------|
| `array` | [Array](/api-docs/clay-web/Array/)<[Arbiter](/api-docs/clay-web/nape/dynamics/Arbiter/)> | The array to be converted  |

| Returns | Description |
|---------|-------------|
| [ArbiterList](/api-docs/clay-web/nape/dynamics/ArbiterList/) | An equivalent Nape list.  |

## Instance Members

<div class="signature field-var has-description has-plugin" id="zpp_inner"><div class="plugin-name">nape</div><code><span class="field-name">zpp_inner</span><span class="operator">:</span> <a href="/api-docs/clay-web/zpp_nape/util/ZPP_ArbiterList/" class="type-link">zpp_nape.util.ZPP_ArbiterList</a></code><a class="header-anchor" href="#zpp_inner"><span aria-hidden="true" class="header-anchor__symbol">#</span></a></div>
...
| Name | Type | Description |
|------|------|-------------|
| `obj` | [Arbiter](/api-docs/clay-web/nape/dynamics/Arbiter/) | The object to test.  |
...
| Returns |
|---------|
| [Arbiter](/api-docs/clay-web/nape/dynamics/Arbiter/) |
...
| Name | Type | Description |
|------|------|-------------|
| `obj` | [Arbiter](/api-docs/clay-web/nape/dynamics/Arbiter/) | The object to insert.  |
...
| Name | Type | Description |
|------|------|-------------|
| `obj` | [Arbiter](/api-docs/clay-web/nape/dynamics/Arbiter/) | The object to remove  |
...
<div class="signature field-method has-description has-plugin" id="iterator"><div class="plugin-name">nape</div><code><span class="field-name">iterator</span><span class="parenthesis">(</span><span class="parenthesis">)</span><span class="operator">:</span> <a href="/api-docs/clay-web/nape/dynamics/ArbiterIterator/" class="type-link">ArbiterIterator</a></code><a class="header-anchor" href="#iterator"><span aria-hidden="true" class="header-anchor__symbol">#</span></a></div>
...
| Returns |
|---------|
| [ArbiterIterator](/api-docs/clay-web/nape/dynamics/ArbiterIterator/) |
...
| Returns | Description |
|---------|-------------|
| [ArbiterList](/api-docs/clay-web/nape/dynamics/ArbiterList/) | The copied list. |
...
| Name | Type | Description |
|------|------|-------------|
| `xs` | [ArbiterList](/api-docs/clay-web/nape/dynamics/ArbiterList/) | The list to merge.  |
...
| Returns | Description |
|---------|-------------|
| [ArbiterList](/api-docs/clay-web/nape/dynamics/ArbiterList/) | A reference to 'this' list.  |
