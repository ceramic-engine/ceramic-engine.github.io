...
target: Clay (Web)
permalink: api-docs/clay-web/nape/callbacks/ListenerIterator/
---
...
|------|------|-------------|
| `list` | [ListenerList](/api-docs/clay-web/nape/callbacks/ListenerList/) | The Nape list to create iterator for.  |

| Returns | Description |
|---------|-------------|
| [ListenerIterator](/api-docs/clay-web/nape/callbacks/ListenerIterator/) | An iterator over the Nape list. |
...
| Returns | Description |
|---------|-------------|
| [Listener](/api-docs/clay-web/nape/callbacks/Listener/) | The next element in iteration. |
