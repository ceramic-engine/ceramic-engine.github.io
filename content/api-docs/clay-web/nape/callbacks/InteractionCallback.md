...
target: Clay (Web)
permalink: api-docs/clay-web/nape/callbacks/InteractionCallback/
---
...
<div class="type-hierarchy"><a href="/api-docs/clay-web/nape/callbacks/Callback/">Callback</a> → <strong>nape.callbacks.InteractionCallback</strong> (final class)</div>
