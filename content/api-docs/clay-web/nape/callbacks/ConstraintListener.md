...
target: Clay (Web)
permalink: api-docs/clay-web/nape/callbacks/ConstraintListener/
---
...
<div class="type-hierarchy"><a href="/api-docs/clay-web/nape/callbacks/Listener/">Listener</a> → <strong>nape.callbacks.ConstraintListener</strong> (final class)</div>
...
<div class="signature field-var has-description has-plugin" id="options"><div class="plugin-name">nape</div><code><span class="field-name">options</span><span class="operator">:</span> <a href="/api-docs/clay-web/nape/callbacks/OptionType/" class="type-link">OptionType</a></code><a class="header-anchor" href="#options"><span aria-hidden="true" class="header-anchor__symbol">#</span></a></div>
...
| `options` | [Null](/api-docs/clay-web/Null/)<[Dynamic](/api-docs/clay-web/Dynamic/)> | | The OptionType to match Constraints against, passing null will equate to an empty OptionType.  |
| `handler` | Function | | The callback handler for this listener.  |
| `precedence` | [Int](/api-docs/clay-web/Int/) | `0` | The precedence of this listener used to sort the order of callbacks in the case of more than one suitable ConstraintListener existing for the same event on the same Constraint. (default 0)  |
