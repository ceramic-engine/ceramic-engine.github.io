...
target: Clay (Web)
permalink: api-docs/clay-web/nape/callbacks/InteractionListener/
---
...
<div class="type-hierarchy"><a href="/api-docs/clay-web/nape/callbacks/Listener/">Listener</a> → <strong>nape.callbacks.InteractionListener</strong> (final class)</div>
...
|------|------|---------|-------------|
| `event` | [CbEvent](/api-docs/clay-web/nape/callbacks/CbEvent/) | | The event type to listen for.  |
| `interactionType` | [InteractionType](/api-docs/clay-web/nape/callbacks/InteractionType/) | | The interaction type to listen for.  |
| `options1` | [Null](/api-docs/clay-web/Null/)<[Dynamic](/api-docs/clay-web/Dynamic/)> | | The OptionType to match first Interactor against, passing null will equate to an empty OptionType.  |
| `options2` | [Null](/api-docs/clay-web/Null/)<[Dynamic](/api-docs/clay-web/Dynamic/)> | | The OptionType to match second Interactor against, passing null will equate to an empty OptionType.  |
| `handler` | Function | | The callback handler for this listener.  |
| `precedence` | [Int](/api-docs/clay-web/Int/) | `0` | The precedence of this listener used to sort the order of callbacks in the case of more than one suitable BodyListener existing for the same event on the same Body. (default 0)  |
