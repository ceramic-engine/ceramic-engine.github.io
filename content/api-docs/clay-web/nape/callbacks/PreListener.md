...
title: PreListener
target: Clay (Web)
permalink: api-docs/clay-web/nape/callbacks/PreListener/
---
...
<div class="type-hierarchy"><a href="/api-docs/clay-web/nape/callbacks/Listener/">Listener</a> → <strong>nape.callbacks.PreListener</strong> (final class)</div>
...
| Returns |
|---------|
| [Null](/api-docs/clay-web/Null/)<[PreFlag](/api-docs/clay-web/nape/callbacks/PreFlag/)> |
...
| `pure` | [Bool](/api-docs/clay-web/Bool/) | `false` | If true, then the listener will be marked as having a pure handler. (default false)  |
