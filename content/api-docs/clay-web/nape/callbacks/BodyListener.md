...
title: BodyListener
target: Clay (Web)
permalink: api-docs/clay-web/nape/callbacks/BodyListener/
---
...
<div class="type-hierarchy"><a href="/api-docs/clay-web/nape/callbacks/Listener/">Listener</a> → <strong>nape.callbacks.BodyListener</strong> (final class)</div>
...
| `options` | [Null](/api-docs/clay-web/Null/)<[Dynamic](/api-docs/clay-web/Dynamic/)> | | The OptionType to match Bodys against, passing null will equate to an empty OptionType.  |
