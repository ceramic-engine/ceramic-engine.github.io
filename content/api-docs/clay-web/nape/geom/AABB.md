...
title: AABB
target: Clay (Web)
permalink: api-docs/clay-web/nape/geom/AABB/
---
...
| Returns | Description |
|---------|-------------|
| [AABB](/api-docs/clay-web/nape/geom/AABB/) | The copy of this AABB. |
...
|------|------|---------|-------------|
| `x` | [Float](/api-docs/clay-web/Float/) | `0` | The x coordinate of the top-left corner of the AABB. (default 0)  |
| `y` | [Float](/api-docs/clay-web/Float/) | `0` | The y coordinate of the top-left corner of the AABB (default 0)  |
| `width` | [Float](/api-docs/clay-web/Float/) | `0` | The width of the AABB. This value may be negative. (default 0)  |
| `height` | [Float](/api-docs/clay-web/Float/) | `0` | The height of the AABB. This value may be negative. (default 0)  |
