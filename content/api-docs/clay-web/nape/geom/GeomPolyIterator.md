...
target: Clay (Web)
permalink: api-docs/clay-web/nape/geom/GeomPolyIterator/
---
...
|------|------|-------------|
| `list` | [GeomPolyList](/api-docs/clay-web/nape/geom/GeomPolyList/) | The Nape list to create iterator for.  |

| Returns | Description |
|---------|-------------|
| [GeomPolyIterator](/api-docs/clay-web/nape/geom/GeomPolyIterator/) | An iterator over the Nape list. |
...
| Returns | Description |
|---------|-------------|
| [GeomPoly](/api-docs/clay-web/nape/geom/GeomPoly/) | The next element in iteration. |
