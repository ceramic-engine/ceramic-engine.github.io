...
target: Clay (Web)
permalink: api-docs/clay-web/loreline/NChoiceStatement/
---
...
<div class="type-hierarchy"><a href="/api-docs/clay-web/loreline/Node/">Node</a> → <a href="/api-docs/clay-web/loreline/AstNode/">AstNode</a> → <strong>loreline.NChoiceStatement</strong> (Class)</div>
...
| Returns | Description |
|---------|-------------|
| [Dynamic](/api-docs/clay-web/Dynamic/) | Dynamic object containing choice data |
...
| `pos` | [Position](/api-docs/clay-web/loreline/Position/) | | Position in source where this choice appears  |
| `options` | [Array](/api-docs/clay-web/Array/)<[NChoiceOption](/api-docs/clay-web/loreline/NChoiceOption/)> | | Array of available choice options  |
| `leadingComments` | [Array](/api-docs/clay-web/Array/)<[Comment](/api-docs/clay-web/loreline/Comment/)> | *(optional)* | Optional comments before the choice  |
| `trailingComments` | [Array](/api-docs/clay-web/Array/)<[Comment](/api-docs/clay-web/loreline/Comment/)> | *(optional)* | Optional comments after the choice |
