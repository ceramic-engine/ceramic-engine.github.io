...
title: NUnary
target: Clay (Web)
permalink: api-docs/clay-web/loreline/NUnary/
---
...
<div class="type-hierarchy"><a href="/api-docs/clay-web/loreline/Node/">Node</a> → <a href="/api-docs/clay-web/loreline/AstNode/">AstNode</a> → <a href="/api-docs/clay-web/loreline/NExpr/">NExpr</a> → <strong>loreline.NUnary</strong> (Class)</div>
...
<div class="signature field-var has-description" id="operand"><code><span class="field-name">operand</span><span class="operator">:</span> <a href="/api-docs/clay-web/loreline/NExpr/" class="type-link">NExpr</a></code><a class="header-anchor" href="#operand"><span aria-hidden="true" class="header-anchor__symbol">#</span></a></div>
...
| `operand` | [NExpr](/api-docs/clay-web/loreline/NExpr/) | | Operand expression  |
