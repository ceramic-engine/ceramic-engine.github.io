...
title: RuntimeError
target: Clay (Web)
permalink: api-docs/clay-web/loreline/RuntimeError/
---
...
<div class="type-hierarchy"><a href="/api-docs/clay-web/loreline/Error/">Error</a> → <strong>loreline.RuntimeError</strong> (Class)</div>
...
| `pos` | [Position](/api-docs/clay-web/loreline/Position/) | *(optional)* |
