...
title: NBlock
target: Clay (Web)
permalink: api-docs/clay-web/loreline/NBlock/
---
...
<div class="type-hierarchy"><a href="/api-docs/clay-web/loreline/Node/">Node</a> → <a href="/api-docs/clay-web/loreline/AstNode/">AstNode</a> → <strong>loreline.NBlock</strong> (Class)</div>
...
| `body` | [Array](/api-docs/clay-web/Array/)<[AstNode](/api-docs/clay-web/loreline/AstNode/)> | | Array of nodes comprising the block's content  |
