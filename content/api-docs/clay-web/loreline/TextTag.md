...
title: TextTag
target: Clay (Web)
permalink: api-docs/clay-web/loreline/TextTag/
---
...
<div class="signature field-var has-description" id="closing"><code><span class="field-name">closing</span><span class="operator">:</span> <a href="/api-docs/clay-web/Bool/" class="type-link">Bool</a></code><a class="header-anchor" href="#closing"><span aria-hidden="true" class="header-anchor__symbol">#</span></a></div>
...
| `value` | [String](/api-docs/clay-web/String/) | * The value or name of the tag. |
| `offset` | [Int](/api-docs/clay-web/Int/) | * The offset in the text where this tag appears. |
