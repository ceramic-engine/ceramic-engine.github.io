...
title: NStateDecl
target: Clay (Web)
permalink: api-docs/clay-web/loreline/NStateDecl/
---
...
<div class="type-hierarchy"><a href="/api-docs/clay-web/loreline/Node/">Node</a> → <a href="/api-docs/clay-web/loreline/AstNode/">AstNode</a> → <strong>loreline.NStateDecl</strong> (Class)</div>
...
<div class="signature field-var has-description" id="temporary"><code><span class="field-name">temporary</span><span class="operator">:</span> <a href="/api-docs/clay-web/Bool/" class="type-link">Bool</a></code><a class="header-anchor" href="#temporary"><span aria-hidden="true" class="header-anchor__symbol">#</span></a></div>
...
| Returns | Description |
|---------|-------------|
| [Dynamic](/api-docs/clay-web/Dynamic/) | Dynamic object containing state data |
...
| `pos` | [Position](/api-docs/clay-web/loreline/Position/) | | Position in source where this state appears  |
| `temporary` | [Bool](/api-docs/clay-web/Bool/) | | Whether this is a temporary state  |
| `fields` | [Array](/api-docs/clay-web/Array/)<[NObjectField](/api-docs/clay-web/loreline/NObjectField/)> | | Array of property definitions  |
| `leadingComments` | [Array](/api-docs/clay-web/Array/)<[Comment](/api-docs/clay-web/loreline/Comment/)> | *(optional)* | Optional comments before the state  |
| `trailingComments` | [Array](/api-docs/clay-web/Array/)<[Comment](/api-docs/clay-web/loreline/Comment/)> | *(optional)* | Optional comments after the state |
