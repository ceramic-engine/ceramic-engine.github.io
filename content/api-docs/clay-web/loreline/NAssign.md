...
title: NAssign
target: Clay (Web)
permalink: api-docs/clay-web/loreline/NAssign/
---
...
<div class="type-hierarchy"><a href="/api-docs/clay-web/loreline/Node/">Node</a> → <a href="/api-docs/clay-web/loreline/AstNode/">AstNode</a> → <a href="/api-docs/clay-web/loreline/NExpr/">NExpr</a> → <strong>loreline.NAssign</strong> (Class)</div>
...
<div class="signature field-var has-description" id="value"><code><span class="field-name">value</span><span class="operator">:</span> <a href="/api-docs/clay-web/loreline/NExpr/" class="type-link">NExpr</a></code><a class="header-anchor" href="#value"><span aria-hidden="true" class="header-anchor__symbol">#</span></a></div>
...
| Returns | Description |
|---------|-------------|
| [Dynamic](/api-docs/clay-web/Dynamic/) | Dynamic object containing assignment data |
...
| `pos` | [Position](/api-docs/clay-web/loreline/Position/) | | Position in source where this assignment appears  |
| `target` | [NExpr](/api-docs/clay-web/loreline/NExpr/) | | Target expression being assigned to  |
| `op` | Anonymous | | Assignment operator type  |
| `value` | [NExpr](/api-docs/clay-web/loreline/NExpr/) | | Value being assigned  |
| `leadingComments` | [Array](/api-docs/clay-web/Array/)<[Comment](/api-docs/clay-web/loreline/Comment/)> | *(optional)* | Optional comments before the assignment  |
| `trailingComments` | [Array](/api-docs/clay-web/Array/)<[Comment](/api-docs/clay-web/loreline/Comment/)> | *(optional)* | Optional comments after the assignment |
