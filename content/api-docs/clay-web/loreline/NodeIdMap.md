...
title: NodeIdMap
target: Clay (Web)
permalink: api-docs/clay-web/loreline/NodeIdMap/
---
...
| Name | Type |
|------|------|
| `key` | [NodeId](/api-docs/clay-web/loreline/NodeId/) |

| Returns |
|---------|
| [Null](/api-docs/clay-web/Null/)<loreline.NodeIdMap.V> |
