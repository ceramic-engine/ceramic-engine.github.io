...
title: NExpr
target: Clay (Web)
permalink: api-docs/clay-web/loreline/NExpr/
---
...
<div class="type-hierarchy"><a href="/api-docs/clay-web/loreline/Node/">Node</a> → <a href="/api-docs/clay-web/loreline/AstNode/">AstNode</a> → <strong>loreline.NExpr</strong> (Class) → <a href="/api-docs/clay-web/loreline/NAccess/">NAccess</a>, <a href="/api-docs/clay-web/loreline/NArrayAccess/">NArrayAccess</a>, <a href="/api-docs/clay-web/loreline/NAssign/">NAssign</a>, <a href="/api-docs/clay-web/loreline/NBinary/">NBinary</a>, <a href="/api-docs/clay-web/loreline/NCall/">NCall</a>, <a href="/api-docs/clay-web/loreline/NFunctionDecl/">NFunctionDecl</a>, <a href="/api-docs/clay-web/loreline/NLiteral/">NLiteral</a>, <a href="/api-docs/clay-web/loreline/NStringLiteral/">NStringLiteral</a>, <a href="/api-docs/clay-web/loreline/NStringPart/">NStringPart</a>, <a href="/api-docs/clay-web/loreline/NUnary/">NUnary</a></div>
...
| Returns | Description |
|---------|-------------|
| [Dynamic](/api-docs/clay-web/Dynamic/) | Dynamic object containing expression data |
...
| `leadingComments` | [Array](/api-docs/clay-web/Array/)<[Comment](/api-docs/clay-web/loreline/Comment/)> | *(optional)* |
| `trailingComments` | [Array](/api-docs/clay-web/Array/)<[Comment](/api-docs/clay-web/loreline/Comment/)> | *(optional)* |
