...
title: NCall
target: Clay (Web)
permalink: api-docs/clay-web/loreline/NCall/
---
...
<div class="type-hierarchy"><a href="/api-docs/clay-web/loreline/Node/">Node</a> → <a href="/api-docs/clay-web/loreline/AstNode/">AstNode</a> → <a href="/api-docs/clay-web/loreline/NExpr/">NExpr</a> → <strong>loreline.NCall</strong> (Class)</div>
...
| Returns | Description |
|---------|-------------|
| [Dynamic](/api-docs/clay-web/Dynamic/) | Dynamic object containing call data |
...
| `pos` | [Position](/api-docs/clay-web/loreline/Position/) | | Position in source where this call appears  |
| `target` | [NExpr](/api-docs/clay-web/loreline/NExpr/) | | Expression being called  |
| `args` | [Array](/api-docs/clay-web/Array/)<[NExpr](/api-docs/clay-web/loreline/NExpr/)> | | Array of argument expressions  |
| `leadingComments` | [Array](/api-docs/clay-web/Array/)<[Comment](/api-docs/clay-web/loreline/Comment/)> | *(optional)* | Optional comments before the call  |
| `trailingComments` | [Array](/api-docs/clay-web/Array/)<[Comment](/api-docs/clay-web/loreline/Comment/)> | *(optional)* | Optional comments after the call |
