...
title: NBeatDecl
target: Clay (Web)
permalink: api-docs/clay-web/loreline/NBeatDecl/
---
...
<div class="type-hierarchy"><a href="/api-docs/clay-web/loreline/Node/">Node</a> → <a href="/api-docs/clay-web/loreline/AstNode/">AstNode</a> → <strong>loreline.NBeatDecl</strong> (Class)</div>
...
| Returns | Description |
|---------|-------------|
| [Dynamic](/api-docs/clay-web/Dynamic/) | Dynamic object containing beat data |
...
| `pos` | [Position](/api-docs/clay-web/loreline/Position/) | | Position in source where this beat appears  |
| `name` | [String](/api-docs/clay-web/String/) | | Name of the beat  |
| `body` | [Array](/api-docs/clay-web/Array/)<[AstNode](/api-docs/clay-web/loreline/AstNode/)> | | Array of nodes comprising the beat's content  |
| `leadingComments` | [Array](/api-docs/clay-web/Array/)<[Comment](/api-docs/clay-web/loreline/Comment/)> | *(optional)* | Optional comments before the beat  |
| `trailingComments` | [Array](/api-docs/clay-web/Array/)<[Comment](/api-docs/clay-web/loreline/Comment/)> | *(optional)* | Optional comments after the beat |
