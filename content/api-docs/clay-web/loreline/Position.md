...
title: Position
target: Clay (Web)
permalink: api-docs/clay-web/loreline/Position/
---
...
|------|------|---------|-------------|
| `content` | [String](/api-docs/clay-web/String/) | | The string content to analyze  |
| `offset` | [Int](/api-docs/clay-web/Int/) | | The character offset from the start of the content  |
| `length` | [Int](/api-docs/clay-web/Int/) | `0` | The length of the position (or 0 if not provided)  |

| Returns | Description |
|---------|-------------|
| [Position](/api-docs/clay-web/loreline/Position/) | A new Position object with proper line and column information |
...
| Returns | Description |
|---------|-------------|
| [String](/api-docs/clay-web/String/) | String in format "(line X col Y)" |
...
| Returns | Description |
|---------|-------------|
| [Dynamic](/api-docs/clay-web/Dynamic/) | Dynamic object containing position data |
...
| Name | Type | Default | Description |
|------|------|---------|-------------|
| `content` | [String](/api-docs/clay-web/String/) | | String content to analyze for line/column tracking  |
| `additionalOffset` | [Int](/api-docs/clay-web/Int/) | | Number of characters to offset from current position (can be negative)  |
| `newLength` | [Int](/api-docs/clay-web/Int/) | `0` | Optional new length for the offset position (default: 0)  |
| `contentStart` | [Int](/api-docs/clay-web/Int/) | `0` |  |

| Returns | Description |
|---------|-------------|
| [Position](/api-docs/clay-web/loreline/Position/) | New Position object at the offset location |
...
|------|------|-------------|
| `endPos` | [Position](/api-docs/clay-web/loreline/Position/) | Position marking the end of the span  |

| Returns | Description |
|---------|-------------|
| [Position](/api-docs/clay-web/loreline/Position/) | New Position object representing the extended span |
...
| Name | Type | Default | Description |
|------|------|---------|-------------|
| `line` | [Int](/api-docs/clay-web/Int/) | | Line number in the source (1-based)  |
| `column` | [Int](/api-docs/clay-web/Int/) | | Column number in the source (1-based)  |
| `offset` | [Int](/api-docs/clay-web/Int/) | | Character offset from start of source  |
| `length` | [Int](/api-docs/clay-web/Int/) | `0` | Optional length of the source span (default: 0) |
