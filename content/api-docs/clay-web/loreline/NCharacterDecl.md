...
target: Clay (Web)
permalink: api-docs/clay-web/loreline/NCharacterDecl/
---
...
<div class="type-hierarchy"><a href="/api-docs/clay-web/loreline/Node/">Node</a> → <a href="/api-docs/clay-web/loreline/AstNode/">AstNode</a> → <strong>loreline.NCharacterDecl</strong> (Class)</div>
...
<div class="signature field-var has-description" id="namePos"><code><span class="field-name">namePos</span><span class="operator">:</span> <a href="/api-docs/clay-web/loreline/Position/" class="type-link">Position</a></code><a class="header-anchor" href="#namePos"><span aria-hidden="true" class="header-anchor__symbol">#</span></a></div>
...
<div class="signature field-method no-description" id="get"><code><span class="field-name">get</span><span class="parenthesis">(</span><span class="arg-name">name</span><span class="operator">:</span> <a href="/api-docs/clay-web/String/" class="type-link">String</a><span class="parenthesis">)</span><span class="operator">:</span> <a href="/api-docs/clay-web/loreline/NExpr/" class="type-link">NExpr</a></code><a class="header-anchor" href="#get"><span aria-hidden="true" class="header-anchor__symbol">#</span></a></div>
...
| Returns |
|---------|
| [NExpr](/api-docs/clay-web/loreline/NExpr/) |
...
| Returns | Description |
|---------|-------------|
| [Dynamic](/api-docs/clay-web/Dynamic/) | Dynamic object containing character data |
...
| `pos` | [Position](/api-docs/clay-web/loreline/Position/) | | Position in source where this character appears  |
| `name` | [String](/api-docs/clay-web/String/) | | Name of the character  |
| `namePos` | [Position](/api-docs/clay-web/loreline/Position/) | |  |
| `fields` | [Array](/api-docs/clay-web/Array/)<[NObjectField](/api-docs/clay-web/loreline/NObjectField/)> | | Array of property definitions  |
| `leadingComments` | [Array](/api-docs/clay-web/Array/)<[Comment](/api-docs/clay-web/loreline/Comment/)> | *(optional)* | Optional comments before the character  |
| `trailingComments` | [Array](/api-docs/clay-web/Array/)<[Comment](/api-docs/clay-web/loreline/Comment/)> | *(optional)* | Optional comments after the character |
