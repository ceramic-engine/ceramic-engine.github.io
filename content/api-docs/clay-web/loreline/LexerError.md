...
title: LexerError
target: Clay (Web)
permalink: api-docs/clay-web/loreline/LexerError/
---
...
<div class="type-hierarchy"><a href="/api-docs/clay-web/loreline/Error/">Error</a> → <strong>loreline.LexerError</strong> (Class)</div>
