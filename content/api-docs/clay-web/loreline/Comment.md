...
title: Comment
target: Clay (Web)
permalink: api-docs/clay-web/loreline/Comment/
---
...
<div class="type-hierarchy"><a href="/api-docs/clay-web/loreline/Node/">Node</a> → <strong>loreline.Comment</strong> (Class)</div>
...
| Returns | Description |
|---------|-------------|
| [Dynamic](/api-docs/clay-web/Dynamic/) | Dynamic object containing comment data |
...
| `pos` | [Position](/api-docs/clay-web/loreline/Position/) | Position in source where this comment appears  |
| `content` | [String](/api-docs/clay-web/String/) | The text content of the comment  |
| `multiline` | [Bool](/api-docs/clay-web/Bool/) | Whether this is a multiline comment |
