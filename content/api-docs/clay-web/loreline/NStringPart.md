...
title: NStringPart
target: Clay (Web)
permalink: api-docs/clay-web/loreline/NStringPart/
---
...
<div class="type-hierarchy"><a href="/api-docs/clay-web/loreline/Node/">Node</a> → <a href="/api-docs/clay-web/loreline/AstNode/">AstNode</a> → <a href="/api-docs/clay-web/loreline/NExpr/">NExpr</a> → <strong>loreline.NStringPart</strong> (Class)</div>
...
| Returns | Description |
|---------|-------------|
| [Dynamic](/api-docs/clay-web/Dynamic/) | Dynamic object containing string part data |
...
| `pos` | [Position](/api-docs/clay-web/loreline/Position/) | | Position in source where this string part appears  |
| `partType` | Anonymous | |  |
