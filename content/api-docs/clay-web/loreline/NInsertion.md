...
title: NInsertion
target: Clay (Web)
permalink: api-docs/clay-web/loreline/NInsertion/
---
...
<div class="type-hierarchy"><a href="/api-docs/clay-web/loreline/Node/">Node</a> → <a href="/api-docs/clay-web/loreline/AstNode/">AstNode</a> → <strong>loreline.NInsertion</strong> (Class)</div>
...
| Returns | Description |
|---------|-------------|
| [Dynamic](/api-docs/clay-web/Dynamic/) | Dynamic object containing insertion data |
...
| `pos` | [Position](/api-docs/clay-web/loreline/Position/) | | Position in source where this insertion appears  |
| `target` | [String](/api-docs/clay-web/String/) | | Name of the target beat  |
| `targetPos` | [Position](/api-docs/clay-web/loreline/Position/) | | Position of the target part of the insertion  |
| `leadingComments` | [Array](/api-docs/clay-web/Array/)<[Comment](/api-docs/clay-web/loreline/Comment/)> | *(optional)* | Optional comments before the insertion  |
| `trailingComments` | [Array](/api-docs/clay-web/Array/)<[Comment](/api-docs/clay-web/loreline/Comment/)> | *(optional)* | Optional comments after the insertion |
