...
title: Token
target: Clay (Web)
permalink: api-docs/clay-web/loreline/Token/
---
...
| Returns | Description |
|---------|-------------|
| [String](/api-docs/clay-web/String/) | Formatted token information with position |
...
| `pos` | [Position](/api-docs/clay-web/loreline/Position/) | The token's position |
