...
target: Clay (Web)
permalink: api-docs/clay-web/loreline/NStringLiteral/
---
...
<div class="type-hierarchy"><a href="/api-docs/clay-web/loreline/Node/">Node</a> → <a href="/api-docs/clay-web/loreline/AstNode/">AstNode</a> → <a href="/api-docs/clay-web/loreline/NExpr/">NExpr</a> → <strong>loreline.NStringLiteral</strong> (Class)</div>

Represents a string literal in the AST, supporting interpolation and tags.

## Instance Members

<div class="signature field-var has-description" id="parts"><code><span class="field-name">parts</span><span class="operator">:</span> <a href="/api-docs/clay-web/Array/" class="type-link">Array</a><span class="operator">&lt;</span><a href="/api-docs/clay-web/loreline/NStringPart/" class="type-link">NStringPart</a><span class="operator">&gt;</span></code><a class="header-anchor" href="#parts"><span aria-hidden="true" class="header-anchor__symbol">#</span></a></div>

Array of parts that make up this string literal.

<hr class="field-separator" />

<div class="signature field-var has-description" id="quotes"><code><span class="field-name">quotes</span><span class="operator">:</span> <a href="/api-docs/clay-web/loreline/Quotes/" class="type-link">Quotes</a></code><a class="header-anchor" href="#quotes"><span aria-hidden="true" class="header-anchor__symbol">#</span></a></div>
...
| Returns | Description |
|---------|-------------|
| [Dynamic](/api-docs/clay-web/Dynamic/) | Dynamic object containing string data and its parts |
...
| `pos` | [Position](/api-docs/clay-web/loreline/Position/) | | Position in source where this string appears  |
| `quotes` | [Quotes](/api-docs/clay-web/loreline/Quotes/) | |  |
| `parts` | [Array](/api-docs/clay-web/Array/)<[NStringPart](/api-docs/clay-web/loreline/NStringPart/)> | | Array of string parts (raw text, interpolations, and tags)  |
| `leadingComments` | [Array](/api-docs/clay-web/Array/)<[Comment](/api-docs/clay-web/loreline/Comment/)> | *(optional)* | Optional comments before the string  |
| `trailingComments` | [Array](/api-docs/clay-web/Array/)<[Comment](/api-docs/clay-web/loreline/Comment/)> | *(optional)* | Optional comments after the string |
