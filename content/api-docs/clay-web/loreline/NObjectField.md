...
title: NObjectField
target: Clay (Web)
permalink: api-docs/clay-web/loreline/NObjectField/
---
...
<div class="type-hierarchy"><a href="/api-docs/clay-web/loreline/Node/">Node</a> → <a href="/api-docs/clay-web/loreline/AstNode/">AstNode</a> → <strong>loreline.NObjectField</strong> (Class)</div>
...
| Returns | Description |
|---------|-------------|
| [Dynamic](/api-docs/clay-web/Dynamic/) | Dynamic object containing field data |
...
| `pos` | [Position](/api-docs/clay-web/loreline/Position/) | | Position in source where this field appears  |
| `name` | [String](/api-docs/clay-web/String/) | | Name of the field  |
| `value` | [NExpr](/api-docs/clay-web/loreline/NExpr/) | | Value expression for the field  |
| `leadingComments` | [Array](/api-docs/clay-web/Array/)<[Comment](/api-docs/clay-web/loreline/Comment/)> | *(optional)* | Optional comments before the field  |
| `trailingComments` | [Array](/api-docs/clay-web/Array/)<[Comment](/api-docs/clay-web/loreline/Comment/)> | *(optional)* | Optional comments after the field |
