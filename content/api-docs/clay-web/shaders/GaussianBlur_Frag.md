...
target: Clay (Web)
permalink: api-docs/clay-web/shaders/GaussianBlur_Frag/
---
...
<div class="type-hierarchy"><a href="/api-docs/clay-web/shade/Shade/">shade.Shade</a> → <a href="/api-docs/clay-web/shade/Frag/">shade.Frag</a> → <strong>shaders.GaussianBlur_Frag</strong> (Class)</div>
...
<div class="signature field-var no-description has-plugin" id="DIRECTIONS"><div class="plugin-name">shade</div><code><span class="field-name">DIRECTIONS</span><span class="operator">:</span> <a href="/api-docs/clay-web/Float/" class="type-link">Float</a></code><a class="header-anchor" href="#DIRECTIONS"><span aria-hidden="true" class="header-anchor__symbol">#</span></a></div>

<hr class="field-separator" />

<div class="signature field-var no-description has-plugin" id="QUALITY"><div class="plugin-name">shade</div><code><span class="field-name">QUALITY</span><span class="operator">:</span> <a href="/api-docs/clay-web/Float/" class="type-link">Float</a></code><a class="header-anchor" href="#QUALITY"><span aria-hidden="true" class="header-anchor__symbol">#</span></a></div>
...
<div class="signature field-var no-description has-plugin" id="blurSize"><div class="plugin-name">shade</div><code><span class="field-name">blurSize</span><span class="operator">:</span> <a href="/api-docs/clay-web/shade/Vec2/" class="type-link">shade.Vec2</a></code><a class="header-anchor" href="#blurSize"><span aria-hidden="true" class="header-anchor__symbol">#</span></a></div>
