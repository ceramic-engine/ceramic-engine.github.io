...
title: Textured_Frag
target: Clay (Web)
permalink: api-docs/clay-web/shaders/Textured_Frag/
---
...
<div class="type-hierarchy"><a href="/api-docs/clay-web/shade/Shade/">shade.Shade</a> → <a href="/api-docs/clay-web/shade/Frag/">shade.Frag</a> → <strong>shaders.Textured_Frag</strong> (Class)</div>
