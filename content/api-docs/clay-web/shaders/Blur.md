...
title: Blur
target: Clay (Web)
permalink: api-docs/clay-web/shaders/Blur/
---

# Blur

<div class="view-source"><a href="https://github.com/ceramic-engine/ceramic/blob/master/plugins/shade/runtime/src/shaders/Blur.hx">View source</a></div>

<div class="type-hierarchy"><a href="/api-docs/clay-web/ceramic/Entity/">ceramic.Entity</a> → <a href="/api-docs/clay-web/ceramic/Shader/">ceramic.Shader</a> → <a href="/api-docs/clay-web/shade/Shader__shaders_Blur_Vert__shaders_Blur_Frag/">shade.Shader__shaders_Blur_Vert__shaders_Blur_Frag</a> → <strong>shaders.Blur</strong> (Class)</div>
