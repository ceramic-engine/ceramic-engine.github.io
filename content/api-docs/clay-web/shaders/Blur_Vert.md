...
title: Blur_Vert
target: Clay (Web)
permalink: api-docs/clay-web/shaders/Blur_Vert/
---
...
<div class="type-hierarchy"><a href="/api-docs/clay-web/shade/Shade/">shade.Shade</a> → <a href="/api-docs/clay-web/shade/Vert/">shade.Vert</a> → <strong>shaders.Blur_Vert</strong> (Class)</div>
