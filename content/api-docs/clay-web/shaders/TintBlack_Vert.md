...
target: Clay (Web)
permalink: api-docs/clay-web/shaders/TintBlack_Vert/
---
...
<div class="type-hierarchy"><a href="/api-docs/clay-web/shade/Shade/">shade.Shade</a> → <a href="/api-docs/clay-web/shade/Vert/">shade.Vert</a> → <strong>shaders.TintBlack_Vert</strong> (Class)</div>
...
<div class="signature field-var no-description has-plugin" id="vertexDarkColor"><div class="plugin-name">shade</div><code><span class="field-name">vertexDarkColor</span><span class="operator">:</span> <a href="/api-docs/clay-web/shade/Vec4/" class="type-link">shade.Vec4</a></code><a class="header-anchor" href="#vertexDarkColor"><span aria-hidden="true" class="header-anchor__symbol">#</span></a></div>
...
<div class="signature field-var no-description has-plugin" id="darkColor"><div class="plugin-name">shade</div><code><span class="field-name">darkColor</span><span class="operator">:</span> <a href="/api-docs/clay-web/shade/Vec4/" class="type-link">shade.Vec4</a></code><a class="header-anchor" href="#darkColor"><span aria-hidden="true" class="header-anchor__symbol">#</span></a></div>
