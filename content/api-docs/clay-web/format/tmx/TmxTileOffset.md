...
title: TmxTileOffset
target: Clay (Web)
permalink: api-docs/clay-web/format/tmx/TmxTileOffset/
---
...
<div class="type-hierarchy"><strong>format.tmx.TmxTileOffset</strong> (Class)</div>
...
|------|------|-------------|
| `x` | [Int](/api-docs/clay-web/Int/) | Horizontal offset in pixels |
| `y` | [Int](/api-docs/clay-web/Int/) | Vertical offset in pixels (positive is down) |
