...
title: Reader
target: Clay (Web)
permalink: api-docs/clay-web/format/tmx/Reader/
---
...
| Returns |
|---------|
| [TmxObjectTemplate](/api-docs/clay-web/format/tmx/TmxObjectTemplate/) |
...
| Returns |
|---------|
| [TmxObjectTypeTemplate](/api-docs/clay-web/format/tmx/TmxObjectTypeTemplate/) |
...
| Name | Type | Default |
|------|------|---------|
| `xml` | [Xml](/api-docs/clay-web/Xml/) | |
| `localPath` | [String](/api-docs/clay-web/String/) | *(optional)* |

| Returns |
|---------|
| [TmxMap](/api-docs/clay-web/format/tmx/TmxMap/) |
...
|------|------|---------|-------------|
| `xml` | [Xml](/api-docs/clay-web/Xml/) | |  |
| `root` | [TmxTileset](/api-docs/clay-web/format/tmx/TmxTileset/) | `null` | Root Tileset into which read TSX data.  |

| Returns | Description |
|---------|-------------|
| [TmxTileset](/api-docs/clay-web/format/tmx/TmxTileset/) | Resulting TmxTileset. If `root` is null - returns new TmxTileset object, otherwise `root` is returned. |

<hr class="field-separator" />

<div class="signature field-method has-description" id="readObjectTypes"><code><span class="field-name">readObjectTypes</span><span class="parenthesis">(</span><span class="arg-name">xml</span><span class="operator">:</span> <a href="/api-docs/clay-web/Xml/" class="type-link">Xml</a><span class="operator">,</span> <span class="operator">?</span><span class="arg-name">root</span><span class="operator">:</span> <a href="/api-docs/clay-web/format/tmx/TmxMap/" class="type-link">TmxMap</a> <span class="operator">=</span> <span class="default-value">null</span><span class="parenthesis">)</span><span class="operator">:</span> <a href="/api-docs/clay-web/Map/" class="type-link">Map</a></code><a class="header-anchor" href="#readObjectTypes"><span aria-hidden="true" class="header-anchor__symbol">#</span></a></div>
...
|------|------|---------|-------------|
| `xml` | [Xml](/api-docs/clay-web/Xml/) | |  |
| `root` | [TmxMap](/api-docs/clay-web/format/tmx/TmxMap/) | `null` | Optional root TMX file to propagate those types into. It uses `Tools.propagateObjectTypes` function with default propagation rules.  |

| Returns | Description |
|---------|-------------|
| [Map](/api-docs/clay-web/Map/) | Map with object type templates. Always pass null, if using during resolveTypeTemplate |
...
<div class="signature field-var no-description" id="customUncompressors"><code><span class="field-name">customUncompressors</span><span class="operator">:</span> <a href="/api-docs/clay-web/Map/" class="type-link">Map</a></code><a class="header-anchor" href="#customUncompressors"><span aria-hidden="true" class="header-anchor__symbol">#</span></a></div>

<hr class="field-separator" />

<div class="signature field-var no-description" id="customEncoders"><code><span class="field-name">customEncoders</span><span class="operator">:</span> <a href="/api-docs/clay-web/Map/" class="type-link">Map</a></code><a class="header-anchor" href="#customEncoders"><span aria-hidden="true" class="header-anchor__symbol">#</span></a></div>
...
<div class="signature field-method no-description" id="resolveGroup"><code><span class="field-name">resolveGroup</span><span class="parenthesis">(</span><span class="arg-name">input</span><span class="operator">:</span> <a href="/api-docs/clay-web/haxe/xml/_Access/Fast/" class="type-link">haxe.xml._Access.Fast</a><span class="parenthesis">)</span><span class="operator">:</span> <a href="/api-docs/clay-web/format/tmx/TmxGroup/" class="type-link">TmxGroup</a></code><a class="header-anchor" href="#resolveGroup"><span aria-hidden="true" class="header-anchor__symbol">#</span></a></div>


| Name | Type |
|------|------|
| `input` | [haxe.xml._Access.Fast](/api-docs/clay-web/haxe/xml/_Access/Fast/) |

| Returns |
|---------|
| [TmxGroup](/api-docs/clay-web/format/tmx/TmxGroup/) |
...
| Name | Type |
|------|------|
| `input` | [String](/api-docs/clay-web/String/) |
...
<div class="signature field-method no-description" id="resolveColor"><code><span class="field-name">resolveColor</span><span class="parenthesis">(</span><span class="arg-name">input</span><span class="operator">:</span> <a href="/api-docs/clay-web/String/" class="type-link">String</a><span class="parenthesis">)</span><span class="operator">:</span> <a href="/api-docs/clay-web/Int/" class="type-link">Int</a></code><a class="header-anchor" href="#resolveColor"><span aria-hidden="true" class="header-anchor__symbol">#</span></a></div>
...
| Returns |
|---------|
| [TmxWangSet](/api-docs/clay-web/format/tmx/TmxWangSet/) |
...
| Returns |
|---------|
| [TmxWangSetColor](/api-docs/clay-web/format/tmx/TmxWangSetColor/) |
...
| Returns |
|---------|
| [TmxImage](/api-docs/clay-web/format/tmx/TmxImage/) |
...
| Returns |
|---------|
| [TmxTileLayer](/api-docs/clay-web/format/tmx/TmxTileLayer/) |
...
| Returns |
|---------|
| [TmxObjectGroup](/api-docs/clay-web/format/tmx/TmxObjectGroup/) |
...
| Name | Type | Default |
|------|------|---------|
| `obj` | [haxe.xml._Access.Fast](/api-docs/clay-web/haxe/xml/_Access/Fast/) | |
| `applyObjectTypeTemplate` | [Bool](/api-docs/clay-web/Bool/) | `true` |

| Returns |
|---------|
| [TmxObject](/api-docs/clay-web/format/tmx/TmxObject/) |
...
| Returns |
|---------|
| [Array](/api-docs/clay-web/Array/)<[TmxPoint](/api-docs/clay-web/format/tmx/TmxPoint/)> |
...
| Returns |
|---------|
| [TmxText](/api-docs/clay-web/format/tmx/TmxText/) |
...
| Returns |
|---------|
| [TmxImageLayer](/api-docs/clay-web/format/tmx/TmxImageLayer/) |
...
| Returns |
|---------|
| [TmxProperties](/api-docs/clay-web/format/tmx/TmxProperties/) |
