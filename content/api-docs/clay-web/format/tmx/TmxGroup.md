...
title: TmxGroup
target: Clay (Web)
permalink: api-docs/clay-web/format/tmx/TmxGroup/
---
...
<div class="signature field-var has-description" id="opacity"><code><span class="field-name">opacity</span><span class="operator">:</span> <a href="/api-docs/clay-web/Float/" class="type-link">Float</a></code><a class="header-anchor" href="#opacity"><span aria-hidden="true" class="header-anchor__symbol">#</span></a></div>
...
|------|------|-------------|
| `id` | [Int](/api-docs/clay-web/Int/) | Unique ID of the layer. Each layer that added to a map gets a unique id. Even if a layer is deleted, no layer ever gets the same ID. Can not be changed in Tiled. (since Tiled 1.2) |
| `name` | [String](/api-docs/clay-web/String/) | The name of the group layer. |
| `offsetX` | [Int](/api-docs/clay-web/Int/) | Rendering offset of the group layer in pixels. Defaults to 0. |
| `offsetY` | [Int](/api-docs/clay-web/Int/) | Rendering offset of the group layer in pixels. Defaults to 0. |
| `opacity` | [Float](/api-docs/clay-web/Float/) | The opacity of the layer as a value from 0 to 1. Defaults to 1. |
| `visible` | [Bool](/api-docs/clay-web/Bool/) | Whether the layer is shown (1) or hidden (0). Defaults to 1. |
| `properties` | [TmxProperties](/api-docs/clay-web/format/tmx/TmxProperties/) |  |
| `layers` | [Array](/api-docs/clay-web/Array/)<Anonymous> |  |
