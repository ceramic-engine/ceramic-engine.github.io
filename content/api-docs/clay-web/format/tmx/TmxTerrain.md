...
title: TmxTerrain
target: Clay (Web)
permalink: api-docs/clay-web/format/tmx/TmxTerrain/
---
...
|------|------|---------|-------------|
| `name` | [String](/api-docs/clay-web/String/) | | The name of the terrain type. |
| `tile` | [Int](/api-docs/clay-web/Int/) | | The local tile-id of the tile that represents the terrain visually. |
