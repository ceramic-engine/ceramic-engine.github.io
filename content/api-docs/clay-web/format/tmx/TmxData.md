...
title: TmxData
target: Clay (Web)
permalink: api-docs/clay-web/format/tmx/TmxData/
---
...
<div class="signature field-var has-description" id="data"><code><span class="field-name">data</span><span class="operator">:</span> <a href="/api-docs/clay-web/haxe/io/Bytes/" class="type-link">haxe.io.Bytes</a></code><a class="header-anchor" href="#data"><span aria-hidden="true" class="header-anchor__symbol">#</span></a></div>
...
| `tiles` | [Array](/api-docs/clay-web/Array/)<[TmxTile](/api-docs/clay-web/format/tmx/TmxTile/)> | *(optional)* | Decoded tile data |
| `chunks` | [Array](/api-docs/clay-web/Array/)<[TmxChunk](/api-docs/clay-web/format/tmx/TmxChunk/)> | *(optional)* | Infinite maps chunk data |
| `data` | [haxe.io.Bytes](/api-docs/clay-web/haxe/io/Bytes/) | *(optional)* | Raw data. Exists for non-tile-layer data objects. |
