...
title: TmxBaseLayer
target: Clay (Web)
permalink: api-docs/clay-web/format/tmx/TmxBaseLayer/
---
...
<div class="type-hierarchy"><strong>format.tmx.TmxBaseLayer</strong> (Class) → <a href="/api-docs/clay-web/format/tmx/TmxImageLayer/">TmxImageLayer</a>, <a href="/api-docs/clay-web/format/tmx/TmxObjectGroup/">TmxObjectGroup</a>, <a href="/api-docs/clay-web/format/tmx/TmxTileLayer/">TmxTileLayer</a></div>
