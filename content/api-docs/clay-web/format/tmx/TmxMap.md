...
title: TmxMap
target: Clay (Web)
permalink: api-docs/clay-web/format/tmx/TmxMap/
---
...
<div class="signature field-var has-description" id="tiledVersion"><code><span class="field-name">tiledVersion</span><span class="operator">:</span> <a href="/api-docs/clay-web/String/" class="type-link">String</a></code><a class="header-anchor" href="#tiledVersion"><span aria-hidden="true" class="header-anchor__symbol">#</span></a></div>
...
<div class="signature field-var has-description" id="tileWidth"><code><span class="field-name">tileWidth</span><span class="operator">:</span> <a href="/api-docs/clay-web/Int/" class="type-link">Int</a></code><a class="header-anchor" href="#tileWidth"><span aria-hidden="true" class="header-anchor__symbol">#</span></a></div>
...
<div class="signature field-var has-description" id="tileHeight"><code><span class="field-name">tileHeight</span><span class="operator">:</span> <a href="/api-docs/clay-web/Int/" class="type-link">Int</a></code><a class="header-anchor" href="#tileHeight"><span aria-hidden="true" class="header-anchor__symbol">#</span></a></div>
...
<div class="signature field-var has-description" id="backgroundColor"><code><span class="field-name">backgroundColor</span><span class="operator">:</span> <a href="/api-docs/clay-web/Int/" class="type-link">Int</a></code><a class="header-anchor" href="#backgroundColor"><span aria-hidden="true" class="header-anchor__symbol">#</span></a></div>
...
<div class="signature field-var has-description" id="hexSideLength"><code><span class="field-name">hexSideLength</span><span class="operator">:</span> <a href="/api-docs/clay-web/Int/" class="type-link">Int</a></code><a class="header-anchor" href="#hexSideLength"><span aria-hidden="true" class="header-anchor__symbol">#</span></a></div>
...
<div class="signature field-var has-description" id="nextObjectId"><code><span class="field-name">nextObjectId</span><span class="operator">:</span> <a href="/api-docs/clay-web/Int/" class="type-link">Int</a></code><a class="header-anchor" href="#nextObjectId"><span aria-hidden="true" class="header-anchor__symbol">#</span></a></div>
...
<div class="signature field-var has-description" id="nextLayerId"><code><span class="field-name">nextLayerId</span><span class="operator">:</span> <a href="/api-docs/clay-web/Int/" class="type-link">Int</a></code><a class="header-anchor" href="#nextLayerId"><span aria-hidden="true" class="header-anchor__symbol">#</span></a></div>
...
<div class="signature field-var has-description" id="infinite"><code><span class="field-name">infinite</span><span class="operator">:</span> <a href="/api-docs/clay-web/Bool/" class="type-link">Bool</a></code><a class="header-anchor" href="#infinite"><span aria-hidden="true" class="header-anchor__symbol">#</span></a></div>
...
|------|------|---------|-------------|
| `version` | [String](/api-docs/clay-web/String/) | | The TMX format version, generally 1.0. |
| `tiledVersion` | [String](/api-docs/clay-web/String/) | | The Tiled version used to save the file (since Tiled 1.0.1). May be a date (for snapshot builds). |
| `orientation` | Anonymous | | Map orientation. |
| `width` | [Int](/api-docs/clay-web/Int/) | | The map width in tiles. |
| `height` | [Int](/api-docs/clay-web/Int/) | | The map height in tiles. |
| `tileWidth` | [Int](/api-docs/clay-web/Int/) | | * The width of a tile. * The tilewidth and tileheight properties determine the general grid size of the map. The individual tiles may have different sizes. Larger tiles will extend at the top and right (anchored to the bottom left).  |
| `tileHeight` | [Int](/api-docs/clay-web/Int/) | | * The height of a tile. * The tilewidth and tileheight properties determine the general grid size of the map. The individual tiles may have different sizes. Larger tiles will extend at the top and right (anchored to the bottom left). |
| `backgroundColor` | [Int](/api-docs/clay-web/Int/) | *(optional)* | The background color of the map. Since 0.9, optional. |
...
| `hexSideLength` | [Int](/api-docs/clay-web/Int/) | *(optional)* | Only for hexagonal maps. Determines the width or height (depending on the staggered axis) of the tile's edge, in pixels. Since 0.11 |
| `nextObjectId` | [Int](/api-docs/clay-web/Int/) | *(optional)* | Stores the next available ID for new objects. This number is stored to prevent reuse of the same ID after objects have been removed. (since 0.11) |
| `nextLayerId` | [Int](/api-docs/clay-web/Int/) | *(optional)* | Stores the next available ID for new layers. This number is stored to prevent reuse of the same ID after layers have been removed. (since 1.2) |
| `properties` | [TmxProperties](/api-docs/clay-web/format/tmx/TmxProperties/) | *(optional)* | Properties of the map |
| `tilesets` | [Array](/api-docs/clay-web/Array/)<[TmxTileset](/api-docs/clay-web/format/tmx/TmxTileset/)> | | Tilesets used in map |
| `layers` | [Array](/api-docs/clay-web/Array/)<Anonymous> | | Array of all layers in map. Tile layers, object groups and image layers. |
| `infinite` | [Bool](/api-docs/clay-web/Bool/) | | Is that map infinite? |
| `localPath` | [Null](/api-docs/clay-web/Null/)<[String](/api-docs/clay-web/String/)> | | Local path of the TmxMap supplied during parsing. |
