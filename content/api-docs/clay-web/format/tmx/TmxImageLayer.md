...
title: TmxImageLayer
target: Clay (Web)
permalink: api-docs/clay-web/format/tmx/TmxImageLayer/
---
...
<div class="type-hierarchy"><a href="/api-docs/clay-web/format/tmx/TmxBaseLayer/">TmxBaseLayer</a> → <strong>format.tmx.TmxImageLayer</strong> (Class)</div>
...
<div class="signature field-var no-description" id="image"><code><span class="field-name">image</span><span class="operator">:</span> <a href="/api-docs/clay-web/format/tmx/TmxImage/" class="type-link">TmxImage</a></code><a class="header-anchor" href="#image"><span aria-hidden="true" class="header-anchor__symbol">#</span></a></div>
...
| Name | Type |
|------|------|
| `image` | [TmxImage](/api-docs/clay-web/format/tmx/TmxImage/) |
