...
title: Tools
target: Clay (Web)
permalink: api-docs/clay-web/format/tmx/Tools/
---
...
|------|------|---------|-------------|
| `map` | [TmxMap](/api-docs/clay-web/format/tmx/TmxMap/) | |  |
| `mapPath` | [String](/api-docs/clay-web/String/) | *(optional)* | Optional local path to the map file used for accurate TSX path resolving when comparing tilesets. |
...
| Returns |
|---------|
| [TmxTilesetTile](/api-docs/clay-web/format/tmx/TmxTilesetTile/) |
...
| Returns |
|---------|
| [TmxTileset](/api-docs/clay-web/format/tmx/TmxTileset/) |

<hr class="field-separator" />

<div class="signature field-method has-description" id="getTilesetIndexByGid"><code><span class="field-name">getTilesetIndexByGid</span><span class="parenthesis">(</span><span class="arg-name">map</span><span class="operator">:</span> <a href="/api-docs/clay-web/format/tmx/TmxMap/" class="type-link">TmxMap</a><span class="operator">,</span> <span class="arg-name">gid</span><span class="operator">:</span> <a href="/api-docs/clay-web/Int/" class="type-link">Int</a><span class="parenthesis">)</span><span class="operator">:</span> <a href="/api-docs/clay-web/Int/" class="type-link">Int</a></code><a class="header-anchor" href="#getTilesetIndexByGid"><span aria-hidden="true" class="header-anchor__symbol">#</span></a></div>
...
| Name | Type | Description |
|------|------|-------------|
| `tileset` | [TmxTileset](/api-docs/clay-web/format/tmx/TmxTileset/) | * |
| `localId` | [Int](/api-docs/clay-web/Int/) | * |
| `output` | [Dynamic](/api-docs/clay-web/Dynamic/) |  |

<hr class="field-separator" />

<div class="signature field-method has-description" id="fixObjectPlacement"><code><span class="field-name">fixObjectPlacement</span><span class="parenthesis">(</span><span class="arg-name">map</span><span class="operator">:</span> <a href="/api-docs/clay-web/format/tmx/TmxMap/" class="type-link">TmxMap</a><span class="parenthesis">)</span><span class="operator">:</span> <a href="/api-docs/clay-web/Void/" class="type-link">Void</a></code><a class="header-anchor" href="#fixObjectPlacement"><span aria-hidden="true" class="header-anchor__symbol">#</span></a></div>
...
|------|------|---------|-------------|
| `map` | [TmxMap](/api-docs/clay-web/format/tmx/TmxMap/) | |  |
| `tx` | [Int](/api-docs/clay-web/Int/) | |  |
| `ty` | [Int](/api-docs/clay-web/Int/) | |  |
| `tileset` | [TmxTileset](/api-docs/clay-web/format/tmx/TmxTileset/) | *(optional)* | Optional tileset reference. If present, it's tile sizes will be used for position calculation. |
| `lid` | [Int](/api-docs/clay-web/Int/) | *(optional)* | Optional local tile ID on tileset. Required for imageset tilesets. |
