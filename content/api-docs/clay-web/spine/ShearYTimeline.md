...
target: Clay (Web)
permalink: api-docs/clay-web/spine/ShearYTimeline/
---
...
<div class="type-hierarchy"><a href="/api-docs/clay-web/spine/Timeline/">Timeline</a> → <a href="/api-docs/clay-web/spine/CurveTimeline/">CurveTimeline</a> → <a href="/api-docs/clay-web/spine/CurveTimeline1/">CurveTimeline1</a> → <strong>spine.ShearYTimeline</strong> (Class)</div>
