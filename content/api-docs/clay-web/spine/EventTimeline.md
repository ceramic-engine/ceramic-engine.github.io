...
title: EventTimeline
target: Clay (Web)
permalink: api-docs/clay-web/spine/EventTimeline/
---
...
<div class="type-hierarchy"><a href="/api-docs/clay-web/spine/Timeline/">Timeline</a> → <strong>spine.EventTimeline</strong> (Class)</div>
...
| Returns |
|---------|
| [spine.support.utils.Array](/api-docs/clay-web/spine/support/utils/Array/)<[Event](/api-docs/clay-web/spine/Event/)> |
...
| `firedEvents` | [spine.support.utils.Array](/api-docs/clay-web/spine/support/utils/Array/)<[Event](/api-docs/clay-web/spine/Event/)> |
