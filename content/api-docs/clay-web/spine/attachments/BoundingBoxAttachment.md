...
target: Clay (Web)
permalink: api-docs/clay-web/spine/attachments/BoundingBoxAttachment/
---
...
<div class="type-hierarchy"><a href="/api-docs/clay-web/spine/attachments/Attachment/">Attachment</a> → <a href="/api-docs/clay-web/spine/attachments/VertexAttachment/">VertexAttachment</a> → <strong>spine.attachments.BoundingBoxAttachment</strong> (Class)</div>
