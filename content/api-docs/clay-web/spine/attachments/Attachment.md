...
title: Attachment
target: Clay (Web)
permalink: api-docs/clay-web/spine/attachments/Attachment/
---

# Attachment

<div class="view-source"><a href="https://github.com/jeremyfa/spine-hx/blob/master/spine/attachments/Attachment.hx">View source</a></div>

<div class="type-hierarchy"><strong>spine.attachments.Attachment</strong> (Class) → <a href="/api-docs/clay-web/spine/attachments/PointAttachment/">PointAttachment</a>, <a href="/api-docs/clay-web/spine/attachments/RegionAttachment/">RegionAttachment</a>, <a href="/api-docs/clay-web/spine/attachments/VertexAttachment/">VertexAttachment</a></div>
...
<div class="signature field-method has-description has-plugin" id="copy"><div class="plugin-name">spine</div><code><span class="field-name">copy</span><span class="parenthesis">(</span><span class="parenthesis">)</span><span class="operator">:</span> <a href="#" class="type-link">Attachment</a></code><a class="header-anchor" href="#copy"><span aria-hidden="true" class="header-anchor__symbol">#</span></a></div>
