...
target: Clay (Web)
permalink: api-docs/clay-web/spine/attachments/AttachmentLoader/
---
...
<div class="type-hierarchy"><strong>spine.attachments.AttachmentLoader</strong> (Interface) → <a href="/api-docs/clay-web/spine/attachments/AtlasAttachmentLoader/">AtlasAttachmentLoader</a></div>
...
| Returns | Description |
|---------|-------------|
| [RegionAttachment](/api-docs/clay-web/spine/attachments/RegionAttachment/) | May be null to not load the attachment. |
...
| Returns | Description |
|---------|-------------|
| [MeshAttachment](/api-docs/clay-web/spine/attachments/MeshAttachment/) | May be null to not load the attachment. In that case null should also be returned for child meshes. |
...
| Returns | Description |
|---------|-------------|
| [BoundingBoxAttachment](/api-docs/clay-web/spine/attachments/BoundingBoxAttachment/) | May be null to not load the attachment. |
...
| Returns | Description |
|---------|-------------|
| [ClippingAttachment](/api-docs/clay-web/spine/attachments/ClippingAttachment/) | May be null to not load the attachment. |
...
| Returns | Description |
|---------|-------------|
| [PathAttachment](/api-docs/clay-web/spine/attachments/PathAttachment/) | May be null to not load the attachment. |
...
| Returns | Description |
|---------|-------------|
| [PointAttachment](/api-docs/clay-web/spine/attachments/PointAttachment/) | May be null to not load the attachment. |
