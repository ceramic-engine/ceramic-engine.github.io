...
title: RGB2Timeline
target: Clay (Web)
permalink: api-docs/clay-web/spine/RGB2Timeline/
---
...
<div class="type-hierarchy"><a href="/api-docs/clay-web/spine/Timeline/">Timeline</a> → <a href="/api-docs/clay-web/spine/CurveTimeline/">CurveTimeline</a> → <strong>spine.RGB2Timeline</strong> (Class)</div>
