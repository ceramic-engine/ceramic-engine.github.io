...
title: EventQueue
target: Clay (Web)
permalink: api-docs/clay-web/spine/EventQueue/
---
...
<div class="signature field-var no-description has-plugin" id="drainDisabled"><div class="plugin-name">spine</div><code><span class="field-name">drainDisabled</span><span class="operator">:</span> <a href="/api-docs/clay-web/Bool/" class="type-link">Bool</a></code><a class="header-anchor" href="#drainDisabled"><span aria-hidden="true" class="header-anchor__symbol">#</span></a></div>
...
<div class="signature field-var no-description has-plugin" id="AnimationState_this"><div class="plugin-name">spine</div><code><span class="field-name">AnimationState_this</span><span class="operator">:</span> <a href="/api-docs/clay-web/spine/AnimationState/" class="type-link">AnimationState</a></code><a class="header-anchor" href="#AnimationState_this"><span aria-hidden="true" class="header-anchor__symbol">#</span></a></div>
