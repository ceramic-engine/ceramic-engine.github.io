...
title: Pool
target: Clay (Web)
permalink: api-docs/clay-web/spine/support/utils/Pool/
---
...
<div class="type-hierarchy"><strong>spine.support.utils.Pool</strong> (Class) → <a href="/api-docs/clay-web/spine/_AnimationState/TrackEntryPool/">spine._AnimationState.TrackEntryPool</a>, <a href="/api-docs/clay-web/spine/_SkeletonBounds/PolygonPool/">spine._SkeletonBounds.PolygonPool</a>, <a href="/api-docs/clay-web/spine/utils/_Triangulator/IndicesPool/">spine.utils._Triangulator.IndicesPool</a>, <a href="/api-docs/clay-web/spine/utils/_Triangulator/PolygonPool/">spine.utils._Triangulator.PolygonPool</a></div>
...
| Name | Type |
|------|------|
| `objects` | [Array](/api-docs/clay-web/spine/support/utils/Array/)<spine.support.utils.Pool.T> |
...
|------|------|---------|-------------|
| `initialCapacity` | [Int](/api-docs/clay-web/Int/) | `64` |  |
| `max` | [Int](/api-docs/clay-web/Int/) | `999999999` | The maximum number of free objects to store in this pool. |
