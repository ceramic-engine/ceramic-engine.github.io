...
title: FileHandle
target: Clay (Web)
permalink: api-docs/clay-web/spine/support/files/FileHandle/
---
...
<div class="type-hierarchy"><strong>spine.support.files.FileHandle</strong> (Interface) → <a href="/api-docs/clay-web/ceramic/SpineFile/">ceramic.SpineFile</a></div>
