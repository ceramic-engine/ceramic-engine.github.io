...
title: ScaleTimeline
target: Clay (Web)
permalink: api-docs/clay-web/spine/ScaleTimeline/
---
...
<div class="type-hierarchy"><a href="/api-docs/clay-web/spine/Timeline/">Timeline</a> → <a href="/api-docs/clay-web/spine/CurveTimeline/">CurveTimeline</a> → <a href="/api-docs/clay-web/spine/CurveTimeline2/">CurveTimeline2</a> → <strong>spine.ScaleTimeline</strong> (Class)</div>
