...
target: Clay (Web)
permalink: api-docs/clay-web/spine/TransformConstraintTimeline/
---
...
<div class="type-hierarchy"><a href="/api-docs/clay-web/spine/Timeline/">Timeline</a> → <a href="/api-docs/clay-web/spine/CurveTimeline/">CurveTimeline</a> → <strong>spine.TransformConstraintTimeline</strong> (Class)</div>
...
<div class="signature field-var no-description has-plugin" id="transformConstraintIndex"><div class="plugin-name">spine</div><code><span class="field-name">transformConstraintIndex</span><span class="operator">:</span> <a href="/api-docs/clay-web/Int/" class="type-link">Int</a></code><a class="header-anchor" href="#transformConstraintIndex"><span aria-hidden="true" class="header-anchor__symbol">#</span></a></div>
...
| `transformConstraintIndex` | [Int](/api-docs/clay-web/Int/) |

## Private Members

<div class="signature field-var no-description has-plugin" id="ROTATE"><div class="plugin-name">spine</div><code><span class="field-name">ROTATE</span><span class="operator">:</span> <a href="/api-docs/clay-web/Int/" class="type-link">Int</a></code><a class="header-anchor" href="#ROTATE"><span aria-hidden="true" class="header-anchor__symbol">#</span></a></div>
...
<div class="signature field-var no-description has-plugin" id="SCALEX"><div class="plugin-name">spine</div><code><span class="field-name">SCALEX</span><span class="operator">:</span> <a href="/api-docs/clay-web/Int/" class="type-link">Int</a></code><a class="header-anchor" href="#SCALEX"><span aria-hidden="true" class="header-anchor__symbol">#</span></a></div>

<hr class="field-separator" />

<div class="signature field-var no-description has-plugin" id="SCALEY"><div class="plugin-name">spine</div><code><span class="field-name">SCALEY</span><span class="operator">:</span> <a href="/api-docs/clay-web/Int/" class="type-link">Int</a></code><a class="header-anchor" href="#SCALEY"><span aria-hidden="true" class="header-anchor__symbol">#</span></a></div>

<hr class="field-separator" />

<div class="signature field-var no-description has-plugin" id="SHEARY"><div class="plugin-name">spine</div><code><span class="field-name">SHEARY</span><span class="operator">:</span> <a href="/api-docs/clay-web/Int/" class="type-link">Int</a></code><a class="header-anchor" href="#SHEARY"><span aria-hidden="true" class="header-anchor__symbol">#</span></a></div>
