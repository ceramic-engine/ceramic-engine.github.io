...
title: RGBTimeline
target: Clay (Web)
permalink: api-docs/clay-web/spine/RGBTimeline/
---
...
<div class="type-hierarchy"><a href="/api-docs/clay-web/spine/Timeline/">Timeline</a> → <a href="/api-docs/clay-web/spine/CurveTimeline/">CurveTimeline</a> → <strong>spine.RGBTimeline</strong> (Class)</div>
