...
target: Clay (Web)
permalink: api-docs/clay-web/spine/ConstraintData/
---
...
<div class="type-hierarchy"><strong>spine.ConstraintData</strong> (Class) → <a href="/api-docs/clay-web/spine/IkConstraintData/">IkConstraintData</a>, <a href="/api-docs/clay-web/spine/PathConstraintData/">PathConstraintData</a>, <a href="/api-docs/clay-web/spine/TransformConstraintData/">TransformConstraintData</a></div>
...
<div class="signature field-var no-description has-plugin" id="order"><div class="plugin-name">spine</div><code><span class="field-name">order</span><span class="operator">:</span> <a href="/api-docs/clay-web/Int/" class="type-link">Int</a></code><a class="header-anchor" href="#order"><span aria-hidden="true" class="header-anchor__symbol">#</span></a></div>
...
<div class="signature field-method has-description has-plugin" id="getOrder"><div class="plugin-name">spine</div><code><span class="field-name">getOrder</span><span class="parenthesis">(</span><span class="parenthesis">)</span><span class="operator">:</span> <a href="/api-docs/clay-web/Int/" class="type-link">Int</a></code><a class="header-anchor" href="#getOrder"><span aria-hidden="true" class="header-anchor__symbol">#</span></a></div>
