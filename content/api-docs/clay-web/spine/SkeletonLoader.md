...
target: Clay (Web)
permalink: api-docs/clay-web/spine/SkeletonLoader/
---
...
<div class="type-hierarchy"><strong>spine.SkeletonLoader</strong> (Class) → <a href="/api-docs/clay-web/spine/SkeletonJson/">SkeletonJson</a></div>
