...
title: RGBATimeline
target: Clay (Web)
permalink: api-docs/clay-web/spine/RGBATimeline/
---
...
<div class="type-hierarchy"><a href="/api-docs/clay-web/spine/Timeline/">Timeline</a> → <a href="/api-docs/clay-web/spine/CurveTimeline/">CurveTimeline</a> → <strong>spine.RGBATimeline</strong> (Class)</div>
