...
title: ArrayPool
target: Clay (Web)
permalink: api-docs/clay-web/ceramic/ArrayPool/
---
...
|------|------|-------------|
| `size` | [Int](/api-docs/clay-web/Int/) | The maximum size of arrays needed  |

| Returns | Description |
|---------|-------------|
| [ArrayPool](/api-docs/clay-web/ceramic/ArrayPool/) | An ArrayPool instance suitable for the requested size |
...
| Returns | Description |
|---------|-------------|
| [ReusableArray](/api-docs/clay-web/ceramic/ReusableArray/)<[Any](/api-docs/clay-web/Any/)> | A ReusableArray instance of the pool's configured size |
...
| Name | Type | Description |
|------|------|-------------|
| `array` | [ReusableArray](/api-docs/clay-web/ceramic/ReusableArray/)<[Any](/api-docs/clay-web/Any/)> | The array to return to the pool |
...
| Name | Type | Description |
|------|------|-------------|
| `arrayLengths` | [Int](/api-docs/clay-web/Int/) | The size of arrays this pool will manage |
