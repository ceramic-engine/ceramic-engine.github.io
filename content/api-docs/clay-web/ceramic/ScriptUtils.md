...
title: ScriptUtils
target: Clay (Web)
permalink: api-docs/clay-web/ceramic/ScriptUtils/
---
...
|------|------|-------------|
| `code` | [String](/api-docs/clay-web/String/) | Source code with JS/TS syntax  |

| Returns | Description |
|---------|-------------|
| [String](/api-docs/clay-web/String/) | Equivalent HScript code |
...
| Name | Type | Description |
|------|------|-------------|
| `code` | [String](/api-docs/clay-web/String/) | Raw JS/TS code  |

| Returns | Description |
|---------|-------------|
| [String](/api-docs/clay-web/String/) | Cleaned code with basic conversions |
...
| Name | Type | Description |
|------|------|-------------|
| `error` | [Dynamic](/api-docs/clay-web/Dynamic/) | Error message  |
| `i` | [Int](/api-docs/clay-web/Int/) | Character position where error occurred  |
| `code` | [String](/api-docs/clay-web/String/) | Full source code |
