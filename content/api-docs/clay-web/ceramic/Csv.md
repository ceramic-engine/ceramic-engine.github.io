...
title: Csv
target: Clay (Web)
permalink: api-docs/clay-web/ceramic/Csv/
---
...
|------|------|-------------|
| `csv` | [String](/api-docs/clay-web/String/) | The CSV string to parse  |

| Returns | Description |
|---------|-------------|
| [Array](/api-docs/clay-web/Array/)<[haxe.DynamicAccess](/api-docs/clay-web/haxe/DynamicAccess/)<[String](/api-docs/clay-web/String/)>> | Array of objects with fields as defined in the header row * ```haxe var csv = 'id,name,description\n' + '1,"Smith, John","Says ""Hello"""\n' + '2,Jane Doe,Regular description'; * var data = Csv.parse(csv); trace(data[0].name); // "Smith, John" trace(data[0].description); // "Says "Hello"" ``` |
...
|------|------|---------|-------------|
| `items` | [Array](/api-docs/clay-web/Array/)<[Dynamic](/api-docs/clay-web/Dynamic/)> | | Array of objects to convert to CSV  |
| `fields` | [Array](/api-docs/clay-web/Array/)<[String](/api-docs/clay-web/String/)> | *(optional)* | Optional array of field names to include in specific order. If not provided, fields are auto-discovered from all objects.  |

| Returns | Description |
|---------|-------------|
| [String](/api-docs/clay-web/String/) | CSV string with header row and data rows * ```haxe var data = [ {id: 1, name: "John", note: "Says "Hi""}, {id: 2, name: "Jane, MD", note: "Multi\nline"} ]; * // Auto-discover fields var csv1 = Csv.stringify(data); * // Specific fields only var csv2 = Csv.stringify(data, ["id", "name"]); ``` |
