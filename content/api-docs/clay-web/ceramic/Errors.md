...
title: Errors
target: Clay (Web)
permalink: api-docs/clay-web/ceramic/Errors/
---
...
|------|------|-------------|
| `e` | [Dynamic](/api-docs/clay-web/Dynamic/) | The uncaught error/exception object |
