...
target: Clay (Web)
permalink: api-docs/clay-web/ceramic/HighPassFilter/
---
...
<div class="type-hierarchy"><a href="/api-docs/clay-web/ceramic/Entity/">Entity</a> → <a href="/api-docs/clay-web/ceramic/AudioFilter/">AudioFilter</a> → <strong>ceramic.HighPassFilter</strong> (Class)</div>
...
<div class="see"><strong>See:</strong> <a href="/api-docs/clay-web/ceramic/LowPassFilter/">LowPassFilter</a>, <a href="/api-docs/clay-web/ceramic/AudioFilter/">AudioFilter</a>, <a href="/api-docs/clay-web/ceramic/AudioMixer/">AudioMixer</a></div>
...
<div class="signature field-method no-description" id="workletClass"><code><span class="field-name">workletClass</span><span class="parenthesis">(</span><span class="parenthesis">)</span><span class="operator">:</span> <a href="/api-docs/clay-web/Class<ceramic/HighPassFilterWorklet>/" class="type-link">Class<ceramic.HighPassFilterWorklet></a></code><a class="header-anchor" href="#workletClass"><span aria-hidden="true" class="header-anchor__symbol">#</span></a></div>

| Returns |
|---------|
| [Class<ceramic.HighPassFilterWorklet>](/api-docs/clay-web/Class<ceramic/HighPassFilterWorklet>/) |
