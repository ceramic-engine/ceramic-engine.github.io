...
target: Clay (Web)
permalink: api-docs/clay-web/ceramic/TilemapLdtkParser/
---
...
| Name | Type | Description |
|------|------|-------------|
| `level` | [LdtkLevel](/api-docs/clay-web/ceramic/LdtkLevel/) | The LDtk level to convert |
...
| Name | Type | Description |
|------|------|-------------|
| `ldtkTiles` | [Array](/api-docs/clay-web/Array/)<[Int](/api-docs/clay-web/Int/)> | Raw tile data from LDtk (7 integers per tile)  |
| `tileset` | [LdtkTilesetDefinition](/api-docs/clay-web/ceramic/LdtkTilesetDefinition/) | The tileset definition for GID mapping  |
| `cols` | [Int](/api-docs/clay-web/Int/) | Number of columns in the layer  |
| `rows` | [Int](/api-docs/clay-web/Int/) | Number of rows in the layer  |
| `gridSize` | [Int](/api-docs/clay-web/Int/) | The grid cell size in pixels  |
| `tilesAlpha` | [Array](/api-docs/clay-web/Array/)<[Float](/api-docs/clay-web/Float/)> | Output array for tile alpha values  |
| `tilesOffsetX` | [Array](/api-docs/clay-web/Array/)<[Int](/api-docs/clay-web/Int/)> | Output array for tile X offsets  |
| `tilesOffsetY` | [Array](/api-docs/clay-web/Array/)<[Int](/api-docs/clay-web/Int/)> | Output array for tile Y offsets  |

| Returns | Description |
|---------|-------------|
| [Array](/api-docs/clay-web/Array/)<[TilemapTile](/api-docs/clay-web/ceramic/TilemapTile/)> | Array of TilemapTile objects, or null if no tiles |
