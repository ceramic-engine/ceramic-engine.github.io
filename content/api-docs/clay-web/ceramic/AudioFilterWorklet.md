...
target: Clay (Web)
permalink: api-docs/clay-web/ceramic/AudioFilterWorklet/
---
...
<div class="type-hierarchy"><strong>ceramic.AudioFilterWorklet</strong> (Class) → <a href="/api-docs/clay-web/ceramic/HighPassFilterWorklet/">HighPassFilterWorklet</a>, <a href="/api-docs/clay-web/ceramic/LowPassFilterWorklet/">LowPassFilterWorklet</a></div>
...
<div class="see"><strong>See:</strong> <a href="/api-docs/clay-web/ceramic/AudioFilter/">AudioFilter</a>, <a href="/api-docs/clay-web/ceramic/AudioFilters/">AudioFilters</a>, <a href="/api-docs/clay-web/ceramic/AudioFilterBuffer/">AudioFilterBuffer</a></div>
...
| Name | Type | Description |
|------|------|-------------|
| `filterId` | [Int](/api-docs/clay-web/Int/) | Unique identifier for this filter instance  |
| `bus` | [Int](/api-docs/clay-web/Int/) | Audio bus ID where this filter will process audio |
...
| Name | Type | Description |
|------|------|-------------|
| `index` | [Int](/api-docs/clay-web/Int/) | Parameter index (order matches |

| Returns | Description |
|---------|-------------|
| [Bool](/api-docs/clay-web/Bool/) | Boolean value of the parameter |
...
| Returns | Description |
|---------|-------------|
| [Int](/api-docs/clay-web/Int/) | Integer value of the parameter |
...
| Returns | Description |
|---------|-------------|
| [Float](/api-docs/clay-web/Float/) | Float value of the parameter |
