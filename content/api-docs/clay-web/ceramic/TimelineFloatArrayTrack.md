...
target: Clay (Web)
permalink: api-docs/clay-web/ceramic/TimelineFloatArrayTrack/
---
...
<div class="type-hierarchy"><a href="/api-docs/clay-web/ceramic/Entity/">Entity</a> → <a href="/api-docs/clay-web/ceramic/TimelineTrack/">TimelineTrack</a> → <strong>ceramic.TimelineFloatArrayTrack</strong> (Class)</div>
...
<div class="see"><strong>See:</strong> <a href="/api-docs/clay-web/ceramic/TimelineFloatArrayKeyframe/">TimelineFloatArrayKeyframe</a>, <a href="/api-docs/clay-web/ceramic/TimelineTrack/">TimelineTrack</a>, <a href="/api-docs/clay-web/ceramic/Timeline/">Timeline</a></div>
...
|------|------|---------|-------------|
| `forceChange` | [Bool](/api-docs/clay-web/Bool/) | `false` | If true, triggers the change event even if no values changed |
...
|------|------|-------------|
| `track` | [TimelineFloatArrayTrack](/api-docs/clay-web/ceramic/TimelineFloatArrayTrack/) | This track instance (for convenience in handlers) |
