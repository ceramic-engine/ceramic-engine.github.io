...
target: Clay (Web)
permalink: api-docs/clay-web/ceramic/InputMapConvertToAxis/
---
...
|------|------|-------------|
| `index` | [Int](/api-docs/clay-web/Int/) | The index of the target axis action |
| `value` | [Int](/api-docs/clay-web/Int/) | The axis value to apply (stored as int * 1000 for precision) |
