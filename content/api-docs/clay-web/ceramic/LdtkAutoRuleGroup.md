...
target: Clay (Web)
permalink: api-docs/clay-web/ceramic/LdtkAutoRuleGroup/
---
...
<div class="signature field-var no-description has-plugin" id="isOptional"><div class="plugin-name">ldtk</div><code><span class="field-name">isOptional</span><span class="operator">:</span> <a href="/api-docs/clay-web/Bool/" class="type-link">Bool</a></code><a class="header-anchor" href="#isOptional"><span aria-hidden="true" class="header-anchor__symbol">#</span></a></div>
