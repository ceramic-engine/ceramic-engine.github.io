...
target: Clay (Web)
permalink: api-docs/clay-web/ceramic/ConvertSpriteSheet/
---
...
| `assets` | [Assets](/api-docs/clay-web/ceramic/Assets/) | The assets instance to load from  |
| `basic` | [String](/api-docs/clay-web/String/) | The sprite sheet asset name  |
...
| `instance` | [Entity](/api-docs/clay-web/ceramic/Entity/) | The entity that owns this field  |
| `field` | [String](/api-docs/clay-web/String/) | The name of the field being converted  |
| `value` | [SpriteSheet](/api-docs/clay-web/ceramic/SpriteSheet/) | The SpriteSheet instance  |

| Returns | Description |
|---------|-------------|
| [String](/api-docs/clay-web/String/) | The asset name, or null if the sheet has no associated asset |
