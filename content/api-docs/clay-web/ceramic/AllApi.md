...
title: AllApi
target: Clay (Web)
permalink: api-docs/clay-web/ceramic/AllApi/
---
...
<div class="signature field-method has-description" id="apiCallCache"><code><span class="field-name">apiCallCache</span><span class="parenthesis">(</span><span class="parenthesis">)</span><span class="operator">:</span> <a href="/api-docs/clay-web/Void/" class="type-link">Void</a></code><a class="header-anchor" href="#apiCallCache"><span aria-hidden="true" class="header-anchor__symbol">#</span></a></div>
...
<div class="signature field-method has-description has-plugin" id="configureHscript"><div class="plugin-name">script</div><code><span class="field-name">configureHscript</span><span class="parenthesis">(</span><span class="arg-name">interp</span><span class="operator">:</span> <a href="/api-docs/clay-web/hscript/Interp/" class="type-link">hscript.Interp</a><span class="parenthesis">)</span><span class="operator">:</span> <a href="/api-docs/clay-web/Void/" class="type-link">Void</a></code><a class="header-anchor" href="#configureHscript"><span aria-hidden="true" class="header-anchor__symbol">#</span></a></div>
...
|------|------|-------------|
| `interp` | [hscript.Interp](/api-docs/clay-web/hscript/Interp/) | The HScript interpreter to configure |
