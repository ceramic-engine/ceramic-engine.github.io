...
title: ArcadeWorld
target: Clay (Web)
permalink: api-docs/clay-web/ceramic/ArcadeWorld/
---
...
<div class="type-hierarchy"><a href="/api-docs/clay-web/arcade/World/">arcade.World</a> → <strong>ceramic.ArcadeWorld</strong> (Class)</div>
...
|------|------|---------|-------------|
| `element1` | [arcade.Collidable](/api-docs/clay-web/arcade/Collidable/) | | First element to check  |
| `element2` | [arcade.Collidable](/api-docs/clay-web/arcade/Collidable/) | *(optional)* | Second element to check (or null to check element1 against itself)  |
...
| Name | Type | Default | Description |
|------|------|---------|-------------|
| `group1` | [arcade.Group](/api-docs/clay-web/arcade/Group/) | | First group of bodies  |
| `group2` | [arcade.Group](/api-docs/clay-web/arcade/Group/) | | Second group of bodies  |
...
| Name | Type | Default |
|------|------|---------|
| `group` | [arcade.Group](/api-docs/clay-web/arcade/Group/) | |
...
| Name | Type | Default | Description |
|------|------|---------|-------------|
| `body` | [arcade.Body](/api-docs/clay-web/arcade/Body/) | | The body to check  |
| `group` | [arcade.Group](/api-docs/clay-web/arcade/Group/) | | The group of bodies to check against  |
...
<div class="signature field-method no-description has-plugin" id="overlapBodyVsCeramicGroup"><div class="plugin-name">arcade</div><code><span class="field-name">overlapBodyVsCeramicGroup</span><span class="parenthesis">(</span><span class="arg-name">body</span><span class="operator">:</span> <a href="/api-docs/clay-web/arcade/Body/" class="type-link">arcade.Body</a><span class="operator">,</span> <span class="arg-name">group</span><span class="operator">:</span> <a href="/api-docs/clay-web/ceramic/Group/" class="type-link">Group</a><span class="operator">&lt;</span><a href="/api-docs/clay-web/ceramic/Visual/" class="type-link">Visual</a><span class="operator">&gt;</span><span class="operator">,</span> <span class="operator">?</span><span class="arg-name">overlapCallback</span><span class="operator">:</span> <span class="type-name">Function</span><span class="operator">,</span> <span class="operator">?</span><span class="arg-name">processCallback</span><span class="operator">:</span> <span class="type-name">Function</span><span class="parenthesis">)</span><span class="operator">:</span> <a href="/api-docs/clay-web/Bool/" class="type-link">Bool</a></code><a class="header-anchor" href="#overlapBodyVsCeramicGroup"><span aria-hidden="true" class="header-anchor__symbol">#</span></a></div>


| Name | Type | Default |
|------|------|---------|
| `body` | [arcade.Body](/api-docs/clay-web/arcade/Body/) | |
| `group` | [Group](/api-docs/clay-web/ceramic/Group/)<[Visual](/api-docs/clay-web/ceramic/Visual/)> | |
| `overlapCallback` | Function | *(optional)* |
| `processCallback` | Function | *(optional)* |
...
| Returns | Description |
|---------|-------------|
| [Bool](/api-docs/clay-web/Bool/) | True if any collisions occurred |
...
| Name | Type | Default |
|------|------|---------|
| `group1` | [arcade.Group](/api-docs/clay-web/arcade/Group/) | |
| `group2` | [arcade.Group](/api-docs/clay-web/arcade/Group/) | |
...
| Name | Type | Default | Description |
|------|------|---------|-------------|
| `group` | [Group](/api-docs/clay-web/ceramic/Group/)<[Visual](/api-docs/clay-web/ceramic/Visual/)> | | The group to sort  |
| `sortDirection` | [arcade.SortDirection](/api-docs/clay-web/arcade/SortDirection/) | `SortDirection.INHERIT` | The direction to sort (or INHERIT to use group/world setting) |
...
|------|------|-------------|
| `boundsX` | [Float](/api-docs/clay-web/Float/) | Left edge of the world  |
| `boundsY` | [Float](/api-docs/clay-web/Float/) | Top edge of the world  |
| `boundsWidth` | [Float](/api-docs/clay-web/Float/) | Width of the world  |
| `boundsHeight` | [Float](/api-docs/clay-web/Float/) | Height of the world |

<hr class="field-separator" />

<div class="signature field-method has-description has-plugin" id="collideBodyVsTilemap"><div class="plugin-name">tilemap</div><code><span class="field-name">collideBodyVsTilemap</span><span class="parenthesis">(</span><span class="arg-name">body</span><span class="operator">:</span> <a href="/api-docs/clay-web/arcade/Body/" class="type-link">arcade.Body</a><span class="operator">,</span> <span class="arg-name">tilemap</span><span class="operator">:</span> <a href="/api-docs/clay-web/ceramic/Tilemap/" class="type-link">Tilemap</a><span class="operator">,</span> <span class="operator">?</span><span class="arg-name">collideCallback</span><span class="operator">:</span> <span class="type-name">Function</span><span class="operator">,</span> <span class="operator">?</span><span class="arg-name">processCallback</span><span class="operator">:</span> <span class="type-name">Function</span><span class="parenthesis">)</span><span class="operator">:</span> <a href="/api-docs/clay-web/Bool/" class="type-link">Bool</a></code><a class="header-anchor" href="#collideBodyVsTilemap"><span aria-hidden="true" class="header-anchor__symbol">#</span></a></div>
...
| Name | Type | Default | Description |
|------|------|---------|-------------|
| `body` | [arcade.Body](/api-docs/clay-web/arcade/Body/) | | The physics body to collide  |
| `tilemap` | [Tilemap](/api-docs/clay-web/ceramic/Tilemap/) | | The tilemap to collide against  |
...
<div class="signature field-method no-description has-plugin" id="collideBodyVsTilemapLayer"><div class="plugin-name">tilemap</div><code><span class="field-name">collideBodyVsTilemapLayer</span><span class="parenthesis">(</span><span class="arg-name">body</span><span class="operator">:</span> <a href="/api-docs/clay-web/arcade/Body/" class="type-link">arcade.Body</a><span class="operator">,</span> <span class="arg-name">layer</span><span class="operator">:</span> <a href="/api-docs/clay-web/ceramic/TilemapLayer/" class="type-link">TilemapLayer</a><span class="operator">,</span> <span class="operator">?</span><span class="arg-name">collideCallback</span><span class="operator">:</span> <span class="type-name">Function</span><span class="operator">,</span> <span class="operator">?</span><span class="arg-name">processCallback</span><span class="operator">:</span> <span class="type-name">Function</span><span class="parenthesis">)</span><span class="operator">:</span> <a href="/api-docs/clay-web/Bool/" class="type-link">Bool</a></code><a class="header-anchor" href="#collideBodyVsTilemapLayer"><span aria-hidden="true" class="header-anchor__symbol">#</span></a></div>


| Name | Type | Default |
|------|------|---------|
| `body` | [arcade.Body](/api-docs/clay-web/arcade/Body/) | |
| `layer` | [TilemapLayer](/api-docs/clay-web/ceramic/TilemapLayer/) | |
| `collideCallback` | Function | *(optional)* |
| `processCallback` | Function | *(optional)* |
...
| Name | Type | Description |
|------|------|-------------|
| `element` | [arcade.Collidable](/api-docs/clay-web/arcade/Collidable/) | The collidable element to identify  |

| Returns | Description |
|---------|-------------|
| [Class](/api-docs/clay-web/Class/)<[Dynamic](/api-docs/clay-web/Dynamic/)> | The base class type for collision handling |

<hr class="field-separator" />

<div class="signature field-method has-description has-plugin" id="overlapCeramicGroupVsCeramicGroup"><div class="plugin-name">arcade</div><code><span class="field-name">overlapCeramicGroupVsCeramicGroup</span><span class="parenthesis">(</span><span class="arg-name">group1</span><span class="operator">:</span> <a href="/api-docs/clay-web/ceramic/Group/" class="type-link">Group</a><span class="operator">&lt;</span><a href="/api-docs/clay-web/ceramic/Visual/" class="type-link">Visual</a><span class="operator">&gt;</span><span class="operator">,</span> <span class="arg-name">group2</span><span class="operator">:</span> <a href="/api-docs/clay-web/ceramic/Group/" class="type-link">Group</a><span class="operator">&lt;</span><a href="/api-docs/clay-web/ceramic/Visual/" class="type-link">Visual</a><span class="operator">&gt;</span><span class="operator">,</span> <span class="operator">?</span><span class="arg-name">overlapCallback</span><span class="operator">:</span> <span class="type-name">Function</span><span class="operator">,</span> <span class="operator">?</span><span class="arg-name">processCallback</span><span class="operator">:</span> <span class="type-name">Function</span><span class="parenthesis">)</span><span class="operator">:</span> <a href="/api-docs/clay-web/Bool/" class="type-link">Bool</a></code><a class="header-anchor" href="#overlapCeramicGroupVsCeramicGroup"><span aria-hidden="true" class="header-anchor__symbol">#</span></a></div>
...
| Name | Type | Default | Description |
|------|------|---------|-------------|
| `group1` | [Group](/api-docs/clay-web/ceramic/Group/)<[Visual](/api-docs/clay-web/ceramic/Visual/)> | | First group of visuals  |
| `group2` | [Group](/api-docs/clay-web/ceramic/Group/)<[Visual](/api-docs/clay-web/ceramic/Visual/)> | | Second group of visuals  |
| `overlapCallback` | Function | *(optional)* | Called for each overlapping pair  |
| `processCallback` | Function | *(optional)* | Optional filter callback  |
...
<div class="signature field-method no-description has-plugin" id="overlapCeramicGroupVsArcadeGroup"><div class="plugin-name">arcade</div><code><span class="field-name">overlapCeramicGroupVsArcadeGroup</span><span class="parenthesis">(</span><span class="arg-name">group1</span><span class="operator">:</span> <a href="/api-docs/clay-web/ceramic/Group/" class="type-link">Group</a><span class="operator">&lt;</span><a href="/api-docs/clay-web/ceramic/Visual/" class="type-link">Visual</a><span class="operator">&gt;</span><span class="operator">,</span> <span class="arg-name">group2</span><span class="operator">:</span> <a href="/api-docs/clay-web/arcade/Group/" class="type-link">arcade.Group</a><span class="operator">,</span> <span class="operator">?</span><span class="arg-name">overlapCallback</span><span class="operator">:</span> <span class="type-name">Function</span><span class="operator">,</span> <span class="operator">?</span><span class="arg-name">processCallback</span><span class="operator">:</span> <span class="type-name">Function</span><span class="parenthesis">)</span><span class="operator">:</span> <a href="/api-docs/clay-web/Bool/" class="type-link">Bool</a></code><a class="header-anchor" href="#overlapCeramicGroupVsArcadeGroup"><span aria-hidden="true" class="header-anchor__symbol">#</span></a></div>


| Name | Type | Default |
|------|------|---------|
| `group1` | [Group](/api-docs/clay-web/ceramic/Group/)<[Visual](/api-docs/clay-web/ceramic/Visual/)> | |
| `group2` | [arcade.Group](/api-docs/clay-web/arcade/Group/) | |
| `overlapCallback` | Function | *(optional)* |
| `processCallback` | Function | *(optional)* |
...
<div class="signature field-method no-description has-plugin" id="collideCeramicGroupVsCeramicGroup"><div class="plugin-name">arcade</div><code><span class="field-name">collideCeramicGroupVsCeramicGroup</span><span class="parenthesis">(</span><span class="arg-name">group1</span><span class="operator">:</span> <a href="/api-docs/clay-web/ceramic/Group/" class="type-link">Group</a><span class="operator">&lt;</span><a href="/api-docs/clay-web/ceramic/Visual/" class="type-link">Visual</a><span class="operator">&gt;</span><span class="operator">,</span> <span class="arg-name">group2</span><span class="operator">:</span> <a href="/api-docs/clay-web/ceramic/Group/" class="type-link">Group</a><span class="operator">&lt;</span><a href="/api-docs/clay-web/ceramic/Visual/" class="type-link">Visual</a><span class="operator">&gt;</span><span class="operator">,</span> <span class="operator">?</span><span class="arg-name">collideCallback</span><span class="operator">:</span> <span class="type-name">Function</span><span class="operator">,</span> <span class="operator">?</span><span class="arg-name">processCallback</span><span class="operator">:</span> <span class="type-name">Function</span><span class="parenthesis">)</span><span class="operator">:</span> <a href="/api-docs/clay-web/Bool/" class="type-link">Bool</a></code><a class="header-anchor" href="#collideCeramicGroupVsCeramicGroup"><span aria-hidden="true" class="header-anchor__symbol">#</span></a></div>


| Name | Type | Default |
|------|------|---------|
| `group1` | [Group](/api-docs/clay-web/ceramic/Group/)<[Visual](/api-docs/clay-web/ceramic/Visual/)> | |
| `group2` | [Group](/api-docs/clay-web/ceramic/Group/)<[Visual](/api-docs/clay-web/ceramic/Visual/)> | |
| `collideCallback` | Function | *(optional)* |
| `processCallback` | Function | *(optional)* |
...
| `collideCallback` | Function | *(optional)* |
| `processCallback` | Function | *(optional)* |
| `overlapOnly` | [Bool](/api-docs/clay-web/Bool/) | `false` |
...
|------|------|-------------|
| `body` | [arcade.Body](/api-docs/clay-web/arcade/Body/) | The body to check  |
| `layer` | [TilemapLayer](/api-docs/clay-web/ceramic/TilemapLayer/) | The tilemap layer  |
| `collideCallback` | Function | Called for each collision  |
| `processCallback` | Function | Optional filter  |
| `overlapOnly` | [Bool](/api-docs/clay-web/Bool/) | If true, only detect overlaps without separation |
