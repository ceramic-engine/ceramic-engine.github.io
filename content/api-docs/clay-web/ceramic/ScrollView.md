...
<div class="type-hierarchy"><a href="/api-docs/clay-web/ceramic/Entity/">Entity</a> → <a href="/api-docs/clay-web/ceramic/Visual/">Visual</a> → <a href="/api-docs/clay-web/ceramic/Quad/">Quad</a> → <a href="/api-docs/clay-web/ceramic/Layer/">Layer</a> → <a href="/api-docs/clay-web/ceramic/View/">View</a> → <strong>ceramic.ScrollView</strong> (Class) → <a href="/api-docs/clay-web/ceramic/CollectionView/">CollectionView</a>, <a href="/api-docs/clay-web/ceramic/PagerView/">PagerView</a>, <a href="/api-docs/clay-web/elements/ScrollingLayout/">elements.ScrollingLayout</a></div>
