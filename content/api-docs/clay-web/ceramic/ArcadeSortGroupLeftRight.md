...
subCategory: doc
menu: Arcade
title: ArcadeSortGroupLeftRight
target: Clay (Web)
permalink: api-docs/clay-web/ceramic/ArcadeSortGroupLeftRight/
---
...
<div class="type-hierarchy"><strong>ceramic.ArcadeSortGroupLeftRight</strong> (Class)</div>
...
| Returns | Description |
|---------|-------------|
| [Int](/api-docs/clay-web/Int/) | 1 if a.body.x >= b.body.x, -1 otherwise, 0 if either has no body |
