...
title: TilemapParser
target: Clay (Web)
permalink: api-docs/clay-web/ceramic/TilemapParser/
---
...
<div class="see"><strong>See:</strong> <a href="/api-docs/clay-web/ceramic/TilemapData/">TilemapData</a>, <a href="/api-docs/clay-web/ceramic/TilemapTmxParser/">TilemapTmxParser</a>, <a href="/api-docs/clay-web/ceramic/TilemapLdtkParser/">TilemapLdtkParser</a></div>
...
|------|------|-------------|
| `rawLdtkData` | [String](/api-docs/clay-web/String/) | Raw LDtk data as string  |
| `loadExternalLdtkLevelData` | Function |  |

| Returns | Description |
|---------|-------------|
| [LdtkData](/api-docs/clay-web/ceramic/LdtkData/) | The LDtk parsed data |
...
| Name | Type | Default |
|------|------|---------|
| `ldtkData` | [LdtkData](/api-docs/clay-web/ceramic/LdtkData/) | |
| `loadTexture` | Function | *(optional)* |
| `skip` | [Array](/api-docs/clay-web/Array/)<[String](/api-docs/clay-web/String/)> | |
...
|------|------|---------|-------------|
| `rawTmxData` | [String](/api-docs/clay-web/String/) | | Raw TMX data as string  |
| `cwd` | [String](/api-docs/clay-web/String/) | *(optional)* | Current working directory. Needed to identify cached tileset relative to their tilemap  |
| `resolveTsxRawData` | Function | *(optional)* | A method to resolve TSX Tileset data that are not embedded in TMX data (optional)  |

| Returns | Description |
|---------|-------------|
| [format.tmx.TmxMap](/api-docs/clay-web/format/tmx/TmxMap/) | The TMX map data |
...
| Name | Type | Description |
|------|------|-------------|
| `rawTmxData` | [String](/api-docs/clay-web/String/) | The raw TMX XML data as a string  |

| Returns | Description |
|---------|-------------|
| [Array](/api-docs/clay-web/Array/)<[String](/api-docs/clay-web/String/)> | Array of external tileset filenames (relative paths as specified in TMX) |

<hr class="field-separator" />

<div class="signature field-method has-description has-plugin" id="tmxMapToTilemapData"><div class="plugin-name">tilemap</div><code><span class="field-name">tmxMapToTilemapData</span><span class="parenthesis">(</span><span class="arg-name">tmxMap</span><span class="operator">:</span> <a href="/api-docs/clay-web/format/tmx/TmxMap/" class="type-link">format.tmx.TmxMap</a><span class="operator">,</span> <span class="operator">?</span><span class="arg-name">loadTexture</span><span class="operator">:</span> <span class="type-name">Function</span><span class="parenthesis">)</span><span class="operator">:</span> <a href="/api-docs/clay-web/ceramic/TilemapData/" class="type-link">TilemapData</a></code><a class="header-anchor" href="#tmxMapToTilemapData"><span aria-hidden="true" class="header-anchor__symbol">#</span></a></div>
...
| Name | Type | Default | Description |
|------|------|---------|-------------|
| `tmxMap` | [format.tmx.TmxMap](/api-docs/clay-web/format/tmx/TmxMap/) | | The parsed TMX map data  |
...
| Returns | Description |
|---------|-------------|
| [TilemapData](/api-docs/clay-web/ceramic/TilemapData/) | A new TilemapData instance ready to be used with a Tilemap visual |
