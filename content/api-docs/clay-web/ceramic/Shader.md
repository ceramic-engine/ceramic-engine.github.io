...
title: Shader
target: Clay (Web)
permalink: api-docs/clay-web/ceramic/Shader/
---
...
<div class="type-hierarchy"><a href="/api-docs/clay-web/ceramic/Entity/">Entity</a> → <strong>ceramic.Shader</strong> (Class) → <a href="/api-docs/clay-web/shade/Shader/">shade.Shader</a>, <a href="/api-docs/clay-web/shade/Shader__shaders_Bloom_Vert__shaders_Bloom_Frag/">shade.Shader__shaders_Bloom_Vert__shaders_Bloom_Frag</a>, <a href="/api-docs/clay-web/shade/Shader__shaders_Blur_Vert__shaders_Blur_Frag/">shade.Shader__shaders_Blur_Vert__shaders_Blur_Frag</a>, <a href="/api-docs/clay-web/shade/Shader__shaders_Fxaa_Vert__shaders_Fxaa_Frag/">shade.Shader__shaders_Fxaa_Vert__shaders_Fxaa_Frag</a>, <a href="/api-docs/clay-web/shade/Shader__shaders_GaussianBlur_Vert__shaders_GaussianBlur_Frag/">shade.Shader__shaders_GaussianBlur_Vert__shaders_GaussianBlur_Frag</a>, <a href="/api-docs/clay-web/shade/Shader__shaders_Glow_Vert__shaders_Glow_Frag/">shade.Shader__shaders_Glow_Vert__shaders_Glow_Frag</a>, <a href="/api-docs/clay-web/shade/Shader__shaders_InnerLight_Vert__shaders_InnerLight_Frag/">shade.Shader__shaders_InnerLight_Vert__shaders_InnerLight_Frag</a>, <a href="/api-docs/clay-web/shade/Shader__shaders_Msdf_Vert__shaders_Msdf_Frag/">shade.Shader__shaders_Msdf_Vert__shaders_Msdf_Frag</a>, <a href="/api-docs/clay-web/shade/Shader__shaders_Outline_Vert__shaders_Outline_Frag/">shade.Shader__shaders_Outline_Vert__shaders_Outline_Frag</a>, <a href="/api-docs/clay-web/shade/Shader__shaders_PixelArt_Vert__shaders_PixelArt_Frag/">shade.Shader__shaders_PixelArt_Vert__shaders_PixelArt_Frag</a>, <a href="/api-docs/clay-web/shade/Shader__shaders_Textured_Vert__shaders_Textured_Frag/">shade.Shader__shaders_Textured_Vert__shaders_Textured_Frag</a>, <a href="/api-docs/clay-web/shade/Shader__shaders_TintBlack_Vert__shaders_TintBlack_Frag/">shade.Shader__shaders_TintBlack_Vert__shaders_TintBlack_Frag</a></div>
...
<div class="see"><strong>See:</strong> <a href="/api-docs/clay-web/ceramic/ShaderAsset/">ShaderAsset</a>, Visual.shader, <a href="/api-docs/clay-web/ceramic/ShaderAttribute/">ShaderAttribute</a></div>


## Instance Members

<div class="signature field-var has-description" id="backendItem"><code><span class="field-name">backendItem</span><span class="operator">:</span> <a href="/api-docs/clay-web/backend/Shader/" class="type-link">backend.Shader</a></code><a class="header-anchor" href="#backendItem"><span aria-hidden="true" class="header-anchor__symbol">#</span></a></div>
...
<div class="signature field-var has-description" id="asset"><code><span class="field-name">asset</span><span class="operator">:</span> <a href="/api-docs/clay-web/ceramic/ShaderAsset/" class="type-link">ShaderAsset</a></code><a class="header-anchor" href="#asset"><span aria-hidden="true" class="header-anchor__symbol">#</span></a></div>
...
| Returns | Description |
|---------|-------------|
| [Shader](/api-docs/clay-web/ceramic/Shader/) | A new shader instance with the same program but separate uniforms |
...
|------|------|-------------|
| `name` | [String](/api-docs/clay-web/String/) | The uniform variable name in the shader  |
| `value` | [Int](/api-docs/clay-web/Int/) | The integer value to set |
...
|------|------|-------------|
| `name` | [String](/api-docs/clay-web/String/) | The uniform variable name in the shader  |
| `x` | [Float](/api-docs/clay-web/Float/) | The x component  |
| `y` | [Float](/api-docs/clay-web/Float/) | The y component |
...
| `x` | [Float](/api-docs/clay-web/Float/) | The x component  |
| `y` | [Float](/api-docs/clay-web/Float/) | The y component  |
| `z` | [Float](/api-docs/clay-web/Float/) | The z component |
...
| `y` | [Float](/api-docs/clay-web/Float/) | The y component  |
| `z` | [Float](/api-docs/clay-web/Float/) | The z component  |
| `w` | [Float](/api-docs/clay-web/Float/) | The w component |
...
|------|------|-------------|
| `name` | [String](/api-docs/clay-web/String/) | The uniform variable name in the shader  |
| `array` | [Array](/api-docs/clay-web/Array/)<[Float](/api-docs/clay-web/Float/)> | The array of float values |
...
|------|------|---------|-------------|
| `name` | [String](/api-docs/clay-web/String/) | | The uniform sampler2D variable name in the shader  |
| `slot` | [Int](/api-docs/clay-web/Int/) | `-1` | The texture slot index (0-based)  |
| `texture` | [Texture](/api-docs/clay-web/ceramic/Texture/) | | The texture to bind, or null to unbind |
...
| Name | Type | Description |
|------|------|-------------|
| `name` | [String](/api-docs/clay-web/String/) | The uniform mat2 variable name in the shader  |
...
| Name | Type | Description |
|------|------|-------------|
| `name` | [String](/api-docs/clay-web/String/) | The uniform mat3 variable name in the shader  |
| `m00` | [Float](/api-docs/clay-web/Float/) | Column 0, row 0  |
| `m10` | [Float](/api-docs/clay-web/Float/) | Column 0, row 1  |
...
| Name | Type | Description |
|------|------|-------------|
| `name` | [String](/api-docs/clay-web/String/) | The uniform mat4 variable name in the shader  |
| `m00` | [Float](/api-docs/clay-web/Float/) | Column 0, row 0  |
| `m10` | [Float](/api-docs/clay-web/Float/) | Column 0, row 1  |
| `m20` | [Float](/api-docs/clay-web/Float/) | Column 0, row 2  |
...
| Name | Type | Description |
|------|------|-------------|
| `customAttributes` | [ReadOnlyArray](/api-docs/clay-web/ceramic/ReadOnlyArray/)<[ShaderAttribute](/api-docs/clay-web/ceramic/ShaderAttribute/)> | Optional additional vertex attributes |
| `baseAttributes` | [ReadOnlyArray](/api-docs/clay-web/ceramic/ReadOnlyArray/)<[ShaderAttribute](/api-docs/clay-web/ceramic/ShaderAttribute/)> |  |
| `textureIdAttribute` | [ShaderAttribute](/api-docs/clay-web/ceramic/ShaderAttribute/) |  |
...
| Name | Type | Description |
|------|------|-------------|
| `name` | [String](/api-docs/clay-web/String/) | The name of the texture uniform  |

| Returns | Description |
|---------|-------------|
| [Int](/api-docs/clay-web/Int/) | The slot or `-1` if not found. |
