...
<div class="type-hierarchy"><a href="/api-docs/clay-web/ceramic/Entity/">Entity</a> → <strong>ceramic.Shader</strong> (Class)</div>
...
| Returns | Description |
|---------|-------------|
| [Shader](/api-docs/clay-web/ceramic/Shader/) | New shader instance, or null if compilation fails |
...
|------|------|-------------|
| `name` | [String](/api-docs/clay-web/String/) | The uniform variable name in the shader  |
| `color` | [AlphaColor](/api-docs/clay-web/ceramic/AlphaColor/) | The color value with alpha |
...
| `slot` | [Int](/api-docs/clay-web/Int/) | The texture slot index (0-based)  |
...
| `transform` | [Transform](/api-docs/clay-web/ceramic/Transform/) | The transform to convert to matrix |
...
|------|------|---------|-------------|
| `backendItem` | [backend.Shader](/api-docs/clay-web/backend/Shader/) | | Backend-specific shader implementation  |
| `customAttributes` | [ReadOnlyArray](/api-docs/clay-web/ceramic/ReadOnlyArray/)<[ShaderAttribute](/api-docs/clay-web/ceramic/ShaderAttribute/)> | *(optional)* | Optional additional vertex attributes |
