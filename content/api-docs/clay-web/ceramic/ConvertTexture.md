...
target: Clay (Web)
permalink: api-docs/clay-web/ceramic/ConvertTexture/
---
...
<div class="see"><strong>See:</strong> <a href="/api-docs/clay-web/ceramic/ConvertField/">ConvertField</a>, <a href="/api-docs/clay-web/ceramic/Texture/">Texture</a>, <a href="/api-docs/clay-web/ceramic/ImageAsset/">ImageAsset</a>, <a href="/api-docs/clay-web/ceramic/Fragment/">Fragment</a></div>
...
|------|------|-------------|
| `instance` | [Entity](/api-docs/clay-web/ceramic/Entity/) | The entity that will use this texture  |
| `field` | [String](/api-docs/clay-web/String/) | The name of the field being converted  |
| `assets` | [Assets](/api-docs/clay-web/ceramic/Assets/) | Assets instance used to load the image  |
| `basic` | [String](/api-docs/clay-web/String/) | The image asset name to load  |
...
| Name | Type | Description |
|------|------|-------------|
| `instance` | [Entity](/api-docs/clay-web/ceramic/Entity/) | The entity that owns this texture  |
| `field` | [String](/api-docs/clay-web/String/) | The name of the field being converted  |
| `value` | [Texture](/api-docs/clay-web/ceramic/Texture/) | The Texture instance to convert  |

| Returns | Description |
|---------|-------------|
| [String](/api-docs/clay-web/String/) | The texture's asset name, or null if the texture or its asset is null |
