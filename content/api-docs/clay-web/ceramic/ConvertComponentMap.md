...
target: Clay (Web)
permalink: api-docs/clay-web/ceramic/ConvertComponentMap/
---
...
<div class="see"><strong>See:</strong> <a href="/api-docs/clay-web/ceramic/ConvertField/">ConvertField</a>, <a href="/api-docs/clay-web/ceramic/Component/">Component</a>, <a href="/api-docs/clay-web/ceramic/Fragment/">Fragment</a></div>
...
|------|------|-------------|
| `instance` | [Entity](/api-docs/clay-web/ceramic/Entity/) | The entity that will own these components  |
| `field` | [String](/api-docs/clay-web/String/) | The name of the field being converted  |
| `assets` | [Assets](/api-docs/clay-web/ceramic/Assets/) | Assets instance for resource loading (unused for components)  |
| `basic` | [haxe.DynamicAccess](/api-docs/clay-web/haxe/DynamicAccess/)<[String](/api-docs/clay-web/String/)> | Object mapping component names to initializer names  |
...
| Name | Type | Description |
|------|------|-------------|
| `instance` | [Entity](/api-docs/clay-web/ceramic/Entity/) | The entity that owns these components  |
| `field` | [String](/api-docs/clay-web/String/) | The name of the field being converted  |
| `value` | [Map](/api-docs/clay-web/Map/) | Map of component instances to serialize  |

| Returns | Description |
|---------|-------------|
| [haxe.DynamicAccess](/api-docs/clay-web/haxe/DynamicAccess/)<[String](/api-docs/clay-web/String/)> | Object mapping component names to initializer names |
