...
title: Click
target: Clay (Web)
permalink: api-docs/clay-web/ceramic/Click/
---
...
<div class="type-hierarchy"><a href="/api-docs/clay-web/ceramic/Entity/">Entity</a> → <strong>ceramic.Click</strong> (Class)</div>
...
| Name | Type |
|------|------|
| `instance` | [Click](/api-docs/clay-web/ceramic/Click/) |
