...
subCategory: doc
menu: Arcade
title: ArcadeSortGroupBottomTop
target: Clay (Web)
permalink: api-docs/clay-web/ceramic/ArcadeSortGroupBottomTop/
---
...
<div class="type-hierarchy"><strong>ceramic.ArcadeSortGroupBottomTop</strong> (Class)</div>
...
| Returns | Description |
|---------|-------------|
| [Int](/api-docs/clay-web/Int/) | 1 if b.body.y > a.body.y, -1 otherwise, 0 if either has no body |
