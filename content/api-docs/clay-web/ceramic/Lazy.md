...
title: Lazy
target: Clay (Web)
permalink: api-docs/clay-web/ceramic/Lazy/
---
...
<div class="type-hierarchy"><strong>ceramic.Lazy</strong> (Interface) → <a href="/api-docs/clay-web/ceramic/Entity/">Entity</a></div>
