...
target: Clay (Web)
permalink: api-docs/clay-web/ceramic/TimelineColorKeyframe/
---
...
<div class="type-hierarchy"><a href="/api-docs/clay-web/ceramic/TimelineKeyframe/">TimelineKeyframe</a> → <strong>ceramic.TimelineColorKeyframe</strong> (Class)</div>
...
<div class="see"><strong>See:</strong> <a href="/api-docs/clay-web/ceramic/TimelineColorTrack/">TimelineColorTrack</a>, <a href="/api-docs/clay-web/ceramic/TimelineKeyframe/">TimelineKeyframe</a>, <a href="/api-docs/clay-web/ceramic/Timeline/">Timeline</a>, <a href="/api-docs/clay-web/ceramic/Color/">Color</a></div>
...
|------|------|-------------|
| `value` | [Color](/api-docs/clay-web/ceramic/Color/) | The color value for this keyframe  |
| `index` | [Int](/api-docs/clay-web/Int/) | The frame index (time position) for this keyframe  |
