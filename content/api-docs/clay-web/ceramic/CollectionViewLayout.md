...
target: Clay (Web)
permalink: api-docs/clay-web/ceramic/CollectionViewLayout/
---
...
<div class="type-hierarchy"><strong>ceramic.CollectionViewLayout</strong> (Interface) → <a href="/api-docs/clay-web/ceramic/CollectionViewFlowLayout/">CollectionViewFlowLayout</a></div>
...
<div class="see"><strong>See:</strong> <a href="/api-docs/clay-web/ceramic/CollectionView/">CollectionView</a>, <a href="/api-docs/clay-web/ceramic/CollectionViewFlowLayout/">CollectionViewFlowLayout</a>, <a href="/api-docs/clay-web/ceramic/CollectionViewItemFrame/">CollectionViewItemFrame</a></div>
...
| `frames` | [ReadOnlyArray](/api-docs/clay-web/ceramic/ReadOnlyArray/)<[CollectionViewItemFrame](/api-docs/clay-web/ceramic/CollectionViewItemFrame/)> | Array of frames to position (modify x and y properties) |
...
| `frame` | [CollectionViewItemFrame](/api-docs/clay-web/ceramic/CollectionViewItemFrame/) | The frame to check for visibility  |

| Returns | Description |
|---------|-------------|
| [Bool](/api-docs/clay-web/Bool/) | true if the frame intersects the visible area |
