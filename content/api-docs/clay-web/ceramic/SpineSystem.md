...
title: SpineSystem
target: Clay (Web)
permalink: api-docs/clay-web/ceramic/SpineSystem/
---
...
<div class="type-hierarchy"><a href="/api-docs/clay-web/ceramic/Entity/">Entity</a> → <a href="/api-docs/clay-web/ceramic/System/">System</a> → <strong>ceramic.SpineSystem</strong> (Class)</div>
...
|------|------|-------------|
| `delta` | [Float](/api-docs/clay-web/Float/) | Time elapsed since the last frame in seconds |
