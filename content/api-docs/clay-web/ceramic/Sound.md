...
title: Sound
target: Clay (Web)
permalink: api-docs/clay-web/ceramic/Sound/
---
...
<div class="type-hierarchy"><a href="/api-docs/clay-web/ceramic/Entity/">Entity</a> → <strong>ceramic.Sound</strong> (Class)</div>
...
<div class="see"><strong>See:</strong> <a href="/api-docs/clay-web/ceramic/SoundPlayer/">SoundPlayer</a>, <a href="/api-docs/clay-web/ceramic/SoundAsset/">SoundAsset</a>, <a href="/api-docs/clay-web/ceramic/AudioMixer/">AudioMixer</a></div>
...
|------|------|-------------|
| `buffer` | [Float32Array](/api-docs/clay-web/ceramic/Float32Array/) | Float32Array containing the raw PCM samples  |
| `samples` | [Int](/api-docs/clay-web/Int/) | Number of sample frames (total samples divided by channel count)  |
...
| `interleaved` | [Bool](/api-docs/clay-web/Bool/) | Whether the PCM data is interleaved (LRLRLR...) or planar (LLL...RRR...)  |

| Returns | Description |
|---------|-------------|
| [Sound](/api-docs/clay-web/ceramic/Sound/) | A new Sound instance ready to be played |

## Instance Members

<div class="signature field-var has-description" id="backendItem"><code><span class="field-name">backendItem</span><span class="operator">:</span> <a href="/api-docs/clay-web/backend/AudioResource/" class="type-link">backend.AudioResource</a></code><a class="header-anchor" href="#backendItem"><span aria-hidden="true" class="header-anchor__symbol">#</span></a></div>

The backend audio resource containing the actual audio data.

<hr class="field-separator" />

<div class="signature field-var has-description" id="asset"><code><span class="field-name">asset</span><span class="operator">:</span> <a href="/api-docs/clay-web/ceramic/SoundAsset/" class="type-link">SoundAsset</a></code><a class="header-anchor" href="#asset"><span aria-hidden="true" class="header-anchor__symbol">#</span></a></div>
...
<div class="signature field-var has-description" id="group"><code><span class="field-name">group</span><span class="operator">:</span> <a href="/api-docs/clay-web/Int/" class="type-link">Int</a></code><a class="header-anchor" href="#group"><span aria-hidden="true" class="header-anchor__symbol">#</span></a></div>
...
<div class="signature field-var has-description" id="pan"><code><span class="field-name">pan</span><span class="operator">:</span> <a href="/api-docs/clay-web/Float/" class="type-link">Float</a></code><a class="header-anchor" href="#pan"><span aria-hidden="true" class="header-anchor__symbol">#</span></a></div>
...
|------|------|---------|-------------|
| `position` | [Float](/api-docs/clay-web/Float/) | `0` | Start position in seconds (0 = beginning)  |
| `loop` | [Bool](/api-docs/clay-web/Bool/) | `false` | Whether to loop the sound continuously  |
| `volume` | [Float](/api-docs/clay-web/Float/) | *(optional)* | Volume override (0-1, null = use default)  |
| `pan` | [Float](/api-docs/clay-web/Float/) | *(optional)* | Pan override (-1 to 1, null = use default)  |
| `pitch` | [Float](/api-docs/clay-web/Float/) | *(optional)* | Pitch override (1 = normal, null = use default)  |
| `bus` | [Int](/api-docs/clay-web/Int/) | *(optional)* | Bus to play on (null = use sound's default bus)  |

| Returns | Description |
|---------|-------------|
| [SoundPlayer](/api-docs/clay-web/ceramic/SoundPlayer/) | A SoundPlayer instance to control this specific playback |
...
| Name | Type | Description |
|------|------|-------------|
| `backendItem` | [backend.AudioResource](/api-docs/clay-web/backend/AudioResource/) | The backend audio resource |
