...
subCategory: doc
menu: Ceramic
title: IntMapKeyValueIterator
target: Clay (Web)
permalink: api-docs/clay-web/ceramic/IntMapKeyValueIterator/
---
...
<div class="type-hierarchy"><strong>ceramic.IntMapKeyValueIterator</strong> (Class)</div>
...
| Name | Type |
|------|------|
| `intMap` | [IntMap](/api-docs/clay-web/ceramic/IntMap/)<ceramic.IntMapKeyValueIterator.V> |
