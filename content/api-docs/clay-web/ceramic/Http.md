...
title: Http
target: Clay (Web)
permalink: api-docs/clay-web/ceramic/Http/
---
...
|------|------|-------------|
| `options` | [HttpRequestOptions](/api-docs/clay-web/ceramic/HttpRequestOptions/) | The HTTP request configuration including URL, method, headers, parameters, and timeout  |
