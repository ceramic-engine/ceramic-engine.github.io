...
target: Clay (Web)
permalink: api-docs/clay-web/ceramic/AppXUpdatesHandler/
---
...
<div class="signature field-var has-description" id="numUpdates"><code><span class="field-name">numUpdates</span><span class="operator">:</span> <a href="/api-docs/clay-web/Int/" class="type-link">Int</a></code><a class="header-anchor" href="#numUpdates"><span aria-hidden="true" class="header-anchor__symbol">#</span></a></div>
