...
title: RenderTexture
target: Clay (Web)
permalink: api-docs/clay-web/ceramic/RenderTexture/
---
...
<div class="type-hierarchy"><a href="/api-docs/clay-web/ceramic/Entity/">Entity</a> → <a href="/api-docs/clay-web/ceramic/Texture/">Texture</a> → <strong>ceramic.RenderTexture</strong> (Class)</div>
...
<div class="see"><strong>See:</strong> <a href="/api-docs/clay-web/ceramic/Texture/">Texture</a>, Visual.renderTarget, <a href="/api-docs/clay-web/ceramic/Filter/">Filter</a></div>
...
<div class="signature field-var has-description" id="clearOnRender"><code><span class="field-name">clearOnRender</span><span class="operator">:</span> <a href="/api-docs/clay-web/Bool/" class="type-link">Bool</a></code><a class="header-anchor" href="#clearOnRender"><span aria-hidden="true" class="header-anchor__symbol">#</span></a></div>
...
<div class="signature field-var has-description" id="renderDirty"><code><span class="field-name">renderDirty</span><span class="operator">:</span> <a href="/api-docs/clay-web/Bool/" class="type-link">Bool</a></code><a class="header-anchor" href="#renderDirty"><span aria-hidden="true" class="header-anchor__symbol">#</span></a></div>
...
<div class="signature field-var has-description" id="priority"><code><span class="field-name">priority</span><span class="operator">:</span> <a href="/api-docs/clay-web/Float/" class="type-link">Float</a></code><a class="header-anchor" href="#priority"><span aria-hidden="true" class="header-anchor__symbol">#</span></a></div>
...
|------|------|-------------|
| `visual` | [Visual](/api-docs/clay-web/ceramic/Visual/) | The visual to render onto this texture  |
...
|------|------|---------|-------------|
| `color` | [Color](/api-docs/clay-web/ceramic/Color/) | `0xFFFFFF` | Fill color (default: white)  |
| `alpha` | [Float](/api-docs/clay-web/Float/) | `0` | Fill alpha (default: 0 = transparent)  |
| `clipX` | [Float](/api-docs/clay-web/Float/) | `-1` | X position of area to clear (-1 = full texture)  |
| `clipY` | [Float](/api-docs/clay-web/Float/) | `-1` | Y position of area to clear (-1 = full texture)  |
| `clipWidth` | [Float](/api-docs/clay-web/Float/) | `-1` | Width of area to clear (-1 = full texture)  |
| `clipHeight` | [Float](/api-docs/clay-web/Float/) | `-1` | Height of area to clear (-1 = full texture)  |
...
| Name | Type | Default | Description |
|------|------|---------|-------------|
| `width` | [Float](/api-docs/clay-web/Float/) | | Width in logical pixels  |
| `height` | [Float](/api-docs/clay-web/Float/) | | Height in logical pixels  |
| `density` | [Float](/api-docs/clay-web/Float/) | `-1` | Pixel density multiplier (-1 = use screen density)  |
| `depth` | [Bool](/api-docs/clay-web/Bool/) | `true` | Enable depth buffer (default: true)  |
| `stencil` | [Bool](/api-docs/clay-web/Bool/) | `true` | Enable stencil buffer (default: true)  |
| `antialiasing` | [Int](/api-docs/clay-web/Int/) | `0` | Multisampling level (default: 0) |
