...
target: Clay (Web)
permalink: api-docs/clay-web/ceramic/_TilemapLdtkParser/TilemapLdtkParser_Fields_/
---
...
|------|------|-------------|
| `array` | [Array](/api-docs/clay-web/Array/)<allEqual.T> | The array to check  |
| `value` | allEqual.T | The value to compare against  |

| Returns | Description |
|---------|-------------|
| [Bool](/api-docs/clay-web/Bool/) | True if all elements equal the value |
