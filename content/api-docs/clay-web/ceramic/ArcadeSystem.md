...
title: ArcadeSystem
target: Clay (Web)
permalink: api-docs/clay-web/ceramic/ArcadeSystem/
---
...
<div class="type-hierarchy"><a href="/api-docs/clay-web/ceramic/Entity/">Entity</a> → <a href="/api-docs/clay-web/ceramic/System/">System</a> → <strong>ceramic.ArcadeSystem</strong> (Class)</div>
...
|------|------|---------|-------------|
| `autoAdd` | [Bool](/api-docs/clay-web/Bool/) | `true` | If true, automatically adds the world to the system's world list  |

| Returns | Description |
|---------|-------------|
| [ArcadeWorld](/api-docs/clay-web/ceramic/ArcadeWorld/) | The newly created ArcadeWorld |

<hr class="field-separator" />

<div class="signature field-method has-description has-plugin" id="addWorld"><div class="plugin-name">arcade</div><code><span class="field-name">addWorld</span><span class="parenthesis">(</span><span class="arg-name">world</span><span class="operator">:</span> <a href="/api-docs/clay-web/ceramic/ArcadeWorld/" class="type-link">ArcadeWorld</a><span class="parenthesis">)</span><span class="operator">:</span> <a href="/api-docs/clay-web/Void/" class="type-link">Void</a></code><a class="header-anchor" href="#addWorld"><span aria-hidden="true" class="header-anchor__symbol">#</span></a></div>
...
|------|------|-------------|
| `world` | [ArcadeWorld](/api-docs/clay-web/ceramic/ArcadeWorld/) | The ArcadeWorld to add |

<hr class="field-separator" />

<div class="signature field-method has-description has-plugin" id="removeWorld"><div class="plugin-name">arcade</div><code><span class="field-name">removeWorld</span><span class="parenthesis">(</span><span class="arg-name">world</span><span class="operator">:</span> <a href="/api-docs/clay-web/ceramic/ArcadeWorld/" class="type-link">ArcadeWorld</a><span class="parenthesis">)</span><span class="operator">:</span> <a href="/api-docs/clay-web/Void/" class="type-link">Void</a></code><a class="header-anchor" href="#removeWorld"><span aria-hidden="true" class="header-anchor__symbol">#</span></a></div>
...
| Name | Type | Description |
|------|------|-------------|
| `world` | [ArcadeWorld](/api-docs/clay-web/ceramic/ArcadeWorld/) | The ArcadeWorld to remove |
...
| Name | Type | Description |
|------|------|-------------|
| `world` | [ArcadeWorld](/api-docs/clay-web/ceramic/ArcadeWorld/) | The world to update  |
| `delta` | [Float](/api-docs/clay-web/Float/) | Time elapsed since last frame in seconds |
