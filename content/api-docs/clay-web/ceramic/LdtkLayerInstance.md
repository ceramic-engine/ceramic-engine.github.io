...
target: Clay (Web)
permalink: api-docs/clay-web/ceramic/LdtkLayerInstance/
---
...
| Name | Type | Default |
|------|------|---------|
| `level` | [LdtkLevel](/api-docs/clay-web/ceramic/LdtkLevel/) | *(optional)* |
