...
title: ValueEntry
target: Clay (Web)
permalink: api-docs/clay-web/ceramic/ValueEntry/
---
...
<div class="type-hierarchy"><a href="/api-docs/clay-web/ceramic/CollectionEntry/">CollectionEntry</a> → <strong>ceramic.ValueEntry</strong> (Class)</div>
...
<div class="see"><strong>See:</strong> <a href="/api-docs/clay-web/ceramic/CollectionEntry/">CollectionEntry</a>, <a href="/api-docs/clay-web/ceramic/Collection/">Collection</a></div>
...
| `id` | [String](/api-docs/clay-web/String/) | *(optional)* | Optional unique identifier for this entry in a collection  |
| `name` | [String](/api-docs/clay-web/String/) | *(optional)* | Optional human-readable name for this entry |
