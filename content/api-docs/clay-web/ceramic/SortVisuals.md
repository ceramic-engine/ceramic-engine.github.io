...
title: SortVisuals
target: Clay (Web)
permalink: api-docs/clay-web/ceramic/SortVisuals/
---
...
|------|------|-------------|
| `a` | [Array](/api-docs/clay-web/Array/)<[Visual](/api-docs/clay-web/ceramic/Visual/)> | The array of visuals to sort. Modified in place. If null, behavior is undefined. |
...
| Returns | Description |
|---------|-------------|
| [Int](/api-docs/clay-web/Int/) | -1 if a should render before b, 1 if b should render before a, 0 if equal |
