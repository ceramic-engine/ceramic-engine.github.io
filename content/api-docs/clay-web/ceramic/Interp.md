...
title: Interp
target: Clay (Web)
permalink: api-docs/clay-web/ceramic/Interp/
---
...
<div class="type-hierarchy"><a href="/api-docs/clay-web/hscript/Interp/">hscript.Interp</a> → <strong>ceramic.Interp</strong> (Class)</div>
...
|------|------|-------------|
| `owner` | [Script](/api-docs/clay-web/ceramic/Script/) | Script that owns this interpreter |

## Private Members

<div class="signature field-var has-description has-plugin" id="owner"><div class="plugin-name">script</div><code><span class="field-name">owner</span><span class="operator">:</span> <a href="/api-docs/clay-web/ceramic/Script/" class="type-link">Script</a></code><a class="header-anchor" href="#owner"><span aria-hidden="true" class="header-anchor__symbol">#</span></a></div>
...
| Name | Type | Description |
|------|------|-------------|
| `o` | [Dynamic](/api-docs/clay-web/Dynamic/) | Object to call method on  |
| `f` | [String](/api-docs/clay-web/String/) | Function name  |
| `args` | [Array](/api-docs/clay-web/Array/)<[Dynamic](/api-docs/clay-web/Dynamic/)> | Function arguments  |

| Returns | Description |
|---------|-------------|
| [Dynamic](/api-docs/clay-web/Dynamic/) | Function result |
...
| Name | Type | Description |
|------|------|-------------|
| `o` | [Dynamic](/api-docs/clay-web/Dynamic/) | Object to get field from  |
| `f` | [String](/api-docs/clay-web/String/) | Field name  |

| Returns | Description |
|---------|-------------|
| [Dynamic](/api-docs/clay-web/Dynamic/) | Field value |
...
| Name | Type | Description |
|------|------|-------------|
| `cl` | [String](/api-docs/clay-web/String/) | Class name  |
| `args` | [Array](/api-docs/clay-web/Array/)<[Dynamic](/api-docs/clay-web/Dynamic/)> | Constructor arguments  |

| Returns | Description |
|---------|-------------|
| [Dynamic](/api-docs/clay-web/Dynamic/) | New instance |
...
| Name | Type | Description |
|------|------|-------------|
| `e` | [hscript.Expr](/api-docs/clay-web/hscript/Expr/) | Expression to evaluate  |

| Returns | Description |
|---------|-------------|
| [Dynamic](/api-docs/clay-web/Dynamic/) | Expression result or null if error |
