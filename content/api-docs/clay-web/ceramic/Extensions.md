...
title: Extensions
target: Clay (Web)
permalink: api-docs/clay-web/ceramic/Extensions/
---
...
|------|------|-------------|
| `array` | [Array](/api-docs/clay-web/Array/)<unsafeGet.T> | The array to access  |
| `index` | [Int](/api-docs/clay-web/Int/) | The index to retrieve (must be 0 <= index < array.length)  |
...
| Name | Type | Description |
|------|------|-------------|
| `array` | [Array](/api-docs/clay-web/Array/)<setArrayLength.T> | The array to resize  |
| `length` | [Int](/api-docs/clay-web/Int/) | The new length (can be larger or smaller) * ```haxe var arr = [1, 2, 3, 4, 5]; arr.setArrayLength(3); // [1, 2, 3] arr.setArrayLength(5); // [1, 2, 3, null, null] ``` |
...
| Name | Type | Description |
|------|------|-------------|
| `array` | [Array](/api-docs/clay-web/Array/)<randomElement.T> | The array to select from  |
...
|------|------|---------|-------------|
| `array` | [Array](/api-docs/clay-web/Array/)<randomElementExcept.T> | | The array in which we extract the element from  |
| `except` | randomElementExcept.T | | The element we don't want  |
| `unsafe` | [Bool](/api-docs/clay-web/Bool/) | `false` | If set to `true`, will prevent allocating a new array (and may be faster) but will loop forever if there is no element except the one we don't want  |
...
| Name | Type | Description |
|------|------|-------------|
| `array` | [Array](/api-docs/clay-web/Array/)<randomElementMatchingValidator.T> | The array in which we extract the element from  |
...
| Name | Type | Description |
|------|------|-------------|
| `arr` | [Array](/api-docs/clay-web/Array/)<shuffle.T> | The array to shuffle (modified in place) * ```haxe var deck = [1, 2, 3, 4, 5]; deck.shuffle(); trace(deck); // e.g., [3, 1, 5, 2, 4] ``` * |

<hr class="field-separator" />

<div class="signature field-method no-description" id="swapElements"><code><span class="field-name">swapElements</span><span class="parenthesis">(</span><span class="arg-name">arr</span><span class="operator">:</span> <a href="/api-docs/clay-web/Array/" class="type-link">Array</a><span class="operator">&lt;</span><span class="type-name">swapElements.T</span><span class="operator">&gt;</span><span class="operator">,</span> <span class="arg-name">index0</span><span class="operator">:</span> <a href="/api-docs/clay-web/Int/" class="type-link">Int</a><span class="operator">,</span> <span class="arg-name">index1</span><span class="operator">:</span> <a href="/api-docs/clay-web/Int/" class="type-link">Int</a><span class="parenthesis">)</span><span class="operator">:</span> <a href="/api-docs/clay-web/Void/" class="type-link">Void</a></code><a class="header-anchor" href="#swapElements"><span aria-hidden="true" class="header-anchor__symbol">#</span></a></div>


| Name | Type |
|------|------|
| `arr` | [Array](/api-docs/clay-web/Array/)<swapElements.T> |
| `index0` | [Int](/api-docs/clay-web/Int/) |
| `index1` | [Int](/api-docs/clay-web/Int/) |

<hr class="field-separator" />

<div class="signature field-method no-description" id="removeNullElements"><code><span class="field-name">removeNullElements</span><span class="parenthesis">(</span><span class="arg-name">arr</span><span class="operator">:</span> <a href="/api-docs/clay-web/Array/" class="type-link">Array</a><span class="operator">&lt;</span><span class="type-name">removeNullElements.T</span><span class="operator">&gt;</span><span class="parenthesis">)</span><span class="operator">:</span> <a href="/api-docs/clay-web/Void/" class="type-link">Void</a></code><a class="header-anchor" href="#removeNullElements"><span aria-hidden="true" class="header-anchor__symbol">#</span></a></div>


| Name | Type |
|------|------|
| `arr` | [Array](/api-docs/clay-web/Array/)<removeNullElements.T> |
