...
title: AudioMixer
target: Clay (Web)
permalink: api-docs/clay-web/ceramic/AudioMixer/
---
...
<div class="type-hierarchy"><a href="/api-docs/clay-web/ceramic/Entity/">Entity</a> → <strong>ceramic.AudioMixer</strong> (Class)</div>
...
<div class="see"><strong>See:</strong> <a href="/api-docs/clay-web/ceramic/Audio/">Audio</a>, <a href="/api-docs/clay-web/ceramic/Sound/">Sound</a></div>
...
<div class="signature field-var has-description" id="mute"><code><span class="field-name">mute</span><span class="operator">:</span> <a href="/api-docs/clay-web/Bool/" class="type-link">Bool</a></code><a class="header-anchor" href="#mute"><span aria-hidden="true" class="header-anchor__symbol">#</span></a></div>
...
|------|------|-------------|
| `index` | [Int](/api-docs/clay-web/Int/) | The group index for this mixer |
