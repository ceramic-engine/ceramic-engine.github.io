...
target: Clay (Web)
permalink: api-docs/clay-web/ceramic/ConvertSpineData/
---
...
<div class="see"><strong>See:</strong> <a href="/api-docs/clay-web/ceramic/SpineData/">SpineData</a>, <a href="/api-docs/clay-web/ceramic/SpineAsset/">SpineAsset</a>, <a href="/api-docs/clay-web/ceramic/ConvertField/">ConvertField</a></div>
...
|------|------|-------------|
| `instance` | [Entity](/api-docs/clay-web/ceramic/Entity/) | The entity instance that owns the field  |
| `field` | [String](/api-docs/clay-web/String/) | The name of the field being converted  |
| `assets` | [Assets](/api-docs/clay-web/ceramic/Assets/) | The asset manager used to load the Spine asset  |
| `basic` | [String](/api-docs/clay-web/String/) | The string value (asset name) to convert from  |
...
| `instance` | [Entity](/api-docs/clay-web/ceramic/Entity/) | The entity instance that owns the field  |
| `field` | [String](/api-docs/clay-web/String/) | The name of the field being converted  |
| `value` | [SpineData](/api-docs/clay-web/ceramic/SpineData/) | The SpineData value to convert  |

| Returns | Description |
|---------|-------------|
| [String](/api-docs/clay-web/String/) | The asset name string, or null if the SpineData has no associated asset |
