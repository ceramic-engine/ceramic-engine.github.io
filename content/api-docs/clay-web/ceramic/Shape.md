...
title: Shape
target: Clay (Web)
permalink: api-docs/clay-web/ceramic/Shape/
---
...
<div class="type-hierarchy"><a href="/api-docs/clay-web/ceramic/Entity/">Entity</a> → <a href="/api-docs/clay-web/ceramic/Visual/">Visual</a> → <a href="/api-docs/clay-web/ceramic/Mesh/">Mesh</a> → <strong>ceramic.Shape</strong> (Class) → <a href="/api-docs/clay-web/ceramic/RoundedRect/">RoundedRect</a></div>
...
<div class="see"><strong>See:</strong> <a href="/api-docs/clay-web/ceramic/Mesh/">Mesh</a>, <a href="/api-docs/clay-web/ceramic/Triangulate/">Triangulate</a></div>
...
| `space` | [nape.space.Space](/api-docs/clay-web/nape/space/Space/) | *(optional)* | Nape physics space (uses default if not provided)  |
| `shape` | [nape.shape.Shape](/api-docs/clay-web/nape/shape/Shape/) | *(optional)* | Custom collision shape (auto-generated from points if null)  |
| `shapes` | [Array](/api-docs/clay-web/Array/)<[nape.shape.Shape](/api-docs/clay-web/nape/shape/Shape/)> | *(optional)* | Array of collision shapes for complex bodies  |
| `material` | [nape.phys.Material](/api-docs/clay-web/nape/phys/Material/) | *(optional)* | Physics material defining friction, elasticity, etc.  |

| Returns | Description |
|---------|-------------|
| [VisualNapePhysics](/api-docs/clay-web/ceramic/VisualNapePhysics/) | VisualNapePhysics component for further configuration |
