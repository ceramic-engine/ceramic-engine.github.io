...
title: Preloadable
target: Clay (Web)
permalink: api-docs/clay-web/ceramic/Preloadable/
---
...
<div class="type-hierarchy"><strong>ceramic.Preloadable</strong> (Interface) → <a href="/api-docs/clay-web/ceramic/Scene/">Scene</a></div>
...
<div class="see"><strong>See:</strong> <a href="/api-docs/clay-web/ceramic/Preloader/">Preloader</a>, <a href="/api-docs/clay-web/ceramic/PreloadStatus/">PreloadStatus</a></div>


## Instance Members

<div class="signature field-method has-description" id="requestPreloadUpdate"><code><span class="field-name">requestPreloadUpdate</span><span class="parenthesis">(</span><span class="arg-name">updatePreload</span><span class="operator">:</span> <span class="type-name">Function</span><span class="parenthesis">)</span><span class="operator">:</span> <a href="/api-docs/clay-web/Void/" class="type-link">Void</a></code><a class="header-anchor" href="#requestPreloadUpdate"><span aria-hidden="true" class="header-anchor__symbol">#</span></a></div>
