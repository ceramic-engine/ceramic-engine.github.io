...
target: Clay (Web)
permalink: api-docs/clay-web/ceramic/SpriteSheetFrame/
---
...
<div class="type-hierarchy"><a href="/api-docs/clay-web/ceramic/Entity/">Entity</a> → <a href="/api-docs/clay-web/tracker/Model/">tracker.Model</a> → <strong>ceramic.SpriteSheetFrame</strong> (Class)</div>
...
|------|------|---------|-------------|
| `atlas` | [TextureAtlas](/api-docs/clay-web/ceramic/TextureAtlas/) | | The texture atlas containing the frame  |
| `name` | [String](/api-docs/clay-web/String/) | | Unique name for the texture region  |
| `page` | [Int](/api-docs/clay-web/Int/) | `0` | Atlas page index (default: 0)  |
| `region` | [TextureAtlasRegion](/api-docs/clay-web/ceramic/TextureAtlasRegion/) | *(optional)* | Optional pre-existing region to use |
...
<div class="signature field-var no-description has-plugin" id="unobservedRegion"><div class="plugin-name">sprite</div><code><span class="field-name">unobservedRegion</span><span class="operator">:</span> <a href="/api-docs/clay-web/ceramic/TextureAtlasRegion/" class="type-link">TextureAtlasRegion</a></code><a class="header-anchor" href="#unobservedRegion"><span aria-hidden="true" class="header-anchor__symbol">#</span></a></div>
