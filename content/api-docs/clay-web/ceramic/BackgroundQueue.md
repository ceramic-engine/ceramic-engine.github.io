...
target: Clay (Web)
permalink: api-docs/clay-web/ceramic/BackgroundQueue/
---
...
<div class="type-hierarchy"><a href="/api-docs/clay-web/ceramic/Entity/">Entity</a> → <strong>ceramic.BackgroundQueue</strong> (Class)</div>
...
|------|------|---------|-------------|
| `checkInterval` | [Float](/api-docs/clay-web/Float/) | `0.1` | Time in seconds between queue checks (default: 0.1) |
