...
title: Assert
target: Clay (Web)
permalink: api-docs/clay-web/ceramic/Assert/
---
...
|------|------|---------|-------------|
| `expr` | [Dynamic](/api-docs/clay-web/Dynamic/) | | The expression to evaluate. Must resolve to a boolean value.  |
| `reason` | [String](/api-docs/clay-web/String/) | *(optional)* | Optional custom error message to include when assertion fails. If not provided, defaults to "Assertion failure". * |
