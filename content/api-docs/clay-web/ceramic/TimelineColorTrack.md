...
target: Clay (Web)
permalink: api-docs/clay-web/ceramic/TimelineColorTrack/
---
...
<div class="type-hierarchy"><a href="/api-docs/clay-web/ceramic/Entity/">Entity</a> → <a href="/api-docs/clay-web/ceramic/TimelineTrack/">TimelineTrack</a> → <strong>ceramic.TimelineColorTrack</strong> (Class)</div>
...
<div class="see"><strong>See:</strong> <a href="/api-docs/clay-web/ceramic/TimelineColorKeyframe/">TimelineColorKeyframe</a>, <a href="/api-docs/clay-web/ceramic/TimelineTrack/">TimelineTrack</a>, <a href="/api-docs/clay-web/ceramic/Timeline/">Timeline</a>, <a href="/api-docs/clay-web/ceramic/Color/">Color</a></div>


## Instance Members

<div class="signature field-var has-description" id="value"><code><span class="field-name">value</span><span class="operator">:</span> <a href="/api-docs/clay-web/ceramic/Color/" class="type-link">Color</a></code><a class="header-anchor" href="#value"><span aria-hidden="true" class="header-anchor__symbol">#</span></a></div>
...
|------|------|---------|-------------|
| `forceChange` | [Bool](/api-docs/clay-web/Bool/) | `false` | If true, triggers the change event even if color hasn't changed |
...
|------|------|-------------|
| `track` | [TimelineColorTrack](/api-docs/clay-web/ceramic/TimelineColorTrack/) | This track instance (for convenience in handlers) |
