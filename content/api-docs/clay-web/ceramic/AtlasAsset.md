...
title: AtlasAsset
target: Clay (Web)
permalink: api-docs/clay-web/ceramic/AtlasAsset/
---
...
|------|------|-------------|
| `newAtlas` | [TextureAtlas](/api-docs/clay-web/ceramic/TextureAtlas/) | The newly loaded atlas  |
| `prevAtlas` | [TextureAtlas](/api-docs/clay-web/ceramic/TextureAtlas/) | The previous atlas that was replaced |
