...
target: Clay (Web)
permalink: api-docs/clay-web/ceramic/ConvertTilemapData/
---
...
|------|------|-------------|
| `instance` | [Entity](/api-docs/clay-web/ceramic/Entity/) | The entity that owns the field being converted  |
...
| `basic` | [String](/api-docs/clay-web/String/) | The tilemap asset name to load  |
...
| `instance` | [Entity](/api-docs/clay-web/ceramic/Entity/) | The entity that owns the field being converted  |
| `field` | [String](/api-docs/clay-web/String/) | The name of the field being converted  |
| `value` | [TilemapData](/api-docs/clay-web/ceramic/TilemapData/) | The TilemapData instance to convert  |

| Returns | Description |
|---------|-------------|
| [String](/api-docs/clay-web/String/) | The asset name string, or null if the data has no associated asset |
