...
target: Clay (Web)
permalink: api-docs/clay-web/ceramic/VisualNapePhysics/
---
...
<div class="type-hierarchy"><a href="/api-docs/clay-web/ceramic/Entity/">Entity</a> → <strong>ceramic.VisualNapePhysics</strong> (Class)</div>
...
<div class="signature field-var has-description has-plugin" id="body"><div class="plugin-name">nape</div><code><span class="field-name">body</span><span class="operator">:</span> <a href="/api-docs/clay-web/nape/phys/Body/" class="type-link">nape.phys.Body</a></code><a class="header-anchor" href="#body"><span aria-hidden="true" class="header-anchor__symbol">#</span></a></div>
...
| `shape` | [nape.shape.Shape](/api-docs/clay-web/nape/shape/Shape/) | *(optional)* | Optional single shape for the body  |
| `shapes` | [Array](/api-docs/clay-web/Array/)<[nape.shape.Shape](/api-docs/clay-web/nape/shape/Shape/)> | *(optional)* | Optional array of shapes for compound bodies  |
...
| `x` | [Float](/api-docs/clay-web/Float/) | | Initial X position (center)  |
| `y` | [Float](/api-docs/clay-web/Float/) | | Initial Y position (center)  |
| `width` | [Float](/api-docs/clay-web/Float/) | | Width for default box shape  |
| `height` | [Float](/api-docs/clay-web/Float/) | | Height for default box shape  |
