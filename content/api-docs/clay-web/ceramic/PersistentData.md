...
target: Clay (Web)
permalink: api-docs/clay-web/ceramic/PersistentData/
---
...
|------|------|-------------|
| `key` | [String](/api-docs/clay-web/String/) | The key to look up  |

| Returns | Description |
|---------|-------------|
| [Dynamic](/api-docs/clay-web/Dynamic/) | The stored value, or null if the key doesn't exist |
...
| Name | Type | Description |
|------|------|-------------|
| `key` | [String](/api-docs/clay-web/String/) | The key to store the value under  |
| `value` | [Dynamic](/api-docs/clay-web/Dynamic/) | The value to store (must be serializable) |
...
| Name | Type | Description |
|------|------|-------------|
| `key` | [String](/api-docs/clay-web/String/) | The key to remove |
...
| Name | Type | Description |
|------|------|-------------|
| `key` | [String](/api-docs/clay-web/String/) | The key to check  |

| Returns | Description |
|---------|-------------|
| [Bool](/api-docs/clay-web/Bool/) | True if the key exists, false otherwise |
...
| Returns | Description |
|---------|-------------|
| [Array](/api-docs/clay-web/Array/)<[String](/api-docs/clay-web/String/)> | Array of all keys currently in storage |

<hr class="field-separator" />

<div class="signature field-method has-description" id="save"><code><span class="field-name">save</span><span class="parenthesis">(</span><span class="parenthesis">)</span><span class="operator">:</span> <a href="/api-docs/clay-web/Void/" class="type-link">Void</a></code><a class="header-anchor" href="#save"><span aria-hidden="true" class="header-anchor__symbol">#</span></a></div>
...
| Name | Type | Description |
|------|------|-------------|
| `id` | [String](/api-docs/clay-web/String/) | Unique identifier for this storage. Used as part of the filename (stored as "persistent_[id]"). Should contain only filename-safe characters. |
