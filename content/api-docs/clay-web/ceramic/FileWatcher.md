...
title: FileWatcher
target: Clay (Web)
permalink: api-docs/clay-web/ceramic/FileWatcher/
---
...
<div class="type-hierarchy"><a href="/api-docs/clay-web/ceramic/Entity/">Entity</a> → <strong>ceramic.FileWatcher</strong> (Class)</div>
...
| Returns | Description |
|---------|-------------|
| [Bool](/api-docs/clay-web/Bool/) | True if the platform supports file watching, false otherwise |
...
|------|------|-------------|
| `path` | [String](/api-docs/clay-web/String/) | The file path to watch  |
...
| Returns | Description |
|---------|-------------|
| [Bool](/api-docs/clay-web/Bool/) | True if the path is a file, false otherwise |
...
| Name | Type | Description |
|------|------|-------------|
| `path` | [String](/api-docs/clay-web/String/) | The file path  |

| Returns | Description |
|---------|-------------|
| [Float](/api-docs/clay-web/Float/) | Modification time in milliseconds since epoch, or -1 if unavailable |
...
| Returns | Description |
|---------|-------------|
| [String](/api-docs/clay-web/String/) | The file content, or null if unavailable |
