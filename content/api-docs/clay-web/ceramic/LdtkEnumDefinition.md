...
target: Clay (Web)
permalink: api-docs/clay-web/ceramic/LdtkEnumDefinition/
---
...
| Returns |
|---------|
| [LdtkEnumValueDefinition](/api-docs/clay-web/ceramic/LdtkEnumValueDefinition/) |
