...
title: LdtkEnumTag
target: Clay (Web)
permalink: api-docs/clay-web/ceramic/LdtkEnumTag/
---
...
<div class="signature field-var no-description has-plugin" id="enumValueId"><div class="plugin-name">ldtk</div><code><span class="field-name">enumValueId</span><span class="operator">:</span> <a href="/api-docs/clay-web/String/" class="type-link">String</a></code><a class="header-anchor" href="#enumValueId"><span aria-hidden="true" class="header-anchor__symbol">#</span></a></div>
