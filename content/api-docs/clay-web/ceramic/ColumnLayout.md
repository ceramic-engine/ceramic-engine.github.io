...
title: ColumnLayout
target: Clay (Web)
permalink: api-docs/clay-web/ceramic/ColumnLayout/
---
...
<div class="type-hierarchy"><a href="/api-docs/clay-web/ceramic/Entity/">Entity</a> → <a href="/api-docs/clay-web/ceramic/Visual/">Visual</a> → <a href="/api-docs/clay-web/ceramic/Quad/">Quad</a> → <a href="/api-docs/clay-web/ceramic/Layer/">Layer</a> → <a href="/api-docs/clay-web/ceramic/View/">View</a> → <a href="/api-docs/clay-web/ceramic/LinearLayout/">LinearLayout</a> → <strong>ceramic.ColumnLayout</strong> (Class) → <a href="/api-docs/clay-web/elements/FormLayout/">elements.FormLayout</a>, <a href="/api-docs/clay-web/elements/Window/">elements.Window</a></div>
