...
title: TilesetImage
target: Clay (Web)
permalink: api-docs/clay-web/ceramic/TilesetImage/
---
...
<div class="type-hierarchy"><a href="/api-docs/clay-web/ceramic/Entity/">Entity</a> → <a href="/api-docs/clay-web/tracker/Model/">tracker.Model</a> → <strong>ceramic.TilesetImage</strong> (Class)</div>
...
<div class="see"><strong>See:</strong> <a href="/api-docs/clay-web/ceramic/Tileset/">Tileset</a>, <a href="/api-docs/clay-web/ceramic/Texture/">Texture</a></div>
...
|------|------|-------------|
| `newTexture` | [Texture](/api-docs/clay-web/ceramic/Texture/) | The new texture instance  |
