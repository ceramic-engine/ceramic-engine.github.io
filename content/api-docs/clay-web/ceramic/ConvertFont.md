...
title: ConvertFont
target: Clay (Web)
permalink: api-docs/clay-web/ceramic/ConvertFont/
---
...
<div class="see"><strong>See:</strong> <a href="/api-docs/clay-web/ceramic/ConvertField/">ConvertField</a>, <a href="/api-docs/clay-web/ceramic/BitmapFont/">BitmapFont</a>, <a href="/api-docs/clay-web/ceramic/FontAsset/">FontAsset</a>, <a href="/api-docs/clay-web/ceramic/Fragment/">Fragment</a></div>
...
| Name | Type | Description |
|------|------|-------------|
| `instance` | [Entity](/api-docs/clay-web/ceramic/Entity/) | The entity that owns this font  |
| `field` | [String](/api-docs/clay-web/String/) | The name of the field being converted  |
| `value` | [BitmapFont](/api-docs/clay-web/ceramic/BitmapFont/) | The BitmapFont instance to convert  |

| Returns | Description |
|---------|-------------|
| [String](/api-docs/clay-web/String/) | The font's asset name, or null if the font or its asset is null |
