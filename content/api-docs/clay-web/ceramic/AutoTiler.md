...
title: AutoTiler
target: Clay (Web)
permalink: api-docs/clay-web/ceramic/AutoTiler/
---
...
<div class="type-hierarchy"><a href="/api-docs/clay-web/ceramic/Entity/">Entity</a> → <strong>ceramic.AutoTiler</strong> (Class)</div>
...
|------|------|-------------|
| `value` | [Int](/api-docs/clay-web/Int/) | 8-bit value encoding edges (bits 0-3) and corners (bits 4-7)  |

| Returns | Description |
|---------|-------------|
| [Bool](/api-docs/clay-web/Bool/) | true if the combination is valid, false otherwise |
...
|------|------|---------|-------------|
| `autoTiles` | [Array](/api-docs/clay-web/Array/)<[AutoTile](/api-docs/clay-web/ceramic/AutoTile/)> | | Array of auto-tile rules to apply  |
...
| Name | Type | Description |
|------|------|-------------|
| `autoTiler` | [AutoTiler](/api-docs/clay-web/ceramic/AutoTiler/) | This AutoTiler instance  |
| `autoTile` | [AutoTile](/api-docs/clay-web/ceramic/AutoTile/) | The auto-tile rule that was applied  |
| `computedTiles` | [Array](/api-docs/clay-web/Array/)<[TilemapTile](/api-docs/clay-web/ceramic/TilemapTile/)> | The array of computed tiles being built  |
| `index` | [Int](/api-docs/clay-web/Int/) | The index of the tile that was just computed |

<hr class="field-separator" />

<div class="signature field-method has-description has-plugin" id="emitComputeTiles"><div class="plugin-name">tilemap</div><code><span class="field-name">emitComputeTiles</span><span class="parenthesis">(</span><span class="arg-name">autoTiler</span><span class="operator">:</span> <a href="#" class="type-link">AutoTiler</a><span class="operator">,</span> <span class="arg-name">computedTiles</span><span class="operator">:</span> <a href="/api-docs/clay-web/Array/" class="type-link">Array</a><span class="operator">&lt;</span><a href="/api-docs/clay-web/ceramic/TilemapTile/" class="type-link">TilemapTile</a><span class="operator">&gt;</span><span class="parenthesis">)</span><span class="operator">:</span> <a href="/api-docs/clay-web/Void/" class="type-link">Void</a></code><a class="header-anchor" href="#emitComputeTiles"><span aria-hidden="true" class="header-anchor__symbol">#</span></a></div>
...
|------|------|-------------|
| `autoTiler` | [AutoTiler](/api-docs/clay-web/ceramic/AutoTiler/) | This AutoTiler instance  |
| `computedTiles` | [Array](/api-docs/clay-web/Array/)<[TilemapTile](/api-docs/clay-web/ceramic/TilemapTile/)> | The complete array of computed tiles |
...
| Name | Type | Description |
|------|------|-------------|
| `tiles` | [ReadOnlyArray](/api-docs/clay-web/ceramic/ReadOnlyArray/)<[TilemapTile](/api-docs/clay-web/ceramic/TilemapTile/)> | The new tile array  |
| `prevTiles` | [ReadOnlyArray](/api-docs/clay-web/ceramic/ReadOnlyArray/)<[TilemapTile](/api-docs/clay-web/ceramic/TilemapTile/)> | The previous tile array (before the change) |

<hr class="field-separator" />

<div class="signature field-method has-description has-plugin" id="computeAutoTiles"><div class="plugin-name">tilemap</div><code><span class="field-name">computeAutoTiles</span><span class="parenthesis">(</span><span class="arg-name">tiles</span><span class="operator">:</span> <a href="/api-docs/clay-web/ceramic/ReadOnlyArray/" class="type-link">ReadOnlyArray</a><span class="operator">&lt;</span><a href="/api-docs/clay-web/ceramic/TilemapTile/" class="type-link">TilemapTile</a><span class="operator">&gt;</span><span class="parenthesis">)</span><span class="operator">:</span> <a href="/api-docs/clay-web/Void/" class="type-link">Void</a></code><a class="header-anchor" href="#computeAutoTiles"><span aria-hidden="true" class="header-anchor__symbol">#</span></a></div>
...
| Name | Type | Description |
|------|------|-------------|
| `tiles` | [ReadOnlyArray](/api-docs/clay-web/ceramic/ReadOnlyArray/)<[TilemapTile](/api-docs/clay-web/ceramic/TilemapTile/)> | The source tile array to process |
