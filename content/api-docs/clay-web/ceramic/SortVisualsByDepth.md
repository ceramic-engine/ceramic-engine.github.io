...
target: Clay (Web)
permalink: api-docs/clay-web/ceramic/SortVisualsByDepth/
---
...
|------|------|-------------|
| `a` | [Array](/api-docs/clay-web/Array/)<[Visual](/api-docs/clay-web/ceramic/Visual/)> | The array of visuals to sort by depth. Modified in place. If null, behavior is undefined. |
...
| Returns | Description |
|---------|-------------|
| [Int](/api-docs/clay-web/Int/) | -1 if a has lower depth, 1 if a has higher depth, 0 if equal |
