...
target: Clay (Web)
permalink: api-docs/clay-web/ceramic/KeyAcceleratorItem/
---
...
<div class="see"><strong>See:</strong> <a href="/api-docs/clay-web/ceramic/KeyBinding/">KeyBinding</a>, <a href="/api-docs/clay-web/ceramic/KeyBindings/">KeyBindings</a></div>
...
|------|------|-------------|
| `scanCode` | [ceramic.ScanCode](/api-docs/clay-web/ceramic/ScanCode/) | The scan code of the key |
...
| Name | Type | Description |
|------|------|-------------|
| `keyCode` | [ceramic.KeyCode](/api-docs/clay-web/ceramic/KeyCode/) | The key code of the key |
