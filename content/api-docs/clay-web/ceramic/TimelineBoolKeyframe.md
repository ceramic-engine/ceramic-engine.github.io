...
target: Clay (Web)
permalink: api-docs/clay-web/ceramic/TimelineBoolKeyframe/
---
...
<div class="type-hierarchy"><a href="/api-docs/clay-web/ceramic/TimelineKeyframe/">TimelineKeyframe</a> → <strong>ceramic.TimelineBoolKeyframe</strong> (Class)</div>
...
<div class="see"><strong>See:</strong> <a href="/api-docs/clay-web/ceramic/TimelineBoolTrack/">TimelineBoolTrack</a>, <a href="/api-docs/clay-web/ceramic/TimelineKeyframe/">TimelineKeyframe</a>, <a href="/api-docs/clay-web/ceramic/Timeline/">Timeline</a></div>
...
|------|------|-------------|
| `value` | [Bool](/api-docs/clay-web/Bool/) | The boolean value for this keyframe  |
