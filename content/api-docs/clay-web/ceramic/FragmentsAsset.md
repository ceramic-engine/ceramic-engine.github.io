...
target: Clay (Web)
permalink: api-docs/clay-web/ceramic/FragmentsAsset/
---
...
|------|------|-------------|
| `rawFragments` | [Dynamic](/api-docs/clay-web/Dynamic/) | The raw parsed JSON data with version field  |

| Returns | Description |
|---------|-------------|
| [haxe.DynamicAccess](/api-docs/clay-web/haxe/DynamicAccess/)<[FragmentData](/api-docs/clay-web/ceramic/FragmentData/)> | Map of fragment IDs to FragmentData objects |
...
| Name | Type |
|------|------|
| `current` | [haxe.DynamicAccess](/api-docs/clay-web/haxe/DynamicAccess/)<[FragmentData](/api-docs/clay-web/ceramic/FragmentData/)> |
| `previous` | [haxe.DynamicAccess](/api-docs/clay-web/haxe/DynamicAccess/)<[FragmentData](/api-docs/clay-web/ceramic/FragmentData/)> |
