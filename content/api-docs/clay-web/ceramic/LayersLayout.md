...
title: LayersLayout
target: Clay (Web)
permalink: api-docs/clay-web/ceramic/LayersLayout/
---
...
<div class="type-hierarchy"><a href="/api-docs/clay-web/ceramic/Entity/">Entity</a> → <a href="/api-docs/clay-web/ceramic/Visual/">Visual</a> → <a href="/api-docs/clay-web/ceramic/Quad/">Quad</a> → <a href="/api-docs/clay-web/ceramic/Layer/">Layer</a> → <a href="/api-docs/clay-web/ceramic/View/">View</a> → <strong>ceramic.LayersLayout</strong> (Class) → <a href="/api-docs/clay-web/elements/CellView/">elements.CellView</a>, <a href="/api-docs/clay-web/elements/ColorPickerView/">elements.ColorPickerView</a></div>
...
<div class="see"><strong>See:</strong> <a href="/api-docs/clay-web/ceramic/View/">View</a>, LinearLayout for sequential layouts</div>
