...
title: Line
target: Clay (Web)
permalink: api-docs/clay-web/ceramic/Line/
---
...
<div class="type-hierarchy"><a href="/api-docs/clay-web/ceramic/Entity/">Entity</a> → <a href="/api-docs/clay-web/ceramic/Visual/">Visual</a> → <a href="/api-docs/clay-web/ceramic/Mesh/">Mesh</a> → <strong>ceramic.Line</strong> (Class)</div>
...
<div class="see"><strong>See:</strong> <a href="/api-docs/clay-web/ceramic/Mesh/">Mesh</a>, <a href="/api-docs/clay-web/ceramic/LineJoin/">LineJoin</a>, <a href="/api-docs/clay-web/ceramic/LineCap/">LineCap</a></div>
...
<div class="signature field-var has-description" id="join"><code><span class="field-name">join</span><span class="operator">:</span> <a href="/api-docs/clay-web/ceramic/LineJoin/" class="type-link">LineJoin</a></code><a class="header-anchor" href="#join"><span aria-hidden="true" class="header-anchor__symbol">#</span></a></div>
...
<div class="signature field-var has-description" id="cap"><code><span class="field-name">cap</span><span class="operator">:</span> <a href="/api-docs/clay-web/ceramic/LineCap/" class="type-link">LineCap</a></code><a class="header-anchor" href="#cap"><span aria-hidden="true" class="header-anchor__symbol">#</span></a></div>
...
<div class="signature field-var has-description" id="autoComputeSize"><code><span class="field-name">autoComputeSize</span><span class="operator">:</span> <a href="/api-docs/clay-web/Bool/" class="type-link">Bool</a></code><a class="header-anchor" href="#autoComputeSize"><span aria-hidden="true" class="header-anchor__symbol">#</span></a></div>
