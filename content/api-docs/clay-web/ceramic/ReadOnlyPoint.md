...
title: ReadOnlyPoint
target: Clay (Web)
permalink: api-docs/clay-web/ceramic/ReadOnlyPoint/
---
...
<div class="see"><strong>See:</strong> <a href="/api-docs/clay-web/ceramic/Point/">Point</a></div>


## Type Conversions

**From:**
- `[ceramic.Point](/api-docs/clay-web/ceramic/Point/)`
