...
target: Clay (Web)
permalink: api-docs/clay-web/ceramic/LorelinePlugin/
---
...
|------|------|---------|-------------|
| `assets` | [Assets](/api-docs/clay-web/ceramic/Assets/) | | The assets collection to add to  |
| `name` | [String](/api-docs/clay-web/String/) | | The asset name (with or without 'loreline:' prefix)  |
| `variant` | [String](/api-docs/clay-web/String/) | *(optional)* | Optional variant identifier  |
...
| Name | Type | Default | Description |
|------|------|---------|-------------|
| `assets` | [Assets](/api-docs/clay-web/ceramic/Assets/) | | The assets collection  |
| `name` | [Either](/api-docs/clay-web/ceramic/Either/)<[String](/api-docs/clay-web/String/), [Dynamic](/api-docs/clay-web/Dynamic/)> | | The asset name or identifier  |
| `variant` | [String](/api-docs/clay-web/String/) | *(optional)* | Optional variant identifier  |
| `options` | [Null](/api-docs/clay-web/Null/)<[AssetOptions](/api-docs/clay-web/ceramic/AssetOptions/)> | *(optional)* | Optional asset loading options  |
...
| Returns | Description |
|---------|-------------|
| [loreline.Script](/api-docs/clay-web/loreline/Script/) | The parsed Loreline script, or null if not found |

<hr class="field-separator" />

<div class="signature field-method has-description has-plugin" id="lorelineAsset"><div class="plugin-name">loreline</div><code><span class="field-name">lorelineAsset</span><span class="parenthesis">(</span><span class="arg-name">assets</span><span class="operator">:</span> <a href="/api-docs/clay-web/ceramic/Assets/" class="type-link">Assets</a><span class="operator">,</span> <span class="arg-name">name</span><span class="operator">:</span> <a href="/api-docs/clay-web/ceramic/Either/" class="type-link">Either</a><span class="operator">&lt;</span><a href="/api-docs/clay-web/String/" class="type-link">String</a><span class="operator">,</span> <a href="/api-docs/clay-web/Dynamic/" class="type-link">Dynamic</a><span class="operator">&gt;</span><span class="operator">,</span> <span class="operator">?</span><span class="arg-name">variant</span><span class="operator">:</span> <a href="/api-docs/clay-web/String/" class="type-link">String</a><span class="parenthesis">)</span><span class="operator">:</span> <a href="/api-docs/clay-web/ceramic/LorelineAsset/" class="type-link">LorelineAsset</a></code><a class="header-anchor" href="#lorelineAsset"><span aria-hidden="true" class="header-anchor__symbol">#</span></a></div>
...
| Returns | Description |
|---------|-------------|
| [LorelineAsset](/api-docs/clay-web/ceramic/LorelineAsset/) | The LorelineAsset, or null if not found |
