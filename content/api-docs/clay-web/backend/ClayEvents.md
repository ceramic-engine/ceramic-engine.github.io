...
title: ClayEvents
target: Clay (Web)
permalink: api-docs/clay-web/backend/ClayEvents/
---
...
<div class="type-hierarchy"><a href="/api-docs/clay-web/clay/Events/">clay.Events</a> → <strong>backend.ClayEvents</strong> (Class)</div>
...
| Name | Type | Description |
|------|------|-------------|
| `type` | [clay.AppEventType](/api-docs/clay-web/clay/AppEventType/) | The type of application event |
...
| Name | Type | Description |
|------|------|-------------|
| `x` | [Int](/api-docs/clay-web/Int/) | Physical X coordinate in pixels  |
| `y` | [Int](/api-docs/clay-web/Int/) | Physical Y coordinate in pixels  |
| `button` | [Int](/api-docs/clay-web/Int/) | Mouse button ID (0=left, 1=middle, 2=right)  |
| `timestamp` | [Float](/api-docs/clay-web/Float/) | Event timestamp in seconds  |
| `windowId` | [Int](/api-docs/clay-web/Int/) | ID of the window that received the event |
...
| `x` | [Int](/api-docs/clay-web/Int/) | Physical X coordinate in pixels  |
| `y` | [Int](/api-docs/clay-web/Int/) | Physical Y coordinate in pixels  |
| `xrel` | [Int](/api-docs/clay-web/Int/) | Relative X movement in pixels (not used)  |
| `yrel` | [Int](/api-docs/clay-web/Int/) | Relative Y movement in pixels (not used)  |
| `timestamp` | [Float](/api-docs/clay-web/Float/) | Event timestamp in seconds  |
| `windowId` | [Int](/api-docs/clay-web/Int/) | ID of the window that received the event |
...
| Name | Type | Description |
|------|------|-------------|
| `x` | [Float](/api-docs/clay-web/Float/) | Horizontal scroll delta (positive = right, negative = left)  |
| `y` | [Float](/api-docs/clay-web/Float/) | Vertical scroll delta (positive = up, negative = down)  |
| `timestamp` | [Float](/api-docs/clay-web/Float/) | Event timestamp in seconds  |
| `windowId` | [Int](/api-docs/clay-web/Int/) | ID of the window that received the event |

<hr class="field-separator" />

<div class="signature field-method has-description has-plugin" id="touchDown"><div class="plugin-name">clay</div><code><span class="field-name">touchDown</span><span class="parenthesis">(</span><span class="arg-name">x</span><span class="operator">:</span> <a href="/api-docs/clay-web/Float/" class="type-link">Float</a><span class="operator">,</span> <span class="arg-name">y</span><span class="operator">:</span> <a href="/api-docs/clay-web/Float/" class="type-link">Float</a><span class="operator">,</span> <span class="arg-name">dx</span><span class="operator">:</span> <a href="/api-docs/clay-web/Float/" class="type-link">Float</a><span class="operator">,</span> <span class="arg-name">dy</span><span class="operator">:</span> <a href="/api-docs/clay-web/Float/" class="type-link">Float</a><span class="operator">,</span> <span class="arg-name">touchId</span><span class="operator">:</span> <a href="/api-docs/clay-web/Int/" class="type-link">Int</a><span class="operator">,</span> <span class="arg-name">timestamp</span><span class="operator">:</span> <a href="/api-docs/clay-web/Float/" class="type-link">Float</a><span class="parenthesis">)</span><span class="operator">:</span> <a href="/api-docs/clay-web/Void/" class="type-link">Void</a></code><a class="header-anchor" href="#touchDown"><span aria-hidden="true" class="header-anchor__symbol">#</span></a></div>
...
| Name | Type | Description |
|------|------|-------------|
| `x` | [Float](/api-docs/clay-web/Float/) | Normalized X coordinate (0.0 to 1.0)  |
| `y` | [Float](/api-docs/clay-web/Float/) | Normalized Y coordinate (0.0 to 1.0)  |
| `dx` | [Float](/api-docs/clay-web/Float/) | Touch pressure or force (not used)  |
| `dy` | [Float](/api-docs/clay-web/Float/) | Touch size or area (not used)  |
| `touchId` | [Int](/api-docs/clay-web/Int/) | Platform-specific touch identifier  |
| `timestamp` | [Float](/api-docs/clay-web/Float/) | Event timestamp in seconds |

<hr class="field-separator" />

<div class="signature field-method has-description has-plugin" id="touchUp"><div class="plugin-name">clay</div><code><span class="field-name">touchUp</span><span class="parenthesis">(</span><span class="arg-name">x</span><span class="operator">:</span> <a href="/api-docs/clay-web/Float/" class="type-link">Float</a><span class="operator">,</span> <span class="arg-name">y</span><span class="operator">:</span> <a href="/api-docs/clay-web/Float/" class="type-link">Float</a><span class="operator">,</span> <span class="arg-name">dx</span><span class="operator">:</span> <a href="/api-docs/clay-web/Float/" class="type-link">Float</a><span class="operator">,</span> <span class="arg-name">dy</span><span class="operator">:</span> <a href="/api-docs/clay-web/Float/" class="type-link">Float</a><span class="operator">,</span> <span class="arg-name">touchId</span><span class="operator">:</span> <a href="/api-docs/clay-web/Int/" class="type-link">Int</a><span class="operator">,</span> <span class="arg-name">timestamp</span><span class="operator">:</span> <a href="/api-docs/clay-web/Float/" class="type-link">Float</a><span class="parenthesis">)</span><span class="operator">:</span> <a href="/api-docs/clay-web/Void/" class="type-link">Void</a></code><a class="header-anchor" href="#touchUp"><span aria-hidden="true" class="header-anchor__symbol">#</span></a></div>
...
<div class="signature field-method has-description has-plugin" id="touchMove"><div class="plugin-name">clay</div><code><span class="field-name">touchMove</span><span class="parenthesis">(</span><span class="arg-name">x</span><span class="operator">:</span> <a href="/api-docs/clay-web/Float/" class="type-link">Float</a><span class="operator">,</span> <span class="arg-name">y</span><span class="operator">:</span> <a href="/api-docs/clay-web/Float/" class="type-link">Float</a><span class="operator">,</span> <span class="arg-name">dx</span><span class="operator">:</span> <a href="/api-docs/clay-web/Float/" class="type-link">Float</a><span class="operator">,</span> <span class="arg-name">dy</span><span class="operator">:</span> <a href="/api-docs/clay-web/Float/" class="type-link">Float</a><span class="operator">,</span> <span class="arg-name">touchId</span><span class="operator">:</span> <a href="/api-docs/clay-web/Int/" class="type-link">Int</a><span class="operator">,</span> <span class="arg-name">timestamp</span><span class="operator">:</span> <a href="/api-docs/clay-web/Float/" class="type-link">Float</a><span class="parenthesis">)</span><span class="operator">:</span> <a href="/api-docs/clay-web/Void/" class="type-link">Void</a></code><a class="header-anchor" href="#touchMove"><span aria-hidden="true" class="header-anchor__symbol">#</span></a></div>
...
| Name | Type | Description |
|------|------|-------------|
| `keyCode` | [clay.KeyCode](/api-docs/clay-web/clay/KeyCode/) | Virtual key code representing the key's logical meaning  |
| `scanCode` | [clay.ScanCode](/api-docs/clay-web/clay/ScanCode/) | Physical scan code representing the key's hardware position  |
| `repeat` | [Bool](/api-docs/clay-web/Bool/) | Whether this is a repeat event from holding the key down  |
| `mod` | [clay.ModState](/api-docs/clay-web/clay/ModState/) | Modifier key state (Shift, Ctrl, Alt, etc.)  |
| `timestamp` | [Float](/api-docs/clay-web/Float/) | Event timestamp in seconds  |
| `windowId` | [Int](/api-docs/clay-web/Int/) | ID of the window that received the event |
...
| `keyCode` | [clay.KeyCode](/api-docs/clay-web/clay/KeyCode/) | Virtual key code representing the key's logical meaning  |
| `scanCode` | [clay.ScanCode](/api-docs/clay-web/clay/ScanCode/) | Physical scan code representing the key's hardware position  |
| `repeat` | [Bool](/api-docs/clay-web/Bool/) | Should always be false for key up events  |
| `mod` | [clay.ModState](/api-docs/clay-web/clay/ModState/) | Modifier key state (Shift, Ctrl, Alt, etc.)  |
| `timestamp` | [Float](/api-docs/clay-web/Float/) | Event timestamp in seconds  |
| `windowId` | [Int](/api-docs/clay-web/Int/) | ID of the window that received the event |
...
| Name | Type | Description |
|------|------|-------------|
| `id` | [Int](/api-docs/clay-web/Int/) | Gamepad device ID (0-3 typically)  |
| `axisId` | [Int](/api-docs/clay-web/Int/) | Axis identifier (0=left stick X, 1=left stick Y, 2=right stick X, etc.)  |
| `value` | [Float](/api-docs/clay-web/Float/) | Axis value from -1.0 to 1.0 (or 0.0 to 1.0 for triggers)  |
| `timestamp` | [Float](/api-docs/clay-web/Float/) | Event timestamp in seconds |
...
|------|------|-------------|
| `id` | [Int](/api-docs/clay-web/Int/) | Gamepad device ID (0-3 typically)  |
| `buttonId` | [Int](/api-docs/clay-web/Int/) | Physical button identifier from the platform  |
| `value` | [Float](/api-docs/clay-web/Float/) | Button pressure (0.0 to 1.0, usually 0.0 or 1.0 for digital buttons)  |
| `timestamp` | [Float](/api-docs/clay-web/Float/) | Event timestamp in seconds |
...
| `id` | [Int](/api-docs/clay-web/Int/) | Gamepad device ID (0-3 typically)  |
| `buttonId` | [Int](/api-docs/clay-web/Int/) | Physical button identifier from the platform  |
| `value` | [Float](/api-docs/clay-web/Float/) | Button pressure (usually 0.0 for button release)  |
| `timestamp` | [Float](/api-docs/clay-web/Float/) | Event timestamp in seconds |
...
|------|------|-------------|
| `id` | [Int](/api-docs/clay-web/Int/) | Gamepad device ID  |
| `name` | [String](/api-docs/clay-web/String/) | Gamepad name/identifier string for device detection  |
| `type` | [clay.GamepadDeviceEventType](/api-docs/clay-web/clay/GamepadDeviceEventType/) | Device event type (DEVICE_ADDED or DEVICE_REMOVED)  |
| `timestamp` | [Float](/api-docs/clay-web/Float/) | Event timestamp in seconds |
...
| Name | Type | Description |
|------|------|-------------|
| `text` | [String](/api-docs/clay-web/String/) | The text string that was input (may be multiple characters)  |
| `start` | [Int](/api-docs/clay-web/Int/) | Starting position for text editing (not used)  |
| `length` | [Int](/api-docs/clay-web/Int/) | Length of text selection/replacement (not used)  |
| `type` | [clay.TextEventType](/api-docs/clay-web/clay/TextEventType/) | Type of text event (input, editing, etc.)  |
| `timestamp` | [Float](/api-docs/clay-web/Float/) | Event timestamp in seconds  |
| `windowId` | [Int](/api-docs/clay-web/Int/) | ID of the window that received the event |

<hr class="field-separator" />

<div class="signature field-method has-description has-plugin" id="windowEvent"><div class="plugin-name">clay</div><code><span class="field-name">windowEvent</span><span class="parenthesis">(</span><span class="arg-name">type</span><span class="operator">:</span> <a href="/api-docs/clay-web/clay/WindowEventType/" class="type-link">clay.WindowEventType</a><span class="operator">,</span> <span class="arg-name">timestamp</span><span class="operator">:</span> <a href="/api-docs/clay-web/Float/" class="type-link">Float</a><span class="operator">,</span> <span class="arg-name">windowId</span><span class="operator">:</span> <a href="/api-docs/clay-web/Int/" class="type-link">Int</a><span class="operator">,</span> <span class="arg-name">x</span><span class="operator">:</span> <a href="/api-docs/clay-web/Int/" class="type-link">Int</a><span class="operator">,</span> <span class="arg-name">y</span><span class="operator">:</span> <a href="/api-docs/clay-web/Int/" class="type-link">Int</a><span class="parenthesis">)</span><span class="operator">:</span> <a href="/api-docs/clay-web/Void/" class="type-link">Void</a></code><a class="header-anchor" href="#windowEvent"><span aria-hidden="true" class="header-anchor__symbol">#</span></a></div>
...
| Name | Type | Description |
|------|------|-------------|
| `type` | [clay.WindowEventType](/api-docs/clay-web/clay/WindowEventType/) | The type of window event that occurred  |
| `timestamp` | [Float](/api-docs/clay-web/Float/) | Event timestamp in seconds  |
| `windowId` | [Int](/api-docs/clay-web/Int/) | ID of the window that generated the event  |
| `x` | [Int](/api-docs/clay-web/Int/) | X coordinate data (usage depends on event type)  |
| `y` | [Int](/api-docs/clay-web/Int/) | Y coordinate data (usage depends on event type) |

## Private Members

<div class="signature field-var has-description has-plugin" id="GAMEPAD_STORAGE_SIZE"><div class="plugin-name">clay</div><code><span class="field-name">GAMEPAD_STORAGE_SIZE</span><span class="operator">:</span> <a href="/api-docs/clay-web/Int/" class="type-link">Int</a></code><a class="header-anchor" href="#GAMEPAD_STORAGE_SIZE"><span aria-hidden="true" class="header-anchor__symbol">#</span></a></div>
