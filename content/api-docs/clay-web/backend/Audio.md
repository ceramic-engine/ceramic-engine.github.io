...
title: Audio
target: Clay (Web)
permalink: api-docs/clay-web/backend/Audio/
---
...
<div class="type-implements"><strong>Implements:</strong> <a href="/api-docs/clay-web/spec/Audio/">spec.Audio</a></div>
...
|------|------|-------------|
| `buffer` | [Float32Array](/api-docs/clay-web/backend/Float32Array/) | The raw PCM samples as 32-bit floats  |
| `samples` | [Int](/api-docs/clay-web/Int/) | Number of sample frames (total samples / channels)  |
...
| `interleaved` | [Bool](/api-docs/clay-web/Bool/) | Whether samples are interleaved (LRLRLR) or planar (LLL...RRR...)  |

| Returns | Description |
|---------|-------------|
| [AudioResource](/api-docs/clay-web/backend/AudioResource/) | The created audio resource, or null on failure |

<hr class="field-separator" />

<div class="signature field-method has-description has-plugin" id="getDuration"><div class="plugin-name">clay</div><code><span class="field-name">getDuration</span><span class="parenthesis">(</span><span class="arg-name">resource</span><span class="operator">:</span> <a href="/api-docs/clay-web/backend/AudioResource/" class="type-link">AudioResource</a><span class="parenthesis">)</span><span class="operator">:</span> <a href="/api-docs/clay-web/Float/" class="type-link">Float</a></code><a class="header-anchor" href="#getDuration"><span aria-hidden="true" class="header-anchor__symbol">#</span></a></div>
...
| Name | Type | Description |
|------|------|-------------|
| `resource` | [AudioResource](/api-docs/clay-web/backend/AudioResource/) | The audio resource to query  |

| Returns | Description |
|---------|-------------|
| [Float](/api-docs/clay-web/Float/) | Duration in seconds, or 0 if unknown |
...
| Returns | Description |
|---------|-------------|
| [Bool](/api-docs/clay-web/Bool/) | true (Clay backend supports audio hot-reload) |
...
| Name | Type | Description |
|------|------|-------------|
| `audio` | [AudioResource](/api-docs/clay-web/backend/AudioResource/) | The audio resource to destroy |
...
| Name | Type | Default | Description |
|------|------|---------|-------------|
| `audio` | [AudioResource](/api-docs/clay-web/backend/AudioResource/) | | The audio resource to play  |
| `volume` | [Float](/api-docs/clay-web/Float/) | `0.5` | Playback volume (0.0 to 1.0, default 0.5)  |
| `pan` | [Float](/api-docs/clay-web/Float/) | `0` | Stereo panning (-1.0 left to 1.0 right, 0 center)  |
| `pitch` | [Float](/api-docs/clay-web/Float/) | `1` | Playback speed/pitch multiplier (1.0 = normal)  |
| `position` | [Float](/api-docs/clay-web/Float/) | `0` | Start position in seconds  |
| `loop` | [Bool](/api-docs/clay-web/Bool/) | `false` | Whether to loop the audio  |
| `bus` | [Int](/api-docs/clay-web/Int/) | `0` | Audio bus index for routing (0 = master)  |

| Returns | Description |
|---------|-------------|
| [AudioHandle](/api-docs/clay-web/backend/AudioHandle/) | Handle for controlling this audio instance, or -1 if failed |
...
| Name | Type | Description |
|------|------|-------------|
| `handle` | [AudioHandle](/api-docs/clay-web/backend/AudioHandle/) | The audio instance handle |
...
| Returns | Description |
|---------|-------------|
| [Float](/api-docs/clay-web/Float/) | Volume level (0.0 to 1.0) |
...
|------|------|-------------|
| `handle` | [AudioHandle](/api-docs/clay-web/backend/AudioHandle/) | The audio instance handle  |
| `volume` | [Float](/api-docs/clay-web/Float/) | New volume level (0.0 to 1.0) |
...
| Returns | Description |
|---------|-------------|
| [Float](/api-docs/clay-web/Float/) | Pan value (-1.0 left to 1.0 right, 0 center) |
...
|------|------|-------------|
| `handle` | [AudioHandle](/api-docs/clay-web/backend/AudioHandle/) | The audio instance handle  |
| `pan` | [Float](/api-docs/clay-web/Float/) | New pan value (-1.0 left to 1.0 right, 0 center) |
...
| Returns | Description |
|---------|-------------|
| [Float](/api-docs/clay-web/Float/) | Pitch multiplier (1.0 = normal speed) |
...
|------|------|-------------|
| `handle` | [AudioHandle](/api-docs/clay-web/backend/AudioHandle/) | The audio instance handle  |
| `pitch` | [Float](/api-docs/clay-web/Float/) | New pitch multiplier (1.0 = normal, 2.0 = double speed) |
...
| Returns | Description |
|---------|-------------|
| [Float](/api-docs/clay-web/Float/) | Position in seconds from the start |
...
|------|------|-------------|
| `handle` | [AudioHandle](/api-docs/clay-web/backend/AudioHandle/) | The audio instance handle  |
| `position` | [Float](/api-docs/clay-web/Float/) | New position in seconds |
...
| Name | Type | Description |
|------|------|-------------|
| `bus` | [Int](/api-docs/clay-web/Int/) | The audio bus to add the filter to (0 = master)  |
| `filter` | [ceramic.AudioFilter](/api-docs/clay-web/ceramic/AudioFilter/) | The audio filter instance to add  |
...
| Name | Type | Description |
|------|------|-------------|
| `bus` | [Int](/api-docs/clay-web/Int/) | The audio bus containing the filter  |
| `filterId` | [Int](/api-docs/clay-web/Int/) | The unique ID of the filter to remove |
...
|------|------|-------------|
| `bus` | [Int](/api-docs/clay-web/Int/) | The audio bus containing the filter  |
| `filterId` | [Int](/api-docs/clay-web/Int/) | The unique ID of the filter that changed |
