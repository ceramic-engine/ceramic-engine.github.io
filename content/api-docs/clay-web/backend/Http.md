...
title: Http
target: Clay (Web)
permalink: api-docs/clay-web/backend/Http/
---
...
<div class="type-implements"><strong>Implements:</strong> <a href="/api-docs/clay-web/spec/Http/">spec.Http</a></div>
...
| Name | Type | Description |
|------|------|-------------|
| `url` | [String](/api-docs/clay-web/String/) | The URL of the file to download  |
| `targetPath` | [String](/api-docs/clay-web/String/) | The local file path where the file should be saved (can be relative)  |
