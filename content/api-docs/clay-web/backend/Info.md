...
title: Info
target: Clay (Web)
permalink: api-docs/clay-web/backend/Info/
---
...
| Returns | Description |
|---------|-------------|
| [String](/api-docs/clay-web/String/) | The storage directory path, or null if not available |
...
| Returns | Description |
|---------|-------------|
| [Array](/api-docs/clay-web/Array/)<[String](/api-docs/clay-web/String/)> | Array of extensions: ['png', 'jpg', 'jpeg'] |
...
| Returns | Description |
|---------|-------------|
| [Array](/api-docs/clay-web/Array/)<[String](/api-docs/clay-web/String/)> | Array of extensions: ['txt', 'json', 'fnt', 'atlas'] |
...
| Returns | Description |
|---------|-------------|
| [Array](/api-docs/clay-web/Array/)<[String](/api-docs/clay-web/String/)> | Array of supported extensions (e.g., ['ogg', 'mp3', 'wav']) |
...
| Returns | Description |
|---------|-------------|
| [Array](/api-docs/clay-web/Array/)<[String](/api-docs/clay-web/String/)> | Array of extensions: ['frag', 'vert'] for fragment and vertex shaders |
...
<div class="signature field-var has-description has-plugin" id="RE_OPERA"><div class="plugin-name">clay</div><code><span class="field-name">RE_OPERA</span><span class="operator">:</span> <a href="/api-docs/clay-web/EReg/" class="type-link">EReg</a></code><a class="header-anchor" href="#RE_OPERA"><span aria-hidden="true" class="header-anchor__symbol">#</span></a></div>

Regular expression to detect Opera browser version

<hr class="field-separator" />

<div class="signature field-var has-description has-plugin" id="RE_SAFARI_VERSION"><div class="plugin-name">clay</div><code><span class="field-name">RE_SAFARI_VERSION</span><span class="operator">:</span> <a href="/api-docs/clay-web/EReg/" class="type-link">EReg</a></code><a class="header-anchor" href="#RE_SAFARI_VERSION"><span aria-hidden="true" class="header-anchor__symbol">#</span></a></div>
