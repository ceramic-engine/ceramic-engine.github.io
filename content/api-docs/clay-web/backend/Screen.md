...
title: Screen
target: Clay (Web)
permalink: api-docs/clay-web/backend/Screen/
---
...
|------|------|-------------|
| `background` | [Int](/api-docs/clay-web/Int/) | Background color as integer |
...
| Name | Type | Description |
|------|------|-------------|
| `fullscreen` | [Bool](/api-docs/clay-web/Bool/) | True to enable fullscreen, false to disable |

<hr class="field-separator" />

<div class="signature field-method has-description has-plugin" id="screenshotToTexture"><div class="plugin-name">clay</div><code><span class="field-name">screenshotToTexture</span><span class="parenthesis">(</span><span class="arg-name">done</span><span class="operator">:</span> <span class="type-name">Function</span><span class="parenthesis">)</span><span class="operator">:</span> <a href="/api-docs/clay-web/Void/" class="type-link">Void</a></code><a class="header-anchor" href="#screenshotToTexture"><span aria-hidden="true" class="header-anchor__symbol">#</span></a></div>
...
<div class="signature field-var no-description has-plugin" id="didTryResumeAudioContext"><div class="plugin-name">clay</div><code><span class="field-name">didTryResumeAudioContext</span><span class="operator">:</span> <a href="/api-docs/clay-web/Bool/" class="type-link">Bool</a></code><a class="header-anchor" href="#didTryResumeAudioContext"><span aria-hidden="true" class="header-anchor__symbol">#</span></a></div>

<hr class="field-separator" />

<div class="signature field-var has-description has-plugin" id="nextScreenshotIndex"><div class="plugin-name">clay</div><code><span class="field-name">nextScreenshotIndex</span><span class="operator">:</span> <a href="/api-docs/clay-web/Int/" class="type-link">Int</a></code><a class="header-anchor" href="#nextScreenshotIndex"><span aria-hidden="true" class="header-anchor__symbol">#</span></a></div>
...
| Name | Type | Description |
|------|------|-------------|
| `buttonId` | [Int](/api-docs/clay-web/Int/) | Mouse button ID (0=left, 1=middle, 2=right)  |
| `x` | [Float](/api-docs/clay-web/Float/) | Mouse X coordinate  |
| `y` | [Float](/api-docs/clay-web/Float/) | Mouse Y coordinate |
...
| Name | Type | Description |
|------|------|-------------|
| `x` | [Float](/api-docs/clay-web/Float/) | Horizontal scroll amount  |
| `y` | [Float](/api-docs/clay-web/Float/) | Vertical scroll amount |
...
| Name | Type | Description |
|------|------|-------------|
| `touchIndex` | [Int](/api-docs/clay-web/Int/) | Touch point index for multi-touch  |
| `x` | [Float](/api-docs/clay-web/Float/) | Touch X coordinate  |
| `y` | [Float](/api-docs/clay-web/Float/) | Touch Y coordinate |
...
<div class="signature field-method no-description has-plugin" id="willEmitTouchDown"><div class="plugin-name">clay</div><code><span class="field-name">willEmitTouchDown</span><span class="parenthesis">(</span><span class="arg-name">buttonId</span><span class="operator">:</span> <a href="/api-docs/clay-web/Int/" class="type-link">Int</a><span class="operator">,</span> <span class="arg-name">x</span><span class="operator">:</span> <a href="/api-docs/clay-web/Float/" class="type-link">Float</a><span class="operator">,</span> <span class="arg-name">y</span><span class="operator">:</span> <a href="/api-docs/clay-web/Float/" class="type-link">Float</a><span class="parenthesis">)</span><span class="operator">:</span> <a href="/api-docs/clay-web/Void/" class="type-link">Void</a></code><a class="header-anchor" href="#willEmitTouchDown"><span aria-hidden="true" class="header-anchor__symbol">#</span></a></div>
...
<div class="signature field-method no-description has-plugin" id="tryResumeAudioContextIfNeeded"><div class="plugin-name">clay</div><code><span class="field-name">tryResumeAudioContextIfNeeded</span><span class="parenthesis">(</span><span class="parenthesis">)</span><span class="operator">:</span> <a href="/api-docs/clay-web/Void/" class="type-link">Void</a></code><a class="header-anchor" href="#tryResumeAudioContextIfNeeded"><span aria-hidden="true" class="header-anchor__symbol">#</span></a></div>
