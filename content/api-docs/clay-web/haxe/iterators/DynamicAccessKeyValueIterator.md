...
target: Clay (Web)
permalink: api-docs/clay-web/haxe/iterators/DynamicAccessKeyValueIterator/
---
...
| Name | Type |
|------|------|
| `access` | [haxe.DynamicAccess](/api-docs/clay-web/haxe/DynamicAccess/)<haxe.iterators.DynamicAccessKeyValueIterator.T> |
