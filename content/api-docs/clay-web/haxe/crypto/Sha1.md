...
title: Sha1
target: Clay (Web)
permalink: api-docs/clay-web/haxe/crypto/Sha1/
---
...
<div class="signature field-method has-description" id="kt"><code><span class="field-name">kt</span><span class="parenthesis">(</span><span class="arg-name">t</span><span class="operator">:</span> <a href="/api-docs/clay-web/Int/" class="type-link">Int</a><span class="parenthesis">)</span><span class="operator">:</span> <a href="/api-docs/clay-web/Int/" class="type-link">Int</a></code><a class="header-anchor" href="#kt"><span aria-hidden="true" class="header-anchor__symbol">#</span></a></div>
