...
title: Hmac
target: Clay (Web)
permalink: api-docs/clay-web/haxe/crypto/Hmac/
---
...
| Name | Type |
|------|------|
| `key` | [haxe.io.Bytes](/api-docs/clay-web/haxe/io/Bytes/) |
| `msg` | [haxe.io.Bytes](/api-docs/clay-web/haxe/io/Bytes/) |
...
<div class="signature field-var no-description" id="blockSize"><code><span class="field-name">blockSize</span><span class="operator">:</span> <a href="/api-docs/clay-web/Int/" class="type-link">Int</a></code><a class="header-anchor" href="#blockSize"><span aria-hidden="true" class="header-anchor__symbol">#</span></a></div>
...
<div class="signature field-method no-description" id="doHash"><code><span class="field-name">doHash</span><span class="parenthesis">(</span><span class="arg-name">b</span><span class="operator">:</span> <a href="/api-docs/clay-web/haxe/io/Bytes/" class="type-link">haxe.io.Bytes</a><span class="parenthesis">)</span><span class="operator">:</span> <a href="/api-docs/clay-web/haxe/io/Bytes/" class="type-link">haxe.io.Bytes</a></code><a class="header-anchor" href="#doHash"><span aria-hidden="true" class="header-anchor__symbol">#</span></a></div>
...
<div class="signature field-method no-description" id="nullPad"><code><span class="field-name">nullPad</span><span class="parenthesis">(</span><span class="arg-name">s</span><span class="operator">:</span> <a href="/api-docs/clay-web/haxe/io/Bytes/" class="type-link">haxe.io.Bytes</a><span class="operator">,</span> <span class="arg-name">chunkLen</span><span class="operator">:</span> <a href="/api-docs/clay-web/Int/" class="type-link">Int</a><span class="parenthesis">)</span><span class="operator">:</span> <a href="/api-docs/clay-web/haxe/io/Bytes/" class="type-link">haxe.io.Bytes</a></code><a class="header-anchor" href="#nullPad"><span aria-hidden="true" class="header-anchor__symbol">#</span></a></div>


| Name | Type |
|------|------|
| `s` | [haxe.io.Bytes](/api-docs/clay-web/haxe/io/Bytes/) |
| `chunkLen` | [Int](/api-docs/clay-web/Int/) |
