...
title: CType
target: Clay (Web)
permalink: api-docs/clay-web/haxe/rtti/CType/
---
...
| Name | Type |
|------|------|
| `name` | [haxe.rtti.Path](/api-docs/clay-web/haxe/rtti/Path/) |
...
| Name | Type |
|------|------|
| `args` | [Array](/api-docs/clay-web/Array/)<[haxe.rtti.FunctionArgument](/api-docs/clay-web/haxe/rtti/FunctionArgument/)> |
| `ret` | Anonymous |
...
| Name | Type |
|------|------|
| `fields` | [Array](/api-docs/clay-web/Array/)<[haxe.rtti.ClassField](/api-docs/clay-web/haxe/rtti/ClassField/)> |
