...
title: TypeApi
target: Clay (Web)
permalink: api-docs/clay-web/haxe/rtti/TypeApi/
---
...
<div class="signature field-method no-description" id="typeInfos"><code><span class="field-name">typeInfos</span><span class="parenthesis">(</span><span class="arg-name">t</span><span class="operator">:</span> <span class="type-name">Anonymous</span><span class="parenthesis">)</span><span class="operator">:</span> <a href="/api-docs/clay-web/haxe/rtti/TypeInfos/" class="type-link">TypeInfos</a></code><a class="header-anchor" href="#typeInfos"><span aria-hidden="true" class="header-anchor__symbol">#</span></a></div>
...
| Name | Type |
|------|------|
| `c1` | [EnumField](/api-docs/clay-web/haxe/rtti/EnumField/) |
| `c2` | [EnumField](/api-docs/clay-web/haxe/rtti/EnumField/) |
