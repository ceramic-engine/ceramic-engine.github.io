...
title: Map
target: Clay (Web)
permalink: api-docs/clay-web/haxe/ds/Map/
---
...
**From:**
- `[haxe.ds.StringMap](/api-docs/clay-web/haxe/ds/StringMap/)<fromStringMap.V>`

**To:**
- `[haxe.ds.StringMap](/api-docs/clay-web/haxe/ds/StringMap/)<toStringMap.V>`
