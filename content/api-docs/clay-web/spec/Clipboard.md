...
title: Clipboard
target: Clay (Web)
permalink: api-docs/clay-web/spec/Clipboard/
---
...
<div class="type-hierarchy"><strong>spec.Clipboard</strong> (Interface) → <a href="/api-docs/clay-web/backend/Clipboard/">backend.Clipboard</a></div>
...
| Returns | Description |
|---------|-------------|
| [String](/api-docs/clay-web/String/) | The clipboard text content, or an empty string if the clipboard is empty or doesn't contain text data |
