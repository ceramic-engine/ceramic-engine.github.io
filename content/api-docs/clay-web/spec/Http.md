...
title: Http
target: Clay (Web)
permalink: api-docs/clay-web/spec/Http/
---
...
<div class="type-hierarchy"><strong>spec.Http</strong> (Interface) → <a href="/api-docs/clay-web/backend/Http/">backend.Http</a></div>
...
|------|------|-------------|
| `options` | [backend.HttpRequestOptions](/api-docs/clay-web/backend/HttpRequestOptions/) | The request configuration including URL, method, headers, body, etc.  |
