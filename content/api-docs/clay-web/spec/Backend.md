...
title: Backend
target: Clay (Web)
permalink: api-docs/clay-web/spec/Backend/
---
...
<div class="type-hierarchy"><strong>spec.Backend</strong> (Interface) → <a href="/api-docs/clay-web/backend/Backend/">backend.Backend</a></div>
...
<div class="signature field-var has-description" id="io"><code><span class="field-name">io</span><span class="operator">:</span> <a href="/api-docs/clay-web/backend/IO/" class="type-link">backend.IO</a></code><a class="header-anchor" href="#io"><span aria-hidden="true" class="header-anchor__symbol">#</span></a></div>
...
<div class="signature field-var has-description" id="info"><code><span class="field-name">info</span><span class="operator">:</span> <a href="/api-docs/clay-web/backend/Info/" class="type-link">backend.Info</a></code><a class="header-anchor" href="#info"><span aria-hidden="true" class="header-anchor__symbol">#</span></a></div>
...
<div class="signature field-var has-description" id="audio"><code><span class="field-name">audio</span><span class="operator">:</span> <a href="/api-docs/clay-web/backend/Audio/" class="type-link">backend.Audio</a></code><a class="header-anchor" href="#audio"><span aria-hidden="true" class="header-anchor__symbol">#</span></a></div>
...
<div class="signature field-var has-description" id="draw"><code><span class="field-name">draw</span><span class="operator">:</span> <a href="/api-docs/clay-web/backend/Draw/" class="type-link">backend.Draw</a></code><a class="header-anchor" href="#draw"><span aria-hidden="true" class="header-anchor__symbol">#</span></a></div>
...
<div class="signature field-var has-description" id="texts"><code><span class="field-name">texts</span><span class="operator">:</span> <a href="/api-docs/clay-web/backend/Texts/" class="type-link">backend.Texts</a></code><a class="header-anchor" href="#texts"><span aria-hidden="true" class="header-anchor__symbol">#</span></a></div>
...
<div class="signature field-var has-description" id="binaries"><code><span class="field-name">binaries</span><span class="operator">:</span> <a href="/api-docs/clay-web/backend/Binaries/" class="type-link">backend.Binaries</a></code><a class="header-anchor" href="#binaries"><span aria-hidden="true" class="header-anchor__symbol">#</span></a></div>
...
<div class="signature field-var has-description" id="textures"><code><span class="field-name">textures</span><span class="operator">:</span> <a href="/api-docs/clay-web/backend/Textures/" class="type-link">backend.Textures</a></code><a class="header-anchor" href="#textures"><span aria-hidden="true" class="header-anchor__symbol">#</span></a></div>
...
<div class="signature field-var has-description" id="screen"><code><span class="field-name">screen</span><span class="operator">:</span> <a href="/api-docs/clay-web/backend/Screen/" class="type-link">backend.Screen</a></code><a class="header-anchor" href="#screen"><span aria-hidden="true" class="header-anchor__symbol">#</span></a></div>
...
<div class="signature field-var has-description" id="http"><code><span class="field-name">http</span><span class="operator">:</span> <a href="/api-docs/clay-web/backend/Http/" class="type-link">backend.Http</a></code><a class="header-anchor" href="#http"><span aria-hidden="true" class="header-anchor__symbol">#</span></a></div>
...
<div class="signature field-var has-description" id="clipboard"><code><span class="field-name">clipboard</span><span class="operator">:</span> <a href="/api-docs/clay-web/backend/Clipboard/" class="type-link">backend.Clipboard</a></code><a class="header-anchor" href="#clipboard"><span aria-hidden="true" class="header-anchor__symbol">#</span></a></div>
...
|------|------|-------------|
| `app` | [ceramic.App](/api-docs/clay-web/ceramic/App/) | The main Ceramic application instance |
...
| Name | Type | Description |
|------|------|-------------|
| `fps` | [Int](/api-docs/clay-web/Int/) | The target frames per second (typically 30, 60, or 120) |
