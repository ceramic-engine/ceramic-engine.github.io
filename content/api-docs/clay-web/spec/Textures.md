...
title: Textures
target: Clay (Web)
permalink: api-docs/clay-web/spec/Textures/
---
...
<div class="type-hierarchy"><strong>spec.Textures</strong> (Interface) → <a href="/api-docs/clay-web/backend/Textures/">backend.Textures</a></div>
...
|------|------|---------|-------------|
| `path` | [String](/api-docs/clay-web/String/) | | The path to the image file (relative to assets)  |
| `options` | [Null](/api-docs/clay-web/Null/)<[backend.LoadTextureOptions](/api-docs/clay-web/backend/LoadTextureOptions/)> | *(optional)* | Optional loading configuration (filtering, density, etc.)  |
...
| Name | Type | Default | Description |
|------|------|---------|-------------|
| `bytes` | [haxe.io.Bytes](/api-docs/clay-web/haxe/io/Bytes/) | | The raw image file data  |
| `type` | [ceramic.ImageType](/api-docs/clay-web/ceramic/ImageType/) | | The image format (PNG, JPEG, etc.)  |
| `options` | [Null](/api-docs/clay-web/Null/)<[backend.LoadTextureOptions](/api-docs/clay-web/backend/LoadTextureOptions/)> | *(optional)* | Optional loading configuration  |
...
|------|------|-------------|
| `width` | [Int](/api-docs/clay-web/Int/) | The texture width in pixels  |
| `height` | [Int](/api-docs/clay-web/Int/) | The texture height in pixels  |
| `pixels` | [ceramic.UInt8Array](/api-docs/clay-web/ceramic/UInt8Array/) | The raw RGBA pixel data (width * height * 4 bytes)  |

| Returns | Description |
|---------|-------------|
| [backend.Texture](/api-docs/clay-web/backend/Texture/) | The created texture |

<hr class="field-separator" />

<div class="signature field-method has-description" id="destroyTexture"><code><span class="field-name">destroyTexture</span><span class="parenthesis">(</span><span class="arg-name">texture</span><span class="operator">:</span> <a href="/api-docs/clay-web/backend/Texture/" class="type-link">backend.Texture</a><span class="parenthesis">)</span><span class="operator">:</span> <a href="/api-docs/clay-web/Void/" class="type-link">Void</a></code><a class="header-anchor" href="#destroyTexture"><span aria-hidden="true" class="header-anchor__symbol">#</span></a></div>
...
| Name | Type | Description |
|------|------|-------------|
| `texture` | [backend.Texture](/api-docs/clay-web/backend/Texture/) | The texture to destroy |

<hr class="field-separator" />

<div class="signature field-method has-description" id="getTextureId"><code><span class="field-name">getTextureId</span><span class="parenthesis">(</span><span class="arg-name">texture</span><span class="operator">:</span> <a href="/api-docs/clay-web/backend/Texture/" class="type-link">backend.Texture</a><span class="parenthesis">)</span><span class="operator">:</span> <a href="/api-docs/clay-web/backend/TextureId/" class="type-link">backend.TextureId</a></code><a class="header-anchor" href="#getTextureId"><span aria-hidden="true" class="header-anchor__symbol">#</span></a></div>
...
| Name | Type | Description |
|------|------|-------------|
| `texture` | [backend.Texture](/api-docs/clay-web/backend/Texture/) | The texture to query  |

| Returns | Description |
|---------|-------------|
| [backend.TextureId](/api-docs/clay-web/backend/TextureId/) | The texture's unique identifier |
...
| Returns | Description |
|---------|-------------|
| [Int](/api-docs/clay-web/Int/) | The logical width in pixels |
...
| Returns | Description |
|---------|-------------|
| [Int](/api-docs/clay-web/Int/) | The logical height in pixels |
...
| Returns | Description |
|---------|-------------|
| [Int](/api-docs/clay-web/Int/) | The actual GPU texture width in pixels |
...
| Name | Type | Default | Description |
|------|------|---------|-------------|
| `texture` | [backend.Texture](/api-docs/clay-web/backend/Texture/) | | The texture to read from  |
| `result` | [Null](/api-docs/clay-web/Null/)<[ceramic.UInt8Array](/api-docs/clay-web/ceramic/UInt8Array/)> | *(optional)* | Optional array to store results (must be width*height*4 bytes)  |
...
| Name | Type | Description |
|------|------|-------------|
| `texture` | [backend.Texture](/api-docs/clay-web/backend/Texture/) | The texture to update  |
| `pixels` | [ceramic.UInt8Array](/api-docs/clay-web/ceramic/UInt8Array/) | The new RGBA pixel data |
...
| Name | Type | Description |
|------|------|-------------|
| `texture` | [backend.Texture](/api-docs/clay-web/backend/Texture/) | The texture to configure  |
...
|------|------|-------------|
| `texture` | [backend.Texture](/api-docs/clay-web/backend/Texture/) | The texture to configure  |
| `wrap` | [ceramic.TextureWrap](/api-docs/clay-web/ceramic/TextureWrap/) | The wrapping mode for the S (horizontal) axis |
...
| Name | Type | Description |
|------|------|-------------|
| `width` | [Int](/api-docs/clay-web/Int/) | The render target width in pixels  |
| `height` | [Int](/api-docs/clay-web/Int/) | The render target height in pixels  |
...
| `antialiasing` | [Int](/api-docs/clay-web/Int/) | MSAA sample count (0 or 1 for no antialiasing)  |

| Returns | Description |
|---------|-------------|
| [backend.Texture](/api-docs/clay-web/backend/Texture/) | The created render target texture |
...
| Returns | Description |
|---------|-------------|
| [Int](/api-docs/clay-web/Int/) | Maximum textures per batch (1 if multi-texturing is not supported) |
...
| Returns | Description |
|---------|-------------|
| [Int](/api-docs/clay-web/Int/) | The texture's slot index for the current batch |
...
| Name | Type | Default | Description |
|------|------|---------|-------------|
| `texture` | [backend.Texture](/api-docs/clay-web/backend/Texture/) | | The texture to export  |
| `reversePremultiplyAlpha` | [Bool](/api-docs/clay-web/Bool/) | `true` | Whether to reverse premultiplied alpha (usually true)  |
| `path` | [String](/api-docs/clay-web/String/) | *(optional)* | Optional file path to save the PNG  |
...
| `pixels` | [ceramic.UInt8Array](/api-docs/clay-web/ceramic/UInt8Array/) | | RGBA pixel data (width * height * 4 bytes)  |
| `path` | [String](/api-docs/clay-web/String/) | *(optional)* | Optional file path to save the PNG  |
| `done` | Function | | Callback with PNG data bytes (null on error) |
