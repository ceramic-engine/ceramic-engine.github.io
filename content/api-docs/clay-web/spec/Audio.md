...
title: Audio
target: Clay (Web)
permalink: api-docs/clay-web/spec/Audio/
---
...
<div class="type-hierarchy"><strong>spec.Audio</strong> (Interface) → <a href="/api-docs/clay-web/backend/Audio/">backend.Audio</a></div>
...
|------|------|-------------|
| `buffer` | [backend.Float32Array](/api-docs/clay-web/backend/Float32Array/) | The raw audio sample data as 32-bit floats (-1.0 to 1.0 range)  |
| `samples` | [Int](/api-docs/clay-web/Int/) | The total number of samples in the buffer  |
| `channels` | [Int](/api-docs/clay-web/Int/) | The number of audio channels (1 for mono, 2 for stereo)  |
| `sampleRate` | [Float](/api-docs/clay-web/Float/) | The sample rate in Hz (e.g., 44100, 48000)  |
| `interleaved` | [Bool](/api-docs/clay-web/Bool/) | Whether samples are interleaved (L,R,L,R) or planar (L,L,L...,R,R,R)  |

| Returns | Description |
|---------|-------------|
| [backend.AudioResource](/api-docs/clay-web/backend/AudioResource/) | A new AudioResource containing the audio data |
...
| Name | Type | Description |
|------|------|-------------|
| `audio` | [backend.AudioResource](/api-docs/clay-web/backend/AudioResource/) | The audio resource to query  |

| Returns | Description |
|---------|-------------|
| [Float](/api-docs/clay-web/Float/) | The duration in seconds, or -1 if unknown (e.g., for streams) |

<hr class="field-separator" />

<div class="signature field-method has-description" id="resumeAudioContext"><code><span class="field-name">resumeAudioContext</span><span class="parenthesis">(</span><span class="arg-name">done</span><span class="operator">:</span> <span class="type-name">Function</span><span class="parenthesis">)</span><span class="operator">:</span> <a href="/api-docs/clay-web/Void/" class="type-link">Void</a></code><a class="header-anchor" href="#resumeAudioContext"><span aria-hidden="true" class="header-anchor__symbol">#</span></a></div>
...
| Name | Type | Default | Description |
|------|------|---------|-------------|
| `audio` | [backend.AudioResource](/api-docs/clay-web/backend/AudioResource/) | | The audio resource to play  |
| `volume` | [Float](/api-docs/clay-web/Float/) | `0.5` | The playback volume (0.0 to 1.0, default 0.5)  |
| `pan` | [Float](/api-docs/clay-web/Float/) | `0` | The stereo panning (-1.0 for left, 0.0 for center, 1.0 for right)  |
| `pitch` | [Float](/api-docs/clay-web/Float/) | `1` | The playback pitch/speed multiplier (1.0 is normal speed)  |
| `position` | [Float](/api-docs/clay-web/Float/) | `0` | The starting position in seconds  |
| `loop` | [Bool](/api-docs/clay-web/Bool/) | `false` | Whether to loop playback when reaching the end  |
| `bus` | [Int](/api-docs/clay-web/Int/) | `0` | The audio bus to route this sound through (0-7)  |

| Returns | Description |
|---------|-------------|
| [backend.AudioHandle](/api-docs/clay-web/backend/AudioHandle/) | An AudioHandle for controlling the playing sound |
...
| Name | Type | Description |
|------|------|-------------|
| `handle` | [backend.AudioHandle](/api-docs/clay-web/backend/AudioHandle/) | The audio handle to pause |
...
| Name | Type | Description |
|------|------|-------------|
| `handle` | [backend.AudioHandle](/api-docs/clay-web/backend/AudioHandle/) | The audio handle to resume |
...
| Name | Type | Description |
|------|------|-------------|
| `handle` | [backend.AudioHandle](/api-docs/clay-web/backend/AudioHandle/) | The audio handle to stop |

<hr class="field-separator" />

<div class="signature field-method has-description" id="getVolume"><code><span class="field-name">getVolume</span><span class="parenthesis">(</span><span class="arg-name">handle</span><span class="operator">:</span> <a href="/api-docs/clay-web/backend/AudioHandle/" class="type-link">backend.AudioHandle</a><span class="parenthesis">)</span><span class="operator">:</span> <a href="/api-docs/clay-web/Float/" class="type-link">Float</a></code><a class="header-anchor" href="#getVolume"><span aria-hidden="true" class="header-anchor__symbol">#</span></a></div>
...
| Name | Type | Description |
|------|------|-------------|
| `handle` | [backend.AudioHandle](/api-docs/clay-web/backend/AudioHandle/) | The audio handle to query  |

| Returns | Description |
|---------|-------------|
| [Float](/api-docs/clay-web/Float/) | The current volume (0.0 to 1.0) |

<hr class="field-separator" />

<div class="signature field-method has-description" id="setVolume"><code><span class="field-name">setVolume</span><span class="parenthesis">(</span><span class="arg-name">handle</span><span class="operator">:</span> <a href="/api-docs/clay-web/backend/AudioHandle/" class="type-link">backend.AudioHandle</a><span class="operator">,</span> <span class="arg-name">volume</span><span class="operator">:</span> <a href="/api-docs/clay-web/Float/" class="type-link">Float</a><span class="parenthesis">)</span><span class="operator">:</span> <a href="/api-docs/clay-web/Void/" class="type-link">Void</a></code><a class="header-anchor" href="#setVolume"><span aria-hidden="true" class="header-anchor__symbol">#</span></a></div>
...
| Name | Type | Description |
|------|------|-------------|
| `handle` | [backend.AudioHandle](/api-docs/clay-web/backend/AudioHandle/) | The audio handle to modify  |
| `volume` | [Float](/api-docs/clay-web/Float/) | The new volume (0.0 to 1.0) |

<hr class="field-separator" />

<div class="signature field-method has-description" id="getPan"><code><span class="field-name">getPan</span><span class="parenthesis">(</span><span class="arg-name">handle</span><span class="operator">:</span> <a href="/api-docs/clay-web/backend/AudioHandle/" class="type-link">backend.AudioHandle</a><span class="parenthesis">)</span><span class="operator">:</span> <a href="/api-docs/clay-web/Float/" class="type-link">Float</a></code><a class="header-anchor" href="#getPan"><span aria-hidden="true" class="header-anchor__symbol">#</span></a></div>
...
| Returns | Description |
|---------|-------------|
| [Float](/api-docs/clay-web/Float/) | The current pan value (-1.0 for left, 0.0 for center, 1.0 for right) |

<hr class="field-separator" />

<div class="signature field-method has-description" id="setPan"><code><span class="field-name">setPan</span><span class="parenthesis">(</span><span class="arg-name">handle</span><span class="operator">:</span> <a href="/api-docs/clay-web/backend/AudioHandle/" class="type-link">backend.AudioHandle</a><span class="operator">,</span> <span class="arg-name">pan</span><span class="operator">:</span> <a href="/api-docs/clay-web/Float/" class="type-link">Float</a><span class="parenthesis">)</span><span class="operator">:</span> <a href="/api-docs/clay-web/Void/" class="type-link">Void</a></code><a class="header-anchor" href="#setPan"><span aria-hidden="true" class="header-anchor__symbol">#</span></a></div>
...
|------|------|-------------|
| `handle` | [backend.AudioHandle](/api-docs/clay-web/backend/AudioHandle/) | The audio handle to modify  |
| `pan` | [Float](/api-docs/clay-web/Float/) | The new pan value (-1.0 for left, 0.0 for center, 1.0 for right) |

<hr class="field-separator" />

<div class="signature field-method has-description" id="getPitch"><code><span class="field-name">getPitch</span><span class="parenthesis">(</span><span class="arg-name">handle</span><span class="operator">:</span> <a href="/api-docs/clay-web/backend/AudioHandle/" class="type-link">backend.AudioHandle</a><span class="parenthesis">)</span><span class="operator">:</span> <a href="/api-docs/clay-web/Float/" class="type-link">Float</a></code><a class="header-anchor" href="#getPitch"><span aria-hidden="true" class="header-anchor__symbol">#</span></a></div>
...
| Returns | Description |
|---------|-------------|
| [Float](/api-docs/clay-web/Float/) | The current pitch multiplier (1.0 is normal speed) |

<hr class="field-separator" />

<div class="signature field-method has-description" id="setPitch"><code><span class="field-name">setPitch</span><span class="parenthesis">(</span><span class="arg-name">handle</span><span class="operator">:</span> <a href="/api-docs/clay-web/backend/AudioHandle/" class="type-link">backend.AudioHandle</a><span class="operator">,</span> <span class="arg-name">pitch</span><span class="operator">:</span> <a href="/api-docs/clay-web/Float/" class="type-link">Float</a><span class="parenthesis">)</span><span class="operator">:</span> <a href="/api-docs/clay-web/Void/" class="type-link">Void</a></code><a class="header-anchor" href="#setPitch"><span aria-hidden="true" class="header-anchor__symbol">#</span></a></div>
...
|------|------|-------------|
| `handle` | [backend.AudioHandle](/api-docs/clay-web/backend/AudioHandle/) | The audio handle to modify  |
| `pitch` | [Float](/api-docs/clay-web/Float/) | The new pitch multiplier (0.5 = half speed/octave down, 2.0 = double speed/octave up) |
...
| Returns | Description |
|---------|-------------|
| [Float](/api-docs/clay-web/Float/) | The current position in seconds |
...
|------|------|-------------|
| `handle` | [backend.AudioHandle](/api-docs/clay-web/backend/AudioHandle/) | The audio handle to modify  |
| `position` | [Float](/api-docs/clay-web/Float/) | The new position in seconds |

<hr class="field-separator" />

<div class="signature field-method has-description" id="addFilter"><code><span class="field-name">addFilter</span><span class="parenthesis">(</span><span class="arg-name">bus</span><span class="operator">:</span> <a href="/api-docs/clay-web/Int/" class="type-link">Int</a><span class="operator">,</span> <span class="arg-name">filter</span><span class="operator">:</span> <a href="/api-docs/clay-web/ceramic/AudioFilter/" class="type-link">ceramic.AudioFilter</a><span class="operator">,</span> <span class="arg-name">onReady</span><span class="operator">:</span> <span class="type-name">Function</span><span class="parenthesis">)</span><span class="operator">:</span> <a href="/api-docs/clay-web/Void/" class="type-link">Void</a></code><a class="header-anchor" href="#addFilter"><span aria-hidden="true" class="header-anchor__symbol">#</span></a></div>
...
| Name | Type | Description |
|------|------|-------------|
| `bus` | [Int](/api-docs/clay-web/Int/) | The audio bus number (0-7) to remove the filter from  |
| `filterId` | [Int](/api-docs/clay-web/Int/) | The ID of the filter to remove (from AudioFilter.id) |

<hr class="field-separator" />

<div class="signature field-method has-description" id="filterParamsChanged"><code><span class="field-name">filterParamsChanged</span><span class="parenthesis">(</span><span class="arg-name">bus</span><span class="operator">:</span> <a href="/api-docs/clay-web/Int/" class="type-link">Int</a><span class="operator">,</span> <span class="arg-name">filterId</span><span class="operator">:</span> <a href="/api-docs/clay-web/Int/" class="type-link">Int</a><span class="parenthesis">)</span><span class="operator">:</span> <a href="/api-docs/clay-web/Void/" class="type-link">Void</a></code><a class="header-anchor" href="#filterParamsChanged"><span aria-hidden="true" class="header-anchor__symbol">#</span></a></div>
...
| Name | Type | Description |
|------|------|-------------|
| `bus` | [Int](/api-docs/clay-web/Int/) | The audio bus number (0-7) containing the filter  |
| `filterId` | [Int](/api-docs/clay-web/Int/) | The ID of the filter whose parameters changed |
