...
title: Shaders
target: Clay (Web)
permalink: api-docs/clay-web/spec/Shaders/
---
...
<div class="type-hierarchy"><strong>spec.Shaders</strong> (Interface) → <a href="/api-docs/clay-web/backend/Shaders/">backend.Shaders</a></div>
...
|------|------|-------------|
| `shader` | [backend.Shader](/api-docs/clay-web/backend/Shader/) | The shader to destroy |
...
<div class="signature field-method has-description" id="clone"><code><span class="field-name">clone</span><span class="parenthesis">(</span><span class="arg-name">shader</span><span class="operator">:</span> <a href="/api-docs/clay-web/backend/Shader/" class="type-link">backend.Shader</a><span class="parenthesis">)</span><span class="operator">:</span> <a href="/api-docs/clay-web/backend/Shader/" class="type-link">backend.Shader</a></code><a class="header-anchor" href="#clone"><span aria-hidden="true" class="header-anchor__symbol">#</span></a></div>
...
| Name | Type | Description |
|------|------|-------------|
| `shader` | [backend.Shader](/api-docs/clay-web/backend/Shader/) | The shader to clone  |

| Returns | Description |
|---------|-------------|
| [backend.Shader](/api-docs/clay-web/backend/Shader/) | A new shader instance sharing the same GPU program |
...
|------|------|-------------|
| `shader` | [backend.Shader](/api-docs/clay-web/backend/Shader/) | The shader to modify  |
| `name` | [String](/api-docs/clay-web/String/) | The uniform array variable name  |
...
| Name | Type | Description |
|------|------|-------------|
| `shader` | [backend.Shader](/api-docs/clay-web/backend/Shader/) | The shader to query  |

| Returns | Description |
|---------|-------------|
| [Int](/api-docs/clay-web/Int/) | The number of floats per vertex for custom attributes |
...
| Returns | Description |
|---------|-------------|
| [Int](/api-docs/clay-web/Int/) | The maximum if statement count, or -1 if unlimited |
...
| Name | Type | Description |
|------|------|-------------|
| `shader` | [backend.Shader](/api-docs/clay-web/backend/Shader/) | The shader to check  |

| Returns | Description |
|---------|-------------|
| [Bool](/api-docs/clay-web/Bool/) | True if multi-texture batching is supported |
