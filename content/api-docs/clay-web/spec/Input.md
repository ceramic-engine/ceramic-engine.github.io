...
title: Input
target: Clay (Web)
permalink: api-docs/clay-web/spec/Input/
---
...
<div class="type-hierarchy"><strong>spec.Input</strong> (Interface) → <a href="/api-docs/clay-web/backend/Input/">backend.Input</a></div>
