...
target: Clay (Web)
permalink: api-docs/clay-web/elements/CellCollectionView/
---
...
<div class="type-hierarchy"><a href="/api-docs/clay-web/ceramic/Entity/">ceramic.Entity</a> → <a href="/api-docs/clay-web/ceramic/Visual/">ceramic.Visual</a> → <a href="/api-docs/clay-web/ceramic/Quad/">ceramic.Quad</a> → <a href="/api-docs/clay-web/ceramic/Layer/">ceramic.Layer</a> → <a href="/api-docs/clay-web/ceramic/View/">ceramic.View</a> → <a href="/api-docs/clay-web/ceramic/ScrollView/">ceramic.ScrollView</a> → <a href="/api-docs/clay-web/ceramic/CollectionView/">ceramic.CollectionView</a> → <strong>elements.CellCollectionView</strong> (Class)</div>
...
<div class="see"><strong>See:</strong> CollectionView, <a href="/api-docs/clay-web/elements/Scrollbar/">Scrollbar</a>, <a href="/api-docs/clay-web/elements/Theme/">Theme</a></div>
...
<div class="signature field-var no-description has-plugin" id="unobservedScrolling"><div class="plugin-name">elements</div><code><span class="field-name">unobservedScrolling</span><span class="operator">:</span> <a href="/api-docs/clay-web/Bool/" class="type-link">Bool</a></code><a class="header-anchor" href="#unobservedScrolling"><span aria-hidden="true" class="header-anchor__symbol">#</span></a></div>
...
| Name | Type |
|------|------|
| `instance` | [CellCollectionView](/api-docs/clay-web/elements/CellCollectionView/) |
...
|------|------|-------------|
| `delta` | [Float](/api-docs/clay-web/Float/) | Time elapsed since last frame (not used) |
