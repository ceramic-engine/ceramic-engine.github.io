...
target: Clay (Web)
permalink: api-docs/clay-web/elements/RelatedToFieldView/
---
...
<div class="type-hierarchy"><strong>elements.RelatedToFieldView</strong> (Interface) → <a href="/api-docs/clay-web/elements/ColorPickerView/">ColorPickerView</a></div>
...
<div class="see"><strong>See:</strong> <a href="/api-docs/clay-web/elements/FieldView/">FieldView</a>, <a href="/api-docs/clay-web/elements/LabeledView/">LabeledView</a></div>
...
| Returns | Description |
|---------|-------------|
| [FieldView](/api-docs/clay-web/elements/FieldView/) | The related FieldView instance |
