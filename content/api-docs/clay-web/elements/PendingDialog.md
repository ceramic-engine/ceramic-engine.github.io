...
title: PendingDialog
target: Clay (Web)
permalink: api-docs/clay-web/elements/PendingDialog/
---
...
<div class="type-hierarchy"><a href="/api-docs/clay-web/ceramic/Entity/">ceramic.Entity</a> → <a href="/api-docs/clay-web/tracker/Model/">tracker.Model</a> → <strong>elements.PendingDialog</strong> (Class)</div>
...
|------|------|---------|-------------|
| `key` | [String](/api-docs/clay-web/String/) | *(optional)* | Optional unique identifier for the dialog  |
| `title` | [String](/api-docs/clay-web/String/) | | Title text for the dialog header  |
| `message` | [String](/api-docs/clay-web/String/) | | Main message text for the dialog body  |
| `prompt` | [Bool](/api-docs/clay-web/Bool/) | `false` | Whether to include a text input prompt  |
| `promptPointer` | [StringPointer](/api-docs/clay-web/elements/StringPointer/) | *(optional)* | Optional string pointer for prompt value binding  |
| `promptPlaceholder` | [String](/api-docs/clay-web/String/) | *(optional)* | Placeholder text for the prompt input  |
| `choices` | [Array](/api-docs/clay-web/Array/)<[String](/api-docs/clay-web/String/)> | | Array of button labels for user choices  |
| `cancelable` | [Bool](/api-docs/clay-web/Bool/) | `false` | Whether the dialog can be canceled  |
| `width` | [Float](/api-docs/clay-web/Float/) | `-1` | Fixed width (-1 for auto-sizing)  |
| `height` | [Float](/api-docs/clay-web/Float/) | `-1` | Fixed height (-1 for auto-sizing)  |
| `async` | [Bool](/api-docs/clay-web/Bool/) | | Whether the dialog operates asynchronously  |
