...
target: Clay (Web)
permalink: api-docs/clay-web/elements/ListViewDataSource/
---
...
<div class="type-implements"><strong>Implements:</strong> <a href="/api-docs/clay-web/ceramic/CollectionViewDataSource/">ceramic.CollectionViewDataSource</a></div>
...
<div class="see"><strong>See:</strong> CollectionViewDataSource, <a href="/api-docs/clay-web/elements/ListView/">ListView</a>, <a href="/api-docs/clay-web/elements/CellView/">CellView</a></div>
...
|------|------|-------------|
| `collectionView` | [ceramic.CollectionView](/api-docs/clay-web/ceramic/CollectionView/) | The requesting collection view  |

| Returns | Description |
|---------|-------------|
| [Int](/api-docs/clay-web/Int/) | The number of items in the ListView's items array |
...
|------|------|-------------|
| `collectionView` | [ceramic.CollectionView](/api-docs/clay-web/ceramic/CollectionView/) | The requesting collection view  |
| `itemIndex` | [Int](/api-docs/clay-web/Int/) | The index of the item  |
| `frame` | [ceramic.CollectionViewItemFrame](/api-docs/clay-web/ceramic/CollectionViewItemFrame/) | The frame to configure |
...
|------|------|-------------|
| `collectionView` | [ceramic.CollectionView](/api-docs/clay-web/ceramic/CollectionView/) | The requesting collection view  |
| `itemIndex` | [Int](/api-docs/clay-web/Int/) | The index where the view was used  |
...
| Name | Type | Description |
|------|------|-------------|
| `listView` | [ListView](/api-docs/clay-web/elements/ListView/) | The ListView this data source serves |
