...
title: DragDrop
target: Clay (Web)
permalink: api-docs/clay-web/elements/DragDrop/
---
...
<div class="type-hierarchy"><a href="/api-docs/clay-web/ceramic/Entity/">ceramic.Entity</a> → <strong>elements.DragDrop</strong> (Class)</div>

<div class="type-implements"><strong>Implements:</strong> <a href="/api-docs/clay-web/tracker/Observable/">tracker.Observable</a>, <a href="/api-docs/clay-web/ceramic/Component/">ceramic.Component</a></div>
...
<div class="signature field-var has-description has-plugin" id="entity"><div class="plugin-name">elements</div><code><span class="field-name">entity</span><span class="operator">:</span> <a href="/api-docs/clay-web/ceramic/Visual/" class="type-link">ceramic.Visual</a></code><a class="header-anchor" href="#entity"><span aria-hidden="true" class="header-anchor__symbol">#</span></a></div>
...
|------|------|---------|-------------|
| `pointerX` | [Float](/api-docs/clay-web/Float/) | *(optional)* | X position to start drag from (defaults to current pointer position)  |
| `pointerY` | [Float](/api-docs/clay-web/Float/) | *(optional)* | Y position to start drag from (defaults to current pointer position) |
...
| Name | Type | Default | Description |
|------|------|---------|-------------|
| `threshold` | [Float](/api-docs/clay-web/Float/) | `4.0` | Minimum pointer movement to start drag (default: 4.0 pixels)  |
| `click` | [ceramic.Click](/api-docs/clay-web/ceramic/Click/) | *(optional)* | Optional click component to cancel when dragging starts  |
...
| Name | Type |
|------|------|
| `instance` | [DragDrop](/api-docs/clay-web/elements/DragDrop/) |
...
|------|------|-------------|
| `pointerX` | [Float](/api-docs/clay-web/Float/) | Current pointer X position in screen space  |
| `pointerY` | [Float](/api-docs/clay-web/Float/) | Current pointer Y position in screen space |
