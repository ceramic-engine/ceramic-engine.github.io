...
target: Clay (Web)
permalink: api-docs/clay-web/elements/EnumValuePointer/
---
...
<div class="see"><strong>See:</strong> EnumFieldView, <a href="/api-docs/clay-web/elements/FieldView/">FieldView</a></div>
