...
title: TextFieldKind
target: Clay (Web)
permalink: api-docs/clay-web/elements/TextFieldKind/
---
...
|------|------|-------------|
| `?title` | [String](/api-docs/clay-web/String/) | Optional title for the directory selection dialog |
...
| Name | Type | Description |
|------|------|-------------|
| `?title` | [String](/api-docs/clay-web/String/) | Optional title for the file selection dialog  |
| `?filters` | [Array](/api-docs/clay-web/Array/)<[ceramic.DialogsFileFilter](/api-docs/clay-web/ceramic/DialogsFileFilter/)> | Optional array of file filters to restrict selectable file types |
