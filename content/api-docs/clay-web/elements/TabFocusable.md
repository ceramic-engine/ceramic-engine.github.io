...
title: TabFocusable
target: Clay (Web)
permalink: api-docs/clay-web/elements/TabFocusable/
---
...
<div class="type-hierarchy"><strong>elements.TabFocusable</strong> (Interface) → <a href="/api-docs/clay-web/elements/Button/">Button</a>, <a href="/api-docs/clay-web/elements/FieldView/">FieldView</a></div>
...
| Returns | Description |
|---------|-------------|
| [Bool](/api-docs/clay-web/Bool/) | true if the element can receive focus, false otherwise |
