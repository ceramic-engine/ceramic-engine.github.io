...
title: Scrollbar
target: Clay (Web)
permalink: api-docs/clay-web/elements/Scrollbar/
---
...
<div class="type-hierarchy"><a href="/api-docs/clay-web/ceramic/Entity/">ceramic.Entity</a> → <a href="/api-docs/clay-web/ceramic/Visual/">ceramic.Visual</a> → <strong>elements.Scrollbar</strong> (Class)</div>
...
|------|------|-------------|
| `insetTop` | [Float](/api-docs/clay-web/Float/) | Top inset in pixels  |
| `insetRight` | [Float](/api-docs/clay-web/Float/) | Right inset in pixels  |
| `insetBottom` | [Float](/api-docs/clay-web/Float/) | Bottom inset in pixels  |
| `insetLeft` | [Float](/api-docs/clay-web/Float/) | Left inset in pixels |
...
| Name | Type |
|------|------|
| `instance` | [Scrollbar](/api-docs/clay-web/elements/Scrollbar/) |
