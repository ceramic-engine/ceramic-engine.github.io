...
target: Clay (Web)
permalink: api-docs/clay-web/elements/ColorPickerHSLuvSpectrumView/
---
...
<div class="type-hierarchy"><a href="/api-docs/clay-web/ceramic/Entity/">ceramic.Entity</a> → <a href="/api-docs/clay-web/ceramic/Visual/">ceramic.Visual</a> → <a href="/api-docs/clay-web/ceramic/Quad/">ceramic.Quad</a> → <a href="/api-docs/clay-web/ceramic/Layer/">ceramic.Layer</a> → <a href="/api-docs/clay-web/ceramic/View/">ceramic.View</a> → <strong>elements.ColorPickerHSLuvSpectrumView</strong> (Class)</div>
...
| Name | Type |
|------|------|
| `instance` | [ColorPickerHSLuvSpectrumView](/api-docs/clay-web/elements/ColorPickerHSLuvSpectrumView/) |
...
|------|------|-------------|
| `lightness` | [Float](/api-docs/clay-web/Float/) | The lightness value (0-1)  |

| Returns | Description |
|---------|-------------|
| [ceramic.AlphaColor](/api-docs/clay-web/ceramic/AlphaColor/) | The resulting color in HSLuv space with full opacity |
