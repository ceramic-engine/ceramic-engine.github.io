...
target: Clay (Web)
permalink: api-docs/clay-web/elements/ScrollingLayout/
---
...
<div class="type-hierarchy"><a href="/api-docs/clay-web/ceramic/Entity/">ceramic.Entity</a> → <a href="/api-docs/clay-web/ceramic/Visual/">ceramic.Visual</a> → <a href="/api-docs/clay-web/ceramic/Quad/">ceramic.Quad</a> → <a href="/api-docs/clay-web/ceramic/Layer/">ceramic.Layer</a> → <a href="/api-docs/clay-web/ceramic/View/">ceramic.View</a> → <a href="/api-docs/clay-web/ceramic/ScrollView/">ceramic.ScrollView</a> → <strong>elements.ScrollingLayout</strong> (Class)</div>
...
<div class="signature field-var has-description has-plugin" id="checkChildrenOfView"><div class="plugin-name">elements</div><code><span class="field-name">checkChildrenOfView</span><span class="operator">:</span> <a href="/api-docs/clay-web/ceramic/View/" class="type-link">ceramic.View</a></code><a class="header-anchor" href="#checkChildrenOfView"><span aria-hidden="true" class="header-anchor__symbol">#</span></a></div>
...
| `withBorders` | [Bool](/api-docs/clay-web/Bool/) | `false` | Whether to add visual borders (top border on content, bottom border on container) |
...
| Name | Type |
|------|------|
| `instance` | [ScrollingLayout](/api-docs/clay-web/elements/ScrollingLayout/)<elements.ScrollingLayout.T> |
...
|------|------|-------------|
| `delta` | [Float](/api-docs/clay-web/Float/) | Time delta since last update |
