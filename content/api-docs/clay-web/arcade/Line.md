...
title: Line
target: Clay (Web)
permalink: api-docs/clay-web/arcade/Line/
---
...
|------|------|-------------|
| `x` | [Float](/api-docs/clay-web/Float/) | The x coordinate of the start point.  |
| `y` | [Float](/api-docs/clay-web/Float/) | The y coordinate of the start point.  |
| `angle` | [Float](/api-docs/clay-web/Float/) | The angle in radians.  |
| `length` | [Float](/api-docs/clay-web/Float/) | The length of the line. |
...
| Name | Type | Description |
|------|------|-------------|
| `x1` | [Float](/api-docs/clay-web/Float/) | The x coordinate of the start point.  |
| `y1` | [Float](/api-docs/clay-web/Float/) | The y coordinate of the start point.  |
| `x2` | [Float](/api-docs/clay-web/Float/) | The x coordinate of the end point.  |
| `y2` | [Float](/api-docs/clay-web/Float/) | The y coordinate of the end point. |
