...
title: Point
target: Clay (Web)
permalink: api-docs/clay-web/arcade/Point/
---
...
|------|------|---------|-------------|
| `azimuth` | [Float](/api-docs/clay-web/Float/) | | The angle in radians (or degrees if asDegrees is true).  |
| `radius` | [Float](/api-docs/clay-web/Float/) | `1` | The distance from the origin.  |
| `asDegrees` | [Bool](/api-docs/clay-web/Bool/) | `false` | Whether the azimuth is given in degrees (true) or radians (false). |
...
| Name | Type | Description |
|------|------|-------------|
| `deg` | [Float](/api-docs/clay-web/Float/) | The angle in degrees.  |

| Returns | Description |
|---------|-------------|
| [Float](/api-docs/clay-web/Float/) | The angle in radians. |
