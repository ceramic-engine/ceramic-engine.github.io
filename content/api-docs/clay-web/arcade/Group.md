...
title: Group
target: Clay (Web)
permalink: api-docs/clay-web/arcade/Group/
---
...
|------|------|-------------|
| `body` | [Body](/api-docs/clay-web/arcade/Body/) | The body to add to the group. |
